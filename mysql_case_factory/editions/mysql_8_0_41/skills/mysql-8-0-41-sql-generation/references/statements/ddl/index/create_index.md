...
structured_config:
  ...
  statement:
    ...
    aliases:
      - create index
      - 创建索引
    purpose: Create MySQL 8.0.41 secondary indexes and cover MySQL-specific index classes and online DDL options.
  syntax_templates:
  ...
  factor_catalog_mapping:
    ...
    imported_factors:
      ...
      - catalog_factor: index.options.visibility
        ...
        coverage_role: rotate_attach
        value_policy: reuse_catalog_values
        reason: MySQL supports visible and invisible indexes before 8.0.41.
