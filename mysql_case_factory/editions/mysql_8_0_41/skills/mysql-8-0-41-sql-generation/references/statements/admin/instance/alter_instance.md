...
structured_config:
  ...
  statement:
    ...
    purpose: Execute MySQL instance-level maintenance actions available in 8.0.41, including RELOAD KEYRING added in 8.0.24.
  syntax_templates:
  ...
  factors:
    action_branch:
      ...
      values: [enable_redo_log, disable_redo_log, rotate_innodb_master_key, rotate_binlog_master_key, reload_tls, reload_keyring]
    privilege_state:
