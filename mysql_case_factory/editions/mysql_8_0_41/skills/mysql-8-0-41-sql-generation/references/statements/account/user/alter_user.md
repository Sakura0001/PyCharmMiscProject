...
structured_config:
  ...
  statement:
    ...
    name: ALTER USER
    aliases: [alter user]
    purpose: Alter MySQL user authentication, MFA, password lifecycle, account lock, and attributes available in 8.0.41.
  syntax_templates:
  ...
  factors:
    ...
    auth_shape:
      ...
      values: [identified_by_password, identified_with_plugin, discard_old_password, add_authentication_factor, modify_authentication_factor, drop_authentication_factor]
