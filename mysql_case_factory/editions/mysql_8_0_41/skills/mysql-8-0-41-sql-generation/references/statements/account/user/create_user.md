...
structured_config:
  ...
  statement:
    ...
    name: CREATE USER
    aliases: [create user]
    purpose: Create MySQL user accounts with 8.0.41 authentication, including MFA available since 8.0.27.
  syntax_templates:
  ...
  factors:
    ...
    auth_shape:
      ...
      importance: important
      values: [omitted, identified_by_password, identified_with_plugin, random_password, two_factor, three_factor]
    expected_status:
