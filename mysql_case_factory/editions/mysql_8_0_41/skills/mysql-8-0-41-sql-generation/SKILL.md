---
name: mysql-8-0-41-sql-generation
description: Use when generating MySQL 8.0.41 SQL test cases, designing lifecycle plans, auditing statement coverage references, or using bundled MySQL base-object templates.
---
...
This skill targets MySQL Community Server 8.0.41. Current MySQL 8.0 online
manual pages may include features introduced after 8.0.41. Before adding a
