...
def build_name_context(case_token: str, sequence: int, max_identifier_length: int = 64) -> dict[str, str]:
    return {
        ...
        "savepoint_name": _build_object_name("sp_", case_token, sequence, max_identifier_length),
        ...
        "loadable_function_name": _build_object_name("udf_", case_token, sequence, max_identifier_length),
