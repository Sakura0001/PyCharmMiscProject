...
public final class PostgreSQLSchemaTypeCoverageTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        require(columns.get("c23").getType() == PostgreSQLSchema.PostgreSQLDataType.TIMETZ,
                "Expected TIMETZ mapping");
        require(columns.get("c24").getType() == PostgreSQLSchema.PostgreSQLDataType.TIMESTAMPTZ,
                "Expected TIMESTAMPTZ mapping");
        require(columns.get("c25").getType() == PostgreSQLSchema.PostgreSQLDataType.INT,
                "Expected SERIAL to map to INT");
        require(columns.get("c26").getType() == PostgreSQLSchema.PostgreSQLDataType.INT,
                "Expected BIGSERIAL to map to INT");
        require(columns.get("c27").getType() == PostgreSQLSchema.PostgreSQLDataType.INT,
                "Expected SMALLSERIAL to map to INT");
        require(columns.get("c25").getColumnDefault() != null && columns.get("c25").getColumnDefault().contains("nextval"),
                "Expected SERIAL default sequence");
