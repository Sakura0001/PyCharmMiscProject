...
public class PostgreSQLSchema extends AbstractSchema<PostgreSQLGlobalState, PostgreSQLTable, PostgreSQLTrigger> {
    ...
    public enum PostgreSQLDataType {
        ...
        BYTEA, DATE, TIME, TIMETZ, TIMESTAMP, TIMESTAMPTZ, INTERVAL, POINT, BOX, LSEG, PATH, POLYGON, CIRCLE,
                ...
                try (ResultSet rs = s.executeQuery(
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (PostgreSQLErrorClassifier.isTransientSchemaRefreshError(e)) {
                                continue;
                            }
                            throw e;
                        }
    ...
    public static PostgreSQLDataType getPostgreSQLDataType(String typeString, String udtName,
        ...
        switch (typeString) {
            ...
            case "time with time zone":
                return PostgreSQLDataType.TIMETZ;
