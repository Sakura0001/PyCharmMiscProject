...
public class PostgreSQLProvider extends SQLProviderAdapter {
    ...
    public enum PostgreSQLQueryProvider implements QueryProvider {
        ...
        CREATE_EXPRESSION_INDEX("create_expression_index", true),
        CREATE_BRIN_INDEX("create_brin_index", true),
        CREATE_SPGIST_INDEX("create_spgist_index", true),
        CREATE_OPCLASS_INDEX("create_opclass_index", true),
        CREATE_UNIQUE_NULLS_INDEX("create_unique_nulls_index", true),
        ...
        ALTER_TABLE_VALIDATE_CONSTRAINT("alter_table_validate_constraint", true),
        ALTER_TABLE_RENAME_CONSTRAINT("alter_table_rename_constraint", true),
        ALTER_TABLE_ADD_IDENTITY("alter_table_add_identity", true),
        ALTER_TABLE_DROP_IDENTITY("alter_table_drop_identity", true),
        ...
        CREATE_TYPE("create_type", true),
        DROP_TYPE("drop_type", true),
        CREATE_STATISTICS("create_statistics", true),
        ALTER_STATISTICS("alter_statistics", true),
        DROP_STATISTICS("drop_statistics", true),
        CREATE_DOMAIN("create_domain", true),
        DROP_DOMAIN("drop_domain", true),
        CREATE_TABLESPACE("create_tablespace", true),
        DROP_TABLESPACE("drop_tablespace", true),
    ...
    private static Map<QueryProvider, Integer> buildQueryWeights(GlobalState state) {
        ...
        queryWeights.put(PostgreSQLQueryProvider.CREATE_EXPRESSION_INDEX, 2);
        queryWeights.put(PostgreSQLQueryProvider.CREATE_BRIN_INDEX, 1);
        queryWeights.put(PostgreSQLQueryProvider.CREATE_SPGIST_INDEX, 1);
        queryWeights.put(PostgreSQLQueryProvider.CREATE_OPCLASS_INDEX, 1);
        queryWeights.put(PostgreSQLQueryProvider.CREATE_UNIQUE_NULLS_INDEX, 1);
        ...
        queryWeights.put(PostgreSQLQueryProvider.ALTER_TABLE_VALIDATE_CONSTRAINT, 1);
        queryWeights.put(PostgreSQLQueryProvider.ALTER_TABLE_RENAME_CONSTRAINT, 1);
        queryWeights.put(PostgreSQLQueryProvider.ALTER_TABLE_ADD_IDENTITY, 1);
        queryWeights.put(PostgreSQLQueryProvider.ALTER_TABLE_DROP_IDENTITY, 1);
        ...
        queryWeights.put(PostgreSQLQueryProvider.CREATE_TYPE, 1);
        queryWeights.put(PostgreSQLQueryProvider.DROP_TYPE, 1);
        queryWeights.put(PostgreSQLQueryProvider.CREATE_STATISTICS, 1);
        queryWeights.put(PostgreSQLQueryProvider.ALTER_STATISTICS, 1);
        queryWeights.put(PostgreSQLQueryProvider.DROP_STATISTICS, 1);
        queryWeights.put(PostgreSQLQueryProvider.CREATE_DOMAIN, 1);
        queryWeights.put(PostgreSQLQueryProvider.DROP_DOMAIN, 1);
        queryWeights.put(PostgreSQLQueryProvider.CREATE_TABLESPACE,
                globalState.getDbmsSpecificOptions().allowTablespaces ? 1 : 0);
        queryWeights.put(PostgreSQLQueryProvider.DROP_TABLESPACE,
                globalState.getDbmsSpecificOptions().allowTablespaces ? 1 : 0);
    ...
    public enum PostgreSQLDDLStmt {
        ...
        CREATE_EXPRESSION_INDEX(PostgreSQLQueryProvider.CREATE_EXPRESSION_INDEX),
        CREATE_BRIN_INDEX(PostgreSQLQueryProvider.CREATE_BRIN_INDEX),
        CREATE_SPGIST_INDEX(PostgreSQLQueryProvider.CREATE_SPGIST_INDEX),
        CREATE_OPCLASS_INDEX(PostgreSQLQueryProvider.CREATE_OPCLASS_INDEX),
        CREATE_UNIQUE_NULLS_INDEX(PostgreSQLQueryProvider.CREATE_UNIQUE_NULLS_INDEX),
        ...
        ALTER_TABLE_VALIDATE_CONSTRAINT(PostgreSQLQueryProvider.ALTER_TABLE_VALIDATE_CONSTRAINT),
        ALTER_TABLE_RENAME_CONSTRAINT(PostgreSQLQueryProvider.ALTER_TABLE_RENAME_CONSTRAINT),
        ALTER_TABLE_ADD_IDENTITY(PostgreSQLQueryProvider.ALTER_TABLE_ADD_IDENTITY),
        ALTER_TABLE_DROP_IDENTITY(PostgreSQLQueryProvider.ALTER_TABLE_DROP_IDENTITY),
        ...
        CREATE_TYPE(PostgreSQLQueryProvider.CREATE_TYPE),
        DROP_TYPE(PostgreSQLQueryProvider.DROP_TYPE),
        CREATE_STATISTICS(PostgreSQLQueryProvider.CREATE_STATISTICS),
        ALTER_STATISTICS(PostgreSQLQueryProvider.ALTER_STATISTICS),
        DROP_STATISTICS(PostgreSQLQueryProvider.DROP_STATISTICS),
        CREATE_DOMAIN(PostgreSQLQueryProvider.CREATE_DOMAIN),
        DROP_DOMAIN(PostgreSQLQueryProvider.DROP_DOMAIN),
