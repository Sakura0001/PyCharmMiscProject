"""Tests for deallocate factor extension plan."""
...
class TestDeallocateFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = build_deallocate_factor_extension_plan(_REPO)
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "e2ec7a79280e6f50c29ed5e743b7577e7d1"
            "1d7776b563cc6b7482486f91384d3",
