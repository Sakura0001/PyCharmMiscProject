"""Tests for set_session_authorization factor extension plan."""
...
class TestSetSessionAuthorizationFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = (
            build_set_session_authorization_factor_extension_plan(
                _REPO
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "c828037e8638575c97fb9988d0b19a9c4856e7c2ee65f"
            "fea4078696ec85904ba",
