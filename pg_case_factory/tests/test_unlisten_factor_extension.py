"""Tests for unlisten factor extension plan."""
...
class TestUnlistenFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = build_unlisten_factor_extension_plan(_REPO)
    ...
    def test_outcome_counts(self) -> None:
        ...
        self.assertEqual(
            {"success": 3840, "expected_failure": 384},
            dict(counts),
        )
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "2916b607de92884e3ee6769516e828dd973ccb00de51cb3"
            "63f91b08477f189aa",
