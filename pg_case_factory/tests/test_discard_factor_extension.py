"""Tests for discard factor extension plan."""
...
class TestDiscardFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = build_discard_factor_extension_plan(_REPO)
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "5f7ff62fb0655cc4eeb6a551c9ed6d4a8adfcd3127b520d3"
            "60b95cd015546c84",
