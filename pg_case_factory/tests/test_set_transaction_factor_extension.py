"""Tests for set_transaction factor extension plan."""
...
class TestSetTransactionFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = build_set_transaction_factor_extension_plan(_REPO)

    def test_frozen_extension_count(self) -> None:
        self.assertEqual(1960, len(self.plan.cases))
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "a52193f744924231f53a1ef67d75eadd6fbd4850d8b178b6"
            "725c1ed2177bef24",
