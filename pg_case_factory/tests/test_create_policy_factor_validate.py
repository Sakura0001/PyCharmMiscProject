"""Tests for create_policy factor validate module."""
...
from src.pg_case_factory.create_policy_factor_validate import (
...
class TestCreatePolicyFactorValidate(unittest.TestCase):
    def setUp(self) -> None:
        self.baseline = build_create_policy_factor_loop_plan(
            _REPO
        )
        self.extension = (
            build_create_policy_factor_extension_plan(_REPO)
        )
    ...
    def test_validation_passes_for_all_files(self) -> None:
        report = validate_create_policy_factor_programs(
    ...
    def test_baseline_case_count(self) -> None:
        ...
        self.assertEqual(81, report.baseline_case_count)
        self.assertEqual(
            936, report.extension_case_count
        )
        self.assertEqual(1017, report.sql_file_count)
    ...
    def test_records_cover_all_cases(self) -> None:
        ...
        self.assertEqual(1017, len(report.records))
    ...
    def test_sha256_dictionary_complete(self) -> None:
        ...
        self.assertEqual(1017, len(report.sql_sha256))

    def test_validation_fails_on_tampered_file(self) -> None:
        filename = "CREATEPOLICY00001.sql"
    ...
    def test_selected_case_ids_validates_subset(
        self,
    ) -> None:
        selected = {
            "CREATEPOLICY00001",
    ...
    def test_to_dict_structure(self) -> None:
        ...
        self.assertEqual(
            "create_policy_actual_factor_witness_report",
            d["kind"],
        )
