"""Tests for set_transaction factor validate module."""
...
from src.pg_case_factory.validate_set_transaction import (
...
class TestSetTransactionFactorValidate(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_validation_passes_for_all_files(self) -> None:
        report = validate_set_transaction_factor_programs(
            self.baseline,
            self.extension,
            self.programs,
            _REPO,
    ...
    def test_baseline_case_count(self) -> None:
        ...
        self.assertEqual(1960, report.extension_case_count)
        self.assertEqual(2004, report.sql_file_count)
    ...
    def test_records_cover_all_cases(self) -> None:
        ...
        self.assertEqual(2004, len(report.records))
    ...
    def test_sha256_dictionary_complete(self) -> None:
        ...
        self.assertEqual(2004, len(report.sql_sha256))

    def test_validation_fails_on_tampered_file(self) -> None:
        filename = "SETTRANSACTION00001.sql"
    ...
    def test_selected_case_ids_validates_subset(self) -> None:
        selected = {"SETTRANSACTION00001", "SETTRANSACTION00045"}
        report = validate_set_transaction_factor_programs(
            self.baseline,
            self.extension,
            self.programs,
    ...
    def test_to_dict_structure(self) -> None:
        ...
        self.assertEqual(
            "set_transaction_actual_factor_witness_report",
            d["kind"],
        )
