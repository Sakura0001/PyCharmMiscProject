"""Tests for listen factor extension plan."""
...
class TestListenFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = build_listen_factor_extension_plan(_REPO)
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "52393b50baf105464bae141318ca04d5beede429f0c7775"
            "425e78ad8345addeb",
