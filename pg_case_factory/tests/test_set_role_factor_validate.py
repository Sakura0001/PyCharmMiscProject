"""Tests for set_role factor validate module."""
...
from src.pg_case_factory.validate_set_role import (
...
class TestSetRoleFactorValidate(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_validation_passes_for_all_files(self) -> None:
        report = validate_set_role_factor_programs(
            self.baseline,
            self.extension,
            self.programs,
            _REPO,
    ...
    def test_baseline_case_count(self) -> None:
        ...
        self.assertEqual(5632, report.extension_case_count)
        self.assertEqual(5675, report.sql_file_count)
    ...
    def test_records_cover_all_cases(self) -> None:
        ...
        self.assertEqual(5675, len(report.records))
    ...
    def test_sha256_dictionary_complete(self) -> None:
        ...
        self.assertEqual(5675, len(report.sql_sha256))

    def test_validation_fails_on_tampered_file(self) -> None:
        filename = "SETROLE00001.sql"
        original = self.programs[filename]
        tampered = original.replace(
            "SET ROLE setrole_00001_witness;", "DROP TABLE"
        )
    ...
    def test_selected_case_ids_validates_subset(self) -> None:
        selected = {"SETROLE00001", "SETROLE00044"}
        report = validate_set_role_factor_programs(
            self.baseline,
            self.extension,
            self.programs,
    ...
    def test_to_dict_structure(self) -> None:
        ...
        self.assertEqual(
            "set_role_actual_factor_witness_report",
            d["kind"],
        )
