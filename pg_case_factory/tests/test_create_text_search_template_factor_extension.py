"""Tests for create_text_search_template factor extension plan."""
...
class TestCreateTextSearchTemplateFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = (
            build_create_text_search_template_factor_extension_plan(
                _REPO
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "5becd55f45b8b8761e8d3c9f038ccd28e2b9e075"
            "46d83ab8060400961d164586",
