"""Tests for do factor render module."""
...
class TestDoFactorRender(unittest.TestCase):
    def setUp(self) -> None:
        self.baseline = (
    ...
    def test_file_count(self) -> None:
        self.assertEqual(10786, self.count)
    ...
    def test_deterministic_render(self) -> None:
        for case in self.baseline.cases[:5]:
            a = render_do_factor_case(
                case, _REPO
            )
            b = render_do_factor_case(
                case, _REPO
            )
