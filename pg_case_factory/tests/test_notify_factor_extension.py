"""Tests for notify factor extension plan."""
...
class TestNotifyFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = build_notify_factor_extension_plan(_REPO)
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "cf6a8a748ecd90cc1237cd13b7fff65e462fab9a1"
            "9095f012f5569aad7a00a0a",
