"""Tests for create_user factor extension plan."""
...
class TestCreateUserFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = build_create_user_factor_extension_plan(_REPO)

    def test_frozen_extension_count(self) -> None:
        self.assertEqual(1620, len(self.plan.cases))
    ...
    def test_outcome_counts(self) -> None:
        ...
        self.assertEqual(
            {"success": 648, "expected_failure": 972}, dict(counts)
        )
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "8a97447a85179fee1bb70350c1320819f9cf0f444afaffc13c70e9f13b68da47",
    ...
    def test_derivation_id_prefix(self) -> None:
        for case in self.plan.cases:
            self.assertTrue(case.derivation_id.startswith("CU-EXT|"))
