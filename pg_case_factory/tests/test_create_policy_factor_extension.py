"""Tests for create_policy factor extension plan."""
...
class TestCreatePolicyFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = build_create_policy_factor_extension_plan(_REPO)

    def test_frozen_extension_count(self) -> None:
        self.assertEqual(936, len(self.plan.cases))
    ...
    def test_outcome_counts(self) -> None:
        ...
        self.assertEqual(
            {"success": 360, "expected_failure": 576},
            dict(counts),
        )
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "b3284b92f3b7d175d0b7b5211ca593c032cbafe51275eb98b3cf7fa6c9292bc0",
