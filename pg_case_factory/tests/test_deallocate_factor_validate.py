"""Tests for deallocate factor validate module."""
...
from src.pg_case_factory.deallocate_factor_validate import (
...
class TestDeallocateFactorValidate(unittest.TestCase):
    def setUp(self) -> None:
        self.baseline = build_deallocate_factor_loop_plan(
            _REPO
        )
        self.extension = (
    ...
    def test_validation_passes_for_all_files(self) -> None:
        report = validate_deallocate_factor_programs(
            self.baseline,
            self.extension,
            self.programs,
            _REPO,
    ...
    def test_to_dict_structure(self) -> None:
        ...
        self.assertEqual(
            "deallocate_actual_factor_witness_report",
            d["kind"],
        )
