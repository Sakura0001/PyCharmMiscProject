"""Tests for create_type factor extension plan."""
...
class TestCreateTypeFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = build_create_type_factor_extension_plan(_REPO)

    def test_frozen_extension_count(self) -> None:
        self.assertEqual(3375, len(self.plan.cases))
    ...
    def test_outcome_counts(self) -> None:
        ...
        self.assertEqual(
            {"success": 2628, "expected_failure": 747},
            dict(counts),
        )
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "921abe84a1211e701c3dbd618eea292a4f9f054dd1a976"
            "d77d32cf56ef79a548",
