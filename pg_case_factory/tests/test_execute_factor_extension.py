"""Tests for execute factor extension plan."""
...
class TestExecuteFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = build_execute_factor_extension_plan(_REPO)
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "0f0e10325c3d6c7f67cba199615050a766f8952"
            "aff25935ffaac3b58369cf9a3",
