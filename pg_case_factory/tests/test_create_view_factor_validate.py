"""Tests for create_view factor validate module."""
...
from src.pg_case_factory.create_view_factor_validate import (
...
class TestCreateViewFactorValidate(unittest.TestCase):
    def setUp(self) -> None:
        self.baseline = (
    ...
    def test_validation_passes_for_all_files(self) -> None:
        report = validate_create_view_factor_programs(
            self.baseline,
            self.extension,
            self.programs,
            _REPO,
    ...
    def test_baseline_case_count(self) -> None:
        ...
        self.assertEqual(5472, report.extension_case_count)
        self.assertEqual(5543, report.sql_file_count)
    ...
    def test_records_cover_all_cases(self) -> None:
        ...
        self.assertEqual(5543, len(report.records))
    ...
    def test_sha256_dictionary_complete(self) -> None:
        ...
        self.assertEqual(5543, len(report.sql_sha256))

    def test_validation_fails_on_tampered_file(self) -> None:
        filename = "CREATEVIEW00001.sql"
    ...
    def test_to_dict_structure(self) -> None:
        ...
        self.assertEqual(
            "create_view_actual_factor_witness_report",
            d["kind"],
        )
