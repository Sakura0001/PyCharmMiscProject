"""Tests for create_index factor extension plan."""
...
class TestCreateIndexFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = build_create_index_factor_extension_plan(_REPO)

    def test_frozen_extension_count(self) -> None:
        self.assertEqual(1908, len(self.plan.cases))
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "730a7e32f4d73eee99a7bef8b24a98a0e5c9636e51b70f5cbd57aa4b3ca6d3f5",
            self.plan.extension_multiset_sha256,
        )

    def test_constants(self) -> None:
        self.assertEqual(101, _BASELINE_COUNT)
    ...
    def test_dropped_combinations(self) -> None:
        self.assertEqual(72, self.plan.dropped_combination_count)

    def test_raw_combinations(self) -> None:
        self.assertEqual(1980, self.plan.raw_combination_count)
    ...
    def test_derivation_id_prefix(self) -> None:
        for case in self.plan.cases:
            self.assertTrue(case.derivation_id.startswith("CINX-EXT|"))
