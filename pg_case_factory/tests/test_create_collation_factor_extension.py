"""Tests for create_collation factor extension plan."""
...
class TestCreateCollationFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = build_create_collation_factor_extension_plan(_REPO)

    def test_frozen_extension_count(self) -> None:
        self.assertEqual(1080, len(self.plan.cases))
    ...
    def test_outcome_counts(self) -> None:
        ...
        self.assertEqual(
            {"success": 540, "expected_failure": 540}, dict(counts)
        )
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "e0b8d80c2cf73eba564dd1070cc64936a4b0ae45c0b82b95e02346d2087dd716",
    ...
    def test_derivation_id_prefix(self) -> None:
        for case in self.plan.cases:
            self.assertTrue(case.derivation_id.startswith("CCOL-EXT|"))
