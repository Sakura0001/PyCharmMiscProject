"""Tests for create_transform factor extension plan."""
...
class TestCreateTransformFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = (
            build_create_transform_factor_extension_plan(
                _REPO
    ...
    def test_frozen_extension_count(self) -> None:
        self.assertEqual(1218, len(self.plan.cases))
    ...
    def test_outcome_counts(self) -> None:
        ...
        self.assertEqual(
            {"success": 792, "expected_failure": 426},
            dict(counts),
        )
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "a79792fa18a5649563f0b5afa6136d75b182f64d7e61dd5e0b88b"
            "af9d376d43a",
            self.plan.extension_multiset_sha256,
        )

    def test_constants(self) -> None:
        self.assertEqual(59, _BASELINE_COUNT)
