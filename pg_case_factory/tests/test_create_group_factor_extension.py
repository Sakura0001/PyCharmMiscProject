"""Tests for create_group factor extension plan."""
...
class TestCreateGroupFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = build_create_group_factor_extension_plan(_REPO)

    def test_frozen_extension_count(self) -> None:
        self.assertEqual(360, len(self.plan.cases))
    ...
    def test_outcome_counts(self) -> None:
        ...
        self.assertEqual(
            {"success": 144, "expected_failure": 216}, dict(counts)
        )
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "b30dd3e41d067e034ad76c35fad441d07cb7788a4c59c33aaef3d2cb27dd8786",
    ...
    def test_derivation_id_prefix(self) -> None:
        for case in self.plan.cases:
            self.assertTrue(case.derivation_id.startswith("CGP-EXT|"))
