"""Tests for create_view factor extension plan."""
...
class TestCreateViewFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = (
    ...
    def test_frozen_extension_count(self) -> None:
        self.assertEqual(5472, len(self.plan.cases))
    ...
    def test_outcome_counts(self) -> None:
        ...
        self.assertEqual(
            {"success": 2724, "expected_failure": 2748},
            dict(counts),
        )
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "e97a6ade87d2ec34b8d575d80db896bbd93402938fb20"
            "8147d6754836078e69c",
