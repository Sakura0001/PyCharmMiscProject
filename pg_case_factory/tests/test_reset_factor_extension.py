"""Tests for reset factor extension plan."""
...
class TestResetFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = build_reset_factor_extension_plan(_REPO)
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "c0cca77d59fde8b22b112e9ca19e0e283e9957cc83cdbe5f"
            "7192c976e90aa022",
