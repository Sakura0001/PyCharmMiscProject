"""Tests for set_constraints factor extension plan."""
...
class TestSetConstraintsFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = build_set_constraints_factor_extension_plan(_REPO)

    def test_frozen_extension_count(self) -> None:
        self.assertEqual(4224, len(self.plan.cases))
    ...
    def test_outcome_counts(self) -> None:
        ...
        self.assertEqual(
            {"success": 3648, "expected_failure": 576},
            dict(counts),
        )
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "856e6e69ce6ac3b257e84dbd7e6869685736e7f7"
            "c264847bd76a9964e0e43d4d",
