"""Tests for create_table factor extension plan."""
...
class TestCreateTableFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = build_create_table_factor_extension_plan(_REPO)

    def test_frozen_extension_count(self) -> None:
        self.assertEqual(5760, len(self.plan.cases))
    ...
    def test_outcome_counts(self) -> None:
        ...
        self.assertEqual(
            {"success": 5500, "expected_failure": 260}, dict(counts)
        )
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "63a491d072345be9765eefa93e5e71dc6b83cfc67340bf65817f7921b615a173",
            self.plan.extension_multiset_sha256,
        )

    def test_constants(self) -> None:
        self.assertEqual(188, _BASELINE_COUNT)
    ...
    def test_raw_combinations(self) -> None:
        self.assertEqual(5760, self.plan.raw_combination_count)
    ...
    def test_derivation_id_prefix(self) -> None:
        for case in self.plan.cases:
            self.assertTrue(case.derivation_id.startswith("CT-EXT|"))
