"""Tests for create_operator_class factor extension plan."""
...
class TestCreateOperatorClassFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = (
    ...
    def test_frozen_extension_count(self) -> None:
        self.assertEqual(5568, len(self.plan.cases))
    ...
    def test_outcome_counts(self) -> None:
        ...
        self.assertEqual(
            {"success": 1344, "expected_failure": 4224},
            dict(counts),
        )
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "b8ba1d63949d51a2234a7631f6e8e0ad40d2faae8238951f60b26c1083672fdf",
