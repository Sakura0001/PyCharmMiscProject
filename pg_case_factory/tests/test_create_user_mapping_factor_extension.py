"""Tests for create_user_mapping factor extension plan."""
...
class TestCreateUserMappingFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = (
            build_create_user_mapping_factor_extension_plan(
                _REPO
    ...
    def test_frozen_extension_count(self) -> None:
        self.assertEqual(1920, len(self.plan.cases))
    ...
    def test_outcome_counts(self) -> None:
        ...
        self.assertEqual(
            {"success": 456, "expected_failure": 1464},
            dict(counts),
        )
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "1fef431a8275f0890a391882118272469f05a81e"
            "5be1bcc21f9b6a1ffb427aef",
