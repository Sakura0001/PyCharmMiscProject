"""Tests for do factor extension plan."""
...
class TestDoFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = (
    ...
    def test_frozen_extension_count(self) -> None:
        self.assertEqual(10740, len(self.plan.cases))
    ...
    def test_outcome_counts(self) -> None:
        ...
        self.assertEqual(
            {"success": 5112, "expected_failure": 5628},
            dict(counts),
        )
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "33378ea5b4d976044eca2aaa33b5c04d1b642deb"
            "4ff09b06cbaef36ff8ab8328",
