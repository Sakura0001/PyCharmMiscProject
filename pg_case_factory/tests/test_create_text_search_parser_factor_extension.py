"""Tests for create_text_search_parser factor extension plan."""
...
class TestCreateTextSearchParserFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = (
            build_create_text_search_parser_factor_extension_plan(
                _REPO
    ...
    def test_frozen_extension_count(self) -> None:
        self.assertEqual(976, len(self.plan.cases))
    ...
    def test_outcome_counts(self) -> None:
        ...
        self.assertEqual(
            {"success": 220, "expected_failure": 756},
            dict(counts),
        )
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "0f545dff5c4485fbfdaf0a792c9956fbbd8da042fcccc5c6"
            "d0cc99399099437d",
