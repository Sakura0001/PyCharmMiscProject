"""Tests for show factor extension plan."""
...
class TestShowFactorExtension(unittest.TestCase):
    def setUp(self) -> None:
        self.plan = build_show_factor_extension_plan(_REPO)
    ...
    def test_frozen_extension_multiset_sha256(self) -> None:
        self.assertEqual(
            "cabfa6f2508a1a84dbc14526eef8d4e7698ca99b16b"
            "513ddea62eef60b11bc0f",
