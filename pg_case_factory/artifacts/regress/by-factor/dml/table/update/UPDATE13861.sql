...
-- primary_obligation_id: UPDATE-EXT|13861|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_13861_tbl, update_13861_src, update_13861_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_13861_tbl SET val = abs(1) WHERE update_13861_no_such_col = 1;
-- primary-target-end
