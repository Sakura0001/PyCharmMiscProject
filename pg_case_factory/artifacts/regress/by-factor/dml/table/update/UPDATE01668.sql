...
-- primary_obligation_id: UPDATE-EXT|01668|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_01668_tbl, update_01668_src, update_01668_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_01668_tbl SET val = 1 WHERE update_01668_no_such_col = 1;
-- primary-target-end
