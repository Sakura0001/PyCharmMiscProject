...
-- primary_obligation_id: UPDATE-EXT|10020|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_10020_tbl, update_10020_src, update_10020_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_10020_tbl SET val = 0 WHERE id = 999;
-- primary-target-end
