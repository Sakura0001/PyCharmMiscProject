...
-- primary_obligation_id: UPDATE-EXT|16682|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_16682_tbl, update_16682_src, update_16682_ref CASCADE;
RESET ROLE;
...
UPDATE update_16682_tbl AS u SET val = (SELECT val FROM update_16682_src) WHERE update_16682_no_such_col = 1;
-- primary-target-end
