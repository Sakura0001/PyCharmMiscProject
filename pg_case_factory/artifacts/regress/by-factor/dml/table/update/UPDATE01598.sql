...
-- primary_obligation_id: UPDATE-EXT|01598|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_01598_tbl, update_01598_src, update_01598_ref CASCADE;
RESET ROLE;
...
UPDATE update_01598_tbl AS u SET val = 1 WHERE update_01598_no_such_col = 1;
-- primary-target-end
