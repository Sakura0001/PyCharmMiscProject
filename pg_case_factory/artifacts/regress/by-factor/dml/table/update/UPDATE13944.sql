...
-- primary_obligation_id: UPDATE-EXT|13944|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_13944_tbl, update_13944_src, update_13944_ref CASCADE;
RESET ROLE;
...
UPDATE "update_13944_tbl" SET val = 1 WHERE update_13944_no_such_col = 1;
-- primary-target-end
