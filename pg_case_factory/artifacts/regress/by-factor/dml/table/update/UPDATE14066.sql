...
-- primary_obligation_id: UPDATE-EXT|14066|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_14066_tbl, update_14066_src, update_14066_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_14066_tbl SET val = (SELECT 1) WHERE update_14066_no_such_col = 1;
-- primary-target-end
