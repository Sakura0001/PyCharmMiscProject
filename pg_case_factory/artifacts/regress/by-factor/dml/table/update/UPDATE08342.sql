...
-- primary_obligation_id: UPDATE-EXT|08342|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_08342_tbl, update_08342_src, update_08342_ref CASCADE;
RESET ROLE;
...
UPDATE update_08342_tbl SET val = id WHERE id = 999;
-- primary-target-end
