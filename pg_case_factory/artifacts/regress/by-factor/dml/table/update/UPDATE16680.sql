...
-- primary_obligation_id: UPDATE-EXT|16680|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_16680_tbl, update_16680_src, update_16680_ref CASCADE;
RESET ROLE;
...
UPDATE update_16680_tbl AS u SET val = (SELECT val FROM update_16680_src) WHERE update_16680_no_such_col = 1;
-- primary-target-end
