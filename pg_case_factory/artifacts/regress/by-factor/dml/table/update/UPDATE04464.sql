...
-- primary_obligation_id: UPDATE-EXT|04464|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_04464_tbl, update_04464_src, update_04464_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_04464_tbl SET val = (SELECT val FROM update_04464_src) WHERE update_04464_no_such_col = 1;
-- primary-target-end
