...
-- primary_obligation_id: UPDATE-EXT|15060|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_15060_tbl, update_15060_src, update_15060_ref CASCADE;
RESET ROLE;
...
UPDATE update_15060_tbl SET val = 0 WHERE update_15060_no_such_col = 1;
-- primary-target-end
