...
-- primary_obligation_id: UPDATE-EXT|16620|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_16620_tbl, update_16620_src, update_16620_ref CASCADE;
RESET ROLE;
...
UPDATE "update_16620_tbl" SET val = (SELECT val FROM update_16620_src) WHERE update_16620_no_such_col = 1;
-- primary-target-end
