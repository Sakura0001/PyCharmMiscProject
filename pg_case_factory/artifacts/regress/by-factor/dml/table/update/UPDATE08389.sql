...
-- primary_obligation_id: UPDATE-EXT|08389|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_08389_tbl, update_08389_src, update_08389_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_08389_tbl SET val = id WHERE id = 999;
-- primary-target-end
