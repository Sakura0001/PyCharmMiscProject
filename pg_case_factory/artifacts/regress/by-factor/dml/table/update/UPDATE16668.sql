...
-- primary_obligation_id: UPDATE-EXT|16668|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_16668_tbl, update_16668_src, update_16668_ref CASCADE;
RESET ROLE;
...
UPDATE update_16668_tbl AS u SET val = (SELECT val FROM update_16668_src) WHERE update_16668_no_such_col = 1;
-- primary-target-end
