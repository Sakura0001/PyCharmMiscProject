...
-- primary_obligation_id: UPDATE-EXT|07092|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_07092_tbl, update_07092_src, update_07092_ref CASCADE;
RESET ROLE;
...
WITH update_07092_cte AS (SELECT 1 AS val)
UPDATE update_07092_tbl SET val = (SELECT val FROM update_07092_cte) WHERE id = 999;
-- primary-target-end
