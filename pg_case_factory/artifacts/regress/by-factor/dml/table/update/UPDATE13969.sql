...
-- primary_obligation_id: UPDATE-EXT|13969|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_13969_tbl, update_13969_src, update_13969_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_13969_tbl SET val = 1 WHERE update_13969_no_such_col = 1;
-- primary-target-end
