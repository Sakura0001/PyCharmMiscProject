...
-- primary_obligation_id: UPDATE-EXT|02820|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_02820_tbl, update_02820_src, update_02820_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_02820_tbl SET val = 0 WHERE update_02820_no_such_col = 1;
-- primary-target-end
