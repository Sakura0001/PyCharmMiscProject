...
-- primary_obligation_id: UPDATE-EXT|04212|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_04212_tbl, update_04212_src, update_04212_ref CASCADE;
RESET ROLE;
...
UPDATE update_04212_tbl SET val = (SELECT val FROM update_04212_src) WHERE update_04212_no_such_col = 1;
-- primary-target-end
