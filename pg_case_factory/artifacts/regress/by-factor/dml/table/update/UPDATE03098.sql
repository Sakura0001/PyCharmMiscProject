...
-- primary_obligation_id: UPDATE-EXT|03098|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_03098_tbl, update_03098_src, update_03098_ref CASCADE;
RESET ROLE;
...
UPDATE "update_03098_tbl" SET val = 0 WHERE update_03098_no_such_col = 1;
-- primary-target-end
