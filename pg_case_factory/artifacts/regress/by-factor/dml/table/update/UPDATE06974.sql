...
-- primary_obligation_id: UPDATE-EXT|06974|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_06974_tbl, update_06974_src, update_06974_ref CASCADE;
RESET ROLE;
...
WITH update_06974_cte AS (SELECT 1 AS val)
UPDATE update_06974_tbl AS u SET val = (SELECT val FROM update_06974_cte) WHERE id = 999;
-- primary-target-end
