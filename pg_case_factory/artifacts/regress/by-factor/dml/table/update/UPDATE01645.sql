...
-- primary_obligation_id: UPDATE-EXT|01645|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_01645_tbl, update_01645_src, update_01645_ref CASCADE;
RESET ROLE;
...
UPDATE "update_01645_tbl" SET val = 1 WHERE update_01645_no_such_col = 1;
-- primary-target-end
