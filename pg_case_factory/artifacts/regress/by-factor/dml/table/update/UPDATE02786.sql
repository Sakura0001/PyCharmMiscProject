...
-- primary_obligation_id: UPDATE-EXT|02786|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_02786_tbl, update_02786_src, update_02786_ref CASCADE;
RESET ROLE;
...
UPDATE update_02786_tbl SET val = 0 WHERE update_02786_no_such_col = 1;
-- primary-target-end
