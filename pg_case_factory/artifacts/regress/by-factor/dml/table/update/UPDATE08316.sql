...
-- primary_obligation_id: UPDATE-EXT|08316|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_08316_tbl, update_08316_src, update_08316_ref CASCADE;
RESET ROLE;
...
UPDATE update_08316_tbl AS u SET val = id WHERE id = 999;
-- primary-target-end
