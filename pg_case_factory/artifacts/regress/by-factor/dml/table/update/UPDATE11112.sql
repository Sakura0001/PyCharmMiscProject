...
-- primary_obligation_id: UPDATE-EXT|11112|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_11112_tbl, update_11112_src, update_11112_ref CASCADE;
RESET ROLE;
...
UPDATE update_11112_tbl AS u SET val = (SELECT val FROM update_11112_src) WHERE id = 999;
-- primary-target-end
