...
-- primary_obligation_id: UPDATE-EXT|08492|effect_query|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_08492_tbl, update_08492_src, update_08492_ref CASCADE;
RESET ROLE;
...
SELECT count(*) = 0 AS effect_state FROM pg_catalog.pg_class WHERE relname = 'update_08492_tbl' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
DROP TABLE IF EXISTS update_08492_tbl, update_08492_src, update_08492_ref CASCADE;
