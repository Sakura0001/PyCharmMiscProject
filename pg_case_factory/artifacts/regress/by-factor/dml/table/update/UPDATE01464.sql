...
-- primary_obligation_id: UPDATE-EXT|01464|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_01464_tbl, update_01464_src, update_01464_ref CASCADE;
RESET ROLE;
...
UPDATE "update_01464_tbl" SET val = id WHERE update_01464_no_such_col = 1;
-- primary-target-end
