...
-- primary_obligation_id: UPDATE-EXT|01730|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_01730_tbl, update_01730_src, update_01730_ref CASCADE;
RESET ROLE;
...
UPDATE update_01730_tbl SET val = (SELECT 1) WHERE update_01730_no_such_col = 1;
-- primary-target-end
