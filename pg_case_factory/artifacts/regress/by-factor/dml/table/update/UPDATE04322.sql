...
-- primary_obligation_id: UPDATE-EXT|04322|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_04322_tbl, update_04322_src, update_04322_ref CASCADE;
RESET ROLE;
...
UPDATE update_04322_tbl SET val = (SELECT val FROM update_04322_src) WHERE update_04322_no_such_col = 1;
-- primary-target-end
