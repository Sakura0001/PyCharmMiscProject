...
-- primary_obligation_id: UPDATE-EXT|13692|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_13692_tbl, update_13692_src, update_13692_ref CASCADE;
RESET ROLE;
...
UPDATE update_13692_tbl AS u SET val = id WHERE update_13692_no_such_col = 1;
-- primary-target-end
