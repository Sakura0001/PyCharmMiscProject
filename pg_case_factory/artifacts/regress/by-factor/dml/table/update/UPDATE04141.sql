...
-- primary_obligation_id: UPDATE-EXT|04141|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_04141_tbl, update_04141_src, update_04141_ref CASCADE;
RESET ROLE;
...
UPDATE "update_04141_tbl" SET val = (SELECT val FROM update_04141_src) WHERE update_04141_no_such_col = 1;
-- primary-target-end
