...
-- primary_obligation_id: UPDATE-EXT|13970|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_13970_tbl, update_13970_src, update_13970_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_13970_tbl SET val = 1 WHERE update_13970_no_such_col = 1;
-- primary-target-end
