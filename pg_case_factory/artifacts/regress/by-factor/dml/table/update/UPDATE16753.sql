...
-- primary_obligation_id: UPDATE-EXT|16753|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_16753_tbl, update_16753_src, update_16753_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_16753_tbl SET val = (SELECT val FROM update_16753_src) WHERE update_16753_no_such_col = 1;
-- primary-target-end
