...
-- primary_obligation_id: UPDATE-EXT|08690|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_08690_tbl, update_08690_src, update_08690_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_08690_tbl SET val = (SELECT 1) WHERE id = 999;
-- primary-target-end
