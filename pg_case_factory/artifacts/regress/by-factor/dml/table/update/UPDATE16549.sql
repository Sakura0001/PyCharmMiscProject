...
-- primary_obligation_id: UPDATE-EXT|16549|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_16549_tbl, update_16549_src, update_16549_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_16549_tbl SET val = (SELECT val FROM update_16549_src) WHERE update_16549_no_such_col = 1;
-- primary-target-end
