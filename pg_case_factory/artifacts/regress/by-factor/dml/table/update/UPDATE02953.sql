...
-- primary_obligation_id: UPDATE-EXT|02953|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_02953_tbl, update_02953_src, update_02953_ref CASCADE;
RESET ROLE;
...
UPDATE update_02953_tbl AS u SET val = 0 WHERE update_02953_no_such_col = 1;
-- primary-target-end
