...
-- primary_obligation_id: UPDATE-EXT|16670|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_16670_tbl, update_16670_src, update_16670_ref CASCADE;
RESET ROLE;
...
UPDATE update_16670_tbl AS u SET val = (SELECT val FROM update_16670_src) WHERE update_16670_no_such_col = 1;
-- primary-target-end
