...
-- primary_obligation_id: UPDATE-EXT|13860|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_13860_tbl, update_13860_src, update_13860_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_13860_tbl SET val = abs(1) WHERE update_13860_no_such_col = 1;
-- primary-target-end
