...
-- primary_obligation_id: UPDATE-EXT|01418|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_01418_tbl, update_01418_src, update_01418_ref CASCADE;
RESET ROLE;
...
UPDATE update_01418_tbl AS u SET val = id WHERE update_01418_no_such_col = 1;
-- primary-target-end
