...
-- primary_obligation_id: UPDATE-EXT|08581|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_08581_tbl, update_08581_src, update_08581_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_08581_tbl SET val = 1 WHERE id = 999;
-- primary-target-end
