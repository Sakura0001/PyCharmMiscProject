...
-- primary_obligation_id: UPDATE-EXT|16646|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_16646_tbl, update_16646_src, update_16646_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_16646_tbl SET val = (SELECT val FROM update_16646_src) WHERE update_16646_no_such_col = 1;
-- primary-target-end
