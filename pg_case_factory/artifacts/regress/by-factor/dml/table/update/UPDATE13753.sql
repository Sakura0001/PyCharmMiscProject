...
-- primary_obligation_id: UPDATE-EXT|13753|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_13753_tbl, update_13753_src, update_13753_ref CASCADE;
RESET ROLE;
...
UPDATE "update_13753_tbl" SET val = id WHERE update_13753_no_such_col = 1;
-- primary-target-end
