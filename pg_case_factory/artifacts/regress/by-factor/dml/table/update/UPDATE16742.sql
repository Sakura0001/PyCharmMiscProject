...
-- primary_obligation_id: UPDATE-EXT|16742|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_16742_tbl, update_16742_src, update_16742_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_16742_tbl SET val = (SELECT val FROM update_16742_src) WHERE update_16742_no_such_col = 1;
-- primary-target-end
