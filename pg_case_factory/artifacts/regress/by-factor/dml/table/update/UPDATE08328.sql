...
-- primary_obligation_id: UPDATE-EXT|08328|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_08328_tbl, update_08328_src, update_08328_ref CASCADE;
RESET ROLE;
...
UPDATE update_08328_tbl AS u SET val = id WHERE id = 999;
-- primary-target-end
