...
-- primary_obligation_id: UPDATE-EXT|04226|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_04226_tbl, update_04226_src, update_04226_ref CASCADE;
RESET ROLE;
...
UPDATE update_04226_tbl SET val = (SELECT val FROM update_04226_src) WHERE update_04226_no_such_col = 1;
-- primary-target-end
