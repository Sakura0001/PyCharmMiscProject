...
-- primary_obligation_id: UPDATE-EXT|14040|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_14040_tbl, update_14040_src, update_14040_ref CASCADE;
RESET ROLE;
...
UPDATE "update_14040_tbl" SET val = (SELECT 1) WHERE update_14040_no_such_col = 1;
-- primary-target-end
