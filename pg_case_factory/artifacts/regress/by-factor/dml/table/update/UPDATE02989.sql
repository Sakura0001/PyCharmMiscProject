...
-- primary_obligation_id: UPDATE-EXT|02989|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_02989_tbl, update_02989_src, update_02989_ref CASCADE;
RESET ROLE;
...
UPDATE "update_02989_tbl" SET val = 0 WHERE update_02989_no_such_col = 1;
-- primary-target-end
