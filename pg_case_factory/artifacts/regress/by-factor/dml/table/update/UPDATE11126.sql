...
-- primary_obligation_id: UPDATE-EXT|11126|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_11126_tbl, update_11126_src, update_11126_ref CASCADE;
RESET ROLE;
...
UPDATE update_11126_tbl SET val = (SELECT val FROM update_11126_src) WHERE id = 999;
-- primary-target-end
