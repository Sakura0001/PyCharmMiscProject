...
-- primary_obligation_id: UPDATE-EXT|06973|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_06973_tbl, update_06973_src, update_06973_ref CASCADE;
RESET ROLE;
...
WITH update_06973_cte AS (SELECT 1 AS val)
UPDATE update_06973_tbl AS u SET val = (SELECT val FROM update_06973_cte) WHERE id = 999;
-- primary-target-end
