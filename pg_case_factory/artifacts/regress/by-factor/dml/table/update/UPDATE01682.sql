...
-- primary_obligation_id: UPDATE-EXT|01682|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_01682_tbl, update_01682_src, update_01682_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_01682_tbl SET val = 1 WHERE update_01682_no_such_col = 1;
-- primary-target-end
