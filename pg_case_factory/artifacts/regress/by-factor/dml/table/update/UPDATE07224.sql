...
-- primary_obligation_id: UPDATE-EXT|07224|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_07224_tbl, update_07224_src, update_07224_ref CASCADE;
RESET ROLE;
...
WITH update_07224_cte AS (SELECT 1 AS val)
UPDATE "update_07224_tbl" SET val = (SELECT val FROM update_07224_cte) WHERE id = 999;
-- primary-target-end
