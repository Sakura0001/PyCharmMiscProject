...
-- primary_obligation_id: UPDATE-EXT|14065|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_14065_tbl, update_14065_src, update_14065_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_14065_tbl SET val = (SELECT 1) WHERE update_14065_no_such_col = 1;
-- primary-target-end
