...
-- primary_obligation_id: UPDATE-EXT|04224|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_04224_tbl, update_04224_src, update_04224_ref CASCADE;
RESET ROLE;
...
UPDATE update_04224_tbl SET val = (SELECT val FROM update_04224_src) WHERE update_04224_no_such_col = 1;
-- primary-target-end
