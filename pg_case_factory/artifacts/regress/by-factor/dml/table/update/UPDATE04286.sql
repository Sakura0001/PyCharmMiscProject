...
-- primary_obligation_id: UPDATE-EXT|04286|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_04286_tbl, update_04286_src, update_04286_ref CASCADE;
RESET ROLE;
...
UPDATE update_04286_tbl AS u SET val = (SELECT val FROM update_04286_src) WHERE update_04286_no_such_col = 1;
-- primary-target-end
