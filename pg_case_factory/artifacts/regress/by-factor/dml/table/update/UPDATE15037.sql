...
-- primary_obligation_id: UPDATE-EXT|15037|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_15037_tbl, update_15037_src, update_15037_ref CASCADE;
RESET ROLE;
...
UPDATE update_15037_tbl AS u SET val = 0 WHERE update_15037_no_such_col = 1;
-- primary-target-end
