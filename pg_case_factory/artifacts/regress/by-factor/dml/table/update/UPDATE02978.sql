...
-- primary_obligation_id: UPDATE-EXT|02978|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_02978_tbl, update_02978_src, update_02978_ref CASCADE;
RESET ROLE;
...
UPDATE update_02978_tbl SET val = 0 WHERE update_02978_no_such_col = 1;
-- primary-target-end
