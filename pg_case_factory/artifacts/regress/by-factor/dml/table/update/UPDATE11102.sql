...
-- primary_obligation_id: UPDATE-EXT|11102|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_11102_tbl, update_11102_src, update_11102_ref CASCADE;
RESET ROLE;
...
UPDATE update_11102_tbl AS u SET val = (SELECT val FROM update_11102_src) WHERE id = 999;
-- primary-target-end
