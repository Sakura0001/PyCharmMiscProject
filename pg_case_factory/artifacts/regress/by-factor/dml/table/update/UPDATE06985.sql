...
-- primary_obligation_id: UPDATE-EXT|06985|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_06985_tbl, update_06985_src, update_06985_ref CASCADE;
RESET ROLE;
...
WITH update_06985_cte AS (SELECT 1 AS val)
UPDATE update_06985_tbl AS u SET val = (SELECT val FROM update_06985_cte) WHERE id = 999;
-- primary-target-end
