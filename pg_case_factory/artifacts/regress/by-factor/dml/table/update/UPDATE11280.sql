...
-- primary_obligation_id: UPDATE-EXT|11280|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_11280_tbl, update_11280_src, update_11280_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_11280_tbl SET val = (SELECT val FROM update_11280_src) WHERE id = 999;
-- primary-target-end
