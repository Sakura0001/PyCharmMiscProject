...
-- primary_obligation_id: UPDATE-EXT|13920|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_13920_tbl, update_13920_src, update_13920_ref CASCADE;
RESET ROLE;
...
UPDATE update_13920_tbl SET val = 1 WHERE update_13920_no_such_col = 1;
-- primary-target-end
