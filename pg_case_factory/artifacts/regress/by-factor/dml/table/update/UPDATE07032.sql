...
-- primary_obligation_id: UPDATE-EXT|07032|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_07032_tbl, update_07032_src, update_07032_ref CASCADE;
RESET ROLE;
...
WITH update_07032_cte AS (SELECT 1 AS val)
UPDATE "update_07032_tbl" SET val = (SELECT val FROM update_07032_cte) WHERE id = 999;
-- primary-target-end
