...
-- primary_obligation_id: UPDATE-EXT|08461|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_08461_tbl, update_08461_src, update_08461_ref CASCADE;
RESET ROLE;
...
UPDATE "update_08461_tbl" SET val = abs(1) WHERE id = 999;
-- primary-target-end
