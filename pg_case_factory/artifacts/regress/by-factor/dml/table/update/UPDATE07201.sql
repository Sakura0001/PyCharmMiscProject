...
-- primary_obligation_id: UPDATE-EXT|07201|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_07201_tbl, update_07201_src, update_07201_ref CASCADE;
RESET ROLE;
...
WITH update_07201_cte AS (SELECT 1 AS val)
UPDATE update_07201_tbl SET val = (SELECT val FROM update_07201_cte) WHERE id = 999;
-- primary-target-end
