...
-- primary_obligation_id: UPDATE-EXT|07272|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_07272_tbl, update_07272_src, update_07272_ref CASCADE;
RESET ROLE;
...
WITH update_07272_cte AS (SELECT 1 AS val)
UPDATE update_07272_tbl AS u SET val = (SELECT val FROM update_07272_cte) WHERE id = 999;
-- primary-target-end
