...
-- primary_obligation_id: UPDATE-EXT|08498|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_08498_tbl, update_08498_src, update_08498_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_08498_tbl SET val = abs(1) WHERE id = 999;
-- primary-target-end
