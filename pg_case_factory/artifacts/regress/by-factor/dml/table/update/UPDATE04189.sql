...
-- primary_obligation_id: UPDATE-EXT|04189|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_04189_tbl, update_04189_src, update_04189_ref CASCADE;
RESET ROLE;
...
UPDATE update_04189_tbl AS u SET val = (SELECT val FROM update_04189_src) WHERE update_04189_no_such_col = 1;
-- primary-target-end
