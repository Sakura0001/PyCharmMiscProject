...
-- primary_obligation_id: UPDATE-EXT|13764|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_13764_tbl, update_13764_src, update_13764_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_13764_tbl SET val = id WHERE update_13764_no_such_col = 1;
-- primary-target-end
