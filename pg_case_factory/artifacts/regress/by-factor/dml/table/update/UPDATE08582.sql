...
-- primary_obligation_id: UPDATE-EXT|08582|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_08582_tbl, update_08582_src, update_08582_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_08582_tbl SET val = 1 WHERE id = 999;
-- primary-target-end
