...
-- primary_obligation_id: UPDATE-EXT|14064|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_14064_tbl, update_14064_src, update_14064_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_14064_tbl SET val = (SELECT 1) WHERE update_14064_no_such_col = 1;
-- primary-target-end
