...
-- primary_obligation_id: UPDATE-EXT|01572|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_01572_tbl, update_01572_src, update_01572_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_01572_tbl SET val = abs(1) WHERE update_01572_no_such_col = 1;
-- primary-target-end
