...
-- primary_obligation_id: UPDATE-EXT|01621|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_01621_tbl, update_01621_src, update_01621_ref CASCADE;
RESET ROLE;
...
UPDATE update_01621_tbl SET val = 1 WHERE update_01621_no_such_col = 1;
-- primary-target-end
