...
-- primary_obligation_id: UPDATE-EXT|07093|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_07093_tbl, update_07093_src, update_07093_ref CASCADE;
RESET ROLE;
...
WITH update_07093_cte AS (SELECT 1 AS val)
UPDATE update_07093_tbl SET val = (SELECT val FROM update_07093_cte) WHERE id = 999;
-- primary-target-end
