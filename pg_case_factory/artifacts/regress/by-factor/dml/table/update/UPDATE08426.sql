...
-- primary_obligation_id: UPDATE-EXT|08426|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_08426_tbl, update_08426_src, update_08426_ref CASCADE;
RESET ROLE;
...
UPDATE update_08426_tbl AS u SET val = abs(1) WHERE id = 999;
-- primary-target-end
