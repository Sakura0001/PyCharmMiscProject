...
-- primary_obligation_id: UPDATE-EXT|06996|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_06996_tbl, update_06996_src, update_06996_ref CASCADE;
RESET ROLE;
...
WITH update_06996_cte AS (SELECT 1 AS val)
UPDATE update_06996_tbl SET val = (SELECT val FROM update_06996_cte) WHERE id = 999;
-- primary-target-end
