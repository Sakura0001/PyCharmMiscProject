...
-- primary_obligation_id: UPDATE-EXT|16452|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_16452_tbl, update_16452_src, update_16452_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_16452_tbl SET val = (SELECT val FROM update_16452_src) WHERE update_16452_no_such_col = 1;
-- primary-target-end
