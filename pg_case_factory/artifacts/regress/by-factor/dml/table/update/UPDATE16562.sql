...
-- primary_obligation_id: UPDATE-EXT|16562|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_16562_tbl, update_16562_src, update_16562_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_16562_tbl SET val = (SELECT val FROM update_16562_src) WHERE update_16562_no_such_col = 1;
-- primary-target-end
