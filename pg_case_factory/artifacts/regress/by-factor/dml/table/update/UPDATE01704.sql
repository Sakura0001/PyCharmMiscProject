...
-- primary_obligation_id: UPDATE-EXT|01704|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_01704_tbl, update_01704_src, update_01704_ref CASCADE;
RESET ROLE;
...
UPDATE update_01704_tbl AS u SET val = (SELECT 1) WHERE update_01704_no_such_col = 1;
-- primary-target-end
