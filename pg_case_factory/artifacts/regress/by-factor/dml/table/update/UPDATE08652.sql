...
-- primary_obligation_id: UPDATE-EXT|08652|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_08652_tbl, update_08652_src, update_08652_ref CASCADE;
RESET ROLE;
...
UPDATE "update_08652_tbl" SET val = (SELECT 1) WHERE id = 999;
-- primary-target-end
