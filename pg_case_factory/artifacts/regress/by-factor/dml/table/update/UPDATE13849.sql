...
-- primary_obligation_id: UPDATE-EXT|13849|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_13849_tbl, update_13849_src, update_13849_ref CASCADE;
RESET ROLE;
...
UPDATE "update_13849_tbl" SET val = abs(1) WHERE update_13849_no_such_col = 1;
-- primary-target-end
