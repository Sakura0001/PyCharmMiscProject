...
-- primary_obligation_id: UPDATE-EXT|06984|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_06984_tbl, update_06984_src, update_06984_ref CASCADE;
RESET ROLE;
...
WITH update_06984_cte AS (SELECT 1 AS val)
UPDATE update_06984_tbl AS u SET val = (SELECT val FROM update_06984_cte) WHERE id = 999;
-- primary-target-end
