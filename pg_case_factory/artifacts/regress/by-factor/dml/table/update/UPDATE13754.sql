...
-- primary_obligation_id: UPDATE-EXT|13754|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_13754_tbl, update_13754_src, update_13754_ref CASCADE;
RESET ROLE;
...
UPDATE "update_13754_tbl" SET val = id WHERE update_13754_no_such_col = 1;
-- primary-target-end
