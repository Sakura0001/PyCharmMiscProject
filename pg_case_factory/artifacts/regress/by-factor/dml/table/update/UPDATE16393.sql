...
-- primary_obligation_id: UPDATE-EXT|16393|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_16393_tbl, update_16393_src, update_16393_ref CASCADE;
RESET ROLE;
...
UPDATE update_16393_tbl AS u SET val = (SELECT val FROM update_16393_src) WHERE update_16393_no_such_col = 1;
-- primary-target-end
