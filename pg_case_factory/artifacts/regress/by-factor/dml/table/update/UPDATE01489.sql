...
-- primary_obligation_id: UPDATE-EXT|01489|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_01489_tbl, update_01489_src, update_01489_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_01489_tbl SET val = id WHERE update_01489_no_such_col = 1;
-- primary-target-end
