...
-- primary_obligation_id: UPDATE-EXT|14053|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_14053_tbl, update_14053_src, update_14053_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_14053_tbl SET val = (SELECT 1) WHERE update_14053_no_such_col = 1;
-- primary-target-end
