...
-- primary_obligation_id: UPDATE-EXT|09768|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_09768_tbl, update_09768_src, update_09768_ref CASCADE;
RESET ROLE;
...
UPDATE update_09768_tbl AS u SET val = 0 WHERE id = 999;
-- primary-target-end
