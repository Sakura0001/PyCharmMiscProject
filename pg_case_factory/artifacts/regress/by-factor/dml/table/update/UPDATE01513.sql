...
-- primary_obligation_id: UPDATE-EXT|01513|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_01513_tbl, update_01513_src, update_01513_ref CASCADE;
RESET ROLE;
...
UPDATE update_01513_tbl AS u SET val = abs(1) WHERE update_01513_no_such_col = 1;
-- primary-target-end
