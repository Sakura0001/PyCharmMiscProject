...
-- primary_obligation_id: UPDATE-EXT|15312|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_15312_tbl, update_15312_src, update_15312_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_15312_tbl SET val = 0 WHERE update_15312_no_such_col = 1;
-- primary-target-end
