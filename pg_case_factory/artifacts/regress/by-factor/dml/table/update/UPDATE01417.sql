...
-- primary_obligation_id: UPDATE-EXT|01417|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_01417_tbl, update_01417_src, update_01417_ref CASCADE;
RESET ROLE;
...
UPDATE update_01417_tbl AS u SET val = id WHERE update_01417_no_such_col = 1;
-- primary-target-end
