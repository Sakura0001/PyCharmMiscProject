...
-- primary_obligation_id: UPDATE-EXT|04356|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_04356_tbl, update_04356_src, update_04356_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_04356_tbl SET val = (SELECT val FROM update_04356_src) WHERE update_04356_no_such_col = 1;
-- primary-target-end
