...
-- primary_obligation_id: UPDATE-EXT|09925|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_09925_tbl, update_09925_src, update_09925_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_09925_tbl SET val = 0 WHERE id = 999;
-- primary-target-end
