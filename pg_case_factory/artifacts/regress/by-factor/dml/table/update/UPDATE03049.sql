...
-- primary_obligation_id: UPDATE-EXT|03049|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_03049_tbl, update_03049_src, update_03049_ref CASCADE;
RESET ROLE;
...
UPDATE update_03049_tbl AS u SET val = 0 WHERE update_03049_no_such_col = 1;
-- primary-target-end
