...
-- primary_obligation_id: UPDATE-EXT|01705|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_01705_tbl, update_01705_src, update_01705_ref CASCADE;
RESET ROLE;
...
UPDATE update_01705_tbl AS u SET val = (SELECT 1) WHERE update_01705_no_such_col = 1;
-- primary-target-end
