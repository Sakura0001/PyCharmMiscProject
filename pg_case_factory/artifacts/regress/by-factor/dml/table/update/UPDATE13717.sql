...
-- primary_obligation_id: UPDATE-EXT|13717|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_13717_tbl, update_13717_src, update_13717_ref CASCADE;
RESET ROLE;
...
UPDATE update_13717_tbl SET val = id WHERE update_13717_no_such_col = 1;
-- primary-target-end
