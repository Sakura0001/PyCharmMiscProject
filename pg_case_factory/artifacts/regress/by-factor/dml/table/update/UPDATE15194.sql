...
-- primary_obligation_id: UPDATE-EXT|15194|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_15194_tbl, update_15194_src, update_15194_ref CASCADE;
RESET ROLE;
...
UPDATE "update_15194_tbl" SET val = 0 WHERE update_15194_no_such_col = 1;
-- primary-target-end
