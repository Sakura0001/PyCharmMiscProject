...
-- primary_obligation_id: UPDATE-EXT|16429|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_16429_tbl, update_16429_src, update_16429_ref CASCADE;
RESET ROLE;
...
UPDATE "update_16429_tbl" SET val = (SELECT val FROM update_16429_src) WHERE update_16429_no_such_col = 1;
-- primary-target-end
