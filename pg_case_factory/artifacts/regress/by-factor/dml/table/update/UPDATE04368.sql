...
-- primary_obligation_id: UPDATE-EXT|04368|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_04368_tbl, update_04368_src, update_04368_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_04368_tbl SET val = (SELECT val FROM update_04368_src) WHERE update_04368_no_such_col = 1;
-- primary-target-end
