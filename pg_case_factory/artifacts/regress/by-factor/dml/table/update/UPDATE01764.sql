...
-- primary_obligation_id: UPDATE-EXT|01764|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_01764_tbl, update_01764_src, update_01764_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_01764_tbl SET val = (SELECT 1) WHERE update_01764_no_such_col = 1;
-- primary-target-end
