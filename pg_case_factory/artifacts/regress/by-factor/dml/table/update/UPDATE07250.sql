...
-- primary_obligation_id: UPDATE-EXT|07250|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_07250_tbl, update_07250_src, update_07250_ref CASCADE;
RESET ROLE;
...
WITH update_07250_cte AS (SELECT 1 AS val)
UPDATE public.update_07250_tbl SET val = (SELECT val FROM update_07250_cte) WHERE id = 999;
-- primary-target-end
