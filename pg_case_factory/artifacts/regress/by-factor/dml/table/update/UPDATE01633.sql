...
-- primary_obligation_id: UPDATE-EXT|01633|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_01633_tbl, update_01633_src, update_01633_ref CASCADE;
RESET ROLE;
...
UPDATE update_01633_tbl SET val = 1 WHERE update_01633_no_such_col = 1;
-- primary-target-end
