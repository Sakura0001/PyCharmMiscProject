...
-- primary_obligation_id: UPDATE-EXT|04200|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_04200_tbl, update_04200_src, update_04200_ref CASCADE;
RESET ROLE;
...
UPDATE update_04200_tbl AS u SET val = (SELECT val FROM update_04200_src) WHERE update_04200_no_such_col = 1;
-- primary-target-end
