...
-- primary_obligation_id: UPDATE-EXT|11185|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_11185_tbl, update_11185_src, update_11185_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_11185_tbl SET val = (SELECT val FROM update_11185_src) WHERE id = 999;
-- primary-target-end
