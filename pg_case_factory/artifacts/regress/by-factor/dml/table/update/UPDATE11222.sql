...
-- primary_obligation_id: UPDATE-EXT|11222|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_11222_tbl, update_11222_src, update_11222_ref CASCADE;
RESET ROLE;
...
UPDATE update_11222_tbl SET val = (SELECT val FROM update_11222_src) WHERE id = 999;
-- primary-target-end
