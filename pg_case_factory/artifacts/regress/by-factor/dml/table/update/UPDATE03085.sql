...
-- primary_obligation_id: UPDATE-EXT|03085|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_03085_tbl, update_03085_src, update_03085_ref CASCADE;
RESET ROLE;
...
UPDATE "update_03085_tbl" SET val = 0 WHERE update_03085_no_such_col = 1;
-- primary-target-end
