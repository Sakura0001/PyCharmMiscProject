...
-- primary_obligation_id: UPDATE-EXT|07105|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_07105_tbl, update_07105_src, update_07105_ref CASCADE;
RESET ROLE;
...
WITH update_07105_cte AS (SELECT 1 AS val)
UPDATE update_07105_tbl SET val = (SELECT val FROM update_07105_cte) WHERE id = 999;
-- primary-target-end
