...
-- primary_obligation_id: UPDATE-EXT|01478|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_01478_tbl, update_01478_src, update_01478_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_01478_tbl SET val = id WHERE update_01478_no_such_col = 1;
-- primary-target-end
