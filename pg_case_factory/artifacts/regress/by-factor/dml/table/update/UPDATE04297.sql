...
-- primary_obligation_id: UPDATE-EXT|04297|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_04297_tbl, update_04297_src, update_04297_ref CASCADE;
RESET ROLE;
...
UPDATE update_04297_tbl AS u SET val = (SELECT val FROM update_04297_src) WHERE update_04297_no_such_col = 1;
-- primary-target-end
