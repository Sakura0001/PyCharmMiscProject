...
-- primary_obligation_id: UPDATE-EXT|06972|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_06972_tbl, update_06972_src, update_06972_ref CASCADE;
RESET ROLE;
...
WITH update_06972_cte AS (SELECT 1 AS val)
UPDATE update_06972_tbl AS u SET val = (SELECT val FROM update_06972_cte) WHERE id = 999;
-- primary-target-end
