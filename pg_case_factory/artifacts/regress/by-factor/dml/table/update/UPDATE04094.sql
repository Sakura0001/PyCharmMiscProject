...
-- primary_obligation_id: UPDATE-EXT|04094|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_04094_tbl, update_04094_src, update_04094_ref CASCADE;
RESET ROLE;
...
UPDATE update_04094_tbl AS u SET val = (SELECT val FROM update_04094_src) WHERE update_04094_no_such_col = 1;
-- primary-target-end
