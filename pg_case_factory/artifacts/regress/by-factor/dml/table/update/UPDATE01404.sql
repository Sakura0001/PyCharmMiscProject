...
-- primary_obligation_id: UPDATE-EXT|01404|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_01404_tbl, update_01404_src, update_01404_ref CASCADE;
RESET ROLE;
...
UPDATE update_01404_tbl AS u SET val = id WHERE update_01404_no_such_col = 1;
-- primary-target-end
