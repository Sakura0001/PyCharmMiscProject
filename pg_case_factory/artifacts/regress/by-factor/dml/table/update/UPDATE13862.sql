...
-- primary_obligation_id: UPDATE-EXT|13862|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_13862_tbl, update_13862_src, update_13862_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_13862_tbl SET val = abs(1) WHERE update_13862_no_such_col = 1;
-- primary-target-end
