...
-- primary_obligation_id: UPDATE-EXT|02881|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_02881_tbl, update_02881_src, update_02881_ref CASCADE;
RESET ROLE;
...
UPDATE update_02881_tbl SET val = 0 WHERE update_02881_no_such_col = 1;
-- primary-target-end
