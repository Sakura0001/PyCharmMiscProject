...
-- primary_obligation_id: UPDATE-EXT|08317|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_08317_tbl, update_08317_src, update_08317_ref CASCADE;
RESET ROLE;
...
UPDATE update_08317_tbl AS u SET val = id WHERE id = 999;
-- primary-target-end
