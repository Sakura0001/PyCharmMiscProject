...
-- primary_obligation_id: UPDATE-EXT|13693|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_13693_tbl, update_13693_src, update_13693_ref CASCADE;
RESET ROLE;
...
UPDATE update_13693_tbl AS u SET val = id WHERE update_13693_no_such_col = 1;
-- primary-target-end
