...
-- primary_obligation_id: UPDATE-EXT|03110|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_03110_tbl, update_03110_src, update_03110_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_03110_tbl SET val = 0 WHERE update_03110_no_such_col = 1;
-- primary-target-end
