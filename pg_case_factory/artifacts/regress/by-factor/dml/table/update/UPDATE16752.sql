...
-- primary_obligation_id: UPDATE-EXT|16752|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_16752_tbl, update_16752_src, update_16752_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_16752_tbl SET val = (SELECT val FROM update_16752_src) WHERE update_16752_no_such_col = 1;
-- primary-target-end
