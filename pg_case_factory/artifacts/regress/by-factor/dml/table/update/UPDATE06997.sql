...
-- primary_obligation_id: UPDATE-EXT|06997|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_06997_tbl, update_06997_src, update_06997_ref CASCADE;
RESET ROLE;
...
WITH update_06997_cte AS (SELECT 1 AS val)
UPDATE update_06997_tbl SET val = (SELECT val FROM update_06997_cte) WHERE id = 999;
-- primary-target-end
