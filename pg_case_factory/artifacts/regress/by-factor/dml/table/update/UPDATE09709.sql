...
-- primary_obligation_id: UPDATE-EXT|09709|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_09709_tbl, update_09709_src, update_09709_ref CASCADE;
RESET ROLE;
...
UPDATE "update_09709_tbl" SET val = 0 WHERE id = 999;
-- primary-target-end
