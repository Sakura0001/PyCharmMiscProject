...
-- primary_obligation_id: UPDATE-EXT|03048|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_03048_tbl, update_03048_src, update_03048_ref CASCADE;
RESET ROLE;
...
UPDATE update_03048_tbl AS u SET val = 0 WHERE update_03048_no_such_col = 1;
-- primary-target-end
