...
-- primary_obligation_id: UPDATE-EXT|13740|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_13740_tbl, update_13740_src, update_13740_ref CASCADE;
RESET ROLE;
...
UPDATE "update_13740_tbl" SET val = id WHERE update_13740_no_such_col = 1;
-- primary-target-end
