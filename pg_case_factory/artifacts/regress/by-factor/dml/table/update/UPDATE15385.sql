...
-- primary_obligation_id: UPDATE-EXT|15385|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_15385_tbl, update_15385_src, update_15385_ref CASCADE;
RESET ROLE;
...
UPDATE "update_15385_tbl" SET val = 0 WHERE update_15385_no_such_col = 1;
-- primary-target-end
