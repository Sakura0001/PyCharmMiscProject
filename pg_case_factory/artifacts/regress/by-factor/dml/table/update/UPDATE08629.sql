...
-- primary_obligation_id: UPDATE-EXT|08629|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_08629_tbl, update_08629_src, update_08629_ref CASCADE;
RESET ROLE;
...
UPDATE update_08629_tbl SET val = (SELECT 1) WHERE id = 999;
-- primary-target-end
