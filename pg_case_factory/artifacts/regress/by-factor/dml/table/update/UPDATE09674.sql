...
-- primary_obligation_id: UPDATE-EXT|09674|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_09674_tbl, update_09674_src, update_09674_ref CASCADE;
RESET ROLE;
...
UPDATE update_09674_tbl AS u SET val = 0 WHERE id = 999;
-- primary-target-end
