...
-- primary_obligation_id: UPDATE-EXT|07046|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_07046_tbl, update_07046_src, update_07046_ref CASCADE;
RESET ROLE;
...
WITH update_07046_cte AS (SELECT 1 AS val)
UPDATE public.update_07046_tbl SET val = (SELECT val FROM update_07046_cte) WHERE id = 999;
-- primary-target-end
