...
-- primary_obligation_id: UPDATE-EXT|04441|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_04441_tbl, update_04441_src, update_04441_ref CASCADE;
RESET ROLE;
...
UPDATE "update_04441_tbl" SET val = (SELECT val FROM update_04441_src) WHERE update_04441_no_such_col = 1;
-- primary-target-end
