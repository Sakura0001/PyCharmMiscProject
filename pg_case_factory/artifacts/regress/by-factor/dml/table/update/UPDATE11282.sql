...
-- primary_obligation_id: UPDATE-EXT|11282|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_11282_tbl, update_11282_src, update_11282_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_11282_tbl SET val = (SELECT val FROM update_11282_src) WHERE id = 999;
-- primary-target-end
