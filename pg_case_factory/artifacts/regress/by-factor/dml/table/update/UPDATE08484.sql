...
-- primary_obligation_id: UPDATE-EXT|08484|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_08484_tbl, update_08484_src, update_08484_ref CASCADE;
RESET ROLE;
...
UPDATE public.update_08484_tbl SET val = abs(1) WHERE id = 999;
-- primary-target-end
