...
-- primary_obligation_id: UPDATE-EXT|13741|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS update_13741_tbl, update_13741_src, update_13741_ref CASCADE;
RESET ROLE;
...
UPDATE "update_13741_tbl" SET val = id WHERE update_13741_no_such_col = 1;
-- primary-target-end
