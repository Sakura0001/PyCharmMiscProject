...
-- primary_obligation_id: DELETE-EXT|12649|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_12649_tbl, delete_12649_src, delete_12649_ref CASCADE;
RESET ROLE;
...
WITH delete_12649_cte AS (SELECT 1 AS val)
DELETE FROM delete_12649_tbl AS d WHERE delete_12649_no_such_col = 1;
-- primary-target-end
