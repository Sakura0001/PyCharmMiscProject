...
-- primary_obligation_id: DELETE-EXT|15409|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_15409_tbl, delete_15409_src, delete_15409_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_15409_tbl WHERE delete_15409_no_such_col = 1;
-- primary-target-end
