...
-- primary_obligation_id: DELETE-EXT|01730|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_01730_tbl, delete_01730_src, delete_01730_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_01730_tbl WHERE delete_01730_no_such_col = 1;
-- primary-target-end
