...
-- primary_obligation_id: DELETE-EXT|02940|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_02940_tbl, delete_02940_src, delete_02940_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_02940_tbl AS d WHERE delete_02940_no_such_col = 1;
-- primary-target-end
