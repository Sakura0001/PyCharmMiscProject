...
-- primary_obligation_id: DELETE-EXT|06985|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_06985_tbl, delete_06985_src, delete_06985_ref CASCADE;
RESET ROLE;
...
WITH delete_06985_cte AS (SELECT 1 AS val)
DELETE FROM delete_06985_tbl AS d WHERE id = 999;
-- primary-target-end
