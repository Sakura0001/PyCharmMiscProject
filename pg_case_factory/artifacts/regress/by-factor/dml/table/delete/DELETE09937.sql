...
-- primary_obligation_id: DELETE-EXT|09937|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_09937_tbl, delete_09937_src, delete_09937_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_09937_tbl WHERE id = 999;
-- primary-target-end
