...
-- primary_obligation_id: DELETE-EXT|00422|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_00422_tbl, delete_00422_src, delete_00422_ref CASCADE;
RESET ROLE;
...
WITH delete_00422_cte AS (SELECT 1 AS val)
DELETE FROM public.delete_00422_tbl WHERE delete_00422_no_such_col = 1;
-- primary-target-end
