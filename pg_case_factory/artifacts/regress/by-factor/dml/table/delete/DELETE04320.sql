...
-- primary_obligation_id: DELETE-EXT|04320|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_04320_tbl, delete_04320_src, delete_04320_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_04320_tbl WHERE delete_04320_no_such_col = 1;
-- primary-target-end
