...
-- primary_obligation_id: DELETE-EXT|14040|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_14040_tbl, delete_14040_src, delete_14040_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_14040_tbl" WHERE delete_14040_no_such_col = 1;
-- primary-target-end
