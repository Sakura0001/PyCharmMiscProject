...
-- primary_obligation_id: DELETE-EXT|02905|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_02905_tbl, delete_02905_src, delete_02905_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_02905_tbl" WHERE delete_02905_no_such_col = 1;
-- primary-target-end
