...
-- primary_obligation_id: DELETE-EXT|16718|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_16718_tbl, delete_16718_src, delete_16718_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_16718_tbl" WHERE delete_16718_no_such_col = 1;
-- primary-target-end
