...
-- primary_obligation_id: DELETE-EXT|07284|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_07284_tbl, delete_07284_src, delete_07284_ref CASCADE;
RESET ROLE;
...
WITH delete_07284_cte AS (SELECT 1 AS val)
DELETE FROM delete_07284_tbl WHERE id = 999;
-- primary-target-end
