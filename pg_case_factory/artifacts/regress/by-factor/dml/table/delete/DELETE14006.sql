...
-- primary_obligation_id: DELETE-EXT|14006|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_14006_tbl, delete_14006_src, delete_14006_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_14006_tbl WHERE delete_14006_no_such_col = 1;
-- primary-target-end
