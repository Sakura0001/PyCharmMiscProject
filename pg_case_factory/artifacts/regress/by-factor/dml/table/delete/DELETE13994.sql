...
-- primary_obligation_id: DELETE-EXT|13994|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13994_tbl, delete_13994_src, delete_13994_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_13994_tbl AS d WHERE delete_13994_no_such_col = 1;
-- primary-target-end
