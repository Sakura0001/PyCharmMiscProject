...
-- primary_obligation_id: DELETE-EXT|03024|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_03024_tbl, delete_03024_src, delete_03024_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_03024_tbl WHERE delete_03024_no_such_col = 1;
-- primary-target-end
