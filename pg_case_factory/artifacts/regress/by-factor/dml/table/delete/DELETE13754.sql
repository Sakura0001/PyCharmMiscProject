...
-- primary_obligation_id: DELETE-EXT|13754|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13754_tbl, delete_13754_src, delete_13754_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_13754_tbl" WHERE delete_13754_no_such_col = 1;
-- primary-target-end
