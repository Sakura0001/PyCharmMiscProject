...
-- primary_obligation_id: DELETE-EXT|00398|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_00398_tbl, delete_00398_src, delete_00398_ref CASCADE;
RESET ROLE;
...
WITH delete_00398_cte AS (SELECT 1 AS val)
DELETE FROM "delete_00398_tbl" WHERE delete_00398_no_such_col = 1;
-- primary-target-end
