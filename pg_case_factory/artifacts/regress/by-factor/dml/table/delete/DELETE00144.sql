...
-- primary_obligation_id: DELETE-EXT|00144|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_00144_tbl, delete_00144_src, delete_00144_ref CASCADE;
RESET ROLE;
...
WITH delete_00144_cte AS (SELECT 1 AS val)
DELETE FROM public.delete_00144_tbl WHERE delete_00144_no_such_col = 1;
-- primary-target-end
