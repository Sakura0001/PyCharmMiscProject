...
-- primary_obligation_id: DELETE-EXT|14004|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_14004_tbl, delete_14004_src, delete_14004_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_14004_tbl WHERE delete_14004_no_such_col = 1;
-- primary-target-end
