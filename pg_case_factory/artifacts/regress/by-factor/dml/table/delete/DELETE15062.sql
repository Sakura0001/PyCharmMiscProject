...
-- primary_obligation_id: DELETE-EXT|15062|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_15062_tbl, delete_15062_src, delete_15062_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_15062_tbl WHERE delete_15062_no_such_col = 1;
-- primary-target-end
