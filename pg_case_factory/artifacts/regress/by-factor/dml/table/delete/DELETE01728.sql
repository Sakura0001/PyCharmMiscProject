...
-- primary_obligation_id: DELETE-EXT|01728|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_01728_tbl, delete_01728_src, delete_01728_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_01728_tbl WHERE delete_01728_no_such_col = 1;
-- primary-target-end
