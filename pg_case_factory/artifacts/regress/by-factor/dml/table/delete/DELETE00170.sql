...
-- primary_obligation_id: DELETE-EXT|00170|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_00170_tbl, delete_00170_src, delete_00170_ref CASCADE;
RESET ROLE;
...
WITH delete_00170_cte AS (SELECT 1 AS val)
DELETE FROM delete_00170_tbl AS d WHERE delete_00170_no_such_col = 1;
-- primary-target-end
