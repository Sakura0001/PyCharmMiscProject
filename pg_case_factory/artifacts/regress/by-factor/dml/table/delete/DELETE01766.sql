...
-- primary_obligation_id: DELETE-EXT|01766|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_01766_tbl, delete_01766_src, delete_01766_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_01766_tbl WHERE delete_01766_no_such_col = 1;
-- primary-target-end
