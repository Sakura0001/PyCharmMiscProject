...
-- primary_obligation_id: DELETE-EXT|07104|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_07104_tbl, delete_07104_src, delete_07104_ref CASCADE;
RESET ROLE;
...
WITH delete_07104_cte AS (SELECT 1 AS val)
DELETE FROM delete_07104_tbl WHERE id = 999;
-- primary-target-end
