...
-- primary_obligation_id: DELETE-EXT|03097|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_03097_tbl, delete_03097_src, delete_03097_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_03097_tbl" WHERE delete_03097_no_such_col = 1;
-- primary-target-end
