...
-- primary_obligation_id: DELETE-EXT|16572|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_16572_tbl, delete_16572_src, delete_16572_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_16572_tbl AS d WHERE delete_16572_no_such_col = 1;
-- primary-target-end
