...
-- primary_obligation_id: DELETE-EXT|00084|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_00084_tbl, delete_00084_src, delete_00084_ref CASCADE;
RESET ROLE;
...
WITH delete_00084_cte AS (SELECT 1 AS val)
DELETE FROM delete_00084_tbl WHERE delete_00084_no_such_col = 1;
-- primary-target-end
