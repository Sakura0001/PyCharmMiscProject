...
-- primary_obligation_id: DELETE-EXT|07141|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_07141_tbl, delete_07141_src, delete_07141_ref CASCADE;
RESET ROLE;
...
WITH delete_07141_cte AS (SELECT 1 AS val)
DELETE FROM public.delete_07141_tbl WHERE id = 999;
-- primary-target-end
