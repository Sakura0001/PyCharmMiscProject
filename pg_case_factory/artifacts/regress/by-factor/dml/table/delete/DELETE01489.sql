...
-- primary_obligation_id: DELETE-EXT|01489|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_01489_tbl, delete_01489_src, delete_01489_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_01489_tbl WHERE delete_01489_no_such_col = 1;
-- primary-target-end
