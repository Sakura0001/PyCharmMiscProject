...
-- primary_obligation_id: DELETE-EXT|08592|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_08592_tbl, delete_08592_src, delete_08592_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_08592_tbl WHERE id = 999;
-- primary-target-end
