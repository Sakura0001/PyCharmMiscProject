...
-- primary_obligation_id: DELETE-EXT|01442|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_01442_tbl, delete_01442_src, delete_01442_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_01442_tbl WHERE delete_01442_no_such_col = 1;
-- primary-target-end
