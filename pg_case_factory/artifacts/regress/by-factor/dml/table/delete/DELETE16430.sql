...
-- primary_obligation_id: DELETE-EXT|16430|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_16430_tbl, delete_16430_src, delete_16430_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_16430_tbl" WHERE delete_16430_no_such_col = 1;
-- primary-target-end
