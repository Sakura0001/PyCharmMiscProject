...
-- primary_obligation_id: DELETE-EXT|04394|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_04394_tbl, delete_04394_src, delete_04394_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_04394_tbl AS d WHERE delete_04394_no_such_col = 1;
-- primary-target-end
