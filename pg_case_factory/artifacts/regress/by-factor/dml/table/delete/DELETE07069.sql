...
-- primary_obligation_id: DELETE-EXT|07069|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_07069_tbl, delete_07069_src, delete_07069_ref CASCADE;
RESET ROLE;
...
WITH delete_07069_cte AS (SELECT 1 AS val)
DELETE FROM delete_07069_tbl AS d WHERE id = 999;
-- primary-target-end
