...
-- primary_obligation_id: DELETE-EXT|13932|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13932_tbl, delete_13932_src, delete_13932_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_13932_tbl" WHERE delete_13932_no_such_col = 1;
-- primary-target-end
