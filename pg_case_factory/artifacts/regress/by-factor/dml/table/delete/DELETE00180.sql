...
-- primary_obligation_id: DELETE-EXT|00180|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_00180_tbl, delete_00180_src, delete_00180_ref CASCADE;
RESET ROLE;
...
WITH delete_00180_cte AS (SELECT 1 AS val)
DELETE FROM delete_00180_tbl WHERE delete_00180_no_such_col = 1;
-- primary-target-end
