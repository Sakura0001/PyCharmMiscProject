...
-- primary_obligation_id: DELETE-EXT|07236|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_07236_tbl, delete_07236_src, delete_07236_ref CASCADE;
RESET ROLE;
...
WITH delete_07236_cte AS (SELECT 1 AS val)
DELETE FROM public.delete_07236_tbl WHERE id = 999;
-- primary-target-end
