...
-- primary_obligation_id: DELETE-EXT|13778|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13778_tbl, delete_13778_src, delete_13778_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_13778_tbl WHERE delete_13778_no_such_col = 1;
-- primary-target-end
