...
-- primary_obligation_id: DELETE-EXT|00242|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_00242_tbl, delete_00242_src, delete_00242_ref CASCADE;
RESET ROLE;
...
WITH delete_00242_cte AS (SELECT 1 AS val)
DELETE FROM public.delete_00242_tbl WHERE delete_00242_no_such_col = 1;
-- primary-target-end
