...
-- primary_obligation_id: DELETE-EXT|12625|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_12625_tbl, delete_12625_src, delete_12625_ref CASCADE;
RESET ROLE;
...
WITH delete_12625_cte AS (SELECT 1 AS val)
DELETE FROM public.delete_12625_tbl WHERE delete_12625_no_such_col = 1;
-- primary-target-end
