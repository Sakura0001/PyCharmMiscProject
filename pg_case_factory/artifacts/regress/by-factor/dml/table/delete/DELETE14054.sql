...
-- primary_obligation_id: DELETE-EXT|14054|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_14054_tbl, delete_14054_src, delete_14054_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_14054_tbl WHERE delete_14054_no_such_col = 1;
-- primary-target-end
