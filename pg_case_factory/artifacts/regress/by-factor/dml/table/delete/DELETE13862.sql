...
-- primary_obligation_id: DELETE-EXT|13862|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13862_tbl, delete_13862_src, delete_13862_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_13862_tbl WHERE delete_13862_no_such_col = 1;
-- primary-target-end
