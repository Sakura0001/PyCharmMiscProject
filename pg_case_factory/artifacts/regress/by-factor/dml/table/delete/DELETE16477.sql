...
-- primary_obligation_id: DELETE-EXT|16477|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_16477_tbl, delete_16477_src, delete_16477_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_16477_tbl AS d WHERE delete_16477_no_such_col = 1;
-- primary-target-end
