...
-- primary_obligation_id: DELETE-EXT|12482|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_12482_tbl, delete_12482_src, delete_12482_ref CASCADE;
RESET ROLE;
...
WITH delete_12482_cte AS (SELECT 1 AS val)
DELETE FROM delete_12482_tbl WHERE delete_12482_no_such_col = 1;
-- primary-target-end
