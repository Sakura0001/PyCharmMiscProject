...
-- primary_obligation_id: DELETE-EXT|12528|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_12528_tbl, delete_12528_src, delete_12528_ref CASCADE;
RESET ROLE;
...
WITH delete_12528_cte AS (SELECT 1 AS val)
DELETE FROM public.delete_12528_tbl WHERE delete_12528_no_such_col = 1;
-- primary-target-end
