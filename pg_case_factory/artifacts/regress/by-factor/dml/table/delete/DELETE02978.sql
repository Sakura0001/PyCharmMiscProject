...
-- primary_obligation_id: DELETE-EXT|02978|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_02978_tbl, delete_02978_src, delete_02978_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_02978_tbl WHERE delete_02978_no_such_col = 1;
-- primary-target-end
