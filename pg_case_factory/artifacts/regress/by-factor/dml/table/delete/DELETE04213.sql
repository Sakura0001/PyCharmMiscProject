...
-- primary_obligation_id: DELETE-EXT|04213|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_04213_tbl, delete_04213_src, delete_04213_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_04213_tbl WHERE delete_04213_no_such_col = 1;
-- primary-target-end
