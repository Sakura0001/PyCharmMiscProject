...
-- primary_obligation_id: DELETE-EXT|12708|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_12708_tbl, delete_12708_src, delete_12708_ref CASCADE;
RESET ROLE;
...
WITH delete_12708_cte AS (SELECT 1 AS val)
DELETE FROM public.delete_12708_tbl WHERE delete_12708_no_such_col = 1;
-- primary-target-end
