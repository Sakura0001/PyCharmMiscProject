...
-- primary_obligation_id: DELETE-EXT|00217|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_00217_tbl, delete_00217_src, delete_00217_ref CASCADE;
RESET ROLE;
...
WITH delete_00217_cte AS (SELECT 1 AS val)
DELETE FROM "delete_00217_tbl" WHERE delete_00217_no_such_col = 1;
-- primary-target-end
