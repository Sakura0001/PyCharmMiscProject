...
-- primary_obligation_id: DELETE-EXT|14053|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_14053_tbl, delete_14053_src, delete_14053_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_14053_tbl WHERE delete_14053_no_such_col = 1;
-- primary-target-end
