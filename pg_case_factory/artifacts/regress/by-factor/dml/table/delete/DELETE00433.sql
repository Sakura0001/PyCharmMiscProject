...
-- primary_obligation_id: DELETE-EXT|00433|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_00433_tbl, delete_00433_src, delete_00433_ref CASCADE;
RESET ROLE;
...
WITH delete_00433_cte AS (SELECT 1 AS val)
DELETE FROM public.delete_00433_tbl WHERE delete_00433_no_such_col = 1;
-- primary-target-end
