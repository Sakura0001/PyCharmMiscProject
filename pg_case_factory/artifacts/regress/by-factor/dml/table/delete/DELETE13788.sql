...
-- primary_obligation_id: DELETE-EXT|13788|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13788_tbl, delete_13788_src, delete_13788_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_13788_tbl AS d WHERE delete_13788_no_such_col = 1;
-- primary-target-end
