...
-- primary_obligation_id: DELETE-EXT|00060|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_00060_tbl, delete_00060_src, delete_00060_ref CASCADE;
RESET ROLE;
...
WITH delete_00060_cte AS (SELECT 1 AS val)
DELETE FROM delete_00060_tbl AS d WHERE delete_00060_no_such_col = 1;
-- primary-target-end
