...
-- primary_obligation_id: DELETE-EXT|02773|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_02773_tbl, delete_02773_src, delete_02773_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_02773_tbl WHERE delete_02773_no_such_col = 1;
-- primary-target-end
