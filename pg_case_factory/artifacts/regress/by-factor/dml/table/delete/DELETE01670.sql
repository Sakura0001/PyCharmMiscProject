...
-- primary_obligation_id: DELETE-EXT|01670|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_01670_tbl, delete_01670_src, delete_01670_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_01670_tbl WHERE delete_01670_no_such_col = 1;
-- primary-target-end
