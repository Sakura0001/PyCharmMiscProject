...
-- primary_obligation_id: DELETE-EXT|13981|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13981_tbl, delete_13981_src, delete_13981_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_13981_tbl AS d WHERE delete_13981_no_such_col = 1;
-- primary-target-end
