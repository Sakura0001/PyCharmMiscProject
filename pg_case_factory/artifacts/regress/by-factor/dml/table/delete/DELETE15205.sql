...
-- primary_obligation_id: DELETE-EXT|15205|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_15205_tbl, delete_15205_src, delete_15205_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_15205_tbl WHERE delete_15205_no_such_col = 1;
-- primary-target-end
