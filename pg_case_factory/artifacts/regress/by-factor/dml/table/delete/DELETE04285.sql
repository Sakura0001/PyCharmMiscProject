...
-- primary_obligation_id: DELETE-EXT|04285|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_04285_tbl, delete_04285_src, delete_04285_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_04285_tbl AS d WHERE delete_04285_no_such_col = 1;
-- primary-target-end
