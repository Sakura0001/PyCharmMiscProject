...
-- primary_obligation_id: DELETE-EXT|15134|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_15134_tbl, delete_15134_src, delete_15134_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_15134_tbl AS d WHERE delete_15134_no_such_col = 1;
-- primary-target-end
