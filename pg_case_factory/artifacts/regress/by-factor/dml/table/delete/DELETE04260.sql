...
-- primary_obligation_id: DELETE-EXT|04260|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_04260_tbl, delete_04260_src, delete_04260_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_04260_tbl WHERE delete_04260_no_such_col = 1;
-- primary-target-end
