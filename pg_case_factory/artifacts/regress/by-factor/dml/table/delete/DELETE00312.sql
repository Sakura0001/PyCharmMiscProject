...
-- primary_obligation_id: DELETE-EXT|00312|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_00312_tbl, delete_00312_src, delete_00312_ref CASCADE;
RESET ROLE;
...
WITH delete_00312_cte AS (SELECT 1 AS val)
DELETE FROM "delete_00312_tbl" WHERE delete_00312_no_such_col = 1;
-- primary-target-end
