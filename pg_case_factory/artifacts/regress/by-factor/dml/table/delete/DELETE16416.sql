...
-- primary_obligation_id: DELETE-EXT|16416|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_16416_tbl, delete_16416_src, delete_16416_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_16416_tbl WHERE delete_16416_no_such_col = 1;
-- primary-target-end
