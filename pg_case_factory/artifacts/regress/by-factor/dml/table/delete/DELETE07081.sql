...
-- primary_obligation_id: DELETE-EXT|07081|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_07081_tbl, delete_07081_src, delete_07081_ref CASCADE;
RESET ROLE;
...
WITH delete_07081_cte AS (SELECT 1 AS val)
DELETE FROM delete_07081_tbl AS d WHERE id = 999;
-- primary-target-end
