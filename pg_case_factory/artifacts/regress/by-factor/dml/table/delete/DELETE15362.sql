...
-- primary_obligation_id: DELETE-EXT|15362|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_15362_tbl, delete_15362_src, delete_15362_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_15362_tbl WHERE delete_15362_no_such_col = 1;
-- primary-target-end
