...
-- primary_obligation_id: DELETE-EXT|07334|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_07334_tbl, delete_07334_src, delete_07334_ref CASCADE;
RESET ROLE;
...
WITH delete_07334_cte AS (SELECT 1 AS val)
DELETE FROM public.delete_07334_tbl WHERE id = 999;
-- primary-target-end
