...
-- primary_obligation_id: DELETE-EXT|02976|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_02976_tbl, delete_02976_src, delete_02976_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_02976_tbl WHERE delete_02976_no_such_col = 1;
-- primary-target-end
