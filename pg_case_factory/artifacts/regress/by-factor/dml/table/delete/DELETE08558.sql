...
-- primary_obligation_id: DELETE-EXT|08558|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_08558_tbl, delete_08558_src, delete_08558_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_08558_tbl" WHERE id = 999;
-- primary-target-end
