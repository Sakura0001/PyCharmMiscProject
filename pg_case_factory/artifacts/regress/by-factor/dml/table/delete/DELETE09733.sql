...
-- primary_obligation_id: DELETE-EXT|09733|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_09733_tbl, delete_09733_src, delete_09733_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_09733_tbl WHERE id = 999;
-- primary-target-end
