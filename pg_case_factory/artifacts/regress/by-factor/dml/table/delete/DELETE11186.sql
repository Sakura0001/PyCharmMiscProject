...
-- primary_obligation_id: DELETE-EXT|11186|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_11186_tbl, delete_11186_src, delete_11186_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_11186_tbl WHERE id = 999;
-- primary-target-end
