...
-- primary_obligation_id: DELETE-EXT|12542|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_12542_tbl, delete_12542_src, delete_12542_ref CASCADE;
RESET ROLE;
...
WITH delete_12542_cte AS (SELECT 1 AS val)
DELETE FROM delete_12542_tbl AS d WHERE delete_12542_no_such_col = 1;
-- primary-target-end
