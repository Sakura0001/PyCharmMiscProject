...
-- primary_obligation_id: DELETE-EXT|11161|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_11161_tbl, delete_11161_src, delete_11161_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_11161_tbl" WHERE id = 999;
-- primary-target-end
