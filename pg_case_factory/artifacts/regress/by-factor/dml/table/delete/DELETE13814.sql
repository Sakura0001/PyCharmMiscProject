...
-- primary_obligation_id: DELETE-EXT|13814|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13814_tbl, delete_13814_src, delete_13814_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_13814_tbl WHERE delete_13814_no_such_col = 1;
-- primary-target-end
