...
-- primary_obligation_id: DELETE-EXT|14005|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_14005_tbl, delete_14005_src, delete_14005_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_14005_tbl WHERE delete_14005_no_such_col = 1;
-- primary-target-end
