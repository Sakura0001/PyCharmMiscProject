...
-- primary_obligation_id: DELETE-EXT|01572|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_01572_tbl, delete_01572_src, delete_01572_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_01572_tbl WHERE delete_01572_no_such_col = 1;
-- primary-target-end
