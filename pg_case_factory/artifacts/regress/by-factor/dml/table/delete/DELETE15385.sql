...
-- primary_obligation_id: DELETE-EXT|15385|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_15385_tbl, delete_15385_src, delete_15385_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_15385_tbl" WHERE delete_15385_no_such_col = 1;
-- primary-target-end
