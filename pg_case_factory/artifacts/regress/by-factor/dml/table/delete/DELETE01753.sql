...
-- primary_obligation_id: DELETE-EXT|01753|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_01753_tbl, delete_01753_src, delete_01753_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_01753_tbl" WHERE delete_01753_no_such_col = 1;
-- primary-target-end
