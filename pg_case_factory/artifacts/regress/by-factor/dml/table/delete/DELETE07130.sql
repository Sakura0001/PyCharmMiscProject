...
-- primary_obligation_id: DELETE-EXT|07130|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_07130_tbl, delete_07130_src, delete_07130_ref CASCADE;
RESET ROLE;
...
WITH delete_07130_cte AS (SELECT 1 AS val)
DELETE FROM "delete_07130_tbl" WHERE id = 999;
-- primary-target-end
