...
-- primary_obligation_id: DELETE-EXT|15252|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_15252_tbl, delete_15252_src, delete_15252_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_15252_tbl WHERE delete_15252_no_such_col = 1;
-- primary-target-end
