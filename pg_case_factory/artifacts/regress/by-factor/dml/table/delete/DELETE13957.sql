...
-- primary_obligation_id: DELETE-EXT|13957|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13957_tbl, delete_13957_src, delete_13957_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_13957_tbl WHERE delete_13957_no_such_col = 1;
-- primary-target-end
