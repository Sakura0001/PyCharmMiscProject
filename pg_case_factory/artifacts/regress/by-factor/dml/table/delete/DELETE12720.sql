...
-- primary_obligation_id: DELETE-EXT|12720|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_12720_tbl, delete_12720_src, delete_12720_ref CASCADE;
RESET ROLE;
...
WITH delete_12720_cte AS (SELECT 1 AS val)
DELETE FROM public.delete_12720_tbl WHERE delete_12720_no_such_col = 1;
-- primary-target-end
