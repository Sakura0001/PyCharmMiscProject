...
-- primary_obligation_id: DELETE-EXT|03060|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_03060_tbl, delete_03060_src, delete_03060_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_03060_tbl WHERE delete_03060_no_such_col = 1;
-- primary-target-end
