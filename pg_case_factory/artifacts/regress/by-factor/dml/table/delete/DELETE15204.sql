...
-- primary_obligation_id: DELETE-EXT|15204|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_15204_tbl, delete_15204_src, delete_15204_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_15204_tbl WHERE delete_15204_no_such_col = 1;
-- primary-target-end
