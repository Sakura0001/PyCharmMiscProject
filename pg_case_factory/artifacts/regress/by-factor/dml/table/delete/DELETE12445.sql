...
-- primary_obligation_id: DELETE-EXT|12445|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_12445_tbl, delete_12445_src, delete_12445_ref CASCADE;
RESET ROLE;
...
WITH delete_12445_cte AS (SELECT 1 AS val)
DELETE FROM delete_12445_tbl AS d WHERE delete_12445_no_such_col = 1;
-- primary-target-end
