...
-- primary_obligation_id: DELETE-EXT|02929|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_02929_tbl, delete_02929_src, delete_02929_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_02929_tbl WHERE delete_02929_no_such_col = 1;
-- primary-target-end
