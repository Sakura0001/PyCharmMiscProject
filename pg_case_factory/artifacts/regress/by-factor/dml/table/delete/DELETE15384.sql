...
-- primary_obligation_id: DELETE-EXT|15384|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_15384_tbl, delete_15384_src, delete_15384_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_15384_tbl" WHERE delete_15384_no_such_col = 1;
-- primary-target-end
