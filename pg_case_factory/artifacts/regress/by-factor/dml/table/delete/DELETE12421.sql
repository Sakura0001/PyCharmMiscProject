...
-- primary_obligation_id: DELETE-EXT|12421|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_12421_tbl, delete_12421_src, delete_12421_ref CASCADE;
RESET ROLE;
...
WITH delete_12421_cte AS (SELECT 1 AS val)
DELETE FROM public.delete_12421_tbl WHERE delete_12421_no_such_col = 1;
-- primary-target-end
