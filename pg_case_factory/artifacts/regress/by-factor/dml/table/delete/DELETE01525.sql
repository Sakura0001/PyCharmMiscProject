...
-- primary_obligation_id: DELETE-EXT|01525|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_01525_tbl, delete_01525_src, delete_01525_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_01525_tbl WHERE delete_01525_no_such_col = 1;
-- primary-target-end
