...
-- primary_obligation_id: DELETE-EXT|06984|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_06984_tbl, delete_06984_src, delete_06984_ref CASCADE;
RESET ROLE;
...
WITH delete_06984_cte AS (SELECT 1 AS val)
DELETE FROM delete_06984_tbl AS d WHERE id = 999;
-- primary-target-end
