...
-- primary_obligation_id: DELETE-EXT|12458|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_12458_tbl, delete_12458_src, delete_12458_ref CASCADE;
RESET ROLE;
...
WITH delete_12458_cte AS (SELECT 1 AS val)
DELETE FROM delete_12458_tbl AS d WHERE delete_12458_no_such_col = 1;
-- primary-target-end
