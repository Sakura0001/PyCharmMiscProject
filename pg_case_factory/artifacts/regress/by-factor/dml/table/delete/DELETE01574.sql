...
-- primary_obligation_id: DELETE-EXT|01574|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_01574_tbl, delete_01574_src, delete_01574_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_01574_tbl WHERE delete_01574_no_such_col = 1;
-- primary-target-end
