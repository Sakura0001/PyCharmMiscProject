...
-- primary_obligation_id: DELETE-EXT|03121|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_03121_tbl, delete_03121_src, delete_03121_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_03121_tbl WHERE delete_03121_no_such_col = 1;
-- primary-target-end
