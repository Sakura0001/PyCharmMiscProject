...
-- primary_obligation_id: DELETE-EXT|03122|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_03122_tbl, delete_03122_src, delete_03122_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_03122_tbl WHERE delete_03122_no_such_col = 1;
-- primary-target-end
