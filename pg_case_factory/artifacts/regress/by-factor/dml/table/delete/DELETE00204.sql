...
-- primary_obligation_id: DELETE-EXT|00204|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_00204_tbl, delete_00204_src, delete_00204_ref CASCADE;
RESET ROLE;
...
WITH delete_00204_cte AS (SELECT 1 AS val)
DELETE FROM "delete_00204_tbl" WHERE delete_00204_no_such_col = 1;
-- primary-target-end
