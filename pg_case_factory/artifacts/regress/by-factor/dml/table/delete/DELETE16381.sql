...
-- primary_obligation_id: DELETE-EXT|16381|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_16381_tbl, delete_16381_src, delete_16381_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_16381_tbl AS d WHERE delete_16381_no_such_col = 1;
-- primary-target-end
