...
-- primary_obligation_id: DELETE-EXT|11088|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_11088_tbl, delete_11088_src, delete_11088_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_11088_tbl WHERE id = 999;
-- primary-target-end
