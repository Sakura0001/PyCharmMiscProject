...
-- primary_obligation_id: DELETE-EXT|00276|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_00276_tbl, delete_00276_src, delete_00276_ref CASCADE;
RESET ROLE;
...
WITH delete_00276_cte AS (SELECT 1 AS val)
DELETE FROM delete_00276_tbl WHERE delete_00276_no_such_col = 1;
-- primary-target-end
