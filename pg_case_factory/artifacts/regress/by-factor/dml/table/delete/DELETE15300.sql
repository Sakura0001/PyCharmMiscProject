...
-- primary_obligation_id: DELETE-EXT|15300|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_15300_tbl, delete_15300_src, delete_15300_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_15300_tbl WHERE delete_15300_no_such_col = 1;
-- primary-target-end
