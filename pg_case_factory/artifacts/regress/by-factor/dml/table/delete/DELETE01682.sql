...
-- primary_obligation_id: DELETE-EXT|01682|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_01682_tbl, delete_01682_src, delete_01682_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_01682_tbl WHERE delete_01682_no_such_col = 1;
-- primary-target-end
