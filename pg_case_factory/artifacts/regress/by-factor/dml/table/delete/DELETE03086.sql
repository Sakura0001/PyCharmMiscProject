...
-- primary_obligation_id: DELETE-EXT|03086|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_03086_tbl, delete_03086_src, delete_03086_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_03086_tbl" WHERE delete_03086_no_such_col = 1;
-- primary-target-end
