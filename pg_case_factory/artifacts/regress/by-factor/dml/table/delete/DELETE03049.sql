...
-- primary_obligation_id: DELETE-EXT|03049|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_03049_tbl, delete_03049_src, delete_03049_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_03049_tbl AS d WHERE delete_03049_no_such_col = 1;
-- primary-target-end
