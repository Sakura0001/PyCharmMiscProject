...
-- primary_obligation_id: DELETE-EXT|04214|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_04214_tbl, delete_04214_src, delete_04214_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_04214_tbl WHERE delete_04214_no_such_col = 1;
-- primary-target-end
