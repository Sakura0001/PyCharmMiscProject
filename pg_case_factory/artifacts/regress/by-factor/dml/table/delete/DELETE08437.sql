...
-- primary_obligation_id: DELETE-EXT|08437|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_08437_tbl, delete_08437_src, delete_08437_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_08437_tbl WHERE id = 999;
-- primary-target-end
