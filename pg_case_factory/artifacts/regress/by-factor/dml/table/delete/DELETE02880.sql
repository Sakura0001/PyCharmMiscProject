...
-- primary_obligation_id: DELETE-EXT|02880|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_02880_tbl, delete_02880_src, delete_02880_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_02880_tbl WHERE delete_02880_no_such_col = 1;
-- primary-target-end
