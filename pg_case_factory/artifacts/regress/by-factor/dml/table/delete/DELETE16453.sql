...
-- primary_obligation_id: DELETE-EXT|16453|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_16453_tbl, delete_16453_src, delete_16453_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_16453_tbl WHERE delete_16453_no_such_col = 1;
-- primary-target-end
