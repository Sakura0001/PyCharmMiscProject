...
-- primary_obligation_id: DELETE-EXT|13861|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13861_tbl, delete_13861_src, delete_13861_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_13861_tbl WHERE delete_13861_no_such_col = 1;
-- primary-target-end
