...
-- primary_obligation_id: DELETE-EXT|02858|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_02858_tbl, delete_02858_src, delete_02858_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_02858_tbl AS d WHERE delete_02858_no_such_col = 1;
-- primary-target-end
