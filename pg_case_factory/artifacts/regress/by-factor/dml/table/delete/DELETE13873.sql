...
-- primary_obligation_id: DELETE-EXT|13873|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13873_tbl, delete_13873_src, delete_13873_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_13873_tbl WHERE delete_13873_no_such_col = 1;
-- primary-target-end
