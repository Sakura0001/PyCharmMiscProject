...
-- primary_obligation_id: DELETE-EXT|01476|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_01476_tbl, delete_01476_src, delete_01476_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_01476_tbl WHERE delete_01476_no_such_col = 1;
-- primary-target-end
