...
-- primary_obligation_id: DELETE-EXT|09782|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_09782_tbl, delete_09782_src, delete_09782_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_09782_tbl WHERE id = 999;
-- primary-target-end
