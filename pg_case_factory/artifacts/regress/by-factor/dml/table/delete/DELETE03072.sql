...
-- primary_obligation_id: DELETE-EXT|03072|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_03072_tbl, delete_03072_src, delete_03072_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_03072_tbl WHERE delete_03072_no_such_col = 1;
-- primary-target-end
