...
-- primary_obligation_id: DELETE-EXT|14065|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_14065_tbl, delete_14065_src, delete_14065_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_14065_tbl WHERE delete_14065_no_such_col = 1;
-- primary-target-end
