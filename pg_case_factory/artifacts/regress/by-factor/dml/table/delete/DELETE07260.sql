...
-- primary_obligation_id: DELETE-EXT|07260|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_07260_tbl, delete_07260_src, delete_07260_ref CASCADE;
RESET ROLE;
...
WITH delete_07260_cte AS (SELECT 1 AS val)
DELETE FROM delete_07260_tbl AS d WHERE id = 999;
-- primary-target-end
