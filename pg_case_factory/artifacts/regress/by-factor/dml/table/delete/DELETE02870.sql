...
-- primary_obligation_id: DELETE-EXT|02870|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_02870_tbl, delete_02870_src, delete_02870_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_02870_tbl WHERE delete_02870_no_such_col = 1;
-- primary-target-end
