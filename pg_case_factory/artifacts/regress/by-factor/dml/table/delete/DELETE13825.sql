...
-- primary_obligation_id: DELETE-EXT|13825|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13825_tbl, delete_13825_src, delete_13825_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_13825_tbl WHERE delete_13825_no_such_col = 1;
-- primary-target-end
