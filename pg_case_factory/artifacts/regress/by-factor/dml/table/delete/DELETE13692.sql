...
-- primary_obligation_id: DELETE-EXT|13692|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13692_tbl, delete_13692_src, delete_13692_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_13692_tbl AS d WHERE delete_13692_no_such_col = 1;
-- primary-target-end
