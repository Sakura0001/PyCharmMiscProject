...
-- primary_obligation_id: DELETE-EXT|07142|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_07142_tbl, delete_07142_src, delete_07142_ref CASCADE;
RESET ROLE;
...
WITH delete_07142_cte AS (SELECT 1 AS val)
DELETE FROM public.delete_07142_tbl WHERE id = 999;
-- primary-target-end
