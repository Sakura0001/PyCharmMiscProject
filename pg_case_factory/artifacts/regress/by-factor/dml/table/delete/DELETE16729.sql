...
-- primary_obligation_id: DELETE-EXT|16729|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_16729_tbl, delete_16729_src, delete_16729_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_16729_tbl" WHERE delete_16729_no_such_col = 1;
-- primary-target-end
