...
-- primary_obligation_id: DELETE-EXT|04200|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_04200_tbl, delete_04200_src, delete_04200_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_04200_tbl AS d WHERE delete_04200_no_such_col = 1;
-- primary-target-end
