...
-- primary_obligation_id: DELETE-EXT|12480|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_12480_tbl, delete_12480_src, delete_12480_ref CASCADE;
RESET ROLE;
...
WITH delete_12480_cte AS (SELECT 1 AS val)
DELETE FROM delete_12480_tbl WHERE delete_12480_no_such_col = 1;
-- primary-target-end
