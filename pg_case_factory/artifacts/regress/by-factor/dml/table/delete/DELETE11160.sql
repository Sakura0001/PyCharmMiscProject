...
-- primary_obligation_id: DELETE-EXT|11160|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_11160_tbl, delete_11160_src, delete_11160_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_11160_tbl" WHERE id = 999;
-- primary-target-end
