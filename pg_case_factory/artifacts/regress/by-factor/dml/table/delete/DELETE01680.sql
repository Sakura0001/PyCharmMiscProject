...
-- primary_obligation_id: DELETE-EXT|01680|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_01680_tbl, delete_01680_src, delete_01680_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_01680_tbl WHERE delete_01680_no_such_col = 1;
-- primary-target-end
