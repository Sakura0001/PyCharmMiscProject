...
-- primary_obligation_id: DELETE-EXT|14029|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_14029_tbl, delete_14029_src, delete_14029_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_14029_tbl" WHERE delete_14029_no_such_col = 1;
-- primary-target-end
