...
-- primary_obligation_id: DELETE-EXT|13992|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13992_tbl, delete_13992_src, delete_13992_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_13992_tbl AS d WHERE delete_13992_no_such_col = 1;
-- primary-target-end
