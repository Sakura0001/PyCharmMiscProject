...
-- primary_obligation_id: DELETE-EXT|09660|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_09660_tbl, delete_09660_src, delete_09660_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_09660_tbl AS d WHERE id = 999;
-- primary-target-end
