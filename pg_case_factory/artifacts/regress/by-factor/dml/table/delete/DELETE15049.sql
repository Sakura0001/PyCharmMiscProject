...
-- primary_obligation_id: DELETE-EXT|15049|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_15049_tbl, delete_15049_src, delete_15049_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_15049_tbl AS d WHERE delete_15049_no_such_col = 1;
-- primary-target-end
