...
-- primary_obligation_id: DELETE-EXT|04201|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_04201_tbl, delete_04201_src, delete_04201_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_04201_tbl AS d WHERE delete_04201_no_such_col = 1;
-- primary-target-end
