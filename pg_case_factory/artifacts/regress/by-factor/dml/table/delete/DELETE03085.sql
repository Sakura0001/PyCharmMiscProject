...
-- primary_obligation_id: DELETE-EXT|03085|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_03085_tbl, delete_03085_src, delete_03085_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_03085_tbl" WHERE delete_03085_no_such_col = 1;
-- primary-target-end
