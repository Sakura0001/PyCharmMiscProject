...
-- primary_obligation_id: DELETE-EXT|15348|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_15348_tbl, delete_15348_src, delete_15348_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_15348_tbl WHERE delete_15348_no_such_col = 1;
-- primary-target-end
