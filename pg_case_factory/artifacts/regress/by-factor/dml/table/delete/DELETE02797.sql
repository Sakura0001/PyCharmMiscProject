...
-- primary_obligation_id: DELETE-EXT|02797|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_02797_tbl, delete_02797_src, delete_02797_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_02797_tbl" WHERE delete_02797_no_such_col = 1;
-- primary-target-end
