...
-- primary_obligation_id: DELETE-EXT|07154|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_07154_tbl, delete_07154_src, delete_07154_ref CASCADE;
RESET ROLE;
...
WITH delete_07154_cte AS (SELECT 1 AS val)
DELETE FROM public.delete_07154_tbl WHERE id = 999;
-- primary-target-end
