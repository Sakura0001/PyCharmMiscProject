...
-- primary_obligation_id: DELETE-EXT|00097|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_00097_tbl, delete_00097_src, delete_00097_ref CASCADE;
RESET ROLE;
...
WITH delete_00097_cte AS (SELECT 1 AS val)
DELETE FROM delete_00097_tbl WHERE delete_00097_no_such_col = 1;
-- primary-target-end
