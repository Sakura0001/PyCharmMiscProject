...
-- primary_obligation_id: DELETE-EXT|16608|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_16608_tbl, delete_16608_src, delete_16608_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_16608_tbl WHERE delete_16608_no_such_col = 1;
-- primary-target-end
