...
-- primary_obligation_id: DELETE-EXT|04177|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_04177_tbl, delete_04177_src, delete_04177_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_04177_tbl WHERE delete_04177_no_such_col = 1;
-- primary-target-end
