...
-- primary_obligation_id: DELETE-EXT|00073|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_00073_tbl, delete_00073_src, delete_00073_ref CASCADE;
RESET ROLE;
...
WITH delete_00073_cte AS (SELECT 1 AS val)
DELETE FROM delete_00073_tbl AS d WHERE delete_00073_no_such_col = 1;
-- primary-target-end
