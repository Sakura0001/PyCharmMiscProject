...
-- primary_obligation_id: DELETE-EXT|00350|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_00350_tbl, delete_00350_src, delete_00350_ref CASCADE;
RESET ROLE;
...
WITH delete_00350_cte AS (SELECT 1 AS val)
DELETE FROM delete_00350_tbl AS d WHERE delete_00350_no_such_col = 1;
-- primary-target-end
