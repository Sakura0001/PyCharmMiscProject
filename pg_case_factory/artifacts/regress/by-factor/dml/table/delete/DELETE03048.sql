...
-- primary_obligation_id: DELETE-EXT|03048|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_03048_tbl, delete_03048_src, delete_03048_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_03048_tbl AS d WHERE delete_03048_no_such_col = 1;
-- primary-target-end
