...
-- primary_obligation_id: DELETE-EXT|12408|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_12408_tbl, delete_12408_src, delete_12408_ref CASCADE;
RESET ROLE;
...
WITH delete_12408_cte AS (SELECT 1 AS val)
DELETE FROM "delete_12408_tbl" WHERE delete_12408_no_such_col = 1;
-- primary-target-end
