...
-- primary_obligation_id: DELETE-EXT|02822|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_02822_tbl, delete_02822_src, delete_02822_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_02822_tbl WHERE delete_02822_no_such_col = 1;
-- primary-target-end
