...
-- primary_obligation_id: DELETE-EXT|16394|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_16394_tbl, delete_16394_src, delete_16394_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_16394_tbl AS d WHERE delete_16394_no_such_col = 1;
-- primary-target-end
