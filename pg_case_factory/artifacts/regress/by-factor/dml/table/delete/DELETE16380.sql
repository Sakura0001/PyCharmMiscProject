...
-- primary_obligation_id: DELETE-EXT|16380|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_16380_tbl, delete_16380_src, delete_16380_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_16380_tbl AS d WHERE delete_16380_no_such_col = 1;
-- primary-target-end
