...
-- primary_obligation_id: DELETE-EXT|02881|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_02881_tbl, delete_02881_src, delete_02881_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_02881_tbl WHERE delete_02881_no_such_col = 1;
-- primary-target-end
