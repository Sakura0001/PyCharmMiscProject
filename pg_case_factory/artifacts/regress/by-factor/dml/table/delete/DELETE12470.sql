...
-- primary_obligation_id: DELETE-EXT|12470|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_12470_tbl, delete_12470_src, delete_12470_ref CASCADE;
RESET ROLE;
...
WITH delete_12470_cte AS (SELECT 1 AS val)
DELETE FROM delete_12470_tbl WHERE delete_12470_no_such_col = 1;
-- primary-target-end
