...
-- primary_obligation_id: DELETE-EXT|04225|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_04225_tbl, delete_04225_src, delete_04225_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_04225_tbl WHERE delete_04225_no_such_col = 1;
-- primary-target-end
