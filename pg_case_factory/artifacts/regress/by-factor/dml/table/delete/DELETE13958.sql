...
-- primary_obligation_id: DELETE-EXT|13958|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13958_tbl, delete_13958_src, delete_13958_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_13958_tbl WHERE delete_13958_no_such_col = 1;
-- primary-target-end
