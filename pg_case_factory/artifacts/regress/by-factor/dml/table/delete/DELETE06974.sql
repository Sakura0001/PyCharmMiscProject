...
-- primary_obligation_id: DELETE-EXT|06974|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_06974_tbl, delete_06974_src, delete_06974_ref CASCADE;
RESET ROLE;
...
WITH delete_06974_cte AS (SELECT 1 AS val)
DELETE FROM delete_06974_tbl AS d WHERE id = 999;
-- primary-target-end
