...
-- primary_obligation_id: DELETE-EXT|13970|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13970_tbl, delete_13970_src, delete_13970_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_13970_tbl WHERE delete_13970_no_such_col = 1;
-- primary-target-end
