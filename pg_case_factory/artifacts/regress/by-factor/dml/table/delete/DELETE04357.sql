...
-- primary_obligation_id: DELETE-EXT|04357|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_04357_tbl, delete_04357_src, delete_04357_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_04357_tbl WHERE delete_04357_no_such_col = 1;
-- primary-target-end
