...
-- primary_obligation_id: DELETE-EXT|01586|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_01586_tbl, delete_01586_src, delete_01586_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_01586_tbl WHERE delete_01586_no_such_col = 1;
-- primary-target-end
