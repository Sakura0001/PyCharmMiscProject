...
-- primary_obligation_id: DELETE-EXT|13813|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13813_tbl, delete_13813_src, delete_13813_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_13813_tbl WHERE delete_13813_no_such_col = 1;
-- primary-target-end
