...
-- primary_obligation_id: DELETE-EXT|07129|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_07129_tbl, delete_07129_src, delete_07129_ref CASCADE;
RESET ROLE;
...
WITH delete_07129_cte AS (SELECT 1 AS val)
DELETE FROM "delete_07129_tbl" WHERE id = 999;
-- primary-target-end
