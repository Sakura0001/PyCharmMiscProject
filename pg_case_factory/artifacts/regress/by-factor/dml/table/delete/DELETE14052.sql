...
-- primary_obligation_id: DELETE-EXT|14052|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_14052_tbl, delete_14052_src, delete_14052_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_14052_tbl WHERE delete_14052_no_such_col = 1;
-- primary-target-end
