...
-- primary_obligation_id: DELETE-EXT|12612|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_12612_tbl, delete_12612_src, delete_12612_ref CASCADE;
RESET ROLE;
...
WITH delete_12612_cte AS (SELECT 1 AS val)
DELETE FROM public.delete_12612_tbl WHERE delete_12612_no_such_col = 1;
-- primary-target-end
