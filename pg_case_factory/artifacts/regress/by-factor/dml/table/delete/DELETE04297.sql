...
-- primary_obligation_id: DELETE-EXT|04297|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_04297_tbl, delete_04297_src, delete_04297_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_04297_tbl AS d WHERE delete_04297_no_such_col = 1;
-- primary-target-end
