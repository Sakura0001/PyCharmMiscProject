...
-- primary_obligation_id: DELETE-EXT|15410|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_15410_tbl, delete_15410_src, delete_15410_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_15410_tbl WHERE delete_15410_no_such_col = 1;
-- primary-target-end
