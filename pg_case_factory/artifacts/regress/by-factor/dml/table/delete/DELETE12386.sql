...
-- primary_obligation_id: DELETE-EXT|12386|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_12386_tbl, delete_12386_src, delete_12386_ref CASCADE;
RESET ROLE;
...
WITH delete_12386_cte AS (SELECT 1 AS val)
DELETE FROM delete_12386_tbl WHERE delete_12386_no_such_col = 1;
-- primary-target-end
