...
-- primary_obligation_id: DELETE-EXT|11078|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_11078_tbl, delete_11078_src, delete_11078_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_11078_tbl WHERE id = 999;
-- primary-target-end
