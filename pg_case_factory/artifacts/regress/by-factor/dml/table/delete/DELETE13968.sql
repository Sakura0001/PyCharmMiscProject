...
-- primary_obligation_id: DELETE-EXT|13968|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13968_tbl, delete_13968_src, delete_13968_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_13968_tbl WHERE delete_13968_no_such_col = 1;
-- primary-target-end
