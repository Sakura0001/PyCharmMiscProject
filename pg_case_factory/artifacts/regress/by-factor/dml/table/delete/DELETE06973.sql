...
-- primary_obligation_id: DELETE-EXT|06973|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_06973_tbl, delete_06973_src, delete_06973_ref CASCADE;
RESET ROLE;
...
WITH delete_06973_cte AS (SELECT 1 AS val)
DELETE FROM delete_06973_tbl AS d WHERE id = 999;
-- primary-target-end
