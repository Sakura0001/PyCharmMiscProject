...
-- primary_obligation_id: DELETE-EXT|09734|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_09734_tbl, delete_09734_src, delete_09734_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_09734_tbl WHERE id = 999;
-- primary-target-end
