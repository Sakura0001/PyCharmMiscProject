...
-- primary_obligation_id: DELETE-EXT|08412|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_08412_tbl, delete_08412_src, delete_08412_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_08412_tbl AS d WHERE id = 999;
-- primary-target-end
