...
-- primary_obligation_id: DELETE-EXT|03000|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_03000_tbl, delete_03000_src, delete_03000_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_03000_tbl" WHERE delete_03000_no_such_col = 1;
-- primary-target-end
