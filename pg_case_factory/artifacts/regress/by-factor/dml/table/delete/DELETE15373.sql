...
-- primary_obligation_id: DELETE-EXT|15373|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_15373_tbl, delete_15373_src, delete_15373_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_15373_tbl" WHERE delete_15373_no_such_col = 1;
-- primary-target-end
