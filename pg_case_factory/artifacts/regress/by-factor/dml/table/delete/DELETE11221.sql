...
-- primary_obligation_id: DELETE-EXT|11221|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_11221_tbl, delete_11221_src, delete_11221_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_11221_tbl WHERE id = 999;
-- primary-target-end
