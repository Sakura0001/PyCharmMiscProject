...
-- primary_obligation_id: DELETE-EXT|13837|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13837_tbl, delete_13837_src, delete_13837_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_13837_tbl" WHERE delete_13837_no_such_col = 1;
-- primary-target-end
