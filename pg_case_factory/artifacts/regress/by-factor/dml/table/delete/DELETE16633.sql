...
-- primary_obligation_id: DELETE-EXT|16633|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_16633_tbl, delete_16633_src, delete_16633_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_16633_tbl" WHERE delete_16633_no_such_col = 1;
-- primary-target-end
