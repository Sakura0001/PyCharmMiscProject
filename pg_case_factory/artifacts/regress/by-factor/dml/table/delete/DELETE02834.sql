...
-- primary_obligation_id: DELETE-EXT|02834|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_02834_tbl, delete_02834_src, delete_02834_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_02834_tbl WHERE delete_02834_no_such_col = 1;
-- primary-target-end
