...
-- primary_obligation_id: DELETE-EXT|00146|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_00146_tbl, delete_00146_src, delete_00146_ref CASCADE;
RESET ROLE;
...
WITH delete_00146_cte AS (SELECT 1 AS val)
DELETE FROM public.delete_00146_tbl WHERE delete_00146_no_such_col = 1;
-- primary-target-end
