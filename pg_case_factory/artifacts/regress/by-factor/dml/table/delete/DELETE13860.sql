...
-- primary_obligation_id: DELETE-EXT|13860|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13860_tbl, delete_13860_src, delete_13860_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_13860_tbl WHERE delete_13860_no_such_col = 1;
-- primary-target-end
