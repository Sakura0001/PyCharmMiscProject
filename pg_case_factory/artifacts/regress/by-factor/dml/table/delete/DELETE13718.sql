...
-- primary_obligation_id: DELETE-EXT|13718|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13718_tbl, delete_13718_src, delete_13718_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_13718_tbl WHERE delete_13718_no_such_col = 1;
-- primary-target-end
