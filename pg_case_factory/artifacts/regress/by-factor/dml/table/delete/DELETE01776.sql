...
-- primary_obligation_id: DELETE-EXT|01776|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_01776_tbl, delete_01776_src, delete_01776_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_01776_tbl WHERE delete_01776_no_such_col = 1;
-- primary-target-end
