...
-- primary_obligation_id: DELETE-EXT|02930|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_02930_tbl, delete_02930_src, delete_02930_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_02930_tbl WHERE delete_02930_no_such_col = 1;
-- primary-target-end
