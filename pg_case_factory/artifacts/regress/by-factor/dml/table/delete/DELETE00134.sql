...
-- primary_obligation_id: DELETE-EXT|00134|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_00134_tbl, delete_00134_src, delete_00134_ref CASCADE;
RESET ROLE;
...
WITH delete_00134_cte AS (SELECT 1 AS val)
DELETE FROM public.delete_00134_tbl WHERE delete_00134_no_such_col = 1;
-- primary-target-end
