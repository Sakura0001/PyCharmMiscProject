...
-- primary_obligation_id: DELETE-EXT|04345|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_04345_tbl, delete_04345_src, delete_04345_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_04345_tbl" WHERE delete_04345_no_such_col = 1;
-- primary-target-end
