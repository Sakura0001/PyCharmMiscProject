...
-- primary_obligation_id: DELETE-EXT|00194|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_00194_tbl, delete_00194_src, delete_00194_ref CASCADE;
RESET ROLE;
...
WITH delete_00194_cte AS (SELECT 1 AS val)
DELETE FROM delete_00194_tbl WHERE delete_00194_no_such_col = 1;
-- primary-target-end
