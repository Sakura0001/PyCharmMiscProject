...
-- primary_obligation_id: DELETE-EXT|15408|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_15408_tbl, delete_15408_src, delete_15408_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_15408_tbl WHERE delete_15408_no_such_col = 1;
-- primary-target-end
