...
-- primary_obligation_id: DELETE-EXT|01741|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_01741_tbl, delete_01741_src, delete_01741_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_01741_tbl" WHERE delete_01741_no_such_col = 1;
-- primary-target-end
