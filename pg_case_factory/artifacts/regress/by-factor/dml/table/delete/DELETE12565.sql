...
-- primary_obligation_id: DELETE-EXT|12565|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_12565_tbl, delete_12565_src, delete_12565_ref CASCADE;
RESET ROLE;
...
WITH delete_12565_cte AS (SELECT 1 AS val)
DELETE FROM delete_12565_tbl WHERE delete_12565_no_such_col = 1;
-- primary-target-end
