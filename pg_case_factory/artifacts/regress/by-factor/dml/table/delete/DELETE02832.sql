...
-- primary_obligation_id: DELETE-EXT|02832|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_02832_tbl, delete_02832_src, delete_02832_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_02832_tbl WHERE delete_02832_no_such_col = 1;
-- primary-target-end
