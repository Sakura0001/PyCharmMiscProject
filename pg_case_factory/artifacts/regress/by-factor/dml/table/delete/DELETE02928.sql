...
-- primary_obligation_id: DELETE-EXT|02928|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_02928_tbl, delete_02928_src, delete_02928_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_02928_tbl WHERE delete_02928_no_such_col = 1;
-- primary-target-end
