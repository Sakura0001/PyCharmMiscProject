...
-- primary_obligation_id: DELETE-EXT|15098|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_15098_tbl, delete_15098_src, delete_15098_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_15098_tbl" WHERE delete_15098_no_such_col = 1;
-- primary-target-end
