...
-- primary_obligation_id: DELETE-EXT|01608|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_01608_tbl, delete_01608_src, delete_01608_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_01608_tbl AS d WHERE delete_01608_no_such_col = 1;
-- primary-target-end
