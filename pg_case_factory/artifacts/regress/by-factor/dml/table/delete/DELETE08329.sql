...
-- primary_obligation_id: DELETE-EXT|08329|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_08329_tbl, delete_08329_src, delete_08329_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_08329_tbl AS d WHERE id = 999;
-- primary-target-end
