...
-- primary_obligation_id: DELETE-EXT|12434|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_12434_tbl, delete_12434_src, delete_12434_ref CASCADE;
RESET ROLE;
...
WITH delete_12434_cte AS (SELECT 1 AS val)
DELETE FROM public.delete_12434_tbl WHERE delete_12434_no_such_col = 1;
-- primary-target-end
