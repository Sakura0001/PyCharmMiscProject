...
-- primary_obligation_id: DELETE-EXT|12518|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_12518_tbl, delete_12518_src, delete_12518_ref CASCADE;
RESET ROLE;
...
WITH delete_12518_cte AS (SELECT 1 AS val)
DELETE FROM public.delete_12518_tbl WHERE delete_12518_no_such_col = 1;
-- primary-target-end
