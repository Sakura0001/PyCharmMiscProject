...
-- primary_obligation_id: DELETE-EXT|04129|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_04129_tbl, delete_04129_src, delete_04129_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_04129_tbl WHERE delete_04129_no_such_col = 1;
-- primary-target-end
