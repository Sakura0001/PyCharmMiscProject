...
-- primary_obligation_id: DELETE-EXT|03025|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_03025_tbl, delete_03025_src, delete_03025_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_03025_tbl WHERE delete_03025_no_such_col = 1;
-- primary-target-end
