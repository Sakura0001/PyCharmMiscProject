...
-- primary_obligation_id: DELETE-EXT|02917|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_02917_tbl, delete_02917_src, delete_02917_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_02917_tbl WHERE delete_02917_no_such_col = 1;
-- primary-target-end
