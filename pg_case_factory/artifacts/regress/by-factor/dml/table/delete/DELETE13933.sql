...
-- primary_obligation_id: DELETE-EXT|13933|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13933_tbl, delete_13933_src, delete_13933_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_13933_tbl" WHERE delete_13933_no_such_col = 1;
-- primary-target-end
