...
-- primary_obligation_id: DELETE-EXT|01716|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_01716_tbl, delete_01716_src, delete_01716_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_01716_tbl WHERE delete_01716_no_such_col = 1;
-- primary-target-end
