...
-- primary_obligation_id: DELETE-EXT|16741|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_16741_tbl, delete_16741_src, delete_16741_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_16741_tbl WHERE delete_16741_no_such_col = 1;
-- primary-target-end
