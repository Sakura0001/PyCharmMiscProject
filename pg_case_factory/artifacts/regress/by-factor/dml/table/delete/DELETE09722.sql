...
-- primary_obligation_id: DELETE-EXT|09722|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_09722_tbl, delete_09722_src, delete_09722_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_09722_tbl" WHERE id = 999;
-- primary-target-end
