...
-- primary_obligation_id: DELETE-EXT|03120|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_03120_tbl, delete_03120_src, delete_03120_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_03120_tbl WHERE delete_03120_no_such_col = 1;
-- primary-target-end
