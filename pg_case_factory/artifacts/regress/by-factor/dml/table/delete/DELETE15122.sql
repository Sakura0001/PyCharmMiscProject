...
-- primary_obligation_id: DELETE-EXT|15122|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_15122_tbl, delete_15122_src, delete_15122_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_15122_tbl WHERE delete_15122_no_such_col = 1;
-- primary-target-end
