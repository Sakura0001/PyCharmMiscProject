...
-- primary_obligation_id: DELETE-EXT|01490|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_01490_tbl, delete_01490_src, delete_01490_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_01490_tbl WHERE delete_01490_no_such_col = 1;
-- primary-target-end
