...
-- primary_obligation_id: DELETE-EXT|00362|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_00362_tbl, delete_00362_src, delete_00362_ref CASCADE;
RESET ROLE;
...
WITH delete_00362_cte AS (SELECT 1 AS val)
DELETE FROM delete_00362_tbl AS d WHERE delete_00362_no_such_col = 1;
-- primary-target-end
