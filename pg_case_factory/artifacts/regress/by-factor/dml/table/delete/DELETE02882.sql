...
-- primary_obligation_id: DELETE-EXT|02882|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_02882_tbl, delete_02882_src, delete_02882_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_02882_tbl WHERE delete_02882_no_such_col = 1;
-- primary-target-end
