...
-- primary_obligation_id: DELETE-EXT|12481|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_12481_tbl, delete_12481_src, delete_12481_ref CASCADE;
RESET ROLE;
...
WITH delete_12481_cte AS (SELECT 1 AS val)
DELETE FROM delete_12481_tbl WHERE delete_12481_no_such_col = 1;
-- primary-target-end
