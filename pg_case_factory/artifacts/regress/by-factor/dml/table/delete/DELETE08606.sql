...
-- primary_obligation_id: DELETE-EXT|08606|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_08606_tbl, delete_08606_src, delete_08606_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_08606_tbl AS d WHERE id = 999;
-- primary-target-end
