...
-- primary_obligation_id: DELETE-EXT|04296|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_04296_tbl, delete_04296_src, delete_04296_ref CASCADE;
RESET ROLE;
...
DELETE FROM delete_04296_tbl AS d WHERE delete_04296_no_such_col = 1;
-- primary-target-end
