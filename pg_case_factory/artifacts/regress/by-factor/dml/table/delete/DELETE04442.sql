...
-- primary_obligation_id: DELETE-EXT|04442|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_04442_tbl, delete_04442_src, delete_04442_ref CASCADE;
RESET ROLE;
...
DELETE FROM "delete_04442_tbl" WHERE delete_04442_no_such_col = 1;
-- primary-target-end
