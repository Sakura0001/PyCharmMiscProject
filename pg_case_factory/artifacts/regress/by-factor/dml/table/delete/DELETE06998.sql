...
-- primary_obligation_id: DELETE-EXT|06998|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_06998_tbl, delete_06998_src, delete_06998_ref CASCADE;
RESET ROLE;
...
WITH delete_06998_cte AS (SELECT 1 AS val)
DELETE FROM delete_06998_tbl WHERE id = 999;
-- primary-target-end
