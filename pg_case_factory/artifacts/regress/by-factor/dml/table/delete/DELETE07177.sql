...
-- primary_obligation_id: DELETE-EXT|07177|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_07177_tbl, delete_07177_src, delete_07177_ref CASCADE;
RESET ROLE;
...
WITH delete_07177_cte AS (SELECT 1 AS val)
DELETE FROM delete_07177_tbl AS d WHERE id = 999;
-- primary-target-end
