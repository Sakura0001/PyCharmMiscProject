...
-- primary_obligation_id: DELETE-EXT|13776|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS delete_13776_tbl, delete_13776_src, delete_13776_ref CASCADE;
RESET ROLE;
...
DELETE FROM public.delete_13776_tbl WHERE delete_13776_no_such_col = 1;
-- primary-target-end
