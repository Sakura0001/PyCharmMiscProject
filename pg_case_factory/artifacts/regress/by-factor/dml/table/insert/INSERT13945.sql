...
-- primary_obligation_id: INSERT-EXT|13945|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_13945_tbl, insert_13945_src, insert_13945_ref CASCADE;
RESET ROLE;
...
INSERT INTO "insert_13945_tbl" (id, val) VALUES (1, insert_13945_no_such_col);
-- primary-target-end
