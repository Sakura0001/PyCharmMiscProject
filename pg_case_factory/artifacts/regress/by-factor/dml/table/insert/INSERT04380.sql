...
-- primary_obligation_id: INSERT-EXT|04380|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_04380_tbl, insert_04380_src, insert_04380_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_04380_tbl AS i (id, val) SELECT 1, val FROM insert_04380_src;
-- primary-target-end
