...
-- primary_obligation_id: INSERT-EXT|01548|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_01548_tbl, insert_01548_src, insert_01548_ref CASCADE;
RESET ROLE;
...
INSERT INTO "insert_01548_tbl" (id, val) VALUES (1, insert_01548_no_such_col);
-- primary-target-end
