...
-- primary_obligation_id: INSERT-EXT|04238|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_04238_tbl, insert_04238_src, insert_04238_ref CASCADE;
RESET ROLE;
...
INSERT INTO "insert_04238_tbl" (id, val) SELECT 1, val FROM insert_04238_src;
-- primary-target-end
