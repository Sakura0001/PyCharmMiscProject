...
-- primary_obligation_id: INSERT-EXT|09781|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_09781_tbl, insert_09781_src, insert_09781_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_09781_tbl SELECT 1, 100 WHERE false;
-- primary-target-end
