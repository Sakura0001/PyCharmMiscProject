...
-- primary_obligation_id: INSERT-EXT|14053|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_14053_tbl, insert_14053_src, insert_14053_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_14053_tbl (id, val) VALUES (1, insert_14053_no_such_col);
-- primary-target-end
