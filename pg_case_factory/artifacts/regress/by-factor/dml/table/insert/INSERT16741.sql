...
-- primary_obligation_id: INSERT-EXT|16741|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_16741_tbl, insert_16741_src, insert_16741_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_16741_tbl (id, val) SELECT 1, val FROM insert_16741_src;
-- primary-target-end
