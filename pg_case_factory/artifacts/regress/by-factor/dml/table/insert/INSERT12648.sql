...
-- primary_obligation_id: INSERT-EXT|12648|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_12648_tbl, insert_12648_src, insert_12648_ref CASCADE;
RESET ROLE;
...
WITH insert_12648_cte AS (SELECT 1 AS val)
INSERT INTO insert_12648_tbl AS i (id, val) SELECT 1, val FROM insert_12648_cte;
-- primary-target-end
