...
-- primary_obligation_id: INSERT-EXT|01428|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_01428_tbl, insert_01428_src, insert_01428_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_01428_tbl (id, val) VALUES (1, insert_01428_no_such_col);
-- primary-target-end
