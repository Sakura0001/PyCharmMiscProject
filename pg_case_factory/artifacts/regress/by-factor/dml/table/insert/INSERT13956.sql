...
-- primary_obligation_id: INSERT-EXT|13956|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_13956_tbl, insert_13956_src, insert_13956_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_13956_tbl (id, val) VALUES (1, insert_13956_no_such_col);
-- primary-target-end
