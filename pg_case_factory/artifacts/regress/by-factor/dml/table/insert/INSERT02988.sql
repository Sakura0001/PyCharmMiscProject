...
-- primary_obligation_id: INSERT-EXT|02988|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_02988_tbl, insert_02988_src, insert_02988_ref CASCADE;
RESET ROLE;
...
INSERT INTO "insert_02988_tbl" VALUES (1, 100);
-- primary-target-end
