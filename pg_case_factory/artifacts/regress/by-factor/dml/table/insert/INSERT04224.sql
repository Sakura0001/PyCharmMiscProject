...
-- primary_obligation_id: INSERT-EXT|04224|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_04224_tbl, insert_04224_src, insert_04224_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_04224_tbl (id, val) SELECT 1, val FROM insert_04224_src;
-- primary-target-end
