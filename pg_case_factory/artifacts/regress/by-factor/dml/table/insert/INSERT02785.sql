...
-- primary_obligation_id: INSERT-EXT|02785|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_02785_tbl, insert_02785_src, insert_02785_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_02785_tbl VALUES (1, 100);
-- primary-target-end
