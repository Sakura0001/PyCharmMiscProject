...
-- primary_obligation_id: INSERT-EXT|14028|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_14028_tbl, insert_14028_src, insert_14028_ref CASCADE;
RESET ROLE;
...
INSERT INTO "insert_14028_tbl" (id, val) VALUES (1, insert_14028_no_such_col);
-- primary-target-end
