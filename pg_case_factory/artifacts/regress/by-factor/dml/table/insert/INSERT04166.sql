...
-- primary_obligation_id: INSERT-EXT|04166|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_04166_tbl, insert_04166_src, insert_04166_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_04166_tbl (id, val) SELECT 1, val FROM insert_04166_src;
-- primary-target-end
