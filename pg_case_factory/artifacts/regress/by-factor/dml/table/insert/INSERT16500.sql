...
-- primary_obligation_id: INSERT-EXT|16500|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_16500_tbl, insert_16500_src, insert_16500_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_16500_tbl (id, val) SELECT 1, val FROM insert_16500_src;
-- primary-target-end
