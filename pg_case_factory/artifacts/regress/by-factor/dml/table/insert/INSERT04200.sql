...
-- primary_obligation_id: INSERT-EXT|04200|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_04200_tbl, insert_04200_src, insert_04200_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_04200_tbl AS i (id, val) SELECT 1, val FROM insert_04200_src;
-- primary-target-end
