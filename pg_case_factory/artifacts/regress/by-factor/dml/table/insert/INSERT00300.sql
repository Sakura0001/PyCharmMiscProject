...
-- primary_obligation_id: INSERT-EXT|00300|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_00300_tbl, insert_00300_src, insert_00300_ref CASCADE;
RESET ROLE;
...
WITH insert_00300_cte AS (SELECT 1 AS val)
INSERT INTO "insert_00300_tbl" (id, val) SELECT 1, val FROM insert_00300_cte;
-- primary-target-end
