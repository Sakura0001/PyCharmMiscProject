...
-- primary_obligation_id: INSERT-EXT|16453|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_16453_tbl, insert_16453_src, insert_16453_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_16453_tbl (id, val) SELECT 1, val FROM insert_16453_src;
-- primary-target-end
