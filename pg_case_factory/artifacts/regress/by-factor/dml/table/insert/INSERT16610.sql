...
-- primary_obligation_id: INSERT-EXT|16610|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_16610_tbl, insert_16610_src, insert_16610_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_16610_tbl (id, val) SELECT 1, val FROM insert_16610_src;
-- primary-target-end
