...
-- primary_obligation_id: INSERT-EXT|06217|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 23505
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_06217_tbl, insert_06217_src, insert_06217_ref CASCADE;
RESET ROLE;
\set ON_ERROR_STOP on
-- 2. 创建完整本地规则和因子专用夹具。
CREATE TABLE insert_06217_tbl (id int PRIMARY KEY, val int UNIQUE);
INSERT INTO insert_06217_tbl VALUES (1, 100);
\set ON_ERROR_STOP off
-- 3. 执行唯一获得覆盖信用的 INSERT。
-- primary-target-begin
INSERT INTO insert_06217_tbl AS i VALUES (2, 100);
-- primary-target-end
