...
-- primary_obligation_id: INSERT-EXT|04370|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_04370_tbl, insert_04370_src, insert_04370_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_04370_tbl (id, val) SELECT 1, val FROM insert_04370_src;
-- primary-target-end
