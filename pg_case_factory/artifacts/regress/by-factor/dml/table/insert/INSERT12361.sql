...
-- primary_obligation_id: INSERT-EXT|12361|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_12361_tbl, insert_12361_src, insert_12361_ref CASCADE;
RESET ROLE;
...
WITH insert_12361_cte AS (SELECT 1 AS val)
INSERT INTO insert_12361_tbl AS i (id, val) SELECT 1, val FROM insert_12361_cte;
-- primary-target-end
