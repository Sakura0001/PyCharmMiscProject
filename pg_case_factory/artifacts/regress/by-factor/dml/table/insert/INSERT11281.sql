...
-- primary_obligation_id: INSERT-EXT|11281|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_11281_tbl, insert_11281_src, insert_11281_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_11281_tbl (id, val) SELECT 1, 100 WHERE false;
-- primary-target-end
