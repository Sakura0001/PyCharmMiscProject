...
-- primary_obligation_id: INSERT-EXT|13741|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_13741_tbl, insert_13741_src, insert_13741_ref CASCADE;
RESET ROLE;
...
INSERT INTO "insert_13741_tbl" (id, val) VALUES (1, insert_13741_no_such_col);
-- primary-target-end
