...
-- primary_obligation_id: INSERT-EXT|12660|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_12660_tbl, insert_12660_src, insert_12660_ref CASCADE;
RESET ROLE;
...
WITH insert_12660_cte AS (SELECT 1 AS val)
INSERT INTO insert_12660_tbl (id, val) SELECT 1, val FROM insert_12660_cte;
-- primary-target-end
