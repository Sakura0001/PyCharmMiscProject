...
-- primary_obligation_id: INSERT-EXT|00242|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_00242_tbl, insert_00242_src, insert_00242_ref CASCADE;
RESET ROLE;
...
WITH insert_00242_cte AS (SELECT 1 AS val)
INSERT INTO public.insert_00242_tbl (id, val) SELECT 1, val FROM insert_00242_cte;
-- primary-target-end
