...
-- primary_obligation_id: INSERT-EXT|04464|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_04464_tbl, insert_04464_src, insert_04464_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_04464_tbl (id, val) SELECT 1, val FROM insert_04464_src;
-- primary-target-end
