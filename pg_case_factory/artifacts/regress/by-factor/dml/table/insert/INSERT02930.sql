...
-- primary_obligation_id: INSERT-EXT|02930|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_02930_tbl, insert_02930_src, insert_02930_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_02930_tbl VALUES (1, 100);
-- primary-target-end
