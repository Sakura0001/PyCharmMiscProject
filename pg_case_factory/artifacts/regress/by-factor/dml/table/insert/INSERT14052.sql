...
-- primary_obligation_id: INSERT-EXT|14052|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_14052_tbl, insert_14052_src, insert_14052_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_14052_tbl (id, val) VALUES (1, insert_14052_no_such_col);
-- primary-target-end
