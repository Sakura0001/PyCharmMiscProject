...
-- primary_obligation_id: INSERT-EXT|02833|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_02833_tbl, insert_02833_src, insert_02833_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_02833_tbl VALUES (1, 100);
-- primary-target-end
