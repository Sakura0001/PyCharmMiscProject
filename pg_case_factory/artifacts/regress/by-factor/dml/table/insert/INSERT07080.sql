...
-- primary_obligation_id: INSERT-EXT|07080|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_07080_tbl, insert_07080_src, insert_07080_ref CASCADE;
RESET ROLE;
...
WITH insert_07080_cte AS (SELECT 1 AS val)
INSERT INTO insert_07080_tbl AS i (id, val) SELECT 1, 100 WHERE false;
-- primary-target-end
