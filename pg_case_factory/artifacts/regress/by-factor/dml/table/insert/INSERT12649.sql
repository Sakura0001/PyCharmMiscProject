...
-- primary_obligation_id: INSERT-EXT|12649|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_12649_tbl, insert_12649_src, insert_12649_ref CASCADE;
RESET ROLE;
...
WITH insert_12649_cte AS (SELECT 1 AS val)
INSERT INTO insert_12649_tbl AS i (id, val) SELECT 1, val FROM insert_12649_cte;
-- primary-target-end
