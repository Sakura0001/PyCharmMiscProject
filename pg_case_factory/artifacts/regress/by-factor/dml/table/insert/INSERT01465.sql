...
-- primary_obligation_id: INSERT-EXT|01465|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_01465_tbl, insert_01465_src, insert_01465_ref CASCADE;
RESET ROLE;
...
INSERT INTO "insert_01465_tbl" (id, val) VALUES (1, insert_01465_no_such_col);
-- primary-target-end
