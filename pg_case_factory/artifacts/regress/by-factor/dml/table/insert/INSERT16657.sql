...
-- primary_obligation_id: INSERT-EXT|16657|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_16657_tbl, insert_16657_src, insert_16657_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_16657_tbl (id, val) SELECT 1, val FROM insert_16657_src;
-- primary-target-end
