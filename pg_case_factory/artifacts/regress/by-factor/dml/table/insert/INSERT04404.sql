...
-- primary_obligation_id: INSERT-EXT|04404|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_04404_tbl, insert_04404_src, insert_04404_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_04404_tbl (id, val) SELECT 1, val FROM insert_04404_src;
-- primary-target-end
