...
-- primary_obligation_id: INSERT-EXT|01740|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_01740_tbl, insert_01740_src, insert_01740_ref CASCADE;
RESET ROLE;
...
INSERT INTO "insert_01740_tbl" (id, val) VALUES (1, insert_01740_no_such_col);
-- primary-target-end
