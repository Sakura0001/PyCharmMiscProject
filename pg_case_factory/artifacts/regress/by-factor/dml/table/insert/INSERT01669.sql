...
-- primary_obligation_id: INSERT-EXT|01669|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_01669_tbl, insert_01669_src, insert_01669_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_01669_tbl (id, val) VALUES (1, insert_01669_no_such_col);
-- primary-target-end
