...
-- primary_obligation_id: INSERT-EXT|04418|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_04418_tbl, insert_04418_src, insert_04418_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_04418_tbl (id, val) SELECT 1, val FROM insert_04418_src;
-- primary-target-end
