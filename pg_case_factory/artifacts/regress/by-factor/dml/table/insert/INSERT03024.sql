...
-- primary_obligation_id: INSERT-EXT|03024|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_03024_tbl, insert_03024_src, insert_03024_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_03024_tbl VALUES (1, 100);
-- primary-target-end
