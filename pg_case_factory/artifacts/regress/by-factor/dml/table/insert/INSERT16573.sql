...
-- primary_obligation_id: INSERT-EXT|16573|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_16573_tbl, insert_16573_src, insert_16573_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_16573_tbl AS i (id, val) SELECT 1, val FROM insert_16573_src;
-- primary-target-end
