...
-- primary_obligation_id: INSERT-EXT|06984|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_06984_tbl, insert_06984_src, insert_06984_ref CASCADE;
RESET ROLE;
...
WITH insert_06984_cte AS (SELECT 1 AS val)
INSERT INTO insert_06984_tbl AS i (id, val) SELECT 1, 100 WHERE false;
-- primary-target-end
