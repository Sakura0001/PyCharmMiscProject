...
-- primary_obligation_id: INSERT-EXT|01777|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_01777_tbl, insert_01777_src, insert_01777_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_01777_tbl (id, val) VALUES (1, insert_01777_no_such_col);
-- primary-target-end
