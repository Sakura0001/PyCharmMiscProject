...
-- primary_obligation_id: INSERT-EXT|00325|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_00325_tbl, insert_00325_src, insert_00325_ref CASCADE;
RESET ROLE;
...
WITH insert_00325_cte AS (SELECT 1 AS val)
INSERT INTO public.insert_00325_tbl (id, val) SELECT 1, val FROM insert_00325_cte;
-- primary-target-end
