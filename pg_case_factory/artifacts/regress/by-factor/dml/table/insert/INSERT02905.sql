...
-- primary_obligation_id: INSERT-EXT|02905|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_02905_tbl, insert_02905_src, insert_02905_ref CASCADE;
RESET ROLE;
...
INSERT INTO "insert_02905_tbl" VALUES (1, 100);
-- primary-target-end
