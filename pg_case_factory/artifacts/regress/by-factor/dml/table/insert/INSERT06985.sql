...
-- primary_obligation_id: INSERT-EXT|06985|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_06985_tbl, insert_06985_src, insert_06985_ref CASCADE;
RESET ROLE;
...
WITH insert_06985_cte AS (SELECT 1 AS val)
INSERT INTO insert_06985_tbl AS i (id, val) SELECT 1, 100 WHERE false;
-- primary-target-end
