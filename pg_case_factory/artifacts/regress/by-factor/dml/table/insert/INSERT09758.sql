...
-- primary_obligation_id: INSERT-EXT|09758|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_09758_tbl, insert_09758_src, insert_09758_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_09758_tbl AS i SELECT 1, 100 WHERE false;
-- primary-target-end
