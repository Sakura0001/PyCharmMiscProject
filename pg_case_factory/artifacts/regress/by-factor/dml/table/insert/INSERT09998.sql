...
-- primary_obligation_id: INSERT-EXT|09998|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_09998_tbl, insert_09998_src, insert_09998_ref CASCADE;
RESET ROLE;
...
INSERT INTO "insert_09998_tbl" SELECT 1, 100 WHERE false;
-- primary-target-end
