...
-- primary_obligation_id: INSERT-EXT|00230|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_00230_tbl, insert_00230_src, insert_00230_ref CASCADE;
RESET ROLE;
...
WITH insert_00230_cte AS (SELECT 1 AS val)
INSERT INTO public.insert_00230_tbl (id, val) SELECT 1, val FROM insert_00230_cte;
-- primary-target-end
