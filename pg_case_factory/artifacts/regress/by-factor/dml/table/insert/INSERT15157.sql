...
-- primary_obligation_id: INSERT-EXT|15157|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_15157_tbl, insert_15157_src, insert_15157_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_15157_tbl VALUES (1, 100);
-- primary-target-end
