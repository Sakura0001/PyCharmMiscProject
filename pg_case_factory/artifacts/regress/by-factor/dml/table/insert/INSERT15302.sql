...
-- primary_obligation_id: INSERT-EXT|15302|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_15302_tbl, insert_15302_src, insert_15302_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_15302_tbl VALUES (1, 100);
-- primary-target-end
