...
-- primary_obligation_id: INSERT-EXT|07176|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_07176_tbl, insert_07176_src, insert_07176_ref CASCADE;
RESET ROLE;
...
WITH insert_07176_cte AS (SELECT 1 AS val)
INSERT INTO insert_07176_tbl AS i (id, val) SELECT 1, 100 WHERE false;
-- primary-target-end
