...
-- primary_obligation_id: INSERT-EXT|04394|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_04394_tbl, insert_04394_src, insert_04394_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_04394_tbl AS i (id, val) SELECT 1, val FROM insert_04394_src;
-- primary-target-end
