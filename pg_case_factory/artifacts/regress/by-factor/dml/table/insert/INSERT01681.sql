...
-- primary_obligation_id: INSERT-EXT|01681|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_01681_tbl, insert_01681_src, insert_01681_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_01681_tbl (id, val) VALUES (1, insert_01681_no_such_col);
-- primary-target-end
