...
-- primary_obligation_id: INSERT-EXT|13946|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_13946_tbl, insert_13946_src, insert_13946_ref CASCADE;
RESET ROLE;
...
INSERT INTO "insert_13946_tbl" (id, val) VALUES (1, insert_13946_no_such_col);
-- primary-target-end
