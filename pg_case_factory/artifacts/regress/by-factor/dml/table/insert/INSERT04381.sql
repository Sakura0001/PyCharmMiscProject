...
-- primary_obligation_id: INSERT-EXT|04381|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_04381_tbl, insert_04381_src, insert_04381_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_04381_tbl AS i (id, val) SELECT 1, val FROM insert_04381_src;
-- primary-target-end
