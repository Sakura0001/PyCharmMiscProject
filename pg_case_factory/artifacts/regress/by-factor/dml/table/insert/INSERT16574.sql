...
-- primary_obligation_id: INSERT-EXT|16574|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_16574_tbl, insert_16574_src, insert_16574_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_16574_tbl AS i (id, val) SELECT 1, val FROM insert_16574_src;
-- primary-target-end
