...
-- primary_obligation_id: INSERT-EXT|08546|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_08546_tbl, insert_08546_src, insert_08546_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_08546_tbl (id, val) SELECT 1, 100 WHERE false;
-- primary-target-end
