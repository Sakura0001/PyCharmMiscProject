...
-- primary_obligation_id: INSERT-EXT|06997|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_06997_tbl, insert_06997_src, insert_06997_ref CASCADE;
RESET ROLE;
...
WITH insert_06997_cte AS (SELECT 1 AS val)
INSERT INTO insert_06997_tbl (id, val) SELECT 1, 100 WHERE false;
-- primary-target-end
