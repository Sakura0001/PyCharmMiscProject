...
-- primary_obligation_id: INSERT-EXT|11006|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_11006_tbl, insert_11006_src, insert_11006_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_11006_tbl AS i (id, val) SELECT 1, 100 WHERE false;
-- primary-target-end
