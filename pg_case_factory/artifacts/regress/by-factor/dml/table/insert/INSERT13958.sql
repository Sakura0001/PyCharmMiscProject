...
-- primary_obligation_id: INSERT-EXT|13958|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_13958_tbl, insert_13958_src, insert_13958_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_13958_tbl (id, val) VALUES (1, insert_13958_no_such_col);
-- primary-target-end
