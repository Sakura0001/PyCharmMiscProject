...
-- primary_obligation_id: INSERT-EXT|13789|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_13789_tbl, insert_13789_src, insert_13789_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_13789_tbl AS i (id, val) VALUES (1, insert_13789_no_such_col);
-- primary-target-end
