...
-- primary_obligation_id: INSERT-EXT|09685|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_09685_tbl, insert_09685_src, insert_09685_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_09685_tbl SELECT 1, 100 WHERE false;
-- primary-target-end
