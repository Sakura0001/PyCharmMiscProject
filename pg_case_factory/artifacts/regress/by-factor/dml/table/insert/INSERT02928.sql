...
-- primary_obligation_id: INSERT-EXT|02928|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_02928_tbl, insert_02928_src, insert_02928_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_02928_tbl VALUES (1, 100);
-- primary-target-end
