...
-- primary_obligation_id: INSERT-EXT|14017|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_14017_tbl, insert_14017_src, insert_14017_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_14017_tbl (id, val) VALUES (1, insert_14017_no_such_col);
-- primary-target-end
