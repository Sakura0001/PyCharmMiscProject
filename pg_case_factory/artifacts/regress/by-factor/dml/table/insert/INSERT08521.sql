...
-- primary_obligation_id: INSERT-EXT|08521|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_08521_tbl, insert_08521_src, insert_08521_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_08521_tbl AS i (id, val) SELECT 1, 100 WHERE false;
-- primary-target-end
