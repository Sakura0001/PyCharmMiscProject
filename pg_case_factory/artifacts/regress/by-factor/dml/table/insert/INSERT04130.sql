...
-- primary_obligation_id: INSERT-EXT|04130|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_04130_tbl, insert_04130_src, insert_04130_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_04130_tbl (id, val) SELECT 1, val FROM insert_04130_src;
-- primary-target-end
