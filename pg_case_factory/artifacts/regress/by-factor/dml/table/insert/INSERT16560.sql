...
-- primary_obligation_id: INSERT-EXT|16560|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_16560_tbl, insert_16560_src, insert_16560_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_16560_tbl (id, val) SELECT 1, val FROM insert_16560_src;
-- primary-target-end
