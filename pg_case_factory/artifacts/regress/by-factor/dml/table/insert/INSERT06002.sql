...
-- primary_obligation_id: INSERT-EXT|06002|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 23505
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_06002_tbl, insert_06002_src, insert_06002_ref CASCADE;
RESET ROLE;
\set ON_ERROR_STOP on
-- 2. 创建完整本地规则和因子专用夹具。
CREATE TABLE insert_06002_tbl (id int PRIMARY KEY, val int UNIQUE);
INSERT INTO insert_06002_tbl VALUES (1, 100);
\set ON_ERROR_STOP off
-- 3. 执行唯一获得覆盖信用的 INSERT。
-- primary-target-begin
INSERT INTO public.insert_06002_tbl (id, val) VALUES (2, 100);
-- primary-target-end
