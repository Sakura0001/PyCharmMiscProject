...
-- primary_obligation_id: INSERT-EXT|01501|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_01501_tbl, insert_01501_src, insert_01501_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_01501_tbl AS i (id, val) VALUES (1, insert_01501_no_such_col);
-- primary-target-end
