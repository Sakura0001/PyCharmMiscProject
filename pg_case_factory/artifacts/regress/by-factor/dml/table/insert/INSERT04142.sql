...
-- primary_obligation_id: INSERT-EXT|04142|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_04142_tbl, insert_04142_src, insert_04142_ref CASCADE;
RESET ROLE;
...
INSERT INTO "insert_04142_tbl" (id, val) SELECT 1, val FROM insert_04142_src;
-- primary-target-end
