...
-- primary_obligation_id: INSERT-EXT|01598|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_01598_tbl, insert_01598_src, insert_01598_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_01598_tbl AS i (id, val) VALUES (1, insert_01598_no_such_col);
-- primary-target-end
