...
-- primary_obligation_id: INSERT-EXT|07344|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_07344_tbl, insert_07344_src, insert_07344_ref CASCADE;
RESET ROLE;
...
WITH insert_07344_cte AS (SELECT 1 AS val)
INSERT INTO public.insert_07344_tbl (id, val) SELECT 1, 100 WHERE false;
-- primary-target-end
