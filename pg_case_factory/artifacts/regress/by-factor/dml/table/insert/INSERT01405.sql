...
-- primary_obligation_id: INSERT-EXT|01405|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_01405_tbl, insert_01405_src, insert_01405_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_01405_tbl AS i (id, val) VALUES (1, insert_01405_no_such_col);
-- primary-target-end
