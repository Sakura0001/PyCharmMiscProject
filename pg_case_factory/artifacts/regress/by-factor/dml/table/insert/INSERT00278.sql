...
-- primary_obligation_id: INSERT-EXT|00278|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_00278_tbl, insert_00278_src, insert_00278_ref CASCADE;
RESET ROLE;
...
WITH insert_00278_cte AS (SELECT 1 AS val)
INSERT INTO insert_00278_tbl (id, val) SELECT 1, val FROM insert_00278_cte;
-- primary-target-end
