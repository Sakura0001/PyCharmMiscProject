...
-- primary_obligation_id: INSERT-EXT|16754|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_16754_tbl, insert_16754_src, insert_16754_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_16754_tbl (id, val) SELECT 1, val FROM insert_16754_src;
-- primary-target-end
