...
-- primary_obligation_id: INSERT-EXT|08652|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_08652_tbl, insert_08652_src, insert_08652_ref CASCADE;
RESET ROLE;
...
INSERT INTO "insert_08652_tbl" (id, val) SELECT 1, 100 WHERE false;
-- primary-target-end
