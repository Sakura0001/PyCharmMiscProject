...
-- primary_obligation_id: INSERT-EXT|14065|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_14065_tbl, insert_14065_src, insert_14065_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_14065_tbl (id, val) VALUES (1, insert_14065_no_such_col);
-- primary-target-end
