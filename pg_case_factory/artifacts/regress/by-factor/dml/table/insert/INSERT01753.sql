...
-- primary_obligation_id: INSERT-EXT|01753|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_01753_tbl, insert_01753_src, insert_01753_ref CASCADE;
RESET ROLE;
...
INSERT INTO "insert_01753_tbl" (id, val) VALUES (1, insert_01753_no_such_col);
-- primary-target-end
