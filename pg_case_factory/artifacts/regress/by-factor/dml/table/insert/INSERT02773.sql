...
-- primary_obligation_id: INSERT-EXT|02773|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_02773_tbl, insert_02773_src, insert_02773_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_02773_tbl VALUES (1, 100);
-- primary-target-end
