...
-- primary_obligation_id: INSERT-EXT|16382|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_16382_tbl, insert_16382_src, insert_16382_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_16382_tbl AS i (id, val) SELECT 1, val FROM insert_16382_src;
-- primary-target-end
