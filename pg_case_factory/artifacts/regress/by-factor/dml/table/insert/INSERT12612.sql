...
-- primary_obligation_id: INSERT-EXT|12612|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_12612_tbl, insert_12612_src, insert_12612_ref CASCADE;
RESET ROLE;
...
WITH insert_12612_cte AS (SELECT 1 AS val)
INSERT INTO public.insert_12612_tbl (id, val) SELECT 1, val FROM insert_12612_cte;
-- primary-target-end
