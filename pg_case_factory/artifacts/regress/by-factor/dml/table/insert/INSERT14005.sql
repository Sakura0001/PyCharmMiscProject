...
-- primary_obligation_id: INSERT-EXT|14005|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_14005_tbl, insert_14005_src, insert_14005_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_14005_tbl (id, val) VALUES (1, insert_14005_no_such_col);
-- primary-target-end
