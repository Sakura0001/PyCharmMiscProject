...
-- primary_obligation_id: INSERT-EXT|01440|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_01440_tbl, insert_01440_src, insert_01440_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_01440_tbl (id, val) VALUES (1, insert_01440_no_such_col);
-- primary-target-end
