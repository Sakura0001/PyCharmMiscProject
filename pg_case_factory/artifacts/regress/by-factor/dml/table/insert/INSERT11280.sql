...
-- primary_obligation_id: INSERT-EXT|11280|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_11280_tbl, insert_11280_src, insert_11280_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_11280_tbl (id, val) SELECT 1, 100 WHERE false;
-- primary-target-end
