...
-- primary_obligation_id: INSERT-EXT|00133|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_00133_tbl, insert_00133_src, insert_00133_ref CASCADE;
RESET ROLE;
...
WITH insert_00133_cte AS (SELECT 1 AS val)
INSERT INTO public.insert_00133_tbl (id, val) SELECT 1, val FROM insert_00133_cte;
-- primary-target-end
