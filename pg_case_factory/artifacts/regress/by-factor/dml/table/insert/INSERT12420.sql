...
-- primary_obligation_id: INSERT-EXT|12420|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_12420_tbl, insert_12420_src, insert_12420_ref CASCADE;
RESET ROLE;
...
WITH insert_12420_cte AS (SELECT 1 AS val)
INSERT INTO public.insert_12420_tbl (id, val) SELECT 1, val FROM insert_12420_cte;
-- primary-target-end
