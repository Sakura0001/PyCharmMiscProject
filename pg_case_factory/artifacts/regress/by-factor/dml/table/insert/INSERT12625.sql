...
-- primary_obligation_id: INSERT-EXT|12625|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_12625_tbl, insert_12625_src, insert_12625_ref CASCADE;
RESET ROLE;
...
WITH insert_12625_cte AS (SELECT 1 AS val)
INSERT INTO public.insert_12625_tbl (id, val) SELECT 1, val FROM insert_12625_cte;
-- primary-target-end
