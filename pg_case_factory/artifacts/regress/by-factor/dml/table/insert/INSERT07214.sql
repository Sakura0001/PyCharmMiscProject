...
-- primary_obligation_id: INSERT-EXT|07214|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_07214_tbl, insert_07214_src, insert_07214_ref CASCADE;
RESET ROLE;
...
WITH insert_07214_cte AS (SELECT 1 AS val)
INSERT INTO "insert_07214_tbl" (id, val) SELECT 1, 100 WHERE false;
-- primary-target-end
