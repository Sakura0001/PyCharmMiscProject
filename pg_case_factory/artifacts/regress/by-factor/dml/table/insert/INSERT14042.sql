...
-- primary_obligation_id: INSERT-EXT|14042|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_14042_tbl, insert_14042_src, insert_14042_ref CASCADE;
RESET ROLE;
...
INSERT INTO "insert_14042_tbl" (id, val) VALUES (1, insert_14042_no_such_col);
-- primary-target-end
