...
-- primary_obligation_id: INSERT-EXT|04368|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_04368_tbl, insert_04368_src, insert_04368_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_04368_tbl (id, val) SELECT 1, val FROM insert_04368_src;
-- primary-target-end
