...
-- primary_obligation_id: INSERT-EXT|04105|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_04105_tbl, insert_04105_src, insert_04105_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_04105_tbl AS i (id, val) SELECT 1, val FROM insert_04105_src;
-- primary-target-end
