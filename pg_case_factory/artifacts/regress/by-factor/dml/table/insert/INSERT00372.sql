...
-- primary_obligation_id: INSERT-EXT|00372|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_00372_tbl, insert_00372_src, insert_00372_ref CASCADE;
RESET ROLE;
...
WITH insert_00372_cte AS (SELECT 1 AS val)
INSERT INTO insert_00372_tbl (id, val) SELECT 1, val FROM insert_00372_cte;
-- primary-target-end
