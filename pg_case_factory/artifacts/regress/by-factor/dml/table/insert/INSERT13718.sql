...
-- primary_obligation_id: INSERT-EXT|13718|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_13718_tbl, insert_13718_src, insert_13718_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_13718_tbl (id, val) VALUES (1, insert_13718_no_such_col);
-- primary-target-end
