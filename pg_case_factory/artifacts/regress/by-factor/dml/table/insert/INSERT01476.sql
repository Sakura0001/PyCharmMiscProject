...
-- primary_obligation_id: INSERT-EXT|01476|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_01476_tbl, insert_01476_src, insert_01476_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_01476_tbl (id, val) VALUES (1, insert_01476_no_such_col);
-- primary-target-end
