...
-- primary_obligation_id: INSERT-EXT|06974|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_06974_tbl, insert_06974_src, insert_06974_ref CASCADE;
RESET ROLE;
...
WITH insert_06974_cte AS (SELECT 1 AS val)
INSERT INTO insert_06974_tbl AS i (id, val) SELECT 1, 100 WHERE false;
-- primary-target-end
