...
-- primary_obligation_id: INSERT-EXT|07320|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_07320_tbl, insert_07320_src, insert_07320_ref CASCADE;
RESET ROLE;
...
WITH insert_07320_cte AS (SELECT 1 AS val)
INSERT INTO "insert_07320_tbl" (id, val) SELECT 1, 100 WHERE false;
-- primary-target-end
