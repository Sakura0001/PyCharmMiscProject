...
-- primary_obligation_id: INSERT-EXT|01694|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_01694_tbl, insert_01694_src, insert_01694_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_01694_tbl AS i (id, val) VALUES (1, insert_01694_no_such_col);
-- primary-target-end
