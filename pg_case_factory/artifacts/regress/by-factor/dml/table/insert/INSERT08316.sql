...
-- primary_obligation_id: INSERT-EXT|08316|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_08316_tbl, insert_08316_src, insert_08316_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_08316_tbl AS i (id, val) SELECT 1, 100 WHERE false;
-- primary-target-end
