...
-- primary_obligation_id: INSERT-EXT|14066|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_14066_tbl, insert_14066_src, insert_14066_ref CASCADE;
RESET ROLE;
...
INSERT INTO public.insert_14066_tbl (id, val) VALUES (1, insert_14066_no_such_col);
-- primary-target-end
