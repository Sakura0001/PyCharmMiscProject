...
-- primary_obligation_id: INSERT-EXT|15350|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_15350_tbl, insert_15350_src, insert_15350_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_15350_tbl VALUES (1, 100);
-- primary-target-end
