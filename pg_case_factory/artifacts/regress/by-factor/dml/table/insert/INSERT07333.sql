...
-- primary_obligation_id: INSERT-EXT|07333|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_07333_tbl, insert_07333_src, insert_07333_ref CASCADE;
RESET ROLE;
...
WITH insert_07333_cte AS (SELECT 1 AS val)
INSERT INTO public.insert_07333_tbl (id, val) SELECT 1, 100 WHERE false;
-- primary-target-end
