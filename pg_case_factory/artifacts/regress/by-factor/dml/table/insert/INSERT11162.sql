...
-- primary_obligation_id: INSERT-EXT|11162|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_11162_tbl, insert_11162_src, insert_11162_ref CASCADE;
RESET ROLE;
...
INSERT INTO "insert_11162_tbl" (id, val) SELECT 1, 100 WHERE false;
-- primary-target-end
