...
-- primary_obligation_id: INSERT-EXT|11208|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS insert_11208_tbl, insert_11208_src, insert_11208_ref CASCADE;
RESET ROLE;
...
INSERT INTO insert_11208_tbl AS i (id, val) SELECT 1, 100 WHERE false;
-- primary-target-end
