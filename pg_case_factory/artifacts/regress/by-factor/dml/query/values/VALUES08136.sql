...
-- primary_obligation_id: VALUES-EXT|08136|error_assertion|drop_objects
...
WITH values_08136_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08136_cte)) ORDER BY column1;
-- primary-target-end
