...
-- primary_obligation_id: VALUES-EXT|13539|catalog_query|drop_objects
...
WITH values_13539_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13539_cte)) ORDER BY column1;
-- primary-target-end
