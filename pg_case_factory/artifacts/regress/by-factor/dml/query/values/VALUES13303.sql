...
-- primary_obligation_id: VALUES-EXT|13303|effect_query|reset_state
...
WITH values_13303_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13303_cte)) ORDER BY column1;
-- primary-target-end
