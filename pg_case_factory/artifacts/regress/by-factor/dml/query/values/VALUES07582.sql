...
-- primary_obligation_id: VALUES-EXT|07582|returned_rows|reset_state
...
WITH values_07582_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07582_cte)) ORDER BY column1;
-- primary-target-end
