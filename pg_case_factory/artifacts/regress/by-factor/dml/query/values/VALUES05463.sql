...
-- primary_obligation_id: VALUES-EXT|05463|catalog_query|drop_objects
...
WITH values_05463_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05463_cte)) ORDER BY column1;
-- primary-target-end
