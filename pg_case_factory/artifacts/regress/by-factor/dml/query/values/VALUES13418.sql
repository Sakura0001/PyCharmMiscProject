...
-- primary_obligation_id: VALUES-EXT|13418|catalog_query|rollback
...
WITH values_13418_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13418_cte)) ORDER BY column1;
-- primary-target-end
