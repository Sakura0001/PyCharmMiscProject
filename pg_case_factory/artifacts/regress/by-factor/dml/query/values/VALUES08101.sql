...
-- primary_obligation_id: VALUES-EXT|08101|error_assertion|reset_state
...
WITH values_08101_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08101_cte)) ORDER BY column1;
-- primary-target-end
