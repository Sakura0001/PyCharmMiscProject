...
-- primary_obligation_id: VALUES-EXT|07703|error_assertion|rollback
...
WITH values_07703_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07703_cte)) ORDER BY column1;
-- primary-target-end
