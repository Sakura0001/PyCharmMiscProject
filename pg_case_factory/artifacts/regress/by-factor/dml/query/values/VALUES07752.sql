...
-- primary_obligation_id: VALUES-EXT|07752|error_assertion|drop_objects
...
WITH values_07752_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07752_cte)) ORDER BY column1;
-- primary-target-end
