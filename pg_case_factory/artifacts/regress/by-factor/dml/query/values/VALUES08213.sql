...
-- primary_obligation_id: VALUES-EXT|08213|effect_query|rollback
...
WITH values_08213_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08213_cte)) ORDER BY column1;
-- primary-target-end
