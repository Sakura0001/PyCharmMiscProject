...
-- primary_obligation_id: VALUES-EXT|07585|error_assertion|reset_state
...
WITH values_07585_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07585_cte)) ORDER BY column1;
-- primary-target-end
