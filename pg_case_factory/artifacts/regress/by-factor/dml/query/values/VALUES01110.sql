...
-- primary_obligation_id: VALUES-EXT|01110|effect_query|drop_objects
...
WITH values_01110_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01110_cte)) ORDER BY column1;
-- primary-target-end
