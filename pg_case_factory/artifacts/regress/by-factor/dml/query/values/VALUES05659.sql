...
-- primary_obligation_id: VALUES-EXT|05659|effect_query|reset_state
...
WITH values_05659_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05659_cte)) ORDER BY column1;
-- primary-target-end
