...
-- primary_obligation_id: VALUES-EXT|12917|effect_query|rollback
...
WITH values_12917_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12917_cte)) ORDER BY column1;
-- primary-target-end
