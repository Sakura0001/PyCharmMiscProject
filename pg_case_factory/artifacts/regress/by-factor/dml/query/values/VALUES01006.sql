...
-- primary_obligation_id: VALUES-EXT|01006|returned_rows|reset_state
...
WITH values_01006_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01006_cte)) ORDER BY column1;
-- primary-target-end
