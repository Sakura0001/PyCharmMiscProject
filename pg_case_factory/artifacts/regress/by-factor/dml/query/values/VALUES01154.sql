...
-- primary_obligation_id: VALUES-EXT|01154|catalog_query|rollback
...
WITH values_01154_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01154_cte)) ORDER BY column1;
-- primary-target-end
