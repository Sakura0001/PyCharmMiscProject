...
-- primary_obligation_id: VALUES-EXT|01010|catalog_query|rollback
...
WITH values_01010_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01010_cte)) ORDER BY column1;
-- primary-target-end
