...
-- primary_obligation_id: VALUES-EXT|05434|returned_rows|reset_state
...
WITH values_05434_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05434_cte)) ORDER BY column1;
-- primary-target-end
