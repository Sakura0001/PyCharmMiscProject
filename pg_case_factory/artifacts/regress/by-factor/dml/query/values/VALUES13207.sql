...
-- primary_obligation_id: VALUES-EXT|13207|effect_query|reset_state
...
WITH values_13207_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13207_cte)) ORDER BY column1;
-- primary-target-end
