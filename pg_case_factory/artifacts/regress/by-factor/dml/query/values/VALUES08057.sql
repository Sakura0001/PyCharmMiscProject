...
-- primary_obligation_id: VALUES-EXT|08057|effect_query|rollback
...
WITH values_08057_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08057_cte)) ORDER BY column1;
-- primary-target-end
