...
-- primary_obligation_id: VALUES-EXT|01002|effect_query|drop_objects
...
WITH values_01002_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01002_cte)) ORDER BY column1;
-- primary-target-end
