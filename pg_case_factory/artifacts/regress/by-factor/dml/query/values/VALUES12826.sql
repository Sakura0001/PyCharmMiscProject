...
-- primary_obligation_id: VALUES-EXT|12826|returned_rows|reset_state
...
WITH values_12826_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12826_cte)) ORDER BY column1;
-- primary-target-end
