...
-- primary_obligation_id: VALUES-EXT|12836|returned_rows|rollback
...
WITH values_12836_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12836_cte)) ORDER BY column1;
-- primary-target-end
