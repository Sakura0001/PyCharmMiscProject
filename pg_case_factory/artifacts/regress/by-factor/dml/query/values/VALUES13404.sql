...
-- primary_obligation_id: VALUES-EXT|13404|error_assertion|drop_objects
...
WITH values_13404_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13404_cte)) ORDER BY column1;
-- primary-target-end
