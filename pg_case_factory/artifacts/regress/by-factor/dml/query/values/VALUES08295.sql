...
-- primary_obligation_id: VALUES-EXT|08295|catalog_query|drop_objects
...
WITH values_08295_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08295_cte)) ORDER BY column1;
-- primary-target-end
