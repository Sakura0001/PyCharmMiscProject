...
-- primary_obligation_id: VALUES-EXT|01248|error_assertion|drop_objects
...
WITH values_01248_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01248_cte)) ORDER BY column1;
-- primary-target-end
