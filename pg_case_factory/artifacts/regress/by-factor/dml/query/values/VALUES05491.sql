...
-- primary_obligation_id: VALUES-EXT|05491|effect_query|reset_state
...
WITH values_05491_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05491_cte)) ORDER BY column1;
-- primary-target-end
