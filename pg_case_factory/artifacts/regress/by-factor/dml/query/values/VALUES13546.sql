...
-- primary_obligation_id: VALUES-EXT|13546|returned_rows|reset_state
...
WITH values_13546_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13546_cte)) ORDER BY column1;
-- primary-target-end
