...
-- primary_obligation_id: VALUES-EXT|01051|effect_query|reset_state
...
WITH values_01051_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01051_cte)) ORDER BY column1;
-- primary-target-end
