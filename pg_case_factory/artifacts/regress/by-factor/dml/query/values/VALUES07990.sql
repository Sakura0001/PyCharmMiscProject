...
-- primary_obligation_id: VALUES-EXT|07990|returned_rows|reset_state
...
WITH values_07990_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07990_cte)) ORDER BY column1;
-- primary-target-end
