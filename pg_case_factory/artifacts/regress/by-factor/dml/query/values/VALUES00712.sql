...
-- primary_obligation_id: VALUES-EXT|00712|catalog_query|reset_state
...
WITH values_00712_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00712_cte)) ORDER BY column1;
-- primary-target-end
