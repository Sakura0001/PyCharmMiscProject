...
-- primary_obligation_id: VALUES-EXT|08111|error_assertion|rollback
...
WITH values_08111_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08111_cte)) ORDER BY column1;
-- primary-target-end
