...
-- primary_obligation_id: VALUES-EXT|00634|returned_rows|reset_state
...
WITH values_00634_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00634_cte)) ORDER BY column1;
-- primary-target-end
