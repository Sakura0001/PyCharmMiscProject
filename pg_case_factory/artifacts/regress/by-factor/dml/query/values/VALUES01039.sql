...
-- primary_obligation_id: VALUES-EXT|01039|effect_query|reset_state
...
WITH values_01039_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01039_cte)) ORDER BY column1;
-- primary-target-end
