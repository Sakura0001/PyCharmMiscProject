...
-- primary_obligation_id: VALUES-EXT|01211|error_assertion|rollback
...
WITH values_01211_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01211_cte)) ORDER BY column1;
-- primary-target-end
