...
-- primary_obligation_id: VALUES-EXT|01292|returned_rows|rollback
...
WITH values_01292_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01292_cte)) ORDER BY column1;
-- primary-target-end
