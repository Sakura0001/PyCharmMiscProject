...
-- primary_obligation_id: VALUES-EXT|12995|error_assertion|rollback
...
WITH values_12995_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12995_cte)) ORDER BY column1;
-- primary-target-end
