...
-- primary_obligation_id: VALUES-EXT|05778|effect_query|drop_objects
...
WITH values_05778_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05778_cte)) ORDER BY column1;
-- primary-target-end
