...
-- primary_obligation_id: VALUES-EXT|08049|returned_rows|drop_objects
...
WITH values_08049_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08049_cte)) ORDER BY column1;
-- primary-target-end
