...
-- primary_obligation_id: VALUES-EXT|12791|error_assertion|rollback
...
WITH values_12791_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12791_cte)) ORDER BY column1;
-- primary-target-end
