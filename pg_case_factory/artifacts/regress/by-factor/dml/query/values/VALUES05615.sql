...
-- primary_obligation_id: VALUES-EXT|05615|error_assertion|rollback
...
WITH values_05615_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05615_cte)) ORDER BY column1;
-- primary-target-end
