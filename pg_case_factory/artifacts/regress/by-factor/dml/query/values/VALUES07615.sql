...
-- primary_obligation_id: VALUES-EXT|07615|effect_query|reset_state
...
WITH values_07615_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07615_cte)) ORDER BY column1;
-- primary-target-end
