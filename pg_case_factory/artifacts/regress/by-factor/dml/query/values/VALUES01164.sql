...
-- primary_obligation_id: VALUES-EXT|01164|error_assertion|drop_objects
...
WITH values_01164_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01164_cte)) ORDER BY column1;
-- primary-target-end
