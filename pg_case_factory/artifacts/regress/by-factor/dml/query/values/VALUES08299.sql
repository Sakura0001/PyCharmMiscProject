...
-- primary_obligation_id: VALUES-EXT|08299|effect_query|reset_state
...
WITH values_08299_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08299_cte)) ORDER BY column1;
-- primary-target-end
