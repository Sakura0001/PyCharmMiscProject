...
-- primary_obligation_id: VALUES-EXT|13599|catalog_query|drop_objects
...
WITH values_13599_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13599_cte)) ORDER BY column1;
-- primary-target-end
