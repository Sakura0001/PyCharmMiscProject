...
-- primary_obligation_id: VALUES-EXT|08188|catalog_query|reset_state
...
WITH values_08188_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08188_cte)) ORDER BY column1;
-- primary-target-end
