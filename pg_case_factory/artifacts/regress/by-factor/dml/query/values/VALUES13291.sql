...
-- primary_obligation_id: VALUES-EXT|13291|effect_query|reset_state
...
WITH values_13291_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13291_cte)) ORDER BY column1;
-- primary-target-end
