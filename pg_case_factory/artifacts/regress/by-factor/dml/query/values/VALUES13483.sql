...
-- primary_obligation_id: VALUES-EXT|13483|effect_query|reset_state
...
WITH values_13483_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13483_cte)) ORDER BY column1;
-- primary-target-end
