...
-- primary_obligation_id: VALUES-EXT|07920|error_assertion|drop_objects
...
WITH values_07920_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07920_cte)) ORDER BY column1;
-- primary-target-end
