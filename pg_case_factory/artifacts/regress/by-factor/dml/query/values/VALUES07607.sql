...
-- primary_obligation_id: VALUES-EXT|07607|error_assertion|rollback
...
WITH values_07607_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07607_cte)) ORDER BY column1;
-- primary-target-end
