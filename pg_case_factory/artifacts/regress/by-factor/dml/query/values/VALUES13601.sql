...
-- primary_obligation_id: VALUES-EXT|13601|effect_query|rollback
...
WITH values_13601_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13601_cte)) ORDER BY column1;
-- primary-target-end
