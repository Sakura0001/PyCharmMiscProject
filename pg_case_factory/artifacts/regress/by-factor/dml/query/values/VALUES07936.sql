...
-- primary_obligation_id: VALUES-EXT|07936|catalog_query|reset_state
...
WITH values_07936_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07936_cte)) ORDER BY column1;
-- primary-target-end
