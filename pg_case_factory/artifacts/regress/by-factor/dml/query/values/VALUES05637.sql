...
-- primary_obligation_id: VALUES-EXT|05637|returned_rows|drop_objects
...
WITH values_05637_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05637_cte)) ORDER BY column1;
-- primary-target-end
