...
-- primary_obligation_id: VALUES-EXT|13408|catalog_query|reset_state
...
WITH values_13408_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13408_cte)) ORDER BY column1;
-- primary-target-end
