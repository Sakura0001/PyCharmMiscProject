...
-- primary_obligation_id: VALUES-EXT|01387|effect_query|reset_state
...
WITH values_01387_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01387_cte)) ORDER BY column1;
-- primary-target-end
