...
-- primary_obligation_id: VALUES-EXT|05682|effect_query|drop_objects
...
WITH values_05682_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05682_cte)) ORDER BY column1;
-- primary-target-end
