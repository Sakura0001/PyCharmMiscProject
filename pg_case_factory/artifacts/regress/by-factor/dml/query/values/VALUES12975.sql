...
-- primary_obligation_id: VALUES-EXT|12975|catalog_query|drop_objects
...
WITH values_12975_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12975_cte)) ORDER BY column1;
-- primary-target-end
