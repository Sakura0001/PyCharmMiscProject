...
-- primary_obligation_id: VALUES-EXT|08013|returned_rows|drop_objects
...
WITH values_08013_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08013_cte)) ORDER BY column1;
-- primary-target-end
