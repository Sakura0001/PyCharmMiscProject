...
-- primary_obligation_id: VALUES-EXT|00528|error_assertion|drop_objects
...
WITH values_00528_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00528_cte)) ORDER BY column1;
-- primary-target-end
