...
-- primary_obligation_id: VALUES-EXT|00809|effect_query|rollback
...
WITH values_00809_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00809_cte)) ORDER BY column1;
-- primary-target-end
