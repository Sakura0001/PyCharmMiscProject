...
-- primary_obligation_id: VALUES-EXT|08153|effect_query|rollback
...
WITH values_08153_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08153_cte)) ORDER BY column1;
-- primary-target-end
