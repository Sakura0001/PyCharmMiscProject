...
-- primary_obligation_id: VALUES-EXT|05450|catalog_query|rollback
...
WITH values_05450_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05450_cte)) ORDER BY column1;
-- primary-target-end
