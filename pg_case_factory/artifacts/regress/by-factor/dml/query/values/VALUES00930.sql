...
-- primary_obligation_id: VALUES-EXT|00930|effect_query|drop_objects
...
WITH values_00930_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00930_cte)) ORDER BY column1;
-- primary-target-end
