...
-- primary_obligation_id: VALUES-EXT|00637|error_assertion|reset_state
...
WITH values_00637_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00637_cte)) ORDER BY column1;
-- primary-target-end
