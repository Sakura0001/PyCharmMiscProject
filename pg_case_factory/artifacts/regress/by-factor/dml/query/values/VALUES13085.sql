...
-- primary_obligation_id: VALUES-EXT|13085|effect_query|rollback
...
WITH values_13085_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13085_cte)) ORDER BY column1;
-- primary-target-end
