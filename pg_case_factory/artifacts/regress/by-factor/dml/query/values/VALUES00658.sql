...
-- primary_obligation_id: VALUES-EXT|00658|returned_rows|reset_state
...
WITH values_00658_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00658_cte)) ORDER BY column1;
-- primary-target-end
