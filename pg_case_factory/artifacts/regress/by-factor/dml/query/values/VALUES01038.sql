...
-- primary_obligation_id: VALUES-EXT|01038|effect_query|drop_objects
...
WITH values_01038_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01038_cte)) ORDER BY column1;
-- primary-target-end
