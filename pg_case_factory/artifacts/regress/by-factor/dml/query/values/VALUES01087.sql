...
-- primary_obligation_id: VALUES-EXT|01087|effect_query|reset_state
...
WITH values_01087_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01087_cte)) ORDER BY column1;
-- primary-target-end
