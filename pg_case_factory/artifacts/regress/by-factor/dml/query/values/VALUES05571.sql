...
-- primary_obligation_id: VALUES-EXT|05571|catalog_query|drop_objects
...
WITH values_05571_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05571_cte)) ORDER BY column1;
-- primary-target-end
