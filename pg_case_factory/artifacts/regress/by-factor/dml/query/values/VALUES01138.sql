...
-- primary_obligation_id: VALUES-EXT|01138|returned_rows|reset_state
...
WITH values_01138_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01138_cte)) ORDER BY column1;
-- primary-target-end
