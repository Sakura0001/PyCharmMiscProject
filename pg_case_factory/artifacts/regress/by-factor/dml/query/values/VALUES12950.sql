...
-- primary_obligation_id: VALUES-EXT|12950|catalog_query|rollback
...
WITH values_12950_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12950_cte)) ORDER BY column1;
-- primary-target-end
