...
-- primary_obligation_id: VALUES-EXT|05806|returned_rows|reset_state
...
WITH values_05806_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05806_cte)) ORDER BY column1;
-- primary-target-end
