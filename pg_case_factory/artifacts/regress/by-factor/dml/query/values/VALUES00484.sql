...
-- primary_obligation_id: VALUES-EXT|00484|catalog_query|reset_state
...
WITH values_00484_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00484_cte)) ORDER BY column1;
-- primary-target-end
