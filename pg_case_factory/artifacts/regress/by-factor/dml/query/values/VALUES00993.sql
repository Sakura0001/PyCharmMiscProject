...
-- primary_obligation_id: VALUES-EXT|00993|returned_rows|drop_objects
...
WITH values_00993_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00993_cte)) ORDER BY column1;
-- primary-target-end
