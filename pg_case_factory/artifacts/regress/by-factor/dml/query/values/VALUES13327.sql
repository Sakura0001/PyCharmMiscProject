...
-- primary_obligation_id: VALUES-EXT|13327|effect_query|reset_state
...
WITH values_13327_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13327_cte)) ORDER BY column1;
-- primary-target-end
