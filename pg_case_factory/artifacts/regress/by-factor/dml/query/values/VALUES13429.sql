...
-- primary_obligation_id: VALUES-EXT|13429|error_assertion|reset_state
...
WITH values_13429_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13429_cte)) ORDER BY column1;
-- primary-target-end
