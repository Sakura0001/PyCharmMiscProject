...
-- primary_obligation_id: VALUES-EXT|12936|error_assertion|drop_objects
...
WITH values_12936_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12936_cte)) ORDER BY column1;
-- primary-target-end
