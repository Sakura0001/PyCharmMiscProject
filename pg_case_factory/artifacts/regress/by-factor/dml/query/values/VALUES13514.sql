...
-- primary_obligation_id: VALUES-EXT|13514|catalog_query|rollback
...
WITH values_13514_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13514_cte)) ORDER BY column1;
-- primary-target-end
