...
-- primary_obligation_id: VALUES-EXT|13462|returned_rows|reset_state
...
WITH values_13462_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13462_cte)) ORDER BY column1;
-- primary-target-end
