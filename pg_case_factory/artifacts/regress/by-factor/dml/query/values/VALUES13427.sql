...
-- primary_obligation_id: VALUES-EXT|13427|error_assertion|rollback
...
WITH values_13427_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13427_cte)) ORDER BY column1;
-- primary-target-end
