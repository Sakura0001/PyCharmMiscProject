...
-- primary_obligation_id: VALUES-EXT|07866|effect_query|drop_objects
...
WITH values_07866_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07866_cte)) ORDER BY column1;
-- primary-target-end
