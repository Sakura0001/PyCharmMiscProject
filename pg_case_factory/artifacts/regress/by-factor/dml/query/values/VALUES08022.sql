...
-- primary_obligation_id: VALUES-EXT|08022|effect_query|drop_objects
...
WITH values_08022_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08022_cte)) ORDER BY column1;
-- primary-target-end
