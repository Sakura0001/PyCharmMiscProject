...
-- primary_obligation_id: VALUES-EXT|01197|returned_rows|drop_objects
...
WITH values_01197_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01197_cte)) ORDER BY column1;
-- primary-target-end
