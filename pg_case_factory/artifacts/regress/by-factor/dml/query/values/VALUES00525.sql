...
-- primary_obligation_id: VALUES-EXT|00525|returned_rows|drop_objects
...
WITH values_00525_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00525_cte)) ORDER BY column1;
-- primary-target-end
