...
-- primary_obligation_id: VALUES-EXT|12987|catalog_query|drop_objects
...
WITH values_12987_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12987_cte)) ORDER BY column1;
-- primary-target-end
