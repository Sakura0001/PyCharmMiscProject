...
-- primary_obligation_id: VALUES-EXT|08085|returned_rows|drop_objects
...
WITH values_08085_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08085_cte)) ORDER BY column1;
-- primary-target-end
