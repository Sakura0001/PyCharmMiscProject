...
-- primary_obligation_id: VALUES-EXT|01192|catalog_query|reset_state
...
WITH values_01192_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01192_cte)) ORDER BY column1;
-- primary-target-end
