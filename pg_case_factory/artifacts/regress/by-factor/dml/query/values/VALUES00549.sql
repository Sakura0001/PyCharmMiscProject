...
-- primary_obligation_id: VALUES-EXT|00549|returned_rows|drop_objects
...
WITH values_00549_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00549_cte)) ORDER BY column1;
-- primary-target-end
