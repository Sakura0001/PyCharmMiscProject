...
-- primary_obligation_id: VALUES-EXT|01085|effect_query|rollback
...
WITH values_01085_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01085_cte)) ORDER BY column1;
-- primary-target-end
