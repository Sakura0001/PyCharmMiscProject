...
-- primary_obligation_id: VALUES-EXT|00983|error_assertion|rollback
...
WITH values_00983_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00983_cte)) ORDER BY column1;
-- primary-target-end
