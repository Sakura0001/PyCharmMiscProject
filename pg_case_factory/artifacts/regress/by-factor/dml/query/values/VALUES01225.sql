...
-- primary_obligation_id: VALUES-EXT|01225|error_assertion|reset_state
...
WITH values_01225_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01225_cte)) ORDER BY column1;
-- primary-target-end
