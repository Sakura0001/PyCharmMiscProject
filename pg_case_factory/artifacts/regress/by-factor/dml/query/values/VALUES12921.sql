...
-- primary_obligation_id: VALUES-EXT|12921|returned_rows|drop_objects
...
WITH values_12921_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12921_cte)) ORDER BY column1;
-- primary-target-end
