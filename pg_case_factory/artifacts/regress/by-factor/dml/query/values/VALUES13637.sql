...
-- primary_obligation_id: VALUES-EXT|13637|effect_query|rollback
...
WITH values_13637_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13637_cte)) ORDER BY column1;
-- primary-target-end
