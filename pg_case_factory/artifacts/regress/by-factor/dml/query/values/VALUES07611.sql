...
-- primary_obligation_id: VALUES-EXT|07611|catalog_query|drop_objects
...
WITH values_07611_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07611_cte)) ORDER BY column1;
-- primary-target-end
