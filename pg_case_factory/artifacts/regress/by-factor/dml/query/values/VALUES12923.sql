...
-- primary_obligation_id: VALUES-EXT|12923|error_assertion|rollback
...
WITH values_12923_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12923_cte)) ORDER BY column1;
-- primary-target-end
