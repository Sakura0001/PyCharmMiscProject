...
-- primary_obligation_id: VALUES-EXT|13334|catalog_query|rollback
...
WITH values_13334_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13334_cte)) ORDER BY column1;
-- primary-target-end
