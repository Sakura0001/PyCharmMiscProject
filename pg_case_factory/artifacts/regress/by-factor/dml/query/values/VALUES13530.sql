...
-- primary_obligation_id: VALUES-EXT|13530|effect_query|drop_objects
...
WITH values_13530_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13530_cte)) ORDER BY column1;
-- primary-target-end
