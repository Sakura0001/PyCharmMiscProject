...
-- primary_obligation_id: VALUES-EXT|00825|returned_rows|drop_objects
...
WITH values_00825_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00825_cte)) ORDER BY column1;
-- primary-target-end
