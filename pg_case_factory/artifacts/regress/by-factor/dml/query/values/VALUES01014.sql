...
-- primary_obligation_id: VALUES-EXT|01014|effect_query|drop_objects
...
WITH values_01014_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01014_cte)) ORDER BY column1;
-- primary-target-end
