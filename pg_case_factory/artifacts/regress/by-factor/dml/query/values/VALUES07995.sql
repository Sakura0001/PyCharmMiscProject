...
-- primary_obligation_id: VALUES-EXT|07995|catalog_query|drop_objects
...
WITH values_07995_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07995_cte)) ORDER BY column1;
-- primary-target-end
