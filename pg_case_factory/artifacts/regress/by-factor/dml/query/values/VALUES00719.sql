...
-- primary_obligation_id: VALUES-EXT|00719|error_assertion|rollback
...
WITH values_00719_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00719_cte)) ORDER BY column1;
-- primary-target-end
