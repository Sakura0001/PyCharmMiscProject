...
-- primary_obligation_id: VALUES-EXT|05735|error_assertion|rollback
...
WITH values_05735_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05735_cte)) ORDER BY column1;
-- primary-target-end
