...
-- primary_obligation_id: VALUES-EXT|01179|catalog_query|drop_objects
...
WITH values_01179_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01179_cte)) ORDER BY column1;
-- primary-target-end
