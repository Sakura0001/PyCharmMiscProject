...
-- primary_obligation_id: VALUES-EXT|00794|catalog_query|rollback
...
WITH values_00794_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00794_cte)) ORDER BY column1;
-- primary-target-end
