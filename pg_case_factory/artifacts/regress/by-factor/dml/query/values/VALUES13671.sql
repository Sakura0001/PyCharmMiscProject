...
-- primary_obligation_id: VALUES-EXT|13671|catalog_query|drop_objects
...
WITH values_13671_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13671_cte)) ORDER BY column1;
-- primary-target-end
