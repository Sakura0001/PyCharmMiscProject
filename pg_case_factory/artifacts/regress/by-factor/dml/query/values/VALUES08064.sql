...
-- primary_obligation_id: VALUES-EXT|08064|error_assertion|drop_objects
...
WITH values_08064_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08064_cte)) ORDER BY column1;
-- primary-target-end
