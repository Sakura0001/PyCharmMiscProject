...
-- primary_obligation_id: VALUES-EXT|12944|returned_rows|rollback
...
WITH values_12944_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12944_cte)) ORDER BY column1;
-- primary-target-end
