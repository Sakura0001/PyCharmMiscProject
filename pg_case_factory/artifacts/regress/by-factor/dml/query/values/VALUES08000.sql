...
-- primary_obligation_id: VALUES-EXT|08000|returned_rows|rollback
...
WITH values_08000_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08000_cte)) ORDER BY column1;
-- primary-target-end
