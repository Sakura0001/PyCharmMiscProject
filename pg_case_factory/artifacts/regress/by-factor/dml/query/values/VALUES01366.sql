...
-- primary_obligation_id: VALUES-EXT|01366|returned_rows|reset_state
...
WITH values_01366_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01366_cte)) ORDER BY column1;
-- primary-target-end
