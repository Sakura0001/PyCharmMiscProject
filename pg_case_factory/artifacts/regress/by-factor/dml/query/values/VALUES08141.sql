...
-- primary_obligation_id: VALUES-EXT|08141|effect_query|rollback
...
WITH values_08141_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08141_cte)) ORDER BY column1;
-- primary-target-end
