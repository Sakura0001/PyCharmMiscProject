...
-- primary_obligation_id: VALUES-EXT|01385|effect_query|rollback
...
WITH values_01385_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01385_cte)) ORDER BY column1;
-- primary-target-end
