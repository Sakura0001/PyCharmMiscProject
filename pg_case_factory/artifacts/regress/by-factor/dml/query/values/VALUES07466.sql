...
-- primary_obligation_id: VALUES-EXT|07466|catalog_query|rollback
...
WITH values_07466_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07466_cte)) ORDER BY column1;
-- primary-target-end
