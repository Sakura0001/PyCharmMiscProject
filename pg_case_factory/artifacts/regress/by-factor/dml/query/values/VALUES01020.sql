...
-- primary_obligation_id: VALUES-EXT|01020|error_assertion|drop_objects
...
WITH values_01020_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01020_cte)) ORDER BY column1;
-- primary-target-end
