...
-- primary_obligation_id: VALUES-EXT|01291|effect_query|reset_state
...
WITH values_01291_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01291_cte)) ORDER BY column1;
-- primary-target-end
