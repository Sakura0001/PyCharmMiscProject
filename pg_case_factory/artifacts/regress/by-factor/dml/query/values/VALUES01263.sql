...
-- primary_obligation_id: VALUES-EXT|01263|catalog_query|drop_objects
...
WITH values_01263_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01263_cte)) ORDER BY column1;
-- primary-target-end
