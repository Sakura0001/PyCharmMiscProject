...
-- primary_obligation_id: VALUES-EXT|05738|catalog_query|rollback
...
WITH values_05738_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05738_cte)) ORDER BY column1;
-- primary-target-end
