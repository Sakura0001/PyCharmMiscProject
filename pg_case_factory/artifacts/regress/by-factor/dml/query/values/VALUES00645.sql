...
-- primary_obligation_id: VALUES-EXT|00645|returned_rows|drop_objects
...
WITH values_00645_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00645_cte)) ORDER BY column1;
-- primary-target-end
