...
-- primary_obligation_id: VALUES-EXT|01208|returned_rows|rollback
...
WITH values_01208_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01208_cte)) ORDER BY column1;
-- primary-target-end
