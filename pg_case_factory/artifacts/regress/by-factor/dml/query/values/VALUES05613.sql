...
-- primary_obligation_id: VALUES-EXT|05613|returned_rows|drop_objects
...
WITH values_05613_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05613_cte)) ORDER BY column1;
-- primary-target-end
