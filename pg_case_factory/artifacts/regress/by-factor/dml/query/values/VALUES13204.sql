...
-- primary_obligation_id: VALUES-EXT|13204|catalog_query|reset_state
...
WITH values_13204_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13204_cte)) ORDER BY column1;
-- primary-target-end
