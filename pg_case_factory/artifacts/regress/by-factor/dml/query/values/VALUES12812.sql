...
-- primary_obligation_id: VALUES-EXT|12812|returned_rows|rollback
...
WITH values_12812_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12812_cte)) ORDER BY column1;
-- primary-target-end
