...
-- primary_obligation_id: VALUES-EXT|08012|returned_rows|rollback
...
WITH values_08012_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08012_cte)) ORDER BY column1;
-- primary-target-end
