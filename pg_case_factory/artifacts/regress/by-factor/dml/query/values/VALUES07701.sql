...
-- primary_obligation_id: VALUES-EXT|07701|returned_rows|drop_objects
...
WITH values_07701_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07701_cte)) ORDER BY column1;
-- primary-target-end
