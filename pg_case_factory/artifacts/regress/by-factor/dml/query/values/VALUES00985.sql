...
-- primary_obligation_id: VALUES-EXT|00985|error_assertion|reset_state
...
WITH values_00985_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00985_cte)) ORDER BY column1;
-- primary-target-end
