...
-- primary_obligation_id: VALUES-EXT|13587|catalog_query|drop_objects
...
WITH values_13587_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13587_cte)) ORDER BY column1;
-- primary-target-end
