...
-- primary_obligation_id: VALUES-EXT|00837|returned_rows|drop_objects
...
WITH values_00837_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00837_cte)) ORDER BY column1;
-- primary-target-end
