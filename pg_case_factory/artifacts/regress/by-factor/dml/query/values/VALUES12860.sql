...
-- primary_obligation_id: VALUES-EXT|12860|returned_rows|rollback
...
WITH values_12860_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12860_cte)) ORDER BY column1;
-- primary-target-end
