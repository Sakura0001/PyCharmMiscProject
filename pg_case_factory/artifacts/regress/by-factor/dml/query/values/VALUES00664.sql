...
-- primary_obligation_id: VALUES-EXT|00664|catalog_query|reset_state
...
WITH values_00664_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00664_cte)) ORDER BY column1;
-- primary-target-end
