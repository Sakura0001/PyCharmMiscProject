...
-- primary_obligation_id: VALUES-EXT|07571|error_assertion|rollback
...
WITH values_07571_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07571_cte)) ORDER BY column1;
-- primary-target-end
