...
-- primary_obligation_id: VALUES-EXT|12831|catalog_query|drop_objects
...
WITH values_12831_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12831_cte)) ORDER BY column1;
-- primary-target-end
