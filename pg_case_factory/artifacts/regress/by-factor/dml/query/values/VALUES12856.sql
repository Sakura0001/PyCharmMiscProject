...
-- primary_obligation_id: VALUES-EXT|12856|catalog_query|reset_state
...
WITH values_12856_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12856_cte)) ORDER BY column1;
-- primary-target-end
