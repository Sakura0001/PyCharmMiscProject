...
-- primary_obligation_id: VALUES-EXT|13060|catalog_query|reset_state
...
WITH values_13060_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13060_cte)) ORDER BY column1;
-- primary-target-end
