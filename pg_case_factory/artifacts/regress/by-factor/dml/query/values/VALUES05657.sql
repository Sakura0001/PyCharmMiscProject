...
-- primary_obligation_id: VALUES-EXT|05657|effect_query|rollback
...
WITH values_05657_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05657_cte)) ORDER BY column1;
-- primary-target-end
