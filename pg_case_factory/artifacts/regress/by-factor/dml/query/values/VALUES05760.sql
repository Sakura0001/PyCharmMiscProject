...
-- primary_obligation_id: VALUES-EXT|05760|error_assertion|drop_objects
...
WITH values_05760_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05760_cte)) ORDER BY column1;
-- primary-target-end
