...
-- primary_obligation_id: VALUES-EXT|05708|returned_rows|rollback
...
WITH values_05708_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05708_cte)) ORDER BY column1;
-- primary-target-end
