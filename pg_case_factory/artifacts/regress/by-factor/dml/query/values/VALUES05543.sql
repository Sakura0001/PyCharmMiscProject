...
-- primary_obligation_id: VALUES-EXT|05543|error_assertion|rollback
...
WITH values_05543_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05543_cte)) ORDER BY column1;
-- primary-target-end
