...
-- primary_obligation_id: VALUES-EXT|00708|error_assertion|drop_objects
...
WITH values_00708_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00708_cte)) ORDER BY column1;
-- primary-target-end
