...
-- primary_obligation_id: VALUES-EXT|12960|error_assertion|drop_objects
...
WITH values_12960_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12960_cte)) ORDER BY column1;
-- primary-target-end
