...
-- primary_obligation_id: VALUES-EXT|05726|catalog_query|rollback
...
WITH values_05726_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05726_cte)) ORDER BY column1;
-- primary-target-end
