...
-- primary_obligation_id: VALUES-EXT|13470|effect_query|drop_objects
...
WITH values_13470_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13470_cte)) ORDER BY column1;
-- primary-target-end
