...
-- primary_obligation_id: VALUES-EXT|07878|effect_query|drop_objects
...
WITH values_07878_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07878_cte)) ORDER BY column1;
-- primary-target-end
