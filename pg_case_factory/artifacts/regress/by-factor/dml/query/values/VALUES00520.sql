...
-- primary_obligation_id: VALUES-EXT|00520|catalog_query|reset_state
...
WITH values_00520_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00520_cte)) ORDER BY column1;
-- primary-target-end
