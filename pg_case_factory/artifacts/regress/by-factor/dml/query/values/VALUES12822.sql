...
-- primary_obligation_id: VALUES-EXT|12822|effect_query|drop_objects
...
WITH values_12822_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12822_cte)) ORDER BY column1;
-- primary-target-end
