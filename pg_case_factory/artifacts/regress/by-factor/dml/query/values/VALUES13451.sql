...
-- primary_obligation_id: VALUES-EXT|13451|error_assertion|rollback
...
WITH values_13451_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13451_cte)) ORDER BY column1;
-- primary-target-end
