...
-- primary_obligation_id: VALUES-EXT|08082|effect_query|drop_objects
...
WITH values_08082_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08082_cte)) ORDER BY column1;
-- primary-target-end
