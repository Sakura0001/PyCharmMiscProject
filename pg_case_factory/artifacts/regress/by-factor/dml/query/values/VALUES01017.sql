...
-- primary_obligation_id: VALUES-EXT|01017|returned_rows|drop_objects
...
WITH values_01017_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01017_cte)) ORDER BY column1;
-- primary-target-end
