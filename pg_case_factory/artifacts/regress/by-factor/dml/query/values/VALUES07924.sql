...
-- primary_obligation_id: VALUES-EXT|07924|catalog_query|reset_state
...
WITH values_07924_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07924_cte)) ORDER BY column1;
-- primary-target-end
