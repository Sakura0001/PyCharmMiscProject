...
-- primary_obligation_id: VALUES-EXT|12942|effect_query|drop_objects
...
WITH values_12942_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12942_cte)) ORDER BY column1;
-- primary-target-end
