...
-- primary_obligation_id: VALUES-EXT|00497|effect_query|rollback
...
WITH values_00497_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00497_cte)) ORDER BY column1;
-- primary-target-end
