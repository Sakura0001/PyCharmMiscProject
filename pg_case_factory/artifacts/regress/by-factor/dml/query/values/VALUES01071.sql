...
-- primary_obligation_id: VALUES-EXT|01071|catalog_query|drop_objects
...
WITH values_01071_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01071_cte)) ORDER BY column1;
-- primary-target-end
