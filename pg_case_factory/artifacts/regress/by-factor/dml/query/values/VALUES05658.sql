...
-- primary_obligation_id: VALUES-EXT|05658|effect_query|drop_objects
...
WITH values_05658_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05658_cte)) ORDER BY column1;
-- primary-target-end
