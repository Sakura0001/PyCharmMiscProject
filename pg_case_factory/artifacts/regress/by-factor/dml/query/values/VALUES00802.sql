...
-- primary_obligation_id: VALUES-EXT|00802|returned_rows|reset_state
...
WITH values_00802_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00802_cte)) ORDER BY column1;
-- primary-target-end
