...
-- primary_obligation_id: VALUES-EXT|13631|error_assertion|rollback
...
WITH values_13631_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13631_cte)) ORDER BY column1;
-- primary-target-end
