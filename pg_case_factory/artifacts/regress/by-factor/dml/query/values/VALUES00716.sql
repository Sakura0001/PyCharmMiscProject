...
-- primary_obligation_id: VALUES-EXT|00716|returned_rows|rollback
...
WITH values_00716_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00716_cte)) ORDER BY column1;
-- primary-target-end
