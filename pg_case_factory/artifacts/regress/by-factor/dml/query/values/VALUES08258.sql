...
-- primary_obligation_id: VALUES-EXT|08258|catalog_query|rollback
...
WITH values_08258_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08258_cte)) ORDER BY column1;
-- primary-target-end
