...
-- primary_obligation_id: VALUES-EXT|13674|effect_query|drop_objects
...
WITH values_13674_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13674_cte)) ORDER BY column1;
-- primary-target-end
