...
-- primary_obligation_id: VALUES-EXT|07601|effect_query|rollback
...
WITH values_07601_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07601_cte)) ORDER BY column1;
-- primary-target-end
