...
-- primary_obligation_id: VALUES-EXT|05747|error_assertion|rollback
...
WITH values_05747_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05747_cte)) ORDER BY column1;
-- primary-target-end
