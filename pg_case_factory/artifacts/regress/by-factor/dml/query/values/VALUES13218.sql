...
-- primary_obligation_id: VALUES-EXT|13218|effect_query|drop_objects
...
WITH values_13218_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13218_cte)) ORDER BY column1;
-- primary-target-end
