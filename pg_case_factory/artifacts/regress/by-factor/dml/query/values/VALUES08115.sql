...
-- primary_obligation_id: VALUES-EXT|08115|catalog_query|drop_objects
...
WITH values_08115_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08115_cte)) ORDER BY column1;
-- primary-target-end
