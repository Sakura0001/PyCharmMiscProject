...
-- primary_obligation_id: VALUES-EXT|08148|error_assertion|drop_objects
...
WITH values_08148_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08148_cte)) ORDER BY column1;
-- primary-target-end
