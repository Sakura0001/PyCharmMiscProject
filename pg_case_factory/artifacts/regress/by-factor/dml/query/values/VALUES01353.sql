...
-- primary_obligation_id: VALUES-EXT|01353|returned_rows|drop_objects
...
WITH values_01353_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01353_cte)) ORDER BY column1;
-- primary-target-end
