...
-- primary_obligation_id: VALUES-EXT|12778|returned_rows|reset_state
...
WITH values_12778_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12778_cte)) ORDER BY column1;
-- primary-target-end
