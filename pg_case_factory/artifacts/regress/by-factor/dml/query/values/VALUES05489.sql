...
-- primary_obligation_id: VALUES-EXT|05489|effect_query|rollback
...
WITH values_05489_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05489_cte)) ORDER BY column1;
-- primary-target-end
