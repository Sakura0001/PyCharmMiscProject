...
-- primary_obligation_id: VALUES-EXT|07838|catalog_query|rollback
...
WITH values_07838_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07838_cte)) ORDER BY column1;
-- primary-target-end
