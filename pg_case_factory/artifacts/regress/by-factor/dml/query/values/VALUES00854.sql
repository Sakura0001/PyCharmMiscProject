...
-- primary_obligation_id: VALUES-EXT|00854|catalog_query|rollback
...
WITH values_00854_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00854_cte)) ORDER BY column1;
-- primary-target-end
