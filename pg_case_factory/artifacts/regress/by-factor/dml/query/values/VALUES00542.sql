...
-- primary_obligation_id: VALUES-EXT|00542|catalog_query|rollback
...
WITH values_00542_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00542_cte)) ORDER BY column1;
-- primary-target-end
