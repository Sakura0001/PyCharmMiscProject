...
-- primary_obligation_id: VALUES-EXT|07706|catalog_query|rollback
...
WITH values_07706_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07706_cte)) ORDER BY column1;
-- primary-target-end
