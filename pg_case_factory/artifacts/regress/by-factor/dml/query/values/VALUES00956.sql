...
-- primary_obligation_id: VALUES-EXT|00956|returned_rows|rollback
...
WITH values_00956_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00956_cte)) ORDER BY column1;
-- primary-target-end
