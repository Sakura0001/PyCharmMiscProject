...
-- primary_obligation_id: VALUES-EXT|07470|effect_query|drop_objects
...
WITH values_07470_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07470_cte)) ORDER BY column1;
-- primary-target-end
