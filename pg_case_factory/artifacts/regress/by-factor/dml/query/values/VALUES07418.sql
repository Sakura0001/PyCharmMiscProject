...
-- primary_obligation_id: VALUES-EXT|07418|catalog_query|rollback
...
WITH values_07418_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07418_cte)) ORDER BY column1;
-- primary-target-end
