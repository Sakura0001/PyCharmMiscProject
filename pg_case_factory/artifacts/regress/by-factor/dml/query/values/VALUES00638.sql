...
-- primary_obligation_id: VALUES-EXT|00638|catalog_query|rollback
...
WITH values_00638_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00638_cte)) ORDER BY column1;
-- primary-target-end
