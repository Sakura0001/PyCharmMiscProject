...
-- primary_obligation_id: VALUES-EXT|08061|returned_rows|drop_objects
...
WITH values_08061_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08061_cte)) ORDER BY column1;
-- primary-target-end
