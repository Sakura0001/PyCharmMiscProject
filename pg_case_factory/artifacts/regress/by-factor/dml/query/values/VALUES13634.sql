...
-- primary_obligation_id: VALUES-EXT|13634|catalog_query|rollback
...
WITH values_13634_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13634_cte)) ORDER BY column1;
-- primary-target-end
