...
-- primary_obligation_id: VALUES-EXT|12824|returned_rows|rollback
...
WITH values_12824_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12824_cte)) ORDER BY column1;
-- primary-target-end
