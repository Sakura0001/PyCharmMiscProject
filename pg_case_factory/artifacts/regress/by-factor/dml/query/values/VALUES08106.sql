...
-- primary_obligation_id: VALUES-EXT|08106|effect_query|drop_objects
...
WITH values_08106_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08106_cte)) ORDER BY column1;
-- primary-target-end
