...
-- primary_obligation_id: VALUES-EXT|01323|catalog_query|drop_objects
...
WITH values_01323_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01323_cte)) ORDER BY column1;
-- primary-target-end
