...
-- primary_obligation_id: VALUES-EXT|01091|error_assertion|rollback
...
WITH values_01091_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01091_cte)) ORDER BY column1;
-- primary-target-end
