...
-- primary_obligation_id: VALUES-EXT|12792|error_assertion|drop_objects
...
WITH values_12792_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12792_cte)) ORDER BY column1;
-- primary-target-end
