...
-- primary_obligation_id: VALUES-EXT|00512|returned_rows|rollback
...
WITH values_00512_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00512_cte)) ORDER BY column1;
-- primary-target-end
