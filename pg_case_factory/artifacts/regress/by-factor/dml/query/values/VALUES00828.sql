...
-- primary_obligation_id: VALUES-EXT|00828|error_assertion|drop_objects
...
WITH values_00828_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00828_cte)) ORDER BY column1;
-- primary-target-end
