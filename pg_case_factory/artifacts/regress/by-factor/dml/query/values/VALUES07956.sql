...
-- primary_obligation_id: VALUES-EXT|07956|error_assertion|drop_objects
...
WITH values_07956_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07956_cte)) ORDER BY column1;
-- primary-target-end
