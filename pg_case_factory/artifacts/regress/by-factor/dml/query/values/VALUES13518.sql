...
-- primary_obligation_id: VALUES-EXT|13518|effect_query|drop_objects
...
WITH values_13518_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13518_cte)) ORDER BY column1;
-- primary-target-end
