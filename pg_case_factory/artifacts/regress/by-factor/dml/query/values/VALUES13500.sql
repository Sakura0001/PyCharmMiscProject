...
-- primary_obligation_id: VALUES-EXT|13500|error_assertion|drop_objects
...
WITH values_13500_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13500_cte)) ORDER BY column1;
-- primary-target-end
