...
-- primary_obligation_id: VALUES-EXT|01364|returned_rows|rollback
...
WITH values_01364_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01364_cte)) ORDER BY column1;
-- primary-target-end
