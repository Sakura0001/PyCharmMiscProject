...
-- primary_obligation_id: VALUES-EXT|01127|error_assertion|rollback
...
WITH values_01127_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01127_cte)) ORDER BY column1;
-- primary-target-end
