...
-- primary_obligation_id: VALUES-EXT|08002|returned_rows|reset_state
...
WITH values_08002_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08002_cte)) ORDER BY column1;
-- primary-target-end
