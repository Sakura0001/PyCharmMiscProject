...
-- primary_obligation_id: VALUES-EXT|13625|effect_query|rollback
...
WITH values_13625_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13625_cte)) ORDER BY column1;
-- primary-target-end
