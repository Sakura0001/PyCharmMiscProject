...
-- primary_obligation_id: VALUES-EXT|01115|error_assertion|rollback
...
WITH values_01115_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01115_cte)) ORDER BY column1;
-- primary-target-end
