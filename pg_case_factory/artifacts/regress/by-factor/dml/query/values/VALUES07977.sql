...
-- primary_obligation_id: VALUES-EXT|07977|returned_rows|drop_objects
...
WITH values_07977_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07977_cte)) ORDER BY column1;
-- primary-target-end
