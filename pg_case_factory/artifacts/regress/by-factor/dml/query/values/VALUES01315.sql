...
-- primary_obligation_id: VALUES-EXT|01315|effect_query|reset_state
...
WITH values_01315_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01315_cte)) ORDER BY column1;
-- primary-target-end
