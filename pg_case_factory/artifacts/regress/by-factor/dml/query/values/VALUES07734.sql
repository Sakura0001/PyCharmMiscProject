...
-- primary_obligation_id: VALUES-EXT|07734|effect_query|drop_objects
...
WITH values_07734_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07734_cte)) ORDER BY column1;
-- primary-target-end
