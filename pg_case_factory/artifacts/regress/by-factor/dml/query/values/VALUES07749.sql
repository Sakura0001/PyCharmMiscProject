...
-- primary_obligation_id: VALUES-EXT|07749|returned_rows|drop_objects
...
WITH values_07749_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07749_cte)) ORDER BY column1;
-- primary-target-end
