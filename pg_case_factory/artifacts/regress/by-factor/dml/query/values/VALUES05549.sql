...
-- primary_obligation_id: VALUES-EXT|05549|effect_query|rollback
...
WITH values_05549_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05549_cte)) ORDER BY column1;
-- primary-target-end
