...
-- primary_obligation_id: VALUES-EXT|08114|catalog_query|rollback
...
WITH values_08114_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08114_cte)) ORDER BY column1;
-- primary-target-end
