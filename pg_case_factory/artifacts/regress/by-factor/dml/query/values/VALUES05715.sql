...
-- primary_obligation_id: VALUES-EXT|05715|catalog_query|drop_objects
...
WITH values_05715_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05715_cte)) ORDER BY column1;
-- primary-target-end
