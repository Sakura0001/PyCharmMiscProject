...
-- primary_obligation_id: VALUES-EXT|08122|returned_rows|reset_state
...
WITH values_08122_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08122_cte)) ORDER BY column1;
-- primary-target-end
