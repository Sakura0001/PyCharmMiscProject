...
-- primary_obligation_id: VALUES-EXT|08158|returned_rows|reset_state
...
WITH values_08158_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08158_cte)) ORDER BY column1;
-- primary-target-end
