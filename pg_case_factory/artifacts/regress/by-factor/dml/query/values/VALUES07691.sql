...
-- primary_obligation_id: VALUES-EXT|07691|error_assertion|rollback
...
WITH values_07691_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07691_cte)) ORDER BY column1;
-- primary-target-end
