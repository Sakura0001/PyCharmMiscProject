...
-- primary_obligation_id: VALUES-EXT|01144|catalog_query|reset_state
...
WITH values_01144_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01144_cte)) ORDER BY column1;
-- primary-target-end
