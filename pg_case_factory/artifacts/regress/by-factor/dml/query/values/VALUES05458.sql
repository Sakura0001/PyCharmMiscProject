...
-- primary_obligation_id: VALUES-EXT|05458|returned_rows|reset_state
...
WITH values_05458_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05458_cte)) ORDER BY column1;
-- primary-target-end
