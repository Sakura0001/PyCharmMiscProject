...
-- primary_obligation_id: VALUES-EXT|08275|effect_query|reset_state
...
WITH values_08275_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08275_cte)) ORDER BY column1;
-- primary-target-end
