...
-- primary_obligation_id: VALUES-EXT|01324|catalog_query|reset_state
...
WITH values_01324_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01324_cte)) ORDER BY column1;
-- primary-target-end
