...
-- primary_obligation_id: VALUES-EXT|13675|effect_query|reset_state
...
WITH values_13675_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13675_cte)) ORDER BY column1;
-- primary-target-end
