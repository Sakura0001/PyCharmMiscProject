...
-- primary_obligation_id: VALUES-EXT|13551|catalog_query|drop_objects
...
WITH values_13551_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13551_cte)) ORDER BY column1;
-- primary-target-end
