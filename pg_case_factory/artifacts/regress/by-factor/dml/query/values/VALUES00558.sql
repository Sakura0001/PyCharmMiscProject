...
-- primary_obligation_id: VALUES-EXT|00558|effect_query|drop_objects
...
WITH values_00558_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00558_cte)) ORDER BY column1;
-- primary-target-end
