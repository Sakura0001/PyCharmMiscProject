...
-- primary_obligation_id: VALUES-EXT|01097|effect_query|rollback
...
WITH values_01097_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01097_cte)) ORDER BY column1;
-- primary-target-end
