...
-- primary_obligation_id: VALUES-EXT|00559|effect_query|reset_state
...
WITH values_00559_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00559_cte)) ORDER BY column1;
-- primary-target-end
