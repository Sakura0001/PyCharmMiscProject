...
-- primary_obligation_id: VALUES-EXT|07967|error_assertion|rollback
...
WITH values_07967_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07967_cte)) ORDER BY column1;
-- primary-target-end
