...
-- primary_obligation_id: VALUES-EXT|07449|returned_rows|drop_objects
...
WITH values_07449_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07449_cte)) ORDER BY column1;
-- primary-target-end
