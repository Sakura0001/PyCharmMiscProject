...
-- primary_obligation_id: VALUES-EXT|08209|error_assertion|reset_state
...
WITH values_08209_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08209_cte)) ORDER BY column1;
-- primary-target-end
