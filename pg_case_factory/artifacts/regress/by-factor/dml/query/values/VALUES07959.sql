...
-- primary_obligation_id: VALUES-EXT|07959|catalog_query|drop_objects
...
WITH values_07959_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07959_cte)) ORDER BY column1;
-- primary-target-end
