...
-- primary_obligation_id: VALUES-EXT|01209|returned_rows|drop_objects
...
WITH values_01209_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01209_cte)) ORDER BY column1;
-- primary-target-end
