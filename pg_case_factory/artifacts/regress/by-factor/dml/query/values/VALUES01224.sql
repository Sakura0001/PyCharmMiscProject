...
-- primary_obligation_id: VALUES-EXT|01224|error_assertion|drop_objects
...
WITH values_01224_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01224_cte)) ORDER BY column1;
-- primary-target-end
