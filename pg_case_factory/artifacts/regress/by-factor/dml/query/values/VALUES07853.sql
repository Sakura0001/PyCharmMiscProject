...
-- primary_obligation_id: VALUES-EXT|07853|effect_query|rollback
...
WITH values_07853_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07853_cte)) ORDER BY column1;
-- primary-target-end
