...
-- primary_obligation_id: VALUES-EXT|00977|effect_query|rollback
...
WITH values_00977_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00977_cte)) ORDER BY column1;
-- primary-target-end
