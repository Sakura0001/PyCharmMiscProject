...
-- primary_obligation_id: VALUES-EXT|13296|error_assertion|drop_objects
...
WITH values_13296_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13296_cte)) ORDER BY column1;
-- primary-target-end
