...
-- primary_obligation_id: VALUES-EXT|00666|effect_query|drop_objects
...
WITH values_00666_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00666_cte)) ORDER BY column1;
-- primary-target-end
