...
-- primary_obligation_id: VALUES-EXT|13270|returned_rows|reset_state
...
WITH values_13270_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13270_cte)) ORDER BY column1;
-- primary-target-end
