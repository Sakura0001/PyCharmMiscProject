...
-- primary_obligation_id: VALUES-EXT|07598|catalog_query|rollback
...
WITH values_07598_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07598_cte)) ORDER BY column1;
-- primary-target-end
