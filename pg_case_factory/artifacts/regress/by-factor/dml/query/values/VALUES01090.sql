...
-- primary_obligation_id: VALUES-EXT|01090|returned_rows|reset_state
...
WITH values_01090_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01090_cte)) ORDER BY column1;
-- primary-target-end
