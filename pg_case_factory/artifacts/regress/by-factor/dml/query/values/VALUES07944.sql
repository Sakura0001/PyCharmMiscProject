...
-- primary_obligation_id: VALUES-EXT|07944|error_assertion|drop_objects
...
WITH values_07944_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07944_cte)) ORDER BY column1;
-- primary-target-end
