...
-- primary_obligation_id: VALUES-EXT|01195|effect_query|reset_state
...
WITH values_01195_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01195_cte)) ORDER BY column1;
-- primary-target-end
