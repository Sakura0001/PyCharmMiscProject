...
-- primary_obligation_id: VALUES-EXT|05453|effect_query|rollback
...
WITH values_05453_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05453_cte)) ORDER BY column1;
-- primary-target-end
