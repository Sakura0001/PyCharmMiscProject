...
-- primary_obligation_id: VALUES-EXT|08004|error_assertion|drop_objects
...
WITH values_08004_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08004_cte)) ORDER BY column1;
-- primary-target-end
