...
-- primary_obligation_id: VALUES-EXT|08073|returned_rows|drop_objects
...
WITH values_08073_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08073_cte)) ORDER BY column1;
-- primary-target-end
