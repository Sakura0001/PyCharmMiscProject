...
-- primary_obligation_id: VALUES-EXT|01025|effect_query|rollback
...
WITH values_01025_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01025_cte)) ORDER BY column1;
-- primary-target-end
