...
-- primary_obligation_id: VALUES-EXT|08088|error_assertion|drop_objects
...
WITH values_08088_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08088_cte)) ORDER BY column1;
-- primary-target-end
