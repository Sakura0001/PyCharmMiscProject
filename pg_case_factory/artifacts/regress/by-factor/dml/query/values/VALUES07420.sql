...
-- primary_obligation_id: VALUES-EXT|07420|catalog_query|reset_state
...
WITH values_07420_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07420_cte)) ORDER BY column1;
-- primary-target-end
