...
-- primary_obligation_id: VALUES-EXT|07773|returned_rows|drop_objects
...
WITH values_07773_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07773_cte)) ORDER BY column1;
-- primary-target-end
