...
-- primary_obligation_id: VALUES-EXT|12780|error_assertion|drop_objects
...
WITH values_12780_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12780_cte)) ORDER BY column1;
-- primary-target-end
