...
-- primary_obligation_id: VALUES-EXT|07458|effect_query|drop_objects
...
WITH values_07458_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07458_cte)) ORDER BY column1;
-- primary-target-end
