...
-- primary_obligation_id: VALUES-EXT|07554|effect_query|drop_objects
...
WITH values_07554_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07554_cte)) ORDER BY column1;
-- primary-target-end
