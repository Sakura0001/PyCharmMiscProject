...
-- primary_obligation_id: VALUES-EXT|01155|catalog_query|drop_objects
...
WITH values_01155_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01155_cte)) ORDER BY column1;
-- primary-target-end
