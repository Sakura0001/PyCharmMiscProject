...
-- primary_obligation_id: VALUES-EXT|07417|error_assertion|reset_state
...
WITH values_07417_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07417_cte)) ORDER BY column1;
-- primary-target-end
