...
-- primary_obligation_id: VALUES-EXT|01278|effect_query|drop_objects
...
WITH values_01278_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01278_cte)) ORDER BY column1;
-- primary-target-end
