...
-- primary_obligation_id: VALUES-EXT|05438|catalog_query|rollback
...
WITH values_05438_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05438_cte)) ORDER BY column1;
-- primary-target-end
