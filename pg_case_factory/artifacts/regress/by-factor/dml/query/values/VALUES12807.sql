...
-- primary_obligation_id: VALUES-EXT|12807|catalog_query|drop_objects
...
WITH values_12807_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12807_cte)) ORDER BY column1;
-- primary-target-end
