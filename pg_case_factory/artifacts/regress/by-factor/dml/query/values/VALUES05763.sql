...
-- primary_obligation_id: VALUES-EXT|05763|catalog_query|drop_objects
...
WITH values_05763_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05763_cte)) ORDER BY column1;
-- primary-target-end
