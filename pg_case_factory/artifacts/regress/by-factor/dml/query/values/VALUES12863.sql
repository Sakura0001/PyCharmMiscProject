...
-- primary_obligation_id: VALUES-EXT|12863|error_assertion|rollback
...
WITH values_12863_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12863_cte)) ORDER BY column1;
-- primary-target-end
