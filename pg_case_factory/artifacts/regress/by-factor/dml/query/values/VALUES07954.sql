...
-- primary_obligation_id: VALUES-EXT|07954|returned_rows|reset_state
...
WITH values_07954_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07954_cte)) ORDER BY column1;
-- primary-target-end
