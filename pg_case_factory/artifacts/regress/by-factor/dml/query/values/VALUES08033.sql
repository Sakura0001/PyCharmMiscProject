...
-- primary_obligation_id: VALUES-EXT|08033|effect_query|rollback
...
WITH values_08033_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08033_cte)) ORDER BY column1;
-- primary-target-end
