...
-- primary_obligation_id: VALUES-EXT|13342|returned_rows|reset_state
...
WITH values_13342_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13342_cte)) ORDER BY column1;
-- primary-target-end
