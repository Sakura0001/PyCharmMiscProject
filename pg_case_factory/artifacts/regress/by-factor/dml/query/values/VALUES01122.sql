...
-- primary_obligation_id: VALUES-EXT|01122|effect_query|drop_objects
...
WITH values_01122_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01122_cte)) ORDER BY column1;
-- primary-target-end
