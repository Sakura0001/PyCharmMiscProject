...
-- primary_obligation_id: VALUES-EXT|13109|effect_query|rollback
...
WITH values_13109_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13109_cte)) ORDER BY column1;
-- primary-target-end
