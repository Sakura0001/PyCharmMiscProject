...
-- primary_obligation_id: VALUES-EXT|07560|error_assertion|drop_objects
...
WITH values_07560_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07560_cte)) ORDER BY column1;
-- primary-target-end
