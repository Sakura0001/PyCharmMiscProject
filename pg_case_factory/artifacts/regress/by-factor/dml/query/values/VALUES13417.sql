...
-- primary_obligation_id: VALUES-EXT|13417|error_assertion|reset_state
...
WITH values_13417_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13417_cte)) ORDER BY column1;
-- primary-target-end
