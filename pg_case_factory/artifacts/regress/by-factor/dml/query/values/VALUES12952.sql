...
-- primary_obligation_id: VALUES-EXT|12952|catalog_query|reset_state
...
WITH values_12952_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12952_cte)) ORDER BY column1;
-- primary-target-end
