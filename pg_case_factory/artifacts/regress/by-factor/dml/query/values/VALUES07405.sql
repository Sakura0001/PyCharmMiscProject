...
-- primary_obligation_id: VALUES-EXT|07405|error_assertion|reset_state
...
WITH values_07405_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07405_cte)) ORDER BY column1;
-- primary-target-end
