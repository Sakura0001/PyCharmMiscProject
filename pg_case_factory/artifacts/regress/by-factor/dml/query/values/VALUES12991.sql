...
-- primary_obligation_id: VALUES-EXT|12991|effect_query|reset_state
...
WITH values_12991_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12991_cte)) ORDER BY column1;
-- primary-target-end
