...
-- primary_obligation_id: VALUES-EXT|00566|catalog_query|rollback
...
WITH values_00566_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00566_cte)) ORDER BY column1;
-- primary-target-end
