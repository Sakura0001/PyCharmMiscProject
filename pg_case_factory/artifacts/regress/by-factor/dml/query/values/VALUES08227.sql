...
-- primary_obligation_id: VALUES-EXT|08227|effect_query|reset_state
...
WITH values_08227_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08227_cte)) ORDER BY column1;
-- primary-target-end
