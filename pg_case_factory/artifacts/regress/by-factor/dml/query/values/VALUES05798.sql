...
-- primary_obligation_id: VALUES-EXT|05798|catalog_query|rollback
...
WITH values_05798_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05798_cte)) ORDER BY column1;
-- primary-target-end
