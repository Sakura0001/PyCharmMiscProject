...
-- primary_obligation_id: VALUES-EXT|01391|error_assertion|rollback
...
WITH values_01391_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01391_cte)) ORDER BY column1;
-- primary-target-end
