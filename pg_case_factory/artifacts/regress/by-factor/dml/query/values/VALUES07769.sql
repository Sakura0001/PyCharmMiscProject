...
-- primary_obligation_id: VALUES-EXT|07769|effect_query|rollback
...
WITH values_07769_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07769_cte)) ORDER BY column1;
-- primary-target-end
