...
-- primary_obligation_id: VALUES-EXT|07723|effect_query|reset_state
...
WITH values_07723_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07723_cte)) ORDER BY column1;
-- primary-target-end
