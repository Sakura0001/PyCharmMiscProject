...
-- primary_obligation_id: VALUES-EXT|01160|returned_rows|rollback
...
WITH values_01160_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01160_cte)) ORDER BY column1;
-- primary-target-end
