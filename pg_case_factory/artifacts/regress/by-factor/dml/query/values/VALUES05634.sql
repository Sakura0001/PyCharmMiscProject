...
-- primary_obligation_id: VALUES-EXT|05634|effect_query|drop_objects
...
WITH values_05634_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05634_cte)) ORDER BY column1;
-- primary-target-end
