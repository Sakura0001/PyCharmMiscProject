...
-- primary_obligation_id: VALUES-EXT|01055|error_assertion|rollback
...
WITH values_01055_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01055_cte)) ORDER BY column1;
-- primary-target-end
