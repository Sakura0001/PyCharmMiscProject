...
-- primary_obligation_id: VALUES-EXT|12962|catalog_query|rollback
...
WITH values_12962_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12962_cte)) ORDER BY column1;
-- primary-target-end
