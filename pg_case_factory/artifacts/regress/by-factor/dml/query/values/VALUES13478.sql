...
-- primary_obligation_id: VALUES-EXT|13478|catalog_query|rollback
...
WITH values_13478_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13478_cte)) ORDER BY column1;
-- primary-target-end
