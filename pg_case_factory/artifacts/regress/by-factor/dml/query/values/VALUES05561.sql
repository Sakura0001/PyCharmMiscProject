...
-- primary_obligation_id: VALUES-EXT|05561|effect_query|rollback
...
WITH values_05561_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05561_cte)) ORDER BY column1;
-- primary-target-end
