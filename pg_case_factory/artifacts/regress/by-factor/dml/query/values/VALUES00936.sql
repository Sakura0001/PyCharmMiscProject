...
-- primary_obligation_id: VALUES-EXT|00936|error_assertion|drop_objects
...
WITH values_00936_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00936_cte)) ORDER BY column1;
-- primary-target-end
