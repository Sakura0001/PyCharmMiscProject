...
-- primary_obligation_id: VALUES-EXT|08165|effect_query|rollback
...
WITH values_08165_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08165_cte)) ORDER BY column1;
-- primary-target-end
