...
-- primary_obligation_id: VALUES-EXT|08063|error_assertion|rollback
...
WITH values_08063_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08063_cte)) ORDER BY column1;
-- primary-target-end
