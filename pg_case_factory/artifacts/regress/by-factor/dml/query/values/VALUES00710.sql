...
-- primary_obligation_id: VALUES-EXT|00710|catalog_query|rollback
...
WITH values_00710_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00710_cte)) ORDER BY column1;
-- primary-target-end
