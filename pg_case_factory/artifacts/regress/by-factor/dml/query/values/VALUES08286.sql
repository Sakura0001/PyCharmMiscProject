...
-- primary_obligation_id: VALUES-EXT|08286|effect_query|drop_objects
...
WITH values_08286_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08286_cte)) ORDER BY column1;
-- primary-target-end
