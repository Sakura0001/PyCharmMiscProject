...
-- primary_obligation_id: VALUES-EXT|08037|returned_rows|drop_objects
...
WITH values_08037_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08037_cte)) ORDER BY column1;
-- primary-target-end
