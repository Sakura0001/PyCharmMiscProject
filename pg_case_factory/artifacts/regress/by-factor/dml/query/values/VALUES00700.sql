...
-- primary_obligation_id: VALUES-EXT|00700|catalog_query|reset_state
...
WITH values_00700_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00700_cte)) ORDER BY column1;
-- primary-target-end
