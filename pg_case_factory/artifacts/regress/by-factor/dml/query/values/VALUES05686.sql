...
-- primary_obligation_id: VALUES-EXT|05686|returned_rows|reset_state
...
WITH values_05686_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05686_cte)) ORDER BY column1;
-- primary-target-end
