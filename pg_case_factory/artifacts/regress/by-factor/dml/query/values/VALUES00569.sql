...
-- primary_obligation_id: VALUES-EXT|00569|effect_query|rollback
...
WITH values_00569_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00569_cte)) ORDER BY column1;
-- primary-target-end
