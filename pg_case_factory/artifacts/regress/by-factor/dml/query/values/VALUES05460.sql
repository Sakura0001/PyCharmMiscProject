...
-- primary_obligation_id: VALUES-EXT|05460|error_assertion|drop_objects
...
WITH values_05460_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05460_cte)) ORDER BY column1;
-- primary-target-end
