...
-- primary_obligation_id: VALUES-EXT|00641|effect_query|rollback
...
WITH values_00641_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00641_cte)) ORDER BY column1;
-- primary-target-end
