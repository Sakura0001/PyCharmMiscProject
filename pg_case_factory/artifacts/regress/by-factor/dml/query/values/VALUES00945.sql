...
-- primary_obligation_id: VALUES-EXT|00945|returned_rows|drop_objects
...
WITH values_00945_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00945_cte)) ORDER BY column1;
-- primary-target-end
