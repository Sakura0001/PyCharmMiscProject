...
-- primary_obligation_id: VALUES-EXT|00962|catalog_query|rollback
...
WITH values_00962_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00962_cte)) ORDER BY column1;
-- primary-target-end
