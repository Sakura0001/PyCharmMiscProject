...
-- primary_obligation_id: VALUES-EXT|13349|effect_query|rollback
...
WITH values_13349_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13349_cte)) ORDER BY column1;
-- primary-target-end
