...
-- primary_obligation_id: VALUES-EXT|05585|effect_query|rollback
...
WITH values_05585_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05585_cte)) ORDER BY column1;
-- primary-target-end
