...
-- primary_obligation_id: VALUES-EXT|13645|error_assertion|reset_state
...
WITH values_13645_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13645_cte)) ORDER BY column1;
-- primary-target-end
