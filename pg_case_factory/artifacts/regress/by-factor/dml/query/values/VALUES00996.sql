...
-- primary_obligation_id: VALUES-EXT|00996|error_assertion|drop_objects
...
WITH values_00996_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00996_cte)) ORDER BY column1;
-- primary-target-end
