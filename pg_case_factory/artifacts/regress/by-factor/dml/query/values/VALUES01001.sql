...
-- primary_obligation_id: VALUES-EXT|01001|effect_query|rollback
...
WITH values_01001_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01001_cte)) ORDER BY column1;
-- primary-target-end
