...
-- primary_obligation_id: VALUES-EXT|07909|error_assertion|reset_state
...
WITH values_07909_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07909_cte)) ORDER BY column1;
-- primary-target-end
