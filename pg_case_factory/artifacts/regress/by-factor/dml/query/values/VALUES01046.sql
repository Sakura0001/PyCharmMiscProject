...
-- primary_obligation_id: VALUES-EXT|01046|catalog_query|rollback
...
WITH values_01046_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01046_cte)) ORDER BY column1;
-- primary-target-end
