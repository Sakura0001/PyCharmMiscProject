...
-- primary_obligation_id: VALUES-EXT|07469|effect_query|rollback
...
WITH values_07469_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07469_cte)) ORDER BY column1;
-- primary-target-end
