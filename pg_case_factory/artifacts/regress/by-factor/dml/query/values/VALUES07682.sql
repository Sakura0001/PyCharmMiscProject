...
-- primary_obligation_id: VALUES-EXT|07682|catalog_query|rollback
...
WITH values_07682_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07682_cte)) ORDER BY column1;
-- primary-target-end
