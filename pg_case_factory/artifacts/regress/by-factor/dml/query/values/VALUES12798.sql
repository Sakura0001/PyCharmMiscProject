...
-- primary_obligation_id: VALUES-EXT|12798|effect_query|drop_objects
...
WITH values_12798_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12798_cte)) ORDER BY column1;
-- primary-target-end
