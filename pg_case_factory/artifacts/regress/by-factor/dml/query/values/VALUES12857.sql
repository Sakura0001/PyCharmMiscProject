...
-- primary_obligation_id: VALUES-EXT|12857|effect_query|rollback
...
WITH values_12857_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12857_cte)) ORDER BY column1;
-- primary-target-end
