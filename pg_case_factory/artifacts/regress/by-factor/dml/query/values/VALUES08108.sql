...
-- primary_obligation_id: VALUES-EXT|08108|returned_rows|rollback
...
WITH values_08108_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08108_cte)) ORDER BY column1;
-- primary-target-end
