...
-- primary_obligation_id: VALUES-EXT|13428|error_assertion|drop_objects
...
WITH values_13428_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13428_cte)) ORDER BY column1;
-- primary-target-end
