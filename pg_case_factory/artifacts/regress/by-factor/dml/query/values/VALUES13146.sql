...
-- primary_obligation_id: VALUES-EXT|13146|effect_query|drop_objects
...
WITH values_13146_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13146_cte)) ORDER BY column1;
-- primary-target-end
