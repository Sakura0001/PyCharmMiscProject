...
-- primary_obligation_id: VALUES-EXT|05794|returned_rows|reset_state
...
WITH values_05794_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05794_cte)) ORDER BY column1;
-- primary-target-end
