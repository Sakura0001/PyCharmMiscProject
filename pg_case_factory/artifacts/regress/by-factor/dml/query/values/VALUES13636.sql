...
-- primary_obligation_id: VALUES-EXT|13636|catalog_query|reset_state
...
WITH values_13636_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13636_cte)) ORDER BY column1;
-- primary-target-end
