...
-- primary_obligation_id: VALUES-EXT|13273|error_assertion|reset_state
...
WITH values_13273_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13273_cte)) ORDER BY column1;
-- primary-target-end
