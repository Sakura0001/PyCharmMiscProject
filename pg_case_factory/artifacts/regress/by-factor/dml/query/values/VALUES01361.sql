...
-- primary_obligation_id: VALUES-EXT|01361|effect_query|rollback
...
WITH values_01361_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01361_cte)) ORDER BY column1;
-- primary-target-end
