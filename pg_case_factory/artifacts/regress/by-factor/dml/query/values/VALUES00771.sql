...
-- primary_obligation_id: VALUES-EXT|00771|catalog_query|drop_objects
...
WITH values_00771_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00771_cte)) ORDER BY column1;
-- primary-target-end
