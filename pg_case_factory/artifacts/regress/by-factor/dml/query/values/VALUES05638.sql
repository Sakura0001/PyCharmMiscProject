...
-- primary_obligation_id: VALUES-EXT|05638|returned_rows|reset_state
...
WITH values_05638_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05638_cte)) ORDER BY column1;
-- primary-target-end
