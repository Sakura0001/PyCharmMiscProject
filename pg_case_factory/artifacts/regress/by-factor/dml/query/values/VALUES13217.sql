...
-- primary_obligation_id: VALUES-EXT|13217|effect_query|rollback
...
WITH values_13217_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13217_cte)) ORDER BY column1;
-- primary-target-end
