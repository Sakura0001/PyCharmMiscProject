...
-- primary_obligation_id: VALUES-EXT|08093|effect_query|rollback
...
WITH values_08093_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08093_cte)) ORDER BY column1;
-- primary-target-end
