...
-- primary_obligation_id: VALUES-EXT|13371|catalog_query|drop_objects
...
WITH values_13371_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13371_cte)) ORDER BY column1;
-- primary-target-end
