...
-- primary_obligation_id: VALUES-EXT|01056|error_assertion|drop_objects
...
WITH values_01056_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01056_cte)) ORDER BY column1;
-- primary-target-end
