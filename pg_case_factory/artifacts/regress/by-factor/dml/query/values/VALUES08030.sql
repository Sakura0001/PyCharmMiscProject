...
-- primary_obligation_id: VALUES-EXT|08030|catalog_query|rollback
...
WITH values_08030_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08030_cte)) ORDER BY column1;
-- primary-target-end
