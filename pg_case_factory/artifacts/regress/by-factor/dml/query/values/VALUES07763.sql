...
-- primary_obligation_id: VALUES-EXT|07763|error_assertion|rollback
...
WITH values_07763_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07763_cte)) ORDER BY column1;
-- primary-target-end
