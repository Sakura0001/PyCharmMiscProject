...
-- primary_obligation_id: VALUES-EXT|07619|error_assertion|rollback
...
WITH values_07619_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07619_cte)) ORDER BY column1;
-- primary-target-end
