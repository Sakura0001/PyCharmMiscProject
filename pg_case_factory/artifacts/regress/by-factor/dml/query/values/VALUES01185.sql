...
-- primary_obligation_id: VALUES-EXT|01185|returned_rows|drop_objects
...
WITH values_01185_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01185_cte)) ORDER BY column1;
-- primary-target-end
