...
-- primary_obligation_id: VALUES-EXT|05717|effect_query|rollback
...
WITH values_05717_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05717_cte)) ORDER BY column1;
-- primary-target-end
