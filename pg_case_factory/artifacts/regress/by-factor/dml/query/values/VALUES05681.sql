...
-- primary_obligation_id: VALUES-EXT|05681|effect_query|rollback
...
WITH values_05681_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05681_cte)) ORDER BY column1;
-- primary-target-end
