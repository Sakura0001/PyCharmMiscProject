...
-- primary_obligation_id: VALUES-EXT|01335|catalog_query|drop_objects
...
WITH values_01335_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01335_cte)) ORDER BY column1;
-- primary-target-end
