...
-- primary_obligation_id: VALUES-EXT|05486|catalog_query|rollback
...
WITH values_05486_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05486_cte)) ORDER BY column1;
-- primary-target-end
