...
-- primary_obligation_id: VALUES-EXT|13113|returned_rows|drop_objects
...
WITH values_13113_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13113_cte)) ORDER BY column1;
-- primary-target-end
