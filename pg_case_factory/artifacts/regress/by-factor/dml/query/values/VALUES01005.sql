...
-- primary_obligation_id: VALUES-EXT|01005|returned_rows|drop_objects
...
WITH values_01005_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01005_cte)) ORDER BY column1;
-- primary-target-end
