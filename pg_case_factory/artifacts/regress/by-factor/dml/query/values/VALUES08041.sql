...
-- primary_obligation_id: VALUES-EXT|08041|error_assertion|reset_state
...
WITH values_08041_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08041_cte)) ORDER BY column1;
-- primary-target-end
