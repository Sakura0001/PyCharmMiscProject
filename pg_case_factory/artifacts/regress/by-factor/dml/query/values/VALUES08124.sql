...
-- primary_obligation_id: VALUES-EXT|08124|error_assertion|drop_objects
...
WITH values_08124_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08124_cte)) ORDER BY column1;
-- primary-target-end
