...
-- primary_obligation_id: VALUES-EXT|12922|returned_rows|reset_state
...
WITH values_12922_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12922_cte)) ORDER BY column1;
-- primary-target-end
