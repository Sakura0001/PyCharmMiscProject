...
-- primary_obligation_id: VALUES-EXT|08031|catalog_query|drop_objects
...
WITH values_08031_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08031_cte)) ORDER BY column1;
-- primary-target-end
