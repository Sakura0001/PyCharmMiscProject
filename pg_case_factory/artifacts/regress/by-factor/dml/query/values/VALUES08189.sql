...
-- primary_obligation_id: VALUES-EXT|08189|effect_query|rollback
...
WITH values_08189_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08189_cte)) ORDER BY column1;
-- primary-target-end
