...
-- primary_obligation_id: VALUES-EXT|00684|error_assertion|drop_objects
...
WITH values_00684_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00684_cte)) ORDER BY column1;
-- primary-target-end
