...
-- primary_obligation_id: VALUES-EXT|05664|error_assertion|drop_objects
...
WITH values_05664_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05664_cte)) ORDER BY column1;
-- primary-target-end
