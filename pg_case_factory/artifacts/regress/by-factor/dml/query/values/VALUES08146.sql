...
-- primary_obligation_id: VALUES-EXT|08146|returned_rows|reset_state
...
WITH values_08146_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08146_cte)) ORDER BY column1;
-- primary-target-end
