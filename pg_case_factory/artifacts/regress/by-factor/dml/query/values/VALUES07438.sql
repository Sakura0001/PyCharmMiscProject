...
-- primary_obligation_id: VALUES-EXT|07438|returned_rows|reset_state
...
WITH values_07438_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07438_cte)) ORDER BY column1;
-- primary-target-end
