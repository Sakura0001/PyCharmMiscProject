...
-- primary_obligation_id: VALUES-EXT|01261|error_assertion|reset_state
...
WITH values_01261_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01261_cte)) ORDER BY column1;
-- primary-target-end
