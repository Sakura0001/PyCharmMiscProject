...
-- primary_obligation_id: VALUES-EXT|13603|effect_query|reset_state
...
WITH values_13603_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13603_cte)) ORDER BY column1;
-- primary-target-end
