...
-- primary_obligation_id: VALUES-EXT|05709|returned_rows|drop_objects
...
WITH values_05709_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05709_cte)) ORDER BY column1;
-- primary-target-end
