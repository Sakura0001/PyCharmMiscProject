...
-- primary_obligation_id: VALUES-EXT|01322|catalog_query|rollback
...
WITH values_01322_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01322_cte)) ORDER BY column1;
-- primary-target-end
