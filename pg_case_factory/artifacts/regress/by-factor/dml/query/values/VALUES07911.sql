...
-- primary_obligation_id: VALUES-EXT|07911|catalog_query|drop_objects
...
WITH values_07911_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07911_cte)) ORDER BY column1;
-- primary-target-end
