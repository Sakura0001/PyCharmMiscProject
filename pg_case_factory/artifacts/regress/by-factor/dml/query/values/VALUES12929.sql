...
-- primary_obligation_id: VALUES-EXT|12929|effect_query|rollback
...
WITH values_12929_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12929_cte)) ORDER BY column1;
-- primary-target-end
