...
-- primary_obligation_id: VALUES-EXT|12918|effect_query|drop_objects
...
WITH values_12918_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12918_cte)) ORDER BY column1;
-- primary-target-end
