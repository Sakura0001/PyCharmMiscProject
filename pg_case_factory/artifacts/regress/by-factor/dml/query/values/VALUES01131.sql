...
-- primary_obligation_id: VALUES-EXT|01131|catalog_query|drop_objects
...
WITH values_01131_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01131_cte)) ORDER BY column1;
-- primary-target-end
