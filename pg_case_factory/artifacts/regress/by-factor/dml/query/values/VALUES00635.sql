...
-- primary_obligation_id: VALUES-EXT|00635|error_assertion|rollback
...
WITH values_00635_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00635_cte)) ORDER BY column1;
-- primary-target-end
