...
-- primary_obligation_id: VALUES-EXT|05733|returned_rows|drop_objects
...
WITH values_05733_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05733_cte)) ORDER BY column1;
-- primary-target-end
