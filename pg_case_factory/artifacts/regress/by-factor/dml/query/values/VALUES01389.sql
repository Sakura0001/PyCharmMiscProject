...
-- primary_obligation_id: VALUES-EXT|01389|returned_rows|drop_objects
...
WITH values_01389_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01389_cte)) ORDER BY column1;
-- primary-target-end
