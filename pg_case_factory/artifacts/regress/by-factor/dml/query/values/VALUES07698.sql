...
-- primary_obligation_id: VALUES-EXT|07698|effect_query|drop_objects
...
WITH values_07698_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07698_cte)) ORDER BY column1;
-- primary-target-end
