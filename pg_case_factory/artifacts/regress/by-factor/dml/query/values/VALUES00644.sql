...
-- primary_obligation_id: VALUES-EXT|00644|returned_rows|rollback
...
WITH values_00644_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00644_cte)) ORDER BY column1;
-- primary-target-end
