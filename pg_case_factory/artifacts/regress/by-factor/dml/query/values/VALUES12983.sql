...
-- primary_obligation_id: VALUES-EXT|12983|error_assertion|rollback
...
WITH values_12983_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12983_cte)) ORDER BY column1;
-- primary-target-end
