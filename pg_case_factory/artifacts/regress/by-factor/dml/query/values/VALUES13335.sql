...
-- primary_obligation_id: VALUES-EXT|13335|catalog_query|drop_objects
...
WITH values_13335_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13335_cte)) ORDER BY column1;
-- primary-target-end
