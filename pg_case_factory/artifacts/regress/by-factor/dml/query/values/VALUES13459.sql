...
-- primary_obligation_id: VALUES-EXT|13459|effect_query|reset_state
...
WITH values_13459_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13459_cte)) ORDER BY column1;
-- primary-target-end
