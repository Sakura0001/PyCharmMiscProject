...
-- primary_obligation_id: VALUES-EXT|07713|returned_rows|drop_objects
...
WITH values_07713_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07713_cte)) ORDER BY column1;
-- primary-target-end
