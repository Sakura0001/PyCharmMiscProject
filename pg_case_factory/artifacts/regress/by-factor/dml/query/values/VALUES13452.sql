...
-- primary_obligation_id: VALUES-EXT|13452|error_assertion|drop_objects
...
WITH values_13452_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13452_cte)) ORDER BY column1;
-- primary-target-end
