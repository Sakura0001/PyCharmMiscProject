...
-- primary_obligation_id: VALUES-EXT|13558|returned_rows|reset_state
...
WITH values_13558_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13558_cte)) ORDER BY column1;
-- primary-target-end
