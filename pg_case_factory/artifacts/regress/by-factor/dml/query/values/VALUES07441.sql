...
-- primary_obligation_id: VALUES-EXT|07441|error_assertion|reset_state
...
WITH values_07441_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07441_cte)) ORDER BY column1;
-- primary-target-end
