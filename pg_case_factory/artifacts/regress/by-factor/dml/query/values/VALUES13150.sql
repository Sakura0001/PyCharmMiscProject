...
-- primary_obligation_id: VALUES-EXT|13150|returned_rows|reset_state
...
WITH values_13150_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13150_cte)) ORDER BY column1;
-- primary-target-end
