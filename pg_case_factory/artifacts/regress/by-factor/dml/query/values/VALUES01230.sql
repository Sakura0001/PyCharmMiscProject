...
-- primary_obligation_id: VALUES-EXT|01230|effect_query|drop_objects
...
WITH values_01230_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01230_cte)) ORDER BY column1;
-- primary-target-end
