...
-- primary_obligation_id: VALUES-EXT|05710|returned_rows|reset_state
...
WITH values_05710_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05710_cte)) ORDER BY column1;
-- primary-target-end
