...
-- primary_obligation_id: VALUES-EXT|07760|returned_rows|rollback
...
WITH values_07760_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07760_cte)) ORDER BY column1;
-- primary-target-end
