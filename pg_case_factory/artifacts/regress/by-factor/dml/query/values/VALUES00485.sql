...
-- primary_obligation_id: VALUES-EXT|00485|effect_query|rollback
...
WITH values_00485_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00485_cte)) ORDER BY column1;
-- primary-target-end
