...
-- primary_obligation_id: VALUES-EXT|08156|returned_rows|rollback
...
WITH values_08156_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08156_cte)) ORDER BY column1;
-- primary-target-end
