...
-- primary_obligation_id: VALUES-EXT|13300|catalog_query|reset_state
...
WITH values_13300_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13300_cte)) ORDER BY column1;
-- primary-target-end
