...
-- primary_obligation_id: VALUES-EXT|13346|catalog_query|rollback
...
WITH values_13346_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13346_cte)) ORDER BY column1;
-- primary-target-end
