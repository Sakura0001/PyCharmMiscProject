...
-- primary_obligation_id: VALUES-EXT|12986|catalog_query|rollback
...
WITH values_12986_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12986_cte)) ORDER BY column1;
-- primary-target-end
