...
-- primary_obligation_id: VALUES-EXT|05752|catalog_query|reset_state
...
WITH values_05752_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05752_cte)) ORDER BY column1;
-- primary-target-end
