...
-- primary_obligation_id: VALUES-EXT|08105|effect_query|rollback
...
WITH values_08105_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08105_cte)) ORDER BY column1;
-- primary-target-end
