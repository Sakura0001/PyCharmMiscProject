...
-- primary_obligation_id: VALUES-EXT|12789|returned_rows|drop_objects
...
WITH values_12789_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12789_cte)) ORDER BY column1;
-- primary-target-end
