...
-- primary_obligation_id: VALUES-EXT|13248|error_assertion|drop_objects
...
WITH values_13248_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13248_cte)) ORDER BY column1;
-- primary-target-end
