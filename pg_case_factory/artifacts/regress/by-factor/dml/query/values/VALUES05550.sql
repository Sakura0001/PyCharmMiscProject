...
-- primary_obligation_id: VALUES-EXT|05550|effect_query|drop_objects
...
WITH values_05550_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05550_cte)) ORDER BY column1;
-- primary-target-end
