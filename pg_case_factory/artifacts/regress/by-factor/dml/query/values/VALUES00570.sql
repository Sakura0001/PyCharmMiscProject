...
-- primary_obligation_id: VALUES-EXT|00570|effect_query|drop_objects
...
WITH values_00570_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00570_cte)) ORDER BY column1;
-- primary-target-end
