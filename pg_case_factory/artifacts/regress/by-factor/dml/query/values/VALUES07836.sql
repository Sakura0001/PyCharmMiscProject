...
-- primary_obligation_id: VALUES-EXT|07836|error_assertion|drop_objects
...
WITH values_07836_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07836_cte)) ORDER BY column1;
-- primary-target-end
