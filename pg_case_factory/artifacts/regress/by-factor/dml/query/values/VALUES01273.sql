...
-- primary_obligation_id: VALUES-EXT|01273|error_assertion|reset_state
...
WITH values_01273_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01273_cte)) ORDER BY column1;
-- primary-target-end
