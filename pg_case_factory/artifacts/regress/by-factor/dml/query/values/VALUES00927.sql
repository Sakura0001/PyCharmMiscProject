...
-- primary_obligation_id: VALUES-EXT|00927|catalog_query|drop_objects
...
WITH values_00927_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00927_cte)) ORDER BY column1;
-- primary-target-end
