...
-- primary_obligation_id: VALUES-EXT|08182|returned_rows|reset_state
...
WITH values_08182_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08182_cte)) ORDER BY column1;
-- primary-target-end
