...
-- primary_obligation_id: VALUES-EXT|05724|error_assertion|drop_objects
...
WITH values_05724_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05724_cte)) ORDER BY column1;
-- primary-target-end
