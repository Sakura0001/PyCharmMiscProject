...
-- primary_obligation_id: VALUES-EXT|05807|error_assertion|rollback
...
WITH values_05807_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05807_cte)) ORDER BY column1;
-- primary-target-end
