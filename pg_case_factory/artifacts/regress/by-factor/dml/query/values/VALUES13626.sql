...
-- primary_obligation_id: VALUES-EXT|13626|effect_query|drop_objects
...
WITH values_13626_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13626_cte)) ORDER BY column1;
-- primary-target-end
