...
-- primary_obligation_id: VALUES-EXT|01384|catalog_query|reset_state
...
WITH values_01384_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01384_cte)) ORDER BY column1;
-- primary-target-end
