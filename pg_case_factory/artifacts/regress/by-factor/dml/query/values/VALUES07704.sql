...
-- primary_obligation_id: VALUES-EXT|07704|error_assertion|drop_objects
...
WITH values_07704_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07704_cte)) ORDER BY column1;
-- primary-target-end
