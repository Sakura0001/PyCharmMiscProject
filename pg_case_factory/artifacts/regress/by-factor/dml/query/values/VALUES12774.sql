...
-- primary_obligation_id: VALUES-EXT|12774|effect_query|drop_objects
...
WITH values_12774_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12774_cte)) ORDER BY column1;
-- primary-target-end
