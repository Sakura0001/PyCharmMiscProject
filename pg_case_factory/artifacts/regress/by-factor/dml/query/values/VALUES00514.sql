...
-- primary_obligation_id: VALUES-EXT|00514|returned_rows|reset_state
...
WITH values_00514_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00514_cte)) ORDER BY column1;
-- primary-target-end
