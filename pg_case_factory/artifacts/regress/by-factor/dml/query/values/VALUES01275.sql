...
-- primary_obligation_id: VALUES-EXT|01275|catalog_query|drop_objects
...
WITH values_01275_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01275_cte)) ORDER BY column1;
-- primary-target-end
