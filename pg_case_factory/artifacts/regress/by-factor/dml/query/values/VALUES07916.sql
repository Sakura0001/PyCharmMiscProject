...
-- primary_obligation_id: VALUES-EXT|07916|returned_rows|rollback
...
WITH values_07916_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07916_cte)) ORDER BY column1;
-- primary-target-end
