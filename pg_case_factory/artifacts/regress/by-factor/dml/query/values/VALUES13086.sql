...
-- primary_obligation_id: VALUES-EXT|13086|effect_query|drop_objects
...
WITH values_13086_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13086_cte)) ORDER BY column1;
-- primary-target-end
