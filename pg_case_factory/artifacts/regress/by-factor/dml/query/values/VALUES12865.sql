...
-- primary_obligation_id: VALUES-EXT|12865|error_assertion|reset_state
...
WITH values_12865_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12865_cte)) ORDER BY column1;
-- primary-target-end
