...
-- primary_obligation_id: VALUES-EXT|12820|catalog_query|reset_state
...
WITH values_12820_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12820_cte)) ORDER BY column1;
-- primary-target-end
