...
-- primary_obligation_id: VALUES-EXT|08018|catalog_query|rollback
...
WITH values_08018_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08018_cte)) ORDER BY column1;
-- primary-target-end
