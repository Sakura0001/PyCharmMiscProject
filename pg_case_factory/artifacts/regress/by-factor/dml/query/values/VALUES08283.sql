...
-- primary_obligation_id: VALUES-EXT|08283|catalog_query|drop_objects
...
WITH values_08283_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08283_cte)) ORDER BY column1;
-- primary-target-end
