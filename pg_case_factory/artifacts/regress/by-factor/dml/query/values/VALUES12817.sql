...
-- primary_obligation_id: VALUES-EXT|12817|error_assertion|reset_state
...
WITH values_12817_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12817_cte)) ORDER BY column1;
-- primary-target-end
