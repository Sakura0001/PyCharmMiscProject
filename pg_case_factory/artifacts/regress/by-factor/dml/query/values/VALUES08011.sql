...
-- primary_obligation_id: VALUES-EXT|08011|effect_query|reset_state
...
WITH values_08011_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08011_cte)) ORDER BY column1;
-- primary-target-end
