...
-- primary_obligation_id: VALUES-EXT|07695|catalog_query|drop_objects
...
WITH values_07695_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07695_cte)) ORDER BY column1;
-- primary-target-end
