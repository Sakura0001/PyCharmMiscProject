...
-- primary_obligation_id: VALUES-EXT|00630|effect_query|drop_objects
...
WITH values_00630_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00630_cte)) ORDER BY column1;
-- primary-target-end
