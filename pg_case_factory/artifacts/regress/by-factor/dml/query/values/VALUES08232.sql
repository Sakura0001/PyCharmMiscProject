...
-- primary_obligation_id: VALUES-EXT|08232|error_assertion|drop_objects
...
WITH values_08232_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08232_cte)) ORDER BY column1;
-- primary-target-end
