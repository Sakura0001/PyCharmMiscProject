...
-- primary_obligation_id: VALUES-EXT|01116|error_assertion|drop_objects
...
WITH values_01116_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01116_cte)) ORDER BY column1;
-- primary-target-end
