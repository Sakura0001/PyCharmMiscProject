...
-- primary_obligation_id: VALUES-EXT|08261|effect_query|rollback
...
WITH values_08261_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08261_cte)) ORDER BY column1;
-- primary-target-end
