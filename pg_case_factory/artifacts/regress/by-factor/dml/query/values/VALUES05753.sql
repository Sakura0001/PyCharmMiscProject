...
-- primary_obligation_id: VALUES-EXT|05753|effect_query|rollback
...
WITH values_05753_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05753_cte)) ORDER BY column1;
-- primary-target-end
