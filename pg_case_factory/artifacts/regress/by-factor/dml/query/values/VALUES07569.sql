...
-- primary_obligation_id: VALUES-EXT|07569|returned_rows|drop_objects
...
WITH values_07569_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07569_cte)) ORDER BY column1;
-- primary-target-end
