...
-- primary_obligation_id: VALUES-EXT|05792|returned_rows|rollback
...
WITH values_05792_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05792_cte)) ORDER BY column1;
-- primary-target-end
