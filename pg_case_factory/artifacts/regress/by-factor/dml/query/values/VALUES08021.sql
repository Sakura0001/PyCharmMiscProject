...
-- primary_obligation_id: VALUES-EXT|08021|effect_query|rollback
...
WITH values_08021_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08021_cte)) ORDER BY column1;
-- primary-target-end
