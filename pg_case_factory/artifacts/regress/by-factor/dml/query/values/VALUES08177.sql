...
-- primary_obligation_id: VALUES-EXT|08177|effect_query|rollback
...
WITH values_08177_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08177_cte)) ORDER BY column1;
-- primary-target-end
