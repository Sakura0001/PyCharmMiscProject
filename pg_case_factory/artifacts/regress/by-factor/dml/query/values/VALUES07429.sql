...
-- primary_obligation_id: VALUES-EXT|07429|error_assertion|reset_state
...
WITH values_07429_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07429_cte)) ORDER BY column1;
-- primary-target-end
