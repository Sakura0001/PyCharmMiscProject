...
-- primary_obligation_id: VALUES-EXT|07689|returned_rows|drop_objects
...
WITH values_07689_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07689_cte)) ORDER BY column1;
-- primary-target-end
