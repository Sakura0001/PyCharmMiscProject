...
-- primary_obligation_id: VALUES-EXT|05641|error_assertion|reset_state
...
WITH values_05641_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05641_cte)) ORDER BY column1;
-- primary-target-end
