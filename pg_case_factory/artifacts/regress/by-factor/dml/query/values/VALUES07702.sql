...
-- primary_obligation_id: VALUES-EXT|07702|returned_rows|reset_state
...
WITH values_07702_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07702_cte)) ORDER BY column1;
-- primary-target-end
