...
-- primary_obligation_id: VALUES-EXT|08089|error_assertion|reset_state
...
WITH values_08089_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08089_cte)) ORDER BY column1;
-- primary-target-end
