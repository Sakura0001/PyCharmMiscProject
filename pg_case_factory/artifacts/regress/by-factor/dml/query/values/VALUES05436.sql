...
-- primary_obligation_id: VALUES-EXT|05436|error_assertion|drop_objects
...
WITH values_05436_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05436_cte)) ORDER BY column1;
-- primary-target-end
