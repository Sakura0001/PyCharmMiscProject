...
-- primary_obligation_id: VALUES-EXT|05803|effect_query|reset_state
...
WITH values_05803_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05803_cte)) ORDER BY column1;
-- primary-target-end
