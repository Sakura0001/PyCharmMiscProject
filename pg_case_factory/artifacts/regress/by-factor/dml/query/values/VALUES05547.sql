...
-- primary_obligation_id: VALUES-EXT|05547|catalog_query|drop_objects
...
WITH values_05547_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05547_cte)) ORDER BY column1;
-- primary-target-end
