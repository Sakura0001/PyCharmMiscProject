...
-- primary_obligation_id: VALUES-EXT|07994|catalog_query|rollback
...
WITH values_07994_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07994_cte)) ORDER BY column1;
-- primary-target-end
