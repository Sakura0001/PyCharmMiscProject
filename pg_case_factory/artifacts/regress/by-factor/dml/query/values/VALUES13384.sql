...
-- primary_obligation_id: VALUES-EXT|13384|catalog_query|reset_state
...
WITH values_13384_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13384_cte)) ORDER BY column1;
-- primary-target-end
