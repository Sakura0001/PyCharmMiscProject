...
-- primary_obligation_id: VALUES-EXT|08160|error_assertion|drop_objects
...
WITH values_08160_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08160_cte)) ORDER BY column1;
-- primary-target-end
