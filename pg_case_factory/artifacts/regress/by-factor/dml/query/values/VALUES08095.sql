...
-- primary_obligation_id: VALUES-EXT|08095|effect_query|reset_state
...
WITH values_08095_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08095_cte)) ORDER BY column1;
-- primary-target-end
