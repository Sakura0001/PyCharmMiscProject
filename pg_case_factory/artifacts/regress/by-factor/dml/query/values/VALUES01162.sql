...
-- primary_obligation_id: VALUES-EXT|01162|returned_rows|reset_state
...
WITH values_01162_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01162_cte)) ORDER BY column1;
-- primary-target-end
