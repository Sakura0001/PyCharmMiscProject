...
-- primary_obligation_id: VALUES-EXT|07718|catalog_query|rollback
...
WITH values_07718_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07718_cte)) ORDER BY column1;
-- primary-target-end
