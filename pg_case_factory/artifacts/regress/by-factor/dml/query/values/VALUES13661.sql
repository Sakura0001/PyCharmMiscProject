...
-- primary_obligation_id: VALUES-EXT|13661|effect_query|rollback
...
WITH values_13661_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13661_cte)) ORDER BY column1;
-- primary-target-end
