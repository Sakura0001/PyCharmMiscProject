...
-- primary_obligation_id: VALUES-EXT|01049|effect_query|rollback
...
WITH values_01049_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01049_cte)) ORDER BY column1;
-- primary-target-end
