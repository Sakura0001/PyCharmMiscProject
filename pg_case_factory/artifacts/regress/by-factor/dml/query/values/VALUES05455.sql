...
-- primary_obligation_id: VALUES-EXT|05455|effect_query|reset_state
...
WITH values_05455_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05455_cte)) ORDER BY column1;
-- primary-target-end
