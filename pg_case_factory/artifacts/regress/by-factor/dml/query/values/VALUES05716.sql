...
-- primary_obligation_id: VALUES-EXT|05716|catalog_query|reset_state
...
WITH values_05716_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05716_cte)) ORDER BY column1;
-- primary-target-end
