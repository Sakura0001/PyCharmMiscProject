...
-- primary_obligation_id: VALUES-EXT|08076|error_assertion|drop_objects
...
WITH values_08076_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08076_cte)) ORDER BY column1;
-- primary-target-end
