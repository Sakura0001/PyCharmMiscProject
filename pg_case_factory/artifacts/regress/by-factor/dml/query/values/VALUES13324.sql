...
-- primary_obligation_id: VALUES-EXT|13324|catalog_query|reset_state
...
WITH values_13324_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13324_cte)) ORDER BY column1;
-- primary-target-end
