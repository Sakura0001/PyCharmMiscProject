...
-- primary_obligation_id: VALUES-EXT|00651|catalog_query|drop_objects
...
WITH values_00651_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00651_cte)) ORDER BY column1;
-- primary-target-end
