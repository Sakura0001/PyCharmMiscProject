...
-- primary_obligation_id: VALUES-EXT|13251|catalog_query|drop_objects
...
WITH values_13251_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13251_cte)) ORDER BY column1;
-- primary-target-end
