...
-- primary_obligation_id: VALUES-EXT|05523|catalog_query|drop_objects
...
WITH values_05523_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05523_cte)) ORDER BY column1;
-- primary-target-end
