...
-- primary_obligation_id: VALUES-EXT|01356|error_assertion|drop_objects
...
WITH values_01356_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01356_cte)) ORDER BY column1;
-- primary-target-end
