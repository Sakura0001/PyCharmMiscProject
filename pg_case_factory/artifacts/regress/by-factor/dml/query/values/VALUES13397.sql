...
-- primary_obligation_id: VALUES-EXT|13397|effect_query|rollback
...
WITH values_13397_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13397_cte)) ORDER BY column1;
-- primary-target-end
