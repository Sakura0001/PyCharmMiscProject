...
-- primary_obligation_id: VALUES-EXT|05595|catalog_query|drop_objects
...
WITH values_05595_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05595_cte)) ORDER BY column1;
-- primary-target-end
