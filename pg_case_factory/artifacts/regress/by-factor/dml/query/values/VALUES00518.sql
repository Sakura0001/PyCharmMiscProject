...
-- primary_obligation_id: VALUES-EXT|00518|catalog_query|rollback
...
WITH values_00518_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00518_cte)) ORDER BY column1;
-- primary-target-end
