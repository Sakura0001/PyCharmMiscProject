...
-- primary_obligation_id: VALUES-EXT|07696|catalog_query|reset_state
...
WITH values_07696_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07696_cte)) ORDER BY column1;
-- primary-target-end
