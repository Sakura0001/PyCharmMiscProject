...
-- primary_obligation_id: VALUES-EXT|00931|effect_query|reset_state
...
WITH values_00931_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00931_cte)) ORDER BY column1;
-- primary-target-end
