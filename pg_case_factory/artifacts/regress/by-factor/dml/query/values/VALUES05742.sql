...
-- primary_obligation_id: VALUES-EXT|05742|effect_query|drop_objects
...
WITH values_05742_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05742_cte)) ORDER BY column1;
-- primary-target-end
