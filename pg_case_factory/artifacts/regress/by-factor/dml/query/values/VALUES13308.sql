...
-- primary_obligation_id: VALUES-EXT|13308|error_assertion|drop_objects
...
WITH values_13308_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13308_cte)) ORDER BY column1;
-- primary-target-end
