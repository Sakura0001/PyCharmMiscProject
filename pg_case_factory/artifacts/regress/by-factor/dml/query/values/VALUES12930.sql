...
-- primary_obligation_id: VALUES-EXT|12930|effect_query|drop_objects
...
WITH values_12930_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12930_cte)) ORDER BY column1;
-- primary-target-end
