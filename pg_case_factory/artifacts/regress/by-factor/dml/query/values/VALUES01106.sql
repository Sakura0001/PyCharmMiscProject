...
-- primary_obligation_id: VALUES-EXT|01106|catalog_query|rollback
...
WITH values_01106_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01106_cte)) ORDER BY column1;
-- primary-target-end
