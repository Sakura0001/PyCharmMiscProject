...
-- primary_obligation_id: VALUES-EXT|00990|effect_query|drop_objects
...
WITH values_00990_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00990_cte)) ORDER BY column1;
-- primary-target-end
