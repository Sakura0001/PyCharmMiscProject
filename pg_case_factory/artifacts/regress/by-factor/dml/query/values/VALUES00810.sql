...
-- primary_obligation_id: VALUES-EXT|00810|effect_query|drop_objects
...
WITH values_00810_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00810_cte)) ORDER BY column1;
-- primary-target-end
