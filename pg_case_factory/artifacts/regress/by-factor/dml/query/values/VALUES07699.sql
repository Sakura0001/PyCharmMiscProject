...
-- primary_obligation_id: VALUES-EXT|07699|effect_query|reset_state
...
WITH values_07699_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07699_cte)) ORDER BY column1;
-- primary-target-end
