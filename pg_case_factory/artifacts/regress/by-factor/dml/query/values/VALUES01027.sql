...
-- primary_obligation_id: VALUES-EXT|01027|effect_query|reset_state
...
WITH values_01027_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01027_cte)) ORDER BY column1;
-- primary-target-end
