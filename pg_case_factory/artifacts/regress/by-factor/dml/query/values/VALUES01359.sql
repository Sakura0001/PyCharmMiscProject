...
-- primary_obligation_id: VALUES-EXT|01359|catalog_query|drop_objects
...
WITH values_01359_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01359_cte)) ORDER BY column1;
-- primary-target-end
