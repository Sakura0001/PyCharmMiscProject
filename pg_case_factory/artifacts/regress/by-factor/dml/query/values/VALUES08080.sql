...
-- primary_obligation_id: VALUES-EXT|08080|catalog_query|reset_state
...
WITH values_08080_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08080_cte)) ORDER BY column1;
-- primary-target-end
