...
-- primary_obligation_id: VALUES-EXT|05700|error_assertion|drop_objects
...
WITH values_05700_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05700_cte)) ORDER BY column1;
-- primary-target-end
