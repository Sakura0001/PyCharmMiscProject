...
-- primary_obligation_id: VALUES-EXT|08262|effect_query|drop_objects
...
WITH values_08262_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08262_cte)) ORDER BY column1;
-- primary-target-end
