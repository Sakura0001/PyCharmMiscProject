...
-- primary_obligation_id: VALUES-EXT|13139|error_assertion|rollback
...
WITH values_13139_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13139_cte)) ORDER BY column1;
-- primary-target-end
