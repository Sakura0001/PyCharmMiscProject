...
-- primary_obligation_id: VALUES-EXT|08161|error_assertion|reset_state
...
WITH values_08161_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08161_cte)) ORDER BY column1;
-- primary-target-end
