...
-- primary_obligation_id: VALUES-EXT|01302|effect_query|drop_objects
...
WITH values_01302_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01302_cte)) ORDER BY column1;
-- primary-target-end
