...
-- primary_obligation_id: VALUES-EXT|12928|catalog_query|reset_state
...
WITH values_12928_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12928_cte)) ORDER BY column1;
-- primary-target-end
