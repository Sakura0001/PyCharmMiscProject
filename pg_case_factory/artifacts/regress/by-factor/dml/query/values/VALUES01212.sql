...
-- primary_obligation_id: VALUES-EXT|01212|error_assertion|drop_objects
...
WITH values_01212_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01212_cte)) ORDER BY column1;
-- primary-target-end
