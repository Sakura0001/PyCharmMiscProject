...
-- primary_obligation_id: VALUES-EXT|01083|catalog_query|drop_objects
...
WITH values_01083_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01083_cte)) ORDER BY column1;
-- primary-target-end
