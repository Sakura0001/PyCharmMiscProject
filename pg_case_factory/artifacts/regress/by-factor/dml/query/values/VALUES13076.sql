...
-- primary_obligation_id: VALUES-EXT|13076|returned_rows|rollback
...
WITH values_13076_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13076_cte)) ORDER BY column1;
-- primary-target-end
