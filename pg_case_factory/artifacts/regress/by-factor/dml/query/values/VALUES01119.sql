...
-- primary_obligation_id: VALUES-EXT|01119|catalog_query|drop_objects
...
WITH values_01119_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01119_cte)) ORDER BY column1;
-- primary-target-end
