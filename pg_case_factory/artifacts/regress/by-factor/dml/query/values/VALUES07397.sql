...
-- primary_obligation_id: VALUES-EXT|07397|effect_query|rollback
...
WITH values_07397_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07397_cte)) ORDER BY column1;
-- primary-target-end
