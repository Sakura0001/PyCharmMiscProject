...
-- primary_obligation_id: VALUES-EXT|13578|effect_query|drop_objects
...
WITH values_13578_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13578_cte)) ORDER BY column1;
-- primary-target-end
