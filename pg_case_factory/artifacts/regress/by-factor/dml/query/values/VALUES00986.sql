...
-- primary_obligation_id: VALUES-EXT|00986|catalog_query|rollback
...
WITH values_00986_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00986_cte)) ORDER BY column1;
-- primary-target-end
