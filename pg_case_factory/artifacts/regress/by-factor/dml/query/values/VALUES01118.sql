...
-- primary_obligation_id: VALUES-EXT|01118|catalog_query|rollback
...
WITH values_01118_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01118_cte)) ORDER BY column1;
-- primary-target-end
