...
-- primary_obligation_id: VALUES-EXT|13383|catalog_query|drop_objects
...
WITH values_13383_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13383_cte)) ORDER BY column1;
-- primary-target-end
