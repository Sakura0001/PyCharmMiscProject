...
-- primary_obligation_id: VALUES-EXT|05750|catalog_query|rollback
...
WITH values_05750_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05750_cte)) ORDER BY column1;
-- primary-target-end
