...
-- primary_obligation_id: VALUES-EXT|07948|catalog_query|reset_state
...
WITH values_07948_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07948_cte)) ORDER BY column1;
-- primary-target-end
