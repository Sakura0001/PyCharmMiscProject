...
-- primary_obligation_id: VALUES-EXT|05584|catalog_query|reset_state
...
WITH values_05584_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05584_cte)) ORDER BY column1;
-- primary-target-end
