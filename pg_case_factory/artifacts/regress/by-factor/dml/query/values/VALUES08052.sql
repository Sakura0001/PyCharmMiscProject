...
-- primary_obligation_id: VALUES-EXT|08052|error_assertion|drop_objects
...
WITH values_08052_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08052_cte)) ORDER BY column1;
-- primary-target-end
