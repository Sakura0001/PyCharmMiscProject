...
-- primary_obligation_id: VALUES-EXT|08202|effect_query|drop_objects
...
WITH values_08202_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08202_cte)) ORDER BY column1;
-- primary-target-end
