...
-- primary_obligation_id: VALUES-EXT|08075|error_assertion|rollback
...
WITH values_08075_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08075_cte)) ORDER BY column1;
-- primary-target-end
