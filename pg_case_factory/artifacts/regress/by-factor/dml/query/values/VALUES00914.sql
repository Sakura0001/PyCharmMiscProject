...
-- primary_obligation_id: VALUES-EXT|00914|catalog_query|rollback
...
WITH values_00914_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00914_cte)) ORDER BY column1;
-- primary-target-end
