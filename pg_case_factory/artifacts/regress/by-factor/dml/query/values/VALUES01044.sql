...
-- primary_obligation_id: VALUES-EXT|01044|error_assertion|drop_objects
...
WITH values_01044_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01044_cte)) ORDER BY column1;
-- primary-target-end
