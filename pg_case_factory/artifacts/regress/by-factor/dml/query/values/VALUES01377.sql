...
-- primary_obligation_id: VALUES-EXT|01377|returned_rows|drop_objects
...
WITH values_01377_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01377_cte)) ORDER BY column1;
-- primary-target-end
