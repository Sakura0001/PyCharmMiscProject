...
-- primary_obligation_id: VALUES-EXT|07606|returned_rows|reset_state
...
WITH values_07606_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07606_cte)) ORDER BY column1;
-- primary-target-end
