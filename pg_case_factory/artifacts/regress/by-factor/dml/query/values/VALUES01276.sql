...
-- primary_obligation_id: VALUES-EXT|01276|catalog_query|reset_state
...
WITH values_01276_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01276_cte)) ORDER BY column1;
-- primary-target-end
