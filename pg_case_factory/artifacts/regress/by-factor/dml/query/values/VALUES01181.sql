...
-- primary_obligation_id: VALUES-EXT|01181|effect_query|rollback
...
WITH values_01181_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01181_cte)) ORDER BY column1;
-- primary-target-end
