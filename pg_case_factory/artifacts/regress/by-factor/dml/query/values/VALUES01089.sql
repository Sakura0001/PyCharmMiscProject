...
-- primary_obligation_id: VALUES-EXT|01089|returned_rows|drop_objects
...
WITH values_01089_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01089_cte)) ORDER BY column1;
-- primary-target-end
