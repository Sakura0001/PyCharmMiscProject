...
-- primary_obligation_id: VALUES-EXT|08221|error_assertion|reset_state
...
WITH values_08221_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08221_cte)) ORDER BY column1;
-- primary-target-end
