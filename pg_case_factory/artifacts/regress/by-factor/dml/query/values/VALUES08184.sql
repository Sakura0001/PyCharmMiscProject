...
-- primary_obligation_id: VALUES-EXT|08184|error_assertion|drop_objects
...
WITH values_08184_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08184_cte)) ORDER BY column1;
-- primary-target-end
