...
-- primary_obligation_id: VALUES-EXT|01370|catalog_query|rollback
...
WITH values_01370_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01370_cte)) ORDER BY column1;
-- primary-target-end
