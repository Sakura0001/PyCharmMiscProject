...
-- primary_obligation_id: VALUES-EXT|05617|error_assertion|reset_state
...
WITH values_05617_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05617_cte)) ORDER BY column1;
-- primary-target-end
