...
-- primary_obligation_id: VALUES-EXT|07419|catalog_query|drop_objects
...
WITH values_07419_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07419_cte)) ORDER BY column1;
-- primary-target-end
