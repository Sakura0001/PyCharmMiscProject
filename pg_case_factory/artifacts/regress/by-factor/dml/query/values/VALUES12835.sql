...
-- primary_obligation_id: VALUES-EXT|12835|effect_query|reset_state
...
WITH values_12835_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12835_cte)) ORDER BY column1;
-- primary-target-end
