...
-- primary_obligation_id: VALUES-EXT|08060|returned_rows|rollback
...
WITH values_08060_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08060_cte)) ORDER BY column1;
-- primary-target-end
