...
-- primary_obligation_id: VALUES-EXT|13088|returned_rows|rollback
...
WITH values_13088_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13088_cte)) ORDER BY column1;
-- primary-target-end
