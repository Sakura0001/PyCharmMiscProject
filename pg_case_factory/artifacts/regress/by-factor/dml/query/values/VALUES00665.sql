...
-- primary_obligation_id: VALUES-EXT|00665|effect_query|rollback
...
WITH values_00665_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00665_cte)) ORDER BY column1;
-- primary-target-end
