...
-- primary_obligation_id: VALUES-EXT|01012|catalog_query|reset_state
...
WITH values_01012_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01012_cte)) ORDER BY column1;
-- primary-target-end
