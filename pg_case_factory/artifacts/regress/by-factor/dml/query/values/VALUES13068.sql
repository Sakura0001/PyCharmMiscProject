...
-- primary_obligation_id: VALUES-EXT|13068|error_assertion|drop_objects
...
WITH values_13068_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13068_cte)) ORDER BY column1;
-- primary-target-end
