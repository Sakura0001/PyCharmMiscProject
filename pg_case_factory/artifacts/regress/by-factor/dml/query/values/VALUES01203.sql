...
-- primary_obligation_id: VALUES-EXT|01203|catalog_query|drop_objects
...
WITH values_01203_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01203_cte)) ORDER BY column1;
-- primary-target-end
