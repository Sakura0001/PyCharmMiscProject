...
-- primary_obligation_id: VALUES-EXT|13576|catalog_query|reset_state
...
WITH values_13576_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13576_cte)) ORDER BY column1;
-- primary-target-end
