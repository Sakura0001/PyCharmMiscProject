...
-- primary_obligation_id: VALUES-EXT|08094|effect_query|drop_objects
...
WITH values_08094_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08094_cte)) ORDER BY column1;
-- primary-target-end
