...
-- primary_obligation_id: VALUES-EXT|08079|catalog_query|drop_objects
...
WITH values_08079_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08079_cte)) ORDER BY column1;
-- primary-target-end
