...
-- primary_obligation_id: VALUES-EXT|12840|error_assertion|drop_objects
...
WITH values_12840_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12840_cte)) ORDER BY column1;
-- primary-target-end
