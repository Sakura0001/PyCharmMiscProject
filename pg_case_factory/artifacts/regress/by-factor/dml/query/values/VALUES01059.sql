...
-- primary_obligation_id: VALUES-EXT|01059|catalog_query|drop_objects
...
WITH values_01059_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01059_cte)) ORDER BY column1;
-- primary-target-end
