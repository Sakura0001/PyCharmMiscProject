...
-- primary_obligation_id: VALUES-EXT|12821|effect_query|rollback
...
WITH values_12821_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12821_cte)) ORDER BY column1;
-- primary-target-end
