...
-- primary_obligation_id: VALUES-EXT|05805|returned_rows|drop_objects
...
WITH values_05805_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05805_cte)) ORDER BY column1;
-- primary-target-end
