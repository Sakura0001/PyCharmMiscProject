...
-- primary_obligation_id: VALUES-EXT|05621|effect_query|rollback
...
WITH values_05621_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05621_cte)) ORDER BY column1;
-- primary-target-end
