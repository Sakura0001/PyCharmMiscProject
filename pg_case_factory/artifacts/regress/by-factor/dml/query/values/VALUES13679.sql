...
-- primary_obligation_id: VALUES-EXT|13679|error_assertion|rollback
...
WITH values_13679_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13679_cte)) ORDER BY column1;
-- primary-target-end
