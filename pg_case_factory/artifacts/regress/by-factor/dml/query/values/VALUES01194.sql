...
-- primary_obligation_id: VALUES-EXT|01194|effect_query|drop_objects
...
WITH values_01194_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01194_cte)) ORDER BY column1;
-- primary-target-end
