...
-- primary_obligation_id: VALUES-EXT|01277|effect_query|rollback
...
WITH values_01277_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01277_cte)) ORDER BY column1;
-- primary-target-end
