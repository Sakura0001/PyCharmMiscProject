...
-- primary_obligation_id: VALUES-EXT|13317|returned_rows|drop_objects
...
WITH values_13317_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13317_cte)) ORDER BY column1;
-- primary-target-end
