...
-- primary_obligation_id: VALUES-EXT|05540|returned_rows|rollback
...
WITH values_05540_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05540_cte)) ORDER BY column1;
-- primary-target-end
