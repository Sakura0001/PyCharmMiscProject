...
-- primary_obligation_id: VALUES-EXT|00919|effect_query|reset_state
...
WITH values_00919_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00919_cte)) ORDER BY column1;
-- primary-target-end
