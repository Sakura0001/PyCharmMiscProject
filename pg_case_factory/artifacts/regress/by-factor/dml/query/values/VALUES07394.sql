...
-- primary_obligation_id: VALUES-EXT|07394|catalog_query|rollback
...
WITH values_07394_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07394_cte)) ORDER BY column1;
-- primary-target-end
