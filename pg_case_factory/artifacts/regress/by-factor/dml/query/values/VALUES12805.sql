...
-- primary_obligation_id: VALUES-EXT|12805|error_assertion|reset_state
...
WITH values_12805_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12805_cte)) ORDER BY column1;
-- primary-target-end
