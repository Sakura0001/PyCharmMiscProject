...
-- primary_obligation_id: VALUES-EXT|13070|catalog_query|rollback
...
WITH values_13070_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13070_cte)) ORDER BY column1;
-- primary-target-end
