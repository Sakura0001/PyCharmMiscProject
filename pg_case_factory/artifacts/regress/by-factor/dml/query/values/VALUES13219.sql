...
-- primary_obligation_id: VALUES-EXT|13219|effect_query|reset_state
...
WITH values_13219_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13219_cte)) ORDER BY column1;
-- primary-target-end
