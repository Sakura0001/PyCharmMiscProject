...
-- primary_obligation_id: VALUES-EXT|00657|returned_rows|drop_objects
...
WITH values_00657_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00657_cte)) ORDER BY column1;
-- primary-target-end
