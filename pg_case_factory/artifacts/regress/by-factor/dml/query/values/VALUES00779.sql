...
-- primary_obligation_id: VALUES-EXT|00779|error_assertion|rollback
...
WITH values_00779_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00779_cte)) ORDER BY column1;
-- primary-target-end
