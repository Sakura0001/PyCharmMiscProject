...
-- primary_obligation_id: VALUES-EXT|05544|error_assertion|drop_objects
...
WITH values_05544_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05544_cte)) ORDER BY column1;
-- primary-target-end
