...
-- primary_obligation_id: VALUES-EXT|01196|returned_rows|rollback
...
WITH values_01196_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01196_cte)) ORDER BY column1;
-- primary-target-end
