...
-- primary_obligation_id: VALUES-EXT|01233|returned_rows|drop_objects
...
WITH values_01233_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01233_cte)) ORDER BY column1;
-- primary-target-end
