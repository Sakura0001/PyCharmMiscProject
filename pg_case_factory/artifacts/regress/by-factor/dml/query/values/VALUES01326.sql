...
-- primary_obligation_id: VALUES-EXT|01326|effect_query|drop_objects
...
WITH values_01326_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01326_cte)) ORDER BY column1;
-- primary-target-end
