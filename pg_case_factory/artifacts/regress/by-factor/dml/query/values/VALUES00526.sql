...
-- primary_obligation_id: VALUES-EXT|00526|returned_rows|reset_state
...
WITH values_00526_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00526_cte)) ORDER BY column1;
-- primary-target-end
