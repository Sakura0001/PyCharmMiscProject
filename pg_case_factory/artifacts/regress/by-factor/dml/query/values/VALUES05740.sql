...
-- primary_obligation_id: VALUES-EXT|05740|catalog_query|reset_state
...
WITH values_05740_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05740_cte)) ORDER BY column1;
-- primary-target-end
