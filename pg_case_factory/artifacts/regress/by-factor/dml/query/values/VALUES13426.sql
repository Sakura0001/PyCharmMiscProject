...
-- primary_obligation_id: VALUES-EXT|13426|returned_rows|reset_state
...
WITH values_13426_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13426_cte)) ORDER BY column1;
-- primary-target-end
