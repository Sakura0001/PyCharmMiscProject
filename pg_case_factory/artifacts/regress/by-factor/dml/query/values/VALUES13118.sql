...
-- primary_obligation_id: VALUES-EXT|13118|catalog_query|rollback
...
WITH values_13118_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13118_cte)) ORDER BY column1;
-- primary-target-end
