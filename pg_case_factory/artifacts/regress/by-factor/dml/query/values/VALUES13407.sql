...
-- primary_obligation_id: VALUES-EXT|13407|catalog_query|drop_objects
...
WITH values_13407_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13407_cte)) ORDER BY column1;
-- primary-target-end
