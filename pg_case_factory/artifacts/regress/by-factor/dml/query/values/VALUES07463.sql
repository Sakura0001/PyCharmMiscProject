...
-- primary_obligation_id: VALUES-EXT|07463|error_assertion|rollback
...
WITH values_07463_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07463_cte)) ORDER BY column1;
-- primary-target-end
