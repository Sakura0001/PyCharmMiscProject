...
-- primary_obligation_id: VALUES-EXT|05727|catalog_query|drop_objects
...
WITH values_05727_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05727_cte)) ORDER BY column1;
-- primary-target-end
