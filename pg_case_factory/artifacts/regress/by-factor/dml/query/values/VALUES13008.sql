...
-- primary_obligation_id: VALUES-EXT|13008|error_assertion|drop_objects
...
WITH values_13008_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13008_cte)) ORDER BY column1;
-- primary-target-end
