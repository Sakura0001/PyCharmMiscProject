...
-- primary_obligation_id: VALUES-EXT|08131|effect_query|reset_state
...
WITH values_08131_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08131_cte)) ORDER BY column1;
-- primary-target-end
