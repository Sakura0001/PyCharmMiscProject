...
-- primary_obligation_id: VALUES-EXT|08216|returned_rows|rollback
...
WITH values_08216_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08216_cte)) ORDER BY column1;
-- primary-target-end
