...
-- primary_obligation_id: VALUES-EXT|07891|effect_query|reset_state
...
WITH values_07891_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07891_cte)) ORDER BY column1;
-- primary-target-end
