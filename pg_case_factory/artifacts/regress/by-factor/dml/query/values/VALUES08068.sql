...
-- primary_obligation_id: VALUES-EXT|08068|catalog_query|reset_state
...
WITH values_08068_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08068_cte)) ORDER BY column1;
-- primary-target-end
