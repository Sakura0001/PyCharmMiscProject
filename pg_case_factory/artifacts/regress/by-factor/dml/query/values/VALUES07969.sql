...
-- primary_obligation_id: VALUES-EXT|07969|error_assertion|reset_state
...
WITH values_07969_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07969_cte)) ORDER BY column1;
-- primary-target-end
