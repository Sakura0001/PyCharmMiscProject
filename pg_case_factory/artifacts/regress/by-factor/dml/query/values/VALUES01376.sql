...
-- primary_obligation_id: VALUES-EXT|01376|returned_rows|rollback
...
WITH values_01376_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01376_cte)) ORDER BY column1;
-- primary-target-end
