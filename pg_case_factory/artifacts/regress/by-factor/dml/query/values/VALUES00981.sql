...
-- primary_obligation_id: VALUES-EXT|00981|returned_rows|drop_objects
...
WITH values_00981_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00981_cte)) ORDER BY column1;
-- primary-target-end
