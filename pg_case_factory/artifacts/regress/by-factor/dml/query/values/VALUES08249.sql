...
-- primary_obligation_id: VALUES-EXT|08249|effect_query|rollback
...
WITH values_08249_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08249_cte)) ORDER BY column1;
-- primary-target-end
