...
-- primary_obligation_id: VALUES-EXT|13432|catalog_query|reset_state
...
WITH values_13432_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13432_cte)) ORDER BY column1;
-- primary-target-end
