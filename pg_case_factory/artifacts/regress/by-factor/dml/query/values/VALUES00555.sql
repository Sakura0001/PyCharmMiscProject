...
-- primary_obligation_id: VALUES-EXT|00555|catalog_query|drop_objects
...
WITH values_00555_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00555_cte)) ORDER BY column1;
-- primary-target-end
