...
-- primary_obligation_id: VALUES-EXT|13548|error_assertion|drop_objects
...
WITH values_13548_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13548_cte)) ORDER BY column1;
-- primary-target-end
