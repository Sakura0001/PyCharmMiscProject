...
-- primary_obligation_id: VALUES-EXT|13114|returned_rows|reset_state
...
WITH values_13114_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13114_cte)) ORDER BY column1;
-- primary-target-end
