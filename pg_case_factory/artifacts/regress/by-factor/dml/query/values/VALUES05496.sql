...
-- primary_obligation_id: VALUES-EXT|05496|error_assertion|drop_objects
...
WITH values_05496_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05496_cte)) ORDER BY column1;
-- primary-target-end
