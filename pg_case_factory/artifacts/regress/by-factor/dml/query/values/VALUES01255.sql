...
-- primary_obligation_id: VALUES-EXT|01255|effect_query|reset_state
...
WITH values_01255_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01255_cte)) ORDER BY column1;
-- primary-target-end
