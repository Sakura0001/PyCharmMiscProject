...
-- primary_obligation_id: VALUES-EXT|08168|returned_rows|rollback
...
WITH values_08168_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08168_cte)) ORDER BY column1;
-- primary-target-end
