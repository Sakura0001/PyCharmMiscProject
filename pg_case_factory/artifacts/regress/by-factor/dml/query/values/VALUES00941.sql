...
-- primary_obligation_id: VALUES-EXT|00941|effect_query|rollback
...
WITH values_00941_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00941_cte)) ORDER BY column1;
-- primary-target-end
