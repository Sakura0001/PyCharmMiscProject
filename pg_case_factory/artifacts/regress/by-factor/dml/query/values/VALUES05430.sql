...
-- primary_obligation_id: VALUES-EXT|05430|effect_query|drop_objects
...
WITH values_05430_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05430_cte)) ORDER BY column1;
-- primary-target-end
