...
-- primary_obligation_id: VALUES-EXT|00834|effect_query|drop_objects
...
WITH values_00834_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00834_cte)) ORDER BY column1;
-- primary-target-end
