...
-- primary_obligation_id: VALUES-EXT|13284|error_assertion|drop_objects
...
WITH values_13284_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13284_cte)) ORDER BY column1;
-- primary-target-end
