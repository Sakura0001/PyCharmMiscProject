...
-- primary_obligation_id: VALUES-EXT|01057|error_assertion|reset_state
...
WITH values_01057_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01057_cte)) ORDER BY column1;
-- primary-target-end
