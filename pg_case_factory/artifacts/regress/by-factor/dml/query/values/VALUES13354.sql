...
-- primary_obligation_id: VALUES-EXT|13354|returned_rows|reset_state
...
WITH values_13354_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13354_cte)) ORDER BY column1;
-- primary-target-end
