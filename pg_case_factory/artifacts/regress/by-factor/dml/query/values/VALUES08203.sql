...
-- primary_obligation_id: VALUES-EXT|08203|effect_query|reset_state
...
WITH values_08203_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08203_cte)) ORDER BY column1;
-- primary-target-end
