...
-- primary_obligation_id: VALUES-EXT|00718|returned_rows|reset_state
...
WITH values_00718_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00718_cte)) ORDER BY column1;
-- primary-target-end
