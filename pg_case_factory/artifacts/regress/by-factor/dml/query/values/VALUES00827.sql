...
-- primary_obligation_id: VALUES-EXT|00827|error_assertion|rollback
...
WITH values_00827_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00827_cte)) ORDER BY column1;
-- primary-target-end
