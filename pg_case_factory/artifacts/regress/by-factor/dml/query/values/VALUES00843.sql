...
-- primary_obligation_id: VALUES-EXT|00843|catalog_query|drop_objects
...
WITH values_00843_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00843_cte)) ORDER BY column1;
-- primary-target-end
