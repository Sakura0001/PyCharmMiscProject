...
-- primary_obligation_id: VALUES-EXT|01047|catalog_query|drop_objects
...
WITH values_01047_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01047_cte)) ORDER BY column1;
-- primary-target-end
