...
-- primary_obligation_id: VALUES-EXT|08127|catalog_query|drop_objects
...
WITH values_08127_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08127_cte)) ORDER BY column1;
-- primary-target-end
