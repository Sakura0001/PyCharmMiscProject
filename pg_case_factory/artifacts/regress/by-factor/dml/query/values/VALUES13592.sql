...
-- primary_obligation_id: VALUES-EXT|13592|returned_rows|rollback
...
WITH values_13592_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13592_cte)) ORDER BY column1;
-- primary-target-end
