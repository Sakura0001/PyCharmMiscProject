...
-- primary_obligation_id: VALUES-EXT|07961|effect_query|rollback
...
WITH values_07961_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07961_cte)) ORDER BY column1;
-- primary-target-end
