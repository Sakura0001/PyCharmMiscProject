...
-- primary_obligation_id: VALUES-EXT|01168|catalog_query|reset_state
...
WITH values_01168_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01168_cte)) ORDER BY column1;
-- primary-target-end
