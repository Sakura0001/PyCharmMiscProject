...
-- primary_obligation_id: VALUES-EXT|01371|catalog_query|drop_objects
...
WITH values_01371_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01371_cte)) ORDER BY column1;
-- primary-target-end
