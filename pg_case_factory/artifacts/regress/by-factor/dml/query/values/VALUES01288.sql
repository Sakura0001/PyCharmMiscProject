...
-- primary_obligation_id: VALUES-EXT|01288|catalog_query|reset_state
...
WITH values_01288_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01288_cte)) ORDER BY column1;
-- primary-target-end
