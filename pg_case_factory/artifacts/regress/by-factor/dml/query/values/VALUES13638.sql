...
-- primary_obligation_id: VALUES-EXT|13638|effect_query|drop_objects
...
WITH values_13638_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13638_cte)) ORDER BY column1;
-- primary-target-end
