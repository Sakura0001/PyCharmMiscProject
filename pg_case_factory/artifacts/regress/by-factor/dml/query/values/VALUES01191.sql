...
-- primary_obligation_id: VALUES-EXT|01191|catalog_query|drop_objects
...
WITH values_01191_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01191_cte)) ORDER BY column1;
-- primary-target-end
