...
-- primary_obligation_id: VALUES-EXT|01068|error_assertion|drop_objects
...
WITH values_01068_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01068_cte)) ORDER BY column1;
-- primary-target-end
