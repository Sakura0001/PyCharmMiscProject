...
-- primary_obligation_id: VALUES-EXT|05759|error_assertion|rollback
...
WITH values_05759_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05759_cte)) ORDER BY column1;
-- primary-target-end
