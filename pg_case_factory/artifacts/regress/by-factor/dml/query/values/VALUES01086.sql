...
-- primary_obligation_id: VALUES-EXT|01086|effect_query|drop_objects
...
WITH values_01086_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01086_cte)) ORDER BY column1;
-- primary-target-end
