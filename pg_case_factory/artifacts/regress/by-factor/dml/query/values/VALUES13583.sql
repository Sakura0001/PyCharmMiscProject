...
-- primary_obligation_id: VALUES-EXT|13583|error_assertion|rollback
...
WITH values_13583_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13583_cte)) ORDER BY column1;
-- primary-target-end
