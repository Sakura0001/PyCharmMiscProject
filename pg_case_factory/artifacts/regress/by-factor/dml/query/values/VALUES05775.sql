...
-- primary_obligation_id: VALUES-EXT|05775|catalog_query|drop_objects
...
WITH values_05775_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05775_cte)) ORDER BY column1;
-- primary-target-end
