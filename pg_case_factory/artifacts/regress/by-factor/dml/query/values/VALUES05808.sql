...
-- primary_obligation_id: VALUES-EXT|05808|error_assertion|drop_objects
...
WITH values_05808_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05808_cte)) ORDER BY column1;
-- primary-target-end
