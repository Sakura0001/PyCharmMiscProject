...
-- primary_obligation_id: VALUES-EXT|07946|catalog_query|rollback
...
WITH values_07946_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07946_cte)) ORDER BY column1;
-- primary-target-end
