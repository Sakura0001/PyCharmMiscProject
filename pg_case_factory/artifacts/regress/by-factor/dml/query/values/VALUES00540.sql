...
-- primary_obligation_id: VALUES-EXT|00540|error_assertion|drop_objects
...
WITH values_00540_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00540_cte)) ORDER BY column1;
-- primary-target-end
