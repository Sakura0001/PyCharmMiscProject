...
-- primary_obligation_id: VALUES-EXT|01318|returned_rows|reset_state
...
WITH values_01318_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01318_cte)) ORDER BY column1;
-- primary-target-end
