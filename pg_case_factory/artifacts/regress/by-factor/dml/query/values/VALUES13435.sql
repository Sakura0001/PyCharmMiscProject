...
-- primary_obligation_id: VALUES-EXT|13435|effect_query|reset_state
...
WITH values_13435_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13435_cte)) ORDER BY column1;
-- primary-target-end
