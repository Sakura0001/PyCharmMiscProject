...
-- primary_obligation_id: VALUES-EXT|08147|error_assertion|rollback
...
WITH values_08147_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08147_cte)) ORDER BY column1;
-- primary-target-end
