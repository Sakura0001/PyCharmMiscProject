...
-- primary_obligation_id: VALUES-EXT|00847|effect_query|reset_state
...
WITH values_00847_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00847_cte)) ORDER BY column1;
-- primary-target-end
