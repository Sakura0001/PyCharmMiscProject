...
-- primary_obligation_id: VALUES-EXT|00650|catalog_query|rollback
...
WITH values_00650_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00650_cte)) ORDER BY column1;
-- primary-target-end
