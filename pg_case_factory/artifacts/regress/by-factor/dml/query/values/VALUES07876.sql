...
-- primary_obligation_id: VALUES-EXT|07876|catalog_query|reset_state
...
WITH values_07876_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07876_cte)) ORDER BY column1;
-- primary-target-end
