...
-- primary_obligation_id: VALUES-EXT|07894|returned_rows|reset_state
...
WITH values_07894_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07894_cte)) ORDER BY column1;
-- primary-target-end
