...
-- primary_obligation_id: VALUES-EXT|00482|catalog_query|rollback
...
WITH values_00482_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00482_cte)) ORDER BY column1;
-- primary-target-end
