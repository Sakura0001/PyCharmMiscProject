...
-- primary_obligation_id: VALUES-EXT|07998|effect_query|drop_objects
...
WITH values_07998_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07998_cte)) ORDER BY column1;
-- primary-target-end
