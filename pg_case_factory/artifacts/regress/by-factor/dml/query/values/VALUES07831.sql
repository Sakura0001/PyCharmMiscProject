...
-- primary_obligation_id: VALUES-EXT|07831|effect_query|reset_state
...
WITH values_07831_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07831_cte)) ORDER BY column1;
-- primary-target-end
