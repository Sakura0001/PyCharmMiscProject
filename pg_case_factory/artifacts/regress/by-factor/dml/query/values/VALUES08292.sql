...
-- primary_obligation_id: VALUES-EXT|08292|error_assertion|drop_objects
...
WITH values_08292_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08292_cte)) ORDER BY column1;
-- primary-target-end
