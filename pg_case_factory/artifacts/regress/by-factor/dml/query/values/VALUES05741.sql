...
-- primary_obligation_id: VALUES-EXT|05741|effect_query|rollback
...
WITH values_05741_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05741_cte)) ORDER BY column1;
-- primary-target-end
