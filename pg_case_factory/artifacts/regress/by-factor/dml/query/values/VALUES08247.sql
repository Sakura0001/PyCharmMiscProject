...
-- primary_obligation_id: VALUES-EXT|08247|catalog_query|drop_objects
...
WITH values_08247_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08247_cte)) ORDER BY column1;
-- primary-target-end
