...
-- primary_obligation_id: VALUES-EXT|13202|catalog_query|rollback
...
WITH values_13202_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13202_cte)) ORDER BY column1;
-- primary-target-end
