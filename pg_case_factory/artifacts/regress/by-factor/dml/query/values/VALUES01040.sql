...
-- primary_obligation_id: VALUES-EXT|01040|returned_rows|rollback
...
WITH values_01040_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01040_cte)) ORDER BY column1;
-- primary-target-end
