...
-- primary_obligation_id: VALUES-EXT|00808|catalog_query|reset_state
...
WITH values_00808_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00808_cte)) ORDER BY column1;
-- primary-target-end
