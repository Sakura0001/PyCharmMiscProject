...
-- primary_obligation_id: VALUES-EXT|08163|catalog_query|drop_objects
...
WITH values_08163_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08163_cte)) ORDER BY column1;
-- primary-target-end
