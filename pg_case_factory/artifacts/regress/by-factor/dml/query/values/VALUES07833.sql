...
-- primary_obligation_id: VALUES-EXT|07833|returned_rows|drop_objects
...
WITH values_07833_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07833_cte)) ORDER BY column1;
-- primary-target-end
