...
-- version      : 1.0
-- description  : VALUES constraint_boundary=constraint_violation
...
-- primary_obligation_id: VALUES-EXT|05508|error_assertion|drop_objects
...
WITH values_05508_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05508_cte)) ORDER BY column1;
-- primary-target-end
