...
-- primary_obligation_id: VALUES-EXT|01188|error_assertion|drop_objects
...
WITH values_01188_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01188_cte)) ORDER BY column1;
-- primary-target-end
