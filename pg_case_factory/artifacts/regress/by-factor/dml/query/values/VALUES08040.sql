...
-- primary_obligation_id: VALUES-EXT|08040|error_assertion|drop_objects
...
WITH values_08040_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08040_cte)) ORDER BY column1;
-- primary-target-end
