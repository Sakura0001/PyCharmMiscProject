...
-- primary_obligation_id: VALUES-EXT|08277|returned_rows|drop_objects
...
WITH values_08277_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08277_cte)) ORDER BY column1;
-- primary-target-end
