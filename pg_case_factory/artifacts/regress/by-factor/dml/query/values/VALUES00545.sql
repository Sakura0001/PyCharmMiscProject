...
-- primary_obligation_id: VALUES-EXT|00545|effect_query|rollback
...
WITH values_00545_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00545_cte)) ORDER BY column1;
-- primary-target-end
