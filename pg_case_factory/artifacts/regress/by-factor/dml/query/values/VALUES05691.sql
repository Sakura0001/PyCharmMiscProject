...
-- primary_obligation_id: VALUES-EXT|05691|catalog_query|drop_objects
...
WITH values_05691_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05691_cte)) ORDER BY column1;
-- primary-target-end
