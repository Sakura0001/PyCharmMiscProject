...
-- primary_obligation_id: VALUES-EXT|01077|returned_rows|drop_objects
...
WITH values_01077_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01077_cte)) ORDER BY column1;
-- primary-target-end
