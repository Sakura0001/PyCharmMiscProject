...
-- primary_obligation_id: VALUES-EXT|01296|error_assertion|drop_objects
...
WITH values_01296_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01296_cte)) ORDER BY column1;
-- primary-target-end
