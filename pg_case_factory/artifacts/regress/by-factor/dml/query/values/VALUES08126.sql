...
-- primary_obligation_id: VALUES-EXT|08126|catalog_query|rollback
...
WITH values_08126_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08126_cte)) ORDER BY column1;
-- primary-target-end
