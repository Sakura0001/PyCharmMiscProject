...
-- primary_obligation_id: VALUES-EXT|00531|catalog_query|drop_objects
...
WITH values_00531_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00531_cte)) ORDER BY column1;
-- primary-target-end
