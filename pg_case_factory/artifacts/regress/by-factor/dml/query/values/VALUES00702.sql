...
-- primary_obligation_id: VALUES-EXT|00702|effect_query|drop_objects
...
WITH values_00702_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00702_cte)) ORDER BY column1;
-- primary-target-end
