...
-- primary_obligation_id: VALUES-EXT|01220|returned_rows|rollback
...
WITH values_01220_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01220_cte)) ORDER BY column1;
-- primary-target-end
