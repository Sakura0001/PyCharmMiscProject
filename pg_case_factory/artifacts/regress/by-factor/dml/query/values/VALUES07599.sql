...
-- primary_obligation_id: VALUES-EXT|07599|catalog_query|drop_objects
...
WITH values_07599_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07599_cte)) ORDER BY column1;
-- primary-target-end
