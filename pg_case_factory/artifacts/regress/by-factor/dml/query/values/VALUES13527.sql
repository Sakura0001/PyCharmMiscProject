...
-- primary_obligation_id: VALUES-EXT|13527|catalog_query|drop_objects
...
WITH values_13527_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13527_cte)) ORDER BY column1;
-- primary-target-end
