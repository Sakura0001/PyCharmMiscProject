...
-- primary_obligation_id: VALUES-EXT|08290|returned_rows|reset_state
...
WITH values_08290_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08290_cte)) ORDER BY column1;
-- primary-target-end
