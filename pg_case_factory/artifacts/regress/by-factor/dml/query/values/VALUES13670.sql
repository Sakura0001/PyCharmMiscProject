...
-- primary_obligation_id: VALUES-EXT|13670|catalog_query|rollback
...
WITH values_13670_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13670_cte)) ORDER BY column1;
-- primary-target-end
