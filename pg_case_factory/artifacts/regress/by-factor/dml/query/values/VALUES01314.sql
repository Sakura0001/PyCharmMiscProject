...
-- primary_obligation_id: VALUES-EXT|01314|effect_query|drop_objects
...
WITH values_01314_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01314_cte)) ORDER BY column1;
-- primary-target-end
