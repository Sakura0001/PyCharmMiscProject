...
-- primary_obligation_id: VALUES-EXT|13256|returned_rows|rollback
...
WITH values_13256_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13256_cte)) ORDER BY column1;
-- primary-target-end
