...
-- primary_obligation_id: VALUES-EXT|05661|returned_rows|drop_objects
...
WITH values_05661_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05661_cte)) ORDER BY column1;
-- primary-target-end
