...
-- primary_obligation_id: VALUES-EXT|12934|returned_rows|reset_state
...
WITH values_12934_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12934_cte)) ORDER BY column1;
-- primary-target-end
