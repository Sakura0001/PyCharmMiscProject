...
-- primary_obligation_id: VALUES-EXT|00934|returned_rows|reset_state
...
WITH values_00934_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00934_cte)) ORDER BY column1;
-- primary-target-end
