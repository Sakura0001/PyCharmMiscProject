...
-- primary_obligation_id: VALUES-EXT|07827|catalog_query|drop_objects
...
WITH values_07827_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07827_cte)) ORDER BY column1;
-- primary-target-end
