...
-- primary_obligation_id: VALUES-EXT|13567|effect_query|reset_state
...
WITH values_13567_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13567_cte)) ORDER BY column1;
-- primary-target-end
