...
-- primary_obligation_id: VALUES-EXT|00958|returned_rows|reset_state
...
WITH values_00958_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00958_cte)) ORDER BY column1;
-- primary-target-end
