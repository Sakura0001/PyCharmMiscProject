...
-- primary_obligation_id: VALUES-EXT|01274|catalog_query|rollback
...
WITH values_01274_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01274_cte)) ORDER BY column1;
-- primary-target-end
