...
-- primary_obligation_id: VALUES-EXT|01139|error_assertion|rollback
...
WITH values_01139_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01139_cte)) ORDER BY column1;
-- primary-target-end
