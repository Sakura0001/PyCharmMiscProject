...
-- primary_obligation_id: VALUES-EXT|07572|error_assertion|drop_objects
...
WITH values_07572_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07572_cte)) ORDER BY column1;
-- primary-target-end
