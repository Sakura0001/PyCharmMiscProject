...
-- primary_obligation_id: VALUES-EXT|01241|effect_query|rollback
...
WITH values_01241_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01241_cte)) ORDER BY column1;
-- primary-target-end
