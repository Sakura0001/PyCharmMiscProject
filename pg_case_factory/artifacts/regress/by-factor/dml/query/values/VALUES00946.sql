...
-- primary_obligation_id: VALUES-EXT|00946|returned_rows|reset_state
...
WITH values_00946_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00946_cte)) ORDER BY column1;
-- primary-target-end
