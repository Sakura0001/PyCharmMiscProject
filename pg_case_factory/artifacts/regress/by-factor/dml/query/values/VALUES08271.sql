...
-- primary_obligation_id: VALUES-EXT|08271|catalog_query|drop_objects
...
WITH values_08271_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08271_cte)) ORDER BY column1;
-- primary-target-end
