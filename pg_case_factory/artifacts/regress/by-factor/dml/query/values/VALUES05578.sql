...
-- primary_obligation_id: VALUES-EXT|05578|returned_rows|reset_state
...
WITH values_05578_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05578_cte)) ORDER BY column1;
-- primary-target-end
