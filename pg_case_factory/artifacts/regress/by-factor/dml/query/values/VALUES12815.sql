...
-- primary_obligation_id: VALUES-EXT|12815|error_assertion|rollback
...
WITH values_12815_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12815_cte)) ORDER BY column1;
-- primary-target-end
