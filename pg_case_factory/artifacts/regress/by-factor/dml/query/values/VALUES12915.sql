...
-- primary_obligation_id: VALUES-EXT|12915|catalog_query|drop_objects
...
WITH values_12915_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12915_cte)) ORDER BY column1;
-- primary-target-end
