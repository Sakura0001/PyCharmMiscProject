...
-- primary_obligation_id: VALUES-EXT|05442|effect_query|drop_objects
...
WITH values_05442_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05442_cte)) ORDER BY column1;
-- primary-target-end
