...
-- primary_obligation_id: VALUES-EXT|05787|catalog_query|drop_objects
...
WITH values_05787_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05787_cte)) ORDER BY column1;
-- primary-target-end
