...
-- primary_obligation_id: VALUES-EXT|13302|effect_query|drop_objects
...
WITH values_13302_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13302_cte)) ORDER BY column1;
-- primary-target-end
