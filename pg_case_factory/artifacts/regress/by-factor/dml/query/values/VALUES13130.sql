...
-- primary_obligation_id: VALUES-EXT|13130|catalog_query|rollback
...
WITH values_13130_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13130_cte)) ORDER BY column1;
-- primary-target-end
