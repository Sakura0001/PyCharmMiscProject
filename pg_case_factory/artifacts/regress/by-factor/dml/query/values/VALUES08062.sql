...
-- primary_obligation_id: VALUES-EXT|08062|returned_rows|reset_state
...
WITH values_08062_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08062_cte)) ORDER BY column1;
-- primary-target-end
