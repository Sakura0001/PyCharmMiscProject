...
-- primary_obligation_id: VALUES-EXT|01272|error_assertion|drop_objects
...
WITH values_01272_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01272_cte)) ORDER BY column1;
-- primary-target-end
