...
-- primary_obligation_id: VALUES-EXT|13646|catalog_query|rollback
...
WITH values_13646_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13646_cte)) ORDER BY column1;
-- primary-target-end
