...
-- primary_obligation_id: VALUES-EXT|00984|error_assertion|drop_objects
...
WITH values_00984_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00984_cte)) ORDER BY column1;
-- primary-target-end
