...
-- primary_obligation_id: VALUES-EXT|05501|effect_query|rollback
...
WITH values_05501_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05501_cte)) ORDER BY column1;
-- primary-target-end
