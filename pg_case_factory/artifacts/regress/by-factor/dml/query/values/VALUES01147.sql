...
-- primary_obligation_id: VALUES-EXT|01147|effect_query|reset_state
...
WITH values_01147_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01147_cte)) ORDER BY column1;
-- primary-target-end
