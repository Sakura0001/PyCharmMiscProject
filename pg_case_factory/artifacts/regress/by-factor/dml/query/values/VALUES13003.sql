...
-- primary_obligation_id: VALUES-EXT|13003|effect_query|reset_state
...
WITH values_13003_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13003_cte)) ORDER BY column1;
-- primary-target-end
