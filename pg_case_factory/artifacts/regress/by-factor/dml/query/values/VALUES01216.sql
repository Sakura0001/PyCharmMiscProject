...
-- primary_obligation_id: VALUES-EXT|01216|catalog_query|reset_state
...
WITH values_01216_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01216_cte)) ORDER BY column1;
-- primary-target-end
