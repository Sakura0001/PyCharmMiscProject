...
-- primary_obligation_id: VALUES-EXT|00541|error_assertion|reset_state
...
WITH values_00541_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00541_cte)) ORDER BY column1;
-- primary-target-end
