...
-- primary_obligation_id: VALUES-EXT|05476|catalog_query|reset_state
...
WITH values_05476_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05476_cte)) ORDER BY column1;
-- primary-target-end
