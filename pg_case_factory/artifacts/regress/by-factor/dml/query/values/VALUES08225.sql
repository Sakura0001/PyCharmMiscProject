...
-- primary_obligation_id: VALUES-EXT|08225|effect_query|rollback
...
WITH values_08225_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08225_cte)) ORDER BY column1;
-- primary-target-end
