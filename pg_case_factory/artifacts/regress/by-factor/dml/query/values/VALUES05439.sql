...
-- primary_obligation_id: VALUES-EXT|05439|catalog_query|drop_objects
...
WITH values_05439_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05439_cte)) ORDER BY column1;
-- primary-target-end
