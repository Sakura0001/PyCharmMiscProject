...
-- primary_obligation_id: VALUES-EXT|08175|catalog_query|drop_objects
...
WITH values_08175_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08175_cte)) ORDER BY column1;
-- primary-target-end
