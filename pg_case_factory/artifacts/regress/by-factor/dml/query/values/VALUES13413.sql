...
-- primary_obligation_id: VALUES-EXT|13413|returned_rows|drop_objects
...
WITH values_13413_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13413_cte)) ORDER BY column1;
-- primary-target-end
