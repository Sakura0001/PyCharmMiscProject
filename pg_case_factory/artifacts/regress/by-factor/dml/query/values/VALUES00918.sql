...
-- primary_obligation_id: VALUES-EXT|00918|effect_query|drop_objects
...
WITH values_00918_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00918_cte)) ORDER BY column1;
-- primary-target-end
