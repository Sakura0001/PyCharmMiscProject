...
-- primary_obligation_id: VALUES-EXT|08224|catalog_query|reset_state
...
WITH values_08224_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08224_cte)) ORDER BY column1;
-- primary-target-end
