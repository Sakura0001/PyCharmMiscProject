...
-- primary_obligation_id: VALUES-EXT|12802|returned_rows|reset_state
...
WITH values_12802_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12802_cte)) ORDER BY column1;
-- primary-target-end
