...
-- primary_obligation_id: VALUES-EXT|01346|catalog_query|rollback
...
WITH values_01346_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01346_cte)) ORDER BY column1;
-- primary-target-end
