...
-- primary_obligation_id: VALUES-EXT|07927|effect_query|reset_state
...
WITH values_07927_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07927_cte)) ORDER BY column1;
-- primary-target-end
