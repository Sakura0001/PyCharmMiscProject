...
-- primary_obligation_id: VALUES-EXT|12965|effect_query|rollback
...
WITH values_12965_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12965_cte)) ORDER BY column1;
-- primary-target-end
