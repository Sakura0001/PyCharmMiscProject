...
-- primary_obligation_id: VALUES-EXT|12816|error_assertion|drop_objects
...
WITH values_12816_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12816_cte)) ORDER BY column1;
-- primary-target-end
