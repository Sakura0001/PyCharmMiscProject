...
-- primary_obligation_id: VALUES-EXT|08259|catalog_query|drop_objects
...
WITH values_08259_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08259_cte)) ORDER BY column1;
-- primary-target-end
