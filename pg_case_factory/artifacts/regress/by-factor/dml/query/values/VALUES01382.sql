...
-- primary_obligation_id: VALUES-EXT|01382|catalog_query|rollback
...
WITH values_01382_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01382_cte)) ORDER BY column1;
-- primary-target-end
