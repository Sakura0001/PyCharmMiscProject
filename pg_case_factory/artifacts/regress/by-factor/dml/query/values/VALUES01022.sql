...
-- primary_obligation_id: VALUES-EXT|01022|catalog_query|rollback
...
WITH values_01022_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01022_cte)) ORDER BY column1;
-- primary-target-end
