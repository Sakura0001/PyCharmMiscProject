...
-- primary_obligation_id: VALUES-EXT|13406|catalog_query|rollback
...
WITH values_13406_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13406_cte)) ORDER BY column1;
-- primary-target-end
