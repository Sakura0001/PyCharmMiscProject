...
-- primary_obligation_id: VALUES-EXT|00932|returned_rows|rollback
...
WITH values_00932_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00932_cte)) ORDER BY column1;
-- primary-target-end
