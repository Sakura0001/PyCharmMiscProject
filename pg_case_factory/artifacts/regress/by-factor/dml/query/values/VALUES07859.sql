...
-- primary_obligation_id: VALUES-EXT|07859|error_assertion|rollback
...
WITH values_07859_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07859_cte)) ORDER BY column1;
-- primary-target-end
