...
-- primary_obligation_id: VALUES-EXT|07436|returned_rows|rollback
...
WITH values_07436_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07436_cte)) ORDER BY column1;
-- primary-target-end
