...
-- primary_obligation_id: VALUES-EXT|01098|effect_query|drop_objects
...
WITH values_01098_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01098_cte)) ORDER BY column1;
-- primary-target-end
