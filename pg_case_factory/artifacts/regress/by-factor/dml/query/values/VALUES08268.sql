...
-- primary_obligation_id: VALUES-EXT|08268|error_assertion|drop_objects
...
WITH values_08268_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08268_cte)) ORDER BY column1;
-- primary-target-end
