...
-- primary_obligation_id: VALUES-EXT|05607|catalog_query|drop_objects
...
WITH values_05607_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05607_cte)) ORDER BY column1;
-- primary-target-end
