...
-- primary_obligation_id: VALUES-EXT|13554|effect_query|drop_objects
...
WITH values_13554_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13554_cte)) ORDER BY column1;
-- primary-target-end
