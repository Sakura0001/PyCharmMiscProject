...
-- primary_obligation_id: VALUES-EXT|00859|effect_query|reset_state
...
WITH values_00859_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00859_cte)) ORDER BY column1;
-- primary-target-end
