...
-- primary_obligation_id: VALUES-EXT|08196|error_assertion|drop_objects
...
WITH values_08196_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08196_cte)) ORDER BY column1;
-- primary-target-end
