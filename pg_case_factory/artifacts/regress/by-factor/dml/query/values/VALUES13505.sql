...
-- primary_obligation_id: VALUES-EXT|13505|effect_query|rollback
...
WITH values_13505_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13505_cte)) ORDER BY column1;
-- primary-target-end
