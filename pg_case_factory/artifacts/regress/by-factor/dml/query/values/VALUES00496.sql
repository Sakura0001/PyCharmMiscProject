...
-- primary_obligation_id: VALUES-EXT|00496|catalog_query|reset_state
...
WITH values_00496_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00496_cte)) ORDER BY column1;
-- primary-target-end
