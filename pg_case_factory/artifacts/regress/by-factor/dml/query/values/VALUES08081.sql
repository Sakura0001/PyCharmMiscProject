...
-- primary_obligation_id: VALUES-EXT|08081|effect_query|rollback
...
WITH values_08081_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08081_cte)) ORDER BY column1;
-- primary-target-end
