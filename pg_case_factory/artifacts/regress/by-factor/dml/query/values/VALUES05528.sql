...
-- primary_obligation_id: VALUES-EXT|05528|returned_rows|rollback
...
WITH values_05528_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05528_cte)) ORDER BY column1;
-- primary-target-end
