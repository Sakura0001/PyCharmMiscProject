...
-- primary_obligation_id: VALUES-EXT|00556|catalog_query|reset_state
...
WITH values_00556_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00556_cte)) ORDER BY column1;
-- primary-target-end
