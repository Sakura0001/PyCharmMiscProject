...
-- primary_obligation_id: VALUES-EXT|12858|effect_query|drop_objects
...
WITH values_12858_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12858_cte)) ORDER BY column1;
-- primary-target-end
