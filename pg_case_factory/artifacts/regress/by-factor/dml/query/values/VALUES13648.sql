...
-- primary_obligation_id: VALUES-EXT|13648|catalog_query|reset_state
...
WITH values_13648_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13648_cte)) ORDER BY column1;
-- primary-target-end
