...
-- primary_obligation_id: VALUES-EXT|12855|catalog_query|drop_objects
...
WITH values_12855_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12855_cte)) ORDER BY column1;
-- primary-target-end
