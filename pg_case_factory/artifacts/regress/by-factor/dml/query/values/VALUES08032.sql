...
-- primary_obligation_id: VALUES-EXT|08032|catalog_query|reset_state
...
WITH values_08032_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08032_cte)) ORDER BY column1;
-- primary-target-end
