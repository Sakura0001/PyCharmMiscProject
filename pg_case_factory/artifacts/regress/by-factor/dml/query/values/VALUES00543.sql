...
-- primary_obligation_id: VALUES-EXT|00543|catalog_query|drop_objects
...
WITH values_00543_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00543_cte)) ORDER BY column1;
-- primary-target-end
