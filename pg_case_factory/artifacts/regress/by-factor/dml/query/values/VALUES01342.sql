...
-- primary_obligation_id: VALUES-EXT|01342|returned_rows|reset_state
...
WITH values_01342_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01342_cte)) ORDER BY column1;
-- primary-target-end
