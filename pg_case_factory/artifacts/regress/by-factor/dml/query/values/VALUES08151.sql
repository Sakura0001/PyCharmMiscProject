...
-- primary_obligation_id: VALUES-EXT|08151|catalog_query|drop_objects
...
WITH values_08151_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08151_cte)) ORDER BY column1;
-- primary-target-end
