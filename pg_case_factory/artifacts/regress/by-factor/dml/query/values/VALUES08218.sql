...
-- primary_obligation_id: VALUES-EXT|08218|returned_rows|reset_state
...
WITH values_08218_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08218_cte)) ORDER BY column1;
-- primary-target-end
