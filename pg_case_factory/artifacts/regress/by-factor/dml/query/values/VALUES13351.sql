...
-- primary_obligation_id: VALUES-EXT|13351|effect_query|reset_state
...
WITH values_13351_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13351_cte)) ORDER BY column1;
-- primary-target-end
