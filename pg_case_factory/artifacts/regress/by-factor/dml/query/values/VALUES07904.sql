...
-- primary_obligation_id: VALUES-EXT|07904|returned_rows|rollback
...
WITH values_07904_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07904_cte)) ORDER BY column1;
-- primary-target-end
