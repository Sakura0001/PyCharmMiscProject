...
-- primary_obligation_id: VALUES-EXT|13509|returned_rows|drop_objects
...
WITH values_13509_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13509_cte)) ORDER BY column1;
-- primary-target-end
