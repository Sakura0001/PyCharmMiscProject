...
-- primary_obligation_id: VALUES-EXT|00789|returned_rows|drop_objects
...
WITH values_00789_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00789_cte)) ORDER BY column1;
-- primary-target-end
