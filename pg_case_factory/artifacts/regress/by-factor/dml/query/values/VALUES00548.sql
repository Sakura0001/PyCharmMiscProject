...
-- primary_obligation_id: VALUES-EXT|00548|returned_rows|rollback
...
WITH values_00548_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00548_cte)) ORDER BY column1;
-- primary-target-end
