...
-- primary_obligation_id: VALUES-EXT|00965|effect_query|rollback
...
WITH values_00965_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00965_cte)) ORDER BY column1;
-- primary-target-end
