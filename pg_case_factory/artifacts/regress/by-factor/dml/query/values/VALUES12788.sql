...
-- primary_obligation_id: VALUES-EXT|12788|returned_rows|rollback
...
WITH values_12788_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12788_cte)) ORDER BY column1;
-- primary-target-end
