...
-- primary_obligation_id: VALUES-EXT|08003|error_assertion|rollback
...
WITH values_08003_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08003_cte)) ORDER BY column1;
-- primary-target-end
