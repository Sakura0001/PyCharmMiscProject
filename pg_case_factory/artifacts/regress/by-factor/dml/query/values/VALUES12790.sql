...
-- primary_obligation_id: VALUES-EXT|12790|returned_rows|reset_state
...
WITH values_12790_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12790_cte)) ORDER BY column1;
-- primary-target-end
