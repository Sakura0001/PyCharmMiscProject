...
-- primary_obligation_id: VALUES-EXT|07460|returned_rows|rollback
...
WITH values_07460_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07460_cte)) ORDER BY column1;
-- primary-target-end
