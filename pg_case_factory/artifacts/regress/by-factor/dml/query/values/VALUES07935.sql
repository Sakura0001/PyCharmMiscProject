...
-- primary_obligation_id: VALUES-EXT|07935|catalog_query|drop_objects
...
WITH values_07935_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07935_cte)) ORDER BY column1;
-- primary-target-end
