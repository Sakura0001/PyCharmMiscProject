...
-- primary_obligation_id: VALUES-EXT|13624|catalog_query|reset_state
...
WITH values_13624_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13624_cte)) ORDER BY column1;
-- primary-target-end
