...
-- primary_obligation_id: VALUES-EXT|08230|returned_rows|reset_state
...
WITH values_08230_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08230_cte)) ORDER BY column1;
-- primary-target-end
