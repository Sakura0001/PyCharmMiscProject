...
-- primary_obligation_id: VALUES-EXT|01267|effect_query|reset_state
...
WITH values_01267_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01267_cte)) ORDER BY column1;
-- primary-target-end
