...
-- primary_obligation_id: VALUES-EXT|08028|error_assertion|drop_objects
...
WITH values_08028_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08028_cte)) ORDER BY column1;
-- primary-target-end
