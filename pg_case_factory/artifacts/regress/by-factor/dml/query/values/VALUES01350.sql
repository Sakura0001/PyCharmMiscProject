...
-- primary_obligation_id: VALUES-EXT|01350|effect_query|drop_objects
...
WITH values_01350_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01350_cte)) ORDER BY column1;
-- primary-target-end
