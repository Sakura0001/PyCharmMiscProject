...
-- primary_obligation_id: VALUES-EXT|12819|catalog_query|drop_objects
...
WITH values_12819_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12819_cte)) ORDER BY column1;
-- primary-target-end
