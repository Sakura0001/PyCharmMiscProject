...
-- primary_obligation_id: VALUES-EXT|00693|returned_rows|drop_objects
...
WITH values_00693_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00693_cte)) ORDER BY column1;
-- primary-target-end
