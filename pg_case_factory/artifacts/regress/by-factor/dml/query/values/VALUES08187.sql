...
-- primary_obligation_id: VALUES-EXT|08187|catalog_query|drop_objects
...
WITH values_08187_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08187_cte)) ORDER BY column1;
-- primary-target-end
