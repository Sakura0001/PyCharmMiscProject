...
-- primary_obligation_id: VALUES-EXT|08071|effect_query|reset_state
...
WITH values_08071_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08071_cte)) ORDER BY column1;
-- primary-target-end
