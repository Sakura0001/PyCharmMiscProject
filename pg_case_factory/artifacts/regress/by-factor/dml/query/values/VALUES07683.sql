...
-- primary_obligation_id: VALUES-EXT|07683|catalog_query|drop_objects
...
WITH values_07683_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07683_cte)) ORDER BY column1;
-- primary-target-end
