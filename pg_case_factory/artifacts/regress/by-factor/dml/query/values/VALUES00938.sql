...
-- primary_obligation_id: VALUES-EXT|00938|catalog_query|rollback
...
WITH values_00938_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00938_cte)) ORDER BY column1;
-- primary-target-end
