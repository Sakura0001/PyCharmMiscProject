...
-- primary_obligation_id: VALUES-EXT|00522|effect_query|drop_objects
...
WITH values_00522_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00522_cte)) ORDER BY column1;
-- primary-target-end
