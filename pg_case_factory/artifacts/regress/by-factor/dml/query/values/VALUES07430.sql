...
-- primary_obligation_id: VALUES-EXT|07430|catalog_query|rollback
...
WITH values_07430_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07430_cte)) ORDER BY column1;
-- primary-target-end
