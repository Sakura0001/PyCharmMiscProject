...
-- primary_obligation_id: VALUES-EXT|07480|catalog_query|reset_state
...
WITH values_07480_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07480_cte)) ORDER BY column1;
-- primary-target-end
