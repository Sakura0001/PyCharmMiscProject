...
-- primary_obligation_id: VALUES-EXT|07895|error_assertion|rollback
...
WITH values_07895_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07895_cte)) ORDER BY column1;
-- primary-target-end
