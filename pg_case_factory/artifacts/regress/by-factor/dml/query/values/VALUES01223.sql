...
-- primary_obligation_id: VALUES-EXT|01223|error_assertion|rollback
...
WITH values_01223_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01223_cte)) ORDER BY column1;
-- primary-target-end
