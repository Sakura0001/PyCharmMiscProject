...
-- primary_obligation_id: VALUES-EXT|07421|effect_query|rollback
...
WITH values_07421_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07421_cte)) ORDER BY column1;
-- primary-target-end
