...
-- primary_obligation_id: VALUES-EXT|13479|catalog_query|drop_objects
...
WITH values_13479_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13479_cte)) ORDER BY column1;
-- primary-target-end
