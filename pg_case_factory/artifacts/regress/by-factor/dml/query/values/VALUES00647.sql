...
-- primary_obligation_id: VALUES-EXT|00647|error_assertion|rollback
...
WITH values_00647_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00647_cte)) ORDER BY column1;
-- primary-target-end
