...
-- primary_obligation_id: VALUES-EXT|08244|error_assertion|drop_objects
...
WITH values_08244_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08244_cte)) ORDER BY column1;
-- primary-target-end
