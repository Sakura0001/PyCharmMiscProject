...
-- primary_obligation_id: VALUES-EXT|13651|effect_query|reset_state
...
WITH values_13651_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13651_cte)) ORDER BY column1;
-- primary-target-end
