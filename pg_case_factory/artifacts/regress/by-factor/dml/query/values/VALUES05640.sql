...
-- primary_obligation_id: VALUES-EXT|05640|error_assertion|drop_objects
...
WITH values_05640_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05640_cte)) ORDER BY column1;
-- primary-target-end
