...
-- primary_obligation_id: VALUES-EXT|05580|error_assertion|drop_objects
...
WITH values_05580_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05580_cte)) ORDER BY column1;
-- primary-target-end
