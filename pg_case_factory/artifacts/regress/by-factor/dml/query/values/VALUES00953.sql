...
-- primary_obligation_id: VALUES-EXT|00953|effect_query|rollback
...
WITH values_00953_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00953_cte)) ORDER BY column1;
-- primary-target-end
