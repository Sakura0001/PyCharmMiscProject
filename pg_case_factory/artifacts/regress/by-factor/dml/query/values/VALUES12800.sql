...
-- primary_obligation_id: VALUES-EXT|12800|returned_rows|rollback
...
WITH values_12800_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12800_cte)) ORDER BY column1;
-- primary-target-end
