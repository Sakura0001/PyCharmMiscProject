...
-- primary_obligation_id: VALUES-EXT|05703|catalog_query|drop_objects
...
WITH values_05703_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05703_cte)) ORDER BY column1;
-- primary-target-end
