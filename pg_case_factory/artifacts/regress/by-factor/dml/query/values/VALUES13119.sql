...
-- primary_obligation_id: VALUES-EXT|13119|catalog_query|drop_objects
...
WITH values_13119_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13119_cte)) ORDER BY column1;
-- primary-target-end
