...
-- primary_obligation_id: VALUES-EXT|00922|returned_rows|reset_state
...
WITH values_00922_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00922_cte)) ORDER BY column1;
-- primary-target-end
