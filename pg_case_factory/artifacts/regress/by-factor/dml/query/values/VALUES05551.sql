...
-- primary_obligation_id: VALUES-EXT|05551|effect_query|reset_state
...
WITH values_05551_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05551_cte)) ORDER BY column1;
-- primary-target-end
