...
-- primary_obligation_id: VALUES-EXT|00660|error_assertion|drop_objects
...
WITH values_00660_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00660_cte)) ORDER BY column1;
-- primary-target-end
