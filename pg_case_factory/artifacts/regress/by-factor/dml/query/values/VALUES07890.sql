...
-- primary_obligation_id: VALUES-EXT|07890|effect_query|drop_objects
...
WITH values_07890_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07890_cte)) ORDER BY column1;
-- primary-target-end
