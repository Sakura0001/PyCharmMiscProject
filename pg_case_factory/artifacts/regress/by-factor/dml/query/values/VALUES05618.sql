...
-- primary_obligation_id: VALUES-EXT|05618|catalog_query|rollback
...
WITH values_05618_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05618_cte)) ORDER BY column1;
-- primary-target-end
