...
-- primary_obligation_id: VALUES-EXT|05695|effect_query|reset_state
...
WITH values_05695_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05695_cte)) ORDER BY column1;
-- primary-target-end
