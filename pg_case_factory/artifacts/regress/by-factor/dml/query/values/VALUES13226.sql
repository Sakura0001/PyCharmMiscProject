...
-- primary_obligation_id: VALUES-EXT|13226|catalog_query|rollback
...
WITH values_13226_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13226_cte)) ORDER BY column1;
-- primary-target-end
