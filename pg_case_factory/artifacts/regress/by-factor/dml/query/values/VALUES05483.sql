...
-- primary_obligation_id: VALUES-EXT|05483|error_assertion|rollback
...
WITH values_05483_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05483_cte)) ORDER BY column1;
-- primary-target-end
