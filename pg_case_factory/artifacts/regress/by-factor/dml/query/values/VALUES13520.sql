...
-- primary_obligation_id: VALUES-EXT|13520|returned_rows|rollback
...
WITH values_13520_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13520_cte)) ORDER BY column1;
-- primary-target-end
