...
-- primary_obligation_id: VALUES-EXT|13101|returned_rows|drop_objects
...
WITH values_13101_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13101_cte)) ORDER BY column1;
-- primary-target-end
