...
-- primary_obligation_id: VALUES-EXT|13618|returned_rows|reset_state
...
WITH values_13618_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13618_cte)) ORDER BY column1;
-- primary-target-end
