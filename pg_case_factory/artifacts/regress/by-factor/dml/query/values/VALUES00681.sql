...
-- primary_obligation_id: VALUES-EXT|00681|returned_rows|drop_objects
...
WITH values_00681_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00681_cte)) ORDER BY column1;
-- primary-target-end
