...
-- primary_obligation_id: VALUES-EXT|08074|returned_rows|reset_state
...
WITH values_08074_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08074_cte)) ORDER BY column1;
-- primary-target-end
