...
-- primary_obligation_id: VALUES-EXT|05616|error_assertion|drop_objects
...
WITH values_05616_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05616_cte)) ORDER BY column1;
-- primary-target-end
