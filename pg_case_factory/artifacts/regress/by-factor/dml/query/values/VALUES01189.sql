...
-- primary_obligation_id: VALUES-EXT|01189|error_assertion|reset_state
...
WITH values_01189_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01189_cte)) ORDER BY column1;
-- primary-target-end
