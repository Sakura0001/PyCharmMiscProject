...
-- primary_obligation_id: VALUES-EXT|12978|effect_query|drop_objects
...
WITH values_12978_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12978_cte)) ORDER BY column1;
-- primary-target-end
