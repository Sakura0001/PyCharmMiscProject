...
-- primary_obligation_id: VALUES-EXT|05790|effect_query|drop_objects
...
WITH values_05790_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05790_cte)) ORDER BY column1;
-- primary-target-end
