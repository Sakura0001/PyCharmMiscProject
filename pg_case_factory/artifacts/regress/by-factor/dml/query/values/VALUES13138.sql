...
-- primary_obligation_id: VALUES-EXT|13138|returned_rows|reset_state
...
WITH values_13138_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13138_cte)) ORDER BY column1;
-- primary-target-end
