...
-- primary_obligation_id: VALUES-EXT|13306|returned_rows|reset_state
...
WITH values_13306_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13306_cte)) ORDER BY column1;
-- primary-target-end
