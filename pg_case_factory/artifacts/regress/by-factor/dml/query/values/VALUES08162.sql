...
-- primary_obligation_id: VALUES-EXT|08162|catalog_query|rollback
...
WITH values_08162_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08162_cte)) ORDER BY column1;
-- primary-target-end
