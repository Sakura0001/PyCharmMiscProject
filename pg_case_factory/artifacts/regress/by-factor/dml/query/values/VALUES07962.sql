...
-- primary_obligation_id: VALUES-EXT|07962|effect_query|drop_objects
...
WITH values_07962_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07962_cte)) ORDER BY column1;
-- primary-target-end
