...
-- primary_obligation_id: VALUES-EXT|08072|returned_rows|rollback
...
WITH values_08072_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08072_cte)) ORDER BY column1;
-- primary-target-end
