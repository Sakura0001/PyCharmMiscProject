...
-- primary_obligation_id: VALUES-EXT|05514|effect_query|drop_objects
...
WITH values_05514_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05514_cte)) ORDER BY column1;
-- primary-target-end
