...
-- primary_obligation_id: VALUES-EXT|01268|returned_rows|rollback
...
WITH values_01268_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01268_cte)) ORDER BY column1;
-- primary-target-end
