...
-- primary_obligation_id: VALUES-EXT|00562|returned_rows|reset_state
...
WITH values_00562_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00562_cte)) ORDER BY column1;
-- primary-target-end
