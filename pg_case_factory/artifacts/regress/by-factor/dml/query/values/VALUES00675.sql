...
-- primary_obligation_id: VALUES-EXT|00675|catalog_query|drop_objects
...
WITH values_00675_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00675_cte)) ORDER BY column1;
-- primary-target-end
