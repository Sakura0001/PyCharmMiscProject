...
-- primary_obligation_id: VALUES-EXT|01058|catalog_query|rollback
...
WITH values_01058_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01058_cte)) ORDER BY column1;
-- primary-target-end
