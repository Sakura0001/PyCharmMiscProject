...
-- primary_obligation_id: VALUES-EXT|05647|effect_query|reset_state
...
WITH values_05647_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05647_cte)) ORDER BY column1;
-- primary-target-end
