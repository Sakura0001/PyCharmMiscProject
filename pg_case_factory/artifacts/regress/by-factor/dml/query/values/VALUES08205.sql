...
-- primary_obligation_id: VALUES-EXT|08205|returned_rows|drop_objects
...
WITH values_08205_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08205_cte)) ORDER BY column1;
-- primary-target-end
