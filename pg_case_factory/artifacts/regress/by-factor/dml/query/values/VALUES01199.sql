...
-- primary_obligation_id: VALUES-EXT|01199|error_assertion|rollback
...
WITH values_01199_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01199_cte)) ORDER BY column1;
-- primary-target-end
