...
-- primary_obligation_id: VALUES-EXT|12804|error_assertion|drop_objects
...
WITH values_12804_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12804_cte)) ORDER BY column1;
-- primary-target-end
