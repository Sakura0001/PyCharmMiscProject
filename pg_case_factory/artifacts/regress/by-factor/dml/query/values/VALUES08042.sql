...
-- primary_obligation_id: VALUES-EXT|08042|catalog_query|rollback
...
WITH values_08042_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08042_cte)) ORDER BY column1;
-- primary-target-end
