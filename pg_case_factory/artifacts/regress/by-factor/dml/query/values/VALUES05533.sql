...
-- primary_obligation_id: VALUES-EXT|05533|error_assertion|reset_state
...
WITH values_05533_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05533_cte)) ORDER BY column1;
-- primary-target-end
