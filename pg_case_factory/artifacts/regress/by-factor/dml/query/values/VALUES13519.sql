...
-- primary_obligation_id: VALUES-EXT|13519|effect_query|reset_state
...
WITH values_13519_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13519_cte)) ORDER BY column1;
-- primary-target-end
