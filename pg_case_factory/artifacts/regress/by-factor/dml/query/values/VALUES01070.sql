...
-- primary_obligation_id: VALUES-EXT|01070|catalog_query|rollback
...
WITH values_01070_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01070_cte)) ORDER BY column1;
-- primary-target-end
