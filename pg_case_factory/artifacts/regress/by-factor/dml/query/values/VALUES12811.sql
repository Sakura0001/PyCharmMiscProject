...
-- primary_obligation_id: VALUES-EXT|12811|effect_query|reset_state
...
WITH values_12811_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12811_cte)) ORDER BY column1;
-- primary-target-end
