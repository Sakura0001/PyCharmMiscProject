...
-- primary_obligation_id: VALUES-EXT|00487|effect_query|reset_state
...
WITH values_00487_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00487_cte)) ORDER BY column1;
-- primary-target-end
