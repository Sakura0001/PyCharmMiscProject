...
-- primary_obligation_id: VALUES-EXT|05567|error_assertion|rollback
...
WITH values_05567_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05567_cte)) ORDER BY column1;
-- primary-target-end
