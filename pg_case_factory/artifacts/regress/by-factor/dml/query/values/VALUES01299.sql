...
-- primary_obligation_id: VALUES-EXT|01299|catalog_query|drop_objects
...
WITH values_01299_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01299_cte)) ORDER BY column1;
-- primary-target-end
