...
-- primary_obligation_id: VALUES-EXT|08066|catalog_query|rollback
...
WITH values_08066_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08066_cte)) ORDER BY column1;
-- primary-target-end
