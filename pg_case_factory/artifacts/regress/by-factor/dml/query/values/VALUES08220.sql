...
-- primary_obligation_id: VALUES-EXT|08220|error_assertion|drop_objects
...
WITH values_08220_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08220_cte)) ORDER BY column1;
-- primary-target-end
