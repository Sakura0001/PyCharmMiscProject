...
-- primary_obligation_id: VALUES-EXT|00924|error_assertion|drop_objects
...
WITH values_00924_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00924_cte)) ORDER BY column1;
-- primary-target-end
