...
-- primary_obligation_id: VALUES-EXT|01300|catalog_query|reset_state
...
WITH values_01300_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01300_cte)) ORDER BY column1;
-- primary-target-end
