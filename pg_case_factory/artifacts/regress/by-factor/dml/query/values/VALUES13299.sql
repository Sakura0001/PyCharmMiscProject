...
-- primary_obligation_id: VALUES-EXT|13299|catalog_query|drop_objects
...
WITH values_13299_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13299_cte)) ORDER BY column1;
-- primary-target-end
