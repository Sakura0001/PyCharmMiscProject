...
-- primary_obligation_id: VALUES-EXT|08112|error_assertion|drop_objects
...
WITH values_08112_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08112_cte)) ORDER BY column1;
-- primary-target-end
