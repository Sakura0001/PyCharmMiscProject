...
-- primary_obligation_id: VALUES-EXT|00572|returned_rows|rollback
...
WITH values_00572_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00572_cte)) ORDER BY column1;
-- primary-target-end
