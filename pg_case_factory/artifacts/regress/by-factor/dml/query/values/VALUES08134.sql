...
-- primary_obligation_id: VALUES-EXT|08134|returned_rows|reset_state
...
WITH values_08134_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08134_cte)) ORDER BY column1;
-- primary-target-end
