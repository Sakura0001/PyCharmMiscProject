...
-- primary_obligation_id: VALUES-EXT|07622|catalog_query|rollback
...
WITH values_07622_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07622_cte)) ORDER BY column1;
-- primary-target-end
