...
-- primary_obligation_id: VALUES-EXT|13401|returned_rows|drop_objects
...
WITH values_13401_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13401_cte)) ORDER BY column1;
-- primary-target-end
