...
-- primary_obligation_id: VALUES-EXT|12827|error_assertion|rollback
...
WITH values_12827_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12827_cte)) ORDER BY column1;
-- primary-target-end
