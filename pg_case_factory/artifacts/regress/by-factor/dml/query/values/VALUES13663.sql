...
-- primary_obligation_id: VALUES-EXT|13663|effect_query|reset_state
...
WITH values_13663_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13663_cte)) ORDER BY column1;
-- primary-target-end
