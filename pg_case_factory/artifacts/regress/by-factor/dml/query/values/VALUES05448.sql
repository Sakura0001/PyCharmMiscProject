...
-- primary_obligation_id: VALUES-EXT|05448|error_assertion|drop_objects
...
WITH values_05448_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05448_cte)) ORDER BY column1;
-- primary-target-end
