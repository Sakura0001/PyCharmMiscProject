...
-- primary_obligation_id: VALUES-EXT|13222|returned_rows|reset_state
...
WITH values_13222_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13222_cte)) ORDER BY column1;
-- primary-target-end
