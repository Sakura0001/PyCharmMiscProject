...
-- primary_obligation_id: VALUES-EXT|13659|catalog_query|drop_objects
...
WITH values_13659_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13659_cte)) ORDER BY column1;
-- primary-target-end
