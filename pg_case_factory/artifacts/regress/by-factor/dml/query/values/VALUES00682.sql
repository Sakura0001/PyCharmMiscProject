...
-- primary_obligation_id: VALUES-EXT|00682|returned_rows|reset_state
...
WITH values_00682_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00682_cte)) ORDER BY column1;
-- primary-target-end
