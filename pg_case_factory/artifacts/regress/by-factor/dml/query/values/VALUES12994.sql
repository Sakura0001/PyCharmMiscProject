...
-- primary_obligation_id: VALUES-EXT|12994|returned_rows|reset_state
...
WITH values_12994_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12994_cte)) ORDER BY column1;
-- primary-target-end
