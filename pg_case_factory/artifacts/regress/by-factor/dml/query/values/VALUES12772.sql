...
-- primary_obligation_id: VALUES-EXT|12772|catalog_query|reset_state
...
WITH values_12772_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12772_cte)) ORDER BY column1;
-- primary-target-end
