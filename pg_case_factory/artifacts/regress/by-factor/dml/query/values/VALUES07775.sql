...
-- primary_obligation_id: VALUES-EXT|07775|error_assertion|rollback
...
WITH values_07775_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07775_cte)) ORDER BY column1;
-- primary-target-end
