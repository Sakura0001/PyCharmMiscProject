...
-- primary_obligation_id: VALUES-EXT|13366|returned_rows|reset_state
...
WITH values_13366_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13366_cte)) ORDER BY column1;
-- primary-target-end
