...
-- primary_obligation_id: VALUES-EXT|08129|effect_query|rollback
...
WITH values_08129_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08129_cte)) ORDER BY column1;
-- primary-target-end
