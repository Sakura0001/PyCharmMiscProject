...
-- primary_obligation_id: VALUES-EXT|05431|effect_query|reset_state
...
WITH values_05431_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05431_cte)) ORDER BY column1;
-- primary-target-end
