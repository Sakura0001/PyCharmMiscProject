...
-- primary_obligation_id: VALUES-EXT|13223|error_assertion|rollback
...
WITH values_13223_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13223_cte)) ORDER BY column1;
-- primary-target-end
