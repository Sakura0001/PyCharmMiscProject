...
-- primary_obligation_id: VALUES-EXT|05454|effect_query|drop_objects
...
WITH values_05454_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05454_cte)) ORDER BY column1;
-- primary-target-end
