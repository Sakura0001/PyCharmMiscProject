...
-- primary_obligation_id: VALUES-EXT|01246|returned_rows|reset_state
...
WITH values_01246_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01246_cte)) ORDER BY column1;
-- primary-target-end
