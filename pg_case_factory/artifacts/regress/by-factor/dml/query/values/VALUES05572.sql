...
-- primary_obligation_id: VALUES-EXT|05572|catalog_query|reset_state
...
WITH values_05572_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05572_cte)) ORDER BY column1;
-- primary-target-end
