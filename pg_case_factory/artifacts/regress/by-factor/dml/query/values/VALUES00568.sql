...
-- primary_obligation_id: VALUES-EXT|00568|catalog_query|reset_state
...
WITH values_00568_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00568_cte)) ORDER BY column1;
-- primary-target-end
