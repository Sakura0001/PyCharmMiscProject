...
-- primary_obligation_id: VALUES-EXT|08149|error_assertion|reset_state
...
WITH values_08149_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08149_cte)) ORDER BY column1;
-- primary-target-end
