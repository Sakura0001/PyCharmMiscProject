...
-- primary_obligation_id: VALUES-EXT|05680|catalog_query|reset_state
...
WITH values_05680_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05680_cte)) ORDER BY column1;
-- primary-target-end
