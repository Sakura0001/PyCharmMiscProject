...
-- primary_obligation_id: VALUES-EXT|13210|returned_rows|reset_state
...
WITH values_13210_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13210_cte)) ORDER BY column1;
-- primary-target-end
