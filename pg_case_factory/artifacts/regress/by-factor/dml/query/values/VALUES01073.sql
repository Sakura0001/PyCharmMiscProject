...
-- primary_obligation_id: VALUES-EXT|01073|effect_query|rollback
...
WITH values_01073_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01073_cte)) ORDER BY column1;
-- primary-target-end
