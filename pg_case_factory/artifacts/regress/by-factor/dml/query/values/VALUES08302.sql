...
-- primary_obligation_id: VALUES-EXT|08302|returned_rows|reset_state
...
WITH values_08302_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08302_cte)) ORDER BY column1;
-- primary-target-end
