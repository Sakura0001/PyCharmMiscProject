...
-- primary_obligation_id: VALUES-EXT|00987|catalog_query|drop_objects
...
WITH values_00987_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00987_cte)) ORDER BY column1;
-- primary-target-end
