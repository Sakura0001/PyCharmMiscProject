...
-- primary_obligation_id: VALUES-EXT|01250|catalog_query|rollback
...
WITH values_01250_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01250_cte)) ORDER BY column1;
-- primary-target-end
