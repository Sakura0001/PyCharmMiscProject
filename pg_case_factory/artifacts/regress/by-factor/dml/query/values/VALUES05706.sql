...
-- primary_obligation_id: VALUES-EXT|05706|effect_query|drop_objects
...
WITH values_05706_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05706_cte)) ORDER BY column1;
-- primary-target-end
