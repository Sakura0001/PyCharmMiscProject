...
-- primary_obligation_id: VALUES-EXT|01018|returned_rows|reset_state
...
WITH values_01018_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01018_cte)) ORDER BY column1;
-- primary-target-end
