...
-- primary_obligation_id: VALUES-EXT|08096|returned_rows|rollback
...
WITH values_08096_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08096_cte)) ORDER BY column1;
-- primary-target-end
