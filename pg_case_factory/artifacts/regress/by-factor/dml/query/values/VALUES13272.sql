...
-- primary_obligation_id: VALUES-EXT|13272|error_assertion|drop_objects
...
WITH values_13272_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13272_cte)) ORDER BY column1;
-- primary-target-end
