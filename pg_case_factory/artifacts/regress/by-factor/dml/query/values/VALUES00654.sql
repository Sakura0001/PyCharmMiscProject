...
-- primary_obligation_id: VALUES-EXT|00654|effect_query|drop_objects
...
WITH values_00654_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00654_cte)) ORDER BY column1;
-- primary-target-end
