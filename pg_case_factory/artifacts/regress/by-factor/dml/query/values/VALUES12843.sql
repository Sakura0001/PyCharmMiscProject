...
-- primary_obligation_id: VALUES-EXT|12843|catalog_query|drop_objects
...
WITH values_12843_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12843_cte)) ORDER BY column1;
-- primary-target-end
