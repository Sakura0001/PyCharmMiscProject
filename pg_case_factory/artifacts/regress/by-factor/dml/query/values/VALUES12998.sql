...
-- primary_obligation_id: VALUES-EXT|12998|catalog_query|rollback
...
WITH values_12998_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_12998_cte)) ORDER BY column1;
-- primary-target-end
