...
-- primary_obligation_id: VALUES-EXT|00676|catalog_query|reset_state
...
WITH values_00676_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00676_cte)) ORDER BY column1;
-- primary-target-end
