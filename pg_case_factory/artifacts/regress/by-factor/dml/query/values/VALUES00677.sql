...
-- primary_obligation_id: VALUES-EXT|00677|effect_query|rollback
...
WITH values_00677_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00677_cte)) ORDER BY column1;
-- primary-target-end
