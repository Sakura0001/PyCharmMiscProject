...
-- primary_obligation_id: VALUES-EXT|07442|catalog_query|rollback
...
WITH values_07442_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07442_cte)) ORDER BY column1;
-- primary-target-end
