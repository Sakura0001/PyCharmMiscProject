...
-- primary_obligation_id: VALUES-EXT|08140|catalog_query|reset_state
...
WITH values_08140_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08140_cte)) ORDER BY column1;
-- primary-target-end
