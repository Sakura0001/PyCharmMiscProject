...
-- primary_obligation_id: VALUES-EXT|07842|effect_query|drop_objects
...
WITH values_07842_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07842_cte)) ORDER BY column1;
-- primary-target-end
