...
-- primary_obligation_id: VALUES-EXT|05526|effect_query|drop_objects
...
WITH values_05526_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05526_cte)) ORDER BY column1;
-- primary-target-end
