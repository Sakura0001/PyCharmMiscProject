...
-- primary_obligation_id: VALUES-EXT|05568|error_assertion|drop_objects
...
WITH values_05568_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05568_cte)) ORDER BY column1;
-- primary-target-end
