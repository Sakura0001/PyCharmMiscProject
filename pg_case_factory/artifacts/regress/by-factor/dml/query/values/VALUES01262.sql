...
-- primary_obligation_id: VALUES-EXT|01262|catalog_query|rollback
...
WITH values_01262_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_01262_cte)) ORDER BY column1;
-- primary-target-end
