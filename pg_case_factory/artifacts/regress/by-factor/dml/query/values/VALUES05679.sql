...
-- primary_obligation_id: VALUES-EXT|05679|catalog_query|drop_objects
...
WITH values_05679_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05679_cte)) ORDER BY column1;
-- primary-target-end
