...
-- primary_obligation_id: VALUES-EXT|08009|effect_query|rollback
...
WITH values_08009_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08009_cte)) ORDER BY column1;
-- primary-target-end
