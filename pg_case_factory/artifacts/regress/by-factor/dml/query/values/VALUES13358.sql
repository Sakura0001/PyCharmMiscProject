...
-- primary_obligation_id: VALUES-EXT|13358|catalog_query|rollback
...
WITH values_13358_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13358_cte)) ORDER BY column1;
-- primary-target-end
