...
-- primary_obligation_id: VALUES-EXT|08058|effect_query|drop_objects
...
WITH values_08058_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08058_cte)) ORDER BY column1;
-- primary-target-end
