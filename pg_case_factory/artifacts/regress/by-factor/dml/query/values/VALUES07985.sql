...
-- primary_obligation_id: VALUES-EXT|07985|effect_query|rollback
...
WITH values_07985_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07985_cte)) ORDER BY column1;
-- primary-target-end
