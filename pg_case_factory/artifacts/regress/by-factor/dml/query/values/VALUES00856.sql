...
-- primary_obligation_id: VALUES-EXT|00856|catalog_query|reset_state
...
WITH values_00856_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_00856_cte)) ORDER BY column1;
-- primary-target-end
