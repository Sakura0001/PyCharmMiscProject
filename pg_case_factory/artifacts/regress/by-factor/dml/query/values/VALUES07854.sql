...
-- primary_obligation_id: VALUES-EXT|07854|effect_query|drop_objects
...
WITH values_07854_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07854_cte)) ORDER BY column1;
-- primary-target-end
