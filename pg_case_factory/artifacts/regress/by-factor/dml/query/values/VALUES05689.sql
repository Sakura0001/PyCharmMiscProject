...
-- primary_obligation_id: VALUES-EXT|05689|error_assertion|reset_state
...
WITH values_05689_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05689_cte)) ORDER BY column1;
-- primary-target-end
