...
-- primary_obligation_id: VALUES-EXT|07563|catalog_query|drop_objects
...
WITH values_07563_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_07563_cte)) ORDER BY column1;
-- primary-target-end
