...
-- primary_obligation_id: VALUES-EXT|08038|returned_rows|reset_state
...
WITH values_08038_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08038_cte)) ORDER BY column1;
-- primary-target-end
