...
-- primary_obligation_id: VALUES-EXT|13449|returned_rows|drop_objects
...
WITH values_13449_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13449_cte)) ORDER BY column1;
-- primary-target-end
