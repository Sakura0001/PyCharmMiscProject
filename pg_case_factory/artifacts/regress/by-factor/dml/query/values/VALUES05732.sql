...
-- primary_obligation_id: VALUES-EXT|05732|returned_rows|rollback
...
WITH values_05732_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05732_cte)) ORDER BY column1;
-- primary-target-end
