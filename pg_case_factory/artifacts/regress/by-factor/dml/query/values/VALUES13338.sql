...
-- primary_obligation_id: VALUES-EXT|13338|effect_query|drop_objects
...
WITH values_13338_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13338_cte)) ORDER BY column1;
-- primary-target-end
