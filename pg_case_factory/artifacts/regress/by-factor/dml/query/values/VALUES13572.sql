...
-- primary_obligation_id: VALUES-EXT|13572|error_assertion|drop_objects
...
WITH values_13572_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13572_cte)) ORDER BY column1;
-- primary-target-end
