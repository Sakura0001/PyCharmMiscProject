...
-- primary_obligation_id: VALUES-EXT|13315|effect_query|reset_state
...
WITH values_13315_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_13315_cte)) ORDER BY column1;
-- primary-target-end
