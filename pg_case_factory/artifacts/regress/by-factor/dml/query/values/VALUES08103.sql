...
-- primary_obligation_id: VALUES-EXT|08103|catalog_query|drop_objects
...
WITH values_08103_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_08103_cte)) ORDER BY column1;
-- primary-target-end
