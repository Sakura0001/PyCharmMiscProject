...
-- primary_obligation_id: VALUES-EXT|05720|returned_rows|rollback
...
WITH values_05720_cte AS (SELECT 1 AS val)
VALUES ((SELECT val FROM values_05720_cte)) ORDER BY column1;
-- primary-target-end
