...
-- primary_obligation_id: SELECT-EXT|13899|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_13899_tbl, select_13899_src, select_13899_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_13899_tbl AS s WHERE select_13899_no_such_col = 1;
-- primary-target-end
