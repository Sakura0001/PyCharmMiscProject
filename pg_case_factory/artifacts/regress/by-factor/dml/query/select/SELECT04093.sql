...
-- primary_obligation_id: SELECT-EXT|04093|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_04093_tbl, select_04093_src, select_04093_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_04093_tbl AS s WHERE select_04093_no_such_col = 1;
-- primary-target-end
