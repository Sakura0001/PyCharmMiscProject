...
-- primary_obligation_id: SELECT-EXT|13969|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_13969_tbl, select_13969_src, select_13969_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_13969_tbl WHERE select_13969_no_such_col = 1;
-- primary-target-end
