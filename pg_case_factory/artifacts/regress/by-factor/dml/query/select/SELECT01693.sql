...
-- primary_obligation_id: SELECT-EXT|01693|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_01693_tbl, select_01693_src, select_01693_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_01693_tbl AS s WHERE select_01693_no_such_col = 1;
-- primary-target-end
