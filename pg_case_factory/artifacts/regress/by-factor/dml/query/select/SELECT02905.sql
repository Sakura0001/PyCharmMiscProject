...
-- primary_obligation_id: SELECT-EXT|02905|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_02905_tbl, select_02905_src, select_02905_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_02905_tbl" WHERE select_02905_no_such_col = 1;
-- primary-target-end
