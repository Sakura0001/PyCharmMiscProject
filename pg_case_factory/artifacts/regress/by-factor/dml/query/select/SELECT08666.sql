...
-- primary_obligation_id: SELECT-EXT|08666|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_08666_tbl, select_08666_src, select_08666_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_08666_tbl" WHERE id = 999;
-- primary-target-end
