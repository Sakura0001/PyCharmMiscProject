...
-- primary_obligation_id: SELECT-EXT|02871|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_02871_tbl, select_02871_src, select_02871_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_02871_tbl WHERE select_02871_no_such_col = 1;
-- primary-target-end
