...
-- primary_obligation_id: SELECT-EXT|04225|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_04225_tbl, select_04225_src, select_04225_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_04225_tbl WHERE select_04225_no_such_col = 1;
-- primary-target-end
