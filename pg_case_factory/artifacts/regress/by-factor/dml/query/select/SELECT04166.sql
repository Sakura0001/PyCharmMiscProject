...
-- primary_obligation_id: SELECT-EXT|04166|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_04166_tbl, select_04166_src, select_04166_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_04166_tbl WHERE select_04166_no_such_col = 1;
-- primary-target-end
