...
-- primary_obligation_id: SELECT-EXT|12505|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_12505_tbl, select_12505_src, select_12505_ref CASCADE;
RESET ROLE;
...
WITH select_12505_cte AS (SELECT 1 AS val)
SELECT 1 FROM "select_12505_tbl" WHERE select_12505_no_such_col = 1;
-- primary-target-end
