...
-- primary_obligation_id: SELECT-EXT|04215|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_04215_tbl, select_04215_src, select_04215_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_04215_tbl WHERE select_04215_no_such_col = 1;
-- primary-target-end
