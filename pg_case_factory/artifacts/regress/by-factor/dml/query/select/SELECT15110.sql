...
-- primary_obligation_id: SELECT-EXT|15110|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_15110_tbl, select_15110_src, select_15110_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_15110_tbl WHERE select_15110_no_such_col = 1;
-- primary-target-end
