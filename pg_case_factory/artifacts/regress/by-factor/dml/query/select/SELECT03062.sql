...
-- primary_obligation_id: SELECT-EXT|03062|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_03062_tbl, select_03062_src, select_03062_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_03062_tbl WHERE select_03062_no_such_col = 1;
-- primary-target-end
