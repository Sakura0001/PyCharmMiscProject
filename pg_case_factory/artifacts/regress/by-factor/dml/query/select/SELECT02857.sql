...
-- primary_obligation_id: SELECT-EXT|02857|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_02857_tbl, select_02857_src, select_02857_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_02857_tbl AS s WHERE select_02857_no_such_col = 1;
-- primary-target-end
