...
-- primary_obligation_id: SELECT-EXT|01753|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_01753_tbl, select_01753_src, select_01753_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_01753_tbl" WHERE select_01753_no_such_col = 1;
-- primary-target-end
