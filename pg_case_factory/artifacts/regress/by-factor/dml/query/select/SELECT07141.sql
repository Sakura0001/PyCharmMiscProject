...
-- primary_obligation_id: SELECT-EXT|07141|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_07141_tbl, select_07141_src, select_07141_ref CASCADE;
RESET ROLE;
...
WITH select_07141_cte AS (SELECT 1 AS val)
SELECT 1 FROM public.select_07141_tbl WHERE id = 999;
-- primary-target-end
