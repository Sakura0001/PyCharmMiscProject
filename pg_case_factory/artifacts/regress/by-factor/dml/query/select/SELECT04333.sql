...
-- primary_obligation_id: SELECT-EXT|04333|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_04333_tbl, select_04333_src, select_04333_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_04333_tbl" WHERE select_04333_no_such_col = 1;
-- primary-target-end
