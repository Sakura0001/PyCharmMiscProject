...
-- primary_obligation_id: SELECT-EXT|00387|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_00387_tbl, select_00387_src, select_00387_ref CASCADE;
RESET ROLE;
...
WITH select_00387_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_00387_tbl WHERE select_00387_no_such_col = 1;
-- primary-target-end
