...
-- primary_obligation_id: SELECT-EXT|00135|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_00135_tbl, select_00135_src, select_00135_ref CASCADE;
RESET ROLE;
...
WITH select_00135_cte AS (SELECT 1 AS val)
SELECT 1 FROM public.select_00135_tbl WHERE select_00135_no_such_col = 1;
-- primary-target-end
