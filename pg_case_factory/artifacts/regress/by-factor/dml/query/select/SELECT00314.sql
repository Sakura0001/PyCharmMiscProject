...
-- primary_obligation_id: SELECT-EXT|00314|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_00314_tbl, select_00314_src, select_00314_ref CASCADE;
RESET ROLE;
...
WITH select_00314_cte AS (SELECT 1 AS val)
SELECT 1 FROM "select_00314_tbl" WHERE select_00314_no_such_col = 1;
-- primary-target-end
