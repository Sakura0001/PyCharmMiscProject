...
-- primary_obligation_id: SELECT-EXT|09829|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_09829_tbl, select_09829_src, select_09829_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_09829_tbl WHERE id = 999;
-- primary-target-end
