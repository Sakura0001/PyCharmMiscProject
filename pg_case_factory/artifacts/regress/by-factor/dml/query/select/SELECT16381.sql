...
-- primary_obligation_id: SELECT-EXT|16381|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_16381_tbl, select_16381_src, select_16381_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_16381_tbl AS s WHERE select_16381_no_such_col = 1;
-- primary-target-end
