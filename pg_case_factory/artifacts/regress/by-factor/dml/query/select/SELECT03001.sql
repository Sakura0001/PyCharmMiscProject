...
-- primary_obligation_id: SELECT-EXT|03001|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_03001_tbl, select_03001_src, select_03001_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_03001_tbl" WHERE select_03001_no_such_col = 1;
-- primary-target-end
