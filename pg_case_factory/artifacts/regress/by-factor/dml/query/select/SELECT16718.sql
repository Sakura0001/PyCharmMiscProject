...
-- primary_obligation_id: SELECT-EXT|16718|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_16718_tbl, select_16718_src, select_16718_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_16718_tbl" WHERE select_16718_no_such_col = 1;
-- primary-target-end
