...
-- primary_obligation_id: SELECT-EXT|03098|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_03098_tbl, select_03098_src, select_03098_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_03098_tbl" WHERE select_03098_no_such_col = 1;
-- primary-target-end
