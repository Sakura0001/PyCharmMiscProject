...
-- primary_obligation_id: SELECT-EXT|14031|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_14031_tbl, select_14031_src, select_14031_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_14031_tbl" WHERE select_14031_no_such_col = 1;
-- primary-target-end
