...
-- primary_obligation_id: SELECT-EXT|09902|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_09902_tbl, select_09902_src, select_09902_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_09902_tbl" WHERE id = 999;
-- primary-target-end
