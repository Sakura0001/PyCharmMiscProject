...
-- primary_obligation_id: SELECT-EXT|13921|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_13921_tbl, select_13921_src, select_13921_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_13921_tbl WHERE select_13921_no_such_col = 1;
-- primary-target-end
