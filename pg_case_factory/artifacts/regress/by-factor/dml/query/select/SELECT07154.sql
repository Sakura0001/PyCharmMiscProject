...
-- primary_obligation_id: SELECT-EXT|07154|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_07154_tbl, select_07154_src, select_07154_ref CASCADE;
RESET ROLE;
...
WITH select_07154_cte AS (SELECT 1 AS val)
SELECT 1 FROM public.select_07154_tbl WHERE id = 999;
-- primary-target-end
