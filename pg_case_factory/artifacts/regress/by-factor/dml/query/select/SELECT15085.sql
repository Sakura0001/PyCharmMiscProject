...
-- primary_obligation_id: SELECT-EXT|15085|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_15085_tbl, select_15085_src, select_15085_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_15085_tbl" WHERE select_15085_no_such_col = 1;
-- primary-target-end
