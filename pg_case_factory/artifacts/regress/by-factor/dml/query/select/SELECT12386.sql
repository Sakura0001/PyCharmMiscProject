...
-- primary_obligation_id: SELECT-EXT|12386|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_12386_tbl, select_12386_src, select_12386_ref CASCADE;
RESET ROLE;
...
WITH select_12386_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_12386_tbl WHERE select_12386_no_such_col = 1;
-- primary-target-end
