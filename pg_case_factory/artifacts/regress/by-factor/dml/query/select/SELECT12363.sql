...
-- primary_obligation_id: SELECT-EXT|12363|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_12363_tbl, select_12363_src, select_12363_ref CASCADE;
RESET ROLE;
...
WITH select_12363_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_12363_tbl AS s WHERE select_12363_no_such_col = 1;
-- primary-target-end
