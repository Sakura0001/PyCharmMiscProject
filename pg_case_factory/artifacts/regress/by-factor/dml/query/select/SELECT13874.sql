...
-- primary_obligation_id: SELECT-EXT|13874|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_13874_tbl, select_13874_src, select_13874_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_13874_tbl WHERE select_13874_no_such_col = 1;
-- primary-target-end
