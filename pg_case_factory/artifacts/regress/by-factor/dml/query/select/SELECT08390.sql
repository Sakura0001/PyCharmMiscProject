...
-- primary_obligation_id: SELECT-EXT|08390|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_08390_tbl, select_08390_src, select_08390_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_08390_tbl WHERE id = 999;
-- primary-target-end
