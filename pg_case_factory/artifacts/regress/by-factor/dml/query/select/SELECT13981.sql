...
-- primary_obligation_id: SELECT-EXT|13981|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_13981_tbl, select_13981_src, select_13981_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_13981_tbl AS s WHERE select_13981_no_such_col = 1;
-- primary-target-end
