...
-- primary_obligation_id: SELECT-EXT|09733|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_09733_tbl, select_09733_src, select_09733_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_09733_tbl WHERE id = 999;
-- primary-target-end
