...
-- primary_obligation_id: SELECT-EXT|16658|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_16658_tbl, select_16658_src, select_16658_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_16658_tbl WHERE select_16658_no_such_col = 1;
-- primary-target-end
