...
-- primary_obligation_id: SELECT-EXT|12686|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_12686_tbl, select_12686_src, select_12686_ref CASCADE;
RESET ROLE;
...
WITH select_12686_cte AS (SELECT 1 AS val)
SELECT 1 FROM "select_12686_tbl" WHERE select_12686_no_such_col = 1;
-- primary-target-end
