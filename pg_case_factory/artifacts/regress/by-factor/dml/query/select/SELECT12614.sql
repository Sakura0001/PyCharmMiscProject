...
-- primary_obligation_id: SELECT-EXT|12614|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_12614_tbl, select_12614_src, select_12614_ref CASCADE;
RESET ROLE;
...
WITH select_12614_cte AS (SELECT 1 AS val)
SELECT 1 FROM public.select_12614_tbl WHERE select_12614_no_such_col = 1;
-- primary-target-end
