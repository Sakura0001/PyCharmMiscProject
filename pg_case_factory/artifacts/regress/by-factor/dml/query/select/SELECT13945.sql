...
-- primary_obligation_id: SELECT-EXT|13945|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_13945_tbl, select_13945_src, select_13945_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_13945_tbl" WHERE select_13945_no_such_col = 1;
-- primary-target-end
