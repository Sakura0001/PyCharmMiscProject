...
-- primary_obligation_id: SELECT-EXT|12543|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_12543_tbl, select_12543_src, select_12543_ref CASCADE;
RESET ROLE;
...
WITH select_12543_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_12543_tbl AS s WHERE select_12543_no_such_col = 1;
-- primary-target-end
