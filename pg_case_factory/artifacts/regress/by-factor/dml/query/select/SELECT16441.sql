...
-- primary_obligation_id: SELECT-EXT|16441|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_16441_tbl, select_16441_src, select_16441_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_16441_tbl" WHERE select_16441_no_such_col = 1;
-- primary-target-end
