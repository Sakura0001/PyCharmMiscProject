...
-- primary_obligation_id: SELECT-EXT|08450|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_08450_tbl, select_08450_src, select_08450_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_08450_tbl WHERE id = 999;
-- primary-target-end
