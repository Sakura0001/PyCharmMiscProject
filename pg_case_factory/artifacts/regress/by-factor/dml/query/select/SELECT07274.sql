...
-- primary_obligation_id: SELECT-EXT|07274|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_07274_tbl, select_07274_src, select_07274_ref CASCADE;
RESET ROLE;
...
WITH select_07274_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_07274_tbl AS s WHERE id = 999;
-- primary-target-end
