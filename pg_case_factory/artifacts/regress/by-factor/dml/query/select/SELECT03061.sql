...
-- primary_obligation_id: SELECT-EXT|03061|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_03061_tbl, select_03061_src, select_03061_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_03061_tbl WHERE select_03061_no_such_col = 1;
-- primary-target-end
