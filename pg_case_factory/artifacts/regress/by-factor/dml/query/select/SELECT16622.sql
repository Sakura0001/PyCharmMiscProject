...
-- primary_obligation_id: SELECT-EXT|16622|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_16622_tbl, select_16622_src, select_16622_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_16622_tbl" WHERE select_16622_no_such_col = 1;
-- primary-target-end
