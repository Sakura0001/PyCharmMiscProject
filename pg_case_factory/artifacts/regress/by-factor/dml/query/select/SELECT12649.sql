...
-- primary_obligation_id: SELECT-EXT|12649|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_12649_tbl, select_12649_src, select_12649_ref CASCADE;
RESET ROLE;
...
WITH select_12649_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_12649_tbl AS s WHERE select_12649_no_such_col = 1;
-- primary-target-end
