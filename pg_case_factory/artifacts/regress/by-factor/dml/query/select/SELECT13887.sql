...
-- primary_obligation_id: SELECT-EXT|13887|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_13887_tbl, select_13887_src, select_13887_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_13887_tbl AS s WHERE select_13887_no_such_col = 1;
-- primary-target-end
