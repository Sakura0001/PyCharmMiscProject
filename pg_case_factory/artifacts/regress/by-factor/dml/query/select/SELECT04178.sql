...
-- primary_obligation_id: SELECT-EXT|04178|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_04178_tbl, select_04178_src, select_04178_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_04178_tbl WHERE select_04178_no_such_col = 1;
-- primary-target-end
