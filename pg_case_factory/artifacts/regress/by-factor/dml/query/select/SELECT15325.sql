...
-- primary_obligation_id: SELECT-EXT|15325|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_15325_tbl, select_15325_src, select_15325_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_15325_tbl AS s WHERE select_15325_no_such_col = 1;
-- primary-target-end
