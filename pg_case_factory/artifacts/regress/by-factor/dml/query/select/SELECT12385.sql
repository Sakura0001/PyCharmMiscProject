...
-- primary_obligation_id: SELECT-EXT|12385|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_12385_tbl, select_12385_src, select_12385_ref CASCADE;
RESET ROLE;
...
WITH select_12385_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_12385_tbl WHERE select_12385_no_such_col = 1;
-- primary-target-end
