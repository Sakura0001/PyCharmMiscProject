...
-- primary_obligation_id: SELECT-EXT|00061|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_00061_tbl, select_00061_src, select_00061_ref CASCADE;
RESET ROLE;
...
WITH select_00061_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_00061_tbl AS s WHERE select_00061_no_such_col = 1;
-- primary-target-end
