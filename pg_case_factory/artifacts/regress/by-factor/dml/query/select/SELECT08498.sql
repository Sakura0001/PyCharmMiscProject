...
-- primary_obligation_id: SELECT-EXT|08498|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_08498_tbl, select_08498_src, select_08498_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_08498_tbl WHERE id = 999;
-- primary-target-end
