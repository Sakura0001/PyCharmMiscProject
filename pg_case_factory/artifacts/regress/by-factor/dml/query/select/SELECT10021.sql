...
-- primary_obligation_id: SELECT-EXT|10021|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_10021_tbl, select_10021_src, select_10021_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_10021_tbl WHERE id = 999;
-- primary-target-end
