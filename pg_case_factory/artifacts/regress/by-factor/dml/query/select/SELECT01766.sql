...
-- primary_obligation_id: SELECT-EXT|01766|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_01766_tbl, select_01766_src, select_01766_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_01766_tbl WHERE select_01766_no_such_col = 1;
-- primary-target-end
