...
-- primary_obligation_id: SELECT-EXT|04095|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_04095_tbl, select_04095_src, select_04095_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_04095_tbl AS s WHERE select_04095_no_such_col = 1;
-- primary-target-end
