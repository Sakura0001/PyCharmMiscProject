...
-- primary_obligation_id: SELECT-EXT|02893|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_02893_tbl, select_02893_src, select_02893_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_02893_tbl" WHERE select_02893_no_such_col = 1;
-- primary-target-end
