...
-- primary_obligation_id: SELECT-EXT|04261|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_04261_tbl, select_04261_src, select_04261_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_04261_tbl WHERE select_04261_no_such_col = 1;
-- primary-target-end
