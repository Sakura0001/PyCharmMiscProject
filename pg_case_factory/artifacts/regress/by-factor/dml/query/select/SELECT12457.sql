...
-- primary_obligation_id: SELECT-EXT|12457|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_12457_tbl, select_12457_src, select_12457_ref CASCADE;
RESET ROLE;
...
WITH select_12457_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_12457_tbl AS s WHERE select_12457_no_such_col = 1;
-- primary-target-end
