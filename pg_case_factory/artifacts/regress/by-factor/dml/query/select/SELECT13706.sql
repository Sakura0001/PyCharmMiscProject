...
-- primary_obligation_id: SELECT-EXT|13706|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_13706_tbl, select_13706_src, select_13706_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_13706_tbl AS s WHERE select_13706_no_such_col = 1;
-- primary-target-end
