...
-- primary_obligation_id: SELECT-EXT|04262|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_04262_tbl, select_04262_src, select_04262_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_04262_tbl WHERE select_04262_no_such_col = 1;
-- primary-target-end
