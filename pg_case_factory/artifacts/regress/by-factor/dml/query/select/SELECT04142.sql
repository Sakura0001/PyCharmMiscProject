...
-- primary_obligation_id: SELECT-EXT|04142|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_04142_tbl, select_04142_src, select_04142_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_04142_tbl" WHERE select_04142_no_such_col = 1;
-- primary-target-end
