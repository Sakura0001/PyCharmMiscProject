...
-- primary_obligation_id: SELECT-EXT|13957|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_13957_tbl, select_13957_src, select_13957_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_13957_tbl WHERE select_13957_no_such_col = 1;
-- primary-target-end
