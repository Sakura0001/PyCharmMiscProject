...
-- primary_obligation_id: SELECT-EXT|06999|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_06999_tbl, select_06999_src, select_06999_ref CASCADE;
RESET ROLE;
...
WITH select_06999_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_06999_tbl WHERE id = 999;
-- primary-target-end
