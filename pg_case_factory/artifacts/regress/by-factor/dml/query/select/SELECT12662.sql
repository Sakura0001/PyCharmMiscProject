...
-- primary_obligation_id: SELECT-EXT|12662|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_12662_tbl, select_12662_src, select_12662_ref CASCADE;
RESET ROLE;
...
WITH select_12662_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_12662_tbl WHERE select_12662_no_such_col = 1;
-- primary-target-end
