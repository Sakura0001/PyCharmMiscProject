...
-- primary_obligation_id: SELECT-EXT|13958|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_13958_tbl, select_13958_src, select_13958_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_13958_tbl WHERE select_13958_no_such_col = 1;
-- primary-target-end
