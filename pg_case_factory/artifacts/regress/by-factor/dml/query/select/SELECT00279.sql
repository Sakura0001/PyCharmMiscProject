...
-- primary_obligation_id: SELECT-EXT|00279|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_00279_tbl, select_00279_src, select_00279_ref CASCADE;
RESET ROLE;
...
WITH select_00279_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_00279_tbl WHERE select_00279_no_such_col = 1;
-- primary-target-end
