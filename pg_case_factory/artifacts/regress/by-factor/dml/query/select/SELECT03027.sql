...
-- primary_obligation_id: SELECT-EXT|03027|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_03027_tbl, select_03027_src, select_03027_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_03027_tbl WHERE select_03027_no_such_col = 1;
-- primary-target-end
