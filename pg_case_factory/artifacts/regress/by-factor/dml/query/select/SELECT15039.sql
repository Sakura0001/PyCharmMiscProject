...
-- primary_obligation_id: SELECT-EXT|15039|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_15039_tbl, select_15039_src, select_15039_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_15039_tbl AS s WHERE select_15039_no_such_col = 1;
-- primary-target-end
