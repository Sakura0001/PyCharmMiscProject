...
-- primary_obligation_id: SELECT-EXT|14029|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_14029_tbl, select_14029_src, select_14029_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_14029_tbl" WHERE select_14029_no_such_col = 1;
-- primary-target-end
