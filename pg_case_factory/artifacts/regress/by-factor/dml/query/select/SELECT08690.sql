...
-- primary_obligation_id: SELECT-EXT|08690|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_08690_tbl, select_08690_src, select_08690_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_08690_tbl WHERE id = 999;
-- primary-target-end
