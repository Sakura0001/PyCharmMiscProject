...
-- primary_obligation_id: SELECT-EXT|04443|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_04443_tbl, select_04443_src, select_04443_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_04443_tbl" WHERE select_04443_no_such_col = 1;
-- primary-target-end
