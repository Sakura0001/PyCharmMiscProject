...
-- primary_obligation_id: SELECT-EXT|15254|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_15254_tbl, select_15254_src, select_15254_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_15254_tbl WHERE select_15254_no_such_col = 1;
-- primary-target-end
