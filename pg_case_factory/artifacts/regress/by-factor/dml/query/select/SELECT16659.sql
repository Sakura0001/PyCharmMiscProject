...
-- primary_obligation_id: SELECT-EXT|16659|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_16659_tbl, select_16659_src, select_16659_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_16659_tbl WHERE select_16659_no_such_col = 1;
-- primary-target-end
