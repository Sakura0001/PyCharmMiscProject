...
-- primary_obligation_id: SELECT-EXT|00290|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_00290_tbl, select_00290_src, select_00290_ref CASCADE;
RESET ROLE;
...
WITH select_00290_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_00290_tbl WHERE select_00290_no_such_col = 1;
-- primary-target-end
