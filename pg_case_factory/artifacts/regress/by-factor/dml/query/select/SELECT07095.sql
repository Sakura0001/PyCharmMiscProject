...
-- primary_obligation_id: SELECT-EXT|07095|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_07095_tbl, select_07095_src, select_07095_ref CASCADE;
RESET ROLE;
...
WITH select_07095_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_07095_tbl WHERE id = 999;
-- primary-target-end
