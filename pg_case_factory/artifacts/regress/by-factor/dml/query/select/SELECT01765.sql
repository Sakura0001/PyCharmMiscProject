...
-- primary_obligation_id: SELECT-EXT|01765|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_01765_tbl, select_01765_src, select_01765_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_01765_tbl WHERE select_01765_no_such_col = 1;
-- primary-target-end
