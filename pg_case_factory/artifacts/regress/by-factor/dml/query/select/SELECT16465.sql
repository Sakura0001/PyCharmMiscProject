...
-- primary_obligation_id: SELECT-EXT|16465|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_16465_tbl, select_16465_src, select_16465_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_16465_tbl WHERE select_16465_no_such_col = 1;
-- primary-target-end
