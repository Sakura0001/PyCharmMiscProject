...
-- primary_obligation_id: SELECT-EXT|16634|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_16634_tbl, select_16634_src, select_16634_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_16634_tbl" WHERE select_16634_no_such_col = 1;
-- primary-target-end
