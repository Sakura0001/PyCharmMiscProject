...
-- primary_obligation_id: SELECT-EXT|06975|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_06975_tbl, select_06975_src, select_06975_ref CASCADE;
RESET ROLE;
...
WITH select_06975_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_06975_tbl AS s WHERE id = 999;
-- primary-target-end
