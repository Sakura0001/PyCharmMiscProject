...
-- primary_obligation_id: SELECT-EXT|07105|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_07105_tbl, select_07105_src, select_07105_ref CASCADE;
RESET ROLE;
...
WITH select_07105_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_07105_tbl WHERE id = 999;
-- primary-target-end
