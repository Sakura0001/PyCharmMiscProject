...
-- primary_obligation_id: SELECT-EXT|07287|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_07287_tbl, select_07287_src, select_07287_ref CASCADE;
RESET ROLE;
...
WITH select_07287_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_07287_tbl WHERE id = 999;
-- primary-target-end
