...
-- primary_obligation_id: SELECT-EXT|15267|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_15267_tbl, select_15267_src, select_15267_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_15267_tbl WHERE select_15267_no_such_col = 1;
-- primary-target-end
