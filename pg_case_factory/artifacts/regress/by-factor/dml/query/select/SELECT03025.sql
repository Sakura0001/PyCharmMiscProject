...
-- primary_obligation_id: SELECT-EXT|03025|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_03025_tbl, select_03025_src, select_03025_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_03025_tbl WHERE select_03025_no_such_col = 1;
-- primary-target-end
