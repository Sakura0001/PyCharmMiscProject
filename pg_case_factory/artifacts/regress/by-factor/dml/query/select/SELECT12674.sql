...
-- primary_obligation_id: SELECT-EXT|12674|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_12674_tbl, select_12674_src, select_12674_ref CASCADE;
RESET ROLE;
...
WITH select_12674_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_12674_tbl WHERE select_12674_no_such_col = 1;
-- primary-target-end
