...
-- primary_obligation_id: SELECT-EXT|07311|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_07311_tbl, select_07311_src, select_07311_ref CASCADE;
RESET ROLE;
...
WITH select_07311_cte AS (SELECT 1 AS val)
SELECT 1 FROM "select_07311_tbl" WHERE id = 999;
-- primary-target-end
