...
-- primary_obligation_id: SELECT-EXT|15183|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_15183_tbl, select_15183_src, select_15183_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_15183_tbl" WHERE select_15183_no_such_col = 1;
-- primary-target-end
