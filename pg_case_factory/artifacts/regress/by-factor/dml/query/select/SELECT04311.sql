...
-- primary_obligation_id: SELECT-EXT|04311|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_04311_tbl, select_04311_src, select_04311_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_04311_tbl WHERE select_04311_no_such_col = 1;
-- primary-target-end
