...
-- primary_obligation_id: SELECT-EXT|13946|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_13946_tbl, select_13946_src, select_13946_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_13946_tbl" WHERE select_13946_no_such_col = 1;
-- primary-target-end
