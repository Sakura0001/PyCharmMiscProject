...
-- primary_obligation_id: SELECT-EXT|12675|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_12675_tbl, select_12675_src, select_12675_ref CASCADE;
RESET ROLE;
...
WITH select_12675_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_12675_tbl WHERE select_12675_no_such_col = 1;
-- primary-target-end
