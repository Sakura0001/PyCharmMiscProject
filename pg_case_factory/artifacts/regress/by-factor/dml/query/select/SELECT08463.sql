...
-- primary_obligation_id: SELECT-EXT|08463|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_08463_tbl, select_08463_src, select_08463_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_08463_tbl" WHERE id = 999;
-- primary-target-end
