...
-- primary_obligation_id: SELECT-EXT|04117|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_04117_tbl, select_04117_src, select_04117_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_04117_tbl WHERE select_04117_no_such_col = 1;
-- primary-target-end
