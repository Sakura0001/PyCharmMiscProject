...
-- primary_obligation_id: SELECT-EXT|12541|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_12541_tbl, select_12541_src, select_12541_ref CASCADE;
RESET ROLE;
...
WITH select_12541_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_12541_tbl AS s WHERE select_12541_no_such_col = 1;
-- primary-target-end
