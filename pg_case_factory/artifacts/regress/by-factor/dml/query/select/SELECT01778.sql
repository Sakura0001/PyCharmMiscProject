...
-- primary_obligation_id: SELECT-EXT|01778|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_01778_tbl, select_01778_src, select_01778_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_01778_tbl WHERE select_01778_no_such_col = 1;
-- primary-target-end
