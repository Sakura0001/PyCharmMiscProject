...
-- primary_obligation_id: SELECT-EXT|02930|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_02930_tbl, select_02930_src, select_02930_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_02930_tbl WHERE select_02930_no_such_col = 1;
-- primary-target-end
