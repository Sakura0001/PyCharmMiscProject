...
-- primary_obligation_id: SELECT-EXT|02943|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_02943_tbl, select_02943_src, select_02943_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_02943_tbl AS s WHERE select_02943_no_such_col = 1;
-- primary-target-end
