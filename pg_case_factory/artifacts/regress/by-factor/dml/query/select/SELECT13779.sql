...
-- primary_obligation_id: SELECT-EXT|13779|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_13779_tbl, select_13779_src, select_13779_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_13779_tbl WHERE select_13779_no_such_col = 1;
-- primary-target-end
