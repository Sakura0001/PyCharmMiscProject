...
-- primary_obligation_id: SELECT-EXT|13971|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_13971_tbl, select_13971_src, select_13971_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_13971_tbl WHERE select_13971_no_such_col = 1;
-- primary-target-end
