...
-- primary_obligation_id: SELECT-EXT|03110|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_03110_tbl, select_03110_src, select_03110_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_03110_tbl WHERE select_03110_no_such_col = 1;
-- primary-target-end
