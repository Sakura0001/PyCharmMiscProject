...
-- primary_obligation_id: SELECT-EXT|04406|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_04406_tbl, select_04406_src, select_04406_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_04406_tbl WHERE select_04406_no_such_col = 1;
-- primary-target-end
