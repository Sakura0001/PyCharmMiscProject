...
-- primary_obligation_id: SELECT-EXT|12445|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_12445_tbl, select_12445_src, select_12445_ref CASCADE;
RESET ROLE;
...
WITH select_12445_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_12445_tbl AS s WHERE select_12445_no_such_col = 1;
-- primary-target-end
