...
-- primary_obligation_id: SELECT-EXT|01730|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_01730_tbl, select_01730_src, select_01730_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_01730_tbl WHERE select_01730_no_such_col = 1;
-- primary-target-end
