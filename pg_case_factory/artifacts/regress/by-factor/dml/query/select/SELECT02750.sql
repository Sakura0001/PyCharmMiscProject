...
-- primary_obligation_id: SELECT-EXT|02750|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_02750_tbl, select_02750_src, select_02750_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_02750_tbl AS s WHERE select_02750_no_such_col = 1;
-- primary-target-end
