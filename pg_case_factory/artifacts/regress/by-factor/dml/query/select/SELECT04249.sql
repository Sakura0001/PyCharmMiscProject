...
-- primary_obligation_id: SELECT-EXT|04249|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_04249_tbl, select_04249_src, select_04249_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_04249_tbl" WHERE select_04249_no_such_col = 1;
-- primary-target-end
