...
-- primary_obligation_id: SELECT-EXT|03037|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_03037_tbl, select_03037_src, select_03037_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_03037_tbl AS s WHERE select_03037_no_such_col = 1;
-- primary-target-end
