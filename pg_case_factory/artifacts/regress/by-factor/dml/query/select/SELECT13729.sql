...
-- primary_obligation_id: SELECT-EXT|13729|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_13729_tbl, select_13729_src, select_13729_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_13729_tbl WHERE select_13729_no_such_col = 1;
-- primary-target-end
