...
-- primary_obligation_id: SELECT-EXT|14067|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_14067_tbl, select_14067_src, select_14067_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_14067_tbl WHERE select_14067_no_such_col = 1;
-- primary-target-end
