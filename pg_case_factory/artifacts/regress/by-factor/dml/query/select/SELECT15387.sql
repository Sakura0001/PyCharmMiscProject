...
-- primary_obligation_id: SELECT-EXT|15387|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_15387_tbl, select_15387_src, select_15387_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_15387_tbl" WHERE select_15387_no_such_col = 1;
-- primary-target-end
