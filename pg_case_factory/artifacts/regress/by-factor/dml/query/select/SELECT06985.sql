...
-- primary_obligation_id: SELECT-EXT|06985|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_06985_tbl, select_06985_src, select_06985_ref CASCADE;
RESET ROLE;
...
WITH select_06985_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_06985_tbl AS s WHERE id = 999;
-- primary-target-end
