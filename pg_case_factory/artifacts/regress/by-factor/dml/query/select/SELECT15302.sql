...
-- primary_obligation_id: SELECT-EXT|15302|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_15302_tbl, select_15302_src, select_15302_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_15302_tbl WHERE select_15302_no_such_col = 1;
-- primary-target-end
