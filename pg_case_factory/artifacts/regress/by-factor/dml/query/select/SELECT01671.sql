...
-- primary_obligation_id: SELECT-EXT|01671|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_01671_tbl, select_01671_src, select_01671_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_01671_tbl WHERE select_01671_no_such_col = 1;
-- primary-target-end
