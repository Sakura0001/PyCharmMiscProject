...
-- primary_obligation_id: SELECT-EXT|07083|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_07083_tbl, select_07083_src, select_07083_ref CASCADE;
RESET ROLE;
...
WITH select_07083_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_07083_tbl AS s WHERE id = 999;
-- primary-target-end
