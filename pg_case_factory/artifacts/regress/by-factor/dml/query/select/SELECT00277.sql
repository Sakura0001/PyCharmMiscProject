...
-- primary_obligation_id: SELECT-EXT|00277|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_00277_tbl, select_00277_src, select_00277_ref CASCADE;
RESET ROLE;
...
WITH select_00277_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_00277_tbl WHERE select_00277_no_such_col = 1;
-- primary-target-end
