...
-- primary_obligation_id: SELECT-EXT|03051|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_03051_tbl, select_03051_src, select_03051_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_03051_tbl AS s WHERE select_03051_no_such_col = 1;
-- primary-target-end
