...
-- primary_obligation_id: SELECT-EXT|15098|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_15098_tbl, select_15098_src, select_15098_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_15098_tbl" WHERE select_15098_no_such_col = 1;
-- primary-target-end
