...
-- primary_obligation_id: SELECT-EXT|13886|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_13886_tbl, select_13886_src, select_13886_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_13886_tbl AS s WHERE select_13886_no_such_col = 1;
-- primary-target-end
