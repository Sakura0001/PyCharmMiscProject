...
-- primary_obligation_id: SELECT-EXT|15397|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_15397_tbl, select_15397_src, select_15397_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_15397_tbl WHERE select_15397_no_such_col = 1;
-- primary-target-end
