...
-- primary_obligation_id: SELECT-EXT|08425|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_08425_tbl, select_08425_src, select_08425_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_08425_tbl AS s WHERE id = 999;
-- primary-target-end
