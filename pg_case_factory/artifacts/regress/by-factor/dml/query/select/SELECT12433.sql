...
-- primary_obligation_id: SELECT-EXT|12433|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_12433_tbl, select_12433_src, select_12433_ref CASCADE;
RESET ROLE;
...
WITH select_12433_cte AS (SELECT 1 AS val)
SELECT 1 FROM public.select_12433_tbl WHERE select_12433_no_such_col = 1;
-- primary-target-end
