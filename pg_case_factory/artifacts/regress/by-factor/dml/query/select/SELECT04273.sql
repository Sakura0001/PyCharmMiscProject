...
-- primary_obligation_id: SELECT-EXT|04273|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_04273_tbl, select_04273_src, select_04273_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_04273_tbl WHERE select_04273_no_such_col = 1;
-- primary-target-end
