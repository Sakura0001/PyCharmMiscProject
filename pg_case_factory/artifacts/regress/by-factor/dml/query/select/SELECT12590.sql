...
-- primary_obligation_id: SELECT-EXT|12590|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_12590_tbl, select_12590_src, select_12590_ref CASCADE;
RESET ROLE;
...
WITH select_12590_cte AS (SELECT 1 AS val)
SELECT 1 FROM "select_12590_tbl" WHERE select_12590_no_such_col = 1;
-- primary-target-end
