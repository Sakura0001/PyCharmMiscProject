...
-- primary_obligation_id: SELECT-EXT|03099|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_03099_tbl, select_03099_src, select_03099_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_03099_tbl" WHERE select_03099_no_such_col = 1;
-- primary-target-end
