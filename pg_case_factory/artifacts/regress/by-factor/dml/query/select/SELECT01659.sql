...
-- primary_obligation_id: SELECT-EXT|01659|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_01659_tbl, select_01659_src, select_01659_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_01659_tbl" WHERE select_01659_no_such_col = 1;
-- primary-target-end
