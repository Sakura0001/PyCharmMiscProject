...
-- primary_obligation_id: SELECT-EXT|00363|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_00363_tbl, select_00363_src, select_00363_ref CASCADE;
RESET ROLE;
...
WITH select_00363_cte AS (SELECT 1 AS val)
SELECT 1 FROM select_00363_tbl AS s WHERE select_00363_no_such_col = 1;
-- primary-target-end
