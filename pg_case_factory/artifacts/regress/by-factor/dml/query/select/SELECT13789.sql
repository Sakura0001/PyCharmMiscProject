...
-- primary_obligation_id: SELECT-EXT|13789|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_13789_tbl, select_13789_src, select_13789_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_13789_tbl AS s WHERE select_13789_no_such_col = 1;
-- primary-target-end
