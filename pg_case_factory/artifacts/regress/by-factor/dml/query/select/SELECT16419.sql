...
-- primary_obligation_id: SELECT-EXT|16419|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_16419_tbl, select_16419_src, select_16419_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_16419_tbl WHERE select_16419_no_such_col = 1;
-- primary-target-end
