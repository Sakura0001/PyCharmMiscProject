...
-- primary_obligation_id: SELECT-EXT|04431|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_04431_tbl, select_04431_src, select_04431_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_04431_tbl" WHERE select_04431_no_such_col = 1;
-- primary-target-end
