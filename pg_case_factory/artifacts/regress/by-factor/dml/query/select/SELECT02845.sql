...
-- primary_obligation_id: SELECT-EXT|02845|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_02845_tbl, select_02845_src, select_02845_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_02845_tbl AS s WHERE select_02845_no_such_col = 1;
-- primary-target-end
