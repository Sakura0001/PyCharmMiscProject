...
-- primary_obligation_id: SELECT-EXT|03085|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_03085_tbl, select_03085_src, select_03085_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_03085_tbl" WHERE select_03085_no_such_col = 1;
-- primary-target-end
