...
-- primary_obligation_id: SELECT-EXT|16538|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_16538_tbl, select_16538_src, select_16538_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_16538_tbl" WHERE select_16538_no_such_col = 1;
-- primary-target-end
