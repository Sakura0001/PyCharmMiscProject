...
-- primary_obligation_id: SELECT-EXT|08462|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_08462_tbl, select_08462_src, select_08462_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_08462_tbl" WHERE id = 999;
-- primary-target-end
