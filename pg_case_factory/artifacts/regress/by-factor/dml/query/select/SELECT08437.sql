...
-- primary_obligation_id: SELECT-EXT|08437|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_08437_tbl, select_08437_src, select_08437_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_08437_tbl WHERE id = 999;
-- primary-target-end
