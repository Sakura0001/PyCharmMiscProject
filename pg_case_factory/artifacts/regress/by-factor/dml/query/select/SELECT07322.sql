...
-- primary_obligation_id: SELECT-EXT|07322|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_07322_tbl, select_07322_src, select_07322_ref CASCADE;
RESET ROLE;
...
WITH select_07322_cte AS (SELECT 1 AS val)
SELECT 1 FROM "select_07322_tbl" WHERE id = 999;
-- primary-target-end
