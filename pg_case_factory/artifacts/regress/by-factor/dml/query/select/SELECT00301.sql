...
-- primary_obligation_id: SELECT-EXT|00301|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_00301_tbl, select_00301_src, select_00301_ref CASCADE;
RESET ROLE;
...
WITH select_00301_cte AS (SELECT 1 AS val)
SELECT 1 FROM "select_00301_tbl" WHERE select_00301_no_such_col = 1;
-- primary-target-end
