...
-- primary_obligation_id: SELECT-EXT|10009|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_10009_tbl, select_10009_src, select_10009_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM "select_10009_tbl" WHERE id = 999;
-- primary-target-end
