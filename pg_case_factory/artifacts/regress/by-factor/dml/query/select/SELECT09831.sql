...
-- primary_obligation_id: SELECT-EXT|09831|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_09831_tbl, select_09831_src, select_09831_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_09831_tbl WHERE id = 999;
-- primary-target-end
