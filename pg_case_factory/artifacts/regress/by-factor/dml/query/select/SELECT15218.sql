...
-- primary_obligation_id: SELECT-EXT|15218|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_15218_tbl, select_15218_src, select_15218_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_15218_tbl WHERE select_15218_no_such_col = 1;
-- primary-target-end
