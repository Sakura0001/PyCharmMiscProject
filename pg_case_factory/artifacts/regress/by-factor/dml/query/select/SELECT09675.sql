...
-- primary_obligation_id: SELECT-EXT|09675|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_09675_tbl, select_09675_src, select_09675_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM select_09675_tbl AS s WHERE id = 999;
-- primary-target-end
