...
-- primary_obligation_id: SELECT-EXT|13873|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_13873_tbl, select_13873_src, select_13873_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_13873_tbl WHERE select_13873_no_such_col = 1;
-- primary-target-end
