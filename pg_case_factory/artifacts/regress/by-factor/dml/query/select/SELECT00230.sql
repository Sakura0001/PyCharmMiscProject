...
-- primary_obligation_id: SELECT-EXT|00230|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_00230_tbl, select_00230_src, select_00230_ref CASCADE;
RESET ROLE;
...
WITH select_00230_cte AS (SELECT 1 AS val)
SELECT 1 FROM public.select_00230_tbl WHERE select_00230_no_such_col = 1;
-- primary-target-end
