...
-- primary_obligation_id: SELECT-EXT|15122|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS select_15122_tbl, select_15122_src, select_15122_ref CASCADE;
RESET ROLE;
...
SELECT 1 FROM public.select_15122_tbl WHERE select_15122_no_such_col = 1;
-- primary-target-end
