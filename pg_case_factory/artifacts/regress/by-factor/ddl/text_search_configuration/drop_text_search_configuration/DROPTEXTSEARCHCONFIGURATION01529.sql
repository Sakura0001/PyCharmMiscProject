...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01529
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01529|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION "droptextsearchconfiguration_01529_select" CASCADE;
-- primary-target-end
