...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01854
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01854|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_01854_cfg RESTRICT;
-- primary-target-end
