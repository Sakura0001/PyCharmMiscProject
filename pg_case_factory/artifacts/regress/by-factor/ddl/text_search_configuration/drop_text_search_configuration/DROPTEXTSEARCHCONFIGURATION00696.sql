...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00696
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00696|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_00696_nosuchcfg CASCADE;
-- primary-target-end
