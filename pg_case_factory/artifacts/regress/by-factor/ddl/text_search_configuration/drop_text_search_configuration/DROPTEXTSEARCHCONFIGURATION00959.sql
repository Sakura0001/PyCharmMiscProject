...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00959
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00959|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_00959_nosuchcfg RESTRICT;
-- primary-target-end
