...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01001
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01001|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION "droptextsearchconfiguration_01001_qcfg" RESTRICT;
-- primary-target-end
