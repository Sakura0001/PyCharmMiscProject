...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01806
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01806|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION public.droptextsearchconfiguration_01806_cfg RESTRICT;
-- primary-target-end
