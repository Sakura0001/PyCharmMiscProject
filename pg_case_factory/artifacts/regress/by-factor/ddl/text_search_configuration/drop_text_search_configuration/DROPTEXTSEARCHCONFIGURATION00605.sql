...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00605
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00605|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION public.droptextsearchconfiguration_00605_cfg;
-- primary-target-end
