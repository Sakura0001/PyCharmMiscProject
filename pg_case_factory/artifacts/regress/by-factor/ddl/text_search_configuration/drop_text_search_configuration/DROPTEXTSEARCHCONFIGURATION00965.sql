...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00965
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00965|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00965_nosuchcfg RESTRICT;
-- primary-target-end
