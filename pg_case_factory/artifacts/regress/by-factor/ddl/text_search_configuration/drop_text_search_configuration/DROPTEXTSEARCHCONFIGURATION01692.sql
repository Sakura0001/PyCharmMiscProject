...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01692
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01692|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01692_nosuchcfg RESTRICT;
-- primary-target-end
