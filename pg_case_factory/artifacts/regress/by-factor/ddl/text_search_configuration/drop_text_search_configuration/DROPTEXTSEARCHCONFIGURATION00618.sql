...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00618
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00618|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION public.droptextsearchconfiguration_00618_cfg;
-- primary-target-end
