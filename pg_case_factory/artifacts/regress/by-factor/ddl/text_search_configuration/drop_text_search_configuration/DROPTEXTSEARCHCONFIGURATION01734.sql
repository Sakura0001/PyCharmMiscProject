...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01734
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01734|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_01734_qcfg" RESTRICT;
-- primary-target-end
