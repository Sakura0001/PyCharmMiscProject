...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01440
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01440|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_01440_nosuchcfg CASCADE;
-- primary-target-end
