...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01013
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01013|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_01013_qcfg" RESTRICT;
-- primary-target-end
