...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00665
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00665|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_00665_cfg;
-- primary-target-end
