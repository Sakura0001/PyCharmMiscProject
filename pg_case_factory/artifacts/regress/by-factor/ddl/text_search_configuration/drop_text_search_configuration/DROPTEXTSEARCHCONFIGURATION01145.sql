...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01145
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01145|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_01145_cfg RESTRICT;
-- primary-target-end
