...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01565
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01565|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS public.droptextsearchconfiguration_01565_cfg CASCADE;
-- primary-target-end
