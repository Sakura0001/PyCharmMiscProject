...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00954
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00954|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_00954_nosuchcfg RESTRICT;
-- primary-target-end
