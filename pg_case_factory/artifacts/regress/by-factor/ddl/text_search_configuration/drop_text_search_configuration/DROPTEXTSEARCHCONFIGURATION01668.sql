...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01668
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01668|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01668_nosuchcfg RESTRICT;
-- primary-target-end
