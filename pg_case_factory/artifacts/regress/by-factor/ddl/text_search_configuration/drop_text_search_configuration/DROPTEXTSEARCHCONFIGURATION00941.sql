...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00941
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00941|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00941_nosuchcfg RESTRICT;
-- primary-target-end
