...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01133
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01133|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_01133_cfg RESTRICT;
-- primary-target-end
