...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01038
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01038|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION "droptextsearchconfiguration_01038_select" RESTRICT;
-- primary-target-end
