...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01542
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01542|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_01542_select" CASCADE;
-- primary-target-end
