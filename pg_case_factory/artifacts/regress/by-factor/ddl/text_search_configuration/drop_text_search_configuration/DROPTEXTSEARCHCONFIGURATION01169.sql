...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01169
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01169|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_01169_nosuchcfg;
-- primary-target-end
