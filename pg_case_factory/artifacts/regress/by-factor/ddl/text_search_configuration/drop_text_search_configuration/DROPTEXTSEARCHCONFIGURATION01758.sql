...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01758
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01758|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION "droptextsearchconfiguration_01758_select" RESTRICT;
-- primary-target-end
