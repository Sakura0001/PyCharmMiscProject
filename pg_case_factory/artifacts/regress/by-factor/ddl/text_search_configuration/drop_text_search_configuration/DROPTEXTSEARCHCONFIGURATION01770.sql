...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01770
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01770|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION "droptextsearchconfiguration_01770_select" RESTRICT;
-- primary-target-end
