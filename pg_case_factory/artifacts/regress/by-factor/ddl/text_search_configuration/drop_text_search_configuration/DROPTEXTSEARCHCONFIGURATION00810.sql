...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00810
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00810|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION "droptextsearchconfiguration_00810_select" CASCADE;
-- primary-target-end
