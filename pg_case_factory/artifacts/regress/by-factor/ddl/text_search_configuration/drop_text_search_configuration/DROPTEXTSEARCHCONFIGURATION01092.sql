...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01092
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01092|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS public.droptextsearchconfiguration_01092_cfg RESTRICT;
-- primary-target-end
