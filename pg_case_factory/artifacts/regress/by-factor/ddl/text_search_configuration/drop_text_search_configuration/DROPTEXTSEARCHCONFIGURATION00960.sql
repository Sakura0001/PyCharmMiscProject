...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00960
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00960|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_00960_nosuchcfg RESTRICT;
-- primary-target-end
