...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00906
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00906|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_00906_cfg CASCADE;
-- primary-target-end
