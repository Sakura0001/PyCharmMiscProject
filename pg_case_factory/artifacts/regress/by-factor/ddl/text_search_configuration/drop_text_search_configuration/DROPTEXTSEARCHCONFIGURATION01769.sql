...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01769
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01769|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION "droptextsearchconfiguration_01769_select" RESTRICT;
-- primary-target-end
