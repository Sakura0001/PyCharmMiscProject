...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01187
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01187|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01187_nosuchcfg;
-- primary-target-end
