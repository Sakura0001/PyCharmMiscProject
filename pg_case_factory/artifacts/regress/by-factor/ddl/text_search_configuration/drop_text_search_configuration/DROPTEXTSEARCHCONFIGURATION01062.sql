...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01062
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01062|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_01062_select" RESTRICT;
-- primary-target-end
