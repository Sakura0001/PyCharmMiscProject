...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00564
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00564|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_00564_select";
-- primary-target-end
