...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00492
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00492|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00492_nosuchcfg;
-- primary-target-end
