...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00515
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00515|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_00515_qcfg";
-- primary-target-end
