...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00845
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00845|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS public.droptextsearchconfiguration_00845_cfg CASCADE;
-- primary-target-end
