...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01469
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01469|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_01469_qcfg" CASCADE;
-- primary-target-end
