...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00485
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00485|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00485_nosuchcfg;
-- primary-target-end
