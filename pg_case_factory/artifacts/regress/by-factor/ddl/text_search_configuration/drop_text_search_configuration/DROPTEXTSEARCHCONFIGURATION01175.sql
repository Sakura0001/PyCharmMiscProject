...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01175
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01175|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_01175_nosuchcfg;
-- primary-target-end
