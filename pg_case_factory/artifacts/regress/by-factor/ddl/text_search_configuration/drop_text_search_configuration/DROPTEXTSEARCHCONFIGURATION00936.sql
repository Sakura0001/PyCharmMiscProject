...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00936
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00936|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_00936_nosuchcfg RESTRICT;
-- primary-target-end
