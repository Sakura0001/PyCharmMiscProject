...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00749
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00749|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_00749_qcfg" CASCADE;
-- primary-target-end
