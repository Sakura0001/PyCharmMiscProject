...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01716
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01716|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_01716_qcfg" RESTRICT;
-- primary-target-end
