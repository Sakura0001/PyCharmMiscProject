...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01638
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01638|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01638_cfg CASCADE;
-- primary-target-end
