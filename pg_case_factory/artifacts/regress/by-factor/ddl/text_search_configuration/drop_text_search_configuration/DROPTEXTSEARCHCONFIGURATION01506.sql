...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01506
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01506|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION "droptextsearchconfiguration_01506_select" CASCADE;
-- primary-target-end
