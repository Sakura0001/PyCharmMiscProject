...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00629
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00629|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS public.droptextsearchconfiguration_00629_cfg;
-- primary-target-end
