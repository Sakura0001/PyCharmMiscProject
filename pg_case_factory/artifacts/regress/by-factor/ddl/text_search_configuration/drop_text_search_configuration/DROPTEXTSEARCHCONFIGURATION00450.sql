...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00450
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00450|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_00450_nosuchcfg;
-- primary-target-end
