...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00708
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00708|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00708_nosuchcfg CASCADE;
-- primary-target-end
