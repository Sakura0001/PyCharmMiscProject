...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00449
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00449|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_00449_nosuchcfg;
-- primary-target-end
