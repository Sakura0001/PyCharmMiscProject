...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00857
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00857|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION public.droptextsearchconfiguration_00857_cfg CASCADE;
-- primary-target-end
