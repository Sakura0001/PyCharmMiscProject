...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01817
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01817|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION public.droptextsearchconfiguration_01817_cfg RESTRICT;
-- primary-target-end
