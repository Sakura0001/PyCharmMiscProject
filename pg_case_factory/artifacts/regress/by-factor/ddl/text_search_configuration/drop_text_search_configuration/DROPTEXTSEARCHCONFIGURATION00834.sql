...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00834
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00834|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION public.droptextsearchconfiguration_00834_cfg CASCADE;
-- primary-target-end
