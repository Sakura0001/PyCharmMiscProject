...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01212
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01212|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01212_nosuchcfg;
-- primary-target-end
