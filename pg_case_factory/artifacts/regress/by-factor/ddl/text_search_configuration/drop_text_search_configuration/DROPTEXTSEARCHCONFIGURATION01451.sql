...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01451
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01451|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01451_nosuchcfg CASCADE;
-- primary-target-end
