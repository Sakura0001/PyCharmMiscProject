...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00930
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00930|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_00930_nosuchcfg RESTRICT;
-- primary-target-end
