...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01427
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01427|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01427_nosuchcfg CASCADE;
-- primary-target-end
