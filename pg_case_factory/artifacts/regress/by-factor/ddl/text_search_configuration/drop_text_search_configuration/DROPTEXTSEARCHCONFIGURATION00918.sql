...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00918
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00918|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00918_cfg CASCADE;
-- primary-target-end
