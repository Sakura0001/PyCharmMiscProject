...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01859
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01859|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01859_cfg RESTRICT;
-- primary-target-end
