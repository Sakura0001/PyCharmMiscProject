...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00533
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00533|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_00533_qcfg";
-- primary-target-end
