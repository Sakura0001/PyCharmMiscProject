...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01445
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01445|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01445_nosuchcfg CASCADE;
-- primary-target-end
