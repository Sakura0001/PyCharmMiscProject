...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00869
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00869|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS public.droptextsearchconfiguration_00869_cfg CASCADE;
-- primary-target-end
