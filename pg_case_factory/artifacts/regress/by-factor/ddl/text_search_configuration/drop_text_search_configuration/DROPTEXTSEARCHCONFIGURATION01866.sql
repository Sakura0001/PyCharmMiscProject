...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01866
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01866|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_01866_cfg RESTRICT;
-- primary-target-end
