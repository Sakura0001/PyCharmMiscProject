...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01098
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01098|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION public.droptextsearchconfiguration_01098_cfg RESTRICT;
-- primary-target-end
