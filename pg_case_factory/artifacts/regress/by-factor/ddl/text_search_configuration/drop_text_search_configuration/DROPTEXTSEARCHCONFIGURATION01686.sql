...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01686
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01686|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01686_nosuchcfg RESTRICT;
-- primary-target-end
