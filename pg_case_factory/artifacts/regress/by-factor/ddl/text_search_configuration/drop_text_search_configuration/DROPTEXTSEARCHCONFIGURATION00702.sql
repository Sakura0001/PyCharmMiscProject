...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00702
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00702|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00702_nosuchcfg CASCADE;
-- primary-target-end
