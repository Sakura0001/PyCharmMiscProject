...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01661
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01661|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01661_nosuchcfg RESTRICT;
-- primary-target-end
