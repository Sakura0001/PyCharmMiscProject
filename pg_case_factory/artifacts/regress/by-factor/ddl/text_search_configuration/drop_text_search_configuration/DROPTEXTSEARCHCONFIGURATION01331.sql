...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01331
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01331|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS public.droptextsearchconfiguration_01331_cfg;
-- primary-target-end
