...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00509
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00509|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION "droptextsearchconfiguration_00509_qcfg";
-- primary-target-end
