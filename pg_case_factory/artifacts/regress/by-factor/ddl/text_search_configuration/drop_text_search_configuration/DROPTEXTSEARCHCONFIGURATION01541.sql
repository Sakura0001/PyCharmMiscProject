...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01541
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01541|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_01541_select" CASCADE;
-- primary-target-end
