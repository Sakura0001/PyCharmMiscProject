...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01691
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01691|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01691_nosuchcfg RESTRICT;
-- primary-target-end
