...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01157
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01157|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01157_cfg RESTRICT;
-- primary-target-end
