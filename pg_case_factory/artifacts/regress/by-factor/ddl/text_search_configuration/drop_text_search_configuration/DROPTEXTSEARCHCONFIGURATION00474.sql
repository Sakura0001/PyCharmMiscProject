...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00474
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00474|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_00474_nosuchcfg;
-- primary-target-end
