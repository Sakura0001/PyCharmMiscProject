...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00677
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00677|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00677_cfg;
-- primary-target-end
