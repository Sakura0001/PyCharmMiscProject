...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00636
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00636|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH CONFIGURATION IF EXISTS public.droptextsearchconfiguration_00636_cfg;
\set ON_ERROR_STOP on
-- 2. 创建完整本地规则和因子专用夹具。
CREATE TEXT SEARCH CONFIGURATION public.droptextsearchconfiguration_00636_cfg (PARSER = default);
