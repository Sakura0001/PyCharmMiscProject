...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00971
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00971|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00971_nosuchcfg RESTRICT;
-- primary-target-end
