...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01416
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01416|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_01416_nosuchcfg CASCADE;
-- primary-target-end
