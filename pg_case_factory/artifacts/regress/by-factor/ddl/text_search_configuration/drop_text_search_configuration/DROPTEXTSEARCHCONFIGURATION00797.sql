...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00797
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00797|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_00797_select" CASCADE;
-- primary-target-end
