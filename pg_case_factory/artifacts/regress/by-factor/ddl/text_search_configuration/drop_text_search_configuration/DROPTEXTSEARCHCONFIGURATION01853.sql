...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01853
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01853|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_01853_cfg RESTRICT;
-- primary-target-end
