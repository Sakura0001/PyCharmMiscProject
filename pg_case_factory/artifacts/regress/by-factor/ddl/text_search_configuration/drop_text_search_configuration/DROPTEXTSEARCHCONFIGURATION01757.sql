...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01757
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01757|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION "droptextsearchconfiguration_01757_select" RESTRICT;
-- primary-target-end
