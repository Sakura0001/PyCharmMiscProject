...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01410
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01410|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_01410_nosuchcfg CASCADE;
-- primary-target-end
