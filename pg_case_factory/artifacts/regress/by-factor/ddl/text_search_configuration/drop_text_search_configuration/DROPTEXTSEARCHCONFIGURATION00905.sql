...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00905
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00905|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_00905_cfg CASCADE;
-- primary-target-end
