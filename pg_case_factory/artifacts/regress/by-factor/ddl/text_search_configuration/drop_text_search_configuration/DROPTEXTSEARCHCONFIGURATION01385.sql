...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01385
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01385|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_01385_cfg;
-- primary-target-end
