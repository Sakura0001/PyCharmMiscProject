...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00929
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00929|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_00929_nosuchcfg RESTRICT;
-- primary-target-end
