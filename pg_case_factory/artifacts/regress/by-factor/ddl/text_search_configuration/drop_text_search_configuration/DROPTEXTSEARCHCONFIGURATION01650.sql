...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01650
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01650|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_01650_nosuchcfg RESTRICT;
-- primary-target-end
