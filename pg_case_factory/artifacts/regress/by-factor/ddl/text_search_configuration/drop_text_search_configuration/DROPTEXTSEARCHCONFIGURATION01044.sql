...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01044
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01044|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_01044_select" RESTRICT;
-- primary-target-end
