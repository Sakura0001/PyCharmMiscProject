...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01553
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01553|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION public.droptextsearchconfiguration_01553_cfg CASCADE;
-- primary-target-end
