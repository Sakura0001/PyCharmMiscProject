...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00461
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00461|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00461_nosuchcfg;
-- primary-target-end
