...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00611
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00611|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS public.droptextsearchconfiguration_00611_cfg;
-- primary-target-end
