...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01878
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01878|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01878_cfg RESTRICT;
-- primary-target-end
