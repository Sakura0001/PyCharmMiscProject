...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01494
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01494|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_01494_qcfg" CASCADE;
-- primary-target-end
