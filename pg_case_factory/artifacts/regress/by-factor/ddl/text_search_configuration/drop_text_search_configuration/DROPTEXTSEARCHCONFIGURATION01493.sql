...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01493
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01493|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_01493_qcfg" CASCADE;
-- primary-target-end
