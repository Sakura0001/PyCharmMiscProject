...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00701
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00701|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00701_nosuchcfg CASCADE;
-- primary-target-end
