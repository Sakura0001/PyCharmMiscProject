...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00473
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00473|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_00473_nosuchcfg;
-- primary-target-end
