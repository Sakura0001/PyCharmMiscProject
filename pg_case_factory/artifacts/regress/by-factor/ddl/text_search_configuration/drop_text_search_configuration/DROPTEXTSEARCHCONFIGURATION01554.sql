...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01554
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01554|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION public.droptextsearchconfiguration_01554_cfg CASCADE;
-- primary-target-end
