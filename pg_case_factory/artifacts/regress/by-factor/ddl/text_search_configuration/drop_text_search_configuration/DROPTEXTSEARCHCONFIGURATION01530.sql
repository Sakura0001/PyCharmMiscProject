...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01530
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01530|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION "droptextsearchconfiguration_01530_select" CASCADE;
-- primary-target-end
