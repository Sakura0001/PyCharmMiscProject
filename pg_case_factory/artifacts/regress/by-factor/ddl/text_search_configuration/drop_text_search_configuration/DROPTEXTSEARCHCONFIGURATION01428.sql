...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01428
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01428|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01428_nosuchcfg CASCADE;
-- primary-target-end
