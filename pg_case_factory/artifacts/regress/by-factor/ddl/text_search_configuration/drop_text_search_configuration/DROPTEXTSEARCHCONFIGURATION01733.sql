...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01733
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01733|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_01733_qcfg" RESTRICT;
-- primary-target-end
