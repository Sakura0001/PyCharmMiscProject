...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01602
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01602|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_01602_cfg CASCADE;
-- primary-target-end
