...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01518
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01518|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_01518_select" CASCADE;
-- primary-target-end
