...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01086
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01086|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION public.droptextsearchconfiguration_01086_cfg RESTRICT;
-- primary-target-end
