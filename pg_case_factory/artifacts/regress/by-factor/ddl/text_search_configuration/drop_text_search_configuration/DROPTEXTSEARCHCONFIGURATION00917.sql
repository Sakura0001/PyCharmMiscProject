...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00917
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00917|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00917_cfg CASCADE;
-- primary-target-end
