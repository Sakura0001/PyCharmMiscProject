...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01470
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01470|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_01470_qcfg" CASCADE;
-- primary-target-end
