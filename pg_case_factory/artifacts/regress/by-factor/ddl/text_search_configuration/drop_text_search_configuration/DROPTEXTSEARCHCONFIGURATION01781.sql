...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01781
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01781|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_01781_select" RESTRICT;
-- primary-target-end
