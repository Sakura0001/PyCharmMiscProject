...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00468
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00468|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00468_nosuchcfg;
-- primary-target-end
