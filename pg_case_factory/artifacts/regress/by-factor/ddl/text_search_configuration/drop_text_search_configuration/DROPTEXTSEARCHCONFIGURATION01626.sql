...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01626
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01626|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_01626_cfg CASCADE;
-- primary-target-end
