...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00858
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00858|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION public.droptextsearchconfiguration_00858_cfg CASCADE;
-- primary-target-end
