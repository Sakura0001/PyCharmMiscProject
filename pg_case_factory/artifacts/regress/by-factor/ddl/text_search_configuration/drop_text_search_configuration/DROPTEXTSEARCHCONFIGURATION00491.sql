...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00491
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00491|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00491_nosuchcfg;
-- primary-target-end
