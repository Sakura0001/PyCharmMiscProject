...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00653
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00653|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_00653_cfg;
-- primary-target-end
