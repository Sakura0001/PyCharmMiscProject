...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00785
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00785|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION "droptextsearchconfiguration_00785_select" CASCADE;
-- primary-target-end
