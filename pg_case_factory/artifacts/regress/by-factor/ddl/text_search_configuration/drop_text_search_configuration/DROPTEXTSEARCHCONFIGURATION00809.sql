...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00809
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00809|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION "droptextsearchconfiguration_00809_select" CASCADE;
-- primary-target-end
