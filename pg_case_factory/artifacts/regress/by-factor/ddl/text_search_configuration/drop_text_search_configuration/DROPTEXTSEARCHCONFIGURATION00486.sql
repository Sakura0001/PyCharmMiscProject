...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00486
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00486|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00486_nosuchcfg;
-- primary-target-end
