...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01139
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01139|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01139_cfg RESTRICT;
-- primary-target-end
