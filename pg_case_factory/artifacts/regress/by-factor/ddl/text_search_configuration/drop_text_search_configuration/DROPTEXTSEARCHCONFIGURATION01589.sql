...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01589
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01589|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS public.droptextsearchconfiguration_01589_cfg CASCADE;
-- primary-target-end
