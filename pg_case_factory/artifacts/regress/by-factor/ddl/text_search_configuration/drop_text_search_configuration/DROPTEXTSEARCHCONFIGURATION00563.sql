...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00563
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00563|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_00563_select";
-- primary-target-end
