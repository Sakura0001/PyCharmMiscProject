...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01637
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01637|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01637_cfg CASCADE;
-- primary-target-end
