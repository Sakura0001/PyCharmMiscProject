...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00942
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00942|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00942_nosuchcfg RESTRICT;
-- primary-target-end
