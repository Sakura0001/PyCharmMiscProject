...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00894
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00894|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00894_cfg CASCADE;
-- primary-target-end
