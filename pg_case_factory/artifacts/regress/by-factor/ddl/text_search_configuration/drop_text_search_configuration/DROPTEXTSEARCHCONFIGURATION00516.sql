...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00516
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00516|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_00516_qcfg";
-- primary-target-end
