...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01146
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01146|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_01146_cfg RESTRICT;
-- primary-target-end
