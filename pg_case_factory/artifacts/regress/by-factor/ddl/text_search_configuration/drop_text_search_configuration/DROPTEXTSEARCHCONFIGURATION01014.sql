...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01014
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01014|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_01014_qcfg" RESTRICT;
-- primary-target-end
