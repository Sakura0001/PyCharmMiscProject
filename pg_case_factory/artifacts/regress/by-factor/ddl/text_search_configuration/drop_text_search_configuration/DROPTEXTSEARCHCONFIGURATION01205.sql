...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01205
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01205|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01205_nosuchcfg;
-- primary-target-end
