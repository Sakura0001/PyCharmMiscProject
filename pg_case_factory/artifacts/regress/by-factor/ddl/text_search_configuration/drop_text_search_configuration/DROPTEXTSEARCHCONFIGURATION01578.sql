...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01578
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01578|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION public.droptextsearchconfiguration_01578_cfg CASCADE;
-- primary-target-end
