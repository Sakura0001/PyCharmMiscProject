...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00972
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00972|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00972_nosuchcfg RESTRICT;
-- primary-target-end
