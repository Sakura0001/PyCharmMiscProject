...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00995
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00995|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_00995_qcfg" RESTRICT;
-- primary-target-end
