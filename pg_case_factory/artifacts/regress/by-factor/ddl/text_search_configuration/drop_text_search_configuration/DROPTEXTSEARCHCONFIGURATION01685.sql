...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01685
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01685|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01685_nosuchcfg RESTRICT;
-- primary-target-end
