...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00659
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00659|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00659_cfg;
-- primary-target-end
