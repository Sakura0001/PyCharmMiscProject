...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00719
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00719|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_00719_nosuchcfg CASCADE;
-- primary-target-end
