...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00822
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00822|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_00822_select" CASCADE;
-- primary-target-end
