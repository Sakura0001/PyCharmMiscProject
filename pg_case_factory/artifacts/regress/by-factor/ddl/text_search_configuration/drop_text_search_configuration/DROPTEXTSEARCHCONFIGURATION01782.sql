...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01782
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01782|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_01782_select" RESTRICT;
-- primary-target-end
