...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01614
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01614|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01614_cfg CASCADE;
-- primary-target-end
