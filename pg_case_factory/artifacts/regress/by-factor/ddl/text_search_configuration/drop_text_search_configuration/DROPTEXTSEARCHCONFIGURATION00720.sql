...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00720
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00720|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_00720_nosuchcfg CASCADE;
-- primary-target-end
