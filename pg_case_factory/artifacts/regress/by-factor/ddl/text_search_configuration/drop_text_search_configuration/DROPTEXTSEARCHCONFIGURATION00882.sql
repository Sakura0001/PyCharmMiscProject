...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00882
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00882|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_00882_cfg CASCADE;
-- primary-target-end
