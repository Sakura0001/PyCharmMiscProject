...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00731
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00731|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00731_nosuchcfg CASCADE;
-- primary-target-end
