...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00893
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00893|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00893_cfg CASCADE;
-- primary-target-end
