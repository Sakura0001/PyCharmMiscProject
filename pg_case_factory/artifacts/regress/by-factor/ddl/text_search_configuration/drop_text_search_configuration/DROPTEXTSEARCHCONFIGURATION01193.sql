...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01193
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01193|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_01193_nosuchcfg;
-- primary-target-end
