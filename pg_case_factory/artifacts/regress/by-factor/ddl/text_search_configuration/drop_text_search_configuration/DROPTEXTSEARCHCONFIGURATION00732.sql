...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00732
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00732|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00732_nosuchcfg CASCADE;
-- primary-target-end
