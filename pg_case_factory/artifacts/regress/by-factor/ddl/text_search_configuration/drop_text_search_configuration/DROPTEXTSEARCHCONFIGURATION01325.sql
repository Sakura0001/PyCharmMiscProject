...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01325
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01325|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION public.droptextsearchconfiguration_01325_cfg;
-- primary-target-end
