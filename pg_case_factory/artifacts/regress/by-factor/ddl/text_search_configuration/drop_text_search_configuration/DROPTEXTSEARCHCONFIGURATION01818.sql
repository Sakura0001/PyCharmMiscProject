...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01818
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01818|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION public.droptextsearchconfiguration_01818_cfg RESTRICT;
-- primary-target-end
