...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00714
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00714|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_00714_nosuchcfg CASCADE;
-- primary-target-end
