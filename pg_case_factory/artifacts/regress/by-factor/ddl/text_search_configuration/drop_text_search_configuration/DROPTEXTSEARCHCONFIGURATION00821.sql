...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00821
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00821|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_00821_select" CASCADE;
-- primary-target-end
