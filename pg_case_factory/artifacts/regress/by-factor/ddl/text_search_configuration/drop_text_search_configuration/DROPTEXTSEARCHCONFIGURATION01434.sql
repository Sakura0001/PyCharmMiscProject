...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01434
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01434|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_01434_nosuchcfg CASCADE;
-- primary-target-end
