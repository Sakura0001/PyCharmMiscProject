...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00833
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00833|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION public.droptextsearchconfiguration_00833_cfg CASCADE;
-- primary-target-end
