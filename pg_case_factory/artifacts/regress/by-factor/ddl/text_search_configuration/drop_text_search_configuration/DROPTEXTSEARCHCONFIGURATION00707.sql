...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00707
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00707|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00707_nosuchcfg CASCADE;
-- primary-target-end
