...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01452
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01452|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01452_nosuchcfg CASCADE;
-- primary-target-end
