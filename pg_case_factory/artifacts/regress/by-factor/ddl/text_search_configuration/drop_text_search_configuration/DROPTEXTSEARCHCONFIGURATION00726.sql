...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00726
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00726|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00726_nosuchcfg CASCADE;
-- primary-target-end
