...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01877
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01877|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_01877_cfg RESTRICT;
-- primary-target-end
