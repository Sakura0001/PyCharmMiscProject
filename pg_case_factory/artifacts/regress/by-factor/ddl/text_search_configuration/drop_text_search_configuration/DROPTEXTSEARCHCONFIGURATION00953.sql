...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00953
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00953|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_00953_nosuchcfg RESTRICT;
-- primary-target-end
