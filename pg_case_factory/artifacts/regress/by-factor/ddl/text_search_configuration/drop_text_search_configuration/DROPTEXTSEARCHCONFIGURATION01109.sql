...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01109
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01109|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS public.droptextsearchconfiguration_01109_cfg RESTRICT;
-- primary-target-end
