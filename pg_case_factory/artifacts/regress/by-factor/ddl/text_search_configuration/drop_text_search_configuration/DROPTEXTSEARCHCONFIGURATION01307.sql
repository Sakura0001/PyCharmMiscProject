...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01307
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01307|drop_text_search_configuration|error_assertion|cascade_cleanup
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_01307_select";
\set ON_ERROR_STOP on
-- 2. 创建完整本地规则和因子专用夹具。
CREATE TEXT SEARCH CONFIGURATION "droptextsearchconfiguration_01307_select" (PARSER = default);
