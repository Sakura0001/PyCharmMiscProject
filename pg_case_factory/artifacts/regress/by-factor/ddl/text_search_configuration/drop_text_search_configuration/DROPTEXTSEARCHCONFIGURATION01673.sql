...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01673
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01673|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_01673_nosuchcfg RESTRICT;
-- primary-target-end
