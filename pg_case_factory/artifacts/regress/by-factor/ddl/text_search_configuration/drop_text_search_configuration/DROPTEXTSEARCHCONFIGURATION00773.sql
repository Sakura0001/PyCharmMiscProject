...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00773
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00773|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_00773_qcfg" CASCADE;
-- primary-target-end
