...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01656
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01656|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_01656_nosuchcfg RESTRICT;
-- primary-target-end
