...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01134
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01134|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_01134_cfg RESTRICT;
-- primary-target-end
