...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01338
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01338|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION public.droptextsearchconfiguration_01338_cfg;
-- primary-target-end
