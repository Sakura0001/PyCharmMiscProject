...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00750
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00750|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_00750_qcfg" CASCADE;
-- primary-target-end
