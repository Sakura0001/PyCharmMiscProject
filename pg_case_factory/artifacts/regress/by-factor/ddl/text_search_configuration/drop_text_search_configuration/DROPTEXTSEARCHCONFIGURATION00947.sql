...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00947
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00947|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00947_nosuchcfg RESTRICT;
-- primary-target-end
