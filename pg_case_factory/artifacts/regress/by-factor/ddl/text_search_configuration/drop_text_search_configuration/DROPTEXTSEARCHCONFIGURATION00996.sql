...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00996
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00996|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_00996_qcfg" RESTRICT;
-- primary-target-end
