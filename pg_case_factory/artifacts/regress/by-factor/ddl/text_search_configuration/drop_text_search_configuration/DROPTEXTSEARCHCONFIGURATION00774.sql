...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00774
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00774|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_00774_qcfg" CASCADE;
-- primary-target-end
