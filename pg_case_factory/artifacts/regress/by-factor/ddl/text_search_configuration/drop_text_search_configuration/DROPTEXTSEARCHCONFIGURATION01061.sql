...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01061
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01061|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_01061_select" RESTRICT;
-- primary-target-end
