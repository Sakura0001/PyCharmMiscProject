...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00678
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00678|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00678_cfg;
-- primary-target-end
