...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01037
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01037|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION "droptextsearchconfiguration_01037_select" RESTRICT;
-- primary-target-end
