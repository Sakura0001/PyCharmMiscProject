...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00990
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00990|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION "droptextsearchconfiguration_00990_qcfg" RESTRICT;
-- primary-target-end
