...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00725
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00725|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00725_nosuchcfg CASCADE;
-- primary-target-end
