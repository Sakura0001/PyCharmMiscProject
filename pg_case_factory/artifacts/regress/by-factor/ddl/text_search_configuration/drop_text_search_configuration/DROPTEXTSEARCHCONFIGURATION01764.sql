...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01764
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01764|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS "droptextsearchconfiguration_01764_select" RESTRICT;
-- primary-target-end
