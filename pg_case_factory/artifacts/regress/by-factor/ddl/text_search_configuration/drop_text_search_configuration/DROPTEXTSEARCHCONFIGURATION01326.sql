...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01326
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01326|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION public.droptextsearchconfiguration_01326_cfg;
-- primary-target-end
