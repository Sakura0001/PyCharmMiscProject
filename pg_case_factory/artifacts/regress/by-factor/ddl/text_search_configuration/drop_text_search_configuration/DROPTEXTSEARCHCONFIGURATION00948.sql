...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00948
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00948|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00948_nosuchcfg RESTRICT;
-- primary-target-end
