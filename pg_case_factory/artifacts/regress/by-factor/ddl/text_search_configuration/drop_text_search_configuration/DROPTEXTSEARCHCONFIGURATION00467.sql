...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00467
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00467|drop_text_search_configuration|error_assertion|cascade_cleanup
...
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchconfiguration_00467_nosuchcfg;
-- primary-target-end
