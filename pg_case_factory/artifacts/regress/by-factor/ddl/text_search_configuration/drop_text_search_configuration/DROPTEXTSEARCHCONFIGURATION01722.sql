...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION01722
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|01722|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION "droptextsearchconfiguration_01722_qcfg" RESTRICT;
-- primary-target-end
