...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHCONFIGURATION00690
...
-- primary_obligation_id: DROPTEXTSEARCHCONFIGURATION-EXT|00690|drop_text_search_configuration|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH CONFIGURATION droptextsearchconfiguration_00690_nosuchcfg CASCADE;
-- primary-target-end
