...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02847
...
-- primary_obligation_id: ATSC-EXT|02847|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02847_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
