...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02834
...
-- primary_obligation_id: ATSC-EXT|02834|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02834_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
