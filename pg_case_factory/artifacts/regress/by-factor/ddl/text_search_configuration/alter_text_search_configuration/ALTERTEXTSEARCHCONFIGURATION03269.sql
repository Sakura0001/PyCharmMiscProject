...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03269
...
-- primary_obligation_id: ATSC-EXT|03269|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03269_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
