...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02729
...
-- primary_obligation_id: ATSC-EXT|02729|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02729_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
