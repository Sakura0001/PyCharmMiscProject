...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02935
...
-- primary_obligation_id: ATSC-EXT|02935|error_assertion|drop_mapping_revert
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02935_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
