...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03251
...
-- primary_obligation_id: ATSC-EXT|03251|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03251_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
