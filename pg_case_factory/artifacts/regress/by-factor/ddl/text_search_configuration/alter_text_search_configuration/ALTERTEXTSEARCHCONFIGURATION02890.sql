...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02890
...
-- primary_obligation_id: ATSC-EXT|02890|error_assertion|drop_mapping_revert
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02890_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
