...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02742
...
-- primary_obligation_id: ATSC-EXT|02742|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02742_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
