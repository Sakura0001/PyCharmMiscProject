...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03239
...
-- primary_obligation_id: ATSC-EXT|03239|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03239_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
