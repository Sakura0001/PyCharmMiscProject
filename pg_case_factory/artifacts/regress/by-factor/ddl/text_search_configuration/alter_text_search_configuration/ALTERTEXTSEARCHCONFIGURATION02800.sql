...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02800
...
-- primary_obligation_id: ATSC-EXT|02800|error_assertion|drop_mapping_revert
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02800_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
