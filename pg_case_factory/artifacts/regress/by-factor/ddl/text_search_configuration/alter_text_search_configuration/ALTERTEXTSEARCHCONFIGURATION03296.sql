...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03296
...
-- primary_obligation_id: ATSC-EXT|03296|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03296_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
