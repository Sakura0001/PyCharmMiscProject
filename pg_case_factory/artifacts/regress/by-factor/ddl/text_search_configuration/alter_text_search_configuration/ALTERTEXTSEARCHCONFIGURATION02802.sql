...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02802
...
-- primary_obligation_id: ATSC-EXT|02802|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02802_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
