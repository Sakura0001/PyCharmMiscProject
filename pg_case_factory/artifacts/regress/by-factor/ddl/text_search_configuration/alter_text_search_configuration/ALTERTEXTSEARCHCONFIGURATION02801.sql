...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02801
...
-- primary_obligation_id: ATSC-EXT|02801|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02801_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
