...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02756
...
-- primary_obligation_id: ATSC-EXT|02756|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02756_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
