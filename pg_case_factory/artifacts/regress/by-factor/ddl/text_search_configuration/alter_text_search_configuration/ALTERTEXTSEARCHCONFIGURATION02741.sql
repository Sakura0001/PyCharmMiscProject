...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02741
...
-- primary_obligation_id: ATSC-EXT|02741|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02741_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
