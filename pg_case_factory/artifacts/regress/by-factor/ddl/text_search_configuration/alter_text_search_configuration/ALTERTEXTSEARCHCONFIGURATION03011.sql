...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03011
...
-- primary_obligation_id: ATSC-EXT|03011|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03011_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
