...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03223
...
-- primary_obligation_id: ATSC-EXT|03223|error_assertion|drop_text_search_configuration
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03223_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
