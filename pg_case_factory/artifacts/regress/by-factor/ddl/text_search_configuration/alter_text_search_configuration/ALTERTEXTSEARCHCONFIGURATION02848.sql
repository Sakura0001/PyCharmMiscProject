...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02848
...
-- primary_obligation_id: ATSC-EXT|02848|error_assertion|drop_text_search_configuration
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02848_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
