...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02966
...
-- primary_obligation_id: ATSC-EXT|02966|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02966_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
