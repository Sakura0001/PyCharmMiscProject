...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02967
...
-- primary_obligation_id: ATSC-EXT|02967|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02967_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
