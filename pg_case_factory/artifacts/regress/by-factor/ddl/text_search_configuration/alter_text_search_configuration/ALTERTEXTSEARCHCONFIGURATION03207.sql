...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03207
...
-- primary_obligation_id: ATSC-EXT|03207|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03207_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
