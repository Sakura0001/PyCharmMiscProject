...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03014
...
-- primary_obligation_id: ATSC-EXT|03014|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03014_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
