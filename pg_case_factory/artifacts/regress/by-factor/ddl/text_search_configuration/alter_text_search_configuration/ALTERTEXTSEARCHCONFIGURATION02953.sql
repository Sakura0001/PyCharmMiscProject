...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02953
...
-- primary_obligation_id: ATSC-EXT|02953|error_assertion|drop_text_search_configuration
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02953_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
