...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02892
...
-- primary_obligation_id: ATSC-EXT|02892|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02892_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
