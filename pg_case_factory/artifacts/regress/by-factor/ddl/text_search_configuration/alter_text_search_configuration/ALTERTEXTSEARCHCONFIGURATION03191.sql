...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03191
...
-- primary_obligation_id: ATSC-EXT|03191|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03191_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
