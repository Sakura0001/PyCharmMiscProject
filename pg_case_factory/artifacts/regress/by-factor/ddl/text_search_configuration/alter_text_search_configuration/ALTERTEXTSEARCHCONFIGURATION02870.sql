...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02870
...
-- primary_obligation_id: ATSC-EXT|02870|mapping_query|drop_mapping_revert
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02870_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
...
SELECT count(*) = 0 AS config_state FROM pg_catalog.pg_ts_config WHERE cfgname = 'alter_text_search_configuration_02870_nosuchcfg' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
