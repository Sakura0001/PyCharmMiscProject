...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03224
...
-- primary_obligation_id: ATSC-EXT|03224|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03224_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
