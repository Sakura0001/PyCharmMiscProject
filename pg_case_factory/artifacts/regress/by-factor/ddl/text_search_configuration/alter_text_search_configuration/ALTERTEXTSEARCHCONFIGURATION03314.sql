...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03314
...
-- primary_obligation_id: ATSC-EXT|03314|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03314_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
