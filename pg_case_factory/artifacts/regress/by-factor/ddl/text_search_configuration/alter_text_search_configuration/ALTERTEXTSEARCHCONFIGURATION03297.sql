...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03297
...
-- primary_obligation_id: ATSC-EXT|03297|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03297_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
