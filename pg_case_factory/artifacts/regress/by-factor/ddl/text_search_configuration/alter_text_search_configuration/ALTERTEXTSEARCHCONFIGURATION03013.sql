...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03013
...
-- primary_obligation_id: ATSC-EXT|03013|error_assertion|drop_text_search_configuration
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03013_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
