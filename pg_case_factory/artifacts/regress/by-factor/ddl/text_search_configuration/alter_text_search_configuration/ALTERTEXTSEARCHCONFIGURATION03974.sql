...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03974
...
-- primary_obligation_id: ATSC-EXT|03974|error_assertion|role_cleanup
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH CONFIGURATION IF EXISTS "alter_text_search_configuration_03974_qnewcfg";
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03974_nosuchcfg RENAME TO "alter_text_search_configuration_03974_qnewcfg";
-- primary-target-end
