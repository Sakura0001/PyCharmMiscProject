...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02863
...
-- primary_obligation_id: ATSC-EXT|02863|error_assertion|drop_text_search_configuration
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02863_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
