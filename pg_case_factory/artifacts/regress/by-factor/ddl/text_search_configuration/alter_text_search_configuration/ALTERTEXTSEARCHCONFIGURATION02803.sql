...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02803
...
-- primary_obligation_id: ATSC-EXT|02803|error_assertion|drop_text_search_configuration
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02803_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
