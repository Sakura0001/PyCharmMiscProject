...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02861
...
-- primary_obligation_id: ATSC-EXT|02861|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02861_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
