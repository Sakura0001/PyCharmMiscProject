...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02969
...
-- primary_obligation_id: ATSC-EXT|02969|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02969_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
