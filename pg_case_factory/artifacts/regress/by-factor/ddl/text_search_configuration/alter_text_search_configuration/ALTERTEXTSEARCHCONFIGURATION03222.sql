...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03222
...
-- primary_obligation_id: ATSC-EXT|03222|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03222_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
