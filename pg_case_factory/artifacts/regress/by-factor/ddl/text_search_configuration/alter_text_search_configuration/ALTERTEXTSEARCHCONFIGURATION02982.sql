...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02982
...
-- primary_obligation_id: ATSC-EXT|02982|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02982_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
