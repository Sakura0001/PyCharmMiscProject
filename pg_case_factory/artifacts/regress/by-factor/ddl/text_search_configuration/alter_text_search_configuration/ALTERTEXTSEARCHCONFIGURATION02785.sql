...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02785
...
-- primary_obligation_id: ATSC-EXT|02785|error_assertion|drop_mapping_revert
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02785_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
