...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03267
...
-- primary_obligation_id: ATSC-EXT|03267|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03267_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
