...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03209
...
-- primary_obligation_id: ATSC-EXT|03209|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03209_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
