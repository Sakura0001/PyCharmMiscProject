...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03312
...
-- primary_obligation_id: ATSC-EXT|03312|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03312_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
