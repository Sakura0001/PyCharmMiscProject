...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02833
...
-- primary_obligation_id: ATSC-EXT|02833|error_assertion|drop_text_search_configuration
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02833_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
