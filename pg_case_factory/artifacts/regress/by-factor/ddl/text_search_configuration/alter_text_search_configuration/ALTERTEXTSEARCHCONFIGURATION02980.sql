...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02980
...
-- primary_obligation_id: ATSC-EXT|02980|error_assertion|drop_mapping_revert
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02980_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
