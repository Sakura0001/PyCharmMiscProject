...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03177
...
-- primary_obligation_id: ATSC-EXT|03177|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03177_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
