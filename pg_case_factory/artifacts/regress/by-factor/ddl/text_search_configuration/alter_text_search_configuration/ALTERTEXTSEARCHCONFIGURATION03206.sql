...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03206
...
-- primary_obligation_id: ATSC-EXT|03206|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03206_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
