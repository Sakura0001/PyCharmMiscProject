...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02772
...
-- primary_obligation_id: ATSC-EXT|02772|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02772_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
