...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02744
...
-- primary_obligation_id: ATSC-EXT|02744|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02744_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
