...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03012
...
-- primary_obligation_id: ATSC-EXT|03012|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03012_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
