...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02924
...
-- primary_obligation_id: ATSC-EXT|02924|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02924_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
