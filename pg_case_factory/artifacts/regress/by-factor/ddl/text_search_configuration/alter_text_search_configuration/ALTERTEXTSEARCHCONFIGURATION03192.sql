...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03192
...
-- primary_obligation_id: ATSC-EXT|03192|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03192_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
