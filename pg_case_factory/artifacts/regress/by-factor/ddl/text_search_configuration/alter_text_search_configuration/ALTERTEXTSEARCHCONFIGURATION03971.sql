...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03971
...
-- primary_obligation_id: ATSC-EXT|03971|error_assertion|revert_rename
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH CONFIGURATION IF EXISTS "alter_text_search_configuration_03971_qnewcfg";
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03971_nosuchcfg RENAME TO "alter_text_search_configuration_03971_qnewcfg";
-- primary-target-end
