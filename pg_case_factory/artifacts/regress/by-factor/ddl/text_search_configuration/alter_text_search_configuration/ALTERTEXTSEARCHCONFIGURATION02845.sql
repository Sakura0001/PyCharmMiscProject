...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02845
...
-- primary_obligation_id: ATSC-EXT|02845|error_assertion|drop_mapping_revert
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02845_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
