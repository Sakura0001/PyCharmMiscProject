...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02891
...
-- primary_obligation_id: ATSC-EXT|02891|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02891_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
