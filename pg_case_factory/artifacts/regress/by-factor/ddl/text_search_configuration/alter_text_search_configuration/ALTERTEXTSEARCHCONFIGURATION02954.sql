...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02954
...
-- primary_obligation_id: ATSC-EXT|02954|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02954_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
