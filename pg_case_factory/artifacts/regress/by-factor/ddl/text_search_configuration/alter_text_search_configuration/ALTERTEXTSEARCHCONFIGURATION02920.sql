...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02920
...
-- primary_obligation_id: ATSC-EXT|02920|error_assertion|drop_mapping_revert
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02920_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
