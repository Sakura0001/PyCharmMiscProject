...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02819
...
-- primary_obligation_id: ATSC-EXT|02819|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02819_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
