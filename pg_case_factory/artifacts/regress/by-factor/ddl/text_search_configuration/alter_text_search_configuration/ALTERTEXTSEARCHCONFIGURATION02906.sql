...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02906
...
-- primary_obligation_id: ATSC-EXT|02906|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02906_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
