...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02740
...
-- primary_obligation_id: ATSC-EXT|02740|error_assertion|drop_mapping_revert
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02740_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
