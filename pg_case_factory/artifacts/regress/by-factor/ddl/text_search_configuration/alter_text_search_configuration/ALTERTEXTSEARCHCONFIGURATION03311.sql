...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03311
...
-- primary_obligation_id: ATSC-EXT|03311|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03311_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
