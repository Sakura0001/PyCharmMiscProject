...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02879
...
-- primary_obligation_id: ATSC-EXT|02879|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02879_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
