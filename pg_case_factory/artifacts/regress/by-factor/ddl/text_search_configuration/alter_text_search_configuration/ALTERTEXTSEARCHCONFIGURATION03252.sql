...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03252
...
-- primary_obligation_id: ATSC-EXT|03252|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03252_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
