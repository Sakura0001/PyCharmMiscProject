...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02907
...
-- primary_obligation_id: ATSC-EXT|02907|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02907_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
