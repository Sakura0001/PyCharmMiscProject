...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02968
...
-- primary_obligation_id: ATSC-EXT|02968|error_assertion|drop_text_search_configuration
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02968_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
