...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03313
...
-- primary_obligation_id: ATSC-EXT|03313|error_assertion|drop_text_search_configuration
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03313_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
