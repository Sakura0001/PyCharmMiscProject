...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02952
...
-- primary_obligation_id: ATSC-EXT|02952|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02952_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
