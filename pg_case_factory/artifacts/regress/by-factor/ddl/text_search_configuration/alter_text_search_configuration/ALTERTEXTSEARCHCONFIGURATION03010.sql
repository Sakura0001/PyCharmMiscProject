...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03010
...
-- primary_obligation_id: ATSC-EXT|03010|error_assertion|drop_mapping_revert
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03010_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
