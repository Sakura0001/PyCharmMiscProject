...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION04240
...
-- primary_obligation_id: ATSC-EXT|04240|error_assertion|drop_mapping_revert
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH CONFIGURATION IF EXISTS alter_text_search_configuration_04240_newcfg;
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_04240_nosuchcfg RENAME TO alter_text_search_configuration_04240_newcfg;
-- primary-target-end
