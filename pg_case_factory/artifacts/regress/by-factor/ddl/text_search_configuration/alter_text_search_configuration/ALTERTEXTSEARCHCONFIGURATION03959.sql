...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03959
...
-- primary_obligation_id: ATSC-EXT|03959|error_assertion|role_cleanup
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH CONFIGURATION IF EXISTS "alter_text_search_configuration_03959_qnewcfg";
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03959_nosuchcfg RENAME TO "alter_text_search_configuration_03959_qnewcfg";
-- primary-target-end
