...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03266
...
-- primary_obligation_id: ATSC-EXT|03266|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03266_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
