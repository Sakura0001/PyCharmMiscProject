...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02877
...
-- primary_obligation_id: ATSC-EXT|02877|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02877_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
