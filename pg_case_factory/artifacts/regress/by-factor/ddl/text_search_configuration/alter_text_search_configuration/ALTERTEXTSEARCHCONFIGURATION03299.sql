...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03299
...
-- primary_obligation_id: ATSC-EXT|03299|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03299_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
