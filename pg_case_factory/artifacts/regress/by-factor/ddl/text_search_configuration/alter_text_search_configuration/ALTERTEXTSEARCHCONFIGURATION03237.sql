...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03237
...
-- primary_obligation_id: ATSC-EXT|03237|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03237_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
