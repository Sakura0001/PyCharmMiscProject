...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02726
...
-- primary_obligation_id: ATSC-EXT|02726|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02726_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
