...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02999
...
-- primary_obligation_id: ATSC-EXT|02999|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02999_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
