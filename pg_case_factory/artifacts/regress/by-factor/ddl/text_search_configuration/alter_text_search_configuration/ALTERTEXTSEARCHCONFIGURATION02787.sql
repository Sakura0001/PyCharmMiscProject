...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02787
...
-- primary_obligation_id: ATSC-EXT|02787|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02787_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
