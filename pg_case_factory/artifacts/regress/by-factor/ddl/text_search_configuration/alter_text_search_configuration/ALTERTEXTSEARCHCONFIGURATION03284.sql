...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03284
...
-- primary_obligation_id: ATSC-EXT|03284|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03284_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
