...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION04123
...
-- primary_obligation_id: ATSC-EXT|04123|error_assertion|drop_text_search_configuration
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH CONFIGURATION IF EXISTS alter_text_search_configuration_04123_newcfg;
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_04123_nosuchcfg RENAME TO alter_text_search_configuration_04123_newcfg;
-- primary-target-end
