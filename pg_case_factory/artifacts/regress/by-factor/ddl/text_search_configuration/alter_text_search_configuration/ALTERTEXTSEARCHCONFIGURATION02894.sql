...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02894
...
-- primary_obligation_id: ATSC-EXT|02894|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02894_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
