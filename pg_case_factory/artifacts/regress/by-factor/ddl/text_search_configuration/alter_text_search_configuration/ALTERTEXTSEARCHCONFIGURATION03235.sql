...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03235
...
-- primary_obligation_id: ATSC-EXT|03235|error_assertion|drop_mapping_revert
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03235_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
