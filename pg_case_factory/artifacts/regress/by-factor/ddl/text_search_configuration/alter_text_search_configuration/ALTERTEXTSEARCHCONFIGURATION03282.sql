...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03282
...
-- primary_obligation_id: ATSC-EXT|03282|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03282_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
