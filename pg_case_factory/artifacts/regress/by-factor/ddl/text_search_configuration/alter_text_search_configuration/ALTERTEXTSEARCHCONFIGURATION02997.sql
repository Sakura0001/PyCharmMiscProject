...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02997
...
-- primary_obligation_id: ATSC-EXT|02997|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02997_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
