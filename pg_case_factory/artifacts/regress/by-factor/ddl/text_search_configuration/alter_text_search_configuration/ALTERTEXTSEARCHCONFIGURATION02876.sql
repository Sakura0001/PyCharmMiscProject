...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02876
...
-- primary_obligation_id: ATSC-EXT|02876|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02876_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
