...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02774
...
-- primary_obligation_id: ATSC-EXT|02774|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02774_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
