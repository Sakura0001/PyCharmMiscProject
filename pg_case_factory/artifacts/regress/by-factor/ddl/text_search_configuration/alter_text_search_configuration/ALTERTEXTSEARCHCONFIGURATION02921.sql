...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02921
...
-- primary_obligation_id: ATSC-EXT|02921|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02921_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
