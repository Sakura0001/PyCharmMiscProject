...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03236
...
-- primary_obligation_id: ATSC-EXT|03236|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03236_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
