...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03221
...
-- primary_obligation_id: ATSC-EXT|03221|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03221_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
