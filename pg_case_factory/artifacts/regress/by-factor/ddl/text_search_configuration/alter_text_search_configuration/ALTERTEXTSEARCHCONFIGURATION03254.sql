...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03254
...
-- primary_obligation_id: ATSC-EXT|03254|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03254_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
