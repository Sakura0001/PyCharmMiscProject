...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02996
...
-- primary_obligation_id: ATSC-EXT|02996|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02996_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
