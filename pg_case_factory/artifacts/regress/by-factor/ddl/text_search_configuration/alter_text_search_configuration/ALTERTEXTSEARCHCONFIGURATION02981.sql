...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02981
...
-- primary_obligation_id: ATSC-EXT|02981|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02981_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
