...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03176
...
-- primary_obligation_id: ATSC-EXT|03176|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03176_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
