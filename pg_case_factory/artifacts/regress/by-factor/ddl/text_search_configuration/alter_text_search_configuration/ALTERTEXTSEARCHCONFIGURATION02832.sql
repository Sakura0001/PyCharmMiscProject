...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02832
...
-- primary_obligation_id: ATSC-EXT|02832|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02832_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
