...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02817
...
-- primary_obligation_id: ATSC-EXT|02817|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02817_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
