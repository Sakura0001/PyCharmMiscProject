...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03179
...
-- primary_obligation_id: ATSC-EXT|03179|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03179_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
