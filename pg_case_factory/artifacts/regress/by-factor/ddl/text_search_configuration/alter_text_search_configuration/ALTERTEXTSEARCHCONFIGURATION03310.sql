...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03310
...
-- primary_obligation_id: ATSC-EXT|03310|error_assertion|drop_mapping_revert
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03310_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
