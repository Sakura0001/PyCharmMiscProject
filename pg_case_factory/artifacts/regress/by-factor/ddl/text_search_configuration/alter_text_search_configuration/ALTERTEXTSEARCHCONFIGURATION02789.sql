...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02789
...
-- primary_obligation_id: ATSC-EXT|02789|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02789_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
