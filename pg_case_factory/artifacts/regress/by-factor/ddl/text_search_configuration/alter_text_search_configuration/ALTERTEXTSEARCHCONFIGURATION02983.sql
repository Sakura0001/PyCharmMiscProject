...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02983
...
-- primary_obligation_id: ATSC-EXT|02983|error_assertion|drop_text_search_configuration
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02983_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
