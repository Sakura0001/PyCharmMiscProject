...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03307
...
-- primary_obligation_id: ATSC-EXT|03307|mapping_query|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03307_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
...
SELECT count(*) = 0 AS config_state FROM pg_catalog.pg_ts_config WHERE cfgname = 'alter_text_search_configuration_03307_nosuchcfg' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
