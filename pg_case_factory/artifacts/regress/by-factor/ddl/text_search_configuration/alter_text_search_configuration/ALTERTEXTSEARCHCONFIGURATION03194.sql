...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03194
...
-- primary_obligation_id: ATSC-EXT|03194|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03194_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
