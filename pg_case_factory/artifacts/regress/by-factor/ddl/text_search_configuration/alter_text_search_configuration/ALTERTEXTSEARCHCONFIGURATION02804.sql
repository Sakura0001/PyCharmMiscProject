...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02804
...
-- primary_obligation_id: ATSC-EXT|02804|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02804_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
