...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03250
...
-- primary_obligation_id: ATSC-EXT|03250|error_assertion|drop_mapping_revert
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03250_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
