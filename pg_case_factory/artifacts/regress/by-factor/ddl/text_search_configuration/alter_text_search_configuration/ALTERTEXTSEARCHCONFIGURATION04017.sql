...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION04017
...
-- primary_obligation_id: ATSC-EXT|04017|error_assertion|revert_owner
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH CONFIGURATION IF EXISTS "alter_text_search_configuration_04017_qnewcfg";
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_04017_nosuchcfg RENAME TO "alter_text_search_configuration_04017_qnewcfg";
-- primary-target-end
