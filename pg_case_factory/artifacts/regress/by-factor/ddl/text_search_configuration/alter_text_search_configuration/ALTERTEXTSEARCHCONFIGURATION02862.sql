...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02862
...
-- primary_obligation_id: ATSC-EXT|02862|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02862_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
