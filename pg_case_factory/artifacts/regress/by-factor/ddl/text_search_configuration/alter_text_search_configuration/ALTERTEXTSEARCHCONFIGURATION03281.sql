...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03281
...
-- primary_obligation_id: ATSC-EXT|03281|error_assertion|revert_rename
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03281_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
