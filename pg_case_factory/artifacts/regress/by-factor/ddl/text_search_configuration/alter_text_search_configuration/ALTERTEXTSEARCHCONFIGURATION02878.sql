...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02878
...
-- primary_obligation_id: ATSC-EXT|02878|error_assertion|drop_text_search_configuration
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02878_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
