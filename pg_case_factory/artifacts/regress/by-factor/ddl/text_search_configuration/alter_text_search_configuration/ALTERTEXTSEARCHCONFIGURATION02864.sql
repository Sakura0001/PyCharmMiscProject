...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02864
...
-- primary_obligation_id: ATSC-EXT|02864|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02864_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
