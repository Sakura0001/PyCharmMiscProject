...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03208
...
-- primary_obligation_id: ATSC-EXT|03208|error_assertion|drop_text_search_configuration
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03208_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
