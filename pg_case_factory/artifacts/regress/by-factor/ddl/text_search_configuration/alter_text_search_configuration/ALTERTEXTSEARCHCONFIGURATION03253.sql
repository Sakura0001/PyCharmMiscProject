...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION03253
...
-- primary_obligation_id: ATSC-EXT|03253|error_assertion|drop_text_search_configuration
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_03253_nosuchcfg OWNER TO SESSION_USER;
-- primary-target-end
