...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02909
...
-- primary_obligation_id: ATSC-EXT|02909|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02909_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
