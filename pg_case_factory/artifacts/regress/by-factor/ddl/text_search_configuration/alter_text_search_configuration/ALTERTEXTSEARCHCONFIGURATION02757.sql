...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02757
...
-- primary_obligation_id: ATSC-EXT|02757|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02757_nosuchcfg OWNER TO CURRENT_ROLE;
-- primary-target-end
