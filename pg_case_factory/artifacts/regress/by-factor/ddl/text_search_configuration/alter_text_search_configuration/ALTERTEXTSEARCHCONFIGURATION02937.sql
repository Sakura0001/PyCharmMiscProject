...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02937
...
-- primary_obligation_id: ATSC-EXT|02937|error_assertion|revert_owner
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02937_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
