...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHCONFIGURATION02939
...
-- primary_obligation_id: ATSC-EXT|02939|error_assertion|role_cleanup
...
ALTER TEXT SEARCH CONFIGURATION alter_text_search_configuration_02939_nosuchcfg OWNER TO CURRENT_USER;
-- primary-target-end
