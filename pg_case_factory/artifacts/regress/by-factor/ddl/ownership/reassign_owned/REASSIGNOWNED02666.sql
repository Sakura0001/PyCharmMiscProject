...
-- primary_obligation_id: REASSIGNOWNED-EXT|02666|reassign_owned|error_assertion|drop_owned_then_drop_role
...
REASSIGN OWNED BY reassignowned_02666_old TO CURRENT_ROLE;
-- primary-target-end
