...
-- primary_obligation_id: REASSIGNOWNED-EXT|02918|reassign_owned|error_assertion|drop_owned_then_drop_role
...
REASSIGN OWNED BY reassignowned_02918_old TO CURRENT_USER;
-- primary-target-end
