...
-- primary_obligation_id: REASSIGNOWNED-EXT|00218|reassign_owned|error_assertion|drop_owned_then_drop_role
...
REASSIGN OWNED BY reassignowned_00218_old TO CURRENT_ROLE;
-- primary-target-end
