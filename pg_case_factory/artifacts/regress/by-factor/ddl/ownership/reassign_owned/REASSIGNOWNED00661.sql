...
-- primary_obligation_id: REASSIGNOWNED-EXT|00661|reassign_owned|error_assertion|reassign_owned_then_drop_role
...
REASSIGN OWNED BY SESSION_USER TO reassignowned_00661_new;
-- primary-target-end
