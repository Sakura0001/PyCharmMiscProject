...
-- primary_obligation_id: REASSIGNOWNED-EXT|02577|reassign_owned|error_assertion|drop_role_cascade
...
REASSIGN OWNED BY CURRENT_ROLE TO reassignowned_02577_new;
-- primary-target-end
