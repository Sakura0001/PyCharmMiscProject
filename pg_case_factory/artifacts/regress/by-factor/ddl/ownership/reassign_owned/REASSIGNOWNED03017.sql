...
-- primary_obligation_id: REASSIGNOWNED-EXT|03017|reassign_owned|error_assertion|drop_owned_then_drop_role
...
REASSIGN OWNED BY CURRENT_USER TO reassignowned_03017_new;
-- primary-target-end
