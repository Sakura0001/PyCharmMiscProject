...
-- primary_obligation_id: REASSIGNOWNED-EXT|00570|reassign_owned|error_assertion|drop_role_cascade
...
REASSIGN OWNED BY CURRENT_USER TO reassignowned_00570_new;
-- primary-target-end
