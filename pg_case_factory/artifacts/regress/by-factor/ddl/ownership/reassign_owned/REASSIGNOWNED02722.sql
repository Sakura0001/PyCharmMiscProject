...
-- primary_obligation_id: REASSIGNOWNED-EXT|02722|reassign_owned|error_assertion|reassign_owned_then_drop_role
...
REASSIGN OWNED BY CURRENT_ROLE TO reassignowned_02722_new;
-- primary-target-end
