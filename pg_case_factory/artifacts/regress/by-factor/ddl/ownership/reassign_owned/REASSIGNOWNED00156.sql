...
-- primary_obligation_id: REASSIGNOWNED-EXT|00156|reassign_owned|error_assertion|drop_role_cascade
...
REASSIGN OWNED BY SESSION_USER TO reassignowned_00156_new;
-- primary-target-end
