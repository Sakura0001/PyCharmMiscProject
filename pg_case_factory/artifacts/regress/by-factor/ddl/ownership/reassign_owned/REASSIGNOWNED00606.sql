...
-- primary_obligation_id: REASSIGNOWNED-EXT|00606|reassign_owned|error_assertion|drop_role_cascade
...
REASSIGN OWNED BY CURRENT_USER TO reassignowned_00606_new;
-- primary-target-end
