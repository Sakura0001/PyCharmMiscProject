...
-- primary_obligation_id: REASSIGNOWNED-EXT|02603|reassign_owned|error_assertion|drop_owned_then_drop_role
...
REASSIGN OWNED BY SESSION_USER TO reassignowned_02603_new;
-- primary-target-end
