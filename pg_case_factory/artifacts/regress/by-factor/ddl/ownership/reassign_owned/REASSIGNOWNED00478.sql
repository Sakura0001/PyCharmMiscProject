...
-- primary_obligation_id: REASSIGNOWNED-EXT|00478|reassign_owned|pg_roles_catalog_query|reassign_owned_then_drop_role
...
SELECT count(*) = 0 AS role_absent FROM pg_catalog.pg_roles WHERE rolname = 'reassignowned_00478_old' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
