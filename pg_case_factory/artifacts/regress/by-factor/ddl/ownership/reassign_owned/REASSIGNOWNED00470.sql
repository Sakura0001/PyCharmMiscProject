...
-- primary_obligation_id: REASSIGNOWNED-EXT|00470|reassign_owned|error_assertion|drop_owned_then_drop_role
...
REASSIGN OWNED BY reassignowned_00470_old TO CURRENT_USER;
-- primary-target-end
