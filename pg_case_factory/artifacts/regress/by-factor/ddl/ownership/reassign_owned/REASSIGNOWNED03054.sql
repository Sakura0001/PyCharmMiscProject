...
-- primary_obligation_id: REASSIGNOWNED-EXT|03054|reassign_owned|error_assertion|drop_role_cascade
...
REASSIGN OWNED BY CURRENT_USER TO reassignowned_03054_new;
-- primary-target-end
