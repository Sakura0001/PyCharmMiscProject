...
-- primary_obligation_id: REASSIGNOWNED-EXT|00398|reassign_owned|error_assertion|drop_owned_then_drop_role
...
REASSIGN OWNED BY reassignowned_00398_old TO CURRENT_ROLE;
-- primary-target-end
