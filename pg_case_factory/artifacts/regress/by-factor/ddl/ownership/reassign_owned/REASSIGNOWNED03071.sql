...
-- primary_obligation_id: REASSIGNOWNED-EXT|03071|reassign_owned|error_assertion|drop_owned_then_drop_role
...
REASSIGN OWNED BY SESSION_USER TO reassignowned_03071_new;
-- primary-target-end
