...
-- primary_obligation_id: REASSIGNOWNED-EXT|03136|reassign_owned|error_assertion|reassign_owned_then_drop_role
...
REASSIGN OWNED BY reassignowned_03136_old TO SESSION_USER;
-- primary-target-end
