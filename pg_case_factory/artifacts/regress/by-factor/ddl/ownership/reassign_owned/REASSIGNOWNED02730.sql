...
-- primary_obligation_id: REASSIGNOWNED-EXT|02730|reassign_owned|error_assertion|drop_role_cascade
...
REASSIGN OWNED BY CURRENT_USER TO reassignowned_02730_new;
-- primary-target-end
