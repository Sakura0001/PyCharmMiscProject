...
-- primary_obligation_id: REASSIGNOWNED-EXT|03009|reassign_owned|error_assertion|drop_role_cascade
...
REASSIGN OWNED BY CURRENT_ROLE TO reassignowned_03009_new;
-- primary-target-end
