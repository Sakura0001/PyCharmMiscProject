...
-- primary_obligation_id: REASSIGNOWNED-EXT|00561|reassign_owned|error_assertion|drop_role_cascade
...
REASSIGN OWNED BY CURRENT_ROLE TO reassignowned_00561_new;
-- primary-target-end
