...
-- primary_obligation_id: REASSIGNOWNED-EXT|03081|reassign_owned|error_assertion|drop_role_cascade
...
REASSIGN OWNED BY CURRENT_ROLE TO reassignowned_03081_new;
-- primary-target-end
