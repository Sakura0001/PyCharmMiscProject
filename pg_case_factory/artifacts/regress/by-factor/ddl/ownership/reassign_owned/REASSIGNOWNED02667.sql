...
-- primary_obligation_id: REASSIGNOWNED-EXT|02667|reassign_owned|error_assertion|drop_role_cascade
...
REASSIGN OWNED BY reassignowned_02667_old TO CURRENT_ROLE;
-- primary-target-end
