...
-- primary_obligation_id: REASSIGNOWNED-EXT|00650|reassign_owned|error_assertion|drop_owned_then_drop_role
...
REASSIGN OWNED BY reassignowned_00650_old TO reassignowned_00650_new;
-- primary-target-end
