...
-- primary_obligation_id: REASSIGNOWNED-EXT|02776|reassign_owned|error_assertion|reassign_owned_then_drop_role
...
REASSIGN OWNED BY reassignowned_02776_old TO SESSION_USER;
-- primary-target-end
