...
-- primary_obligation_id: REASSIGNOWNED-EXT|00686|reassign_owned|error_assertion|drop_owned_then_drop_role
...
REASSIGN OWNED BY reassignowned_00686_old TO SESSION_USER;
-- primary-target-end
