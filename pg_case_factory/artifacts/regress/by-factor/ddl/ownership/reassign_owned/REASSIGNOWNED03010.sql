...
-- primary_obligation_id: REASSIGNOWNED-EXT|03010|reassign_owned|error_assertion|reassign_owned_then_drop_role
...
REASSIGN OWNED BY CURRENT_ROLE TO reassignowned_03010_new;
-- primary-target-end
