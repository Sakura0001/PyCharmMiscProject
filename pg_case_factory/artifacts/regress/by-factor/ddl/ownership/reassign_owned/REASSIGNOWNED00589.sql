...
-- primary_obligation_id: REASSIGNOWNED-EXT|00589|reassign_owned|error_assertion|reassign_owned_then_drop_role
...
REASSIGN OWNED BY SESSION_USER TO reassignowned_00589_new;
-- primary-target-end
