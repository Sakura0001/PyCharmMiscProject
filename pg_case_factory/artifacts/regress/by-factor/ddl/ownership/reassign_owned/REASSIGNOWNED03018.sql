...
-- primary_obligation_id: REASSIGNOWNED-EXT|03018|reassign_owned|error_assertion|drop_role_cascade
...
REASSIGN OWNED BY CURRENT_USER TO reassignowned_03018_new;
-- primary-target-end
