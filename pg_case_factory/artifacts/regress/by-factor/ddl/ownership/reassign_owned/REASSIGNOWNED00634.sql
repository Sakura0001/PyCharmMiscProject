...
-- primary_obligation_id: REASSIGNOWNED-EXT|00634|reassign_owned|error_assertion|reassign_owned_then_drop_role
...
REASSIGN OWNED BY CURRENT_ROLE TO reassignowned_00634_new;
-- primary-target-end
