...
-- primary_obligation_id: REASSIGNOWNED-EXT|02604|reassign_owned|error_assertion|drop_role_cascade
...
REASSIGN OWNED BY SESSION_USER TO reassignowned_02604_new;
-- primary-target-end
