...
-- primary_obligation_id: REASSIGNOWNED-EXT|00687|reassign_owned|error_assertion|drop_role_cascade
...
REASSIGN OWNED BY reassignowned_00687_old TO SESSION_USER;
-- primary-target-end
