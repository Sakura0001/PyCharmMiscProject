...
-- primary_obligation_id: REASSIGNOWNED-EXT|00184|reassign_owned|error_assertion|reassign_owned_then_drop_role
...
REASSIGN OWNED BY reassignowned_00184_old TO SESSION_USER;
-- primary-target-end
