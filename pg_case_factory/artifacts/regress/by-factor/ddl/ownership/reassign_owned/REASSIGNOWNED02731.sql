...
-- primary_obligation_id: REASSIGNOWNED-EXT|02731|reassign_owned|error_assertion|reassign_owned_then_drop_role
...
REASSIGN OWNED BY CURRENT_USER TO reassignowned_02731_new;
-- primary-target-end
