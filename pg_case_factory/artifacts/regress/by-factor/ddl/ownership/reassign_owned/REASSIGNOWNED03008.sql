...
-- primary_obligation_id: REASSIGNOWNED-EXT|03008|reassign_owned|error_assertion|drop_owned_then_drop_role
...
REASSIGN OWNED BY CURRENT_ROLE TO reassignowned_03008_new;
-- primary-target-end
