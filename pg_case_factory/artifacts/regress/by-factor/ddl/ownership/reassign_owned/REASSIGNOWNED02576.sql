...
-- primary_obligation_id: REASSIGNOWNED-EXT|02576|reassign_owned|error_assertion|drop_owned_then_drop_role
...
REASSIGN OWNED BY CURRENT_ROLE TO reassignowned_02576_new;
-- primary-target-end
