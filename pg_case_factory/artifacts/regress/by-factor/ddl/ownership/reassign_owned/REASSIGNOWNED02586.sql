...
-- primary_obligation_id: REASSIGNOWNED-EXT|02586|reassign_owned|error_assertion|drop_role_cascade
...
REASSIGN OWNED BY CURRENT_USER TO reassignowned_02586_new;
-- primary-target-end
