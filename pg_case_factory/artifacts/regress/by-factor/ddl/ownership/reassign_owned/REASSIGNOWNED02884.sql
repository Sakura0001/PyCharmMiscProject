...
-- primary_obligation_id: REASSIGNOWNED-EXT|02884|reassign_owned|error_assertion|reassign_owned_then_drop_role
...
REASSIGN OWNED BY reassignowned_02884_old TO CURRENT_ROLE;
-- primary-target-end
