...
-- primary_obligation_id: REASSIGNOWNED-EXT|02560|reassign_owned|error_assertion|reassign_owned_then_drop_role
...
REASSIGN OWNED BY reassignowned_02560_old TO CURRENT_USER;
-- primary-target-end
