...
-- primary_obligation_id: REASSIGNOWNED-EXT|00642|reassign_owned|error_assertion|drop_role_cascade
...
REASSIGN OWNED BY CURRENT_USER TO reassignowned_00642_new;
-- primary-target-end
