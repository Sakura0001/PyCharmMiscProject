...
-- primary_obligation_id: REASSIGNOWNED-EXT|00688|reassign_owned|error_assertion|reassign_owned_then_drop_role
...
REASSIGN OWNED BY reassignowned_00688_old TO SESSION_USER;
-- primary-target-end
