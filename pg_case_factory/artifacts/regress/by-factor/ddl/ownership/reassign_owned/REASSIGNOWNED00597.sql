...
-- primary_obligation_id: REASSIGNOWNED-EXT|00597|reassign_owned|error_assertion|drop_role_cascade
...
REASSIGN OWNED BY CURRENT_ROLE TO reassignowned_00597_new;
-- primary-target-end
