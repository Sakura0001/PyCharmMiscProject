...
-- primary_obligation_id: REASSIGNOWNED-EXT|03072|reassign_owned|error_assertion|drop_role_cascade
...
REASSIGN OWNED BY SESSION_USER TO reassignowned_03072_new;
-- primary-target-end
