...
-- primary_obligation_id: DROPOWNED-EXT|02653|drop_owned|error_assertion|drop_role_cascade
...
DROP OWNED BY CURRENT_USER, dropowned_02653_actor2;
-- primary-target-end
