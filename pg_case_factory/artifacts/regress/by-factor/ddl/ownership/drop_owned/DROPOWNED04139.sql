...
-- primary_obligation_id: DROPOWNED-EXT|04139|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY dropowned_04139_actor RESTRICT;
-- primary-target-end
