...
-- primary_obligation_id: DROPOWNED-EXT|01619|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY dropowned_01619_actor CASCADE;
-- primary-target-end
