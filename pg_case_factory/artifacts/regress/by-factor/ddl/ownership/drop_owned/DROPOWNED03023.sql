...
-- primary_obligation_id: DROPOWNED-EXT|03023|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY dropowned_03023_actor, dropowned_03023_actor2;
-- primary-target-end
