...
-- primary_obligation_id: DROPOWNED-EXT|04112|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY SESSION_USER, dropowned_04112_actor2 RESTRICT;
-- primary-target-end
