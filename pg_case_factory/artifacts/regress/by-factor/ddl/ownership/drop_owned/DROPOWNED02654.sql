...
-- primary_obligation_id: DROPOWNED-EXT|02654|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY CURRENT_USER, dropowned_02654_actor2;
-- primary-target-end
