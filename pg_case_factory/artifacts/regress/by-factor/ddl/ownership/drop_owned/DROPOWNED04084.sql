...
-- primary_obligation_id: DROPOWNED-EXT|04084|drop_owned|error_assertion|drop_role_cascade
...
DROP OWNED BY CURRENT_ROLE, dropowned_04084_actor2 RESTRICT;
-- primary-target-end
