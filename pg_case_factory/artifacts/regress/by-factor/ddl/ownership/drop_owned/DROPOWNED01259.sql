...
-- primary_obligation_id: DROPOWNED-EXT|01259|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY dropowned_01259_actor CASCADE;
-- primary-target-end
