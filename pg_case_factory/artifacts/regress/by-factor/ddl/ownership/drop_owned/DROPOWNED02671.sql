...
-- primary_obligation_id: DROPOWNED-EXT|02671|drop_owned|error_assertion|drop_role_cascade
...
DROP OWNED BY SESSION_USER, dropowned_02671_actor2;
-- primary-target-end
