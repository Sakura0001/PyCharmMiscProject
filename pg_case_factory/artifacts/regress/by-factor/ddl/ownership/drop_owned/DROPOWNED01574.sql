...
-- primary_obligation_id: DROPOWNED-EXT|01574|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY CURRENT_USER, dropowned_01574_actor2 CASCADE;
-- primary-target-end
