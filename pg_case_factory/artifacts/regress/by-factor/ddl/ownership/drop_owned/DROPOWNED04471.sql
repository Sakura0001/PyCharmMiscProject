...
-- primary_obligation_id: DROPOWNED-EXT|04471|drop_owned|error_assertion|drop_role_cascade
...
DROP OWNED BY SESSION_USER, dropowned_04471_actor2 RESTRICT;
-- primary-target-end
