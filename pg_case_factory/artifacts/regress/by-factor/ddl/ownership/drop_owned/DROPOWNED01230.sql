...
-- primary_obligation_id: DROPOWNED-EXT|01230|drop_owned|error_assertion|drop_owned_cascade
...
DROP OWNED BY SESSION_USER, dropowned_01230_actor2 CASCADE;
-- primary-target-end
