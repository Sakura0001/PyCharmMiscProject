...
-- primary_obligation_id: DROPOWNED-EXT|02699|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY dropowned_02699_actor;
-- primary-target-end
