...
-- primary_obligation_id: DROPOWNED-EXT|04445|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY CURRENT_ROLE, dropowned_04445_actor2 RESTRICT;
-- primary-target-end
