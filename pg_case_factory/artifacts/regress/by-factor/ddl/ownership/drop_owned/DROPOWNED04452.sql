...
-- primary_obligation_id: DROPOWNED-EXT|04452|drop_owned|error_assertion|drop_owned_cascade
...
DROP OWNED BY CURRENT_USER, dropowned_04452_actor2 RESTRICT;
-- primary-target-end
