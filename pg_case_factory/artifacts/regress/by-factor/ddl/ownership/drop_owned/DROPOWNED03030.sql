...
-- primary_obligation_id: DROPOWNED-EXT|03030|drop_owned|error_assertion|drop_owned_cascade
...
DROP OWNED BY SESSION_USER, dropowned_03030_actor2;
-- primary-target-end
