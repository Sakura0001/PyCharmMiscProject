...
-- primary_obligation_id: DROPOWNED-EXT|03005|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY CURRENT_ROLE, dropowned_03005_actor2;
-- primary-target-end
