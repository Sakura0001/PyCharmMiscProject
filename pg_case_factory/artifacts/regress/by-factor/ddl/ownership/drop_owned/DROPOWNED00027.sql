...
-- primary_obligation_id: DROPOWNED-SFV|sfv-7f8e58c8eff7a6be80f4f326|drop_owned
...
DROP OWNED BY dropowned_00027_actor;
-- primary-target-end
...
SELECT count(*) = 0 AS objects_absent FROM pg_catalog.pg_class WHERE relname = 'dropowned_00027_t' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
