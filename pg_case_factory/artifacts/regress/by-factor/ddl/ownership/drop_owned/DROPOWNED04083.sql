...
-- primary_obligation_id: DROPOWNED-EXT|04083|drop_owned|error_assertion|drop_owned_cascade
...
DROP OWNED BY CURRENT_ROLE, dropowned_04083_actor2 RESTRICT;
-- primary-target-end
