...
-- primary_obligation_id: DROPOWNED-EXT|04462|drop_owned|error_assertion|drop_role_cascade
...
DROP OWNED BY dropowned_04462_actor, dropowned_04462_actor2 RESTRICT;
-- primary-target-end
