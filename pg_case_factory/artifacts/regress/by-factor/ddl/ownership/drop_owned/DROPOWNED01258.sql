...
-- primary_obligation_id: DROPOWNED-EXT|01258|drop_owned|error_assertion|drop_role_cascade
...
DROP OWNED BY dropowned_01258_actor CASCADE;
-- primary-target-end
