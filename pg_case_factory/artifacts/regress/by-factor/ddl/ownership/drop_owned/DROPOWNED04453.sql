...
-- primary_obligation_id: DROPOWNED-EXT|04453|drop_owned|error_assertion|drop_role_cascade
...
DROP OWNED BY CURRENT_USER, dropowned_04453_actor2 RESTRICT;
-- primary-target-end
