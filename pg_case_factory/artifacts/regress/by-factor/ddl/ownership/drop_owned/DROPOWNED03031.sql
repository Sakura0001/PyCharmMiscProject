...
-- primary_obligation_id: DROPOWNED-EXT|03031|drop_owned|error_assertion|drop_role_cascade
...
DROP OWNED BY SESSION_USER, dropowned_03031_actor2;
-- primary-target-end
