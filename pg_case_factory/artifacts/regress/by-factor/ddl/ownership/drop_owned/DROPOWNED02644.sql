...
-- primary_obligation_id: DROPOWNED-EXT|02644|drop_owned|error_assertion|drop_role_cascade
...
DROP OWNED BY CURRENT_ROLE, dropowned_02644_actor2;
-- primary-target-end
