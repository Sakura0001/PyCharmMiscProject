...
-- primary_obligation_id: DROPOWNED-EXT|01214|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY CURRENT_USER, dropowned_01214_actor2 CASCADE;
-- primary-target-end
