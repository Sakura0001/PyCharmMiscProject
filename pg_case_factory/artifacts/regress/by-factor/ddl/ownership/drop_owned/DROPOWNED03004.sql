...
-- primary_obligation_id: DROPOWNED-EXT|03004|drop_owned|error_assertion|drop_role_cascade
...
DROP OWNED BY CURRENT_ROLE, dropowned_03004_actor2;
-- primary-target-end
