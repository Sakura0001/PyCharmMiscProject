...
-- primary_obligation_id: DROPOWNED-EXT|03014|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY CURRENT_USER, dropowned_03014_actor2;
-- primary-target-end
