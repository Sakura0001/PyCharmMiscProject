...
-- primary_obligation_id: DROPOWNED-EXT|04137|drop_owned|error_assertion|drop_owned_cascade
...
DROP OWNED BY dropowned_04137_actor RESTRICT;
-- primary-target-end
