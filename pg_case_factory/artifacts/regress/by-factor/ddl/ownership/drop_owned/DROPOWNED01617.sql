...
-- primary_obligation_id: DROPOWNED-EXT|01617|drop_owned|error_assertion|drop_owned_cascade
...
DROP OWNED BY dropowned_01617_actor CASCADE;
-- primary-target-end
