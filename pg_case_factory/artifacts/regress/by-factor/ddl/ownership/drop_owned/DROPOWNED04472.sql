...
-- primary_obligation_id: DROPOWNED-EXT|04472|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY SESSION_USER, dropowned_04472_actor2 RESTRICT;
-- primary-target-end
