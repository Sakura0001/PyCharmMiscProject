...
-- primary_obligation_id: DROPOWNED-EXT|01583|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY dropowned_01583_actor, dropowned_01583_actor2 CASCADE;
-- primary-target-end
