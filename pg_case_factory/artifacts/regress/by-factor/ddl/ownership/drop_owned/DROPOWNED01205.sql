...
-- primary_obligation_id: DROPOWNED-EXT|01205|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY CURRENT_ROLE, dropowned_01205_actor2 CASCADE;
-- primary-target-end
