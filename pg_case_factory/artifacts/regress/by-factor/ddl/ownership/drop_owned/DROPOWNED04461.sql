...
-- primary_obligation_id: DROPOWNED-EXT|04461|drop_owned|error_assertion|drop_owned_cascade
...
DROP OWNED BY dropowned_04461_actor, dropowned_04461_actor2 RESTRICT;
-- primary-target-end
