...
-- primary_obligation_id: DROPOWNED-EXT|01203|drop_owned|error_assertion|drop_owned_cascade
...
DROP OWNED BY CURRENT_ROLE, dropowned_01203_actor2 CASCADE;
-- primary-target-end
