...
-- primary_obligation_id: DROPOWNED-EXT|01591|drop_owned|error_assertion|drop_role_cascade
...
DROP OWNED BY SESSION_USER, dropowned_01591_actor2 CASCADE;
-- primary-target-end
