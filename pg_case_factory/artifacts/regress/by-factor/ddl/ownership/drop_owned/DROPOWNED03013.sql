...
-- primary_obligation_id: DROPOWNED-EXT|03013|drop_owned|error_assertion|drop_role_cascade
...
DROP OWNED BY CURRENT_USER, dropowned_03013_actor2;
-- primary-target-end
