...
-- primary_obligation_id: DROPOWNED-EXT|02670|drop_owned|error_assertion|drop_owned_cascade
...
DROP OWNED BY SESSION_USER, dropowned_02670_actor2;
-- primary-target-end
