...
-- primary_obligation_id: DROPOWNED-EXT|04103|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY dropowned_04103_actor, dropowned_04103_actor2 RESTRICT;
-- primary-target-end
