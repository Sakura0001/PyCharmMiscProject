...
-- primary_obligation_id: DROPOWNED-EXT|02672|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY SESSION_USER, dropowned_02672_actor2;
-- primary-target-end
