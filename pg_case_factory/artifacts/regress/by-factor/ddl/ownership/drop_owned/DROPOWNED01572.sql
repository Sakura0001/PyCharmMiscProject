...
-- primary_obligation_id: DROPOWNED-EXT|01572|drop_owned|error_assertion|drop_owned_cascade
...
DROP OWNED BY CURRENT_USER, dropowned_01572_actor2 CASCADE;
-- primary-target-end
