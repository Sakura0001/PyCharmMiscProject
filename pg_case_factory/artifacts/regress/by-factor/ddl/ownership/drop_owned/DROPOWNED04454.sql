...
-- primary_obligation_id: DROPOWNED-EXT|04454|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY CURRENT_USER, dropowned_04454_actor2 RESTRICT;
-- primary-target-end
