...
-- primary_obligation_id: DROPOWNED-EXT|04085|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY CURRENT_ROLE, dropowned_04085_actor2 RESTRICT;
-- primary-target-end
