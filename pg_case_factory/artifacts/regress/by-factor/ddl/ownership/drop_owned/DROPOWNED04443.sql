...
-- primary_obligation_id: DROPOWNED-EXT|04443|drop_owned|error_assertion|drop_owned_cascade
...
DROP OWNED BY CURRENT_ROLE, dropowned_04443_actor2 RESTRICT;
-- primary-target-end
