...
-- primary_obligation_id: DROPOWNED-EXT|04482|drop_owned|pg_class_catalog_query|drop_owned_cascade
...
SELECT count(*) = 0 AS objects_absent FROM pg_catalog.pg_class WHERE relname = 'dropowned_04482_t' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
