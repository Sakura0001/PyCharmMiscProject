...
-- primary_obligation_id: DROPOWNED-EXT|01592|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY SESSION_USER, dropowned_01592_actor2 CASCADE;
-- primary-target-end
