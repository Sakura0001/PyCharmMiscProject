...
-- primary_obligation_id: DROPOWNED-EXT|02643|drop_owned|error_assertion|drop_owned_cascade
...
DROP OWNED BY CURRENT_ROLE, dropowned_02643_actor2;
-- primary-target-end
