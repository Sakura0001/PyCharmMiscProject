...
-- primary_obligation_id: DROPOWNED-EXT|02652|drop_owned|error_assertion|drop_owned_cascade
...
DROP OWNED BY CURRENT_USER, dropowned_02652_actor2;
-- primary-target-end
