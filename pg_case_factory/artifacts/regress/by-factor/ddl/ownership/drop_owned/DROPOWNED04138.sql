...
-- primary_obligation_id: DROPOWNED-EXT|04138|drop_owned|error_assertion|drop_role_cascade
...
DROP OWNED BY dropowned_04138_actor RESTRICT;
-- primary-target-end
