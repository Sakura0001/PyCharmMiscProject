...
-- primary_obligation_id: DROPOWNED-EXT|01212|drop_owned|error_assertion|drop_owned_cascade
...
DROP OWNED BY CURRENT_USER, dropowned_01212_actor2 CASCADE;
-- primary-target-end
