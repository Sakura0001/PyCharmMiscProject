...
-- primary_obligation_id: DROPOWNED-EXT|03012|drop_owned|error_assertion|drop_owned_cascade
...
DROP OWNED BY CURRENT_USER, dropowned_03012_actor2;
-- primary-target-end
