...
-- primary_obligation_id: DROPOWNED-EXT|03059|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY dropowned_03059_actor;
-- primary-target-end
