...
-- primary_obligation_id: DROPOWNED-EXT|02675|drop_owned|pg_class_catalog_query|reassign_owned_then_drop_role
...
SELECT count(*) = 0 AS objects_absent FROM pg_catalog.pg_class WHERE relname = 'dropowned_02675_t' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
