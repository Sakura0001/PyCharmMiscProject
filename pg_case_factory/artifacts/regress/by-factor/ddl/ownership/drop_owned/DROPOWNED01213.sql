...
-- primary_obligation_id: DROPOWNED-EXT|01213|drop_owned|error_assertion|drop_role_cascade
...
DROP OWNED BY CURRENT_USER, dropowned_01213_actor2 CASCADE;
-- primary-target-end
