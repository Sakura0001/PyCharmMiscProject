...
-- primary_obligation_id: DROPOWNED-EXT|03045|drop_owned|pg_roles_catalog_query|drop_owned_cascade
...
SELECT count(*) = 0 AS role_absent FROM pg_catalog.pg_roles WHERE rolname = 'dropowned_03045_actor' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
