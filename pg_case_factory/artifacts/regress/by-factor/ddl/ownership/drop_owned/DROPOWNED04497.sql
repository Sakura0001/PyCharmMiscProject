...
-- primary_obligation_id: DROPOWNED-EXT|04497|drop_owned|error_assertion|drop_owned_cascade
...
DROP OWNED BY dropowned_04497_actor RESTRICT;
-- primary-target-end
