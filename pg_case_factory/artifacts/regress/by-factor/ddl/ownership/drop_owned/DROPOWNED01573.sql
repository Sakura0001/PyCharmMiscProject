...
-- primary_obligation_id: DROPOWNED-EXT|01573|drop_owned|error_assertion|drop_role_cascade
...
DROP OWNED BY CURRENT_USER, dropowned_01573_actor2 CASCADE;
-- primary-target-end
