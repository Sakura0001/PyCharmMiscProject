...
-- primary_obligation_id: DROPOWNED-EXT|03032|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY SESSION_USER, dropowned_03032_actor2;
-- primary-target-end
