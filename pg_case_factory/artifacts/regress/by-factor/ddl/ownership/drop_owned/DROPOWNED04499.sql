...
-- primary_obligation_id: DROPOWNED-EXT|04499|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY dropowned_04499_actor RESTRICT;
-- primary-target-end
