...
-- primary_obligation_id: DROPOWNED-EXT|02645|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY CURRENT_ROLE, dropowned_02645_actor2;
-- primary-target-end
