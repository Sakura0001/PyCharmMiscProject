...
-- primary_obligation_id: DROPOWNED-EXT|01564|drop_owned|error_assertion|drop_role_cascade
...
DROP OWNED BY CURRENT_ROLE, dropowned_01564_actor2 CASCADE;
-- primary-target-end
