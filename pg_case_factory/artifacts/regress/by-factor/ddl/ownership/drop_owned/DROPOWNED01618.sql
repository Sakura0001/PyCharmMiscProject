...
-- primary_obligation_id: DROPOWNED-EXT|01618|drop_owned|error_assertion|drop_role_cascade
...
DROP OWNED BY dropowned_01618_actor CASCADE;
-- primary-target-end
