...
-- primary_obligation_id: DROPOWNED-EXT|04498|drop_owned|error_assertion|drop_role_cascade
...
DROP OWNED BY dropowned_04498_actor RESTRICT;
-- primary-target-end
