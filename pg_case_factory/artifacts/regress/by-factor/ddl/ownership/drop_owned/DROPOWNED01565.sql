...
-- primary_obligation_id: DROPOWNED-EXT|01565|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY CURRENT_ROLE, dropowned_01565_actor2 CASCADE;
-- primary-target-end
