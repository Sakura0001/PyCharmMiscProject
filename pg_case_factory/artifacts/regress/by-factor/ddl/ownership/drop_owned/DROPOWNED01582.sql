...
-- primary_obligation_id: DROPOWNED-EXT|01582|drop_owned|error_assertion|drop_role_cascade
...
DROP OWNED BY dropowned_01582_actor, dropowned_01582_actor2 CASCADE;
-- primary-target-end
