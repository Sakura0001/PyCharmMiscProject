...
-- primary_obligation_id: DROPOWNED-EXT|04110|drop_owned|error_assertion|drop_owned_cascade
...
DROP OWNED BY SESSION_USER, dropowned_04110_actor2 RESTRICT;
-- primary-target-end
