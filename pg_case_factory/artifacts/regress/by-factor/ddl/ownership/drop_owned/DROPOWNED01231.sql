...
-- primary_obligation_id: DROPOWNED-EXT|01231|drop_owned|error_assertion|drop_role_cascade
...
DROP OWNED BY SESSION_USER, dropowned_01231_actor2 CASCADE;
-- primary-target-end
