...
-- primary_obligation_id: DROPOWNED-EXT|01563|drop_owned|error_assertion|drop_owned_cascade
...
DROP OWNED BY CURRENT_ROLE, dropowned_01563_actor2 CASCADE;
-- primary-target-end
