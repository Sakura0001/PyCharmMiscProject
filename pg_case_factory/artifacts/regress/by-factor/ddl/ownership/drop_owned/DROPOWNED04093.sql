...
-- primary_obligation_id: DROPOWNED-EXT|04093|drop_owned|error_assertion|drop_role_cascade
...
DROP OWNED BY CURRENT_USER, dropowned_04093_actor2 RESTRICT;
-- primary-target-end
