...
-- primary_obligation_id: DROPOWNED-EXT|01581|drop_owned|error_assertion|drop_owned_cascade
...
DROP OWNED BY dropowned_01581_actor, dropowned_01581_actor2 CASCADE;
-- primary-target-end
