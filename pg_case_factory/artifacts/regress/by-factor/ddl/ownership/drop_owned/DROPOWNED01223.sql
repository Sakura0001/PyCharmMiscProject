...
-- primary_obligation_id: DROPOWNED-EXT|01223|drop_owned|error_assertion|reassign_owned_then_drop_role
...
DROP OWNED BY dropowned_01223_actor, dropowned_01223_actor2 CASCADE;
-- primary-target-end
