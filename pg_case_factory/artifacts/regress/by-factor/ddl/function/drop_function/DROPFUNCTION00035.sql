...
-- version      : 1.0
-- description  : DROP FUNCTION schema_dependency=schema_not_exists
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: DROPFUNCTION00035
...
-- primary_obligation_id: DROPFUNCTION-SFV|sfv-eab6706ebb05bf7d0de71626|drop_function
...
DROP FUNCTION dropfunction_00035_fn;
-- primary-target-end
...
SELECT count(*) = 0 AS function_absent FROM pg_catalog.pg_proc WHERE proname = 'dropfunction_00035_fn' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
