...
-- primary_obligation_id: DROPFUNCTION-EXT|01208|drop_function|pg_proc_catalog_query|DROP_FUNCTION_if_exists_cascade
...
DROP FUNCTION dropfunction_01208_fn(integer);
-- primary-target-end
...
SELECT count(*) = 0 AS function_absent FROM pg_catalog.pg_proc WHERE proname = 'dropfunction_01208_fn' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
