...
-- primary_obligation_id: DROPFUNCTION-EXT|00827|drop_function|information_schema_routines|DROP_FUNCTION_if_exists_cascade
...
DROP FUNCTION dropfunction_00827_fn(integer) RESTRICT;
-- primary-target-end
...
SELECT count(*) = 0 AS function_absent FROM pg_catalog.pg_proc WHERE proname = 'dropfunction_00827_fn' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
