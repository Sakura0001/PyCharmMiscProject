...
-- primary_obligation_id: DROPFUNCTION-SFV|sfv-4234f88abbd0736a4273a930|drop_function
...
DROP FUNCTION dropfunction_00027_fn(integer);
-- primary-target-end
...
SELECT count(*) = 0 AS function_absent FROM pg_catalog.pg_proc WHERE proname = 'dropfunction_00027_fn' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
