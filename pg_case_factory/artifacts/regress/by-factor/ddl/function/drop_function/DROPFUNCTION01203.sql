...
-- primary_obligation_id: DROPFUNCTION-EXT|01203|drop_function|pg_proc_catalog_query|no_cleanup_needed
...
DROP FUNCTION dropfunction_01203_fn(integer);
-- primary-target-end
...
SELECT count(*) = 0 AS function_absent FROM pg_catalog.pg_proc WHERE proname = 'dropfunction_01203_fn' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
