...
-- primary_obligation_id: AF-EXT|03027|owner|information_schema_routines|DROP_FUNCTION_CASCADE
...
ALTER FUNCTION "alterfunction_03027_select"(integer) OWNER TO CURRENT_USER;
-- primary-target-end
...
SELECT r.routine_schema, r.routine_name, r.routine_type FROM information_schema.routines AS r WHERE r.routine_name = 'alterfunction_03027_select' ORDER BY r.routine_schema, r.routine_name;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
