...
-- primary_obligation_id: AF-EXT|12422|called_on_null_input|information_schema_routines|DROP_FUNCTION_IF_EXISTS
...
ALTER FUNCTION alterfunction_12422_fn CALLED ON NULL INPUT RESTRICT;
-- primary-target-end
...
SELECT r.routine_schema, r.routine_name, r.routine_type FROM information_schema.routines AS r WHERE r.routine_name = 'alterfunction_12422_fn' ORDER BY r.routine_schema, r.routine_name;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
