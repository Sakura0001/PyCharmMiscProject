...
-- primary_obligation_id: AF-EXT|05932|set_parameter|information_schema_routines|DROP_FUNCTION
...
ALTER FUNCTION alterfunction_05932_fn(integer) SET work_mem TO 100 RESTRICT;
-- primary-target-end
...
SELECT r.routine_schema, r.routine_name, r.routine_type FROM information_schema.routines AS r WHERE r.routine_name = 'alterfunction_05932_fn' ORDER BY r.routine_schema, r.routine_name;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
