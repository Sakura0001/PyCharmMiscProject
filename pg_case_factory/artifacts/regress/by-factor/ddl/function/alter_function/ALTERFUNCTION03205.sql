...
-- primary_obligation_id: AF-EXT|03205|rename|information_schema_routines|DROP_FUNCTION
...
ALTER FUNCTION "alterfunction_03205_select"(integer) RENAME TO "alterfunction_03205_Mixed Name";
-- primary-target-end
...
SELECT r.routine_schema, r.routine_name, r.routine_type FROM information_schema.routines AS r WHERE r.routine_name = 'alterfunction_03205_select' ORDER BY r.routine_schema, r.routine_name;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
