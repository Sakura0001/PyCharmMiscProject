...
-- primary_obligation_id: AF-EXT|12394|security_definer|information_schema_routines|DROP_FUNCTION
...
ALTER FUNCTION alterfunction_12394_fn SECURITY DEFINER;
-- primary-target-end
...
SELECT r.routine_schema, r.routine_name, r.routine_type FROM information_schema.routines AS r WHERE r.routine_name = 'alterfunction_12394_fn' ORDER BY r.routine_schema, r.routine_name;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
