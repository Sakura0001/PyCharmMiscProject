...
-- primary_obligation_id: COMMENT-EXT|09893|psql_dd_command|comment_is_null_cleanup
...
COMMENT ON TABLE comment_09893_no_such_tbl IS 'short comment';
-- primary-target-end
