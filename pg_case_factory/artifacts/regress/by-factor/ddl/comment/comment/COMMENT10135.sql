...
-- primary_obligation_id: COMMENT-EXT|10135|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_10135_no_such_tbl IS 'short comment';
-- primary-target-end
