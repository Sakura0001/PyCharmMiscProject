...
-- primary_obligation_id: COMMENT-EXT|06679|shobj_description_query|drop_prerequisite_object
...
COMMENT ON TABLE comment_06679_no_such_tbl IS NULL;
-- primary-target-end
...
SELECT shobj_description('comment_06679_role'::regrole, 'pg_authid') AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
