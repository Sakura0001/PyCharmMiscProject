...
-- primary_obligation_id: COMMENT-EXT|12112|psql_dd_command|drop_prerequisite_object
...
COMMENT ON DATABASE comment_12112_db IS 'short comment';
-- primary-target-end
