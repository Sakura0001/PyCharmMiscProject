...
-- primary_obligation_id: COMMENT-EXT|04241|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON TABLESPACE comment_04241_ts IS '';
-- primary-target-end
