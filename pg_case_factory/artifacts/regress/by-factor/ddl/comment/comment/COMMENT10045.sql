...
-- primary_obligation_id: COMMENT-EXT|10045|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_10045_no_such_tbl IS 'short comment';
-- primary-target-end
