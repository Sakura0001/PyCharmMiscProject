...
-- primary_obligation_id: COMMENT-EXT|11307|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_11307_no_such_tbl IS 'short comment';
-- primary-target-end
