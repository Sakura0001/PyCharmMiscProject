...
-- primary_obligation_id: COMMENT-EXT|00835|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_00835_no_such_tbl IS '';
-- primary-target-end
