...
-- primary_obligation_id: COMMENT-EXT|10673|psql_dd_command|comment_is_null_cleanup
...
COMMENT ON TABLE comment_10673_no_such_tbl IS 'short comment';
-- primary-target-end
