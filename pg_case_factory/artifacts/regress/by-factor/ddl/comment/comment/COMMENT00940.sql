...
-- primary_obligation_id: COMMENT-EXT|00940|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_00940_no_such_tbl IS '';
-- primary-target-end
