...
-- primary_obligation_id: COMMENT-EXT|01616|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON TABLE comment_01616_no_such_tbl IS '';
-- primary-target-end
