...
-- primary_obligation_id: COMMENT-EXT|11637|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_11637_no_such_tbl IS 'short comment';
-- primary-target-end
