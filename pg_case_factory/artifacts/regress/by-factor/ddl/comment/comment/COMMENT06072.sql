...
-- primary_obligation_id: COMMENT-EXT|06072|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_06072_no_such_tbl IS NULL;
-- primary-target-end
