...
-- primary_obligation_id: COMMENT-EXT|12113|psql_dd_command|comment_is_null_cleanup
...
COMMENT ON DATABASE comment_12113_db IS 'short comment';
-- primary-target-end
