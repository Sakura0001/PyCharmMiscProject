...
-- primary_obligation_id: COMMENT-EXT|08786|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON TABLESPACE comment_08786_ts IS NULL;
-- primary-target-end
