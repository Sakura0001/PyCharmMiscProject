...
-- primary_obligation_id: COMMENT-EXT|13267|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLESPACE comment_13267_ts IS 'short comment';
-- primary-target-end
