...
-- primary_obligation_id: COMMENT-EXT|07042|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_07042_no_such_tbl IS NULL;
-- primary-target-end
