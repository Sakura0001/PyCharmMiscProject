...
-- primary_obligation_id: COMMENT-EXT|06646|col_description_query|drop_prerequisite_object
...
COMMENT ON TABLE comment_06646_no_such_tbl IS NULL;
-- primary-target-end
...
SELECT col_description('comment_06646_tbl'::regclass, 1) AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
