...
-- primary_obligation_id: COMMENT-EXT|10417|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_10417_no_such_tbl IS 'short comment';
-- primary-target-end
