...
-- primary_obligation_id: COMMENT-EXT|10253|psql_dd_command|comment_is_null_cleanup
...
COMMENT ON TABLE comment_10253_no_such_tbl IS 'short comment';
-- primary-target-end
