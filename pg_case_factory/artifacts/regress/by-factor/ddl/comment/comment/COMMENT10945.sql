...
-- primary_obligation_id: COMMENT-EXT|10945|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_10945_no_such_tbl IS 'short comment';
-- primary-target-end
