...
-- primary_obligation_id: COMMENT-EXT|06310|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_06310_no_such_tbl IS NULL;
-- primary-target-end
