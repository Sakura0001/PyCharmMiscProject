...
-- primary_obligation_id: COMMENT-EXT|00880|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_00880_no_such_tbl IS '';
-- primary-target-end
