...
-- primary_obligation_id: COMMENT-EXT|11412|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_11412_no_such_tbl IS 'short comment';
-- primary-target-end
