...
-- primary_obligation_id: COMMENT-EXT|07102|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_07102_no_such_tbl IS NULL;
-- primary-target-end
