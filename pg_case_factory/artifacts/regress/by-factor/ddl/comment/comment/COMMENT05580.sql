...
-- primary_obligation_id: COMMENT-EXT|05580|obj_description_query|cascade_drop
...
COMMENT ON TABLE comment_05580_no_such_tbl IS NULL;
-- primary-target-end
...
SELECT obj_description('comment_05580_tbl'::regclass) AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
