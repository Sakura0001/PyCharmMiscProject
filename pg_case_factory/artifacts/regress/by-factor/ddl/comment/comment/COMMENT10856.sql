...
-- primary_obligation_id: COMMENT-EXT|10856|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON TABLE comment_10856_no_such_tbl IS 'short comment';
-- primary-target-end
