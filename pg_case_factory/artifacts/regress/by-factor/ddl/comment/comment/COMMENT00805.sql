...
-- primary_obligation_id: COMMENT-EXT|00805|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_00805_no_such_tbl IS '';
-- primary-target-end
