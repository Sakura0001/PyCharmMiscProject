...
-- primary_obligation_id: COMMENT-EXT|01855|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_01855_no_such_tbl IS '';
-- primary-target-end
