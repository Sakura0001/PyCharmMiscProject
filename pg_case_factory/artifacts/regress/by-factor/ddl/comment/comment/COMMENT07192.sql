...
-- primary_obligation_id: COMMENT-EXT|07192|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_07192_no_such_tbl IS NULL;
-- primary-target-end
