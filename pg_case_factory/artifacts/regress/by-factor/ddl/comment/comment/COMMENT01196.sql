...
-- primary_obligation_id: COMMENT-EXT|01196|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON TABLE comment_01196_no_such_tbl IS '';
-- primary-target-end
