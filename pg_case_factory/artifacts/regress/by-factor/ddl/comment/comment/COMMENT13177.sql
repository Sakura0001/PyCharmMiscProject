...
-- primary_obligation_id: COMMENT-EXT|13177|psql_dd_command|drop_prerequisite_object
...
COMMENT ON SUBSCRIPTION comment_13177_sub IS 'short comment';
-- primary-target-end
