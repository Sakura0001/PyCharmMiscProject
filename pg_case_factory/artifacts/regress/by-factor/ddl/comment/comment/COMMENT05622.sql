...
-- primary_obligation_id: COMMENT-EXT|05622|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_05622_no_such_tbl IS NULL;
-- primary-target-end
