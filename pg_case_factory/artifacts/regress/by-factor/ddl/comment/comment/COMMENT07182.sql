...
-- primary_obligation_id: COMMENT-EXT|07182|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_07182_no_such_tbl IS NULL;
-- primary-target-end
