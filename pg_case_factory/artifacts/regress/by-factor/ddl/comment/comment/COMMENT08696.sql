...
-- primary_obligation_id: COMMENT-EXT|08696|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON SUBSCRIPTION comment_08696_sub IS NULL;
-- primary-target-end
