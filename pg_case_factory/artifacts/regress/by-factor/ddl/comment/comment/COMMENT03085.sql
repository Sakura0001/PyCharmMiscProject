...
-- primary_obligation_id: COMMENT-EXT|03085|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON DATABASE comment_03085_db IS '';
-- primary-target-end
