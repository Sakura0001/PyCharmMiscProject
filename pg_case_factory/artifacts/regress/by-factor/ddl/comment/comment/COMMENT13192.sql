...
-- primary_obligation_id: COMMENT-EXT|13192|psql_dd_command|drop_prerequisite_object
...
COMMENT ON SUBSCRIPTION comment_13192_sub IS 'short comment';
-- primary-target-end
