...
-- primary_obligation_id: COMMENT-EXT|07970|shobj_description_query|comment_is_null_cleanup
...
SELECT shobj_description('comment_07970_role'::regrole, 'pg_authid') AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT lo_unlink(16399);
