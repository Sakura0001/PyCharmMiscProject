...
-- primary_obligation_id: COMMENT-EXT|07195|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_07195_no_such_tbl IS NULL;
-- primary-target-end
