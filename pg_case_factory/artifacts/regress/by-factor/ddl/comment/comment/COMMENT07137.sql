...
-- primary_obligation_id: COMMENT-EXT|07137|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_07137_no_such_tbl IS NULL;
-- primary-target-end
