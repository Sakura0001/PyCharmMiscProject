...
-- primary_obligation_id: COMMENT-EXT|01263|col_description_query|cascade_drop
...
COMMENT ON TABLE comment_01263_no_such_tbl IS '';
-- primary-target-end
...
SELECT col_description('comment_01263_tbl'::regclass, 1) AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
