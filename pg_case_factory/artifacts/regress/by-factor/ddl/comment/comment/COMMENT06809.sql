...
-- primary_obligation_id: COMMENT-EXT|06809|obj_description_query|comment_is_null_cleanup
...
COMMENT ON TABLE comment_06809_no_such_tbl IS NULL;
-- primary-target-end
...
SELECT obj_description('comment_06809_tbl'::regclass) AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
