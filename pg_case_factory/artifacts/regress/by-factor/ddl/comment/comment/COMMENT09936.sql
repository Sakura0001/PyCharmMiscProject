...
-- primary_obligation_id: COMMENT-EXT|09936|shobj_description_query|cascade_drop
...
COMMENT ON TABLE comment_09936_no_such_tbl IS 'short comment';
-- primary-target-end
...
SELECT shobj_description('comment_09936_role'::regrole, 'pg_authid') AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
