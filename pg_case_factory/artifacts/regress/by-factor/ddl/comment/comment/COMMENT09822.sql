...
-- primary_obligation_id: COMMENT-EXT|09822|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_09822_no_such_tbl IS 'short comment';
-- primary-target-end
