...
-- primary_obligation_id: COMMENT-EXT|10987|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_10987_no_such_tbl IS 'short comment';
-- primary-target-end
