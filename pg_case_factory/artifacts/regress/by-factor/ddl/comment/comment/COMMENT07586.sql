...
-- primary_obligation_id: COMMENT-EXT|07586|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON DATABASE comment_07586_db IS NULL;
-- primary-target-end
