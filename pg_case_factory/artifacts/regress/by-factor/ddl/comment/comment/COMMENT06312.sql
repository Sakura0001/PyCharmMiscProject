...
-- primary_obligation_id: COMMENT-EXT|06312|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_06312_no_such_tbl IS NULL;
-- primary-target-end
