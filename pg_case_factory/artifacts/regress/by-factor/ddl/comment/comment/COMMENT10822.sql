...
-- primary_obligation_id: COMMENT-EXT|10822|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_10822_no_such_tbl IS 'short comment';
-- primary-target-end
