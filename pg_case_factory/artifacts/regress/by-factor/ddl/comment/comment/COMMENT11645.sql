...
-- primary_obligation_id: COMMENT-EXT|11645|shobj_description_query|comment_is_null_cleanup
...
COMMENT ON TABLE comment_11645_no_such_tbl IS 'short comment';
-- primary-target-end
...
SELECT shobj_description('comment_11645_role'::regrole, 'pg_authid') AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
