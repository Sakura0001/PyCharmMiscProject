...
-- primary_obligation_id: COMMENT-EXT|10113|col_description_query|cascade_drop
...
COMMENT ON TABLE comment_10113_no_such_tbl IS 'short comment';
-- primary-target-end
...
SELECT col_description('comment_10113_tbl'::regclass, 1) AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
