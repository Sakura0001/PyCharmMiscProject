...
-- primary_obligation_id: COMMENT-EXT|01990|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_01990_no_such_tbl IS '';
-- primary-target-end
