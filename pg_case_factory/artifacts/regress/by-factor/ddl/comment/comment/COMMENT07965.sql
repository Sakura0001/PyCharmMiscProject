...
-- primary_obligation_id: COMMENT-EXT|07965|obj_description_query|cascade_drop
...
SELECT obj_description('comment_07965_tbl'::regclass) AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT lo_unlink(16399);
