...
-- primary_obligation_id: COMMENT-EXT|07952|col_description_query|comment_is_null_cleanup
...
SELECT col_description('comment_07952_tbl'::regclass, 1) AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT lo_unlink(16399);
