...
-- primary_obligation_id: COMMENT-EXT|04255|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLESPACE comment_04255_ts IS '';
-- primary-target-end
