...
-- primary_obligation_id: COMMENT-EXT|11558|psql_dd_command|comment_is_null_cleanup
...
COMMENT ON TABLE comment_11558_no_such_tbl IS 'short comment';
-- primary-target-end
