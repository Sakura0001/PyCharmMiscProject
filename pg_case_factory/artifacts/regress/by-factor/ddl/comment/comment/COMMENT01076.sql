...
-- primary_obligation_id: COMMENT-EXT|01076|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON TABLE comment_01076_no_such_tbl IS '';
-- primary-target-end
