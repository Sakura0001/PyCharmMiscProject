...
-- primary_obligation_id: COMMENT-EXT|09743|psql_dd_command|comment_is_null_cleanup
-- expected_outcome: expected_failure
-- expected_sqlstate: 42501
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TYPE IF EXISTS comment_09743_typ;
DROP OWNED BY comment_09743_actor CASCADE;
DROP ROLE IF EXISTS comment_09743_actor;
\set ON_ERROR_STOP on
-- 2. 创建完整本地规则和因子专用夹具。
CREATE ROLE comment_09743_actor LOGIN NOSUPERUSER;
CREATE TYPE comment_09743_typ AS (x int);
SET ROLE comment_09743_actor;
