...
-- primary_obligation_id: COMMENT-EXT|07601|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON DATABASE comment_07601_db IS NULL;
-- primary-target-end
