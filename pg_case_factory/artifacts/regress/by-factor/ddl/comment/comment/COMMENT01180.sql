...
-- primary_obligation_id: COMMENT-EXT|01180|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_01180_no_such_tbl IS '';
-- primary-target-end
