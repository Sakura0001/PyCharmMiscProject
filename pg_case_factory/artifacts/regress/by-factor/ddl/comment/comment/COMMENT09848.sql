...
-- primary_obligation_id: COMMENT-EXT|09848|psql_dd_command|comment_is_null_cleanup
...
COMMENT ON TABLE comment_09848_no_such_tbl IS 'short comment';
-- primary-target-end
