...
-- primary_obligation_id: COMMENT-EXT|04180|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON SUBSCRIPTION comment_04180_sub IS '';
-- primary-target-end
