...
-- primary_obligation_id: COMMENT-EXT|08755|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLESPACE comment_08755_ts IS NULL;
-- primary-target-end
