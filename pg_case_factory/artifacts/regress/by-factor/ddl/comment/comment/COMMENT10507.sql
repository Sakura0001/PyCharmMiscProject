...
-- primary_obligation_id: COMMENT-EXT|10507|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_10507_no_such_tbl IS 'short comment';
-- primary-target-end
