...
-- primary_obligation_id: COMMENT-EXT|07963|obj_description_query|drop_prerequisite_object
...
SELECT obj_description('comment_07963_tbl'::regclass) AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT lo_unlink(16399);
