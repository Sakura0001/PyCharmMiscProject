...
-- primary_obligation_id: COMMENT-EXT|04270|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLESPACE comment_04270_ts IS '';
-- primary-target-end
