...
-- primary_obligation_id: COMMENT-EXT|11262|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_11262_no_such_tbl IS 'short comment';
-- primary-target-end
