...
-- primary_obligation_id: COMMENT-EXT|08667|catalog_query_pg_description|cascade_drop
...
COMMENT ON SUBSCRIPTION comment_08667_sub IS NULL;
-- primary-target-end
