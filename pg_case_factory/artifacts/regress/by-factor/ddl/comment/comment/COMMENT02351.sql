...
-- primary_obligation_id: COMMENT-EXT|02351|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON TABLE comment_02351_no_such_tbl IS '';
-- primary-target-end
