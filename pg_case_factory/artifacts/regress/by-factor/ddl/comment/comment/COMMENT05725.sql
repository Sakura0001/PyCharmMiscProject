...
-- primary_obligation_id: COMMENT-EXT|05725|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_05725_no_such_tbl IS NULL;
-- primary-target-end
