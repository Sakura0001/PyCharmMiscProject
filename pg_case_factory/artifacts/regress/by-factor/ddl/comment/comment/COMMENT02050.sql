...
-- primary_obligation_id: COMMENT-EXT|02050|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_02050_no_such_tbl IS '';
-- primary-target-end
