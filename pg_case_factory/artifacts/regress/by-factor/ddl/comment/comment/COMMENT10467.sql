...
-- primary_obligation_id: COMMENT-EXT|10467|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_10467_no_such_tbl IS 'short comment';
-- primary-target-end
