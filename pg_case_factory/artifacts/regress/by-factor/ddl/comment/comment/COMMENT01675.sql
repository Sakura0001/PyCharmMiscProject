...
-- primary_obligation_id: COMMENT-EXT|01675|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_01675_no_such_tbl IS '';
-- primary-target-end
