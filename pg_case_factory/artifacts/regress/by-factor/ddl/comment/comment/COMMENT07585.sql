...
-- primary_obligation_id: COMMENT-EXT|07585|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON DATABASE comment_07585_db IS NULL;
-- primary-target-end
