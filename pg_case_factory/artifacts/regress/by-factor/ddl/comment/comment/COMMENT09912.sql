...
-- primary_obligation_id: COMMENT-EXT|09912|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_09912_no_such_tbl IS 'short comment';
-- primary-target-end
