...
-- primary_obligation_id: COMMENT-EXT|06727|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_06727_no_such_tbl IS NULL;
-- primary-target-end
