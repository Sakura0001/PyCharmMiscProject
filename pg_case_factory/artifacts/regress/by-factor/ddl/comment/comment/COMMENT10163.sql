...
-- primary_obligation_id: COMMENT-EXT|10163|psql_dd_command|comment_is_null_cleanup
...
COMMENT ON TABLE comment_10163_no_such_tbl IS 'short comment';
-- primary-target-end
