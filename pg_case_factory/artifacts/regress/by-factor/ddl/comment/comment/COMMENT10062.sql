...
-- primary_obligation_id: COMMENT-EXT|10062|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_10062_no_such_tbl IS 'short comment';
-- primary-target-end
