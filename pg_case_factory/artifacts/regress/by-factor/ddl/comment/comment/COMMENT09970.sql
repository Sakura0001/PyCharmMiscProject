...
-- primary_obligation_id: COMMENT-EXT|09970|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_09970_no_such_tbl IS 'short comment';
-- primary-target-end
