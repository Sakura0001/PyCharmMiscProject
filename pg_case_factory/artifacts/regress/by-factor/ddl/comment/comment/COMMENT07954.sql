...
-- primary_obligation_id: COMMENT-EXT|07954|shobj_description_query|drop_prerequisite_object
...
SELECT shobj_description('comment_07954_role'::regrole, 'pg_authid') AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT lo_unlink(16399);
