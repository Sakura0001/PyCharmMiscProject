...
-- primary_obligation_id: COMMENT-EXT|07092|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_07092_no_such_tbl IS NULL;
-- primary-target-end
