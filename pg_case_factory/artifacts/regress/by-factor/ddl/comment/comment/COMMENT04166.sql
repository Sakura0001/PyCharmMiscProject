...
-- primary_obligation_id: COMMENT-EXT|04166|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON SUBSCRIPTION comment_04166_sub IS '';
-- primary-target-end
