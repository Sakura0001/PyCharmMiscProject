...
-- primary_obligation_id: COMMENT-EXT|07197|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_07197_no_such_tbl IS NULL;
-- primary-target-end
