...
-- primary_obligation_id: COMMENT-EXT|07616|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON DATABASE comment_07616_db IS NULL;
-- primary-target-end
