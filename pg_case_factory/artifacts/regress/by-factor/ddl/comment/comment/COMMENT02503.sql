...
-- primary_obligation_id: COMMENT-EXT|02503|obj_description_query|drop_prerequisite_object
...
COMMENT ON TABLE comment_02503_no_such_tbl IS '';
-- primary-target-end
...
SELECT obj_description('comment_02503_tbl'::regclass) AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
