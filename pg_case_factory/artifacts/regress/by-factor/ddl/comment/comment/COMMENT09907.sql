...
-- primary_obligation_id: COMMENT-EXT|09907|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_09907_no_such_tbl IS 'short comment';
-- primary-target-end
