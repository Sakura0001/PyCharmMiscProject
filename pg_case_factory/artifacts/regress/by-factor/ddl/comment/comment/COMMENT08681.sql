...
-- primary_obligation_id: COMMENT-EXT|08681|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON SUBSCRIPTION comment_08681_sub IS NULL;
-- primary-target-end
