...
-- primary_obligation_id: COMMENT-EXT|09987|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_09987_no_such_tbl IS 'short comment';
-- primary-target-end
