...
-- primary_obligation_id: COMMENT-EXT|07941|shobj_description_query|cascade_drop
...
SELECT shobj_description('comment_07941_role'::regrole, 'pg_authid') AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT lo_unlink(16399);
