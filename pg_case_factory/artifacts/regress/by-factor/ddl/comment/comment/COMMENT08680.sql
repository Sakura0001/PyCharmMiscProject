...
-- primary_obligation_id: COMMENT-EXT|08680|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON SUBSCRIPTION comment_08680_sub IS NULL;
-- primary-target-end
