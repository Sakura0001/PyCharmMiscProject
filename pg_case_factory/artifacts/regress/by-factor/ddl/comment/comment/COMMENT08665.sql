...
-- primary_obligation_id: COMMENT-EXT|08665|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON SUBSCRIPTION comment_08665_sub IS NULL;
-- primary-target-end
