...
-- primary_obligation_id: COMMENT-EXT|00775|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_00775_no_such_tbl IS '';
-- primary-target-end
