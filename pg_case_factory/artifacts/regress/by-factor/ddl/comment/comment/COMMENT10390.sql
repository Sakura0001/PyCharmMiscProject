...
-- primary_obligation_id: COMMENT-EXT|10390|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_10390_no_such_tbl IS 'short comment';
-- primary-target-end
