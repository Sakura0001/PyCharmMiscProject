...
-- primary_obligation_id: COMMENT-EXT|10943|psql_dd_command|comment_is_null_cleanup
...
COMMENT ON TABLE comment_10943_no_such_tbl IS 'short comment';
-- primary-target-end
