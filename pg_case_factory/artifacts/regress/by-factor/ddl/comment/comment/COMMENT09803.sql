...
-- primary_obligation_id: COMMENT-EXT|09803|psql_dd_command|comment_is_null_cleanup
...
COMMENT ON TABLE comment_09803_no_such_tbl IS 'short comment';
-- primary-target-end
