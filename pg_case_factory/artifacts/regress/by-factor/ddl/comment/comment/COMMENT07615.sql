...
-- primary_obligation_id: COMMENT-EXT|07615|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON DATABASE comment_07615_db IS NULL;
-- primary-target-end
