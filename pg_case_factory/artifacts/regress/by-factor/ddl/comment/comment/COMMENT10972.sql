...
-- primary_obligation_id: COMMENT-EXT|10972|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_10972_no_such_tbl IS 'short comment';
-- primary-target-end
