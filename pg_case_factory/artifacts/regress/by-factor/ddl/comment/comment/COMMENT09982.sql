...
-- primary_obligation_id: COMMENT-EXT|09982|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_09982_no_such_tbl IS 'short comment';
-- primary-target-end
