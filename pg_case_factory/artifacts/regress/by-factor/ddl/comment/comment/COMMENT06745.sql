...
-- primary_obligation_id: COMMENT-EXT|06745|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_06745_no_such_tbl IS NULL;
-- primary-target-end
