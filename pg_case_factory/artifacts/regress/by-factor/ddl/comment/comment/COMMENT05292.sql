...
-- primary_obligation_id: COMMENT-EXT|05292|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_05292_no_such_tbl IS NULL;
-- primary-target-end
