...
-- primary_obligation_id: COMMENT-EXT|10362|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_10362_no_such_tbl IS 'short comment';
-- primary-target-end
