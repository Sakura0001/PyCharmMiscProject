...
-- primary_obligation_id: COMMENT-EXT|07951|col_description_query|drop_prerequisite_object
...
SELECT col_description('comment_07951_tbl'::regclass, 1) AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT lo_unlink(16399);
