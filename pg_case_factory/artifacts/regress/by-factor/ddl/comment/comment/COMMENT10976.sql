...
-- primary_obligation_id: COMMENT-EXT|10976|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON TABLE comment_10976_no_such_tbl IS 'short comment';
-- primary-target-end
