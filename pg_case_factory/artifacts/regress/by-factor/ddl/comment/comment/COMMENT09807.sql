...
-- primary_obligation_id: COMMENT-EXT|09807|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_09807_no_such_tbl IS 'short comment';
-- primary-target-end
