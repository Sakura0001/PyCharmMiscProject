...
-- primary_obligation_id: COMMENT-EXT|10302|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_10302_no_such_tbl IS 'short comment';
-- primary-target-end
