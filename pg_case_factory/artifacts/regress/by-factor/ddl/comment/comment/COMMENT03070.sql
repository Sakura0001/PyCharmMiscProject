...
-- primary_obligation_id: COMMENT-EXT|03070|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON DATABASE comment_03070_db IS '';
-- primary-target-end
