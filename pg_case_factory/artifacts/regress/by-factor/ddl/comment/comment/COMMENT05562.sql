...
-- primary_obligation_id: COMMENT-EXT|05562|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_05562_no_such_tbl IS NULL;
-- primary-target-end
