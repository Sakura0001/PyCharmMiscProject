...
-- primary_obligation_id: COMMENT-EXT|01960|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_01960_no_such_tbl IS '';
-- primary-target-end
