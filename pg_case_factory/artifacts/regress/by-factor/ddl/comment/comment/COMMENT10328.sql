...
-- primary_obligation_id: COMMENT-EXT|10328|psql_dd_command|comment_is_null_cleanup
...
COMMENT ON TABLE comment_10328_no_such_tbl IS 'short comment';
-- primary-target-end
