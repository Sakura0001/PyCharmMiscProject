...
-- primary_obligation_id: COMMENT-EXT|10357|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_10357_no_such_tbl IS 'short comment';
-- primary-target-end
