...
-- primary_obligation_id: COMMENT-EXT|12097|psql_dd_command|drop_prerequisite_object
...
COMMENT ON DATABASE comment_12097_db IS 'short comment';
-- primary-target-end
