...
-- primary_obligation_id: COMMENT-EXT|10917|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_10917_no_such_tbl IS 'short comment';
-- primary-target-end
