...
-- primary_obligation_id: COMMENT-EXT|13208|psql_dd_command|comment_is_null_cleanup
...
COMMENT ON SUBSCRIPTION comment_13208_sub IS 'short comment';
-- primary-target-end
