...
-- primary_obligation_id: COMMENT-EXT|03420|obj_description_query|cascade_drop
...
SELECT obj_description('comment_03420_tbl'::regclass) AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT lo_unlink(16399);
