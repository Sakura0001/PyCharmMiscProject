...
-- primary_obligation_id: COMMENT-EXT|02530|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_02530_no_such_tbl IS '';
-- primary-target-end
