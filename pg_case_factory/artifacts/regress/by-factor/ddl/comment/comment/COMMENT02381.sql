...
-- primary_obligation_id: COMMENT-EXT|02381|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON TABLE comment_02381_no_such_tbl IS '';
-- primary-target-end
