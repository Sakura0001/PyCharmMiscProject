...
-- primary_obligation_id: COMMENT-EXT|06607|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_06607_no_such_tbl IS NULL;
-- primary-target-end
