...
-- primary_obligation_id: COMMENT-EXT|05380|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_05380_no_such_tbl IS NULL;
-- primary-target-end
