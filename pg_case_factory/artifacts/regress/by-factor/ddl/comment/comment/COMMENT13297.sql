...
-- primary_obligation_id: COMMENT-EXT|13297|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLESPACE comment_13297_ts IS 'short comment';
-- primary-target-end
