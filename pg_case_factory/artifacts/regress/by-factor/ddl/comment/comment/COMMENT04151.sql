...
-- primary_obligation_id: COMMENT-EXT|04151|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON SUBSCRIPTION comment_04151_sub IS '';
-- primary-target-end
