...
-- primary_obligation_id: COMMENT-EXT|10432|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_10432_no_such_tbl IS 'short comment';
-- primary-target-end
