...
-- primary_obligation_id: COMMENT-EXT|07934|obj_description_query|comment_is_null_cleanup
...
SELECT obj_description('comment_07934_tbl'::regclass) AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT lo_unlink(16399);
