...
-- primary_obligation_id: COMMENT-EXT|03435|obj_description_query|cascade_drop
...
SELECT obj_description('comment_03435_tbl'::regclass) AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT lo_unlink(16399);
