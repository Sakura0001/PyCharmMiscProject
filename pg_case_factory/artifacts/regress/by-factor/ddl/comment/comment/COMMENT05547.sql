...
-- primary_obligation_id: COMMENT-EXT|05547|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_05547_no_such_tbl IS NULL;
-- primary-target-end
