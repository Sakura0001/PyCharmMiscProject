...
-- primary_obligation_id: COMMENT-EXT|03101|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON DATABASE comment_03101_db IS '';
-- primary-target-end
