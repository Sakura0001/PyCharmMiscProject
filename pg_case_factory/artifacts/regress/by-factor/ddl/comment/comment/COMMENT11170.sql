...
-- primary_obligation_id: COMMENT-EXT|11170|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_11170_no_such_tbl IS 'short comment';
-- primary-target-end
