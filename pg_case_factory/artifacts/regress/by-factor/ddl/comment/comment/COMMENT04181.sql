...
-- primary_obligation_id: COMMENT-EXT|04181|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON SUBSCRIPTION comment_04181_sub IS '';
-- primary-target-end
