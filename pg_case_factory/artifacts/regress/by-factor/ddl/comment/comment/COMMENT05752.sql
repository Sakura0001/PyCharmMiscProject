...
-- primary_obligation_id: COMMENT-EXT|05752|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_05752_no_such_tbl IS NULL;
-- primary-target-end
