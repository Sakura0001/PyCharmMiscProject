...
-- primary_obligation_id: COMMENT-EXT|11382|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_11382_no_such_tbl IS 'short comment';
-- primary-target-end
