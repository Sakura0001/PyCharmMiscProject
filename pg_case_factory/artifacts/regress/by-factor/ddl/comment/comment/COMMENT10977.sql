...
-- primary_obligation_id: COMMENT-EXT|10977|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_10977_no_such_tbl IS 'short comment';
-- primary-target-end
