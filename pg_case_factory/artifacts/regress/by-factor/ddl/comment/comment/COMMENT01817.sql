...
-- primary_obligation_id: COMMENT-EXT|01817|col_description_query|comment_is_null_cleanup
...
COMMENT ON TABLE comment_01817_no_such_tbl IS '';
-- primary-target-end
...
SELECT col_description('comment_01817_tbl'::regclass, 1) AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
