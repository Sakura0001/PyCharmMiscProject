...
-- primary_obligation_id: COMMENT-EXT|13207|psql_dd_command|drop_prerequisite_object
...
COMMENT ON SUBSCRIPTION comment_13207_sub IS 'short comment';
-- primary-target-end
