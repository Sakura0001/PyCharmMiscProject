...
-- primary_obligation_id: COMMENT-EXT|05457|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_05457_no_such_tbl IS NULL;
-- primary-target-end
