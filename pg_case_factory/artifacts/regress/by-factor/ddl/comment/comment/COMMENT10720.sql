...
-- primary_obligation_id: COMMENT-EXT|10720|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_10720_no_such_tbl IS 'short comment';
-- primary-target-end
