...
-- primary_obligation_id: COMMENT-EXT|08756|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON TABLESPACE comment_08756_ts IS NULL;
-- primary-target-end
