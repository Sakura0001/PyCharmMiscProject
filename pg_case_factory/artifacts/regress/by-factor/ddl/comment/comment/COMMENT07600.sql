...
-- primary_obligation_id: COMMENT-EXT|07600|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON DATABASE comment_07600_db IS NULL;
-- primary-target-end
