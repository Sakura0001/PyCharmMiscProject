...
-- primary_obligation_id: COMMENT-EXT|11261|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON TABLE comment_11261_no_such_tbl IS 'short comment';
-- primary-target-end
