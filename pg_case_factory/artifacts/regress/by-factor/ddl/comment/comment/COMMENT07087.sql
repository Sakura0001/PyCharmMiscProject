...
-- primary_obligation_id: COMMENT-EXT|07087|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_07087_no_such_tbl IS NULL;
-- primary-target-end
