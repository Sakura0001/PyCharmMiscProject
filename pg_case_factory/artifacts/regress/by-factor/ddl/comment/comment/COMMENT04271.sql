...
-- primary_obligation_id: COMMENT-EXT|04271|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON TABLESPACE comment_04271_ts IS '';
-- primary-target-end
