...
-- primary_obligation_id: COMMENT-EXT|08770|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLESPACE comment_08770_ts IS NULL;
-- primary-target-end
