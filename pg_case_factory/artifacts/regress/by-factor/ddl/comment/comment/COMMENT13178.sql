...
-- primary_obligation_id: COMMENT-EXT|13178|psql_dd_command|comment_is_null_cleanup
...
COMMENT ON SUBSCRIPTION comment_13178_sub IS 'short comment';
-- primary-target-end
