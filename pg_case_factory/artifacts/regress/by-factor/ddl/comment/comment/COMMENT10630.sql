...
-- primary_obligation_id: COMMENT-EXT|10630|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_10630_no_such_tbl IS 'short comment';
-- primary-target-end
