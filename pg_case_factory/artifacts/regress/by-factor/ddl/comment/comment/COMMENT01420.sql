...
-- primary_obligation_id: COMMENT-EXT|01420|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_01420_no_such_tbl IS '';
-- primary-target-end
