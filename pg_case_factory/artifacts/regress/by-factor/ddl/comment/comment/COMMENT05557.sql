...
-- primary_obligation_id: COMMENT-EXT|05557|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_05557_no_such_tbl IS NULL;
-- primary-target-end
