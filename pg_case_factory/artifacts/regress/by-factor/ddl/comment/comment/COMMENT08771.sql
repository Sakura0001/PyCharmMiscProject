...
-- primary_obligation_id: COMMENT-EXT|08771|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON TABLESPACE comment_08771_ts IS NULL;
-- primary-target-end
