...
-- primary_obligation_id: COMMENT-EXT|06672|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_06672_no_such_tbl IS NULL;
-- primary-target-end
