...
-- primary_obligation_id: COMMENT-EXT|11666|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON TABLE comment_11666_no_such_tbl IS 'short comment';
-- primary-target-end
