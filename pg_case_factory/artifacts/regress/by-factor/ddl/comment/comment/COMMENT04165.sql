...
-- primary_obligation_id: COMMENT-EXT|04165|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON SUBSCRIPTION comment_04165_sub IS '';
-- primary-target-end
