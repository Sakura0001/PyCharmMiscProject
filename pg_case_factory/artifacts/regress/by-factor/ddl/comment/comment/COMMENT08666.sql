...
-- primary_obligation_id: COMMENT-EXT|08666|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON SUBSCRIPTION comment_08666_sub IS NULL;
-- primary-target-end
