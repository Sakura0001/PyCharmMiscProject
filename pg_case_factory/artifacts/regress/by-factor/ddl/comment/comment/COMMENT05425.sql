...
-- primary_obligation_id: COMMENT-EXT|05425|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_05425_no_such_tbl IS NULL;
-- primary-target-end
