...
-- primary_obligation_id: COMMENT-EXT|06626|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON TABLE comment_06626_no_such_tbl IS NULL;
-- primary-target-end
