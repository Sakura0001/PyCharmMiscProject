...
-- primary_obligation_id: COMMENT-EXT|11397|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_11397_no_such_tbl IS 'short comment';
-- primary-target-end
