...
-- primary_obligation_id: COMMENT-EXT|03198|col_description_query|cascade_drop
...
SELECT col_description('comment_03198_tbl'::regclass, 1) AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
