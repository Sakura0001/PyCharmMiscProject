...
-- primary_obligation_id: COMMENT-EXT|11520|obj_description_query|cascade_drop
...
COMMENT ON TABLE comment_11520_no_such_tbl IS 'short comment';
-- primary-target-end
...
SELECT obj_description('comment_11520_tbl'::regclass) AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
