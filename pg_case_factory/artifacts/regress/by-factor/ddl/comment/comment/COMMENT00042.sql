...
-- primary_obligation_id: COMMENT-SFV|sfv-6b77cdc330c7a5ea24f7f056|table
...
COMMENT ON TABLE comment_00042_no_such_tbl IS 'short comment';
-- primary-target-end
...
SELECT obj_description('comment_00042_tbl'::regclass) AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
