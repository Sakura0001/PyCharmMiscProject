...
-- primary_obligation_id: COMMENT-EXT|08697|catalog_query_pg_description|cascade_drop
...
COMMENT ON SUBSCRIPTION comment_08697_sub IS NULL;
-- primary-target-end
