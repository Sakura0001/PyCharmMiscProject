...
-- primary_obligation_id: COMMENT-EXT|10948|obj_description_query|drop_prerequisite_object
...
COMMENT ON TABLE comment_10948_no_such_tbl IS 'short comment';
-- primary-target-end
...
SELECT obj_description('comment_10948_tbl'::regclass) AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
