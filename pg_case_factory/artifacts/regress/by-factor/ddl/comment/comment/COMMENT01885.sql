...
-- primary_obligation_id: COMMENT-EXT|01885|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_01885_no_such_tbl IS '';
-- primary-target-end
