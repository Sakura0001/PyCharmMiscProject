...
-- primary_obligation_id: COMMENT-EXT|07162|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_07162_no_such_tbl IS NULL;
-- primary-target-end
