...
-- primary_obligation_id: COMMENT-EXT|09837|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_09837_no_such_tbl IS 'short comment';
-- primary-target-end
