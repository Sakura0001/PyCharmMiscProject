...
-- primary_obligation_id: COMMENT-EXT|06172|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_06172_no_such_tbl IS NULL;
-- primary-target-end
