...
-- primary_obligation_id: COMMENT-EXT|11125|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_11125_no_such_tbl IS 'short comment';
-- primary-target-end
