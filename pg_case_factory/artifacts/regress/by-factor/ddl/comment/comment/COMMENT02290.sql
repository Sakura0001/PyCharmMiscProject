...
-- primary_obligation_id: COMMENT-EXT|02290|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_02290_no_such_tbl IS '';
-- primary-target-end
