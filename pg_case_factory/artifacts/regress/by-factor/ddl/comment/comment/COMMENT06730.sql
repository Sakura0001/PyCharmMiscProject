...
-- primary_obligation_id: COMMENT-EXT|06730|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_06730_no_such_tbl IS NULL;
-- primary-target-end
