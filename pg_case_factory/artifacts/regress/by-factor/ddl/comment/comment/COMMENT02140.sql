...
-- primary_obligation_id: COMMENT-EXT|02140|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_02140_no_such_tbl IS '';
-- primary-target-end
