...
-- primary_obligation_id: COMMENT-EXT|03100|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON DATABASE comment_03100_db IS '';
-- primary-target-end
