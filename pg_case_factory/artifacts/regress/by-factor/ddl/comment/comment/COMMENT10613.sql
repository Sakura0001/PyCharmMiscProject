...
-- primary_obligation_id: COMMENT-EXT|10613|psql_dd_command|comment_is_null_cleanup
...
COMMENT ON TABLE comment_10613_no_such_tbl IS 'short comment';
-- primary-target-end
