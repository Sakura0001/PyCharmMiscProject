...
-- primary_obligation_id: COMMENT-EXT|00985|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_00985_no_such_tbl IS '';
-- primary-target-end
