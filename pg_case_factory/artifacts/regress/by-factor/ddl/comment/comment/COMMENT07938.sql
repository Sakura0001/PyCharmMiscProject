...
-- primary_obligation_id: COMMENT-EXT|07938|col_description_query|cascade_drop
...
SELECT col_description('comment_07938_tbl'::regclass, 1) AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT lo_unlink(16399);
