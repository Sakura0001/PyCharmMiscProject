...
-- primary_obligation_id: COMMENT-EXT|04256|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON TABLESPACE comment_04256_ts IS '';
-- primary-target-end
