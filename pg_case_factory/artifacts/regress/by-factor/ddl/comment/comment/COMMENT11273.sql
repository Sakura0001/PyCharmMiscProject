...
-- primary_obligation_id: COMMENT-EXT|11273|psql_dd_command|comment_is_null_cleanup
...
COMMENT ON TABLE comment_11273_no_such_tbl IS 'short comment';
-- primary-target-end
