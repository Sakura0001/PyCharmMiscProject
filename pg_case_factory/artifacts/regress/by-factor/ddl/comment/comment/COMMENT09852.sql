...
-- primary_obligation_id: COMMENT-EXT|09852|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_09852_no_such_tbl IS 'short comment';
-- primary-target-end
