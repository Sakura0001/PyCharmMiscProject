...
-- primary_obligation_id: COMMENT-EXT|13193|psql_dd_command|comment_is_null_cleanup
...
COMMENT ON SUBSCRIPTION comment_13193_sub IS 'short comment';
-- primary-target-end
