...
-- primary_obligation_id: COMMENT-EXT|11111|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON TABLE comment_11111_no_such_tbl IS 'short comment';
-- primary-target-end
