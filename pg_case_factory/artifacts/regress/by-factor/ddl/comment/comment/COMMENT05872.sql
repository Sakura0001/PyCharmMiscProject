...
-- primary_obligation_id: COMMENT-EXT|05872|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_05872_no_such_tbl IS NULL;
-- primary-target-end
