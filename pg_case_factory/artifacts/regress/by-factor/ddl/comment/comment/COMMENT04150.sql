...
-- primary_obligation_id: COMMENT-EXT|04150|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON SUBSCRIPTION comment_04150_sub IS '';
-- primary-target-end
