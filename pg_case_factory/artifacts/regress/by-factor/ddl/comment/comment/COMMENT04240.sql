...
-- primary_obligation_id: COMMENT-EXT|04240|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLESPACE comment_04240_ts IS '';
-- primary-target-end
