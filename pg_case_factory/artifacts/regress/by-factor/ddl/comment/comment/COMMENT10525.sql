...
-- primary_obligation_id: COMMENT-EXT|10525|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_10525_no_such_tbl IS 'short comment';
-- primary-target-end
