...
-- primary_obligation_id: COMMENT-EXT|05506|col_description_query|drop_prerequisite_object
...
COMMENT ON TABLE comment_05506_no_such_tbl IS NULL;
-- primary-target-end
...
SELECT col_description('comment_05506_tbl'::regclass, 1) AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
