...
-- primary_obligation_id: COMMENT-EXT|02260|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_02260_no_such_tbl IS '';
-- primary-target-end
