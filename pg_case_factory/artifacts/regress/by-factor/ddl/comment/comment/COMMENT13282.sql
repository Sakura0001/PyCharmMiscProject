...
-- primary_obligation_id: COMMENT-EXT|13282|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLESPACE comment_13282_ts IS 'short comment';
-- primary-target-end
