...
-- primary_obligation_id: COMMENT-EXT|12098|psql_dd_command|comment_is_null_cleanup
...
COMMENT ON DATABASE comment_12098_db IS 'short comment';
-- primary-target-end
