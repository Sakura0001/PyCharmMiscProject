...
-- primary_obligation_id: COMMENT-EXT|05682|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_05682_no_such_tbl IS NULL;
-- primary-target-end
