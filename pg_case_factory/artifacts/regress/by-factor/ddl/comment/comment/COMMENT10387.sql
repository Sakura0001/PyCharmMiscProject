...
-- primary_obligation_id: COMMENT-EXT|10387|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_10387_no_such_tbl IS 'short comment';
-- primary-target-end
