...
-- primary_obligation_id: COMMENT-EXT|10208|psql_dd_command|comment_is_null_cleanup
...
COMMENT ON TABLE comment_10208_no_such_tbl IS 'short comment';
-- primary-target-end
