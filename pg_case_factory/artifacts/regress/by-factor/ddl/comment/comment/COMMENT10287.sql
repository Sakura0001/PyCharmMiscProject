...
-- primary_obligation_id: COMMENT-EXT|10287|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_10287_no_such_tbl IS 'short comment';
-- primary-target-end
