...
-- primary_obligation_id: COMMENT-EXT|11183|psql_dd_command|comment_is_null_cleanup
...
COMMENT ON TABLE comment_11183_no_such_tbl IS 'short comment';
-- primary-target-end
