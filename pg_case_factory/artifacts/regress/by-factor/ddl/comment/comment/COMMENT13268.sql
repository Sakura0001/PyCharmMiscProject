...
-- primary_obligation_id: COMMENT-EXT|13268|psql_dd_command|comment_is_null_cleanup
...
COMMENT ON TABLESPACE comment_13268_ts IS 'short comment';
-- primary-target-end
