...
-- primary_obligation_id: COMMENT-EXT|10657|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_10657_no_such_tbl IS 'short comment';
-- primary-target-end
