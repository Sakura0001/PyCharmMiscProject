...
-- primary_obligation_id: COMMENT-EXT|05317|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_05317_no_such_tbl IS NULL;
-- primary-target-end
