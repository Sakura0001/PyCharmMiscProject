...
-- primary_obligation_id: COMMENT-EXT|10342|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_10342_no_such_tbl IS 'short comment';
-- primary-target-end
