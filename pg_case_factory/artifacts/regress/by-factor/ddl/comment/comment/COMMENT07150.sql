...
-- primary_obligation_id: COMMENT-EXT|07150|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_07150_no_such_tbl IS NULL;
-- primary-target-end
