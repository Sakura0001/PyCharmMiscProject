...
-- primary_obligation_id: COMMENT-EXT|02605|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_02605_no_such_tbl IS '';
-- primary-target-end
