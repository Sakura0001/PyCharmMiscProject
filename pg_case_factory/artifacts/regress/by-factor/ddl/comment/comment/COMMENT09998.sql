...
-- primary_obligation_id: COMMENT-EXT|09998|psql_dd_command|comment_is_null_cleanup
...
COMMENT ON TABLE comment_09998_no_such_tbl IS 'short comment';
-- primary-target-end
