...
-- primary_obligation_id: COMMENT-EXT|05967|catalog_query_pg_description|cascade_drop
...
COMMENT ON TABLE comment_05967_no_such_tbl IS NULL;
-- primary-target-end
