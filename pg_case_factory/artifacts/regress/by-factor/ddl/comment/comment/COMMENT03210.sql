...
-- primary_obligation_id: COMMENT-EXT|03210|obj_description_query|cascade_drop
...
SELECT obj_description('comment_03210_tbl'::regclass) AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
