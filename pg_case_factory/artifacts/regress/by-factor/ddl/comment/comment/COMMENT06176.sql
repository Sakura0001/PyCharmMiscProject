...
-- primary_obligation_id: COMMENT-EXT|06176|catalog_query_pg_description|comment_is_null_cleanup
...
COMMENT ON TABLE comment_06176_no_such_tbl IS NULL;
-- primary-target-end
