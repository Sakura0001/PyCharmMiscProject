...
-- primary_obligation_id: COMMENT-EXT|01550|shobj_description_query|comment_is_null_cleanup
...
COMMENT ON TABLE comment_01550_no_such_tbl IS '';
-- primary-target-end
...
SELECT shobj_description('comment_01550_role'::regrole, 'pg_authid') AS comment ORDER BY comment;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
