...
-- primary_obligation_id: COMMENT-EXT|02500|catalog_query_pg_description|drop_prerequisite_object
...
COMMENT ON TABLE comment_02500_no_such_tbl IS '';
-- primary-target-end
