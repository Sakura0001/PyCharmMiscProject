...
-- primary_obligation_id: COMMENT-EXT|11722|psql_dd_command|drop_prerequisite_object
...
COMMENT ON TABLE comment_11722_no_such_tbl IS 'short comment';
-- primary-target-end
