...
-- primary_obligation_id: ATSP-EXT|06206|error_assertion|drop_tablespace
...
ALTER TABLESPACE alter_tablespace_06206_no_such_ts SET (random_page_cost = 2.0);
-- primary-target-end
