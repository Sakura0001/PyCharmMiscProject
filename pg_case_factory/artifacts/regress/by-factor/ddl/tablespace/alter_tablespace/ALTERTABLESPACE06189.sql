...
-- primary_obligation_id: ATSP-EXT|06189|error_assertion|revert_owner
...
ALTER TABLESPACE alter_tablespace_06189_no_such_ts SET (seq_page_cost = 1.0, random_page_cost = 2.0);
-- primary-target-end
