...
-- primary_obligation_id: ATSP-EXT|04331|error_assertion|drop_tablespace
...
ALTER TABLESPACE alter_tablespace_04331_no_such_ts RESET (random_page_cost);
-- primary-target-end
