...
-- primary_obligation_id: ATSP-EXT|06207|error_assertion|role_cleanup
...
ALTER TABLESPACE alter_tablespace_06207_no_such_ts SET (random_page_cost = 2.0);
-- primary-target-end
