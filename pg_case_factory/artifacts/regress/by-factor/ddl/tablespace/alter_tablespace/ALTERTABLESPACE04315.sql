...
-- primary_obligation_id: ATSP-EXT|04315|error_assertion|reset_option
...
ALTER TABLESPACE alter_tablespace_04315_no_such_ts RESET (seq_page_cost, random_page_cost);
-- primary-target-end
