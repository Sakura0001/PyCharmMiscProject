...
-- primary_obligation_id: ATSP-EXT|04314|error_assertion|revert_owner
...
ALTER TABLESPACE alter_tablespace_04314_no_such_ts RESET (seq_page_cost, random_page_cost);
-- primary-target-end
