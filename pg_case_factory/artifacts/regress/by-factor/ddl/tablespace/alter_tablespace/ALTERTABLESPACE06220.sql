...
-- primary_obligation_id: ATSP-EXT|06220|error_assertion|reset_option
...
ALTER TABLESPACE alter_tablespace_06220_no_such_ts SET (seq_page_cost = 1.0);
-- primary-target-end
