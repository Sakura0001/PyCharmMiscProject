...
-- primary_obligation_id: ATSP-EXT|06222|error_assertion|role_cleanup
...
ALTER TABLESPACE alter_tablespace_06222_no_such_ts SET (seq_page_cost = 1.0);
-- primary-target-end
