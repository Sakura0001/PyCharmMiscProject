...
-- primary_obligation_id: ATSP-EXT|04286|error_assertion|drop_tablespace
...
ALTER TABLESPACE alter_tablespace_04286_no_such_ts RESET (effective_io_concurrency);
-- primary-target-end
