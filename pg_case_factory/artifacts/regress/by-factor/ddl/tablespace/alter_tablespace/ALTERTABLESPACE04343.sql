...
-- primary_obligation_id: ATSP-EXT|04343|error_assertion|revert_rename
...
ALTER TABLESPACE alter_tablespace_04343_no_such_ts RESET (seq_page_cost);
-- primary-target-end
