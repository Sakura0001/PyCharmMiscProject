...
-- primary_obligation_id: ATSP-EXT|04344|error_assertion|revert_owner
...
ALTER TABLESPACE alter_tablespace_04344_no_such_ts RESET (seq_page_cost);
-- primary-target-end
