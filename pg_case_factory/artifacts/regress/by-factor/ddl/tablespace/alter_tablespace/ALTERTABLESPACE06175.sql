...
-- primary_obligation_id: ATSP-EXT|06175|error_assertion|reset_option
...
ALTER TABLESPACE alter_tablespace_06175_no_such_ts SET (maintenance_io_concurrency = 4);
-- primary-target-end
