...
-- primary_obligation_id: ATSP-EXT|04283|error_assertion|revert_rename
...
ALTER TABLESPACE alter_tablespace_04283_no_such_ts RESET (effective_io_concurrency);
-- primary-target-end
