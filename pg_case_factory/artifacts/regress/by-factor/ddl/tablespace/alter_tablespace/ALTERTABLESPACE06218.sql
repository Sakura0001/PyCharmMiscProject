...
-- primary_obligation_id: ATSP-EXT|06218|error_assertion|revert_rename
...
ALTER TABLESPACE alter_tablespace_06218_no_such_ts SET (seq_page_cost = 1.0);
-- primary-target-end
