...
-- primary_obligation_id: ATSP-EXT|06176|error_assertion|drop_tablespace
...
ALTER TABLESPACE alter_tablespace_06176_no_such_ts SET (maintenance_io_concurrency = 4);
-- primary-target-end
