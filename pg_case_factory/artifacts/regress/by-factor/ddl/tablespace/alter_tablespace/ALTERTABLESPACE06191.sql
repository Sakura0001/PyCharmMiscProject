...
-- primary_obligation_id: ATSP-EXT|06191|error_assertion|drop_tablespace
...
ALTER TABLESPACE alter_tablespace_06191_no_such_ts SET (seq_page_cost = 1.0, random_page_cost = 2.0);
-- primary-target-end
