...
-- primary_obligation_id: ATSP-EXT|06205|error_assertion|reset_option
...
ALTER TABLESPACE alter_tablespace_06205_no_such_ts SET (random_page_cost = 2.0);
-- primary-target-end
