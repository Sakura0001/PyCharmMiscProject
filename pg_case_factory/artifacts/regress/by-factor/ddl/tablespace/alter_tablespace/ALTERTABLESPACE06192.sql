...
-- primary_obligation_id: ATSP-EXT|06192|error_assertion|role_cleanup
...
ALTER TABLESPACE alter_tablespace_06192_no_such_ts SET (seq_page_cost = 1.0, random_page_cost = 2.0);
-- primary-target-end
