...
-- primary_obligation_id: ATSP-EXT|04302|error_assertion|role_cleanup
...
ALTER TABLESPACE alter_tablespace_04302_no_such_ts RESET (maintenance_io_concurrency);
-- primary-target-end
