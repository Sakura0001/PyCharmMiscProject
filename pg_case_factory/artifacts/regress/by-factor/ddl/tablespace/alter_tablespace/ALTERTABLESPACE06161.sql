...
-- primary_obligation_id: ATSP-EXT|06161|error_assertion|drop_tablespace
...
ALTER TABLESPACE alter_tablespace_06161_no_such_ts SET (effective_io_concurrency = 4);
-- primary-target-end
