...
-- primary_obligation_id: ATSP-EXT|06158|error_assertion|revert_rename
...
ALTER TABLESPACE alter_tablespace_06158_no_such_ts SET (effective_io_concurrency = 4);
-- primary-target-end
