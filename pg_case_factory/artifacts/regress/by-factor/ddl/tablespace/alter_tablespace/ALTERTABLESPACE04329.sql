...
-- primary_obligation_id: ATSP-EXT|04329|error_assertion|revert_owner
...
ALTER TABLESPACE alter_tablespace_04329_no_such_ts RESET (random_page_cost);
-- primary-target-end
