...
-- primary_obligation_id: ATSP-EXT|04298|error_assertion|revert_rename
...
ALTER TABLESPACE alter_tablespace_04298_no_such_ts RESET (maintenance_io_concurrency);
-- primary-target-end
