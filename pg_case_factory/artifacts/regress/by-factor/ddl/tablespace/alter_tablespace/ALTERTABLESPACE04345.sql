...
-- primary_obligation_id: ATSP-EXT|04345|error_assertion|reset_option
...
ALTER TABLESPACE alter_tablespace_04345_no_such_ts RESET (seq_page_cost);
-- primary-target-end
