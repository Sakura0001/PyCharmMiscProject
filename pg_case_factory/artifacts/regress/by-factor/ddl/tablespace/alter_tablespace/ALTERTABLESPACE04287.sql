...
-- primary_obligation_id: ATSP-EXT|04287|error_assertion|role_cleanup
...
ALTER TABLESPACE alter_tablespace_04287_no_such_ts RESET (effective_io_concurrency);
-- primary-target-end
