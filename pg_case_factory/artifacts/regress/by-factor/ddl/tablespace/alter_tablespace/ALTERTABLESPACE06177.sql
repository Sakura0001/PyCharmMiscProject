...
-- primary_obligation_id: ATSP-EXT|06177|error_assertion|role_cleanup
...
ALTER TABLESPACE alter_tablespace_06177_no_such_ts SET (maintenance_io_concurrency = 4);
-- primary-target-end
