...
-- primary_obligation_id: ATSP-EXT|04301|error_assertion|drop_tablespace
...
ALTER TABLESPACE alter_tablespace_04301_no_such_ts RESET (maintenance_io_concurrency);
-- primary-target-end
