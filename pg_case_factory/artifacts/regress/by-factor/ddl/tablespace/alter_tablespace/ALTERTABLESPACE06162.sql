...
-- primary_obligation_id: ATSP-EXT|06162|error_assertion|role_cleanup
...
ALTER TABLESPACE alter_tablespace_06162_no_such_ts SET (effective_io_concurrency = 4);
-- primary-target-end
