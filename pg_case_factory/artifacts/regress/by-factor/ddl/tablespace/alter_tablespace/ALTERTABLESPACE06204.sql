...
-- primary_obligation_id: ATSP-EXT|06204|error_assertion|revert_owner
...
ALTER TABLESPACE alter_tablespace_06204_no_such_ts SET (random_page_cost = 2.0);
-- primary-target-end
