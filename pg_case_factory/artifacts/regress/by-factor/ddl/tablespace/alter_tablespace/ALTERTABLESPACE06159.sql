...
-- primary_obligation_id: ATSP-EXT|06159|error_assertion|revert_owner
...
ALTER TABLESPACE alter_tablespace_06159_no_such_ts SET (effective_io_concurrency = 4);
-- primary-target-end
