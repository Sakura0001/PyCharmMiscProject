...
-- primary_obligation_id: ATSP-EXT|04316|error_assertion|drop_tablespace
...
ALTER TABLESPACE alter_tablespace_04316_no_such_ts RESET (seq_page_cost, random_page_cost);
-- primary-target-end
