...
-- primary_obligation_id: ATSP-EXT|04332|error_assertion|role_cleanup
...
ALTER TABLESPACE alter_tablespace_04332_no_such_ts RESET (random_page_cost);
-- primary-target-end
