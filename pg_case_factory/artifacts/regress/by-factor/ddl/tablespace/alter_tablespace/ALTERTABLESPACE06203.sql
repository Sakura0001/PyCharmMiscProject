...
-- primary_obligation_id: ATSP-EXT|06203|error_assertion|revert_rename
...
ALTER TABLESPACE alter_tablespace_06203_no_such_ts SET (random_page_cost = 2.0);
-- primary-target-end
