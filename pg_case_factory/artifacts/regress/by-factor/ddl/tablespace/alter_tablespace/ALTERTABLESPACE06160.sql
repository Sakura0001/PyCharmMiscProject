...
-- primary_obligation_id: ATSP-EXT|06160|error_assertion|reset_option
...
ALTER TABLESPACE alter_tablespace_06160_no_such_ts SET (effective_io_concurrency = 4);
-- primary-target-end
