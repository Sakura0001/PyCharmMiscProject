...
-- primary_obligation_id: ATSP-EXT|06174|error_assertion|revert_owner
...
ALTER TABLESPACE alter_tablespace_06174_no_such_ts SET (maintenance_io_concurrency = 4);
-- primary-target-end
