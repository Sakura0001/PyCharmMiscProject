...
-- primary_obligation_id: ATSP-EXT|04346|error_assertion|drop_tablespace
...
ALTER TABLESPACE alter_tablespace_04346_no_such_ts RESET (seq_page_cost);
-- primary-target-end
