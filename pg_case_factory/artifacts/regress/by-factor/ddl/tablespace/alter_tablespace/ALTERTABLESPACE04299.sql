...
-- primary_obligation_id: ATSP-EXT|04299|error_assertion|revert_owner
...
ALTER TABLESPACE alter_tablespace_04299_no_such_ts RESET (maintenance_io_concurrency);
-- primary-target-end
