...
-- primary_obligation_id: ATSP-EXT|06188|error_assertion|revert_rename
...
ALTER TABLESPACE alter_tablespace_06188_no_such_ts SET (seq_page_cost = 1.0, random_page_cost = 2.0);
-- primary-target-end
