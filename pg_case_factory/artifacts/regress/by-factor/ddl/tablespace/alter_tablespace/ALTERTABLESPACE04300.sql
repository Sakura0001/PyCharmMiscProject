...
-- primary_obligation_id: ATSP-EXT|04300|error_assertion|reset_option
...
ALTER TABLESPACE alter_tablespace_04300_no_such_ts RESET (maintenance_io_concurrency);
-- primary-target-end
