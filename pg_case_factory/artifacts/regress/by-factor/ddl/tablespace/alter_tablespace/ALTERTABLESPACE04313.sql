...
-- primary_obligation_id: ATSP-EXT|04313|error_assertion|revert_rename
...
ALTER TABLESPACE alter_tablespace_04313_no_such_ts RESET (seq_page_cost, random_page_cost);
-- primary-target-end
