...
-- primary_obligation_id: ATSP-EXT|06173|error_assertion|revert_rename
...
ALTER TABLESPACE alter_tablespace_06173_no_such_ts SET (maintenance_io_concurrency = 4);
-- primary-target-end
