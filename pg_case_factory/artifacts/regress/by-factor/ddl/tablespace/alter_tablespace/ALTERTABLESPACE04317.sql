...
-- primary_obligation_id: ATSP-EXT|04317|error_assertion|role_cleanup
...
ALTER TABLESPACE alter_tablespace_04317_no_such_ts RESET (seq_page_cost, random_page_cost);
-- primary-target-end
