...
-- primary_obligation_id: ATSP-EXT|06190|error_assertion|reset_option
...
ALTER TABLESPACE alter_tablespace_06190_no_such_ts SET (seq_page_cost = 1.0, random_page_cost = 2.0);
-- primary-target-end
