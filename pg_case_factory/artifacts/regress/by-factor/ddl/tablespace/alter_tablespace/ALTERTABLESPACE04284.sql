...
-- primary_obligation_id: ATSP-EXT|04284|error_assertion|revert_owner
...
ALTER TABLESPACE alter_tablespace_04284_no_such_ts RESET (effective_io_concurrency);
-- primary-target-end
