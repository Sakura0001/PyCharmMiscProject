...
-- primary_obligation_id: ATSP-EXT|04285|error_assertion|reset_option
...
ALTER TABLESPACE alter_tablespace_04285_no_such_ts RESET (effective_io_concurrency);
-- primary-target-end
