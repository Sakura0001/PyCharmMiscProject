...
-- primary_obligation_id: ATSP-EXT|04330|error_assertion|reset_option
...
ALTER TABLESPACE alter_tablespace_04330_no_such_ts RESET (random_page_cost);
-- primary-target-end
