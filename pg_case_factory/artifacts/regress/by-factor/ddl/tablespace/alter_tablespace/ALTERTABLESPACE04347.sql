...
-- primary_obligation_id: ATSP-EXT|04347|error_assertion|role_cleanup
...
ALTER TABLESPACE alter_tablespace_04347_no_such_ts RESET (seq_page_cost);
-- primary-target-end
