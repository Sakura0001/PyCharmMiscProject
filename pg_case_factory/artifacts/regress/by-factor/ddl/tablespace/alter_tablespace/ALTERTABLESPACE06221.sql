...
-- primary_obligation_id: ATSP-EXT|06221|error_assertion|drop_tablespace
...
ALTER TABLESPACE alter_tablespace_06221_no_such_ts SET (seq_page_cost = 1.0);
-- primary-target-end
