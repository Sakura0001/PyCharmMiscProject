...
-- primary_obligation_id: ATSP-EXT|04328|error_assertion|revert_rename
...
ALTER TABLESPACE alter_tablespace_04328_no_such_ts RESET (random_page_cost);
-- primary-target-end
