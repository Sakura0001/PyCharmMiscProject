...
-- primary_obligation_id: ATSP-EXT|06219|error_assertion|revert_owner
...
ALTER TABLESPACE alter_tablespace_06219_no_such_ts SET (seq_page_cost = 1.0);
-- primary-target-end
