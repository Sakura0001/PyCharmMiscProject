...
-- primary_obligation_id: DROPTABLESPACE-EXT|07041|drop_tablespace|catalog_query|reset_temp_tablespaces
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_07041_tsloc';
