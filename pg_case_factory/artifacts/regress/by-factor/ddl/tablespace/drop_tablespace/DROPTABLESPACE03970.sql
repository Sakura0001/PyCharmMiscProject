...
-- primary_obligation_id: DROPTABLESPACE-EXT|03970|drop_tablespace|catalog_query|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_03970_tsloc';
