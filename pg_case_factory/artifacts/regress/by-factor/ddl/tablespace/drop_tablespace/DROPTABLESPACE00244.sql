...
-- primary_obligation_id: DROPTABLESPACE-EXT|00244|drop_tablespace|catalog_query|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_00244_tsloc';
