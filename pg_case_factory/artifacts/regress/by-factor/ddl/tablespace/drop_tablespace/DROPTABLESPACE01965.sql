...
-- primary_obligation_id: DROPTABLESPACE-EXT|01965|drop_tablespace|catalog_query|reset_temp_tablespaces
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_01965_tsloc';
