...
-- primary_obligation_id: DROPTABLESPACE-EXT|07662|drop_tablespace|catalog_query|reset_temp_tablespaces
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_07662_tsloc';
