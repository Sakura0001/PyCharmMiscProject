...
-- primary_obligation_id: DROPTABLESPACE-EXT|00248|drop_tablespace|error_assertion|drop_tablespace
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_00248_tsloc';
