...
-- primary_obligation_id: DROPTABLESPACE-EXT|06031|drop_tablespace|catalog_query|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_06031_tsloc';
