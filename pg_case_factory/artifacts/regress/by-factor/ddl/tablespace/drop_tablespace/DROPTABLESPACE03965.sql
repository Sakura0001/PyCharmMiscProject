...
-- primary_obligation_id: DROPTABLESPACE-EXT|03965|drop_tablespace|error_assertion|drop_tablespace
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_03965_tsloc';
