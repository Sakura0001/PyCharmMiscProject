...
-- primary_obligation_id: DROPTABLESPACE-EXT|02452|drop_tablespace|error_assertion|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_02452_tsloc';
