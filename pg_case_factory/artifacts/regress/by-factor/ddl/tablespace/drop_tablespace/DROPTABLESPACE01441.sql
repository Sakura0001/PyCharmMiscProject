...
-- primary_obligation_id: DROPTABLESPACE-EXT|01441|drop_tablespace|catalog_query|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_01441_tsloc';
