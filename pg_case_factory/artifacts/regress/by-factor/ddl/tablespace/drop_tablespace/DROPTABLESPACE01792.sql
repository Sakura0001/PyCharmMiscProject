...
-- primary_obligation_id: DROPTABLESPACE-EXT|01792|drop_tablespace|catalog_query|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_01792_tsloc';
