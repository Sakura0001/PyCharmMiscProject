...
-- primary_obligation_id: DROPTABLESPACE-EXT|06007|drop_tablespace|error_assertion|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_06007_tsloc';
