...
-- primary_obligation_id: DROPTABLESPACE-EXT|03459|drop_tablespace|catalog_query|reset_temp_tablespaces
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_03459_tsloc';
