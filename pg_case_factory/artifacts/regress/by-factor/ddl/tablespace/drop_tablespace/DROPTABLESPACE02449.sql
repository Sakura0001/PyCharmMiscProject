...
-- primary_obligation_id: DROPTABLESPACE-EXT|02449|drop_tablespace|catalog_query|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_02449_tsloc';
