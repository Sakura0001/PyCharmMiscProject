...
-- primary_obligation_id: DROPTABLESPACE-EXT|05646|drop_tablespace|catalog_query|reset_temp_tablespaces
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_05646_tsloc';
