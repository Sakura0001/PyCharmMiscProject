...
-- primary_obligation_id: DROPTABLESPACE-EXT|01966|drop_tablespace|error_assertion|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_01966_tsloc';
