...
-- primary_obligation_id: DROPTABLESPACE-EXT|05662|drop_tablespace|catalog_query|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_05662_tsloc';
