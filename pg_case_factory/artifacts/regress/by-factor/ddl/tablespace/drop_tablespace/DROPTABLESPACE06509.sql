...
-- primary_obligation_id: DROPTABLESPACE-EXT|06509|drop_tablespace|catalog_query|drop_tablespace
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_06509_tsloc';
