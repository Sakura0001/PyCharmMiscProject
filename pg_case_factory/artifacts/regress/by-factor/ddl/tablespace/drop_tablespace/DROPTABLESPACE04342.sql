...
-- primary_obligation_id: DROPTABLESPACE-EXT|04342|drop_tablespace|error_assertion|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_04342_tsloc';
