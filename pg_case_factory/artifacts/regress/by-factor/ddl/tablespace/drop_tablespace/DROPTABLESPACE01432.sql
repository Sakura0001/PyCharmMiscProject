...
-- primary_obligation_id: DROPTABLESPACE-EXT|01432|drop_tablespace|catalog_query|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_01432_tsloc';
