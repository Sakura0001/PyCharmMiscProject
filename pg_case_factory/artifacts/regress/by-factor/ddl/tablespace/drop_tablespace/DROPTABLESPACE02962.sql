...
-- primary_obligation_id: DROPTABLESPACE-EXT|02962|drop_tablespace|catalog_query|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_02962_tsloc';
