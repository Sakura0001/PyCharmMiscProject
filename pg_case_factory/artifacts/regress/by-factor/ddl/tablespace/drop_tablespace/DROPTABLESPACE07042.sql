...
-- primary_obligation_id: DROPTABLESPACE-EXT|07042|drop_tablespace|error_assertion|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_07042_tsloc';
