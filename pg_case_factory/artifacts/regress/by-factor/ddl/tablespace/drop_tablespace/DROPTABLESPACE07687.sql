...
-- primary_obligation_id: DROPTABLESPACE-EXT|07687|drop_tablespace|catalog_query|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_07687_tsloc';
