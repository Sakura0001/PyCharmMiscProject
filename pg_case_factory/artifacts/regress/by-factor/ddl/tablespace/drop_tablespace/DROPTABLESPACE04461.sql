...
-- primary_obligation_id: DROPTABLESPACE-EXT|04461|drop_tablespace|error_assertion|reset_temp_tablespaces
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_04461_tsloc';
