...
-- primary_obligation_id: DROPTABLESPACE-EXT|00633|drop_tablespace|catalog_query|reset_temp_tablespaces
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_00633_tsloc';
