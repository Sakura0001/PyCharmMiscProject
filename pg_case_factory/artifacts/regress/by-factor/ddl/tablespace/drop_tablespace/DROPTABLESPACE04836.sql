...
-- primary_obligation_id: DROPTABLESPACE-EXT|04836|drop_tablespace|catalog_query|reset_temp_tablespaces
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_04836_tsloc';
