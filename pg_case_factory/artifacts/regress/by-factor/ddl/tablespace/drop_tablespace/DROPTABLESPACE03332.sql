...
-- primary_obligation_id: DROPTABLESPACE-EXT|03332|drop_tablespace|catalog_query|drop_tablespace
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_03332_tsloc';
