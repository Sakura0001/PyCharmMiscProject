...
-- primary_obligation_id: DROPTABLESPACE-EXT|05665|drop_tablespace|error_assertion|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_05665_tsloc';
