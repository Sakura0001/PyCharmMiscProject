...
-- primary_obligation_id: DROPTABLESPACE-EXT|02323|drop_tablespace|catalog_query|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_02323_tsloc';
