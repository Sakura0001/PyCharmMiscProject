...
-- primary_obligation_id: DROPTABLESPACE-EXT|02955|drop_tablespace|catalog_query|reset_temp_tablespaces
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_02955_tsloc';
