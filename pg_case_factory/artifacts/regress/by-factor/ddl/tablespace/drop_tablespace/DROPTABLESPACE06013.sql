...
-- primary_obligation_id: DROPTABLESPACE-EXT|06013|drop_tablespace|catalog_query|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_06013_tsloc';
