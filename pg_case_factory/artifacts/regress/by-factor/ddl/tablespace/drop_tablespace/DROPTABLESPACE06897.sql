...
-- primary_obligation_id: DROPTABLESPACE-EXT|06897|drop_tablespace|catalog_query|reset_temp_tablespaces
-- expected_outcome: expected_failure
-- expected_sqlstate: 55006
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLESPACE IF EXISTS droptablespace_06897_ts;
...
SELECT count(*) = 0 AS tablespace_absent FROM pg_catalog.pg_tablespace WHERE spcname = 'droptablespace_06897_ts' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
DROP TABLESPACE IF EXISTS droptablespace_06897_ts;
