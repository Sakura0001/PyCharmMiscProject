...
-- primary_obligation_id: DROPTABLESPACE-EXT|02301|drop_tablespace|error_assertion|reset_temp_tablespaces
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_02301_tsloc';
