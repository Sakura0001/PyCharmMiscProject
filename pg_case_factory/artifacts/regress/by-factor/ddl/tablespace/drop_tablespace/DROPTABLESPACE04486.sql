...
-- primary_obligation_id: DROPTABLESPACE-EXT|04486|drop_tablespace|error_assertion|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_04486_tsloc';
