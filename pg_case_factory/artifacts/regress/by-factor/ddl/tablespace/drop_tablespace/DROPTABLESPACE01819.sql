...
-- primary_obligation_id: DROPTABLESPACE-EXT|01819|drop_tablespace|catalog_query|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_01819_tsloc';
