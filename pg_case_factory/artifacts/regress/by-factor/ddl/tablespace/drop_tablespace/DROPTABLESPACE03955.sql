...
-- primary_obligation_id: DROPTABLESPACE-EXT|03955|drop_tablespace|error_assertion|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_03955_tsloc';
