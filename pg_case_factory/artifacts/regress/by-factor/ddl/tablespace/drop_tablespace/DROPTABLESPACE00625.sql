...
-- primary_obligation_id: DROPTABLESPACE-EXT|00625|drop_tablespace|error_assertion|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_00625_tsloc';
