...
-- primary_obligation_id: DROPTABLESPACE-EXT|01462|drop_tablespace|error_assertion|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_01462_tsloc';
