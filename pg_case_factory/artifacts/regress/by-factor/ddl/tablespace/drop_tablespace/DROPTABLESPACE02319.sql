...
-- primary_obligation_id: DROPTABLESPACE-EXT|02319|drop_tablespace|error_assertion|reset_temp_tablespaces
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_02319_tsloc';
