...
-- primary_obligation_id: DROPTABLESPACE-EXT|08524|drop_tablespace|catalog_query|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_08524_tsloc';
