...
-- primary_obligation_id: DROPTABLESPACE-EXT|08544|drop_tablespace|catalog_query|reset_temp_tablespaces
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_08544_tsloc';
