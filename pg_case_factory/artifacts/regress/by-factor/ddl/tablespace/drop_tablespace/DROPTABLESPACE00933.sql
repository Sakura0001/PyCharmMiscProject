...
-- primary_obligation_id: DROPTABLESPACE-EXT|00933|drop_tablespace|error_assertion|reset_temp_tablespaces
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_00933_tsloc';
