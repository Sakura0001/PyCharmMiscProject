...
-- primary_obligation_id: DROPTABLESPACE-EXT|00253|drop_tablespace|catalog_query|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_00253_tsloc';
