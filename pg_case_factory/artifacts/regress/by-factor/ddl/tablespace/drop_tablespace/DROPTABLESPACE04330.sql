...
-- primary_obligation_id: DROPTABLESPACE-EXT|04330|drop_tablespace|catalog_query|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_04330_tsloc';
