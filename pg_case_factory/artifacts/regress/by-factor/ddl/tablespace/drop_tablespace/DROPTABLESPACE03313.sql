...
-- primary_obligation_id: DROPTABLESPACE-EXT|03313|drop_tablespace|catalog_query|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_03313_tsloc';
