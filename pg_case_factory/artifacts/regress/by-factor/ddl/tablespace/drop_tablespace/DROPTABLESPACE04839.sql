...
-- primary_obligation_id: DROPTABLESPACE-EXT|04839|drop_tablespace|error_assertion|reset_temp_tablespaces
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_04839_tsloc';
