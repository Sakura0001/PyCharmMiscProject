...
-- primary_obligation_id: DROPTABLESPACE-EXT|00955|drop_tablespace|catalog_query|remove_objects_first
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_00955_tsloc';
