...
-- primary_obligation_id: DROPTABLESPACE-EXT|06168|drop_tablespace|catalog_query|reset_temp_tablespaces
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_06168_tsloc';
