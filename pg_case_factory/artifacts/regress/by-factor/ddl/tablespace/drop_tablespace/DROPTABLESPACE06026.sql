...
-- primary_obligation_id: DROPTABLESPACE-EXT|06026|drop_tablespace|error_assertion|drop_tablespace
...
CREATE TABLESPACE "abort" LOCATION '/tmp/droptablespace_06026_tsloc';
