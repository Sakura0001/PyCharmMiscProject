...
-- primary_obligation_id: CTSP-EXT|01122|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01122_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01122_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
