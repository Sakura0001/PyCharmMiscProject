...
-- primary_obligation_id: CTSP-EXT|01111|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01111_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01111_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
