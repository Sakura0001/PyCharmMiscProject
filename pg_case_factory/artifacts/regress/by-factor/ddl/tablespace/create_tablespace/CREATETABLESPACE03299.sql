...
-- primary_obligation_id: CTSP-EXT|03299|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03299_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03299_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
