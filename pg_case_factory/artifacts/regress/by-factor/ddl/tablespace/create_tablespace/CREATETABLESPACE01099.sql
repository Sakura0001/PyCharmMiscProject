...
-- primary_obligation_id: CTSP-EXT|01099|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01099_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01099_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
