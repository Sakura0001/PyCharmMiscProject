...
-- primary_obligation_id: CTSP-EXT|03138|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03138_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03138_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
