...
-- primary_obligation_id: CTSP-EXT|01711|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01711_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01711_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
