...
-- primary_obligation_id: CTSP-EXT|01225|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01225_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01225_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
