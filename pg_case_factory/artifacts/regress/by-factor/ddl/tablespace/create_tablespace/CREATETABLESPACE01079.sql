...
-- primary_obligation_id: CTSP-EXT|01079|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01079_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01079_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
