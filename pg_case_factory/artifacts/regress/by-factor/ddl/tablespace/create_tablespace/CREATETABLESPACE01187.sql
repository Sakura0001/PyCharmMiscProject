...
-- primary_obligation_id: CTSP-EXT|01187|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01187_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01187_dir';
-- primary-target-end
