...
-- primary_obligation_id: CTSP-EXT|01303|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01303_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01303_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
