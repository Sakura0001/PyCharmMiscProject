...
-- primary_obligation_id: CTSP-EXT|00962|catalog_query_pg_tablespace|drop_tablespace
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00962_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
