...
-- primary_obligation_id: CTSP-EXT|03306|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03306_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03306_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
