...
-- primary_obligation_id: CTSP-EXT|01247|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01247_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01247_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
