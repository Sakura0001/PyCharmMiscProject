...
-- primary_obligation_id: CTSP-EXT|00940|catalog_query_pg_tablespace|role_cleanup
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00940_dir';
-- primary-target-end
