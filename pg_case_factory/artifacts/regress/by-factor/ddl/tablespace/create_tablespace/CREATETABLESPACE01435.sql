...
-- primary_obligation_id: CTSP-EXT|01435|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01435_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01435_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
