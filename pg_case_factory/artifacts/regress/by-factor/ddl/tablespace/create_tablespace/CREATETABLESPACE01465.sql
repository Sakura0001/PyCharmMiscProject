...
-- primary_obligation_id: CTSP-EXT|01465|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01465_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01465_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
