...
-- primary_obligation_id: CTSP-EXT|03432|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03432_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03432_dir';
-- primary-target-end
