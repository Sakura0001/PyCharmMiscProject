...
-- primary_obligation_id: CTSP-EXT|03179|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03179_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03179_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
