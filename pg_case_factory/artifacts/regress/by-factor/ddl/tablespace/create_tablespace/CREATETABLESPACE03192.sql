...
-- primary_obligation_id: CTSP-EXT|03192|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03192_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03192_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
