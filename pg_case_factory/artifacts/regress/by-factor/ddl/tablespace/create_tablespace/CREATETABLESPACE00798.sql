...
-- primary_obligation_id: CTSP-EXT|00798|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00798_dir';
-- primary-target-end
