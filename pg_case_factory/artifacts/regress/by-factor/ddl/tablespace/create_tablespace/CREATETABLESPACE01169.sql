...
-- primary_obligation_id: CTSP-EXT|01169|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01169_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01169_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
