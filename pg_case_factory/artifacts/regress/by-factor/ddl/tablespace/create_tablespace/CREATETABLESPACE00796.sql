...
-- primary_obligation_id: CTSP-EXT|00796|catalog_query_pg_tablespace|role_cleanup
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00796_dir';
-- primary-target-end
