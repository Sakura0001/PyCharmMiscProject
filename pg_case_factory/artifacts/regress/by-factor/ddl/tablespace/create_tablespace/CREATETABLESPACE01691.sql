...
-- primary_obligation_id: CTSP-EXT|01691|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01691_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01691_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
