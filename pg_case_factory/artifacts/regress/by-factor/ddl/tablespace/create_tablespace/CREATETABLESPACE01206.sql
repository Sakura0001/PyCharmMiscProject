...
-- primary_obligation_id: CTSP-EXT|01206|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01206_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01206_dir';
-- primary-target-end
