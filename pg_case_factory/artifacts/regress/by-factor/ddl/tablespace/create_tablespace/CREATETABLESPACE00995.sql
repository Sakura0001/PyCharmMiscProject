...
-- primary_obligation_id: CTSP-EXT|00995|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_00995_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_00995_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
