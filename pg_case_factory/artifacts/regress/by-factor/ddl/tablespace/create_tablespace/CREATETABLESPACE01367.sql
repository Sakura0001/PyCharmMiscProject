...
-- primary_obligation_id: CTSP-EXT|01367|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01367_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01367_dir';
-- primary-target-end
