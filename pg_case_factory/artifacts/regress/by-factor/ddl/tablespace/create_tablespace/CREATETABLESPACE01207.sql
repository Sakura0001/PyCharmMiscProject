...
-- primary_obligation_id: CTSP-EXT|01207|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01207_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01207_dir';
-- primary-target-end
