...
-- primary_obligation_id: CTSP-EXT|00935|error_assertion|drop_tablespace
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00935_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
