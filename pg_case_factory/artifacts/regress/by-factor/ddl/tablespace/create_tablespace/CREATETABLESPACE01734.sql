...
-- primary_obligation_id: CTSP-EXT|01734|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01734_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01734_dir';
-- primary-target-end
