...
-- primary_obligation_id: CTSP-EXT|01849|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01849_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01849_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
