...
-- primary_obligation_id: CTSP-EXT|00874|catalog_query_pg_tablespace|role_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00874_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
