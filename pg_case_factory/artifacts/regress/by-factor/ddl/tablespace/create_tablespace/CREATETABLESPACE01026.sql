...
-- primary_obligation_id: CTSP-EXT|01026|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01026_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01026_dir';
-- primary-target-end
