...
-- primary_obligation_id: CTSP-EXT|00845|error_assertion|drop_tablespace
...
CREATE TABLESPACE "" OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_00845_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
