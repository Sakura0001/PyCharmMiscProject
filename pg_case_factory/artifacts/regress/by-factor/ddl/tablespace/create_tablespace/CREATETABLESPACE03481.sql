...
-- primary_obligation_id: CTSP-EXT|03481|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03481_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03481_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
