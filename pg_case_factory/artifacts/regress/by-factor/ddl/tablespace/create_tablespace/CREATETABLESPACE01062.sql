...
-- primary_obligation_id: CTSP-EXT|01062|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01062_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01062_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
