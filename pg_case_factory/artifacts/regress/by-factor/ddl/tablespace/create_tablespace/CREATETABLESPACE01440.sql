...
-- primary_obligation_id: CTSP-EXT|01440|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01440_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01440_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
