...
-- primary_obligation_id: CTSP-EXT|01069|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01069_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01069_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
