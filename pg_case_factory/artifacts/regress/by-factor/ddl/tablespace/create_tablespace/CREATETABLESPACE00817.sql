...
-- primary_obligation_id: CTSP-EXT|00817|error_assertion|role_cleanup
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00817_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
