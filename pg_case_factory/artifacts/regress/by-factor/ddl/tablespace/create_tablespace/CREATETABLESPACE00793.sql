...
-- primary_obligation_id: CTSP-EXT|00793|error_assertion|role_cleanup
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00793_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
