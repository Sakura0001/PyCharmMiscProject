...
-- primary_obligation_id: CTSP-EXT|03341|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03341_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03341_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
