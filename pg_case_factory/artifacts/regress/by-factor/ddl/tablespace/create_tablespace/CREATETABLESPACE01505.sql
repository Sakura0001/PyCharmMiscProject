...
-- primary_obligation_id: CTSP-EXT|01505|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01505_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01505_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
