...
-- primary_obligation_id: CTSP-EXT|03324|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03324_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03324_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
