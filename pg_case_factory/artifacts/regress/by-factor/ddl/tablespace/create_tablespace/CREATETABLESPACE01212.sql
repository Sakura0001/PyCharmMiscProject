...
-- primary_obligation_id: CTSP-EXT|01212|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01212_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01212_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
