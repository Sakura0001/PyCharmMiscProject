...
-- primary_obligation_id: CTSP-SFV|sfv-7b713d9c52ab14633be6952f|create
...
CREATE TABLESPACE pg_createtablespace_00037_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_00037_dir';
-- primary-target-end
...
SELECT count(*) = 0 AS tablespace_state FROM pg_catalog.pg_tablespace WHERE spcname = 'pg_createtablespace_00037_ts' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
