...
-- primary_obligation_id: CTSP-EXT|01429|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01429_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01429_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
