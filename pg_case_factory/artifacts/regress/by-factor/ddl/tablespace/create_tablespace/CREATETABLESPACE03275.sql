...
-- primary_obligation_id: CTSP-EXT|03275|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03275_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03275_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
