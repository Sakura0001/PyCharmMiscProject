...
-- primary_obligation_id: CTSP-EXT|03450|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03450_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03450_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
