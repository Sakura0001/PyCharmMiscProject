...
-- primary_obligation_id: CTSP-EXT|03444|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03444_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03444_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
