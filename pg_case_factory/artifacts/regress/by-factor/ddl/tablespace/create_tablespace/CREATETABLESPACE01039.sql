...
-- primary_obligation_id: CTSP-EXT|01039|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01039_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01039_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
