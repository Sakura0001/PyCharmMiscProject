...
-- primary_obligation_id: CTSP-EXT|00846|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_00846_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
