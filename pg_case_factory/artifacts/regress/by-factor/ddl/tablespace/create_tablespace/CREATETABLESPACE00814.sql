...
-- primary_obligation_id: CTSP-EXT|00814|catalog_query_pg_tablespace|role_cleanup
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00814_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
