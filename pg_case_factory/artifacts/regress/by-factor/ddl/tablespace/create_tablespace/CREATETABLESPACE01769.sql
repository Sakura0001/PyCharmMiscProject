...
-- primary_obligation_id: CTSP-EXT|01769|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01769_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01769_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
