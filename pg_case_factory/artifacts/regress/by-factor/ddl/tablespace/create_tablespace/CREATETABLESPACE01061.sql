...
-- primary_obligation_id: CTSP-EXT|01061|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01061_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01061_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
