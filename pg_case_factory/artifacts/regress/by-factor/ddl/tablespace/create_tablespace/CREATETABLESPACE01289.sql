...
-- primary_obligation_id: CTSP-EXT|01289|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01289_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01289_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
