...
-- primary_obligation_id: CTSP-EXT|03161|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03161_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03161_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
