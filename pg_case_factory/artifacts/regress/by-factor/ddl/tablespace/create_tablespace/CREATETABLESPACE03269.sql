...
-- primary_obligation_id: CTSP-EXT|03269|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03269_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03269_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
