...
-- primary_obligation_id: CTSP-EXT|01866|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01866_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01866_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
