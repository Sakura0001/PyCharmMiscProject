...
-- primary_obligation_id: CTSP-EXT|00794|catalog_query_pg_tablespace|drop_tablespace
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00794_dir';
-- primary-target-end
