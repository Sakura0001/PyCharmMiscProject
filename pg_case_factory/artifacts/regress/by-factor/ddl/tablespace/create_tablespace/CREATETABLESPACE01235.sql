...
-- primary_obligation_id: CTSP-EXT|01235|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01235_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01235_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
