...
-- primary_obligation_id: CTSP-EXT|01362|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01362_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01362_dir';
-- primary-target-end
