...
-- primary_obligation_id: CTSP-EXT|00867|catalog_query_pg_tablespace|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00867_dir';
-- primary-target-end
