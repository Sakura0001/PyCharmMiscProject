...
-- primary_obligation_id: CTSP-EXT|01805|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01805_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01805_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
