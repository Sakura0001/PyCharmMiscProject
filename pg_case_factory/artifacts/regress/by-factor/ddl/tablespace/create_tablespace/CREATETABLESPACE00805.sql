...
-- primary_obligation_id: CTSP-EXT|00805|error_assertion|role_cleanup
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00805_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
