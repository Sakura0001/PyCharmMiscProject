...
-- primary_obligation_id: CTSP-EXT|03312|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03312_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03312_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
