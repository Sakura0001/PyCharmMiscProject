...
-- primary_obligation_id: CTSP-EXT|01428|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01428_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01428_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
