...
-- primary_obligation_id: CTSP-EXT|00850|catalog_query_pg_tablespace|role_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_00850_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
