...
-- primary_obligation_id: CTSP-EXT|01074|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01074_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01074_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
