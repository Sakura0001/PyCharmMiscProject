...
-- primary_obligation_id: CTSP-EXT|01199|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01199_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01199_dir';
-- primary-target-end
