...
-- primary_obligation_id: CTSP-EXT|01393|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01393_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01393_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
