...
-- primary_obligation_id: CTSP-EXT|03217|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03217_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03217_dir';
-- primary-target-end
