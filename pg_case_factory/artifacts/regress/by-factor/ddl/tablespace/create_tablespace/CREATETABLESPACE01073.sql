...
-- primary_obligation_id: CTSP-EXT|01073|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01073_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01073_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
