...
-- primary_obligation_id: CTSP-EXT|01709|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01709_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01709_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
