...
-- primary_obligation_id: CTSP-EXT|00820|catalog_query_pg_tablespace|role_cleanup
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00820_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
