...
-- primary_obligation_id: CTSP-EXT|01283|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01283_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01283_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
