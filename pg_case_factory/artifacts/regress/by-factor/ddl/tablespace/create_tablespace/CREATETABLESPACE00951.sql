...
-- primary_obligation_id: CTSP-EXT|00951|catalog_query_pg_tablespace|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00951_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
