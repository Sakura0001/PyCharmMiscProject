...
-- primary_obligation_id: CTSP-EXT|00799|error_assertion|role_cleanup
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00799_dir';
-- primary-target-end
