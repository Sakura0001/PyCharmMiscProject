...
-- primary_obligation_id: CTSP-EXT|00830|catalog_query_pg_tablespace|drop_tablespace
...
CREATE TABLESPACE "" OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_00830_dir';
-- primary-target-end
