...
-- primary_obligation_id: CTSP-EXT|03235|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03235_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03235_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
