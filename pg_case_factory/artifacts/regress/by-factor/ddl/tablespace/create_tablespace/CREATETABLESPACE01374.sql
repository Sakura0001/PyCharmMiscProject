...
-- primary_obligation_id: CTSP-EXT|01374|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01374_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01374_dir';
-- primary-target-end
