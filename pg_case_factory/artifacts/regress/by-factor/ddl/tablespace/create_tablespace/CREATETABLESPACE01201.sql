...
-- primary_obligation_id: CTSP-EXT|01201|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01201_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01201_dir';
-- primary-target-end
