...
-- primary_obligation_id: CTSP-EXT|01044|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01044_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01044_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
