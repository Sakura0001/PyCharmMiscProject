...
-- primary_obligation_id: CTSP-EXT|01494|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01494_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01494_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
