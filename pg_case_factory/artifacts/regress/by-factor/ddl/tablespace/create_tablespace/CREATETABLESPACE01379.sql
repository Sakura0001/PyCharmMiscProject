...
-- primary_obligation_id: CTSP-EXT|01379|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01379_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01379_dir';
-- primary-target-end
