...
-- primary_obligation_id: CTSP-EXT|01075|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01075_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01075_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
