...
-- primary_obligation_id: CTSP-EXT|03229|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03229_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03229_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
