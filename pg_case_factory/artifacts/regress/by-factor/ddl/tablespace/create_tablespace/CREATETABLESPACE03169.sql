...
-- primary_obligation_id: CTSP-EXT|03169|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03169_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03169_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
