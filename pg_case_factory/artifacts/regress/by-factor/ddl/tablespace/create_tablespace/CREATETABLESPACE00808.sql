...
-- primary_obligation_id: CTSP-EXT|00808|catalog_query_pg_tablespace|role_cleanup
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00808_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
