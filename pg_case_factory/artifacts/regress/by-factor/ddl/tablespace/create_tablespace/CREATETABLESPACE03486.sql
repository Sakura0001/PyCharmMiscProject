...
-- primary_obligation_id: CTSP-EXT|03486|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03486_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03486_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
