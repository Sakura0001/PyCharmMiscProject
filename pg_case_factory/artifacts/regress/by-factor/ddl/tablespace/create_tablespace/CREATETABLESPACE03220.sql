...
-- primary_obligation_id: CTSP-EXT|03220|catalog_query_pg_tablespace|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03220_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03220_dir';
-- primary-target-end
...
SELECT count(*) = 0 AS tablespace_state FROM pg_catalog.pg_tablespace WHERE spcname = 'pg_createtablespace_03220_ts' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
