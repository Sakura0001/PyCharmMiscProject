...
-- primary_obligation_id: CTSP-EXT|01163|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01163_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01163_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
