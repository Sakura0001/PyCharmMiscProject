...
-- primary_obligation_id: CTSP-EXT|00952|catalog_query_pg_tablespace|role_cleanup
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00952_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
