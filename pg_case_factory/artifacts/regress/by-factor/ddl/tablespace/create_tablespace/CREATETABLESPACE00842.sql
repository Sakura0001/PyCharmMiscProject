...
-- primary_obligation_id: CTSP-EXT|00842|catalog_query_pg_tablespace|drop_tablespace
...
CREATE TABLESPACE "" OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_00842_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
