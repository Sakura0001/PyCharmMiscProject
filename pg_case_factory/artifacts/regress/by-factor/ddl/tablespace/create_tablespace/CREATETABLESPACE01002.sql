...
-- primary_obligation_id: CTSP-EXT|01002|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01002_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01002_dir';
-- primary-target-end
