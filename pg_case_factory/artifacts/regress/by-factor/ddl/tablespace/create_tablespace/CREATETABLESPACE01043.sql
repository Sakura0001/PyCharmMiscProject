...
-- primary_obligation_id: CTSP-EXT|01043|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01043_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01043_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
