...
-- primary_obligation_id: CTSP-EXT|00834|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_00834_dir';
-- primary-target-end
