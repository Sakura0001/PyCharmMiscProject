...
-- primary_obligation_id: CTSP-EXT|01409|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01409_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01409_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
