...
-- primary_obligation_id: CTSP-EXT|03263|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03263_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03263_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
