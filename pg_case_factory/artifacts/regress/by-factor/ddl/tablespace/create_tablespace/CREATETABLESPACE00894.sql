...
-- primary_obligation_id: CTSP-EXT|00894|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00894_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
