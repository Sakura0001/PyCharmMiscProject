...
-- primary_obligation_id: CTSP-EXT|03325|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03325_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03325_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
