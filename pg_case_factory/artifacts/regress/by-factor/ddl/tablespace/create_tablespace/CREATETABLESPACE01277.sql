...
-- primary_obligation_id: CTSP-EXT|01277|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01277_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01277_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
