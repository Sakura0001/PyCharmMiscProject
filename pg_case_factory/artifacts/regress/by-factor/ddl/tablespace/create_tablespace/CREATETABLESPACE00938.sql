...
-- primary_obligation_id: CTSP-EXT|00938|catalog_query_pg_tablespace|drop_tablespace
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00938_dir';
-- primary-target-end
