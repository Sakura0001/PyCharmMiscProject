...
-- primary_obligation_id: CTSP-EXT|00803|error_assertion|drop_tablespace
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00803_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
