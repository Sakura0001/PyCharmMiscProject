...
-- primary_obligation_id: CTSP-EXT|01368|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01368_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01368_dir';
-- primary-target-end
