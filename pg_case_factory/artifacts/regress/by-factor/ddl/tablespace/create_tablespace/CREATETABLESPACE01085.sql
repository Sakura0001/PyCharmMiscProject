...
-- primary_obligation_id: CTSP-EXT|01085|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01085_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01085_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
