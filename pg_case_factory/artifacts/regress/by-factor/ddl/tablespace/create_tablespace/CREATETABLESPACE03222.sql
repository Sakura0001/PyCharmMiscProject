...
-- primary_obligation_id: CTSP-EXT|03222|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03222_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03222_dir';
-- primary-target-end
