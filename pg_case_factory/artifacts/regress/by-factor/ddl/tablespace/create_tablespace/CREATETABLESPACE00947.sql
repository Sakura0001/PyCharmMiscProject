...
-- primary_obligation_id: CTSP-EXT|00947|error_assertion|drop_tablespace
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00947_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
