...
-- primary_obligation_id: CTSP-EXT|01278|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01278_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01278_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
