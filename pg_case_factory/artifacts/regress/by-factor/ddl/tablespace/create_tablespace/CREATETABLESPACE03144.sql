...
-- primary_obligation_id: CTSP-EXT|03144|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03144_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03144_dir';
-- primary-target-end
