...
-- primary_obligation_id: CTSP-EXT|00835|error_assertion|role_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_00835_dir';
-- primary-target-end
