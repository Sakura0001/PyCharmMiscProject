...
-- primary_obligation_id: CTSP-EXT|01253|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01253_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01253_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
