...
-- primary_obligation_id: CTSP-EXT|00859|error_assertion|role_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_00859_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
