...
-- primary_obligation_id: CTSP-EXT|00888|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00888_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
