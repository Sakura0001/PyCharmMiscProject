...
-- primary_obligation_id: CTSP-EXT|01302|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01302_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01302_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
