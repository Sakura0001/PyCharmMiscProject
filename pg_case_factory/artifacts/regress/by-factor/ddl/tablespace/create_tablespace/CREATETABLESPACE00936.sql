...
-- primary_obligation_id: CTSP-EXT|00936|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00936_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
