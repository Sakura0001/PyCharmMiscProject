...
-- primary_obligation_id: CTSP-EXT|00849|catalog_query_pg_tablespace|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_00849_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
