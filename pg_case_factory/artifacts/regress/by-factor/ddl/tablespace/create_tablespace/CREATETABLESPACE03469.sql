...
-- primary_obligation_id: CTSP-EXT|03469|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03469_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03469_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
