...
-- primary_obligation_id: CTSP-EXT|01860|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01860_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01860_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
