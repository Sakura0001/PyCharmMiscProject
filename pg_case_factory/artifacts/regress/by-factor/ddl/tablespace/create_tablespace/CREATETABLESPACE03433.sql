...
-- primary_obligation_id: CTSP-EXT|03433|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03433_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03433_dir';
-- primary-target-end
