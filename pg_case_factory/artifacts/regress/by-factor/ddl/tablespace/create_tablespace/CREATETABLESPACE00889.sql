...
-- primary_obligation_id: CTSP-EXT|00889|error_assertion|role_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00889_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
