...
-- primary_obligation_id: CTSP-EXT|01104|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01104_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01104_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
