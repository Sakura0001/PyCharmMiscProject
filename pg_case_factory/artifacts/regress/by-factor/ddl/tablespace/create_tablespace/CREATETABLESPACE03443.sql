...
-- primary_obligation_id: CTSP-EXT|03443|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03443_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03443_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
