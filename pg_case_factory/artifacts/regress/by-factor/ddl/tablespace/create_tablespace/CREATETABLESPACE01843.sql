...
-- primary_obligation_id: CTSP-EXT|01843|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01843_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01843_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
