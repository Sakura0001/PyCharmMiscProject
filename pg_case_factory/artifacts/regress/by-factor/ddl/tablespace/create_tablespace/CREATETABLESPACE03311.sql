...
-- primary_obligation_id: CTSP-EXT|03311|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03311_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03311_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
