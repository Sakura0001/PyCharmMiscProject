...
-- primary_obligation_id: CTSP-EXT|00942|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00942_dir';
-- primary-target-end
