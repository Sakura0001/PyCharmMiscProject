...
-- primary_obligation_id: CTSP-EXT|03300|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03300_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03300_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
