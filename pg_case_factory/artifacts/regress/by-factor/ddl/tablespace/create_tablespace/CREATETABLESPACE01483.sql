...
-- primary_obligation_id: CTSP-EXT|01483|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01483_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01483_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
