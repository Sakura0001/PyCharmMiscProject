...
-- primary_obligation_id: CTSP-EXT|03221|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03221_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03221_dir';
-- primary-target-end
