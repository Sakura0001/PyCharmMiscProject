...
-- primary_obligation_id: CTSP-EXT|01831|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01831_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01831_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
