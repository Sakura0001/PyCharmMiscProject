...
-- primary_obligation_id: CTSP-EXT|01279|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01279_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01279_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
