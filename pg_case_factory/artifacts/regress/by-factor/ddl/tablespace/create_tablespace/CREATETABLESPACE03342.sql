...
-- primary_obligation_id: CTSP-EXT|03342|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03342_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03342_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
