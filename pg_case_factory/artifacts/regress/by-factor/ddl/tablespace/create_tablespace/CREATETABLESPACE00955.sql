...
-- primary_obligation_id: CTSP-EXT|00955|error_assertion|role_cleanup
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00955_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
