...
-- primary_obligation_id: CTSP-EXT|00847|error_assertion|role_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_00847_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
