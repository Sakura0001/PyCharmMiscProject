...
-- primary_obligation_id: CTSP-EXT|00854|catalog_query_pg_tablespace|drop_tablespace
...
CREATE TABLESPACE "" OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_00854_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
