...
-- primary_obligation_id: CTSP-EXT|03193|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03193_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03193_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
