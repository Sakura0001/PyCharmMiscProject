...
-- primary_obligation_id: CTSP-EXT|00932|catalog_query_pg_tablespace|drop_tablespace
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00932_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
