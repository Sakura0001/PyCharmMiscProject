...
-- primary_obligation_id: CTSP-EXT|03139|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03139_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03139_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
