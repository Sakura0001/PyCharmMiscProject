...
-- primary_obligation_id: CTSP-EXT|00806|catalog_query_pg_tablespace|drop_tablespace
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00806_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
