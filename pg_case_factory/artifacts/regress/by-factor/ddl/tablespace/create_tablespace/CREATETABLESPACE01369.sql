...
-- primary_obligation_id: CTSP-EXT|01369|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01369_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01369_dir';
-- primary-target-end
