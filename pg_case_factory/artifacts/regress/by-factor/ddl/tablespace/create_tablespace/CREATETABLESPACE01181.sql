...
-- primary_obligation_id: CTSP-EXT|01181|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01181_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01181_dir';
-- primary-target-end
