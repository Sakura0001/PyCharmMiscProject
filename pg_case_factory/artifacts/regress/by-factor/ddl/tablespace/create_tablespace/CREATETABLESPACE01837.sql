...
-- primary_obligation_id: CTSP-EXT|01837|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01837_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01837_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
