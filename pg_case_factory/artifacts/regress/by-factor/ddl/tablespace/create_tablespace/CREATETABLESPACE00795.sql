...
-- primary_obligation_id: CTSP-EXT|00795|catalog_query_pg_tablespace|filesystem_cleanup
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00795_dir';
-- primary-target-end
