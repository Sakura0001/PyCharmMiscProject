...
-- primary_obligation_id: CTSP-EXT|00810|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00810_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
