...
-- primary_obligation_id: CTSP-EXT|00997|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_00997_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_00997_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
