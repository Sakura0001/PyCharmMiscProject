...
-- primary_obligation_id: CTSP-EXT|01829|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01829_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01829_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
