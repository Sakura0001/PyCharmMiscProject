...
-- primary_obligation_id: CTSP-EXT|00893|error_assertion|drop_tablespace
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00893_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
