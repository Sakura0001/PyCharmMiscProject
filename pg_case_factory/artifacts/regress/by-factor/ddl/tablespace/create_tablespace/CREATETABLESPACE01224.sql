...
-- primary_obligation_id: CTSP-EXT|01224|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01224_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01224_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
