...
-- primary_obligation_id: CTSP-EXT|01427|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01427_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01427_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
