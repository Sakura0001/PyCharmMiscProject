...
-- primary_obligation_id: CTSP-EXT|01038|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01038_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01038_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
