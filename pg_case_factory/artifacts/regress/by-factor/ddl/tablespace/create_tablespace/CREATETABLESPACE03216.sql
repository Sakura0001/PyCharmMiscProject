...
-- primary_obligation_id: CTSP-EXT|03216|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03216_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03216_dir';
-- primary-target-end
