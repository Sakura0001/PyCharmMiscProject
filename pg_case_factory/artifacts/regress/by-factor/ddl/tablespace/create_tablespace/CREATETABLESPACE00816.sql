...
-- primary_obligation_id: CTSP-EXT|00816|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00816_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
