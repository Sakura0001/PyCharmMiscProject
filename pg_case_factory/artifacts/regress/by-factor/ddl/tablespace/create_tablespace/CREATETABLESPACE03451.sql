...
-- primary_obligation_id: CTSP-EXT|03451|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03451_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03451_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
