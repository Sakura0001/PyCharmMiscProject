...
-- primary_obligation_id: CTSP-EXT|00841|error_assertion|role_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_00841_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
