...
-- primary_obligation_id: CTSP-EXT|01309|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01309_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01309_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
