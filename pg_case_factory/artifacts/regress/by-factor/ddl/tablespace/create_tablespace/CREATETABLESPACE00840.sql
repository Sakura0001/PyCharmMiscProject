...
-- primary_obligation_id: CTSP-EXT|00840|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_00840_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
