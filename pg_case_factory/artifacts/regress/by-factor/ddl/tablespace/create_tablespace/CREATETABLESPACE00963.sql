...
-- primary_obligation_id: CTSP-EXT|00963|catalog_query_pg_tablespace|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00963_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
