...
-- primary_obligation_id: CTSP-EXT|03319|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03319_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03319_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
