...
-- primary_obligation_id: CTSP-EXT|00959|error_assertion|drop_tablespace
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00959_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
