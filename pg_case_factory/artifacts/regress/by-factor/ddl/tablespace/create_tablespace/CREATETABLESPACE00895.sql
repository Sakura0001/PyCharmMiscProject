...
-- primary_obligation_id: CTSP-EXT|00895|error_assertion|role_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00895_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
