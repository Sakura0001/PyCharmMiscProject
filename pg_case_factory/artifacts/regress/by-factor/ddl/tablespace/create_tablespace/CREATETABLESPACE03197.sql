...
-- primary_obligation_id: CTSP-EXT|03197|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03197_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03197_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
