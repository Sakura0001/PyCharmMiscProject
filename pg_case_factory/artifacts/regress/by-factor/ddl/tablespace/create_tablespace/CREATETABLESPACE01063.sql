...
-- primary_obligation_id: CTSP-EXT|01063|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01063_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01063_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
