...
-- primary_obligation_id: CTSP-EXT|00985|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_00985_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_00985_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
