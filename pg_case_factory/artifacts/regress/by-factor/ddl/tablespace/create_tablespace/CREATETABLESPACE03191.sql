...
-- primary_obligation_id: CTSP-EXT|03191|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03191_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03191_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
