...
-- primary_obligation_id: CTSP-EXT|01793|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01793_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01793_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
