...
-- primary_obligation_id: CTSP-EXT|01219|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01219_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01219_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
