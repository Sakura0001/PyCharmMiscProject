...
-- primary_obligation_id: CTSP-EXT|01373|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01373_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01373_dir';
-- primary-target-end
