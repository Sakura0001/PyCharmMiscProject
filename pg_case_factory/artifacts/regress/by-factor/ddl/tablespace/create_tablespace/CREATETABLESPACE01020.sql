...
-- primary_obligation_id: CTSP-EXT|01020|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01020_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01020_dir';
-- primary-target-end
