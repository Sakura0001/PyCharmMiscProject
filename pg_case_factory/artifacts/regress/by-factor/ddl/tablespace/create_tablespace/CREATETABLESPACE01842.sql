...
-- primary_obligation_id: CTSP-EXT|01842|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01842_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01842_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
