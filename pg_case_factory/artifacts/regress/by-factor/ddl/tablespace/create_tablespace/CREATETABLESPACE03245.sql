...
-- primary_obligation_id: CTSP-EXT|03245|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03245_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03245_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
