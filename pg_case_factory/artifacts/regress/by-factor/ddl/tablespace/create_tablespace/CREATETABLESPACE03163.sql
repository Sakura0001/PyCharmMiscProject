...
-- primary_obligation_id: CTSP-EXT|03163|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03163_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03163_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
