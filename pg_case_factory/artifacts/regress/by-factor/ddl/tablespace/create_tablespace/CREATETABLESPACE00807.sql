...
-- primary_obligation_id: CTSP-EXT|00807|catalog_query_pg_tablespace|filesystem_cleanup
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00807_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
