...
-- primary_obligation_id: CTSP-EXT|01135|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01135_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01135_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
