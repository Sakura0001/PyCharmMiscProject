...
-- primary_obligation_id: CTSP-EXT|01103|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01103_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01103_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
