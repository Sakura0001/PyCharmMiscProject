...
-- primary_obligation_id: CTSP-EXT|01205|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01205_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01205_dir';
-- primary-target-end
