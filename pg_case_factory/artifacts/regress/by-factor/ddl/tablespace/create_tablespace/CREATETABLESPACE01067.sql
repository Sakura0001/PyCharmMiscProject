...
-- primary_obligation_id: CTSP-EXT|01067|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01067_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01067_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
