...
-- primary_obligation_id: CTSP-EXT|01746|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01746_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01746_dir';
-- primary-target-end
