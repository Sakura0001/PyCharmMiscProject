...
-- primary_obligation_id: CTSP-EXT|00857|error_assertion|drop_tablespace
...
CREATE TABLESPACE "" OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_00857_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
