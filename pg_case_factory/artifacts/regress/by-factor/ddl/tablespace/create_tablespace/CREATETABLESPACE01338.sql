...
-- primary_obligation_id: CTSP-EXT|01338|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01338_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01338_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
