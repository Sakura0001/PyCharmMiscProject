...
-- primary_obligation_id: CTSP-EXT|01182|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01182_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01182_dir';
-- primary-target-end
