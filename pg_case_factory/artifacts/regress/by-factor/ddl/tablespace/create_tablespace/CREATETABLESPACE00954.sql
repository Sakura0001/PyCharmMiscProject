...
-- primary_obligation_id: CTSP-EXT|00954|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00954_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
