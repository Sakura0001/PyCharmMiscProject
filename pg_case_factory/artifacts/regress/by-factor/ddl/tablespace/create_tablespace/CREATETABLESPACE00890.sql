...
-- primary_obligation_id: CTSP-EXT|00890|catalog_query_pg_tablespace|drop_tablespace
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00890_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
