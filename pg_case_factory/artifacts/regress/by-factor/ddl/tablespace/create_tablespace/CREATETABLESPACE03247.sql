...
-- primary_obligation_id: CTSP-EXT|03247|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03247_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03247_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
