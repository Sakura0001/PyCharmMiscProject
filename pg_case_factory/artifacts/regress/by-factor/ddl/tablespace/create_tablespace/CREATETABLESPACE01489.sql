...
-- primary_obligation_id: CTSP-EXT|01489|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01489_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01489_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
