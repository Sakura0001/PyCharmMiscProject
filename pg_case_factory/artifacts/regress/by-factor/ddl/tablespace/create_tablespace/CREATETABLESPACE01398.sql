...
-- primary_obligation_id: CTSP-EXT|01398|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01398_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01398_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
