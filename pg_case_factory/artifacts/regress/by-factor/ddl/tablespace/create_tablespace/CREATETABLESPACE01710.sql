...
-- primary_obligation_id: CTSP-EXT|01710|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01710_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01710_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
