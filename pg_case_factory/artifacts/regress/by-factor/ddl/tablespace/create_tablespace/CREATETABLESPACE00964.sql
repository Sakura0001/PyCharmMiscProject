...
-- primary_obligation_id: CTSP-EXT|00964|catalog_query_pg_tablespace|role_cleanup
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00964_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
