...
-- primary_obligation_id: CTSP-EXT|00977|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_00977_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_00977_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
