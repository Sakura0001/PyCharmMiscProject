...
-- primary_obligation_id: CTSP-EXT|03257|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03257_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03257_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
