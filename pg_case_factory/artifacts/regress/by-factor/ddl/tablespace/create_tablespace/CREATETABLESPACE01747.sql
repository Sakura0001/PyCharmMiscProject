...
-- primary_obligation_id: CTSP-EXT|01747|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01747_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01747_dir';
-- primary-target-end
