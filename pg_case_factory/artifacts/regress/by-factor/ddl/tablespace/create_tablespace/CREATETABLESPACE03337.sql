...
-- primary_obligation_id: CTSP-EXT|03337|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03337_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03337_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
