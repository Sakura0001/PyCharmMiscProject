...
-- primary_obligation_id: CTSP-EXT|01801|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01801_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01801_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
