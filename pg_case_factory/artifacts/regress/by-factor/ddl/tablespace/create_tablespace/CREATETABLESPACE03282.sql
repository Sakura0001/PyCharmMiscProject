...
-- primary_obligation_id: CTSP-EXT|03282|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03282_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03282_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
