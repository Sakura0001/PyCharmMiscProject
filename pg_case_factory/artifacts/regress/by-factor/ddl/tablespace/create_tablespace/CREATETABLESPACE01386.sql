...
-- primary_obligation_id: CTSP-EXT|01386|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01386_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01386_dir';
-- primary-target-end
