...
-- primary_obligation_id: CTSP-EXT|01355|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01355_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01355_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
