...
-- primary_obligation_id: CTSP-EXT|03479|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03479_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03479_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
