...
-- primary_obligation_id: CTSP-EXT|03131|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03131_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03131_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
