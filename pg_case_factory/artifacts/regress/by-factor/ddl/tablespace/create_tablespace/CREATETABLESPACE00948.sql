...
-- primary_obligation_id: CTSP-EXT|00948|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00948_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
