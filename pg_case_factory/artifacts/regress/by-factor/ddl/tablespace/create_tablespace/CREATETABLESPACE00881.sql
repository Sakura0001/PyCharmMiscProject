...
-- primary_obligation_id: CTSP-EXT|00881|error_assertion|drop_tablespace
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00881_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
