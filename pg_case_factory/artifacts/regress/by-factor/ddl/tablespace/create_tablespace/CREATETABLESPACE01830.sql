...
-- primary_obligation_id: CTSP-EXT|01830|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01830_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01830_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
