...
-- primary_obligation_id: CTSP-EXT|03431|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03431_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03431_dir';
-- primary-target-end
