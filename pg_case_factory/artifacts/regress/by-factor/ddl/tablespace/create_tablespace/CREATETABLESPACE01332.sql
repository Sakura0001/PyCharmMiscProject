...
-- primary_obligation_id: CTSP-EXT|01332|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01332_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01332_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
