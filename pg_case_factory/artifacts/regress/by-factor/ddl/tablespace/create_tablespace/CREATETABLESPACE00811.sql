...
-- primary_obligation_id: CTSP-EXT|00811|error_assertion|role_cleanup
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00811_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
