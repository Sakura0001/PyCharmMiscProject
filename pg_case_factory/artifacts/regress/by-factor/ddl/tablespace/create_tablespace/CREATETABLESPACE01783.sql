...
-- primary_obligation_id: CTSP-EXT|01783|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01783_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01783_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
