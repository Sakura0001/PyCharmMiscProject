...
-- primary_obligation_id: CTSP-EXT|03468|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03468_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03468_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
