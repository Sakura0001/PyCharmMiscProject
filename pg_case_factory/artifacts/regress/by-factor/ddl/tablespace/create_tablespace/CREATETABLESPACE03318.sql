...
-- primary_obligation_id: CTSP-EXT|03318|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03318_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03318_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
