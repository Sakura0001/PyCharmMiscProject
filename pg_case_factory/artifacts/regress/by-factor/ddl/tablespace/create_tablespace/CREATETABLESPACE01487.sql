...
-- primary_obligation_id: CTSP-EXT|01487|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01487_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01487_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
