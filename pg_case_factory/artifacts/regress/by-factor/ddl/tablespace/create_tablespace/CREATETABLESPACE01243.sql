...
-- primary_obligation_id: CTSP-EXT|01243|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01243_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01243_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
