...
-- primary_obligation_id: CTSP-EXT|01116|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01116_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01116_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
