...
-- primary_obligation_id: CTSP-EXT|00866|catalog_query_pg_tablespace|drop_tablespace
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00866_dir';
-- primary-target-end
