...
-- primary_obligation_id: CTSP-EXT|01115|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01115_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01115_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
