...
-- primary_obligation_id: CTSP-EXT|01151|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01151_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01151_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
