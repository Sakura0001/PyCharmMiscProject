...
-- primary_obligation_id: CTSP-EXT|01799|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01799_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01799_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
