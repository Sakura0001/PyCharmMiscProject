...
-- primary_obligation_id: CTSP-EXT|03227|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03227_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03227_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
