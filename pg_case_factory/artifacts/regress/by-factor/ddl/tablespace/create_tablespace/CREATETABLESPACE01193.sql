...
-- primary_obligation_id: CTSP-EXT|01193|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01193_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01193_dir';
-- primary-target-end
