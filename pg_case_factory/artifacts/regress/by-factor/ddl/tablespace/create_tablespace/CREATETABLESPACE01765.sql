...
-- primary_obligation_id: CTSP-EXT|01765|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01765_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01765_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
