...
-- primary_obligation_id: CTSP-EXT|03253|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03253_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03253_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
