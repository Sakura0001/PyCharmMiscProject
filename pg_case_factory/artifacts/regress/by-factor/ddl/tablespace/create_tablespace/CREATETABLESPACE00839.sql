...
-- primary_obligation_id: CTSP-EXT|00839|error_assertion|drop_tablespace
...
CREATE TABLESPACE "" OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_00839_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
