...
-- primary_obligation_id: CTSP-EXT|01723|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01723_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01723_dir';
-- primary-target-end
