...
-- primary_obligation_id: CTSP-EXT|03462|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03462_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03462_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
