...
-- primary_obligation_id: CTSP-EXT|03199|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03199_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03199_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
