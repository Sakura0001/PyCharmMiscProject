...
-- primary_obligation_id: CTSP-EXT|01806|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01806_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01806_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
