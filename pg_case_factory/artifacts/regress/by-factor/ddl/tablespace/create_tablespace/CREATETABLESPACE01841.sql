...
-- primary_obligation_id: CTSP-EXT|01841|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01841_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01841_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
