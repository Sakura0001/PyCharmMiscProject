...
-- primary_obligation_id: CTSP-EXT|03180|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03180_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03180_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
