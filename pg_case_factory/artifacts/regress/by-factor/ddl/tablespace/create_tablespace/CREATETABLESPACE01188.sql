...
-- primary_obligation_id: CTSP-EXT|01188|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01188_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01188_dir';
-- primary-target-end
