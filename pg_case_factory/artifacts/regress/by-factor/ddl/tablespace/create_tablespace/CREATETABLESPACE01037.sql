...
-- primary_obligation_id: CTSP-EXT|01037|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01037_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01037_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
