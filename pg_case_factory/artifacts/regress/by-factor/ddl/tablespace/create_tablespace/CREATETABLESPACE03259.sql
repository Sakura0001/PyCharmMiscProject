...
-- primary_obligation_id: CTSP-EXT|03259|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03259_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03259_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
