...
-- primary_obligation_id: CTSP-EXT|00833|error_assertion|drop_tablespace
...
CREATE TABLESPACE "" OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_00833_dir';
-- primary-target-end
