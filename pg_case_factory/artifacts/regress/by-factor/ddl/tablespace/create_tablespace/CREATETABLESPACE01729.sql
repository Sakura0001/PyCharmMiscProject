...
-- primary_obligation_id: CTSP-EXT|01729|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01729_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01729_dir';
-- primary-target-end
