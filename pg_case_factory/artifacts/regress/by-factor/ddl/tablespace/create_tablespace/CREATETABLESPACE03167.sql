...
-- primary_obligation_id: CTSP-EXT|03167|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03167_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03167_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
