...
-- primary_obligation_id: CTSP-EXT|03187|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03187_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03187_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
