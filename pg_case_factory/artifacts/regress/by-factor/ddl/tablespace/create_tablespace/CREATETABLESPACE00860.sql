...
-- primary_obligation_id: CTSP-EXT|00860|catalog_query_pg_tablespace|drop_tablespace
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00860_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
