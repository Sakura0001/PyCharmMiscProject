...
-- primary_obligation_id: CTSP-EXT|03480|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03480_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03480_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
