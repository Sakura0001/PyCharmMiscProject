...
-- primary_obligation_id: CTSP-EXT|01488|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01488_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01488_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
