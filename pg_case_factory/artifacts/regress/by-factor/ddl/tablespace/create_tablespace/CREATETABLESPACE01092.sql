...
-- primary_obligation_id: CTSP-EXT|01092|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01092_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01092_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
