...
-- primary_obligation_id: CTSP-EXT|00818|catalog_query_pg_tablespace|drop_tablespace
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00818_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
