...
-- primary_obligation_id: CTSP-EXT|01416|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01416_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01416_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
