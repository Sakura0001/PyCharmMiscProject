...
-- primary_obligation_id: CTSP-EXT|00884|catalog_query_pg_tablespace|drop_tablespace
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00884_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
