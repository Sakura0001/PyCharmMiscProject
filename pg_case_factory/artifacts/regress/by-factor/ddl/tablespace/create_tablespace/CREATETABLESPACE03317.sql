...
-- primary_obligation_id: CTSP-EXT|03317|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03317_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03317_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
