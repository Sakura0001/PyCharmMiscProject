...
-- primary_obligation_id: CTSP-EXT|01041|catalog_query_pg_tablespace|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01041_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01041_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
...
SELECT count(*) = 0 AS tablespace_state FROM pg_catalog.pg_tablespace WHERE spcname = 'pg_createtablespace_01041_ts' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
