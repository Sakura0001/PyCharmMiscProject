...
-- primary_obligation_id: CTSP-EXT|01812|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01812_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01812_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
