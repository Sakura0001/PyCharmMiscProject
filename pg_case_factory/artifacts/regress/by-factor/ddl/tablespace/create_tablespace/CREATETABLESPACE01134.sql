...
-- primary_obligation_id: CTSP-EXT|01134|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01134_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01134_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
