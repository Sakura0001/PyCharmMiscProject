...
-- primary_obligation_id: CTSP-EXT|03463|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03463_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03463_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
