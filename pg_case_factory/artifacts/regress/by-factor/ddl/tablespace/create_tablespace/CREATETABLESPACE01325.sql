...
-- primary_obligation_id: CTSP-EXT|01325|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01325_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01325_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
