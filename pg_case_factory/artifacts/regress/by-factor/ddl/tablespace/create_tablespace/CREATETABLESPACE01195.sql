...
-- primary_obligation_id: CTSP-EXT|01195|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01195_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01195_dir';
-- primary-target-end
