...
-- primary_obligation_id: CTSP-EXT|03313|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03313_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03313_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
