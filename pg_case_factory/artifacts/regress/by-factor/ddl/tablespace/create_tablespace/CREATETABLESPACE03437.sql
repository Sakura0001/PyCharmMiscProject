...
-- primary_obligation_id: CTSP-EXT|03437|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03437_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03437_dir';
-- primary-target-end
