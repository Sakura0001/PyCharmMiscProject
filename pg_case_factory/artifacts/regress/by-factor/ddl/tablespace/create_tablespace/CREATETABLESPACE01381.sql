...
-- primary_obligation_id: CTSP-EXT|01381|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01381_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01381_dir';
-- primary-target-end
