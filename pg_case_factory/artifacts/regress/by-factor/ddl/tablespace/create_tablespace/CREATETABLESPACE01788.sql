...
-- primary_obligation_id: CTSP-EXT|01788|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01788_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01788_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
