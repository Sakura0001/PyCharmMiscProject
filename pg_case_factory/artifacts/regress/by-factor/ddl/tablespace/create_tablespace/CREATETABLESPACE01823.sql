...
-- primary_obligation_id: CTSP-EXT|01823|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01823_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01823_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
