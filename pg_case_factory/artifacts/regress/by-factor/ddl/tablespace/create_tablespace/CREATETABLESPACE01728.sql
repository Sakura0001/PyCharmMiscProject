...
-- primary_obligation_id: CTSP-EXT|01728|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01728_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01728_dir';
-- primary-target-end
