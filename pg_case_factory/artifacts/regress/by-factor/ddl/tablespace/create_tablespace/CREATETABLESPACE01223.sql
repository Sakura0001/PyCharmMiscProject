...
-- primary_obligation_id: CTSP-EXT|01223|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01223_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01223_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
