...
-- primary_obligation_id: CTSP-EXT|03439|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03439_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03439_dir';
-- primary-target-end
