...
-- primary_obligation_id: CTSP-EXT|03265|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03265_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03265_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
