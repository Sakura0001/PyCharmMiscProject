...
-- primary_obligation_id: CTSP-EXT|00879|catalog_query_pg_tablespace|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00879_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
