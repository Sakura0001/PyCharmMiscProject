...
-- primary_obligation_id: CTSP-EXT|03132|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03132_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03132_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
