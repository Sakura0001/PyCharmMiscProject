...
-- primary_obligation_id: CTSP-EXT|01105|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01105_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01105_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
