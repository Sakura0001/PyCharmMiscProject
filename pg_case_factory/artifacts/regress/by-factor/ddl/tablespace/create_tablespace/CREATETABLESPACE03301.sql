...
-- primary_obligation_id: CTSP-EXT|03301|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03301_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03301_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
