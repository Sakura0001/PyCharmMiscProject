...
-- primary_obligation_id: CTSP-EXT|00877|error_assertion|role_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00877_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
