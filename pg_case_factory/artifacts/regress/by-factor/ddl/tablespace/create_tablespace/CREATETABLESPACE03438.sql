...
-- primary_obligation_id: CTSP-EXT|03438|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03438_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03438_dir';
-- primary-target-end
