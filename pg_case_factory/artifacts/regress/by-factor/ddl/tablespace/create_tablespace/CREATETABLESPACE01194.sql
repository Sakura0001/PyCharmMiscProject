...
-- primary_obligation_id: CTSP-EXT|01194|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01194_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01194_dir';
-- primary-target-end
