...
-- primary_obligation_id: CTSP-EXT|00809|error_assertion|drop_tablespace
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00809_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
