...
-- primary_obligation_id: CTSP-EXT|00967|error_assertion|role_cleanup
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00967_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
