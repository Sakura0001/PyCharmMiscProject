...
-- primary_obligation_id: CTSP-EXT|01411|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01411_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01411_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
