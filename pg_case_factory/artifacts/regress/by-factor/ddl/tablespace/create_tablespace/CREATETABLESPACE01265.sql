...
-- primary_obligation_id: CTSP-EXT|01265|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01265_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01265_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
