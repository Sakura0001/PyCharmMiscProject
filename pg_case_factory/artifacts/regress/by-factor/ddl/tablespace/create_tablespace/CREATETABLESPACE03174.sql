...
-- primary_obligation_id: CTSP-EXT|03174|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03174_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03174_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
