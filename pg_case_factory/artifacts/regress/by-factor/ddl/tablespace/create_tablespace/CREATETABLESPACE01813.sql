...
-- primary_obligation_id: CTSP-EXT|01813|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01813_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01813_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
