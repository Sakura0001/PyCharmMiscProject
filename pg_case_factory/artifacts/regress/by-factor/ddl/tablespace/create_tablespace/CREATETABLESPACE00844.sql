...
-- primary_obligation_id: CTSP-EXT|00844|catalog_query_pg_tablespace|role_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_00844_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
