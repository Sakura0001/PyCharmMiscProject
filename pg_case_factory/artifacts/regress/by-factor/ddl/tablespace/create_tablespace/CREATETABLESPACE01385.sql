...
-- primary_obligation_id: CTSP-EXT|01385|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01385_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01385_dir';
-- primary-target-end
