...
-- primary_obligation_id: CTSP-EXT|01331|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01331_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01331_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
