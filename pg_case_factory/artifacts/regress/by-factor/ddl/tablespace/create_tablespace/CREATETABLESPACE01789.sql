...
-- primary_obligation_id: CTSP-EXT|01789|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01789_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01789_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
