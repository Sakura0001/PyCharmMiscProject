...
-- primary_obligation_id: CTSP-EXT|01056|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01056_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01056_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
