...
-- primary_obligation_id: CTSP-EXT|03277|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03277_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03277_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
