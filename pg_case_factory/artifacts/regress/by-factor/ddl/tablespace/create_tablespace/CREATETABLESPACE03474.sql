...
-- primary_obligation_id: CTSP-EXT|03474|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03474_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03474_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
