...
-- primary_obligation_id: CTSP-EXT|01213|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01213_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01213_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
