...
-- primary_obligation_id: CTSP-EXT|01050|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01050_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01050_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
