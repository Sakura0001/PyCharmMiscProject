...
-- primary_obligation_id: CTSP-EXT|01189|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01189_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01189_dir';
-- primary-target-end
