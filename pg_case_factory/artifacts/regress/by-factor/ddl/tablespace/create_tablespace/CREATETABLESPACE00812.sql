...
-- primary_obligation_id: CTSP-EXT|00812|catalog_query_pg_tablespace|drop_tablespace
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00812_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
