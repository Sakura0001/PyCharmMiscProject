...
-- primary_obligation_id: CTSP-EXT|01499|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01499_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01499_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
