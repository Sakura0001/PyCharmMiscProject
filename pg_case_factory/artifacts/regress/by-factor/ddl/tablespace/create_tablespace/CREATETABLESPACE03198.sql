...
-- primary_obligation_id: CTSP-EXT|03198|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03198_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03198_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
