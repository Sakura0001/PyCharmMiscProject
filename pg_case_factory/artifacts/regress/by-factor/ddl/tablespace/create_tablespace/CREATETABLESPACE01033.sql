...
-- primary_obligation_id: CTSP-EXT|01033|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01033_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01033_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
