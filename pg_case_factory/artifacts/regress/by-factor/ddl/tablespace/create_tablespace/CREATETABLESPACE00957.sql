...
-- primary_obligation_id: CTSP-EXT|00957|catalog_query_pg_tablespace|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00957_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
