...
-- primary_obligation_id: CTSP-EXT|03426|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03426_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03426_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
