...
-- primary_obligation_id: CTSP-EXT|01735|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01735_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01735_dir';
-- primary-target-end
