...
-- primary_obligation_id: CTSP-EXT|03419|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03419_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03419_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
