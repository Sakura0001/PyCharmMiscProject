...
-- primary_obligation_id: CTSP-EXT|01835|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01835_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01835_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
