...
-- primary_obligation_id: CTSP-EXT|00791|error_assertion|drop_tablespace
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00791_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
