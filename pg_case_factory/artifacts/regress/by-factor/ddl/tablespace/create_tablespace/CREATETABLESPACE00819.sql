...
-- primary_obligation_id: CTSP-EXT|00819|catalog_query_pg_tablespace|filesystem_cleanup
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00819_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
