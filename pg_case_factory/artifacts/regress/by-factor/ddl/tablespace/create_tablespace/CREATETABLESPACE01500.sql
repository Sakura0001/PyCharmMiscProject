...
-- primary_obligation_id: CTSP-EXT|01500|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01500_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01500_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
