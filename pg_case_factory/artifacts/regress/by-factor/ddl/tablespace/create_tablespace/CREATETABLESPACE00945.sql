...
-- primary_obligation_id: CTSP-EXT|00945|catalog_query_pg_tablespace|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00945_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
