...
-- primary_obligation_id: CTSP-EXT|00800|catalog_query_pg_tablespace|drop_tablespace
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00800_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
