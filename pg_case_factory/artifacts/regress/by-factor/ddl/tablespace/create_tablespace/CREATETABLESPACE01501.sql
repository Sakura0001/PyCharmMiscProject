...
-- primary_obligation_id: CTSP-EXT|01501|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01501_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01501_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
