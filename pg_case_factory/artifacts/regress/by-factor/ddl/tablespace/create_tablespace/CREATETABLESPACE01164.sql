...
-- primary_obligation_id: CTSP-EXT|01164|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01164_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01164_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
