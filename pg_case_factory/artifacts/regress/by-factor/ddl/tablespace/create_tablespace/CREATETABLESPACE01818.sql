...
-- primary_obligation_id: CTSP-EXT|01818|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01818_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01818_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
