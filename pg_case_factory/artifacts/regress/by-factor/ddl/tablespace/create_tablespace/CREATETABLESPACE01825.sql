...
-- primary_obligation_id: CTSP-EXT|01825|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01825_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01825_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
