...
-- primary_obligation_id: CTSP-EXT|01819|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01819_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01819_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
