...
-- primary_obligation_id: CTSP-EXT|03295|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03295_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03295_dir';
-- primary-target-end
