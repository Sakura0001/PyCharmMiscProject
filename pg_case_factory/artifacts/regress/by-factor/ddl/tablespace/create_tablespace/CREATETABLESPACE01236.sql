...
-- primary_obligation_id: CTSP-EXT|01236|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01236_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01236_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
