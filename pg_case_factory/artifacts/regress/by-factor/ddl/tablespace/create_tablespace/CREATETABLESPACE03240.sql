...
-- primary_obligation_id: CTSP-EXT|03240|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03240_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03240_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
