...
-- primary_obligation_id: CTSP-EXT|01363|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01363_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01363_dir';
-- primary-target-end
