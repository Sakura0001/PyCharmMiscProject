...
-- primary_obligation_id: CTSP-EXT|03157|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03157_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03157_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
