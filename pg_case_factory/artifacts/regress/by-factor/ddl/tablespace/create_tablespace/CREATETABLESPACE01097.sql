...
-- primary_obligation_id: CTSP-EXT|01097|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01097_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01097_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
