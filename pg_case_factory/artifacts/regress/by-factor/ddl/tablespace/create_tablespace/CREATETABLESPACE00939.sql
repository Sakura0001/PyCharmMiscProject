...
-- primary_obligation_id: CTSP-EXT|00939|catalog_query_pg_tablespace|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00939_dir';
-- primary-target-end
