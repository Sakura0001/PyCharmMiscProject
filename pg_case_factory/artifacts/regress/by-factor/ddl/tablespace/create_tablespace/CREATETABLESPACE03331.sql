...
-- primary_obligation_id: CTSP-EXT|03331|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03331_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03331_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
