...
-- primary_obligation_id: CTSP-EXT|03329|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03329_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03329_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
