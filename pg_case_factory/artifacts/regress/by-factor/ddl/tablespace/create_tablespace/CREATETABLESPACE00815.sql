...
-- primary_obligation_id: CTSP-EXT|00815|error_assertion|drop_tablespace
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00815_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
