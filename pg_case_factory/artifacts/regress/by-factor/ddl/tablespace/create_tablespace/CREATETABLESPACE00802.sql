...
-- primary_obligation_id: CTSP-EXT|00802|catalog_query_pg_tablespace|role_cleanup
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00802_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
