...
-- primary_obligation_id: CTSP-EXT|01045|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01045_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01045_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
