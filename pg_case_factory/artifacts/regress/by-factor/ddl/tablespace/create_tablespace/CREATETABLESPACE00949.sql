...
-- primary_obligation_id: CTSP-EXT|00949|error_assertion|role_cleanup
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00949_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
