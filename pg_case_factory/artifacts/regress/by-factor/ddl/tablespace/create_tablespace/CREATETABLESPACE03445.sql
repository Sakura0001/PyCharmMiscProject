...
-- primary_obligation_id: CTSP-EXT|03445|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03445_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03445_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
