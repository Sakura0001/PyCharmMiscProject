...
-- primary_obligation_id: CTSP-EXT|03288|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03288_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03288_dir';
-- primary-target-end
