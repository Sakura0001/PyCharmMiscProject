...
-- primary_obligation_id: CTSP-EXT|01722|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01722_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01722_dir';
-- primary-target-end
