...
-- primary_obligation_id: CTSP-EXT|00869|error_assertion|drop_tablespace
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00869_dir';
-- primary-target-end
