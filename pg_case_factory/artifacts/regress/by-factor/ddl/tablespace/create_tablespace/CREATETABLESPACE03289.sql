...
-- primary_obligation_id: CTSP-EXT|03289|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03289_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03289_dir';
-- primary-target-end
