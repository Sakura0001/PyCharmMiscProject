...
-- primary_obligation_id: CTSP-EXT|03252|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03252_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03252_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
