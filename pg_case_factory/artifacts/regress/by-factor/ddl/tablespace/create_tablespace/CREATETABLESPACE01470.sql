...
-- primary_obligation_id: CTSP-EXT|01470|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01470_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01470_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
