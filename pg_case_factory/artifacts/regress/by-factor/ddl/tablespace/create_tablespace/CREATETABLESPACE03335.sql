...
-- primary_obligation_id: CTSP-EXT|03335|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03335_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03335_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
