...
-- primary_obligation_id: CTSP-EXT|01121|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01121_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01121_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
