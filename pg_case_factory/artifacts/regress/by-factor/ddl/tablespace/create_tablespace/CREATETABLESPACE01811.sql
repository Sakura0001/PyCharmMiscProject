...
-- primary_obligation_id: CTSP-EXT|01811|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01811_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01811_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
