...
-- primary_obligation_id: CTSP-EXT|01404|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01404_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01404_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
