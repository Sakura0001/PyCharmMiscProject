...
-- primary_obligation_id: CTSP-EXT|00941|error_assertion|drop_tablespace
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00941_dir';
-- primary-target-end
