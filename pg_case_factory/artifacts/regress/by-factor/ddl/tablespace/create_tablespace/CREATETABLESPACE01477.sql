...
-- primary_obligation_id: CTSP-EXT|01477|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01477_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01477_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
