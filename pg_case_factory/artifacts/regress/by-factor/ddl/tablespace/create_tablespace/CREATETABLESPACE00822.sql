...
-- primary_obligation_id: CTSP-EXT|00822|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00822_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
