...
-- primary_obligation_id: CTSP-EXT|01014|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01014_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01014_dir';
-- primary-target-end
