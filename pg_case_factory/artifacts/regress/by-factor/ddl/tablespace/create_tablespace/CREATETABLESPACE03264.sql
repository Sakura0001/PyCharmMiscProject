...
-- primary_obligation_id: CTSP-EXT|03264|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03264_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03264_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
