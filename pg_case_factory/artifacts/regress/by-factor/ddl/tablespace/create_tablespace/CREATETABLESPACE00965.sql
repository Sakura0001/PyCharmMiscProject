...
-- primary_obligation_id: CTSP-EXT|00965|error_assertion|drop_tablespace
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00965_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
