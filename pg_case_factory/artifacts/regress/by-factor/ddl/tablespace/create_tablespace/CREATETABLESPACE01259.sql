...
-- primary_obligation_id: CTSP-EXT|01259|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01259_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01259_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
