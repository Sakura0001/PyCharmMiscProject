...
-- primary_obligation_id: CTSP-EXT|01273|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01273_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01273_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
