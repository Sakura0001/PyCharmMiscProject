...
-- primary_obligation_id: CTSP-EXT|03251|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03251_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03251_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
