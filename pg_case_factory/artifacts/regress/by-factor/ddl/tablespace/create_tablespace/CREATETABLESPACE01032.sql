...
-- primary_obligation_id: CTSP-EXT|01032|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01032_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01032_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
