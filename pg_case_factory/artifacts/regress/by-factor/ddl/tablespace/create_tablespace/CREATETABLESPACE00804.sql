...
-- primary_obligation_id: CTSP-EXT|00804|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00804_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
