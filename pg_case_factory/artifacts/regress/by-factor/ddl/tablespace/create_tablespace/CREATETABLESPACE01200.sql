...
-- primary_obligation_id: CTSP-EXT|01200|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01200_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01200_dir';
-- primary-target-end
