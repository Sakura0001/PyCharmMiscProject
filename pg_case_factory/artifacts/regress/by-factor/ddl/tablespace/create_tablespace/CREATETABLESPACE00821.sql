...
-- primary_obligation_id: CTSP-EXT|00821|error_assertion|drop_tablespace
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00821_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
