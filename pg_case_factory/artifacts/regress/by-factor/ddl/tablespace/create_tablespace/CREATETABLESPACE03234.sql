...
-- primary_obligation_id: CTSP-EXT|03234|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03234_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03234_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
