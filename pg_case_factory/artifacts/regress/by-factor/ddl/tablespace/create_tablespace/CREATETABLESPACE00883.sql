...
-- primary_obligation_id: CTSP-EXT|00883|error_assertion|role_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00883_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
