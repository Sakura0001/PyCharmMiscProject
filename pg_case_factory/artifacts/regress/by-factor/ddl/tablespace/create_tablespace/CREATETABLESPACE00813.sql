...
-- primary_obligation_id: CTSP-EXT|00813|catalog_query_pg_tablespace|filesystem_cleanup
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00813_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
