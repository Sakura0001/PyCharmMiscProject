...
-- primary_obligation_id: CTSP-EXT|03185|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03185_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03185_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
