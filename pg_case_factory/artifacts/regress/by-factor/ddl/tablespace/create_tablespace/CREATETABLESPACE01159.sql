...
-- primary_obligation_id: CTSP-EXT|01159|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01159_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01159_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
