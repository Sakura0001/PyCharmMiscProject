...
-- primary_obligation_id: CTSP-EXT|03449|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03449_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03449_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
