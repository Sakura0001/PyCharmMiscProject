...
-- primary_obligation_id: CTSP-EXT|03307|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03307_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03307_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
