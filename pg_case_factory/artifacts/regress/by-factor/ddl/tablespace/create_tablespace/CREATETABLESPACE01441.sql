...
-- primary_obligation_id: CTSP-EXT|01441|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01441_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01441_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
