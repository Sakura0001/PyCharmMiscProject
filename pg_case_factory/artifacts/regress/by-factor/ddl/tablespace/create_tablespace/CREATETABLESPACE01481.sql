...
-- primary_obligation_id: CTSP-EXT|01481|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01481_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01481_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
