...
-- primary_obligation_id: CTSP-EXT|03181|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03181_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03181_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
