...
-- primary_obligation_id: CTSP-EXT|03241|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03241_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03241_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
