...
-- primary_obligation_id: CTSP-EXT|00961|error_assertion|role_cleanup
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00961_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
