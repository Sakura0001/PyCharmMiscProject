...
-- primary_obligation_id: CTSP-EXT|01740|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01740_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01740_dir';
-- primary-target-end
