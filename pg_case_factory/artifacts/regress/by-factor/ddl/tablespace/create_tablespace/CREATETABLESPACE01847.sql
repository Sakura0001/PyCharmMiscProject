...
-- primary_obligation_id: CTSP-EXT|01847|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01847_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01847_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
