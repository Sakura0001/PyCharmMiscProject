...
-- primary_obligation_id: CTSP-EXT|00855|catalog_query_pg_tablespace|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_00855_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
