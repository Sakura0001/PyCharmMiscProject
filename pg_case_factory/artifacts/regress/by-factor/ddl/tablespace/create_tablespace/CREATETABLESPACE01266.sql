...
-- primary_obligation_id: CTSP-EXT|01266|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01266_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01266_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
