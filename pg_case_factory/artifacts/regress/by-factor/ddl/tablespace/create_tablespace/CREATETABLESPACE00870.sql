...
-- primary_obligation_id: CTSP-EXT|00870|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00870_dir';
-- primary-target-end
