...
-- primary_obligation_id: CTSP-EXT|01356|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01356_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01356_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
