...
-- primary_obligation_id: CTSP-EXT|00876|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00876_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
