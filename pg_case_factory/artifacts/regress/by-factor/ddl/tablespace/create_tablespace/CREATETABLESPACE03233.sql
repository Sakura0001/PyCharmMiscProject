...
-- primary_obligation_id: CTSP-EXT|03233|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03233_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03233_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
