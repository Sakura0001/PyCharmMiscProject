...
-- primary_obligation_id: CTSP-EXT|01423|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01423_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01423_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
