...
-- primary_obligation_id: CTSP-EXT|01320|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01320_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01320_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
