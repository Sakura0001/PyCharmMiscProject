...
-- primary_obligation_id: CTSP-EXT|03168|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03168_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03168_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
