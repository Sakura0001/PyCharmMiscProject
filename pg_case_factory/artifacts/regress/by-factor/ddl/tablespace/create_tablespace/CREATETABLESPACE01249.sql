...
-- primary_obligation_id: CTSP-EXT|01249|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01249_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01249_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
