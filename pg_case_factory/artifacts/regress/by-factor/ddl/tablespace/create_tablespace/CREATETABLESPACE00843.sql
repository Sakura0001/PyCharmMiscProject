...
-- primary_obligation_id: CTSP-EXT|00843|catalog_query_pg_tablespace|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_00843_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
