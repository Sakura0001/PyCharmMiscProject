...
-- primary_obligation_id: CTSP-EXT|00871|error_assertion|role_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00871_dir';
-- primary-target-end
