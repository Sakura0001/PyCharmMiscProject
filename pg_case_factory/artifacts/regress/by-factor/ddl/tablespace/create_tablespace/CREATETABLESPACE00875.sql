...
-- primary_obligation_id: CTSP-EXT|00875|error_assertion|drop_tablespace
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00875_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
