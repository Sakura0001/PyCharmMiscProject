...
-- primary_obligation_id: CTSP-EXT|01451|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01451_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01451_dir' WITH (random_page_cost = 4.0);
-- primary-target-end
