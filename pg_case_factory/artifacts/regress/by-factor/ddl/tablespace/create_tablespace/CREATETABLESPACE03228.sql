...
-- primary_obligation_id: CTSP-EXT|03228|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03228_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03228_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
