...
-- primary_obligation_id: CTSP-EXT|00996|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_00996_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_00996_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
