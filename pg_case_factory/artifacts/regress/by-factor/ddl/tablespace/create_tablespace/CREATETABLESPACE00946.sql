...
-- primary_obligation_id: CTSP-EXT|00946|catalog_query_pg_tablespace|role_cleanup
...
CREATE TABLESPACE "" OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00946_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
