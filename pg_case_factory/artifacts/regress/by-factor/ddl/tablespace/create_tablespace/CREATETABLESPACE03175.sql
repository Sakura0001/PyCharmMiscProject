...
-- primary_obligation_id: CTSP-EXT|03175|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03175_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_03175_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
