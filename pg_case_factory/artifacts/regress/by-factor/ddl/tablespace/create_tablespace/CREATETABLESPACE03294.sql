...
-- primary_obligation_id: CTSP-EXT|03294|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_03294_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03294_dir';
-- primary-target-end
