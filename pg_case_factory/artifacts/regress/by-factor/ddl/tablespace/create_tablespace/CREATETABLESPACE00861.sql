...
-- primary_obligation_id: CTSP-EXT|00861|catalog_query_pg_tablespace|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00861_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
