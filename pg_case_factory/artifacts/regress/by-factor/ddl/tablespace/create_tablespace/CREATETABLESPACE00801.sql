...
-- primary_obligation_id: CTSP-EXT|00801|catalog_query_pg_tablespace|filesystem_cleanup
...
CREATE TABLESPACE "" LOCATION '/tmp/pgcf_ctsp/createtablespace_00801_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
