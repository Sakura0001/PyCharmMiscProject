...
-- primary_obligation_id: CTSP-EXT|03455|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03455_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_03455_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
