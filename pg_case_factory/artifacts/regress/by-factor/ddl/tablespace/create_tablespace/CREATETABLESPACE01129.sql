...
-- primary_obligation_id: CTSP-EXT|01129|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01129_ts LOCATION '/tmp/pgcf_ctsp/createtablespace_01129_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
