...
-- primary_obligation_id: CTSP-EXT|03215|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_03215_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03215_dir';
-- primary-target-end
