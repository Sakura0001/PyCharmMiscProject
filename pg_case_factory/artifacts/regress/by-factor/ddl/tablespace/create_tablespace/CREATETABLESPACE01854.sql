...
-- primary_obligation_id: CTSP-EXT|01854|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01854_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01854_dir' WITH (seq_page_cost = 1.0);
-- primary-target-end
