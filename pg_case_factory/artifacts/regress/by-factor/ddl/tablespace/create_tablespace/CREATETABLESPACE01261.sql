...
-- primary_obligation_id: CTSP-EXT|01261|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01261_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_01261_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
