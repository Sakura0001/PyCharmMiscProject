...
-- primary_obligation_id: CTSP-EXT|00828|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_00828_dir' WITH (seq_page_cost = 1.0, random_page_cost = 4.0);
-- primary-target-end
