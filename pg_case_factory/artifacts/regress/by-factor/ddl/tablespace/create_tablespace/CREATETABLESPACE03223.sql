...
-- primary_obligation_id: CTSP-EXT|03223|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_03223_ts OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_03223_dir';
-- primary-target-end
