...
-- primary_obligation_id: CTSP-EXT|00832|catalog_query_pg_tablespace|role_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_ROLE LOCATION '/tmp/pgcf_ctsp/createtablespace_00832_dir';
-- primary-target-end
