...
-- primary_obligation_id: CTSP-EXT|01745|error_assertion|drop_tablespace
...
CREATE TABLESPACE pg_createtablespace_01745_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01745_dir';
-- primary-target-end
