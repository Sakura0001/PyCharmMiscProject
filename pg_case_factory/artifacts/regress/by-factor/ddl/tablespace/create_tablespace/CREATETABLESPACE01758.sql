...
-- primary_obligation_id: CTSP-EXT|01758|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01758_ts OWNER SESSION_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01758_dir' WITH (effective_io_concurrency = 16);
-- primary-target-end
