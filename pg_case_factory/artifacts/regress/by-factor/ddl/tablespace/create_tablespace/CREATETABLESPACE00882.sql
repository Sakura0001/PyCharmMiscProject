...
-- primary_obligation_id: CTSP-EXT|00882|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00882_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
