...
-- primary_obligation_id: CTSP-EXT|01375|error_assertion|role_cleanup
...
CREATE TABLESPACE pg_createtablespace_01375_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01375_dir';
-- primary-target-end
