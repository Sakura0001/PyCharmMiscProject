...
-- primary_obligation_id: CTSP-EXT|00868|catalog_query_pg_tablespace|role_cleanup
...
CREATE TABLESPACE "" OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_00868_dir';
-- primary-target-end
