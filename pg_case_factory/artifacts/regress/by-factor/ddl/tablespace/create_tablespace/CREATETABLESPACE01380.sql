...
-- primary_obligation_id: CTSP-EXT|01380|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01380_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01380_dir';
-- primary-target-end
