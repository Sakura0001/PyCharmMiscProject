...
-- primary_obligation_id: CTSP-EXT|01446|error_assertion|filesystem_cleanup
...
CREATE TABLESPACE pg_createtablespace_01446_ts OWNER CURRENT_USER LOCATION '/tmp/pgcf_ctsp/createtablespace_01446_dir' WITH (maintenance_io_concurrency = 16);
-- primary-target-end
