...
-- primary_obligation_id: DROPTRIGGER-EXT|01072|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON "droptrigger_01072_qt" CASCADE;
-- primary-target-end
