...
-- primary_obligation_id: DROPTRIGGER-EXT|03810|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_03810_t;
-- primary-target-end
