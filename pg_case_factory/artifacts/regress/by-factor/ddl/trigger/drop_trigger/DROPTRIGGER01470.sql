...
-- primary_obligation_id: DROPTRIGGER-EXT|01470|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_01470_t CASCADE;
-- primary-target-end
