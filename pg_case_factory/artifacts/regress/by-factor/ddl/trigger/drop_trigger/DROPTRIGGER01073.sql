...
-- primary_obligation_id: DROPTRIGGER-EXT|01073|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER "select" ON "droptrigger_01073_qt" CASCADE;
-- primary-target-end
