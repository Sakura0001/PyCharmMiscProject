...
-- primary_obligation_id: DROPTRIGGER-EXT|04003|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_04003_t;
-- primary-target-end
