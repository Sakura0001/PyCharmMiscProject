...
-- primary_obligation_id: DROPTRIGGER-EXT|02529|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON "droptrigger_02529_qt" RESTRICT;
-- primary-target-end
