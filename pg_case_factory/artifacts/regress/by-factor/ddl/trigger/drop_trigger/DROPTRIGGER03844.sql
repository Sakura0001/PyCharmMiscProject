...
-- primary_obligation_id: DROPTRIGGER-EXT|03844|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_03844_t;
-- primary-target-end
