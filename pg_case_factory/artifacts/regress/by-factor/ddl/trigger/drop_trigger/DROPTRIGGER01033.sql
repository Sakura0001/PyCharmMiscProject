...
-- primary_obligation_id: DROPTRIGGER-EXT|01033|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON public.droptrigger_01033_t CASCADE;
-- primary-target-end
