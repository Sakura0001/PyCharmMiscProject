...
-- primary_obligation_id: DROPTRIGGER-EXT|04004|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_04004_t;
-- primary-target-end
