...
-- primary_obligation_id: DROPTRIGGER-EXT|02311|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON "droptrigger_02311_qt" RESTRICT;
-- primary-target-end
