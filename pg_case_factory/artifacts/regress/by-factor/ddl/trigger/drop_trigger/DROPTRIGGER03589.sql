...
-- primary_obligation_id: DROPTRIGGER-EXT|03589|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON droptrigger_03589_t;
-- primary-target-end
