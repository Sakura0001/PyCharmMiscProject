...
-- primary_obligation_id: DROPTRIGGER-EXT|01449|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON "droptrigger_01449_qt" CASCADE;
-- primary-target-end
