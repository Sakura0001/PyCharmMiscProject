...
-- primary_obligation_id: DROPTRIGGER-EXT|03575|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER "select" ON public.droptrigger_03575_t;
-- primary-target-end
