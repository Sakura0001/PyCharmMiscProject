...
-- primary_obligation_id: DROPTRIGGER-EXT|03936|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON "droptrigger_03936_qt";
-- primary-target-end
