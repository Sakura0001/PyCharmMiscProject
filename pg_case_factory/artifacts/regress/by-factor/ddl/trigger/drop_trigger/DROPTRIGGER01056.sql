...
-- primary_obligation_id: DROPTRIGGER-EXT|01056|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER "select" ON droptrigger_01056_t CASCADE;
-- primary-target-end
