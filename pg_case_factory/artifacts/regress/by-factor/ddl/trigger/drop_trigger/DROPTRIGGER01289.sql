...
-- primary_obligation_id: DROPTRIGGER-EXT|01289|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER IF EXISTS "select" ON "droptrigger_01289_qt" CASCADE;
-- primary-target-end
