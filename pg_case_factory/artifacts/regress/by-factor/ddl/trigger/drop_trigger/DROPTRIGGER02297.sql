...
-- primary_obligation_id: DROPTRIGGER-EXT|02297|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER "select" ON droptrigger_02297_t RESTRICT;
-- primary-target-end
