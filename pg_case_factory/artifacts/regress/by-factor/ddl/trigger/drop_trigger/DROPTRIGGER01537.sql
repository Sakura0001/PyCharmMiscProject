...
-- primary_obligation_id: DROPTRIGGER-EXT|01537|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_01537_t CASCADE;
-- primary-target-end
