...
-- primary_obligation_id: DROPTRIGGER-EXT|02766|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_02766_t RESTRICT;
-- primary-target-end
