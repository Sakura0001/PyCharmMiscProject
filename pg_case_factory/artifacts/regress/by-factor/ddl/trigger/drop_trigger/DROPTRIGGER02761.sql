...
-- primary_obligation_id: DROPTRIGGER-EXT|02761|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_02761_t RESTRICT;
-- primary-target-end
