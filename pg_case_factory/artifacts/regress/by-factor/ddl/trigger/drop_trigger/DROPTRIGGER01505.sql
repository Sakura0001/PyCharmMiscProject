...
-- primary_obligation_id: DROPTRIGGER-EXT|01505|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER IF EXISTS "select" ON "droptrigger_01505_qt" CASCADE;
-- primary-target-end
