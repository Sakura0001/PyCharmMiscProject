...
-- primary_obligation_id: DROPTRIGGER-EXT|02296|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON droptrigger_02296_t RESTRICT;
-- primary-target-end
