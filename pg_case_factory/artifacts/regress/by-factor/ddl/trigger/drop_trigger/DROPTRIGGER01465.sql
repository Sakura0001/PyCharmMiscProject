...
-- primary_obligation_id: DROPTRIGGER-EXT|01465|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_01465_t CASCADE;
-- primary-target-end
