...
-- primary_obligation_id: DROPTRIGGER-EXT|02279|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER "select" ON public.droptrigger_02279_t RESTRICT;
-- primary-target-end
