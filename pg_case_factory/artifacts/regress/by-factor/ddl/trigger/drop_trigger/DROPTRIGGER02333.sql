...
-- primary_obligation_id: DROPTRIGGER-EXT|02333|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER "select" ON public.droptrigger_02333_t RESTRICT;
-- primary-target-end
