...
-- primary_obligation_id: DROPTRIGGER-EXT|03970|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_03970_t;
-- primary-target-end
