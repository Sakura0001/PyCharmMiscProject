...
-- primary_obligation_id: DROPTRIGGER-EXT|03859|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_03859_t;
-- primary-target-end
