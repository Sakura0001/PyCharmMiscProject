...
-- primary_obligation_id: DROPTRIGGER-EXT|01020|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER "select" ON "droptrigger_01020_qt" CASCADE;
-- primary-target-end
