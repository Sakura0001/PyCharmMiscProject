...
-- primary_obligation_id: DROPTRIGGER-EXT|03522|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER "select" ON public.droptrigger_03522_t;
-- primary-target-end
