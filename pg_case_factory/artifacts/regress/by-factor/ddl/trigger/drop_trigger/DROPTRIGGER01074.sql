...
-- primary_obligation_id: DROPTRIGGER-EXT|01074|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER "select" ON "droptrigger_01074_qt" CASCADE;
-- primary-target-end
