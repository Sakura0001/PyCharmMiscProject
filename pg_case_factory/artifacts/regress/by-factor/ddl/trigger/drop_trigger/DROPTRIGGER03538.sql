...
-- primary_obligation_id: DROPTRIGGER-EXT|03538|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON droptrigger_03538_t;
-- primary-target-end
