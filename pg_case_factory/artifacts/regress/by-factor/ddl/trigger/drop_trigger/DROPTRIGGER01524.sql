...
-- primary_obligation_id: DROPTRIGGER-EXT|01524|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_01524_t CASCADE;
-- primary-target-end
