...
-- primary_obligation_id: DROPTRIGGER-EXT|02260|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON "droptrigger_02260_qt" RESTRICT;
-- primary-target-end
