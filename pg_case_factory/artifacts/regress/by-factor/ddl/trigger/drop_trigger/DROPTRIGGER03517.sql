...
-- primary_obligation_id: DROPTRIGGER-EXT|03517|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON public.droptrigger_03517_t;
-- primary-target-end
