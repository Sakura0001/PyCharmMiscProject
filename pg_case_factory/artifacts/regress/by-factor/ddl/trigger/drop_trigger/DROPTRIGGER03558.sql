...
-- primary_obligation_id: DROPTRIGGER-EXT|03558|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER "select" ON "droptrigger_03558_qt";
-- primary-target-end
