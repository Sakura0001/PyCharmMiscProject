...
-- primary_obligation_id: DROPTRIGGER-EXT|01451|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER IF EXISTS "select" ON "droptrigger_01451_qt" CASCADE;
-- primary-target-end
