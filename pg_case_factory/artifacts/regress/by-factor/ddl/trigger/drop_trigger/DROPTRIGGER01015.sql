...
-- primary_obligation_id: DROPTRIGGER-EXT|01015|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON "droptrigger_01015_qt" CASCADE;
-- primary-target-end
