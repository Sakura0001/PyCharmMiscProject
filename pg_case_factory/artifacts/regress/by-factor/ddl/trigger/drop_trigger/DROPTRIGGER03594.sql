...
-- primary_obligation_id: DROPTRIGGER-EXT|03594|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER "select" ON droptrigger_03594_t;
-- primary-target-end
