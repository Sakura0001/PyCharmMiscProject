...
-- primary_obligation_id: DROPTRIGGER-EXT|03499|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON "droptrigger_03499_qt";
-- primary-target-end
