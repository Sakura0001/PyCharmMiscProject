...
-- primary_obligation_id: DROPTRIGGER-EXT|01016|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER "select" ON "droptrigger_01016_qt" CASCADE;
-- primary-target-end
