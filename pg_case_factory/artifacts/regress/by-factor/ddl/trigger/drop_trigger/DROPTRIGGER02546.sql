...
-- primary_obligation_id: DROPTRIGGER-EXT|02546|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_02546_t RESTRICT;
-- primary-target-end
