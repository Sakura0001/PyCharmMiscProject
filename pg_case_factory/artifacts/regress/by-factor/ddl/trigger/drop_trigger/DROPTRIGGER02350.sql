...
-- primary_obligation_id: DROPTRIGGER-EXT|02350|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON droptrigger_02350_t RESTRICT;
-- primary-target-end
