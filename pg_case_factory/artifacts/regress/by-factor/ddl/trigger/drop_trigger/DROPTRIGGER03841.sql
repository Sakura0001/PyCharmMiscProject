...
-- primary_obligation_id: DROPTRIGGER-EXT|03841|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_03841_t;
-- primary-target-end
