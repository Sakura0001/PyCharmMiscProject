...
-- primary_obligation_id: DROPTRIGGER-EXT|02331|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER "select" ON public.droptrigger_02331_t RESTRICT;
-- primary-target-end
