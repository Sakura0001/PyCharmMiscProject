...
-- primary_obligation_id: DROPTRIGGER-EXT|02707|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_02707_t RESTRICT;
-- primary-target-end
