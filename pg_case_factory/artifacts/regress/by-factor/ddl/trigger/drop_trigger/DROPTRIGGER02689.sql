...
-- primary_obligation_id: DROPTRIGGER-EXT|02689|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON "droptrigger_02689_qt" RESTRICT;
-- primary-target-end
