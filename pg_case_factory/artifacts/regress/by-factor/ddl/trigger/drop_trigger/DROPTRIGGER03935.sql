...
-- primary_obligation_id: DROPTRIGGER-EXT|03935|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER IF EXISTS "select" ON "droptrigger_03935_qt";
-- primary-target-end
