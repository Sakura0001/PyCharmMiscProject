...
-- primary_obligation_id: DROPTRIGGER-EXT|03985|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON "droptrigger_03985_qt";
-- primary-target-end
