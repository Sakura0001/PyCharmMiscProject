...
-- primary_obligation_id: DROPTRIGGER-EXT|03501|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER "select" ON "droptrigger_03501_qt";
-- primary-target-end
