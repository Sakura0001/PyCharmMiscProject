...
-- primary_obligation_id: DROPTRIGGER-EXT|02726|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_02726_t RESTRICT;
-- primary-target-end
