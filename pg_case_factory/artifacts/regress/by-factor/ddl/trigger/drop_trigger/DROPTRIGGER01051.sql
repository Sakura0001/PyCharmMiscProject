...
-- primary_obligation_id: DROPTRIGGER-EXT|01051|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON droptrigger_01051_t CASCADE;
-- primary-target-end
