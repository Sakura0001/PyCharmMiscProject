...
-- primary_obligation_id: DROPTRIGGER-EXT|02275|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON public.droptrigger_02275_t RESTRICT;
-- primary-target-end
