...
-- primary_obligation_id: DROPTRIGGER-EXT|02782|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_02782_t RESTRICT;
-- primary-target-end
