...
-- primary_obligation_id: DROPTRIGGER-EXT|02746|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON "droptrigger_02746_qt" RESTRICT;
-- primary-target-end
