...
-- primary_obligation_id: DROPTRIGGER-EXT|01035|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER "select" ON public.droptrigger_01035_t CASCADE;
-- primary-target-end
