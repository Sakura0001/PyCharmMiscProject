...
-- primary_obligation_id: DROPTRIGGER-EXT|03809|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_03809_t;
-- primary-target-end
