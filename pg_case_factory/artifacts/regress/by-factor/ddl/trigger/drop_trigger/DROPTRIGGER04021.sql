...
-- primary_obligation_id: DROPTRIGGER-EXT|04021|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_04021_t;
-- primary-target-end
