...
-- primary_obligation_id: DROPTRIGGER-EXT|01377|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_01377_t CASCADE;
-- primary-target-end
