...
-- primary_obligation_id: DROPTRIGGER-EXT|01324|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_01324_t CASCADE;
-- primary-target-end
