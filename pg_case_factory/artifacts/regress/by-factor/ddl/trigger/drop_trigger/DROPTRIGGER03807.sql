...
-- primary_obligation_id: DROPTRIGGER-EXT|03807|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_03807_t;
-- primary-target-end
