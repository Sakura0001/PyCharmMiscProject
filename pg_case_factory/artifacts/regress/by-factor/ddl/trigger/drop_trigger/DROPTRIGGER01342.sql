...
-- primary_obligation_id: DROPTRIGGER-EXT|01342|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON "droptrigger_01342_qt" CASCADE;
-- primary-target-end
