...
-- primary_obligation_id: DROPTRIGGER-EXT|03969|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_03969_t;
-- primary-target-end
