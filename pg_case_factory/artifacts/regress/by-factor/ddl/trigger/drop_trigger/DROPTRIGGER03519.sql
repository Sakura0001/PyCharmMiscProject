...
-- primary_obligation_id: DROPTRIGGER-EXT|03519|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER "select" ON public.droptrigger_03519_t;
-- primary-target-end
