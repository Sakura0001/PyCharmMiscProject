...
-- primary_obligation_id: DROPTRIGGER-EXT|03540|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER "select" ON droptrigger_03540_t;
-- primary-target-end
