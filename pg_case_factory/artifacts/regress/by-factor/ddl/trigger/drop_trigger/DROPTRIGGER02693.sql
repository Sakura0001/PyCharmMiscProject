...
-- primary_obligation_id: DROPTRIGGER-EXT|02693|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER IF EXISTS "select" ON "droptrigger_02693_qt" RESTRICT;
-- primary-target-end
