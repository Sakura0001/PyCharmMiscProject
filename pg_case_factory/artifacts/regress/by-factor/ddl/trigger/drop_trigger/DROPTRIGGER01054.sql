...
-- primary_obligation_id: DROPTRIGGER-EXT|01054|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON droptrigger_01054_t CASCADE;
-- primary-target-end
