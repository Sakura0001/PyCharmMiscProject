...
-- primary_obligation_id: DROPTRIGGER-EXT|03846|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_03846_t;
-- primary-target-end
