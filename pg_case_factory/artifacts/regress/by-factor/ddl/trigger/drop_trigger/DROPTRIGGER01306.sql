...
-- primary_obligation_id: DROPTRIGGER-EXT|01306|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_01306_t CASCADE;
-- primary-target-end
