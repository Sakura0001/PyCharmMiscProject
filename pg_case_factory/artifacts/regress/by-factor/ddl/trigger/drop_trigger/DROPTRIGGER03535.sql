...
-- primary_obligation_id: DROPTRIGGER-EXT|03535|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON droptrigger_03535_t;
-- primary-target-end
