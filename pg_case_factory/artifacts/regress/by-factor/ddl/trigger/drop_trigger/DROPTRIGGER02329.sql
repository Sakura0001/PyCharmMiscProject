...
-- primary_obligation_id: DROPTRIGGER-EXT|02329|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON public.droptrigger_02329_t RESTRICT;
-- primary-target-end
