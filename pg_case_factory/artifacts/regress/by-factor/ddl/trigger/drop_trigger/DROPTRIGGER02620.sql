...
-- primary_obligation_id: DROPTRIGGER-EXT|02620|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_02620_t RESTRICT;
-- primary-target-end
