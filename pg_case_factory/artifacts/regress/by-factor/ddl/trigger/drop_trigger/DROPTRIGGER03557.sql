...
-- primary_obligation_id: DROPTRIGGER-EXT|03557|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER "select" ON "droptrigger_03557_qt";
-- primary-target-end
