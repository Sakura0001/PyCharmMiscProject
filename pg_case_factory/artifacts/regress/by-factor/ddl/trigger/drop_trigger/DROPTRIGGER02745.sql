...
-- primary_obligation_id: DROPTRIGGER-EXT|02745|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON "droptrigger_02745_qt" RESTRICT;
-- primary-target-end
