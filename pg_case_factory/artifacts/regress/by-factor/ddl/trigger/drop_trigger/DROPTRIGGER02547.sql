...
-- primary_obligation_id: DROPTRIGGER-EXT|02547|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_02547_t RESTRICT;
-- primary-target-end
