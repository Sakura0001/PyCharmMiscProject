...
-- primary_obligation_id: DROPTRIGGER-EXT|01380|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_01380_t CASCADE;
-- primary-target-end
