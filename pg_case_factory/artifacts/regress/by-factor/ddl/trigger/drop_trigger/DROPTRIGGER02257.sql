...
-- primary_obligation_id: DROPTRIGGER-EXT|02257|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON "droptrigger_02257_qt" RESTRICT;
-- primary-target-end
