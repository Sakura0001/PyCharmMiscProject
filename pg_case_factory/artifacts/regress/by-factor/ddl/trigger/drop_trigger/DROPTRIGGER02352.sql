...
-- primary_obligation_id: DROPTRIGGER-EXT|02352|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER "select" ON droptrigger_02352_t RESTRICT;
-- primary-target-end
