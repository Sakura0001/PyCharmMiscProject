...
-- primary_obligation_id: DROPTRIGGER-EXT|01501|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON "droptrigger_01501_qt" CASCADE;
-- primary-target-end
