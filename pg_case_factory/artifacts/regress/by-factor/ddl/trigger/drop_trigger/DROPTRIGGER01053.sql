...
-- primary_obligation_id: DROPTRIGGER-EXT|01053|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER "select" ON droptrigger_01053_t CASCADE;
-- primary-target-end
