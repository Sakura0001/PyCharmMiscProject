...
-- primary_obligation_id: DROPTRIGGER-EXT|01307|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_01307_t CASCADE;
-- primary-target-end
