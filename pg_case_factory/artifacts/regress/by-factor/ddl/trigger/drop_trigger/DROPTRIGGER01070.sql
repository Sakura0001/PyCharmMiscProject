...
-- primary_obligation_id: DROPTRIGGER-EXT|01070|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER "select" ON "droptrigger_01070_qt" CASCADE;
-- primary-target-end
