...
-- primary_obligation_id: DROPTRIGGER-EXT|01069|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON "droptrigger_01069_qt" CASCADE;
-- primary-target-end
