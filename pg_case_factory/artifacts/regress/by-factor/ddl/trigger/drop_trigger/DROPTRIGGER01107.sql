...
-- primary_obligation_id: DROPTRIGGER-EXT|01107|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER "select" ON droptrigger_01107_t CASCADE;
-- primary-target-end
