...
-- primary_obligation_id: DROPTRIGGER-EXT|01521|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_01521_t CASCADE;
-- primary-target-end
