...
-- primary_obligation_id: DROPTRIGGER-EXT|01108|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON droptrigger_01108_t CASCADE;
-- primary-target-end
