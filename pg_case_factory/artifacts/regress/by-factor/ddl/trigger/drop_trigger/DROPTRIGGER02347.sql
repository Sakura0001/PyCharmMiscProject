...
-- primary_obligation_id: DROPTRIGGER-EXT|02347|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON droptrigger_02347_t RESTRICT;
-- primary-target-end
