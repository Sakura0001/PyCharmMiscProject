...
-- primary_obligation_id: DROPTRIGGER-EXT|03573|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER "select" ON public.droptrigger_03573_t;
-- primary-target-end
