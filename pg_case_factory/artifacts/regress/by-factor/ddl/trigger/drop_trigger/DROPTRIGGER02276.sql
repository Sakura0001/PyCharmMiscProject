...
-- primary_obligation_id: DROPTRIGGER-EXT|02276|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER "select" ON public.droptrigger_02276_t RESTRICT;
-- primary-target-end
