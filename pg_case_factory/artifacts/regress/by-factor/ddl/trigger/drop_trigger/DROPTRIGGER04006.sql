...
-- primary_obligation_id: DROPTRIGGER-EXT|04006|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_04006_t;
-- primary-target-end
