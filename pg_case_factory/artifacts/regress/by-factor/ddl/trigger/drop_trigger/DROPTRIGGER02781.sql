...
-- primary_obligation_id: DROPTRIGGER-EXT|02781|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_02781_t RESTRICT;
-- primary-target-end
