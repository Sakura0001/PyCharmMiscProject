...
-- primary_obligation_id: DROPTRIGGER-EXT|02784|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_02784_t RESTRICT;
-- primary-target-end
