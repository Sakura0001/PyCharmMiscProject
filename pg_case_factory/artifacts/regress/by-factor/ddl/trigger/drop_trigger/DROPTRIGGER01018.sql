...
-- primary_obligation_id: DROPTRIGGER-EXT|01018|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON "droptrigger_01018_qt" CASCADE;
-- primary-target-end
