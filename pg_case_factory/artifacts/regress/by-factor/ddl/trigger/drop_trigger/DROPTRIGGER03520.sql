...
-- primary_obligation_id: DROPTRIGGER-EXT|03520|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON public.droptrigger_03520_t;
-- primary-target-end
