...
-- primary_obligation_id: DROPTRIGGER-EXT|04008|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_04008_t;
-- primary-target-end
