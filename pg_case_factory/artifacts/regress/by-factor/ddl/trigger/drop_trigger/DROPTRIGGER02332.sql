...
-- primary_obligation_id: DROPTRIGGER-EXT|02332|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON public.droptrigger_02332_t RESTRICT;
-- primary-target-end
