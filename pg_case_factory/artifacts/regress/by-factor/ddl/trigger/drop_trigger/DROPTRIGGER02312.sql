...
-- primary_obligation_id: DROPTRIGGER-EXT|02312|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER "select" ON "droptrigger_02312_qt" RESTRICT;
-- primary-target-end
