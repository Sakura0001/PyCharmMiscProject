...
-- primary_obligation_id: DROPTRIGGER-EXT|04005|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_04005_t;
-- primary-target-end
