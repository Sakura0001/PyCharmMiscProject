...
-- primary_obligation_id: DROPTRIGGER-EXT|04026|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_04026_t;
-- primary-target-end
