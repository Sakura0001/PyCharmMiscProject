...
-- primary_obligation_id: DROPTRIGGER-EXT|02765|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_02765_t RESTRICT;
-- primary-target-end
