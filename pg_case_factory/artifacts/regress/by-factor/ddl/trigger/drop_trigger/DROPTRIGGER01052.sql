...
-- primary_obligation_id: DROPTRIGGER-EXT|01052|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER "select" ON droptrigger_01052_t CASCADE;
-- primary-target-end
