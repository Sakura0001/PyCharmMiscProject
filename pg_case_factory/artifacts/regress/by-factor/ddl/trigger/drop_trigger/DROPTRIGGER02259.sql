...
-- primary_obligation_id: DROPTRIGGER-EXT|02259|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER "select" ON "droptrigger_02259_qt" RESTRICT;
-- primary-target-end
