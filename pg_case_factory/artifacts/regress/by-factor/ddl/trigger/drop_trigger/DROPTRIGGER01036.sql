...
-- primary_obligation_id: DROPTRIGGER-EXT|01036|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON public.droptrigger_01036_t CASCADE;
-- primary-target-end
