...
-- primary_obligation_id: DROPTRIGGER-EXT|01523|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_01523_t CASCADE;
-- primary-target-end
