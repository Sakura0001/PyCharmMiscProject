...
-- primary_obligation_id: DROPTRIGGER-EXT|03556|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON "droptrigger_03556_qt";
-- primary-target-end
