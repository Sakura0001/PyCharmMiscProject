...
-- primary_obligation_id: DROPTRIGGER-EXT|01506|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON "droptrigger_01506_qt" CASCADE;
-- primary-target-end
