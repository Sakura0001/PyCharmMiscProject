...
-- primary_obligation_id: DROPTRIGGER-EXT|03503|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER "select" ON "droptrigger_03503_qt";
-- primary-target-end
