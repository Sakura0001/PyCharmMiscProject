...
-- primary_obligation_id: DROPTRIGGER-EXT|02298|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER "select" ON droptrigger_02298_t RESTRICT;
-- primary-target-end
