...
-- primary_obligation_id: DROPTRIGGER-EXT|01038|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER "select" ON public.droptrigger_01038_t CASCADE;
-- primary-target-end
