...
-- primary_obligation_id: DROPTRIGGER-EXT|02277|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER "select" ON public.droptrigger_02277_t RESTRICT;
-- primary-target-end
