...
-- primary_obligation_id: DROPTRIGGER-EXT|01089|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER "select" ON public.droptrigger_01089_t CASCADE;
-- primary-target-end
