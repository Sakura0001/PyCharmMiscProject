...
-- primary_obligation_id: DROPTRIGGER-EXT|01452|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON "droptrigger_01452_qt" CASCADE;
-- primary-target-end
