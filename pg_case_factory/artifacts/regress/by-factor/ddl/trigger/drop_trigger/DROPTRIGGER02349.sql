...
-- primary_obligation_id: DROPTRIGGER-EXT|02349|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER "select" ON droptrigger_02349_t RESTRICT;
-- primary-target-end
