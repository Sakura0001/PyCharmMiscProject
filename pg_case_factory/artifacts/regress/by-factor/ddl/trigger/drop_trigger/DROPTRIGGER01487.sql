...
-- primary_obligation_id: DROPTRIGGER-EXT|01487|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_01487_t CASCADE;
-- primary-target-end
