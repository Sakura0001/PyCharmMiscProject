...
-- primary_obligation_id: DROPTRIGGER-EXT|03971|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_03971_t;
-- primary-target-end
