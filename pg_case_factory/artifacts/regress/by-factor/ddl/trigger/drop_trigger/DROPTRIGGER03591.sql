...
-- primary_obligation_id: DROPTRIGGER-EXT|03591|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER "select" ON droptrigger_03591_t;
-- primary-target-end
