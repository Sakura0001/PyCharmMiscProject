...
-- primary_obligation_id: DROPTRIGGER-EXT|03554|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER "select" ON "droptrigger_03554_qt";
-- primary-target-end
