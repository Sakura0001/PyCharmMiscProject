...
-- primary_obligation_id: DROPTRIGGER-EXT|01037|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER "select" ON public.droptrigger_01037_t CASCADE;
-- primary-target-end
