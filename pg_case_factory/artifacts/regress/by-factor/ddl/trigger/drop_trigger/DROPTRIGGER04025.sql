...
-- primary_obligation_id: DROPTRIGGER-EXT|04025|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_04025_t;
-- primary-target-end
