...
-- primary_obligation_id: DROPTRIGGER-EXT|01378|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_01378_t CASCADE;
-- primary-target-end
