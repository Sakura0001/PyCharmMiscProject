...
-- primary_obligation_id: DROPTRIGGER-EXT|03572|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER "select" ON public.droptrigger_03572_t;
-- primary-target-end
