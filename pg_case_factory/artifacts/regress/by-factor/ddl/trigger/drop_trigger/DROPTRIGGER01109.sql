...
-- primary_obligation_id: DROPTRIGGER-EXT|01109|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER "select" ON droptrigger_01109_t CASCADE;
-- primary-target-end
