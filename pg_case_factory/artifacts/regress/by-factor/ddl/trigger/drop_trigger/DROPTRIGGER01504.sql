...
-- primary_obligation_id: DROPTRIGGER-EXT|01504|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON "droptrigger_01504_qt" CASCADE;
-- primary-target-end
