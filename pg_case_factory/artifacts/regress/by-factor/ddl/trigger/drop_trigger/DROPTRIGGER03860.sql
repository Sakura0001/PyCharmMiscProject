...
-- primary_obligation_id: DROPTRIGGER-EXT|03860|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_03860_t;
-- primary-target-end
