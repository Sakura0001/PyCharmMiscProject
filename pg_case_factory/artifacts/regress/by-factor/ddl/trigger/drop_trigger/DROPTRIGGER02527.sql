...
-- primary_obligation_id: DROPTRIGGER-EXT|02527|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON "droptrigger_02527_qt" RESTRICT;
-- primary-target-end
