...
-- primary_obligation_id: DROPTRIGGER-EXT|03769|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON "droptrigger_03769_qt";
-- primary-target-end
