...
-- primary_obligation_id: DROPTRIGGER-EXT|01034|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER "select" ON public.droptrigger_01034_t CASCADE;
-- primary-target-end
