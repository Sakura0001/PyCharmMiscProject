...
-- primary_obligation_id: DROPTRIGGER-EXT|02710|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_02710_t RESTRICT;
-- primary-target-end
