...
-- primary_obligation_id: DROPTRIGGER-EXT|01326|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_01326_t CASCADE;
-- primary-target-end
