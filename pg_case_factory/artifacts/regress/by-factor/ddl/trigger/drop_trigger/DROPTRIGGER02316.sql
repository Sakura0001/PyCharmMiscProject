...
-- primary_obligation_id: DROPTRIGGER-EXT|02316|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER "select" ON "droptrigger_02316_qt" RESTRICT;
-- primary-target-end
