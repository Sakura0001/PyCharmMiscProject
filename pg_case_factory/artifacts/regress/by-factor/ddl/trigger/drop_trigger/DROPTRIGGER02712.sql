...
-- primary_obligation_id: DROPTRIGGER-EXT|02712|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_02712_t RESTRICT;
-- primary-target-end
