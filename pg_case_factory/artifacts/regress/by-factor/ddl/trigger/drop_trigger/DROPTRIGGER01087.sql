...
-- primary_obligation_id: DROPTRIGGER-EXT|01087|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON public.droptrigger_01087_t CASCADE;
-- primary-target-end
