...
-- primary_obligation_id: DROPTRIGGER-EXT|02532|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON "droptrigger_02532_qt" RESTRICT;
-- primary-target-end
