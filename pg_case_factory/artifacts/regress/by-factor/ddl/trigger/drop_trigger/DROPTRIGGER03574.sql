...
-- primary_obligation_id: DROPTRIGGER-EXT|03574|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON public.droptrigger_03574_t;
-- primary-target-end
