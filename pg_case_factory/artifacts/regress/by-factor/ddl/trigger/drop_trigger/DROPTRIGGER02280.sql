...
-- primary_obligation_id: DROPTRIGGER-EXT|02280|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER "select" ON public.droptrigger_02280_t RESTRICT;
-- primary-target-end
