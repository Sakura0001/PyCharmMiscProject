...
-- primary_obligation_id: DROPTRIGGER-EXT|03537|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER "select" ON droptrigger_03537_t;
-- primary-target-end
