...
-- primary_obligation_id: DROPTRIGGER-EXT|02315|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER "select" ON "droptrigger_02315_qt" RESTRICT;
-- primary-target-end
