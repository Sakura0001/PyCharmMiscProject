...
-- primary_obligation_id: DROPTRIGGER-EXT|02278|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON public.droptrigger_02278_t RESTRICT;
-- primary-target-end
