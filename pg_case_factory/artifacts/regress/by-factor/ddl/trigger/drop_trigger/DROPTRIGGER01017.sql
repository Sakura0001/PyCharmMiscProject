...
-- primary_obligation_id: DROPTRIGGER-EXT|01017|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER "select" ON "droptrigger_01017_qt" CASCADE;
-- primary-target-end
