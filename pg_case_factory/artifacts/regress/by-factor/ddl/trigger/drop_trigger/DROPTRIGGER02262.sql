...
-- primary_obligation_id: DROPTRIGGER-EXT|02262|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER "select" ON "droptrigger_02262_qt" RESTRICT;
-- primary-target-end
