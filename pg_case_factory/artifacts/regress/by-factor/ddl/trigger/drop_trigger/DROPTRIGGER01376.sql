...
-- primary_obligation_id: DROPTRIGGER-EXT|01376|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_01376_t CASCADE;
-- primary-target-end
