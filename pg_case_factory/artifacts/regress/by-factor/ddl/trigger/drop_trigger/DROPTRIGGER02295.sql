...
-- primary_obligation_id: DROPTRIGGER-EXT|02295|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER "select" ON droptrigger_02295_t RESTRICT;
-- primary-target-end
