...
-- primary_obligation_id: DROPTRIGGER-EXT|04024|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_04024_t;
-- primary-target-end
