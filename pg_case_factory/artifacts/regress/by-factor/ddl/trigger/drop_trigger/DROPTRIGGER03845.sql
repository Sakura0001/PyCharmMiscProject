...
-- primary_obligation_id: DROPTRIGGER-EXT|03845|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_03845_t;
-- primary-target-end
