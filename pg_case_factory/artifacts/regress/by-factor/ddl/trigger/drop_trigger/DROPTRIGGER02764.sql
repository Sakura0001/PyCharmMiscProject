...
-- primary_obligation_id: DROPTRIGGER-EXT|02764|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_02764_t RESTRICT;
-- primary-target-end
