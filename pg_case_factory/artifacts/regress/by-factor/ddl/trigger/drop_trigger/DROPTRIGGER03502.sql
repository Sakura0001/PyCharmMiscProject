...
-- primary_obligation_id: DROPTRIGGER-EXT|03502|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER "select" ON "droptrigger_03502_qt";
-- primary-target-end
