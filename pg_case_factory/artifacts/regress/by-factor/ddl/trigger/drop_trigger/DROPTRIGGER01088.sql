...
-- primary_obligation_id: DROPTRIGGER-EXT|01088|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER "select" ON public.droptrigger_01088_t CASCADE;
-- primary-target-end
