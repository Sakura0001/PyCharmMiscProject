...
-- primary_obligation_id: DROPTRIGGER-EXT|02568|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_02568_t RESTRICT;
-- primary-target-end
