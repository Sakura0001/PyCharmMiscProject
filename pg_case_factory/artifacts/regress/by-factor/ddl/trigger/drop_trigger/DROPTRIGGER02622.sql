...
-- primary_obligation_id: DROPTRIGGER-EXT|02622|drop_trigger|information_schema_triggers|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_02622_t RESTRICT;
-- primary-target-end
