...
-- primary_obligation_id: DROPTRIGGER-EXT|03843|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON public.droptrigger_03843_t;
-- primary-target-end
