...
-- primary_obligation_id: DROPTRIGGER-EXT|01541|drop_trigger|information_schema_triggers|DROP_TRIGGER_if_exists_cascade
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_01541_t CASCADE;
-- primary-target-end
