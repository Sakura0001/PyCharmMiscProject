...
-- primary_obligation_id: DROPTRIGGER-EXT|02565|drop_trigger|pg_trigger_catalog_query|no_cleanup_needed
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_02565_t RESTRICT;
-- primary-target-end
