...
-- primary_obligation_id: DROPTRIGGER-EXT|01375|drop_trigger|pg_trigger_catalog_query|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_01375_t CASCADE;
-- primary-target-end
