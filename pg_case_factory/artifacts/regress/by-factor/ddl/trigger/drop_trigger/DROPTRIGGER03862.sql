...
-- primary_obligation_id: DROPTRIGGER-EXT|03862|drop_trigger|information_schema_triggers|DROP_TRIGGER_cascade
...
DROP TRIGGER IF EXISTS "select" ON droptrigger_03862_t;
-- primary-target-end
