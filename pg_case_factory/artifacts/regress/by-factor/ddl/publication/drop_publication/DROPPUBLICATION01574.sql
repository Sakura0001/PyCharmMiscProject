...
-- primary_obligation_id: DROPPUBLICATION-EXT|01574|drop_publication|pg_publication_catalog|drop_subscription_then_drop_publication
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP PUBLICATION IF EXISTS droppublication_01574_pub;
...
SELECT count(*) = 0 AS publication_absent FROM pg_catalog.pg_publication WHERE pubname = 'droppublication_01574_pub' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
DROP PUBLICATION IF EXISTS droppublication_01574_pub;
