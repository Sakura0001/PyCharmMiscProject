...
-- primary_obligation_id: DROPPUBLICATION-EXT|01538|drop_publication|pg_publication_catalog|drop_subscription_then_drop_publication
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP PUBLICATION IF EXISTS "droppublication_01538_all";
...
SELECT count(*) = 0 AS publication_absent FROM pg_catalog.pg_publication WHERE pubname = 'droppublication_01538_all' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
DROP PUBLICATION IF EXISTS "droppublication_01538_all";
