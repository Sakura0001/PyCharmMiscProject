...
-- primary_obligation_id: AP-EXT|02664|security_invoker|information_schema_routines|DROP_PROCEDURE_IF_EXISTS
...
ALTER PROCEDURE "alterprocedure_02664_select"(integer) SECURITY INVOKER;
-- primary-target-end
...
SELECT r.routine_schema, r.routine_name, r.routine_type FROM information_schema.routines AS r WHERE r.routine_name = 'alterprocedure_02664_select' ORDER BY r.routine_schema, r.routine_name;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
