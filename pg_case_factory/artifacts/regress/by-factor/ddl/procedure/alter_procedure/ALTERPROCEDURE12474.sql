...
-- primary_obligation_id: AP-EXT|12474|set_parameter|information_schema_routines|DROP_PROCEDURE_IF_EXISTS
...
ALTER PROCEDURE alterprocedure_12474_proc SET work_mem TO 100 RESTRICT;
-- primary-target-end
...
SELECT r.routine_schema, r.routine_name, r.routine_type FROM information_schema.routines AS r WHERE r.routine_name = 'alterprocedure_12474_proc' ORDER BY r.routine_schema, r.routine_name;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
