...
-- primary_obligation_id: AP-EXT|12140|security_definer|information_schema_routines|DROP_PROCEDURE
...
ALTER PROCEDURE "alterprocedure_12140_Mixed Procedure" SECURITY DEFINER;
-- primary-target-end
...
SELECT r.routine_schema, r.routine_name, r.routine_type FROM information_schema.routines AS r WHERE r.routine_name = 'alterprocedure_12140_Mixed Procedure' ORDER BY r.routine_schema, r.routine_name;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
