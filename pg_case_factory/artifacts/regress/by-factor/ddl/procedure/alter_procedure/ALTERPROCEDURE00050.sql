...
-- primary_obligation_id: AP-SFV|sfv-d2fd68f3621045da7692c359|security_invoker
...
ALTER PROCEDURE alterprocedure_00050_proc(integer) SECURITY INVOKER;
-- primary-target-end
...
SELECT p.prokind, p.prosecdef FROM pg_catalog.pg_proc AS p WHERE p.proname = 'alterprocedure_00050_proc' ORDER BY p.proname, p.oid;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
