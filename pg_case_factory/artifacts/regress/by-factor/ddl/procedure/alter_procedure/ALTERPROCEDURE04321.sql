...
-- primary_obligation_id: AP-EXT|04321|owner|information_schema_routines|DROP_PROCEDURE_CASCADE
...
ALTER PROCEDURE "alterprocedure_04321_select"(integer) OWNER TO CURRENT_USER;
-- primary-target-end
...
SELECT r.routine_schema, r.routine_name, r.routine_type FROM information_schema.routines AS r WHERE r.routine_name = 'alterprocedure_04321_select' ORDER BY r.routine_schema, r.routine_name;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
