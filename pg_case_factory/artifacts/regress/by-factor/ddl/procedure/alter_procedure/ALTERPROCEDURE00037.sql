...
-- version      : 1.0
-- description  : ALTER PROCEDURE expected_status=failure
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ALTERPROCEDURE00037
...
-- primary_obligation_id: AP-SFV|sfv-9905a9e8050161b7b4db5aa7|security_invoker
...
ALTER PROCEDURE alterprocedure_00037_proc(integer) SECURITY INVOKER;
-- primary-target-end
...
SELECT p.prokind, p.prosecdef FROM pg_catalog.pg_proc AS p WHERE p.proname = 'alterprocedure_00037_proc' ORDER BY p.proname, p.oid;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
