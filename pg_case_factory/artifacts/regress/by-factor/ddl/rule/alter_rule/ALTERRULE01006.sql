...
-- primary_obligation_id: AR-EXT|01006|error_assertion|drop_table
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP VIEW IF EXISTS alterrule_01006_no_such_view CASCADE;
...
ALTER RULE alterrule_01006_existing_rule ON alterrule_01006_no_such_view RENAME TO alterrule_01006_renamed;
-- primary-target-end
