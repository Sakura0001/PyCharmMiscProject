...
-- primary_obligation_id: AR-EXT|01004|error_assertion|drop_rule
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP VIEW IF EXISTS alterrule_01004_no_such_view CASCADE;
...
ALTER RULE alterrule_01004_existing_rule ON alterrule_01004_no_such_view RENAME TO alterrule_01004_renamed;
-- primary-target-end
