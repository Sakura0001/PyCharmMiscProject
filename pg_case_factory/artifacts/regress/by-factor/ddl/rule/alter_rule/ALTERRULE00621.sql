...
-- primary_obligation_id: AR-EXT|00621|error_assertion|drop_view
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS alterrule_00621_no_such_table CASCADE;
...
ALTER RULE alterrule_00621_existing_rule ON alterrule_00621_no_such_table RENAME TO "alterrule_00621_Mixed Name";
-- primary-target-end
