...
-- primary_obligation_id: AR-EXT|00651|error_assertion|revert_rename
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS alterrule_00651_no_such_table CASCADE;
...
ALTER RULE alterrule_00651_rule ON alterrule_00651_no_such_table RENAME TO "alterrule_00651_Mixed Name";
-- primary-target-end
