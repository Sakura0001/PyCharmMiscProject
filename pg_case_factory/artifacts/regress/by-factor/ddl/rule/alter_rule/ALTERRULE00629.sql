...
-- primary_obligation_id: AR-EXT|00629|error_assertion|drop_view
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP VIEW IF EXISTS alterrule_00629_no_such_view CASCADE;
...
ALTER RULE alterrule_00629_existing_rule ON alterrule_00629_no_such_view RENAME TO "alterrule_00629_Mixed Name";
-- primary-target-end
