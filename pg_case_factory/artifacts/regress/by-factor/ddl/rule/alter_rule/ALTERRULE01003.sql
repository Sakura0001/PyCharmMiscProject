...
-- primary_obligation_id: AR-EXT|01003|error_assertion|revert_rename
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP VIEW IF EXISTS alterrule_01003_no_such_view CASCADE;
...
ALTER RULE alterrule_01003_existing_rule ON alterrule_01003_no_such_view RENAME TO alterrule_01003_renamed;
-- primary-target-end
