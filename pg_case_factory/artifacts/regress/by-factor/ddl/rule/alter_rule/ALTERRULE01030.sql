...
-- primary_obligation_id: AR-EXT|01030|error_assertion|drop_table
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS alterrule_01030_no_such_table CASCADE;
...
ALTER RULE alterrule_01030_rule ON alterrule_01030_no_such_table RENAME TO alterrule_01030_renamed;
-- primary-target-end
