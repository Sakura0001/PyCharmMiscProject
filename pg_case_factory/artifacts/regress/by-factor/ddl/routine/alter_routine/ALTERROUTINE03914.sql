...
-- primary_obligation_id: AR-EXT|03914|security_invoker|error_assertion|drop_aggregate
...
ALTER ROUTINE alterroutine_03914_routine SECURITY INVOKER RESTRICT;
-- primary-target-end
