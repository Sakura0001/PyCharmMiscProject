...
-- primary_obligation_id: AR-EXT|03913|security_invoker|error_assertion|drop_procedure
...
ALTER ROUTINE alterroutine_03913_routine SECURITY INVOKER RESTRICT;
-- primary-target-end
