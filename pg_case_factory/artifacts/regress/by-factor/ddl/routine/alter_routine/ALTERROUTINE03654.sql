...
-- primary_obligation_id: AR-EXT|03654|security_invoker|error_assertion|drop_aggregate
...
ALTER ROUTINE alterroutine_03654_routine SECURITY INVOKER;
-- primary-target-end
