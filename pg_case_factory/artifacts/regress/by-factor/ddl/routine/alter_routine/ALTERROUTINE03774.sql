...
-- primary_obligation_id: AR-EXT|03774|volatile|error_assertion|drop_aggregate
...
ALTER ROUTINE alterroutine_03774_routine VOLATILE RESTRICT;
-- primary-target-end
