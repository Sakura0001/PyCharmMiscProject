...
-- primary_obligation_id: AR-EXT|03953|depends_on_extension|error_assertion|drop_procedure
...
ALTER ROUTINE alterroutine_03953_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
