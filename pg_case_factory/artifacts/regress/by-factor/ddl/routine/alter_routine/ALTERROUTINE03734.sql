...
-- primary_obligation_id: AR-EXT|03734|security_invoker|error_assertion|drop_aggregate
...
ALTER ROUTINE alterroutine_03734_routine SECURITY INVOKER;
-- primary-target-end
