...
-- primary_obligation_id: AR-EXT|03731|security_invoker|error_assertion|drop_routine
...
ALTER ROUTINE alterroutine_03731_routine SECURITY INVOKER;
-- primary-target-end
