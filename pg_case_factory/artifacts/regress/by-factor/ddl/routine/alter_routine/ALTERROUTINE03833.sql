...
-- primary_obligation_id: AR-EXT|03833|security_invoker|error_assertion|drop_procedure
...
ALTER ROUTINE alterroutine_03833_routine SECURITY INVOKER RESTRICT;
-- primary-target-end
