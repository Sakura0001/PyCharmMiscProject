...
-- primary_obligation_id: AR-EXT|03874|volatile|error_assertion|drop_aggregate
...
ALTER ROUTINE alterroutine_03874_routine VOLATILE RESTRICT;
-- primary-target-end
