...
-- primary_obligation_id: AR-EXT|04651|depends_on_extension|error_assertion|drop_routine
...
ALTER ROUTINE alterroutine_04651_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
