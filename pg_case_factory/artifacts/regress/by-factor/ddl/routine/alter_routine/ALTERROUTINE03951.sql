...
-- primary_obligation_id: AR-EXT|03951|depends_on_extension|error_assertion|drop_routine
...
ALTER ROUTINE alterroutine_03951_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
