...
-- primary_obligation_id: AR-EXT|04054|owner|error_assertion|drop_aggregate
...
ALTER ROUTINE alterroutine_04054_routine OWNER TO CURRENT_ROLE;
-- primary-target-end
