...
-- primary_obligation_id: AR-EXT|04194|owner|error_assertion|drop_aggregate
...
ALTER ROUTINE alterroutine_04194_routine OWNER TO SESSION_USER;
-- primary-target-end
