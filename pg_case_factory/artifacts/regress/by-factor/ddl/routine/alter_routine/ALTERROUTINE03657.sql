...
-- primary_obligation_id: AR-EXT|03657|set_config_parameter|pg_proc_catalog|drop_function
...
ALTER ROUTINE alterroutine_03657_routine SET alterroutine_03657_work_mem TO 100;
-- primary-target-end
...
SELECT p.proname, p.prokind, p.proowner::regrole, p.proleakproof, p.prosecdef, p.proparallel FROM pg_catalog.pg_proc AS p WHERE p.proname = 'alterroutine_03657_routine' ORDER BY p.proname, p.oid;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
