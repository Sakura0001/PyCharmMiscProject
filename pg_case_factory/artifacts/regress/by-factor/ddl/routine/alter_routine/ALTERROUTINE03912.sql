...
-- primary_obligation_id: AR-EXT|03912|security_invoker|error_assertion|drop_function
...
ALTER ROUTINE alterroutine_03912_routine SECURITY INVOKER RESTRICT;
-- primary-target-end
