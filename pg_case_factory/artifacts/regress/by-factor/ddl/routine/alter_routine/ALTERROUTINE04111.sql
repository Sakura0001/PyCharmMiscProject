...
-- primary_obligation_id: AR-EXT|04111|owner|error_assertion|drop_routine
...
ALTER ROUTINE alterroutine_04111_routine OWNER TO CURRENT_USER;
-- primary-target-end
