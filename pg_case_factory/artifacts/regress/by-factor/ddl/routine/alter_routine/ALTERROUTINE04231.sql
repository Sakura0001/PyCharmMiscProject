...
-- primary_obligation_id: AR-EXT|04231|owner|error_assertion|drop_routine
...
ALTER ROUTINE alterroutine_04231_routine OWNER TO SESSION_USER;
-- primary-target-end
