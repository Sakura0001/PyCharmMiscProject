...
-- primary_obligation_id: AR-EXT|03792|leakproof|error_assertion|drop_function
...
ALTER ROUTINE alterroutine_03792_routine LEAKPROOF RESTRICT;
-- primary-target-end
