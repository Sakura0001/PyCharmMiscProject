...
-- primary_obligation_id: AR-EXT|04112|owner|error_assertion|drop_function
...
ALTER ROUTINE alterroutine_04112_routine OWNER TO CURRENT_USER;
-- primary-target-end
