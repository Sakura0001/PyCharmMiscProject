...
-- primary_obligation_id: AR-EXT|04011|owner|error_assertion|drop_routine
...
ALTER ROUTINE alterroutine_04011_routine OWNER TO CURRENT_ROLE;
-- primary-target-end
