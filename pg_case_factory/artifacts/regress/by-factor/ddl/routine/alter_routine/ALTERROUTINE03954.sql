...
-- primary_obligation_id: AR-EXT|03954|depends_on_extension|error_assertion|drop_aggregate
...
ALTER ROUTINE alterroutine_03954_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
