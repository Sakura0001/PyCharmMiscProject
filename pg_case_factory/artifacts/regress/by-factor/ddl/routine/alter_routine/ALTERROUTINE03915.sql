...
-- primary_obligation_id: AR-EXT|03915|security_invoker|error_assertion|reset_config_parameter
...
ALTER ROUTINE alterroutine_03915_routine SECURITY INVOKER RESTRICT;
-- primary-target-end
