...
-- primary_obligation_id: AR-EXT|04234|owner|error_assertion|drop_aggregate
...
ALTER ROUTINE alterroutine_04234_routine OWNER TO SESSION_USER;
-- primary-target-end
