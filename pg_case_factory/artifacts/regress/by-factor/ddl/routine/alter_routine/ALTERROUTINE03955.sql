...
-- primary_obligation_id: AR-EXT|03955|depends_on_extension|error_assertion|reset_config_parameter
...
ALTER ROUTINE alterroutine_03955_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
