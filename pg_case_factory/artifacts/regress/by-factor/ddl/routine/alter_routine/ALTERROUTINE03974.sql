...
-- primary_obligation_id: AR-EXT|03974|depends_on_extension|error_assertion|drop_aggregate
...
ALTER ROUTINE alterroutine_03974_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
