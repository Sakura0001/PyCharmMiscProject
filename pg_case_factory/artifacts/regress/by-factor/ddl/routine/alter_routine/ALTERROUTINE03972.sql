...
-- primary_obligation_id: AR-EXT|03972|depends_on_extension|error_assertion|drop_function
...
ALTER ROUTINE alterroutine_03972_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
