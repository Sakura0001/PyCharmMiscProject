...
-- primary_obligation_id: AR-EXT|03892|security_definer|error_assertion|drop_function
...
ALTER ROUTINE alterroutine_03892_routine SECURITY DEFINER RESTRICT;
-- primary-target-end
