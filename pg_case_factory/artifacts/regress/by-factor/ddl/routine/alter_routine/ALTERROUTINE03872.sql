...
-- primary_obligation_id: AR-EXT|03872|volatile|error_assertion|drop_function
...
ALTER ROUTINE alterroutine_03872_routine VOLATILE RESTRICT;
-- primary-target-end
