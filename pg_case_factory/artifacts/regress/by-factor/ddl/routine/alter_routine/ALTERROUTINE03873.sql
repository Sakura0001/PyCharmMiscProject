...
-- primary_obligation_id: AR-EXT|03873|volatile|error_assertion|drop_procedure
...
ALTER ROUTINE alterroutine_03873_routine VOLATILE RESTRICT;
-- primary-target-end
