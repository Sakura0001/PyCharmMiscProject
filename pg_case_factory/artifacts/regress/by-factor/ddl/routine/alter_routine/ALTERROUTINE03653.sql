...
-- primary_obligation_id: AR-EXT|03653|security_invoker|error_assertion|drop_procedure
...
ALTER ROUTINE alterroutine_03653_routine SECURITY INVOKER;
-- primary-target-end
