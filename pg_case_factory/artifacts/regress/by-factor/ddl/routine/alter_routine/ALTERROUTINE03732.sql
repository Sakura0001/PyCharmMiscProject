...
-- primary_obligation_id: AR-EXT|03732|security_invoker|error_assertion|drop_function
...
ALTER ROUTINE alterroutine_03732_routine SECURITY INVOKER;
-- primary-target-end
