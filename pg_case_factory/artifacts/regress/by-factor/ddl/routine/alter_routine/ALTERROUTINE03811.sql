...
-- primary_obligation_id: AR-EXT|03811|security_definer|error_assertion|drop_routine
...
ALTER ROUTINE alterroutine_03811_routine SECURITY DEFINER RESTRICT;
-- primary-target-end
