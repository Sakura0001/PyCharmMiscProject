...
-- primary_obligation_id: ALTERROUTINE-SFV|sfv-a71dffde1baedeaff299bb15|volatile
...
ALTER ROUTINE alterroutine_00099_routine VOLATILE;
-- primary-target-end
...
SELECT p.proname, p.prokind, p.proowner::regrole, p.proleakproof, p.prosecdef, p.proparallel FROM pg_catalog.pg_proc AS p WHERE p.proname = 'alterroutine_00099_routine' ORDER BY p.proname, p.oid;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
