...
-- primary_obligation_id: AR-EXT|03814|security_definer|error_assertion|drop_aggregate
...
ALTER ROUTINE alterroutine_03814_routine SECURITY DEFINER RESTRICT;
-- primary-target-end
