...
-- primary_obligation_id: AR-EXT|04013|owner|error_assertion|drop_procedure
...
ALTER ROUTINE alterroutine_04013_routine OWNER TO CURRENT_ROLE;
-- primary-target-end
