...
-- primary_obligation_id: AR-EXT|03832|security_invoker|error_assertion|drop_function
...
ALTER ROUTINE alterroutine_03832_routine SECURITY INVOKER RESTRICT;
-- primary-target-end
