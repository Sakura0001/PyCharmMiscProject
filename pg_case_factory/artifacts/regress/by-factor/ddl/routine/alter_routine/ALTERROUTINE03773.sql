...
-- primary_obligation_id: AR-EXT|03773|volatile|error_assertion|drop_procedure
...
ALTER ROUTINE alterroutine_03773_routine VOLATILE RESTRICT;
-- primary-target-end
