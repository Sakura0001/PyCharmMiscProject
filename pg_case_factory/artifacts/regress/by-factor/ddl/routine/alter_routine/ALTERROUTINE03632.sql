...
-- primary_obligation_id: AR-EXT|03632|security_definer|error_assertion|drop_function
...
ALTER ROUTINE alterroutine_03632_routine SECURITY DEFINER;
-- primary-target-end
