...
-- primary_obligation_id: AR-EXT|03651|security_invoker|error_assertion|drop_routine
...
ALTER ROUTINE alterroutine_03651_routine SECURITY INVOKER;
-- primary-target-end
