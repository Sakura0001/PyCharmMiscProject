...
-- primary_obligation_id: AR-EXT|04652|depends_on_extension|error_assertion|drop_function
...
ALTER ROUTINE alterroutine_04652_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
