...
-- primary_obligation_id: AR-EXT|04074|owner|error_assertion|drop_aggregate
...
ALTER ROUTINE alterroutine_04074_routine OWNER TO CURRENT_USER;
-- primary-target-end
