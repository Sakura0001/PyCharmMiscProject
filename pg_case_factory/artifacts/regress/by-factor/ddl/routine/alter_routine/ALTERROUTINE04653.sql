...
-- primary_obligation_id: AR-EXT|04653|depends_on_extension|error_assertion|drop_procedure
...
ALTER ROUTINE alterroutine_04653_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
