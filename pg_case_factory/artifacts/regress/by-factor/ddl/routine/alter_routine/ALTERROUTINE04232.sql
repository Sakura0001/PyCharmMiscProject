...
-- primary_obligation_id: AR-EXT|04232|owner|error_assertion|drop_function
...
ALTER ROUTINE alterroutine_04232_routine OWNER TO SESSION_USER;
-- primary-target-end
