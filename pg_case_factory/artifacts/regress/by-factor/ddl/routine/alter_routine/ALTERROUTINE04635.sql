...
-- primary_obligation_id: AR-EXT|04635|depends_on_extension|error_assertion|reset_config_parameter
...
ALTER ROUTINE alterroutine_04635_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
