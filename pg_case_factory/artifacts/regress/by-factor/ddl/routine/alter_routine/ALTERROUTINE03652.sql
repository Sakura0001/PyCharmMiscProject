...
-- primary_obligation_id: AR-EXT|03652|security_invoker|error_assertion|drop_function
...
ALTER ROUTINE alterroutine_03652_routine SECURITY INVOKER;
-- primary-target-end
