...
-- primary_obligation_id: AR-EXT|01872|volatile|error_assertion|drop_function
-- expected_outcome: expected_failure
-- expected_sqlstate: 42883
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP ROLE IF EXISTS alterroutine_01872_owner;
\set ON_ERROR_STOP on
-- 2. 创建完整本地过程和因子专用夹具。
CREATE ROLE alterroutine_01872_owner LOGIN;
GRANT CREATE ON SCHEMA public TO alterroutine_01872_owner;
SET ROLE alterroutine_01872_owner;
...
ALTER ROUTINE alterroutine_01872_routine VOLATILE;
-- primary-target-end
...
-- 5. 清理全部本编号对象。
RESET ROLE;
DROP OWNED BY alterroutine_01872_owner;
DROP ROLE IF EXISTS alterroutine_01872_owner;
