...
-- primary_obligation_id: AR-EXT|04033|owner|error_assertion|drop_procedure
...
ALTER ROUTINE alterroutine_04033_routine OWNER TO CURRENT_ROLE;
-- primary-target-end
