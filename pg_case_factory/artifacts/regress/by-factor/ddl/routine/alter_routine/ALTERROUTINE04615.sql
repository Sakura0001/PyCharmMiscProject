...
-- primary_obligation_id: AR-EXT|04615|depends_on_extension|error_assertion|reset_config_parameter
...
ALTER ROUTINE alterroutine_04615_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
