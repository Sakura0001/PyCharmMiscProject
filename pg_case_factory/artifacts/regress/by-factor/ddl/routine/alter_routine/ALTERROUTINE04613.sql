...
-- primary_obligation_id: AR-EXT|04613|depends_on_extension|error_assertion|drop_procedure
...
ALTER ROUTINE alterroutine_04613_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
