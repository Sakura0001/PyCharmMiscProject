...
-- primary_obligation_id: AR-EXT|04356|rename|pg_proc_catalog|drop_routine
...
ALTER ROUTINE alterroutine_04356_routine RENAME TO alterroutine_04356_renamed;
-- primary-target-end
...
SELECT p.proname, p.prokind, p.proowner::regrole, p.proleakproof, p.prosecdef, p.proparallel FROM pg_catalog.pg_proc AS p WHERE p.proname = 'alterroutine_04356_routine' ORDER BY p.proname, p.oid;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
