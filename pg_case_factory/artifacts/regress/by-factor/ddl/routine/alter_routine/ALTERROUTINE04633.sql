...
-- primary_obligation_id: AR-EXT|04633|depends_on_extension|error_assertion|drop_procedure
...
ALTER ROUTINE alterroutine_04633_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
