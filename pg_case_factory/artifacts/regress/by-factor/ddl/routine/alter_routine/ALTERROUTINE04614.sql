...
-- primary_obligation_id: AR-EXT|04614|depends_on_extension|error_assertion|drop_aggregate
...
ALTER ROUTINE alterroutine_04614_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
