...
-- primary_obligation_id: AR-EXT|04611|depends_on_extension|error_assertion|drop_routine
...
ALTER ROUTINE alterroutine_04611_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
