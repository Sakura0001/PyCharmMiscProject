...
-- primary_obligation_id: AR-EXT|03973|depends_on_extension|error_assertion|drop_procedure
...
ALTER ROUTINE alterroutine_03973_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
