...
-- primary_obligation_id: AR-EXT|04052|owner|error_assertion|drop_function
...
ALTER ROUTINE alterroutine_04052_routine OWNER TO CURRENT_ROLE;
-- primary-target-end
