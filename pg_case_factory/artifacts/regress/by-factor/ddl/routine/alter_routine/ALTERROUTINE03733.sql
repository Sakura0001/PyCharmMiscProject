...
-- primary_obligation_id: AR-EXT|03733|security_invoker|error_assertion|drop_procedure
...
ALTER ROUTINE alterroutine_03733_routine SECURITY INVOKER;
-- primary-target-end
