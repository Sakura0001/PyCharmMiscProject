...
-- primary_obligation_id: AR-EXT|03995|depends_on_extension|error_assertion|reset_config_parameter
...
ALTER ROUTINE alterroutine_03995_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
