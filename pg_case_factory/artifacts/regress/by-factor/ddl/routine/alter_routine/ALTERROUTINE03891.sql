...
-- primary_obligation_id: AR-EXT|03891|security_definer|error_assertion|drop_routine
...
ALTER ROUTINE alterroutine_03891_routine SECURITY DEFINER RESTRICT;
-- primary-target-end
