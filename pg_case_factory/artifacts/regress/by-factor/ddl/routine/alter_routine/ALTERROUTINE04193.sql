...
-- primary_obligation_id: AR-EXT|04193|owner|error_assertion|drop_procedure
...
ALTER ROUTINE alterroutine_04193_routine OWNER TO SESSION_USER;
-- primary-target-end
