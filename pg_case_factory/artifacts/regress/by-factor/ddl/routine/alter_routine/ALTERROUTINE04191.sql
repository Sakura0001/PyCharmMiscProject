...
-- primary_obligation_id: AR-EXT|04191|owner|error_assertion|drop_routine
...
ALTER ROUTINE alterroutine_04191_routine OWNER TO SESSION_USER;
-- primary-target-end
