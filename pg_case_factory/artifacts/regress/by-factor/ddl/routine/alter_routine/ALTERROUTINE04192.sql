...
-- primary_obligation_id: AR-EXT|04192|owner|error_assertion|drop_function
...
ALTER ROUTINE alterroutine_04192_routine OWNER TO SESSION_USER;
-- primary-target-end
