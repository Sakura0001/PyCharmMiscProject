...
-- primary_obligation_id: AR-EXT|04053|owner|error_assertion|drop_procedure
...
ALTER ROUTINE alterroutine_04053_routine OWNER TO CURRENT_ROLE;
-- primary-target-end
