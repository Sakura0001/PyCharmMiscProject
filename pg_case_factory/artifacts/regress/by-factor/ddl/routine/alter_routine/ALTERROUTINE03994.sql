...
-- primary_obligation_id: AR-EXT|03994|depends_on_extension|error_assertion|drop_aggregate
...
ALTER ROUTINE alterroutine_03994_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
