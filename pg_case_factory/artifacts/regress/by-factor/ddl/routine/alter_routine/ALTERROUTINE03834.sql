...
-- primary_obligation_id: AR-EXT|03834|security_invoker|error_assertion|drop_aggregate
...
ALTER ROUTINE alterroutine_03834_routine SECURITY INVOKER RESTRICT;
-- primary-target-end
