...
-- primary_obligation_id: AR-EXT|03812|security_definer|error_assertion|drop_function
...
ALTER ROUTINE alterroutine_03812_routine SECURITY DEFINER RESTRICT;
-- primary-target-end
