...
-- primary_obligation_id: AR-EXT|04092|owner|error_assertion|drop_function
...
ALTER ROUTINE alterroutine_04092_routine OWNER TO CURRENT_USER;
-- primary-target-end
