...
-- primary_obligation_id: AR-EXT|04632|depends_on_extension|error_assertion|drop_function
...
ALTER ROUTINE alterroutine_04632_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
