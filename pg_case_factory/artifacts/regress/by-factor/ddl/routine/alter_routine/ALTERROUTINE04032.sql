...
-- primary_obligation_id: AR-EXT|04032|owner|error_assertion|drop_function
...
ALTER ROUTINE alterroutine_04032_routine OWNER TO CURRENT_ROLE;
-- primary-target-end
