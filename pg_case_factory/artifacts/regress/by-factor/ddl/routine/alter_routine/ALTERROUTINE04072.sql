...
-- primary_obligation_id: AR-EXT|04072|owner|error_assertion|drop_function
...
ALTER ROUTINE alterroutine_04072_routine OWNER TO CURRENT_USER;
-- primary-target-end
