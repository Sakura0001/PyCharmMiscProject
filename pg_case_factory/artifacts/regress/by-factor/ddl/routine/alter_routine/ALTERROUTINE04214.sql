...
-- primary_obligation_id: AR-EXT|04214|owner|error_assertion|drop_aggregate
...
ALTER ROUTINE alterroutine_04214_routine OWNER TO SESSION_USER;
-- primary-target-end
