...
-- primary_obligation_id: AR-EXT|03791|leakproof|error_assertion|drop_routine
...
ALTER ROUTINE alterroutine_03791_routine LEAKPROOF RESTRICT;
-- primary-target-end
