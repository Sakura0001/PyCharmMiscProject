...
-- primary_obligation_id: AR-EXT|03993|depends_on_extension|error_assertion|drop_procedure
...
ALTER ROUTINE alterroutine_03993_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
