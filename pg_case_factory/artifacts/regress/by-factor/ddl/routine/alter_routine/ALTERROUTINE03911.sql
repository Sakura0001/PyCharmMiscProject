...
-- primary_obligation_id: AR-EXT|03911|security_invoker|error_assertion|drop_routine
...
ALTER ROUTINE alterroutine_03911_routine SECURITY INVOKER RESTRICT;
-- primary-target-end
