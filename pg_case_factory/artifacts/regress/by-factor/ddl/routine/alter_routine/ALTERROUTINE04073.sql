...
-- primary_obligation_id: AR-EXT|04073|owner|error_assertion|drop_procedure
...
ALTER ROUTINE alterroutine_04073_routine OWNER TO CURRENT_USER;
-- primary-target-end
