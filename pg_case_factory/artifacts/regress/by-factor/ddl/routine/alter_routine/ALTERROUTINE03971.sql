...
-- primary_obligation_id: AR-EXT|03971|depends_on_extension|error_assertion|drop_routine
...
ALTER ROUTINE alterroutine_03971_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
