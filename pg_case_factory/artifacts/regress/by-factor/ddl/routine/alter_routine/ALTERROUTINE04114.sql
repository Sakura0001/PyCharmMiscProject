...
-- primary_obligation_id: AR-EXT|04114|owner|error_assertion|drop_aggregate
...
ALTER ROUTINE alterroutine_04114_routine OWNER TO CURRENT_USER;
-- primary-target-end
