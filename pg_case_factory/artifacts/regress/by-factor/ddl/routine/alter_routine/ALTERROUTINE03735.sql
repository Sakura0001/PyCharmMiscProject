...
-- primary_obligation_id: AR-EXT|03735|security_invoker|error_assertion|reset_config_parameter
...
ALTER ROUTINE alterroutine_03735_routine SECURITY INVOKER;
-- primary-target-end
