...
-- primary_obligation_id: AR-EXT|03991|depends_on_extension|error_assertion|drop_routine
...
ALTER ROUTINE alterroutine_03991_routine DEPENDS ON EXTENSION plpgsql;
-- primary-target-end
