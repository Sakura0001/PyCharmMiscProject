...
-- primary_obligation_id: DROPROUTINE-SFV|sfv-3474f24b66fbc0f2314349b1|drop_routine
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP ROUTINE IF EXISTS droproutine_00047_r CASCADE;
...
DROP ROUTINE droproutine_00047_r;
-- primary-target-end
...
SELECT count(*) = 0 AS routine_absent FROM pg_catalog.pg_proc WHERE proname = 'droproutine_00047_r' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
DROP ROUTINE IF EXISTS droproutine_00047_r CASCADE;
