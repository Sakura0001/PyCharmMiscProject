...
-- primary_obligation_id: DROPROUTINE-EXT|01398|drop_routine|pg_proc_catalog|cascade_drop_with_dependents
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP ROUTINE IF EXISTS droproutine_01398_r CASCADE;
...
SELECT count(*) = 0 AS routine_absent FROM pg_catalog.pg_proc WHERE proname = 'droproutine_01398_r' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
DROP ROUTINE IF EXISTS droproutine_01398_r CASCADE;
