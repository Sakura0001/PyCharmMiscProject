...
-- primary_obligation_id: AG-EXT|1203|add_user|pg_auth_members_catalog|drop_role
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP ROLE IF EXISTS altergroup_1203_grp;
DROP ROLE IF EXISTS "altergroup_1203_Usr";
DROP ROLE IF EXISTS "altergroup_1203_Usr2";
\set ON_ERROR_STOP on
-- 2. 创建完整本地角色和因子专用夹具。
CREATE ROLE altergroup_1203_grp;
CREATE ROLE "altergroup_1203_Usr";
CREATE ROLE "altergroup_1203_Usr2";
GRANT altergroup_1203_grp TO "altergroup_1203_Usr";
GRANT altergroup_1203_grp TO "altergroup_1203_Usr2";
-- 3. 执行唯一获得覆盖信用的 ALTER GROUP。
-- primary-target-begin
ALTER GROUP altergroup_1203_grp ADD USER "altergroup_1203_Usr", "altergroup_1203_Usr2";
-- primary-target-end
