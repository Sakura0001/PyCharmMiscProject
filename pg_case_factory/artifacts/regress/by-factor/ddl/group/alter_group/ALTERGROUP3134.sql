...
-- primary_obligation_id: AG-EXT|3134|drop_user|pg_auth_members_catalog|revert_rename
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP ROLE IF EXISTS "altergroup_3134_Grp";
DROP ROLE IF EXISTS altergroup_3134_usr;
DROP ROLE IF EXISTS altergroup_3134_usr2;
\set ON_ERROR_STOP on
-- 2. 创建完整本地角色和因子专用夹具。
CREATE ROLE "altergroup_3134_Grp";
CREATE ROLE altergroup_3134_usr;
CREATE ROLE altergroup_3134_usr2;
GRANT "altergroup_3134_Grp" TO altergroup_3134_usr;
GRANT "altergroup_3134_Grp" TO altergroup_3134_usr2;
-- 3. 执行唯一获得覆盖信用的 ALTER GROUP。
-- primary-target-begin
ALTER GROUP "altergroup_3134_Grp" DROP USER altergroup_3134_usr, altergroup_3134_usr2;
-- primary-target-end
