...
-- primary_obligation_id: AG-EXT|1308|add_user|pg_auth_members_catalog|revoke_membership
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP ROLE IF EXISTS "altergroup_1308_Grp";
DROP ROLE IF EXISTS altergroup_1308_usr;
DROP ROLE IF EXISTS altergroup_1308_usr2;
DROP ROLE IF EXISTS altergroup_1308_admin;
\set ON_ERROR_STOP on
-- 2. 创建完整本地角色和因子专用夹具。
CREATE ROLE "altergroup_1308_Grp";
CREATE ROLE altergroup_1308_usr;
CREATE ROLE altergroup_1308_usr2;
CREATE ROLE altergroup_1308_admin LOGIN;
GRANT "altergroup_1308_Grp" TO altergroup_1308_admin WITH ADMIN OPTION;
SET ROLE altergroup_1308_admin;
-- 3. 执行唯一获得覆盖信用的 ALTER GROUP。
-- primary-target-begin
ALTER GROUP "altergroup_1308_Grp" ADD USER altergroup_1308_usr, altergroup_1308_usr2;
-- primary-target-end
