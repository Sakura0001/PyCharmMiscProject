...
-- primary_obligation_id: DROPGROUP-EXT|00087|drop_group|notice_assertion|recreate_role
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP GROUP IF EXISTS dropgroup_00087_grp;
...
DROP GROUP dropgroup_00087_grp;
-- primary-target-end
...
SELECT count(*) = 0 AS group_absent FROM pg_catalog.pg_roles WHERE rolname = 'dropgroup_00087_grp' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
DROP GROUP IF EXISTS dropgroup_00087_grp;
