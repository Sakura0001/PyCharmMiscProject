...
-- primary_obligation_id: DROPGROUP-EXT|00190|drop_group|pg_authid_catalog_query|cleanup_referenced_objects
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP GROUP IF EXISTS dropgroup_00190_grp;
...
SELECT count(*) = 0 AS group_absent FROM pg_catalog.pg_roles WHERE rolname = 'dropgroup_00190_grp' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
DROP GROUP IF EXISTS dropgroup_00190_grp;
