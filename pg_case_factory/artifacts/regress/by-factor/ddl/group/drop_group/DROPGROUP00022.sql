...
-- primary_obligation_id: DROPGROUP-SFV|sfv-9f4b933c6881e2053f39dac7|drop_group
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP GROUP IF EXISTS dropgroup_00022_grp;
...
DROP GROUP dropgroup_00022_grp;
-- primary-target-end
...
SELECT count(*) = 0 AS group_absent FROM pg_catalog.pg_roles WHERE rolname = 'dropgroup_00022_grp' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
DROP GROUP IF EXISTS dropgroup_00022_grp;
