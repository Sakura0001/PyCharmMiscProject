...
-- primary_obligation_id: DROPEXTENSION-EXT|00315|drop_extension|notice_assertion|role_cleanup
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP EXTENSION IF EXISTS dropextension_00315_ext CASCADE;
...
DROP EXTENSION dropextension_00315_ext;
-- primary-target-end
...
SELECT count(*) = 0 AS extension_absent FROM pg_catalog.pg_extension WHERE extname = 'dropextension_00315_ext' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
DROP EXTENSION IF EXISTS dropextension_00315_ext CASCADE;
