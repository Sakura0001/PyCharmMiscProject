...
-- primary_obligation_id: REINDEX-EXT|02043|invalid_index_detection|drop_invalid_index
...
REINDEX SCHEMA CONCURRENTLY reindex_02043_no_such_obj;
-- primary-target-end
