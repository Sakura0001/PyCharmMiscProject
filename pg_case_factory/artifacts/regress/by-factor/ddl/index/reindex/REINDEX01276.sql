...
-- version      : 1.0
-- description  : REINDEX statement_branch=reindex_system
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: REINDEX01276
...
-- primary_obligation_id: REINDEX-EXT|01276|invalid_index_detection|reindex_concurrently_fix
...
REINDEX SYSTEM reindex_01276_db;
-- primary-target-end
