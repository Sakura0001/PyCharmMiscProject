...
-- primary_obligation_id: REINDEX-EXT|02107|search_path_sandbox|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02107_no_such_obj;
-- primary-target-end
