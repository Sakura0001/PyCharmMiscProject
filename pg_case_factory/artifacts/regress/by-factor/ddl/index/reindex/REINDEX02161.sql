...
-- primary_obligation_id: REINDEX-EXT|02161|catalog_validity_check|reindex_concurrently_fix
...
REINDEX SCHEMA CONCURRENTLY reindex_02161_no_such_obj;
-- primary-target-end
