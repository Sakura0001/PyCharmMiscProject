...
-- primary_obligation_id: REINDEX-EXT|02040|catalog_validity_check|drop_invalid_index
...
REINDEX SCHEMA CONCURRENTLY reindex_02040_no_such_obj;
-- primary-target-end
