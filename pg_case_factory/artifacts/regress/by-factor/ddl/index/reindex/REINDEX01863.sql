...
-- primary_obligation_id: REINDEX-EXT|01863|invalid_index_detection|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_01863_no_such_obj;
-- primary-target-end
