...
-- primary_obligation_id: REINDEX-EXT|01995|invalid_index_detection|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_01995_no_such_obj;
-- primary-target-end
