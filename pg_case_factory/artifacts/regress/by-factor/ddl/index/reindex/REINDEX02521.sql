...
-- primary_obligation_id: REINDEX-EXT|02521|catalog_validity_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02521_no_such_obj;
-- primary-target-end
