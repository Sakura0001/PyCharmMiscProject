...
-- primary_obligation_id: REINDEX-EXT|01849|catalog_validity_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_01849_no_such_obj;
-- primary-target-end
