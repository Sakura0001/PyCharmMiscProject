...
-- primary_obligation_id: REINDEX-EXT|02004|catalog_validity_check|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02004_no_such_obj;
-- primary-target-end
