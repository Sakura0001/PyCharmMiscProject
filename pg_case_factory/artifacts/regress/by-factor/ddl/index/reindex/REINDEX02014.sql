...
-- primary_obligation_id: REINDEX-EXT|02014|verbose_output_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02014_no_such_obj;
-- primary-target-end
