...
-- primary_obligation_id: REINDEX-EXT|02673|verbose_output_check|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02673_no_such_obj;
-- primary-target-end
