...
-- primary_obligation_id: REINDEX-EXT|01873|catalog_validity_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_01873_no_such_obj;
-- primary-target-end
