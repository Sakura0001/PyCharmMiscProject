...
-- primary_obligation_id: REINDEX-EXT|02146|verbose_output_check|reindex_concurrently_fix
...
REINDEX SCHEMA CONCURRENTLY reindex_02146_no_such_obj;
-- primary-target-end
