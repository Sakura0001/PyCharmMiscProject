...
-- primary_obligation_id: REINDEX-EXT|01906|verbose_output_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_01906_no_such_obj;
-- primary-target-end
