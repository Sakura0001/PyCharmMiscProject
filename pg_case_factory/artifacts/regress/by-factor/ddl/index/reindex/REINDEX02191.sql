...
-- primary_obligation_id: REINDEX-EXT|02191|search_path_sandbox|reindex_concurrently_fix
...
REINDEX TABLE CONCURRENTLY reindex_02191_no_such_obj;
-- primary-target-end
