...
-- primary_obligation_id: REINDEX-EXT|02194|verbose_output_check|reindex_concurrently_fix
...
REINDEX TABLE CONCURRENTLY reindex_02194_no_such_obj;
-- primary-target-end
