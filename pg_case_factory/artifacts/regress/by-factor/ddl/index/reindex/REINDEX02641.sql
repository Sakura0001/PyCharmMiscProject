...
-- primary_obligation_id: REINDEX-EXT|02641|catalog_validity_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02641_no_such_obj;
-- primary-target-end
