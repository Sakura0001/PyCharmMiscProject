...
-- primary_obligation_id: REINDEX-EXT|02149|catalog_validity_check|reindex_concurrently_fix
...
REINDEX SCHEMA CONCURRENTLY reindex_02149_no_such_obj;
-- primary-target-end
