...
-- primary_obligation_id: REINDEX-EXT|02155|search_path_sandbox|reindex_concurrently_fix
...
REINDEX SCHEMA CONCURRENTLY reindex_02155_no_such_obj;
-- primary-target-end
