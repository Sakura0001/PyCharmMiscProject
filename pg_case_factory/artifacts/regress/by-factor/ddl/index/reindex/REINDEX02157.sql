...
-- primary_obligation_id: REINDEX-EXT|02157|verbose_output_check|drop_invalid_index
...
REINDEX SCHEMA CONCURRENTLY reindex_02157_no_such_obj;
-- primary-target-end
