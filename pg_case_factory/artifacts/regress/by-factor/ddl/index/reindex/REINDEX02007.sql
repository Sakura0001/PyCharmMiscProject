...
-- primary_obligation_id: REINDEX-EXT|02007|invalid_index_detection|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02007_no_such_obj;
-- primary-target-end
