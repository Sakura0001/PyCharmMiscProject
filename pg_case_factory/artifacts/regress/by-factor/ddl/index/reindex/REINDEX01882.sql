...
-- primary_obligation_id: REINDEX-EXT|01882|verbose_output_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_01882_no_such_obj;
-- primary-target-end
