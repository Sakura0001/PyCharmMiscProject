...
-- primary_obligation_id: REINDEX-EXT|02110|verbose_output_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02110_no_such_obj;
-- primary-target-end
