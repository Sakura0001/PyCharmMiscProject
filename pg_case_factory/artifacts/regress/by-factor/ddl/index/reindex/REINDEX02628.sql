...
-- primary_obligation_id: REINDEX-EXT|02628|catalog_validity_check|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02628_no_such_obj;
-- primary-target-end
