...
-- primary_obligation_id: REINDEX-EXT|02490|search_path_sandbox|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02490_no_such_obj;
-- primary-target-end
