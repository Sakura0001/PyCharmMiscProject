...
-- primary_obligation_id: REINDEX-EXT|02025|verbose_output_check|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02025_no_such_obj;
-- primary-target-end
