...
-- primary_obligation_id: REINDEX-EXT|01879|search_path_sandbox|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_01879_no_such_obj;
-- primary-target-end
