...
-- primary_obligation_id: REINDEX-EXT|02133|verbose_output_check|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02133_no_such_obj;
-- primary-target-end
