...
-- primary_obligation_id: REINDEX-EXT|02664|catalog_validity_check|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02664_no_such_obj;
-- primary-target-end
