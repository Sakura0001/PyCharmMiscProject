...
-- primary_obligation_id: REINDEX-EXT|02487|invalid_index_detection|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02487_no_such_obj;
-- primary-target-end
