...
-- primary_obligation_id: REINDEX-EXT|01867|search_path_sandbox|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_01867_no_such_obj;
-- primary-target-end
