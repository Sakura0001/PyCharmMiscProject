...
-- primary_obligation_id: REINDEX-EXT|02518|verbose_output_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02518_no_such_obj;
-- primary-target-end
