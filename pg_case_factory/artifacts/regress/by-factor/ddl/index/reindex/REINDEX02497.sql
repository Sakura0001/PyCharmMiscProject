...
-- primary_obligation_id: REINDEX-EXT|02497|catalog_validity_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02497_no_such_obj;
-- primary-target-end
