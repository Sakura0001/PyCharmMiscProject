...
-- primary_obligation_id: REINDEX-EXT|02683|search_path_sandbox|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02683_no_such_obj;
-- primary-target-end
