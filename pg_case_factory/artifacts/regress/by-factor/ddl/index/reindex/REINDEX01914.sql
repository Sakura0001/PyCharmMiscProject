...
-- primary_obligation_id: REINDEX-EXT|01914|search_path_sandbox|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_01914_no_such_obj;
-- primary-target-end
