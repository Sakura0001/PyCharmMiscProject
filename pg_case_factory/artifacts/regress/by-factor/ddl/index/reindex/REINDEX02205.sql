...
-- primary_obligation_id: REINDEX-EXT|02205|verbose_output_check|drop_invalid_index
...
REINDEX TABLE CONCURRENTLY reindex_02205_no_such_obj;
-- primary-target-end
