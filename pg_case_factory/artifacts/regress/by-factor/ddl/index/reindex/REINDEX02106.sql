...
-- primary_obligation_id: REINDEX-EXT|02106|search_path_sandbox|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02106_no_such_obj;
-- primary-target-end
