...
-- primary_obligation_id: REINDEX-EXT|02095|search_path_sandbox|reindex_concurrently_fix
...
REINDEX TABLE CONCURRENTLY reindex_02095_no_such_obj;
-- primary-target-end
