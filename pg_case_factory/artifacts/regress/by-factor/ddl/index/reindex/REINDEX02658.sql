...
-- primary_obligation_id: REINDEX-EXT|02658|search_path_sandbox|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02658_no_such_obj;
-- primary-target-end
