...
-- primary_obligation_id: REINDEX-EXT|02136|catalog_validity_check|drop_invalid_index
...
REINDEX SCHEMA CONCURRENTLY reindex_02136_no_such_obj;
-- primary-target-end
