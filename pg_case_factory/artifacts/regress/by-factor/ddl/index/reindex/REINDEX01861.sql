...
-- primary_obligation_id: REINDEX-EXT|01861|catalog_validity_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_01861_no_such_obj;
-- primary-target-end
