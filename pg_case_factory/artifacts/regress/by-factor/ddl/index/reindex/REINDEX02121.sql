...
-- primary_obligation_id: REINDEX-EXT|02121|verbose_output_check|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02121_no_such_obj;
-- primary-target-end
