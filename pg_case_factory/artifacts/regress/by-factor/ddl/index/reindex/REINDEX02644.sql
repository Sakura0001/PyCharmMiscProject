...
-- primary_obligation_id: REINDEX-EXT|02644|invalid_index_detection|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02644_no_such_obj;
-- primary-target-end
