...
-- primary_obligation_id: REINDEX-EXT|02232|catalog_validity_check|drop_invalid_index
...
REINDEX TABLE CONCURRENTLY reindex_02232_no_such_obj;
-- primary-target-end
