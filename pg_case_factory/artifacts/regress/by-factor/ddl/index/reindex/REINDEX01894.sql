...
-- primary_obligation_id: REINDEX-EXT|01894|verbose_output_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_01894_no_such_obj;
-- primary-target-end
