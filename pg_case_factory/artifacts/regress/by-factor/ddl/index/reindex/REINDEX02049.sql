...
-- primary_obligation_id: REINDEX-EXT|02049|verbose_output_check|drop_invalid_index
...
REINDEX SCHEMA CONCURRENTLY reindex_02049_no_such_obj;
-- primary-target-end
