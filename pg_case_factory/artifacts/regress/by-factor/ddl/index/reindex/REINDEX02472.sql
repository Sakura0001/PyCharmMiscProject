...
-- primary_obligation_id: REINDEX-EXT|02472|catalog_validity_check|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02472_no_such_obj;
-- primary-target-end
