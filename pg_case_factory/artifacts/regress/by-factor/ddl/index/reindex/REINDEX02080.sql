...
-- primary_obligation_id: REINDEX-EXT|02080|invalid_index_detection|reindex_concurrently_fix
...
REINDEX TABLE CONCURRENTLY reindex_02080_no_such_obj;
-- primary-target-end
