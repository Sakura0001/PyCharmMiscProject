...
-- primary_obligation_id: REINDEX-EXT|02682|search_path_sandbox|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02682_no_such_obj;
-- primary-target-end
