...
-- primary_obligation_id: REINDEX-EXT|01888|invalid_index_detection|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_01888_no_such_obj;
-- primary-target-end
