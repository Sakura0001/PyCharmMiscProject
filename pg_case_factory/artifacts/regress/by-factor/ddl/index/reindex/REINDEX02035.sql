...
-- primary_obligation_id: REINDEX-EXT|02035|search_path_sandbox|reindex_concurrently_fix
...
REINDEX SCHEMA CONCURRENTLY reindex_02035_no_such_obj;
-- primary-target-end
