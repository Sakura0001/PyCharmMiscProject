...
-- primary_obligation_id: REINDEX-EXT|01884|catalog_validity_check|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_01884_no_such_obj;
-- primary-target-end
