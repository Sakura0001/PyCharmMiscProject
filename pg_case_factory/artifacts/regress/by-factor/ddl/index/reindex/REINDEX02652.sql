...
-- primary_obligation_id: REINDEX-EXT|02652|catalog_validity_check|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02652_no_such_obj;
-- primary-target-end
