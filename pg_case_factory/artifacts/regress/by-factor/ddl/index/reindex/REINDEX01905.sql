...
-- primary_obligation_id: REINDEX-EXT|01905|verbose_output_check|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_01905_no_such_obj;
-- primary-target-end
