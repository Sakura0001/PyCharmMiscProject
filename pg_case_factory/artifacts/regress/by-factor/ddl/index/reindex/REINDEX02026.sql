...
-- primary_obligation_id: REINDEX-EXT|02026|verbose_output_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02026_no_such_obj;
-- primary-target-end
