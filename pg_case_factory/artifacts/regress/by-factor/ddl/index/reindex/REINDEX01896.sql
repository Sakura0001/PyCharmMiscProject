...
-- primary_obligation_id: REINDEX-EXT|01896|catalog_validity_check|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_01896_no_such_obj;
-- primary-target-end
