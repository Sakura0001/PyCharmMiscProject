...
-- primary_obligation_id: REINDEX-EXT|02674|verbose_output_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02674_no_such_obj;
-- primary-target-end
