...
-- primary_obligation_id: REINDEX-EXT|02152|invalid_index_detection|reindex_concurrently_fix
...
REINDEX SCHEMA CONCURRENTLY reindex_02152_no_such_obj;
-- primary-target-end
