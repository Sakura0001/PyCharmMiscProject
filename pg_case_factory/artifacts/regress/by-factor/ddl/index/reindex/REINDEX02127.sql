...
-- primary_obligation_id: REINDEX-EXT|02127|invalid_index_detection|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02127_no_such_obj;
-- primary-target-end
