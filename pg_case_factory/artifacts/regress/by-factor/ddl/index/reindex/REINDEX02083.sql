...
-- primary_obligation_id: REINDEX-EXT|02083|search_path_sandbox|reindex_concurrently_fix
...
REINDEX TABLE CONCURRENTLY reindex_02083_no_such_obj;
-- primary-target-end
