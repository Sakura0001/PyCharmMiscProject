...
-- primary_obligation_id: REINDEX-EXT|02509|catalog_validity_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02509_no_such_obj;
-- primary-target-end
