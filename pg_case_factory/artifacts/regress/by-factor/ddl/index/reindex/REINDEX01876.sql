...
-- primary_obligation_id: REINDEX-EXT|01876|invalid_index_detection|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_01876_no_such_obj;
-- primary-target-end
