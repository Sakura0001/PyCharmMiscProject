...
-- primary_obligation_id: REINDEX-EXT|02494|verbose_output_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02494_no_such_obj;
-- primary-target-end
