...
-- primary_obligation_id: REINDEX-EXT|01870|verbose_output_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_01870_no_such_obj;
-- primary-target-end
