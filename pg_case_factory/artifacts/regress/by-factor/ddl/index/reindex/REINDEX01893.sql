...
-- primary_obligation_id: REINDEX-EXT|01893|verbose_output_check|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_01893_no_such_obj;
-- primary-target-end
