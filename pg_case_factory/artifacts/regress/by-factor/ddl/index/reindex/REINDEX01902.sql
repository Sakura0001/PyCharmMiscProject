...
-- primary_obligation_id: REINDEX-EXT|01902|search_path_sandbox|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_01902_no_such_obj;
-- primary-target-end
