...
-- primary_obligation_id: REINDEX-EXT|01992|catalog_validity_check|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_01992_no_such_obj;
-- primary-target-end
