...
-- primary_obligation_id: REINDEX-EXT|02505|verbose_output_check|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02505_no_such_obj;
-- primary-target-end
