...
-- primary_obligation_id: REINDEX-EXT|02667|invalid_index_detection|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02667_no_such_obj;
-- primary-target-end
