...
-- primary_obligation_id: REINDEX-EXT|01918|verbose_output_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_01918_no_such_obj;
-- primary-target-end
