...
-- primary_obligation_id: REINDEX-EXT|02038|verbose_output_check|reindex_concurrently_fix
...
REINDEX SCHEMA CONCURRENTLY reindex_02038_no_such_obj;
-- primary-target-end
