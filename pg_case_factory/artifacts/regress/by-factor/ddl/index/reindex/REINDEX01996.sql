...
-- primary_obligation_id: REINDEX-EXT|01996|invalid_index_detection|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_01996_no_such_obj;
-- primary-target-end
