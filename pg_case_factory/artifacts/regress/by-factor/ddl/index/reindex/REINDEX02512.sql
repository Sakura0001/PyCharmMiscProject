...
-- primary_obligation_id: REINDEX-EXT|02512|invalid_index_detection|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02512_no_such_obj;
-- primary-target-end
