...
-- primary_obligation_id: REINDEX-EXT|02100|catalog_validity_check|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02100_no_such_obj;
-- primary-target-end
