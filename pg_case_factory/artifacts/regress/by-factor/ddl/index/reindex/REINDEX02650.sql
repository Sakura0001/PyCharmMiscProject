...
-- primary_obligation_id: REINDEX-EXT|02650|verbose_output_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02650_no_such_obj;
-- primary-target-end
