...
-- primary_obligation_id: REINDEX-EXT|02619|invalid_index_detection|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02619_no_such_obj;
-- primary-target-end
