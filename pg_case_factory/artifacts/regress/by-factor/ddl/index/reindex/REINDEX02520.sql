...
-- primary_obligation_id: REINDEX-EXT|02520|catalog_validity_check|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02520_no_such_obj;
-- primary-target-end
