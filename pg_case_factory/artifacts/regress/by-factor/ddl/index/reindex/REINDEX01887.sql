...
-- primary_obligation_id: REINDEX-EXT|01887|invalid_index_detection|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_01887_no_such_obj;
-- primary-target-end
