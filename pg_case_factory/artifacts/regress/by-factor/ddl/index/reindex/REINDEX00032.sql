...
-- version      : 1.0
-- description  : REINDEX invalid_combination=concurrently_with_system
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: REINDEX00032
...
-- primary_obligation_id: REINDEX-SFV|sfv-89060bafe5f06b8a057395b1|reindex_system
...
REINDEX SYSTEM CONCURRENTLY reindex_00032_db;
-- primary-target-end
