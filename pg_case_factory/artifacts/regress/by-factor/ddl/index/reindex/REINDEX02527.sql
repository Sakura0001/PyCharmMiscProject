...
-- primary_obligation_id: REINDEX-EXT|02527|search_path_sandbox|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02527_no_such_obj;
-- primary-target-end
