...
-- primary_obligation_id: REINDEX-EXT|02167|search_path_sandbox|reindex_concurrently_fix
...
REINDEX SCHEMA CONCURRENTLY reindex_02167_no_such_obj;
-- primary-target-end
