...
-- primary_obligation_id: REINDEX-EXT|02037|verbose_output_check|drop_invalid_index
...
REINDEX SCHEMA CONCURRENTLY reindex_02037_no_such_obj;
-- primary-target-end
