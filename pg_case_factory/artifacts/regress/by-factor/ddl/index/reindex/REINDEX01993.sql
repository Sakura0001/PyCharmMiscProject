...
-- primary_obligation_id: REINDEX-EXT|01993|catalog_validity_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_01993_no_such_obj;
-- primary-target-end
