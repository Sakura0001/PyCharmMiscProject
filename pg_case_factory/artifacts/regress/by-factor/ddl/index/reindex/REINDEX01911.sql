...
-- primary_obligation_id: REINDEX-EXT|01911|invalid_index_detection|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_01911_no_such_obj;
-- primary-target-end
