...
-- primary_obligation_id: REINDEX-EXT|02500|invalid_index_detection|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02500_no_such_obj;
-- primary-target-end
