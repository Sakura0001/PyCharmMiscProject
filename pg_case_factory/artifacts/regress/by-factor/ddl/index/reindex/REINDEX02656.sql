...
-- primary_obligation_id: REINDEX-EXT|02656|invalid_index_detection|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02656_no_such_obj;
-- primary-target-end
