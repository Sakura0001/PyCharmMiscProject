...
-- primary_obligation_id: REINDEX-EXT|02143|search_path_sandbox|reindex_concurrently_fix
...
REINDEX SCHEMA CONCURRENTLY reindex_02143_no_such_obj;
-- primary-target-end
