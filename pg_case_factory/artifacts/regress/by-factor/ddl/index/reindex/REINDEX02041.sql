...
-- primary_obligation_id: REINDEX-EXT|02041|catalog_validity_check|reindex_concurrently_fix
...
REINDEX SCHEMA CONCURRENTLY reindex_02041_no_such_obj;
-- primary-target-end
