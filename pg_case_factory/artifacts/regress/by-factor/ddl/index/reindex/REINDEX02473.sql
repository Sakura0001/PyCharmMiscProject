...
-- primary_obligation_id: REINDEX-EXT|02473|catalog_validity_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02473_no_such_obj;
-- primary-target-end
