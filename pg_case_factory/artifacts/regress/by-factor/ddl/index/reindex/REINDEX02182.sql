...
-- primary_obligation_id: REINDEX-EXT|02182|verbose_output_check|reindex_concurrently_fix
...
REINDEX TABLE CONCURRENTLY reindex_02182_no_such_obj;
-- primary-target-end
