...
-- primary_obligation_id: REINDEX-EXT|02529|verbose_output_check|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02529_no_such_obj;
-- primary-target-end
