...
-- primary_obligation_id: REINDEX-EXT|02262|search_path_sandbox|drop_invalid_index
...
REINDEX TABLE CONCURRENTLY reindex_02262_no_such_obj;
-- primary-target-end
