...
-- primary_obligation_id: REINDEX-EXT|02077|catalog_validity_check|reindex_concurrently_fix
...
REINDEX TABLE CONCURRENTLY reindex_02077_no_such_obj;
-- primary-target-end
