...
-- primary_obligation_id: REINDEX-EXT|02661|verbose_output_check|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02661_no_such_obj;
-- primary-target-end
