...
-- primary_obligation_id: REINDEX-EXT|02170|verbose_output_check|reindex_concurrently_fix
...
REINDEX SCHEMA CONCURRENTLY reindex_02170_no_such_obj;
-- primary-target-end
