...
-- primary_obligation_id: REINDEX-EXT|02065|catalog_validity_check|reindex_concurrently_fix
...
REINDEX TABLE CONCURRENTLY reindex_02065_no_such_obj;
-- primary-target-end
