...
-- primary_obligation_id: REINDEX-EXT|02643|invalid_index_detection|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02643_no_such_obj;
-- primary-target-end
