...
-- primary_obligation_id: REINDEX-EXT|02046|search_path_sandbox|drop_invalid_index
...
REINDEX SCHEMA CONCURRENTLY reindex_02046_no_such_obj;
-- primary-target-end
