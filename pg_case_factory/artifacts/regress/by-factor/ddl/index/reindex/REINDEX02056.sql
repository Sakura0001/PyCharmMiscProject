...
-- primary_obligation_id: REINDEX-EXT|02056|invalid_index_detection|reindex_concurrently_fix
...
REINDEX SCHEMA CONCURRENTLY reindex_02056_no_such_obj;
-- primary-target-end
