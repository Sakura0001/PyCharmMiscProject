...
-- primary_obligation_id: REINDEX-EXT|02073|verbose_output_check|drop_invalid_index
...
REINDEX TABLE CONCURRENTLY reindex_02073_no_such_obj;
-- primary-target-end
