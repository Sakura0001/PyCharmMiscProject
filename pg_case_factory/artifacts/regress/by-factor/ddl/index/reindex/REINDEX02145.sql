...
-- primary_obligation_id: REINDEX-EXT|02145|verbose_output_check|drop_invalid_index
...
REINDEX SCHEMA CONCURRENTLY reindex_02145_no_such_obj;
-- primary-target-end
