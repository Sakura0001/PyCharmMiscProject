...
-- primary_obligation_id: REINDEX-EXT|02638|verbose_output_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02638_no_such_obj;
-- primary-target-end
