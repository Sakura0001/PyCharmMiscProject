...
-- primary_obligation_id: REINDEX-EXT|02005|catalog_validity_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02005_no_such_obj;
-- primary-target-end
