...
-- primary_obligation_id: REINDEX-EXT|02485|catalog_validity_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02485_no_such_obj;
-- primary-target-end
