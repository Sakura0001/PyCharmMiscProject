...
-- primary_obligation_id: REINDEX-EXT|02115|invalid_index_detection|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02115_no_such_obj;
-- primary-target-end
