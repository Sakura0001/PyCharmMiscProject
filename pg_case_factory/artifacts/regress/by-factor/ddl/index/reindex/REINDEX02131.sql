...
-- primary_obligation_id: REINDEX-EXT|02131|search_path_sandbox|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02131_no_such_obj;
-- primary-target-end
