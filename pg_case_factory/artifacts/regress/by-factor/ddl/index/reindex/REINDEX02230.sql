...
-- primary_obligation_id: REINDEX-EXT|02230|verbose_output_check|reindex_concurrently_fix
...
REINDEX TABLE CONCURRENTLY reindex_02230_no_such_obj;
-- primary-target-end
