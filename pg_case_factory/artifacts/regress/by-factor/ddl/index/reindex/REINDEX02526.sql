...
-- primary_obligation_id: REINDEX-EXT|02526|search_path_sandbox|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02526_no_such_obj;
-- primary-target-end
