...
-- primary_obligation_id: REINDEX-EXT|02646|search_path_sandbox|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_02646_no_such_obj;
-- primary-target-end
