...
-- primary_obligation_id: REINDEX-EXT|02148|catalog_validity_check|drop_invalid_index
...
REINDEX SCHEMA CONCURRENTLY reindex_02148_no_such_obj;
-- primary-target-end
