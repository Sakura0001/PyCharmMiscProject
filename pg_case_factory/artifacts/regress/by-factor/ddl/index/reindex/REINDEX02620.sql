...
-- primary_obligation_id: REINDEX-EXT|02620|invalid_index_detection|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02620_no_such_obj;
-- primary-target-end
