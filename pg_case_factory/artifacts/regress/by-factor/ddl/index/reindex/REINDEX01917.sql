...
-- primary_obligation_id: REINDEX-EXT|01917|verbose_output_check|drop_invalid_index
...
REINDEX INDEX CONCURRENTLY reindex_01917_no_such_obj;
-- primary-target-end
