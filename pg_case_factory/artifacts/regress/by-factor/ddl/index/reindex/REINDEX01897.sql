...
-- primary_obligation_id: REINDEX-EXT|01897|catalog_validity_check|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_01897_no_such_obj;
-- primary-target-end
