...
-- primary_obligation_id: REINDEX-EXT|02632|invalid_index_detection|reindex_concurrently_fix
...
REINDEX INDEX CONCURRENTLY reindex_02632_no_such_obj;
-- primary-target-end
