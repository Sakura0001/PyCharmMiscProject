...
-- version      : 1.0
-- description  : SECURITY LABEL ON object_type=database
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: SECURITYLABEL00034
...
-- primary_obligation_id: SECURITYLABEL-SFV|sfv-71e6f469fb12d8b3fde1dd10|database
...
SECURITY LABEL ON DATABASE securitylabel_00034_db IS 'classification';
-- primary-target-end
...
-- 5. 清理全部本编号对象。
SECURITY LABEL ON DATABASE securitylabel_00034_db IS NULL;
