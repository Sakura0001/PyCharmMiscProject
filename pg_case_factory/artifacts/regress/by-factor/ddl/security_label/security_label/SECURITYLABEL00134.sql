...
-- primary_obligation_id: SECURITYLABEL-EXT|00134|error_assertion|drop_object
...
SECURITY LABEL ON TABLE securitylabel_00134_no_such_tbl IS 'classification';
-- primary-target-end
