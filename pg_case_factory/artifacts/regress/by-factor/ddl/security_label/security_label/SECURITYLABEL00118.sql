...
-- primary_obligation_id: SECURITYLABEL-EXT|00118|error_assertion|drop_object
...
SECURITY LABEL ON TABLE securitylabel_00118_no_such_tbl IS '';
-- primary-target-end
