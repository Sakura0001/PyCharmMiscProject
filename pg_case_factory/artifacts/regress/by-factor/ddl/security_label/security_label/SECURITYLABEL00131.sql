...
-- primary_obligation_id: SECURITYLABEL-EXT|00131|pg_seclabel_catalog_query|security_label_is_null
...
SECURITY LABEL ON TABLE securitylabel_00131_no_such_tbl IS 'classification';
-- primary-target-end
