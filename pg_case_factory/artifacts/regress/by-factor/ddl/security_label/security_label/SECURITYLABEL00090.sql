...
-- primary_obligation_id: SECURITYLABEL-EXT|00090|error_assertion|drop_object
...
SECURITY LABEL FOR seclabel ON TABLE securitylabel_00090_no_such_tbl IS NULL;
-- primary-target-end
