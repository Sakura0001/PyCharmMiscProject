...
-- primary_obligation_id: SECURITYLABEL-EXT|00122|error_assertion|drop_object
...
SECURITY LABEL ON TABLE securitylabel_00122_no_such_tbl IS NULL;
-- primary-target-end
