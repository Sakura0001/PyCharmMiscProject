...
-- primary_obligation_id: SECURITYLABEL-EXT|00089|error_assertion|security_label_is_null
...
SECURITY LABEL FOR seclabel ON TABLE securitylabel_00089_no_such_tbl IS NULL;
-- primary-target-end
