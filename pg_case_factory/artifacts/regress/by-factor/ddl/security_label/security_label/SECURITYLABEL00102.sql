...
-- primary_obligation_id: SECURITYLABEL-EXT|00102|error_assertion|drop_object
...
SECURITY LABEL FOR seclabel ON TABLE securitylabel_00102_no_such_tbl IS 'a:b:c@special';
-- primary-target-end
