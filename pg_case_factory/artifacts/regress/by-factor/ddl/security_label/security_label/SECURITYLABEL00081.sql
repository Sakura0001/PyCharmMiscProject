...
-- version      : 1.0
-- description  : SECURITY LABEL ON statement_branch=branch_on_tablespace
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: SECURITYLABEL00081
...
-- primary_obligation_id: SECURITYLABEL-SFV|sfv-26c69a842761c7f50c79e779|tablespace
...
SECURITY LABEL ON TABLESPACE securitylabel_00081_ts IS 'classification';
-- primary-target-end
...
-- 5. 清理全部本编号对象。
SECURITY LABEL ON TABLESPACE securitylabel_00081_ts IS NULL;
