...
-- primary_obligation_id: SECURITYLABEL-EXT|00117|error_assertion|security_label_is_null
...
SECURITY LABEL ON TABLE securitylabel_00117_no_such_tbl IS '';
-- primary-target-end
