...
-- primary_obligation_id: SECURITYLABEL-EXT|00092|pg_seclabel_catalog_query|drop_object
...
SECURITY LABEL FOR seclabel ON TABLE securitylabel_00092_no_such_tbl IS '';
-- primary-target-end
