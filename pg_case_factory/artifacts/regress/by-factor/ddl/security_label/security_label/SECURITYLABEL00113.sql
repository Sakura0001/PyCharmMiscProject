...
-- primary_obligation_id: SECURITYLABEL-EXT|00113|error_assertion|security_label_is_null
...
SECURITY LABEL ON TABLE securitylabel_00113_no_such_tbl IS NULL;
-- primary-target-end
