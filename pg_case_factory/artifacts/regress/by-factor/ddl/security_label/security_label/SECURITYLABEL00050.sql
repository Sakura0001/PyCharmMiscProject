...
-- version      : 1.0
-- description  : SECURITY LABEL ON object_type=tablespace
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: SECURITYLABEL00050
...
-- primary_obligation_id: SECURITYLABEL-SFV|sfv-dcdc39c4e9629f7292dea0f4|tablespace
...
SECURITY LABEL ON TABLESPACE securitylabel_00050_ts IS 'classification';
-- primary-target-end
...
-- 5. 清理全部本编号对象。
SECURITY LABEL ON TABLESPACE securitylabel_00050_ts IS NULL;
