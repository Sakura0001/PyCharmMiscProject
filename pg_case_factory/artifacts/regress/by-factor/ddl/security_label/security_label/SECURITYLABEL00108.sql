...
-- primary_obligation_id: SECURITYLABEL-EXT|00108|pg_seclabel_catalog_query|drop_object
...
SECURITY LABEL FOR seclabel ON TABLE securitylabel_00108_no_such_tbl IS 'classification';
-- primary-target-end
