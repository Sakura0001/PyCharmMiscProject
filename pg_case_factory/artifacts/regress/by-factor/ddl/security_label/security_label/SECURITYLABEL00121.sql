...
-- primary_obligation_id: SECURITYLABEL-EXT|00121|error_assertion|security_label_is_null
...
SECURITY LABEL ON TABLE securitylabel_00121_no_such_tbl IS NULL;
-- primary-target-end
