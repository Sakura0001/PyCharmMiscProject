...
-- primary_obligation_id: SECURITYLABEL-EXT|00120|pg_seclabel_catalog_query|drop_object
...
SECURITY LABEL ON TABLE securitylabel_00120_no_such_tbl IS NULL;
-- primary-target-end
