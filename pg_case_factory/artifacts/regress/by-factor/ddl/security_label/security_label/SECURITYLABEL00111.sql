...
-- primary_obligation_id: SECURITYLABEL-EXT|00111|pg_seclabel_catalog_query|security_label_is_null
...
SECURITY LABEL ON TABLE securitylabel_00111_no_such_tbl IS NULL;
-- primary-target-end
