...
-- primary_obligation_id: SECURITYLABEL-EXT|00096|pg_seclabel_catalog_query|drop_object
...
SECURITY LABEL FOR seclabel ON TABLE securitylabel_00096_no_such_tbl IS NULL;
-- primary-target-end
