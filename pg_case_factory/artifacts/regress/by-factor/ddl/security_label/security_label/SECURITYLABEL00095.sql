...
-- primary_obligation_id: SECURITYLABEL-EXT|00095|pg_seclabel_catalog_query|security_label_is_null
...
SECURITY LABEL FOR seclabel ON TABLE securitylabel_00095_no_such_tbl IS NULL;
-- primary-target-end
