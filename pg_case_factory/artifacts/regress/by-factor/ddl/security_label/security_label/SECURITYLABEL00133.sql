...
-- primary_obligation_id: SECURITYLABEL-EXT|00133|error_assertion|security_label_is_null
...
SECURITY LABEL ON TABLE securitylabel_00133_no_such_tbl IS 'classification';
-- primary-target-end
