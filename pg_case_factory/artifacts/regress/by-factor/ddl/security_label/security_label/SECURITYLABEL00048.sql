...
-- version      : 1.0
-- description  : SECURITY LABEL ON object_type=subscription
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: SECURITYLABEL00048
...
-- primary_obligation_id: SECURITYLABEL-SFV|sfv-1afa33ff14b96c6e019ee9ba|subscription
...
SECURITY LABEL ON SUBSCRIPTION securitylabel_00048_sub IS 'classification';
-- primary-target-end
...
-- 5. 清理全部本编号对象。
SECURITY LABEL ON SUBSCRIPTION securitylabel_00048_sub IS NULL;
