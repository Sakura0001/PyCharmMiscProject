...
-- primary_obligation_id: SECURITYLABEL-EXT|00107|pg_seclabel_catalog_query|security_label_is_null
...
SECURITY LABEL FOR seclabel ON TABLE securitylabel_00107_no_such_tbl IS 'classification';
-- primary-target-end
