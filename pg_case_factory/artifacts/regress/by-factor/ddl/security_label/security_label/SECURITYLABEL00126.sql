...
-- primary_obligation_id: SECURITYLABEL-EXT|00126|error_assertion|drop_object
...
SECURITY LABEL ON TABLE securitylabel_00126_no_such_tbl IS 'a:b:c@special';
-- primary-target-end
