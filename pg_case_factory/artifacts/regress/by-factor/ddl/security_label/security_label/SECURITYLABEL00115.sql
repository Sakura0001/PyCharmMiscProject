...
-- primary_obligation_id: SECURITYLABEL-EXT|00115|pg_seclabel_catalog_query|security_label_is_null
...
SECURITY LABEL ON TABLE securitylabel_00115_no_such_tbl IS '';
-- primary-target-end
