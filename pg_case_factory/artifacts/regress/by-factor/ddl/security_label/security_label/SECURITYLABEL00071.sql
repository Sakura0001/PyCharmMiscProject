...
-- version      : 1.0
-- description  : SECURITY LABEL ON statement_branch=branch_on_large_object
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: SECURITYLABEL00071
...
-- primary_obligation_id: SECURITYLABEL-SFV|sfv-f0924e9e5e73fea597074bd0|large_object
...
SECURITY LABEL ON LARGE OBJECT 16399 IS 'classification';
-- primary-target-end
...
-- 5. 清理全部本编号对象。
SECURITY LABEL ON LARGE OBJECT 16399 IS NULL;
SELECT lo_unlink(16399);
