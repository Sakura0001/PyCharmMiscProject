...
-- primary_obligation_id: SECURITYLABEL-EXT|00125|error_assertion|security_label_is_null
...
SECURITY LABEL ON TABLE securitylabel_00125_no_such_tbl IS 'a:b:c@special';
-- primary-target-end
