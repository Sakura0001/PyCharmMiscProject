...
-- primary_obligation_id: SECURITYLABEL-EXT|00097|error_assertion|security_label_is_null
...
SECURITY LABEL FOR seclabel ON TABLE securitylabel_00097_no_such_tbl IS NULL;
-- primary-target-end
