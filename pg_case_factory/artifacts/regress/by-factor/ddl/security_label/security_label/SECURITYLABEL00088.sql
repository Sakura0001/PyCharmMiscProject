...
-- primary_obligation_id: SECURITYLABEL-EXT|00088|pg_seclabel_catalog_query|drop_object
...
SECURITY LABEL FOR seclabel ON TABLE securitylabel_00088_no_such_tbl IS NULL;
-- primary-target-end
