...
-- primary_obligation_id: SECURITYLABEL-EXT|00098|error_assertion|drop_object
...
SECURITY LABEL FOR seclabel ON TABLE securitylabel_00098_no_such_tbl IS NULL;
-- primary-target-end
