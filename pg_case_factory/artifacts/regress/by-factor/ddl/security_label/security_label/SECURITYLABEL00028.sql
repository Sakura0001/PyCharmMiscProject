...
-- version      : 1.0
-- description  : SECURITY LABEL ON object_name_shape=non_existing_name
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: SECURITYLABEL00028
...
-- primary_obligation_id: SECURITYLABEL-SFV|sfv-ffd3435355df615531287d94|table
...
SECURITY LABEL ON TABLE securitylabel_00028_no_such_tbl IS 'classification';
-- primary-target-end
