...
-- version      : 1.0
-- description  : SECURITY LABEL ON statement_branch=branch_on_database
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: SECURITYLABEL00065
...
-- primary_obligation_id: SECURITYLABEL-SFV|sfv-41db1d9e17a6aedae79eb5c6|database
...
SECURITY LABEL ON DATABASE securitylabel_00065_db IS 'classification';
-- primary-target-end
...
-- 5. 清理全部本编号对象。
SECURITY LABEL ON DATABASE securitylabel_00065_db IS NULL;
