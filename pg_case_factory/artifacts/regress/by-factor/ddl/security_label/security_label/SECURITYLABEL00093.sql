...
-- primary_obligation_id: SECURITYLABEL-EXT|00093|error_assertion|security_label_is_null
...
SECURITY LABEL FOR seclabel ON TABLE securitylabel_00093_no_such_tbl IS '';
-- primary-target-end
