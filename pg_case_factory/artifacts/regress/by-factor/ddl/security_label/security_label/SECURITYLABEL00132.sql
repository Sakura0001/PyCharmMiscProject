...
-- primary_obligation_id: SECURITYLABEL-EXT|00132|pg_seclabel_catalog_query|drop_object
...
SECURITY LABEL ON TABLE securitylabel_00132_no_such_tbl IS 'classification';
-- primary-target-end
