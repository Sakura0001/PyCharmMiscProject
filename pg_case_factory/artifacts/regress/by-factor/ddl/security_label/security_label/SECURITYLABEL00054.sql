...
-- version      : 1.0
-- description  : SECURITY LABEL ON prerequisite_object=object_not_exists
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: SECURITYLABEL00054
...
-- primary_obligation_id: SECURITYLABEL-SFV|sfv-87e7b581795de3d803f4402f|table
...
SECURITY LABEL ON TABLE securitylabel_00054_no_such_tbl IS 'classification';
-- primary-target-end
