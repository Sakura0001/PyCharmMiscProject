...
-- primary_obligation_id: SECURITYLABEL-EXT|00109|error_assertion|security_label_is_null
...
SECURITY LABEL FOR seclabel ON TABLE securitylabel_00109_no_such_tbl IS 'classification';
-- primary-target-end
