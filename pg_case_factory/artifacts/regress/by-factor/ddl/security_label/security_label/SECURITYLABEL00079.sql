...
-- version      : 1.0
-- description  : SECURITY LABEL ON statement_branch=branch_on_subscription
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: SECURITYLABEL00079
...
-- primary_obligation_id: SECURITYLABEL-SFV|sfv-0ae48771e53a9efc09524c42|subscription
...
SECURITY LABEL ON SUBSCRIPTION securitylabel_00079_sub IS 'classification';
-- primary-target-end
...
-- 5. 清理全部本编号对象。
SECURITY LABEL ON SUBSCRIPTION securitylabel_00079_sub IS NULL;
