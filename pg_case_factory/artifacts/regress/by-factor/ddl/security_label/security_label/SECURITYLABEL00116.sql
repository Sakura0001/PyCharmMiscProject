...
-- primary_obligation_id: SECURITYLABEL-EXT|00116|pg_seclabel_catalog_query|drop_object
...
SECURITY LABEL ON TABLE securitylabel_00116_no_such_tbl IS '';
-- primary-target-end
