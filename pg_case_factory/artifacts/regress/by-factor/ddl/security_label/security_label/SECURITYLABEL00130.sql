...
-- primary_obligation_id: SECURITYLABEL-EXT|00130|error_assertion|drop_object
...
SECURITY LABEL ON TABLE securitylabel_00130_no_such_tbl IS NULL;
-- primary-target-end
