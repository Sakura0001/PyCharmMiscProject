...
-- version      : 1.0
-- description  : SECURITY LABEL ON nonexistent_object=target_object_does_not_exist
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: SECURITYLABEL00025
...
-- primary_obligation_id: SECURITYLABEL-SFV|sfv-fa19d51d57388d7005cc2538|table
...
SECURITY LABEL ON TABLE securitylabel_00025_no_such_tbl IS 'classification';
-- primary-target-end
