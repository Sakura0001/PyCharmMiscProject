...
-- primary_obligation_id: SECURITYLABEL-EXT|00110|error_assertion|drop_object
...
SECURITY LABEL FOR seclabel ON TABLE securitylabel_00110_no_such_tbl IS 'classification';
-- primary-target-end
