...
-- primary_obligation_id: SECURITYLABEL-EXT|00112|pg_seclabel_catalog_query|drop_object
...
SECURITY LABEL ON TABLE securitylabel_00112_no_such_tbl IS NULL;
-- primary-target-end
