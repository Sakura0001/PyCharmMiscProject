...
-- primary_obligation_id: SECURITYLABEL-EXT|00094|error_assertion|drop_object
...
SECURITY LABEL FOR seclabel ON TABLE securitylabel_00094_no_such_tbl IS '';
-- primary-target-end
