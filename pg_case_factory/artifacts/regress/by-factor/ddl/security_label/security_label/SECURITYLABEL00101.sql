...
-- primary_obligation_id: SECURITYLABEL-EXT|00101|error_assertion|security_label_is_null
...
SECURITY LABEL FOR seclabel ON TABLE securitylabel_00101_no_such_tbl IS 'a:b:c@special';
-- primary-target-end
