...
-- version      : 1.0
-- description  : SECURITY LABEL ON statement_branch=branch_on_language
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: SECURITYLABEL00070
...
-- primary_obligation_id: SECURITYLABEL-SFV|sfv-11babc6aac0f8abc392b2965|language
...
SECURITY LABEL ON LANGUAGE plpgsql IS 'classification';
-- primary-target-end
...
-- 5. 清理全部本编号对象。
SECURITY LABEL ON LANGUAGE plpgsql IS NULL;
