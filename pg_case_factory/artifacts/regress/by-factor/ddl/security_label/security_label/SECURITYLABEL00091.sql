...
-- primary_obligation_id: SECURITYLABEL-EXT|00091|pg_seclabel_catalog_query|security_label_is_null
...
SECURITY LABEL FOR seclabel ON TABLE securitylabel_00091_no_such_tbl IS '';
-- primary-target-end
