...
-- primary_obligation_id: SECURITYLABEL-EXT|00106|error_assertion|drop_object
...
SECURITY LABEL FOR seclabel ON TABLE securitylabel_00106_no_such_tbl IS NULL;
-- primary-target-end
