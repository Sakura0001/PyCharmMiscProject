...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY02940
...
-- primary_obligation_id: CTSD-EXT|02940|error_assertion|drop_text_search_dictionary
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS public.createtextsearchdictionary_02940_dict CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_02940_tmpl;
...
CREATE TEXT SEARCH DICTIONARY public.createtextsearchdictionary_02940_dict (TEMPLATE = simple);
-- primary-target-end
