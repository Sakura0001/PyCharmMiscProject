...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY03145
...
-- primary_obligation_id: CTSD-EXT|03145|error_assertion|drop_template
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS public.createtextsearchdictionary_03145_dict CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_03145_tmpl;
...
CREATE TEXT SEARCH DICTIONARY public.createtextsearchdictionary_03145_dict (TEMPLATE = pg_catalog.simple, stopwords = 'createtextsearchdictionary_03145_stop0');
-- primary-target-end
