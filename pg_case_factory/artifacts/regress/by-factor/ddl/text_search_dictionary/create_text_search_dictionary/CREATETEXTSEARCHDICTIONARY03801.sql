...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY03801
...
-- primary_obligation_id: CTSD-EXT|03801|error_assertion|drop_template
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS createtextsearchdictionary_03801_dict CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_03801_tmpl;
...
CREATE TEXT SEARCH DICTIONARY createtextsearchdictionary_03801_dict (TEMPLATE = pg_catalog.simple);
-- primary-target-end
