...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY01256
...
-- primary_obligation_id: CTSD-EXT|01256|error_assertion|drop_text_search_dictionary
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS "createtextsearchdictionary_01256_QDict" CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_01256_tmpl;
...
CREATE TEXT SEARCH DICTIONARY "createtextsearchdictionary_01256_QDict" (TEMPLATE = pg_catalog.simple);
-- primary-target-end
