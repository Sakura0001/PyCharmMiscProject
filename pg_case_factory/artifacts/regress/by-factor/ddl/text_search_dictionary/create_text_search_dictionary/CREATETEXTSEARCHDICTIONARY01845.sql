...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY01845
...
-- primary_obligation_id: CTSD-EXT|01845|error_assertion|drop_template
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS "createtextsearchdictionary_01845_QDict" CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_01845_tmpl;
...
CREATE TEXT SEARCH DICTIONARY "createtextsearchdictionary_01845_QDict" (TEMPLATE = simple);
-- primary-target-end
