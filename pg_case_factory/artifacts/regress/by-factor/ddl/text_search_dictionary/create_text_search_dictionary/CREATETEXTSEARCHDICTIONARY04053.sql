...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY04053
...
-- primary_obligation_id: CTSD-EXT|04053|error_assertion|drop_template
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS createtextsearchdictionary_04053_dict CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_04053_tmpl;
...
CREATE TEXT SEARCH DICTIONARY createtextsearchdictionary_04053_dict (TEMPLATE = simple, stopwords = 'createtextsearchdictionary_04053_stop0');
-- primary-target-end
