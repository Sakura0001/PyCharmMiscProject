...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY02861
...
-- primary_obligation_id: CTSD-EXT|02861|error_assertion|drop_template
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS "all" CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_02861_tmpl;
...
CREATE TEXT SEARCH DICTIONARY "all" (TEMPLATE = simple, stopwords = 'createtextsearchdictionary_02861_stop0');
-- primary-target-end
