...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY04381
...
-- primary_obligation_id: CTSD-EXT|04381|error_assertion|drop_template
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS createtextsearchdictionary_04381_dict CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_04381_tmpl;
...
CREATE TEXT SEARCH DICTIONARY createtextsearchdictionary_04381_dict (TEMPLATE = simple);
-- primary-target-end
