...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY04041
...
-- primary_obligation_id: CTSD-EXT|04041|error_assertion|drop_template
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS createtextsearchdictionary_04041_dict CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_04041_tmpl;
...
CREATE TEXT SEARCH DICTIONARY createtextsearchdictionary_04041_dict (TEMPLATE = pg_catalog.simple, stopwords = 5);
-- primary-target-end
