...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY03984
...
-- primary_obligation_id: CTSD-EXT|03984|error_assertion|drop_text_search_dictionary
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS createtextsearchdictionary_03984_dict CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_03984_tmpl;
...
CREATE TEXT SEARCH DICTIONARY createtextsearchdictionary_03984_dict (TEMPLATE = pg_catalog.simple, stopwords = 'createtextsearchdictionary_03984_stop0');
-- primary-target-end
