...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY03925
...
-- primary_obligation_id: CTSD-EXT|03925|error_assertion|drop_template
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS createtextsearchdictionary_03925_dict CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_03925_tmpl;
...
CREATE TEXT SEARCH DICTIONARY createtextsearchdictionary_03925_dict (TEMPLATE = simple, stopwords = 'createtextsearchdictionary_03925_stop0', language = 'createtextsearchdictionary_03925_stop1');
-- primary-target-end
