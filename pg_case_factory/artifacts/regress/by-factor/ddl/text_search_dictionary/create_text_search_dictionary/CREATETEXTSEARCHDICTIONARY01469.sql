...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY01469
...
-- primary_obligation_id: CTSD-EXT|01469|error_assertion|drop_template
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS "createtextsearchdictionary_01469_QDict" CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_01469_tmpl;
...
CREATE TEXT SEARCH DICTIONARY "createtextsearchdictionary_01469_QDict" (TEMPLATE = simple, stopwords = 'createtextsearchdictionary_01469_stop0');
-- primary-target-end
