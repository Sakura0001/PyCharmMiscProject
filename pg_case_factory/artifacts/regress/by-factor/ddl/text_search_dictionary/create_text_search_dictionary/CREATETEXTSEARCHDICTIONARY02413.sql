...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY02413
...
-- primary_obligation_id: CTSD-EXT|02413|error_assertion|drop_template
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS "all" CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_02413_tmpl;
...
CREATE TEXT SEARCH DICTIONARY "all" (TEMPLATE = createtextsearchdictionary_02413_nosuchtmpl);
-- primary-target-end
