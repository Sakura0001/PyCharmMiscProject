...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY03989
...
-- primary_obligation_id: CTSD-EXT|03989|error_assertion|drop_template
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS createtextsearchdictionary_03989_dict CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_03989_tmpl;
...
CREATE TEXT SEARCH DICTIONARY createtextsearchdictionary_03989_dict (TEMPLATE = simple, stopwords = 'createtextsearchdictionary_03989_stop0');
-- primary-target-end
