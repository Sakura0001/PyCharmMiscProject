...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY02857
...
-- primary_obligation_id: CTSD-EXT|02857|error_assertion|drop_template
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS "all" CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_02857_tmpl;
...
CREATE TEXT SEARCH DICTIONARY "all" (TEMPLATE = pg_catalog.simple, stopwords = 'createtextsearchdictionary_02857_stop0');
-- primary-target-end
