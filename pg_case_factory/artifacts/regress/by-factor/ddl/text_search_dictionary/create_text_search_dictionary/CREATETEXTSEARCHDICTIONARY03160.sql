...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY03160
...
-- primary_obligation_id: CTSD-EXT|03160|error_assertion|drop_text_search_dictionary
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS public.createtextsearchdictionary_03160_dict CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_03160_tmpl;
...
CREATE TEXT SEARCH DICTIONARY public.createtextsearchdictionary_03160_dict (TEMPLATE = pg_catalog.simple, stopwords = 'createtextsearchdictionary_03160_stop0');
-- primary-target-end
