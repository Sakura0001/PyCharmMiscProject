...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY03845
...
-- primary_obligation_id: CTSD-EXT|03845|error_assertion|drop_template
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS createtextsearchdictionary_03845_dict CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_03845_tmpl;
...
CREATE TEXT SEARCH DICTIONARY createtextsearchdictionary_03845_dict (TEMPLATE = simple);
-- primary-target-end
