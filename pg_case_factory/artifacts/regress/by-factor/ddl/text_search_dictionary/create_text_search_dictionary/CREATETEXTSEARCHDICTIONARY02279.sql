...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY02279
...
-- primary_obligation_id: CTSD-EXT|02279|catalog_query_pg_ts_dict|drop_template
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS "all" CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_02279_tmpl;
...
CREATE TEXT SEARCH DICTIONARY "all" (TEMPLATE = pg_catalog.simple, stopwords = 'createtextsearchdictionary_02279_stop0');
-- primary-target-end
