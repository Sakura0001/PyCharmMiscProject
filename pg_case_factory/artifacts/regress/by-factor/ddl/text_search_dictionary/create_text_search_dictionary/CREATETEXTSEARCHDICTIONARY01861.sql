...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY01861
...
-- primary_obligation_id: CTSD-EXT|01861|error_assertion|drop_template
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS "createtextsearchdictionary_01861_QDict" CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_01861_tmpl;
...
CREATE TEXT SEARCH DICTIONARY "createtextsearchdictionary_01861_QDict" (TEMPLATE = simple);
-- primary-target-end
