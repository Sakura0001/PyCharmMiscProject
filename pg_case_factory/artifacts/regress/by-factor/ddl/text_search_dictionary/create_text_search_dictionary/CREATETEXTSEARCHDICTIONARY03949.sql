...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY03949
...
-- primary_obligation_id: CTSD-EXT|03949|error_assertion|drop_template
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS createtextsearchdictionary_03949_dict CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_03949_tmpl;
...
CREATE TEXT SEARCH DICTIONARY createtextsearchdictionary_03949_dict (TEMPLATE = simple, stopwords = 5, language = 6);
-- primary-target-end
