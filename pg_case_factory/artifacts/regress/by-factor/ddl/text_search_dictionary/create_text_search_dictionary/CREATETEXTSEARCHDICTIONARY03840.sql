...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY03840
...
-- primary_obligation_id: CTSD-EXT|03840|error_assertion|drop_text_search_dictionary
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS createtextsearchdictionary_03840_dict CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_03840_tmpl;
...
CREATE TEXT SEARCH DICTIONARY createtextsearchdictionary_03840_dict (TEMPLATE = pg_catalog.simple);
-- primary-target-end
