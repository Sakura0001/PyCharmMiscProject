...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY01781
...
-- primary_obligation_id: CTSD-EXT|01781|error_assertion|drop_template
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS "createtextsearchdictionary_01781_QDict" CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_01781_tmpl;
...
CREATE TEXT SEARCH DICTIONARY "createtextsearchdictionary_01781_QDict" (TEMPLATE = simple);
-- primary-target-end
