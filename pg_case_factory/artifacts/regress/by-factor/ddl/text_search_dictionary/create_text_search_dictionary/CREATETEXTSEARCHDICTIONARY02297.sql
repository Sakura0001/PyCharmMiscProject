...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY02297
...
-- primary_obligation_id: CTSD-EXT|02297|error_assertion|drop_template
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS "all" CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_02297_tmpl;
...
CREATE TEXT SEARCH DICTIONARY "all" (TEMPLATE = pg_catalog.simple, stopwords = 'createtextsearchdictionary_02297_stop0');
-- primary-target-end
