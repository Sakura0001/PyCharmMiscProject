...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY04012
...
-- primary_obligation_id: CTSD-EXT|04012|error_assertion|drop_text_search_dictionary
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS createtextsearchdictionary_04012_dict CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_04012_tmpl;
...
CREATE TEXT SEARCH DICTIONARY createtextsearchdictionary_04012_dict (TEMPLATE = simple, stopwords = 'createtextsearchdictionary_04012_stop0');
-- primary-target-end
