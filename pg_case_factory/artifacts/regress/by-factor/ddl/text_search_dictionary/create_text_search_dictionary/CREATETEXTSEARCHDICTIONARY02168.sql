...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY02168
...
-- primary_obligation_id: CTSD-EXT|02168|error_assertion|drop_text_search_dictionary
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS "all" CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_02168_tmpl;
...
CREATE TEXT SEARCH DICTIONARY "all" (TEMPLATE = pg_catalog.simple, stopwords = 'createtextsearchdictionary_02168_stop0', language = 'createtextsearchdictionary_02168_stop1');
-- primary-target-end
