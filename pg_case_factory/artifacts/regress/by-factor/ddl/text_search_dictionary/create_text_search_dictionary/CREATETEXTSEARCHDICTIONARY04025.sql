...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY04025
...
-- primary_obligation_id: CTSD-EXT|04025|error_assertion|drop_template
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS createtextsearchdictionary_04025_dict CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_04025_tmpl;
...
CREATE TEXT SEARCH DICTIONARY createtextsearchdictionary_04025_dict (TEMPLATE = pg_catalog.simple, stopwords = 'createtextsearchdictionary_04025_stop0');
-- primary-target-end
