...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY01484
...
-- primary_obligation_id: CTSD-EXT|01484|error_assertion|drop_text_search_dictionary
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS "createtextsearchdictionary_01484_QDict" CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_01484_tmpl;
...
CREATE TEXT SEARCH DICTIONARY "createtextsearchdictionary_01484_QDict" (TEMPLATE = simple, stopwords = createtextsearchdictionary_01484_stop0);
-- primary-target-end
