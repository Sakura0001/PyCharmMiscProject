...
-- ++
-- --------------------------------------------------------
-- case_id: CREATETEXTSEARCHDICTIONARY01448
...
-- primary_obligation_id: CTSD-EXT|01448|error_assertion|drop_text_search_dictionary
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS "createtextsearchdictionary_01448_QDict" CASCADE;
DROP TEXT SEARCH TEMPLATE IF EXISTS createtextsearchdictionary_01448_tmpl;
...
CREATE TEXT SEARCH DICTIONARY "createtextsearchdictionary_01448_QDict" (TEMPLATE = pg_catalog.simple, stopwords = 5);
-- primary-target-end
