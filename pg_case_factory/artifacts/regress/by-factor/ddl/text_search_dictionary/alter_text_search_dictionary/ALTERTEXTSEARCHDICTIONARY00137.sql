...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00137
...
-- primary_obligation_id: ATSD-EXT|00137|error_assertion|revert_owner
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00137_no_such_dict (stopword = 'english');
-- primary-target-end
