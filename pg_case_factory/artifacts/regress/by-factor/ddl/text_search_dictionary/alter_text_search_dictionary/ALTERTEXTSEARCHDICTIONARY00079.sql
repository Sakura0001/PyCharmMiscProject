...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00079
...
-- primary_obligation_id: ATSD-EXT|00079|error_assertion|role_cleanup
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00079_no_such_dict (dummy);
-- primary-target-end
