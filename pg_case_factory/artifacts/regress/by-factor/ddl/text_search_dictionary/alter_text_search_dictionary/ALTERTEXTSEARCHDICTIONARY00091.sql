...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00091
...
-- primary_obligation_id: ATSD-EXT|00091|error_assertion|revert_rename
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00091_no_such_dict (dummy);
-- primary-target-end
