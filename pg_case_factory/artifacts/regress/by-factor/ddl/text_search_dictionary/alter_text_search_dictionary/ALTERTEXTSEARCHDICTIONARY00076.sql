...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00076
...
-- primary_obligation_id: ATSD-EXT|00076|error_assertion|revert_rename
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00076_no_such_dict (dummy);
-- primary-target-end
