...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY01234
...
-- primary_obligation_id: ATSD-EXT|01234|error_assertion|role_cleanup
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_01234_no_such_dict SET SCHEMA alter_text_search_dictionary_01234_schema;
-- primary-target-end
