...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY01227
...
-- primary_obligation_id: ATSD-EXT|01227|option_query|revert_owner
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_01227_no_such_dict SET SCHEMA alter_text_search_dictionary_01227_schema;
-- primary-target-end
...
SELECT count(*) = 0 AS option_state FROM pg_catalog.pg_ts_dict WHERE dictname = 'alter_text_search_dictionary_01227_no_such_dict' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
