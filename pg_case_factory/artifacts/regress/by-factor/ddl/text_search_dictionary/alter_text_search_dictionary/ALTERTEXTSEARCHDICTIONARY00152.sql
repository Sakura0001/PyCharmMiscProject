...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00152
...
-- primary_obligation_id: ATSD-EXT|00152|error_assertion|revert_owner
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00152_no_such_dict (stopword = 'english');
-- primary-target-end
