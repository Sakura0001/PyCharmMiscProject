...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00544
...
-- primary_obligation_id: ATSD-EXT|00544|error_assertion|role_cleanup
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00544_no_such_dict OWNER TO SESSION_USER;
-- primary-target-end
