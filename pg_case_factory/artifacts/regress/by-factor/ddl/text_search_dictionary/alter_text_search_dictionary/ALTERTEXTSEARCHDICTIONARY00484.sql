...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00484
...
-- primary_obligation_id: ATSD-EXT|00484|error_assertion|role_cleanup
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00484_no_such_dict OWNER TO CURRENT_USER;
-- primary-target-end
