...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00121
...
-- primary_obligation_id: ATSD-EXT|00121|error_assertion|revert_rename
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00121_no_such_dict (stopword);
-- primary-target-end
