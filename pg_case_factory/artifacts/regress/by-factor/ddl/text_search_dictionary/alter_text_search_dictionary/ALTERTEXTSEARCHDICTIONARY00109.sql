...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00109
...
-- primary_obligation_id: ATSD-EXT|00109|error_assertion|role_cleanup
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00109_no_such_dict (stopword);
-- primary-target-end
