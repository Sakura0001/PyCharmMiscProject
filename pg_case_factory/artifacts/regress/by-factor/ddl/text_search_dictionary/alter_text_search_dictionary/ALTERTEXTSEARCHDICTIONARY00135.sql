...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00135
...
-- primary_obligation_id: ATSD-EXT|00135|error_assertion|revert_option
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00135_no_such_dict (stopword = 'english');
-- primary-target-end
