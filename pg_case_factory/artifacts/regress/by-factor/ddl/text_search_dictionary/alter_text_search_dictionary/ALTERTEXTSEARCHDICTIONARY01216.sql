...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY01216
...
-- primary_obligation_id: ATSD-EXT|01216|error_assertion|revert_rename
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_01216_no_such_dict SET SCHEMA alter_text_search_dictionary_01216_schema;
-- primary-target-end
