...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY01218
...
-- primary_obligation_id: ATSD-EXT|01218|error_assertion|drop_text_search_dictionary
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_01218_no_such_dict SET SCHEMA alter_text_search_dictionary_01218_schema;
-- primary-target-end
