...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY01217
...
-- primary_obligation_id: ATSD-EXT|01217|error_assertion|revert_owner
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_01217_no_such_dict SET SCHEMA alter_text_search_dictionary_01217_schema;
-- primary-target-end
