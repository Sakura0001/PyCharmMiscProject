...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00124
...
-- primary_obligation_id: ATSD-EXT|00124|error_assertion|role_cleanup
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00124_no_such_dict (stopword);
-- primary-target-end
