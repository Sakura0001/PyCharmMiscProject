...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00092
...
-- primary_obligation_id: ATSD-EXT|00092|error_assertion|revert_owner
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00092_no_such_dict (dummy);
-- primary-target-end
