...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00255
...
-- primary_obligation_id: ATSD-EXT|00255|error_assertion|revert_option
...
-- 2. 创建完整本地规则和因子专用夹具。
CREATE TEXT SEARCH DICTIONARY alter_text_search_dictionary_00255_dict (TEMPLATE = pg_catalog.simple);
-- 3. 执行唯一获得覆盖信用的 ALTER TEXT SEARCH DICTIONARY。
-- primary-target-begin
ALTER TEXT SEARCH DICTIONARY "alter_text_search_dictionary_00255_Mixed Dict" (stopword);
-- primary-target-end
