...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00481
...
-- primary_obligation_id: ATSD-EXT|00481|error_assertion|revert_rename
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00481_no_such_dict OWNER TO CURRENT_USER;
-- primary-target-end
