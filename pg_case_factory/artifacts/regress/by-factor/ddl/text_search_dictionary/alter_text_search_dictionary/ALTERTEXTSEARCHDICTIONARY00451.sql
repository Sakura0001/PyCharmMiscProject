...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00451
...
-- primary_obligation_id: ATSD-EXT|00451|error_assertion|revert_rename
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00451_no_such_dict OWNER TO CURRENT_ROLE;
-- primary-target-end
