...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00452
...
-- primary_obligation_id: ATSD-EXT|00452|error_assertion|revert_owner
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00452_no_such_dict OWNER TO CURRENT_ROLE;
-- primary-target-end
