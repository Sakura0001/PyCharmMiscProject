...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00090
...
-- primary_obligation_id: ATSD-EXT|00090|error_assertion|revert_option
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00090_no_such_dict (dummy);
-- primary-target-end
