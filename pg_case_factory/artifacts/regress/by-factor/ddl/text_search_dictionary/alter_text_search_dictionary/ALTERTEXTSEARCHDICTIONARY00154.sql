...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00154
...
-- primary_obligation_id: ATSD-EXT|00154|error_assertion|role_cleanup
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00154_no_such_dict (stopword = 'english');
-- primary-target-end
