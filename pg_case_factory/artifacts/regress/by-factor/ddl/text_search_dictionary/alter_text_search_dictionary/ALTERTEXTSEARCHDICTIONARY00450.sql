...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00450
...
-- primary_obligation_id: ATSD-EXT|00450|error_assertion|revert_option
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00450_no_such_dict OWNER TO CURRENT_ROLE;
-- primary-target-end
