...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00153
...
-- primary_obligation_id: ATSD-EXT|00153|error_assertion|drop_text_search_dictionary
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00153_no_such_dict (stopword = 'english');
-- primary-target-end
