...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00077
...
-- primary_obligation_id: ATSD-EXT|00077|error_assertion|revert_owner
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00077_no_such_dict (dummy);
-- primary-target-end
