...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00948
...
-- primary_obligation_id: ATSD-EXT|00948|error_assertion|drop_text_search_dictionary
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS alter_text_search_dictionary_00948_newdict;
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00948_no_such_dict RENAME TO alter_text_search_dictionary_00948_newdict;
-- primary-target-end
