...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00139
...
-- primary_obligation_id: ATSD-EXT|00139|error_assertion|role_cleanup
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00139_no_such_dict (stopword = 'english');
-- primary-target-end
