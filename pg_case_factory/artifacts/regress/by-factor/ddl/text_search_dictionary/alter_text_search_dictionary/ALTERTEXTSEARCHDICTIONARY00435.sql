...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00435
...
-- primary_obligation_id: ATSD-EXT|00435|error_assertion|revert_option
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00435_no_such_dict OWNER TO CURRENT_ROLE;
-- primary-target-end
