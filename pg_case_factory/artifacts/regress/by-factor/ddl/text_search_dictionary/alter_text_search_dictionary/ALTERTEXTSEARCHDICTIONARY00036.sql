...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00036
...
-- primary_obligation_id: ATSD-SFV|sfv-683d43f1dfd434206d6a5870|option_modify
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00036_no_such_dict (stopword = 'english');
-- primary-target-end
...
SELECT count(*) = 0 AS dict_state FROM pg_catalog.pg_ts_dict WHERE dictname = 'alter_text_search_dictionary_00036_no_such_dict' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
