...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00437
...
-- primary_obligation_id: ATSD-EXT|00437|error_assertion|revert_owner
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00437_no_such_dict OWNER TO CURRENT_ROLE;
-- primary-target-end
