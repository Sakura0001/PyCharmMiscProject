...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00093
...
-- primary_obligation_id: ATSD-EXT|00093|error_assertion|drop_text_search_dictionary
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00093_no_such_dict (dummy);
-- primary-target-end
