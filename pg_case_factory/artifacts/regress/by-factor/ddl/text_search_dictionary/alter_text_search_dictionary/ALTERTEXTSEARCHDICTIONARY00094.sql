...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00094
...
-- primary_obligation_id: ATSD-EXT|00094|error_assertion|role_cleanup
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00094_no_such_dict (dummy);
-- primary-target-end
