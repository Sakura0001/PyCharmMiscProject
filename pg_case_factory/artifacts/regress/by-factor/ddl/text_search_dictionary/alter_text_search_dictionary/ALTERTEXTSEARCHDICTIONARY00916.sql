...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00916
...
-- primary_obligation_id: ATSD-EXT|00916|error_assertion|revert_rename
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS "alter_text_search_dictionary_00916_Mixed New";
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00916_no_such_dict RENAME TO "alter_text_search_dictionary_00916_Mixed New";
-- primary-target-end
