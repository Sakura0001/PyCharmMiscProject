...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY01215
...
-- primary_obligation_id: ATSD-EXT|01215|error_assertion|revert_option
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_01215_no_such_dict SET SCHEMA alter_text_search_dictionary_01215_schema;
-- primary-target-end
