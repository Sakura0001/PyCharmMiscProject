...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00466
...
-- primary_obligation_id: ATSD-EXT|00466|error_assertion|revert_rename
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00466_no_such_dict OWNER TO CURRENT_USER;
-- primary-target-end
