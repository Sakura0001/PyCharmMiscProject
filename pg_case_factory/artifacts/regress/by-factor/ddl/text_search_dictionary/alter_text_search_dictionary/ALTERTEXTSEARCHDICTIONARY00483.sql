...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00483
...
-- primary_obligation_id: ATSD-EXT|00483|error_assertion|drop_text_search_dictionary
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00483_no_such_dict OWNER TO CURRENT_USER;
-- primary-target-end
