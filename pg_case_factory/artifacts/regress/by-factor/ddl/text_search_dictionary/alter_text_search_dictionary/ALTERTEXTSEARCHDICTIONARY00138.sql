...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00138
...
-- primary_obligation_id: ATSD-EXT|00138|error_assertion|drop_text_search_dictionary
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00138_no_such_dict (stopword = 'english');
-- primary-target-end
