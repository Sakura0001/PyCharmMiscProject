...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00122
...
-- primary_obligation_id: ATSD-EXT|00122|error_assertion|revert_owner
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00122_no_such_dict (stopword);
-- primary-target-end
