...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00439
...
-- primary_obligation_id: ATSD-EXT|00439|error_assertion|role_cleanup
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00439_no_such_dict OWNER TO CURRENT_ROLE;
-- primary-target-end
