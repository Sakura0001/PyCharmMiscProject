...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00136
...
-- primary_obligation_id: ATSD-EXT|00136|error_assertion|revert_rename
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00136_no_such_dict (stopword = 'english');
-- primary-target-end
