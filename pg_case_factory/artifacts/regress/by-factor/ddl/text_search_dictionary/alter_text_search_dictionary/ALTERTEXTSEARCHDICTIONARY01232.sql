...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY01232
...
-- primary_obligation_id: ATSD-EXT|01232|error_assertion|revert_owner
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_01232_no_such_dict SET SCHEMA alter_text_search_dictionary_01232_schema;
-- primary-target-end
