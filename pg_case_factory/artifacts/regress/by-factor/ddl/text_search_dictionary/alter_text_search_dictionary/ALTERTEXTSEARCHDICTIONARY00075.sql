...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00075
...
-- primary_obligation_id: ATSD-EXT|00075|error_assertion|revert_option
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00075_no_such_dict (dummy);
-- primary-target-end
