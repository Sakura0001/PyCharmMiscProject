...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00525
...
-- primary_obligation_id: ATSD-EXT|00525|error_assertion|revert_option
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00525_no_such_dict OWNER TO SESSION_USER;
-- primary-target-end
