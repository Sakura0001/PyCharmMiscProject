...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00529
...
-- primary_obligation_id: ATSD-EXT|00529|error_assertion|role_cleanup
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00529_no_such_dict OWNER TO SESSION_USER;
-- primary-target-end
