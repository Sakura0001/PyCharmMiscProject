...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00105
...
-- primary_obligation_id: ATSD-EXT|00105|error_assertion|revert_option
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00105_no_such_dict (stopword);
-- primary-target-end
