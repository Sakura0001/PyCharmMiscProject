...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00108
...
-- primary_obligation_id: ATSD-EXT|00108|error_assertion|drop_text_search_dictionary
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00108_no_such_dict (stopword);
-- primary-target-end
