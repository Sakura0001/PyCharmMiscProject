...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00436
...
-- primary_obligation_id: ATSD-EXT|00436|error_assertion|revert_rename
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00436_no_such_dict OWNER TO CURRENT_ROLE;
-- primary-target-end
