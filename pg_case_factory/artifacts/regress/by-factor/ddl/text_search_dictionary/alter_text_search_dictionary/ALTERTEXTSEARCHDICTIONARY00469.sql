...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00469
...
-- primary_obligation_id: ATSD-EXT|00469|error_assertion|role_cleanup
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00469_no_such_dict OWNER TO CURRENT_USER;
-- primary-target-end
