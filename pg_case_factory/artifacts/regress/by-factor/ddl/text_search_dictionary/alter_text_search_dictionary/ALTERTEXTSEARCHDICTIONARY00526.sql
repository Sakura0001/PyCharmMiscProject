...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00526
...
-- primary_obligation_id: ATSD-EXT|00526|error_assertion|revert_rename
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00526_no_such_dict OWNER TO SESSION_USER;
-- primary-target-end
