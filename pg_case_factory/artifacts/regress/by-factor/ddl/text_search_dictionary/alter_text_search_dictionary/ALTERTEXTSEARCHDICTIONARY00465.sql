...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00465
...
-- primary_obligation_id: ATSD-EXT|00465|error_assertion|revert_option
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00465_no_such_dict OWNER TO CURRENT_USER;
-- primary-target-end
