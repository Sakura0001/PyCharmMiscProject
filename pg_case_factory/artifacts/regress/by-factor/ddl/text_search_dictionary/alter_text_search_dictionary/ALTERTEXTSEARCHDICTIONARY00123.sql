...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00123
...
-- primary_obligation_id: ATSD-EXT|00123|error_assertion|drop_text_search_dictionary
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00123_no_such_dict (stopword);
-- primary-target-end
