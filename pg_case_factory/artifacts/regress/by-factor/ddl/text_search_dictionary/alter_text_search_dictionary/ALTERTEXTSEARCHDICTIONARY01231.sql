...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY01231
...
-- primary_obligation_id: ATSD-EXT|01231|error_assertion|revert_rename
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_01231_no_such_dict SET SCHEMA alter_text_search_dictionary_01231_schema;
-- primary-target-end
