...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00078
...
-- primary_obligation_id: ATSD-EXT|00078|error_assertion|drop_text_search_dictionary
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00078_no_such_dict (dummy);
-- primary-target-end
