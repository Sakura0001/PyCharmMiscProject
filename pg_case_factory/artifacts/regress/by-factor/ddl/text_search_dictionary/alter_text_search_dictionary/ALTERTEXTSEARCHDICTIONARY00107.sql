...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00107
...
-- primary_obligation_id: ATSD-EXT|00107|error_assertion|revert_owner
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00107_no_such_dict (stopword);
-- primary-target-end
