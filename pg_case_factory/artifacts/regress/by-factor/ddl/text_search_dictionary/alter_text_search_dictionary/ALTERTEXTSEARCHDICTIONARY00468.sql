...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00468
...
-- primary_obligation_id: ATSD-EXT|00468|error_assertion|drop_text_search_dictionary
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00468_no_such_dict OWNER TO CURRENT_USER;
-- primary-target-end
