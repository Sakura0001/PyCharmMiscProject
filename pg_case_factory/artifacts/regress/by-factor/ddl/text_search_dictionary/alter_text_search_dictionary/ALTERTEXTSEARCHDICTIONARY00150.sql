...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00150
...
-- primary_obligation_id: ATSD-EXT|00150|error_assertion|revert_option
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00150_no_such_dict (stopword = 'english');
-- primary-target-end
