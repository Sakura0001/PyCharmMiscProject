...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00949
...
-- primary_obligation_id: ATSD-EXT|00949|error_assertion|role_cleanup
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS alter_text_search_dictionary_00949_newdict;
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00949_no_such_dict RENAME TO alter_text_search_dictionary_00949_newdict;
-- primary-target-end
