...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY01233
...
-- primary_obligation_id: ATSD-EXT|01233|error_assertion|drop_text_search_dictionary
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_01233_no_such_dict SET SCHEMA alter_text_search_dictionary_01233_schema;
-- primary-target-end
