...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00482
...
-- primary_obligation_id: ATSD-EXT|00482|error_assertion|revert_owner
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00482_no_such_dict OWNER TO CURRENT_USER;
-- primary-target-end
