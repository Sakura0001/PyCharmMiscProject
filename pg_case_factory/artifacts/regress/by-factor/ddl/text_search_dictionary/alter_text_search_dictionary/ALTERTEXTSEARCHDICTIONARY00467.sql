...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00467
...
-- primary_obligation_id: ATSD-EXT|00467|error_assertion|revert_owner
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00467_no_such_dict OWNER TO CURRENT_USER;
-- primary-target-end
