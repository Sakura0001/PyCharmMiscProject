...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00106
...
-- primary_obligation_id: ATSD-EXT|00106|error_assertion|revert_rename
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00106_no_such_dict (stopword);
-- primary-target-end
