...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00151
...
-- primary_obligation_id: ATSD-EXT|00151|error_assertion|revert_rename
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00151_no_such_dict (stopword = 'english');
-- primary-target-end
