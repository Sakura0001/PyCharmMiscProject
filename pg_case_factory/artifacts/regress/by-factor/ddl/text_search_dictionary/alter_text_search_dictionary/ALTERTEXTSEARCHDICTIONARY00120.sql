...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00120
...
-- primary_obligation_id: ATSD-EXT|00120|error_assertion|revert_option
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00120_no_such_dict (stopword);
-- primary-target-end
