...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY01219
...
-- primary_obligation_id: ATSD-EXT|01219|error_assertion|role_cleanup
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_01219_no_such_dict SET SCHEMA alter_text_search_dictionary_01219_schema;
-- primary-target-end
