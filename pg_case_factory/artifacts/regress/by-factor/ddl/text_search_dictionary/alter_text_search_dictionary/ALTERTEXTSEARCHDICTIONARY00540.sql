...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00540
...
-- primary_obligation_id: ATSD-EXT|00540|error_assertion|revert_option
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00540_no_such_dict OWNER TO SESSION_USER;
-- primary-target-end
