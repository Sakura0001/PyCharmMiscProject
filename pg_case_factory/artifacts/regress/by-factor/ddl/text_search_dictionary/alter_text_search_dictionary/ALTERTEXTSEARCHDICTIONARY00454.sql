...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHDICTIONARY00454
...
-- primary_obligation_id: ATSD-EXT|00454|error_assertion|role_cleanup
...
ALTER TEXT SEARCH DICTIONARY alter_text_search_dictionary_00454_no_such_dict OWNER TO CURRENT_ROLE;
-- primary-target-end
