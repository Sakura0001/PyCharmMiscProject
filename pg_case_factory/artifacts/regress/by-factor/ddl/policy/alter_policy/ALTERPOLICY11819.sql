...
-- primary_obligation_id: AP-EXT|11819|rename|error_assertion|disable_rls_and_drop_policy
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS alterpolicy_11819_no_such_table CASCADE;
...
ALTER POLICY alterpolicy_11819_pol_ex ON alterpolicy_11819_no_such_table RENAME TO alterpolicy_11819_pol_new;
-- primary-target-end
