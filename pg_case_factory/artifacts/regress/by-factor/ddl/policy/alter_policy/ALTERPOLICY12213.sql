...
-- primary_obligation_id: AP-EXT|12213|rename|error_assertion|drop_policy
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS alterpolicy_12213_no_such_table CASCADE;
...
ALTER POLICY alterpolicy_12213_pol ON alterpolicy_12213_no_such_table RENAME TO alterpolicy_12213_pol_new;
-- primary-target-end
