...
-- primary_obligation_id: AP-EXT|09192|modify_with_check|error_assertion|drop_table
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS alterpolicy_09192_no_such_table CASCADE;
...
ALTER POLICY "alterpolicy_09192_pol" ON alterpolicy_09192_no_such_table WITH CHECK (false);
-- primary-target-end
