...
-- primary_obligation_id: AP-EXT|00540|modify_combined|error_assertion|drop_table
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS alterpolicy_00540_no_such_table CASCADE;
...
ALTER POLICY alterpolicy_00540_pol ON alterpolicy_00540_no_such_table TO PUBLIC USING (true) WITH CHECK (true);
-- primary-target-end
