...
-- primary_obligation_id: AP-EXT|03048|modify_roles|error_assertion|drop_table
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS alterpolicy_03048_no_such_table CASCADE;
...
ALTER POLICY "alterpolicy_03048_pol" ON alterpolicy_03048_no_such_table TO CURRENT_USER;
-- primary-target-end
