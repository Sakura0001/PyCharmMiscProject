...
-- primary_obligation_id: AP-EXT|08687|modify_with_check|error_assertion|disable_rls_and_drop_policy
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS alterpolicy_08687_no_such_table CASCADE;
...
ALTER POLICY alterpolicy_08687_pol_ex ON alterpolicy_08687_no_such_table WITH CHECK (false);
-- primary-target-end
