...
-- primary_obligation_id: AP-EXT|01533|modify_roles|error_assertion|drop_policy
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS alterpolicy_01533_no_such_table CASCADE;
...
ALTER POLICY alterpolicy_01533_pol_ex ON alterpolicy_01533_no_such_table TO CURRENT_USER;
-- primary-target-end
