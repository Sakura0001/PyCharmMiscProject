...
-- primary_obligation_id: AP-EXT|07342|modify_using|error_assertion|revert_rename
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS alterpolicy_07342_no_such_table CASCADE;
...
ALTER POLICY "alterpolicy_07342_pol" ON alterpolicy_07342_no_such_table USING (false);
-- primary-target-end
