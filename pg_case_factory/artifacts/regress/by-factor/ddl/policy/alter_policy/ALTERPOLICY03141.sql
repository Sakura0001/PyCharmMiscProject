...
-- primary_obligation_id: AP-EXT|03141|modify_roles|error_assertion|drop_policy
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS alterpolicy_03141_no_such_table CASCADE;
...
ALTER POLICY "alterpolicy_03141_pol" ON alterpolicy_03141_no_such_table TO SESSION_USER;
-- primary-target-end
