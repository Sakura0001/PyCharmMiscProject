...
-- primary_obligation_id: AP-EXT|09444|modify_with_check|error_assertion|drop_table
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS alterpolicy_09444_no_such_table CASCADE;
...
ALTER POLICY alterpolicy_09444_pol ON alterpolicy_09444_no_such_table WITH CHECK (true);
-- primary-target-end
