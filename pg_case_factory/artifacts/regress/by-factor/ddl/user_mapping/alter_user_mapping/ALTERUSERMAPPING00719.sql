...
-- primary_obligation_id: AUM-EXT|00719|error_assertion|revert_option
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP SERVER IF EXISTS alterusermapping_00719_no_such_server CASCADE;
DROP FOREIGN DATA WRAPPER IF EXISTS alterusermapping_00719_fdw;
...
ALTER USER MAPPING FOR CURRENT_ROLE SERVER alterusermapping_00719_no_such_server OPTIONS (DROP alterusermapping_00719_opt);
-- primary-target-end
