...
-- primary_obligation_id: AUM-EXT|01575|error_assertion|drop_user_mapping
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP SERVER IF EXISTS alterusermapping_01575_no_such_server CASCADE;
DROP FOREIGN DATA WRAPPER IF EXISTS alterusermapping_01575_fdw;
...
ALTER USER MAPPING FOR PUBLIC SERVER alterusermapping_01575_no_such_server OPTIONS (DROP alterusermapping_01575_opt);
-- primary-target-end
