...
-- primary_obligation_id: AUM-EXT|01187|error_assertion|revert_option
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP SERVER IF EXISTS alterusermapping_01187_no_such_server CASCADE;
DROP FOREIGN DATA WRAPPER IF EXISTS alterusermapping_01187_fdw;
...
ALTER USER MAPPING FOR USER SERVER alterusermapping_01187_no_such_server OPTIONS (DROP alterusermapping_01187_opt);
-- primary-target-end
