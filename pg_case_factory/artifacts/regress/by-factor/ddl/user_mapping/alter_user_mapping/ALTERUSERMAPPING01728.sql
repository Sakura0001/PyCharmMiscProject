...
-- primary_obligation_id: AUM-EXT|01728|error_assertion|drop_user_mapping
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP SERVER IF EXISTS alterusermapping_01728_no_such_server CASCADE;
DROP FOREIGN DATA WRAPPER IF EXISTS alterusermapping_01728_fdw;
...
ALTER USER MAPPING FOR USER SERVER alterusermapping_01728_no_such_server OPTIONS (SET alterusermapping_01728_opt 'val');
-- primary-target-end
