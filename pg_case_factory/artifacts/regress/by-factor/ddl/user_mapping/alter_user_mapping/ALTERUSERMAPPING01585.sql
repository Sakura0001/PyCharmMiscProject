...
-- primary_obligation_id: AUM-EXT|01585|error_assertion|drop_server
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP SERVER IF EXISTS alterusermapping_01585_no_such_server CASCADE;
DROP FOREIGN DATA WRAPPER IF EXISTS alterusermapping_01585_fdw;
...
ALTER USER MAPPING FOR CURRENT_ROLE SERVER alterusermapping_01585_no_such_server OPTIONS (DROP alterusermapping_01585_opt);
-- primary-target-end
