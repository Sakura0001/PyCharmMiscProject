...
-- primary_obligation_id: AUM-EXT|00316|error_assertion|drop_server
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP SERVER IF EXISTS alterusermapping_00316_no_such_server CASCADE;
DROP FOREIGN DATA WRAPPER IF EXISTS alterusermapping_00316_fdw;
...
ALTER USER MAPPING FOR SESSION_USER SERVER alterusermapping_00316_no_such_server OPTIONS (DROP alterusermapping_00316_opt);
-- primary-target-end
