...
-- primary_obligation_id: AUM-EXT|00215|error_assertion|revert_option
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP SERVER IF EXISTS alterusermapping_00215_no_such_server CASCADE;
DROP FOREIGN DATA WRAPPER IF EXISTS alterusermapping_00215_fdw;
...
ALTER USER MAPPING FOR USER SERVER alterusermapping_00215_no_such_server OPTIONS (ADD alterusermapping_00215_opt 'val');
-- primary-target-end
