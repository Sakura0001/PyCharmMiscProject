...
-- primary_obligation_id: AUM-EXT|01250|error_assertion|revert_option
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP SERVER IF EXISTS alterusermapping_01250_no_such_server CASCADE;
DROP FOREIGN DATA WRAPPER IF EXISTS alterusermapping_01250_fdw;
...
ALTER USER MAPPING FOR PUBLIC SERVER alterusermapping_01250_no_such_server OPTIONS (SET alterusermapping_01250_opt 'val');
-- primary-target-end
