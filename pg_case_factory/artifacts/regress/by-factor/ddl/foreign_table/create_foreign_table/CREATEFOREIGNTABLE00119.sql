...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE00119
...
-- primary_obligation_id: CFT-EXT|00119|error_assertion|drop_server
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_00119_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_00119_ft (createforeigntable_00119_col bigint) SERVER createforeigntable_00119_noserver;
-- primary-target-end
