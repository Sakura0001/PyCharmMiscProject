...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE00959
...
-- primary_obligation_id: CFT-EXT|00959|error_assertion|drop_server
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_00959_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_00959_ft (createforeigntable_00959_col integer) SERVER createforeigntable_00959_noserver;
-- primary-target-end
