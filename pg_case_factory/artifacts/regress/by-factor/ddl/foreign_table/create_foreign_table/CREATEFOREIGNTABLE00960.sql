...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE00960
...
-- primary_obligation_id: CFT-EXT|00960|error_assertion|drop_fdw
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_00960_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_00960_ft (createforeigntable_00960_col integer) SERVER createforeigntable_00960_noserver;
-- primary-target-end
