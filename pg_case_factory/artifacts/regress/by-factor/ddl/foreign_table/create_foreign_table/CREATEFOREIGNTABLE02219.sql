...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE02219
...
-- primary_obligation_id: CFT-EXT|02219|error_assertion|drop_server
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_02219_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_02219_ft (createforeigntable_02219_col uuid) SERVER createforeigntable_02219_noserver;
-- primary-target-end
