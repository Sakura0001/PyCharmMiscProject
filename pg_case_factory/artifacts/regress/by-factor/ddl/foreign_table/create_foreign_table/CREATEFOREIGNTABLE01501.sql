...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE01501
...
-- primary_obligation_id: CFT-EXT|01501|error_assertion|drop_parent_table
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_01501_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_01501_ft (createforeigntable_01501_col jsonb) SERVER createforeigntable_01501_noserver;
-- primary-target-end
