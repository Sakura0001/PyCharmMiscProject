...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE02037
...
-- primary_obligation_id: CFT-EXT|02037|error_assertion|drop_foreign_table
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_02037_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_02037_ft (createforeigntable_02037_col timestamp) SERVER createforeigntable_02037_noserver;
-- primary-target-end
