...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE01860
...
-- primary_obligation_id: CFT-EXT|01860|error_assertion|drop_fdw
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_01860_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_01860_ft (createforeigntable_01860_col text) SERVER createforeigntable_01860_noserver;
-- primary-target-end
