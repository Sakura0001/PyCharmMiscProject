...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE02400
...
-- primary_obligation_id: CFT-EXT|02400|error_assertion|drop_fdw
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_02400_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_02400_ft (createforeigntable_02400_col character varying(100)) SERVER createforeigntable_02400_noserver;
-- primary-target-end
