...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE01681
...
-- primary_obligation_id: CFT-EXT|01681|error_assertion|drop_parent_table
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_01681_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_01681_ft (createforeigntable_01681_col numeric(10,2)) SERVER createforeigntable_01681_noserver;
-- primary-target-end
