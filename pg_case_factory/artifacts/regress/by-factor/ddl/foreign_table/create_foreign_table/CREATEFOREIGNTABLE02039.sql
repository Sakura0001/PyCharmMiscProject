...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE02039
...
-- primary_obligation_id: CFT-EXT|02039|error_assertion|drop_server
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_02039_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_02039_ft (createforeigntable_02039_col timestamp) SERVER createforeigntable_02039_noserver;
-- primary-target-end
