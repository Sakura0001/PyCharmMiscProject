...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE00659
...
-- primary_obligation_id: CFT-EXT|00659|error_assertion|drop_server
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_00659_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_00659_ft (createforeigntable_00659_col double precision) SERVER createforeigntable_00659_noserver;
-- primary-target-end
