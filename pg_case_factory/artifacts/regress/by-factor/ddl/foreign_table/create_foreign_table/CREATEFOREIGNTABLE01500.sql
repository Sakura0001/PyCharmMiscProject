...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE01500
...
-- primary_obligation_id: CFT-EXT|01500|error_assertion|drop_fdw
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_01500_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_01500_ft (createforeigntable_01500_col jsonb) SERVER createforeigntable_01500_noserver;
-- primary-target-end
