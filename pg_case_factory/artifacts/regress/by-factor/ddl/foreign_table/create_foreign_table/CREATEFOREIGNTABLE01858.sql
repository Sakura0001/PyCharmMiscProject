...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE01858
...
-- primary_obligation_id: CFT-EXT|01858|error_assertion|drop_foreign_table_cascade
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_01858_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_01858_ft (createforeigntable_01858_col text) SERVER createforeigntable_01858_noserver;
-- primary-target-end
