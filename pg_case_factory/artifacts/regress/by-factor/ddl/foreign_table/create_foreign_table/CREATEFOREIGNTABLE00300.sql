...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE00300
...
-- primary_obligation_id: CFT-EXT|00300|error_assertion|drop_fdw
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_00300_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_00300_ft (createforeigntable_00300_col boolean) SERVER createforeigntable_00300_noserver;
-- primary-target-end
