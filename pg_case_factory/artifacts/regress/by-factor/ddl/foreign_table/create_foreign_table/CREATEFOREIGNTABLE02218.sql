...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE02218
...
-- primary_obligation_id: CFT-EXT|02218|error_assertion|drop_foreign_table_cascade
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_02218_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_02218_ft (createforeigntable_02218_col uuid) SERVER createforeigntable_02218_noserver;
-- primary-target-end
