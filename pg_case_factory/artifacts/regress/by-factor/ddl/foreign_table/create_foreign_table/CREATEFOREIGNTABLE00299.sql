...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE00299
...
-- primary_obligation_id: CFT-EXT|00299|error_assertion|drop_server
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_00299_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_00299_ft (createforeigntable_00299_col boolean) SERVER createforeigntable_00299_noserver;
-- primary-target-end
