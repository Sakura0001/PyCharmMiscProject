...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE01680
...
-- primary_obligation_id: CFT-EXT|01680|error_assertion|drop_fdw
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_01680_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_01680_ft (createforeigntable_01680_col numeric(10,2)) SERVER createforeigntable_01680_noserver;
-- primary-target-end
