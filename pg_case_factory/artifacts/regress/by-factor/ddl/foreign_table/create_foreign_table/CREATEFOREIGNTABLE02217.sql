...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE02217
...
-- primary_obligation_id: CFT-EXT|02217|error_assertion|drop_foreign_table
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_02217_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_02217_ft (createforeigntable_02217_col uuid) SERVER createforeigntable_02217_noserver;
-- primary-target-end
