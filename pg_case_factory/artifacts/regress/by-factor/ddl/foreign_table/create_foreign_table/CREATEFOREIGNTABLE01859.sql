...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE01859
...
-- primary_obligation_id: CFT-EXT|01859|error_assertion|drop_server
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_01859_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_01859_ft (createforeigntable_01859_col text) SERVER createforeigntable_01859_noserver;
-- primary-target-end
