...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE00480
...
-- primary_obligation_id: CFT-EXT|00480|error_assertion|drop_fdw
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_00480_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_00480_ft (createforeigntable_00480_col date) SERVER createforeigntable_00480_noserver;
-- primary-target-end
