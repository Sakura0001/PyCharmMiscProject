...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE00301
...
-- primary_obligation_id: CFT-EXT|00301|error_assertion|drop_parent_table
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_00301_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_00301_ft (createforeigntable_00301_col boolean) SERVER createforeigntable_00301_noserver;
-- primary-target-end
