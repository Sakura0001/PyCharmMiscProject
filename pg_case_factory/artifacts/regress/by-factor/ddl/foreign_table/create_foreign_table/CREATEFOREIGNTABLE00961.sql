...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE00961
...
-- primary_obligation_id: CFT-EXT|00961|error_assertion|drop_parent_table
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_00961_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_00961_ft (createforeigntable_00961_col integer) SERVER createforeigntable_00961_noserver;
-- primary-target-end
