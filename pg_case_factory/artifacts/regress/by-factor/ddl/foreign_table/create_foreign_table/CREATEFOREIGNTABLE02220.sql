...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE02220
...
-- primary_obligation_id: CFT-EXT|02220|error_assertion|drop_fdw
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_02220_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_02220_ft (createforeigntable_02220_col uuid) SERVER createforeigntable_02220_noserver;
-- primary-target-end
