...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE02399
...
-- primary_obligation_id: CFT-EXT|02399|error_assertion|drop_server
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_02399_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_02399_ft (createforeigntable_02399_col character varying(100)) SERVER createforeigntable_02399_noserver;
-- primary-target-end
