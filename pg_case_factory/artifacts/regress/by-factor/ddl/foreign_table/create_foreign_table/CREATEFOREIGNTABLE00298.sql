...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE00298
...
-- primary_obligation_id: CFT-EXT|00298|error_assertion|drop_foreign_table_cascade
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_00298_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_00298_ft (createforeigntable_00298_col boolean) SERVER createforeigntable_00298_noserver;
-- primary-target-end
