...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE01499
...
-- primary_obligation_id: CFT-EXT|01499|error_assertion|drop_server
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_01499_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_01499_ft (createforeigntable_01499_col jsonb) SERVER createforeigntable_01499_noserver;
-- primary-target-end
