...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE01677
...
-- primary_obligation_id: CFT-EXT|01677|error_assertion|drop_foreign_table
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_01677_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_01677_ft (createforeigntable_01677_col numeric(10,2)) SERVER createforeigntable_01677_noserver;
-- primary-target-end
