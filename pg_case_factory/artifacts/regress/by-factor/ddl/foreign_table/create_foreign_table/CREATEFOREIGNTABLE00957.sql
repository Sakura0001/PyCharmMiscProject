...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE00957
...
-- primary_obligation_id: CFT-EXT|00957|error_assertion|drop_foreign_table
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_00957_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_00957_ft (createforeigntable_00957_col integer) SERVER createforeigntable_00957_noserver;
-- primary-target-end
