...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE00657
...
-- primary_obligation_id: CFT-EXT|00657|error_assertion|drop_foreign_table
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_00657_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_00657_ft (createforeigntable_00657_col double precision) SERVER createforeigntable_00657_noserver;
-- primary-target-end
