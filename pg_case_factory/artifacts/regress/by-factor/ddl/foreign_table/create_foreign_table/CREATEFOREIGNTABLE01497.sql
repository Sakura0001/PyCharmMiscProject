...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE01497
...
-- primary_obligation_id: CFT-EXT|01497|error_assertion|drop_foreign_table
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_01497_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_01497_ft (createforeigntable_01497_col jsonb) SERVER createforeigntable_01497_noserver;
-- primary-target-end
