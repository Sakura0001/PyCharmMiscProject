...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE00120
...
-- primary_obligation_id: CFT-EXT|00120|error_assertion|drop_fdw
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_00120_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_00120_ft (createforeigntable_00120_col bigint) SERVER createforeigntable_00120_noserver;
-- primary-target-end
