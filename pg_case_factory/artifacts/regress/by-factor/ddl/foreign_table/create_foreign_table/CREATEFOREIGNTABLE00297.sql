...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE00297
...
-- primary_obligation_id: CFT-EXT|00297|error_assertion|drop_foreign_table
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_00297_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_00297_ft (createforeigntable_00297_col boolean) SERVER createforeigntable_00297_noserver;
-- primary-target-end
