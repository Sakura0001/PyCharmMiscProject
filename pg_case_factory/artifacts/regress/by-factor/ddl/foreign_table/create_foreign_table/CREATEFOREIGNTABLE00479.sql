...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE00479
...
-- primary_obligation_id: CFT-EXT|00479|error_assertion|drop_server
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_00479_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_00479_ft (createforeigntable_00479_col date) SERVER createforeigntable_00479_noserver;
-- primary-target-end
