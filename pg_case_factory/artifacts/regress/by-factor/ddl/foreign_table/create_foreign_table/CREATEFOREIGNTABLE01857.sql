...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE01857
...
-- primary_obligation_id: CFT-EXT|01857|error_assertion|drop_foreign_table
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_01857_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_01857_ft (createforeigntable_01857_col text) SERVER createforeigntable_01857_noserver;
-- primary-target-end
