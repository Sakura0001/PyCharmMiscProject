...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE02040
...
-- primary_obligation_id: CFT-EXT|02040|error_assertion|drop_fdw
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_02040_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_02040_ft (createforeigntable_02040_col timestamp) SERVER createforeigntable_02040_noserver;
-- primary-target-end
