...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE02041
...
-- primary_obligation_id: CFT-EXT|02041|error_assertion|drop_parent_table
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_02041_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_02041_ft (createforeigntable_02041_col timestamp) SERVER createforeigntable_02041_noserver;
-- primary-target-end
