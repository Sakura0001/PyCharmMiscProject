...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE01679
...
-- primary_obligation_id: CFT-EXT|01679|error_assertion|drop_server
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_01679_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_01679_ft (createforeigntable_01679_col numeric(10,2)) SERVER createforeigntable_01679_noserver;
-- primary-target-end
