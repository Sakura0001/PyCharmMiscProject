...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE00660
...
-- primary_obligation_id: CFT-EXT|00660|error_assertion|drop_fdw
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_00660_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_00660_ft (createforeigntable_00660_col double precision) SERVER createforeigntable_00660_noserver;
-- primary-target-end
