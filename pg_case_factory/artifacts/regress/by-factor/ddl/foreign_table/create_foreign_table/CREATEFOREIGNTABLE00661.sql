...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE00661
...
-- primary_obligation_id: CFT-EXT|00661|error_assertion|drop_parent_table
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_00661_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_00661_ft (createforeigntable_00661_col double precision) SERVER createforeigntable_00661_noserver;
-- primary-target-end
