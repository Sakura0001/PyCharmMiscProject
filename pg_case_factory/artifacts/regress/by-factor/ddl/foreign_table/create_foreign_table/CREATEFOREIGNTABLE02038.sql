...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE02038
...
-- primary_obligation_id: CFT-EXT|02038|error_assertion|drop_foreign_table_cascade
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_02038_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_02038_ft (createforeigntable_02038_col timestamp) SERVER createforeigntable_02038_noserver;
-- primary-target-end
