...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE00958
...
-- primary_obligation_id: CFT-EXT|00958|error_assertion|drop_foreign_table_cascade
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_00958_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_00958_ft (createforeigntable_00958_col integer) SERVER createforeigntable_00958_noserver;
-- primary-target-end
