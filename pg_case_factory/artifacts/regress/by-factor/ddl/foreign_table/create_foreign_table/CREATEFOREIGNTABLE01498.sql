...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEFOREIGNTABLE01498
...
-- primary_obligation_id: CFT-EXT|01498|error_assertion|drop_foreign_table_cascade
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN TABLE IF EXISTS createforeigntable_01498_ft CASCADE;
...
CREATE FOREIGN TABLE createforeigntable_01498_ft (createforeigntable_01498_col jsonb) SERVER createforeigntable_01498_noserver;
-- primary-target-end
