...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEOPERATORFAMILY00672
...
-- primary_obligation_id: COF-EXT|00672|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP OPERATOR FAMILY IF EXISTS "createoperatorfamily_00672_QOpfam" CASCADE;
RESET ROLE;
...
CREATE OPERATOR FAMILY "createoperatorfamily_00672_QOpfam" USING pgcf_nosucham;
-- primary-target-end
