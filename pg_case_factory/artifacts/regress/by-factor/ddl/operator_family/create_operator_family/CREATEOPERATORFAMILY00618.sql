...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEOPERATORFAMILY00618
...
-- primary_obligation_id: COF-EXT|00618|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP OPERATOR FAMILY IF EXISTS "createoperatorfamily_00618_QOpfam" CASCADE;
RESET ROLE;
...
CREATE OPERATOR FAMILY "createoperatorfamily_00618_QOpfam" USING pgcf_nosucham;
-- primary-target-end
