...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEOPERATORFAMILY00115
...
-- primary_obligation_id: COF-EXT|00115|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP OPERATOR FAMILY IF EXISTS createoperatorfamily_00115_opfam CASCADE;
RESET ROLE;
...
CREATE OPERATOR FAMILY createoperatorfamily_00115_opfam USING pgcf_nosucham;
-- primary-target-end
