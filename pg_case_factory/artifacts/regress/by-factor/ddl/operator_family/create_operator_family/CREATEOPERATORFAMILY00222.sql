...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEOPERATORFAMILY00222
...
-- primary_obligation_id: COF-EXT|00222|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP OPERATOR FAMILY IF EXISTS public.createoperatorfamily_00222_opfam CASCADE;
RESET ROLE;
...
CREATE OPERATOR FAMILY public.createoperatorfamily_00222_opfam USING pgcf_nosucham;
-- primary-target-end
