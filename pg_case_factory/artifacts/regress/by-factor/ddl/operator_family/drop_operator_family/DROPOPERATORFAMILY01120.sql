...
-- ++
-- --------------------------------------------------------
-- case_id: DROPOPERATORFAMILY01120
...
-- primary_obligation_id: DROPOPERATORFAMILY-EXT|01120|drop_operator_family|catalog_query|drop_objects
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP OPERATOR FAMILY IF EXISTS dropoperatorfamily_01120_opf USING btree CASCADE;
...
SELECT count(*) = 0 AS family_absent FROM pg_catalog.pg_opfamily WHERE opfname = 'dropoperatorfamily_01120_opf' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
DROP OPERATOR FAMILY IF EXISTS dropoperatorfamily_01120_opf USING btree CASCADE;
