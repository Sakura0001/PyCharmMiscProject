...
-- ++
-- --------------------------------------------------------
-- case_id: DROPOPERATORFAMILY01098
...
-- primary_obligation_id: DROPOPERATORFAMILY-EXT|01098|drop_operator_family|effect_query|drop_objects
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP OPERATOR FAMILY IF EXISTS dropoperatorfamily_01098_opf USING btree CASCADE;
...
SELECT count(*) = 0 AS family_absent FROM pg_catalog.pg_opfamily WHERE opfname = 'dropoperatorfamily_01098_opf' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
DROP OPERATOR FAMILY IF EXISTS dropoperatorfamily_01098_opf USING btree CASCADE;
