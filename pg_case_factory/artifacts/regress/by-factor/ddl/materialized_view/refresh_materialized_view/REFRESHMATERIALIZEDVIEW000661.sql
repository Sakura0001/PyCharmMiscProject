...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000661
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000661|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000661_no_such_mv WITH NO DATA;
-- primary-target-end
