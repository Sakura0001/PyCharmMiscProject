...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000133
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000133|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000133_no_such_mv WITH DATA;
-- primary-target-end
