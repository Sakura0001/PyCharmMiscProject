...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000077
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000077|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000077_no_such_mv WITH DATA;
-- primary-target-end
