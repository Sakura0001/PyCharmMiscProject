...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000710
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000710|error_assertion|reset_state
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000710_no_such_mv WITH NO DATA;
-- primary-target-end
