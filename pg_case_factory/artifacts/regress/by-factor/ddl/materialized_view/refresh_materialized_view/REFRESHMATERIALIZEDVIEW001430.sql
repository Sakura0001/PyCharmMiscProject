...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001430
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001430|error_assertion|reset_state
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001430_no_such_mv WITH NO DATA;
-- primary-target-end
