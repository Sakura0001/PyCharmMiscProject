...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001469
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001469|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001469_no_such_mv WITH NO DATA;
-- primary-target-end
