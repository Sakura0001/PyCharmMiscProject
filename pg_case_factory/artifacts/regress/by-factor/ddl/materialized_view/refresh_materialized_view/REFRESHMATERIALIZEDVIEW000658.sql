...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000658
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000658|effect_query|reset_state
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000658_no_such_mv WITH NO DATA;
-- primary-target-end
...
SELECT count(*) AS refreshed_row_count FROM refreshmaterializedview_000658_mv ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
