...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000182
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000182|error_assertion|reset_state
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000182_no_such_mv WITH DATA;
-- primary-target-end
