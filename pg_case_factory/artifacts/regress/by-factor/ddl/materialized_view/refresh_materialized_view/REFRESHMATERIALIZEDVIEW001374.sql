...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001374
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001374|error_assertion|reset_state
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001374_no_such_mv WITH NO DATA;
-- primary-target-end
