...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000169
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000169|effect_query|drop_objects
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000169_no_such_mv WITH DATA;
-- primary-target-end
...
SELECT count(*) AS refreshed_row_count FROM refreshmaterializedview_000169_mv ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
