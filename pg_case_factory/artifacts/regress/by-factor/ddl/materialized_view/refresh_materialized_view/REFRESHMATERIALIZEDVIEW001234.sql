...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001234
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001234|effect_query|reset_state
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001234_no_such_mv WITH DATA;
-- primary-target-end
...
SELECT count(*) AS refreshed_row_count FROM refreshmaterializedview_001234_mv ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
