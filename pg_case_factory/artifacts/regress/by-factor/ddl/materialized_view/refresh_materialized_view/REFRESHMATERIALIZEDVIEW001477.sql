...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001477
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001477|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001477_no_such_mv WITH NO DATA;
-- primary-target-end
