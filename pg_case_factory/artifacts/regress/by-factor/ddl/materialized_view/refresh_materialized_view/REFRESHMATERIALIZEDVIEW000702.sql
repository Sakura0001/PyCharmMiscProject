...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000702
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000702|error_assertion|reset_state
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000702_no_such_mv WITH NO DATA;
-- primary-target-end
