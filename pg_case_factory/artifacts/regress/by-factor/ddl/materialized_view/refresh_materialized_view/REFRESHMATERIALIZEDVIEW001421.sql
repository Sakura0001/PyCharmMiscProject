...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001421
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001421|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001421_no_such_mv WITH NO DATA;
-- primary-target-end
