...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000662
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000662|error_assertion|reset_state
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000662_no_such_mv WITH NO DATA;
-- primary-target-end
