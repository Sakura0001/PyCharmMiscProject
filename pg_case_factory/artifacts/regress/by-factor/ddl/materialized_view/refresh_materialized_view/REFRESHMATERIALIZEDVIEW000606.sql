...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000606
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000606|error_assertion|reset_state
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000606_no_such_mv WITH NO DATA;
-- primary-target-end
