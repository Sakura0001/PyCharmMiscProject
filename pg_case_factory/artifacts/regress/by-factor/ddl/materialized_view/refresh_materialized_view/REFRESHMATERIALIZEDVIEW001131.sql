...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001131
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001131|returned_rows|drop_objects
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001131_no_such_mv WITH DATA;
-- primary-target-end
...
SELECT count(*) AS returned_row_count FROM refreshmaterializedview_001131_mv ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
