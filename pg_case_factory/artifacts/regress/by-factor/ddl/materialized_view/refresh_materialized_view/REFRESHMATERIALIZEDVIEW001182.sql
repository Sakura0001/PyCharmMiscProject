...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001182
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001182|error_assertion|reset_state
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001182_no_such_mv WITH DATA;
-- primary-target-end
