...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000173
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000173|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000173_no_such_mv WITH DATA;
-- primary-target-end
