...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001134
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001134|error_assertion|reset_state
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001134_no_such_mv WITH DATA;
-- primary-target-end
