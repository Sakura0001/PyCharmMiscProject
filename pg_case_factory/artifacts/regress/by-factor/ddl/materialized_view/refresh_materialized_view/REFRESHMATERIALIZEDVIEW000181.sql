...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000181
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000181|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000181_no_such_mv WITH DATA;
-- primary-target-end
