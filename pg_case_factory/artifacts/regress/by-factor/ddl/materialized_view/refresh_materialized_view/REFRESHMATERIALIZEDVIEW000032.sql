...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000032
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-SFV|sfv-9c18e1b6d6cae674d65f578e|refresh_materialized_view_branch_1
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000032_no_such_mv WITH DATA;
-- primary-target-end
...
SELECT count(*) AS matview_relation_count FROM pg_catalog.pg_class c WHERE c.relname = 'refreshmaterializedview_000032_mv' AND c.relkind = 'm' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
