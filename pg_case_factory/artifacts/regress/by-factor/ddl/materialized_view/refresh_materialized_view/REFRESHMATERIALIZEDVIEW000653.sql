...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000653
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000653|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000653_no_such_mv WITH NO DATA;
-- primary-target-end
