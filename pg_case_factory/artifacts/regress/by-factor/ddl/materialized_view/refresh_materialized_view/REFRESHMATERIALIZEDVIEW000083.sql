...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000083
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000083|returned_rows|drop_objects
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000083_no_such_mv WITH DATA;
-- primary-target-end
...
SELECT count(*) AS returned_row_count FROM refreshmaterializedview_000083_mv ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
