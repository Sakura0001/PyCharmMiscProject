...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000605
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000605|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000605_no_such_mv WITH NO DATA;
-- primary-target-end
