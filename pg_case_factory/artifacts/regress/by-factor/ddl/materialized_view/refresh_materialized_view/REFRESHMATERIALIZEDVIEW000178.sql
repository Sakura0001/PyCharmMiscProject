...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000178
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000178|effect_query|reset_state
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000178_no_such_mv WITH DATA;
-- primary-target-end
...
SELECT count(*) AS refreshed_row_count FROM refreshmaterializedview_000178_mv ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
