...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000085
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000085|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000085_no_such_mv WITH DATA;
-- primary-target-end
