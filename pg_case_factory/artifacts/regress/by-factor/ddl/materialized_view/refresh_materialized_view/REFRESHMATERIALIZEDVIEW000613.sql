...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000613
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000613|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000613_no_such_mv WITH NO DATA;
-- primary-target-end
