...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000707
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000707|returned_rows|drop_objects
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000707_no_such_mv WITH NO DATA;
-- primary-target-end
...
SELECT count(*) AS returned_row_count FROM refreshmaterializedview_000707_mv ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
