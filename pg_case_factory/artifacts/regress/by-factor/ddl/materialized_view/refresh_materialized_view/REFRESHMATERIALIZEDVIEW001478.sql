...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001478
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001478|error_assertion|reset_state
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001478_no_such_mv WITH NO DATA;
-- primary-target-end
