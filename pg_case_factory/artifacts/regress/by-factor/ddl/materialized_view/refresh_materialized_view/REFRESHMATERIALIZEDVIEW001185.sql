...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001185
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001185|effect_query|drop_objects
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001185_no_such_mv WITH DATA;
-- primary-target-end
...
SELECT count(*) AS refreshed_row_count FROM refreshmaterializedview_001185_mv ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
