...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001190
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001190|error_assertion|reset_state
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001190_no_such_mv WITH DATA;
-- primary-target-end
