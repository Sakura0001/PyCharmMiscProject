...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001142
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001142|error_assertion|reset_state
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001142_no_such_mv WITH DATA;
-- primary-target-end
