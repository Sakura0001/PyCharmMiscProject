...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000614
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000614|error_assertion|reset_state
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000614_no_such_mv WITH NO DATA;
-- primary-target-end
