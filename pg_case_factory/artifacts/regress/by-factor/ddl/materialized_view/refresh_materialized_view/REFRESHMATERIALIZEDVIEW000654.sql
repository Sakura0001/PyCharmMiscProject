...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000654
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000654|error_assertion|reset_state
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000654_no_such_mv WITH NO DATA;
-- primary-target-end
