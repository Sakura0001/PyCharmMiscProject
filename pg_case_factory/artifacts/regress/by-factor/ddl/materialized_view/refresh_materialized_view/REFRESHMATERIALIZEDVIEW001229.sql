...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001229
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001229|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001229_no_such_mv WITH DATA;
-- primary-target-end
