...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000709
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000709|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000709_no_such_mv WITH NO DATA;
-- primary-target-end
