...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001373
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001373|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001373_no_such_mv WITH NO DATA;
-- primary-target-end
