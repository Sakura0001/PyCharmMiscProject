...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001382
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001382|error_assertion|reset_state
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001382_no_such_mv WITH NO DATA;
-- primary-target-end
