...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001181
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001181|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001181_no_such_mv WITH DATA;
-- primary-target-end
