...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000701
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000701|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000701_no_such_mv WITH NO DATA;
-- primary-target-end
