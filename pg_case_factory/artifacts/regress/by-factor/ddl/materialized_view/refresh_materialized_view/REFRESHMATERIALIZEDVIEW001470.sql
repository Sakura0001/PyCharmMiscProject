...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001470
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001470|error_assertion|reset_state
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001470_no_such_mv WITH NO DATA;
-- primary-target-end
