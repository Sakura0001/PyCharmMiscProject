...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001141
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001141|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001141_no_such_mv WITH DATA;
-- primary-target-end
