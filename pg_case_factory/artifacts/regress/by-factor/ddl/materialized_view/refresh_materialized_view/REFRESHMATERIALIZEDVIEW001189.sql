...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001189
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001189|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001189_no_such_mv WITH DATA;
-- primary-target-end
