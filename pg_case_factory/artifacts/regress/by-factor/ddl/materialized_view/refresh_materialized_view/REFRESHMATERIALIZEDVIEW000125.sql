...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000125
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000125|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000125_no_such_mv WITH DATA;
-- primary-target-end
