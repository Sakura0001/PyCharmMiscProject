...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001230
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001230|error_assertion|reset_state
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001230_no_such_mv WITH DATA;
-- primary-target-end
