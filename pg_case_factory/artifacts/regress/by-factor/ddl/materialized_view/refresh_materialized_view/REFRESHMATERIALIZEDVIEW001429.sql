...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001429
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001429|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001429_no_such_mv WITH NO DATA;
-- primary-target-end
