...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW000603
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|000603|returned_rows|drop_objects
...
REFRESH MATERIALIZED VIEW refreshmaterializedview_000603_no_such_mv WITH NO DATA;
-- primary-target-end
...
SELECT count(*) AS returned_row_count FROM refreshmaterializedview_000603_mv ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
