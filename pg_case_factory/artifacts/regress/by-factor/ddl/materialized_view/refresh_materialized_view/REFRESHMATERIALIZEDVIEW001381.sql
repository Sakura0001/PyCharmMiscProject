...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001381
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001381|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001381_no_such_mv WITH NO DATA;
-- primary-target-end
