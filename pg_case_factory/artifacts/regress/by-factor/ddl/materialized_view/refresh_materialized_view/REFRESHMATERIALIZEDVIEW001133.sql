...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001133
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001133|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001133_no_such_mv WITH DATA;
-- primary-target-end
