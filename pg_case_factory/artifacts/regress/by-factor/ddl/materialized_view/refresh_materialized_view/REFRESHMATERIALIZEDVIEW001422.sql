...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001422
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001422|error_assertion|reset_state
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001422_no_such_mv WITH NO DATA;
-- primary-target-end
