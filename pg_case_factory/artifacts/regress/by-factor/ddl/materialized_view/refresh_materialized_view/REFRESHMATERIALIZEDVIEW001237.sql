...
-- ++
-- --------------------------------------------------------
-- case_id: REFRESHMATERIALIZEDVIEW001237
...
-- primary_obligation_id: REFRESHMATERIALIZEDVIEW-EXT|001237|error_assertion|drop_objects
...
REFRESH MATERIALIZED VIEW CONCURRENTLY refreshmaterializedview_001237_no_such_mv WITH DATA;
-- primary-target-end
