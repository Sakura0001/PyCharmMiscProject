...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEMATERIALIZEDVIEW03591
...
-- primary_obligation_id: CMATVIEW-EXT|03591|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP MATERIALIZED VIEW IF EXISTS public.creatematerializedview_03591_mv;
...
CREATE MATERIALIZED VIEW public.creatematerializedview_03591_mv AS SELECT * FROM creatematerializedview_03591_nosrc WITH DATA;
-- primary-target-end
