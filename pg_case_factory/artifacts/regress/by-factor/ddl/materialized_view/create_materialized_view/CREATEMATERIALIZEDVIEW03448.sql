...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEMATERIALIZEDVIEW03448
...
-- primary_obligation_id: CMATVIEW-EXT|03448|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP MATERIALIZED VIEW IF EXISTS creatematerializedview_03448_mv;
...
CREATE MATERIALIZED VIEW creatematerializedview_03448_mv AS SELECT * FROM creatematerializedview_03448_nosrc WITH DATA;
-- primary-target-end
