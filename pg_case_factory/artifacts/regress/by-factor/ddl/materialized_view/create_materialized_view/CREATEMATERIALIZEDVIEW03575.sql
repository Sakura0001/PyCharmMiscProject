...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEMATERIALIZEDVIEW03575
...
-- primary_obligation_id: CMATVIEW-EXT|03575|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP MATERIALIZED VIEW IF EXISTS public.creatematerializedview_03575_mv;
...
CREATE MATERIALIZED VIEW public.creatematerializedview_03575_mv AS SELECT * FROM creatematerializedview_03575_nosrc WITH DATA;
-- primary-target-end
