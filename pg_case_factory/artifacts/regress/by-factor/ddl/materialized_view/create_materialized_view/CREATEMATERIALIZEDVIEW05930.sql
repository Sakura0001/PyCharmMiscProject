...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEMATERIALIZEDVIEW05930
...
-- primary_obligation_id: CMATVIEW-EXT|05930|catalog_query|reset_state
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP MATERIALIZED VIEW IF EXISTS creatematerializedview_05930_mv;
...
SELECT count(*) > 0 AS mv_present FROM pg_catalog.pg_matviews WHERE matviewname = 'creatematerializedview_05930_mv' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
DROP MATERIALIZED VIEW IF EXISTS creatematerializedview_05930_mv;
