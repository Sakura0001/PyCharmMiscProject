...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEMATERIALIZEDVIEW03511
...
-- primary_obligation_id: CMATVIEW-EXT|03511|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP MATERIALIZED VIEW IF EXISTS "creatematerializedview_03511_mv";
...
CREATE MATERIALIZED VIEW "creatematerializedview_03511_mv" AS SELECT * FROM creatematerializedview_03511_nosrc WITH DATA;
-- primary-target-end
