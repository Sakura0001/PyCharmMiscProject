...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEMATERIALIZEDVIEW03599
...
-- primary_obligation_id: CMATVIEW-EXT|03599|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP MATERIALIZED VIEW IF EXISTS public.creatematerializedview_03599_mv;
...
CREATE MATERIALIZED VIEW public.creatematerializedview_03599_mv AS SELECT * FROM creatematerializedview_03599_nosrc WITH DATA;
-- primary-target-end
