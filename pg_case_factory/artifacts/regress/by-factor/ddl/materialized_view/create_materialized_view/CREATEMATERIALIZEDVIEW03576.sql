...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEMATERIALIZEDVIEW03576
...
-- primary_obligation_id: CMATVIEW-EXT|03576|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP MATERIALIZED VIEW IF EXISTS public.creatematerializedview_03576_mv;
...
CREATE MATERIALIZED VIEW public.creatematerializedview_03576_mv AS SELECT * FROM creatematerializedview_03576_nosrc WITH DATA;
-- primary-target-end
