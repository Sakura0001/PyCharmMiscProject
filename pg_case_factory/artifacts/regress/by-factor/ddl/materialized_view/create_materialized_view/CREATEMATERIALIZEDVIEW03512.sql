...
-- ++
-- --------------------------------------------------------
-- case_id: CREATEMATERIALIZEDVIEW03512
...
-- primary_obligation_id: CMATVIEW-EXT|03512|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP MATERIALIZED VIEW IF EXISTS "creatematerializedview_03512_mv";
...
CREATE MATERIALIZED VIEW "creatematerializedview_03512_mv" AS SELECT * FROM creatematerializedview_03512_nosrc WITH DATA;
-- primary-target-end
