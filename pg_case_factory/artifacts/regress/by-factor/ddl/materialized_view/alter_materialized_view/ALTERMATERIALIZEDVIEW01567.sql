...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01567
...
-- primary_obligation_id: AMV-EXT|01567|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_01567_mv OWNER TO SESSION_USER;
-- primary-target-end
