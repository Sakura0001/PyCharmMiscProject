...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02820
...
-- primary_obligation_id: AMV-EXT|02820|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_02820_mv" OWNER TO CURRENT_ROLE;
-- primary-target-end
