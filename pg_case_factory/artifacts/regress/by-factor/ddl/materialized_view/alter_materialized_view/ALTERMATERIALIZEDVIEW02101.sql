...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02101
...
-- primary_obligation_id: AMV-EXT|02101|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW "altermaterializedview_02101_mv" OWNER TO SESSION_USER;
-- primary-target-end
