...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW03018
...
-- primary_obligation_id: AMV-EXT|03018|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_03018_mv OWNER TO altermaterializedview_03018_nonexistent_role;
-- primary-target-end
