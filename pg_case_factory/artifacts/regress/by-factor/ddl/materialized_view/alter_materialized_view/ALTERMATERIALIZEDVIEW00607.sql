...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00607
...
-- primary_obligation_id: AMV-EXT|00607|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW altermaterializedview_00607_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
