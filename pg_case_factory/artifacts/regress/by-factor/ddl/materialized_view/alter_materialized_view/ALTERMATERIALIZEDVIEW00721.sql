...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00721
...
-- primary_obligation_id: AMV-EXT|00721|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW altermaterializedview_00721_mv OWNER TO SESSION_USER;
-- primary-target-end
