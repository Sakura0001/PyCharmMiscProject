...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01717
...
-- primary_obligation_id: AMV-EXT|01717|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_01717_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
