...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02881
...
-- primary_obligation_id: AMV-EXT|02881|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_02881_mv" OWNER TO altermaterializedview_02881_nonexistent_role;
-- primary-target-end
