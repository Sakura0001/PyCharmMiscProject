...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01501
...
-- primary_obligation_id: AMV-EXT|01501|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_01501_mv OWNER TO altermaterializedview_01501_nonexistent_role;
-- primary-target-end
