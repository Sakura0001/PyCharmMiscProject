...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00636
...
-- primary_obligation_id: AMV-EXT|00636|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW altermaterializedview_00636_mv OWNER TO CURRENT_USER;
-- primary-target-end
