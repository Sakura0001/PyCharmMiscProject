...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01680
...
-- primary_obligation_id: AMV-EXT|01680|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_01680_mv" OWNER TO SESSION_USER;
-- primary-target-end
