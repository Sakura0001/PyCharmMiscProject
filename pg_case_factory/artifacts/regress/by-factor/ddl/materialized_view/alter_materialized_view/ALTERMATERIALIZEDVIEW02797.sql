...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02797
...
-- primary_obligation_id: AMV-EXT|02797|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_02797_mv OWNER TO SESSION_USER;
-- primary-target-end
