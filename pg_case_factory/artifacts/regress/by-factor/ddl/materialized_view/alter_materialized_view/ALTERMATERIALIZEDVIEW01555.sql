...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01555
...
-- primary_obligation_id: AMV-EXT|01555|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_01555_mv OWNER TO SESSION_USER;
-- primary-target-end
