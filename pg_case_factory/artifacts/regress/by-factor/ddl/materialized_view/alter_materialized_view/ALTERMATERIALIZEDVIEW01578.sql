...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01578
...
-- primary_obligation_id: AMV-EXT|01578|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_01578_mv" OWNER TO CURRENT_ROLE;
-- primary-target-end
