...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01776
...
-- primary_obligation_id: AMV-EXT|01776|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_01776_mv OWNER TO altermaterializedview_01776_nonexistent_role;
-- primary-target-end
