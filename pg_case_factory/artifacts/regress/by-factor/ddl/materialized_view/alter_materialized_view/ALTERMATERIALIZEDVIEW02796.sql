...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02796
...
-- primary_obligation_id: AMV-EXT|02796|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_02796_mv OWNER TO SESSION_USER;
-- primary-target-end
