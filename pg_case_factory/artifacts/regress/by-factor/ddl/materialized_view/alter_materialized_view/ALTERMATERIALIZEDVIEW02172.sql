...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02172
...
-- primary_obligation_id: AMV-EXT|02172|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW public.altermaterializedview_02172_mv OWNER TO CURRENT_USER;
-- primary-target-end
