...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01842
...
-- primary_obligation_id: AMV-EXT|01842|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_01842_mv OWNER TO SESSION_USER;
-- primary-target-end
