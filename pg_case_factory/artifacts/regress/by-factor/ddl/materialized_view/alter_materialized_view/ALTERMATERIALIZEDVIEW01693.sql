...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01693
...
-- primary_obligation_id: AMV-EXT|01693|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_01693_mv" OWNER TO SESSION_USER;
-- primary-target-end
