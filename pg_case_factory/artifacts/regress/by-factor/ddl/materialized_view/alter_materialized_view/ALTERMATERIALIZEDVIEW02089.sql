...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02089
...
-- primary_obligation_id: AMV-EXT|02089|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW "altermaterializedview_02089_mv" OWNER TO SESSION_USER;
-- primary-target-end
