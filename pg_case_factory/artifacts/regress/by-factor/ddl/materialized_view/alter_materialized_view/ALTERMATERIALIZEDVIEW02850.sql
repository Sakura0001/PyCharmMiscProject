...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02850
...
-- primary_obligation_id: AMV-EXT|02850|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_02850_mv" OWNER TO CURRENT_USER;
-- primary-target-end
