...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02784
...
-- primary_obligation_id: AMV-EXT|02784|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_02784_mv OWNER TO SESSION_USER;
-- primary-target-end
