...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02923
...
-- primary_obligation_id: AMV-EXT|02923|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_02923_mv" OWNER TO SESSION_USER;
-- primary-target-end
