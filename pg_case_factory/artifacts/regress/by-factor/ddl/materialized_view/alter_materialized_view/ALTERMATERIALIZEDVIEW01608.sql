...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01608
...
-- primary_obligation_id: AMV-EXT|01608|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_01608_mv" OWNER TO CURRENT_USER;
-- primary-target-end
