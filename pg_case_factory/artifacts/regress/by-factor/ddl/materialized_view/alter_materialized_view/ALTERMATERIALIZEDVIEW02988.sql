...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02988
...
-- primary_obligation_id: AMV-EXT|02988|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_02988_mv OWNER TO CURRENT_USER;
-- primary-target-end
