...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW03084
...
-- primary_obligation_id: AMV-EXT|03084|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_03084_mv OWNER TO SESSION_USER;
-- primary-target-end
