...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02947
...
-- primary_obligation_id: AMV-EXT|02947|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_02947_mv" OWNER TO SESSION_USER;
-- primary-target-end
