...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00859
...
-- primary_obligation_id: AMV-EXT|00859|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW "altermaterializedview_00859_mv" OWNER TO SESSION_USER;
-- primary-target-end
