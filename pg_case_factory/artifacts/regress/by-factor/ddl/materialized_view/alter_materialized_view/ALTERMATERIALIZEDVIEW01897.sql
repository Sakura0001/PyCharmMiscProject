...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01897
...
-- primary_obligation_id: AMV-EXT|01897|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW altermaterializedview_01897_mv OWNER TO CURRENT_USER;
-- primary-target-end
