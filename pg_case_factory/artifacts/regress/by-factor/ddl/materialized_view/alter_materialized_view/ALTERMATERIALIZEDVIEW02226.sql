...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02226
...
-- primary_obligation_id: AMV-EXT|02226|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW public.altermaterializedview_02226_mv OWNER TO SESSION_USER;
-- primary-target-end
