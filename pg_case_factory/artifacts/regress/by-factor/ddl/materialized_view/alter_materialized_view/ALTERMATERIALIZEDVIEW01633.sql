...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01633
...
-- primary_obligation_id: AMV-EXT|01633|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_01633_mv" OWNER TO altermaterializedview_01633_nonexistent_role;
-- primary-target-end
