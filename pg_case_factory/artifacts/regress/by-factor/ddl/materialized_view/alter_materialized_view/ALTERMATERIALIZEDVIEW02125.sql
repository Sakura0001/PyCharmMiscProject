...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02125
...
-- primary_obligation_id: AMV-EXT|02125|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW public.altermaterializedview_02125_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
