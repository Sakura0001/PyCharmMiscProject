...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01681
...
-- primary_obligation_id: AMV-EXT|01681|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_01681_mv" OWNER TO SESSION_USER;
-- primary-target-end
