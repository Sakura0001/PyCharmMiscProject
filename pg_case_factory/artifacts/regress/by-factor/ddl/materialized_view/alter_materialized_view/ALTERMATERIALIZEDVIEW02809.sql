...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02809
...
-- primary_obligation_id: AMV-EXT|02809|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_02809_mv OWNER TO SESSION_USER;
-- primary-target-end
