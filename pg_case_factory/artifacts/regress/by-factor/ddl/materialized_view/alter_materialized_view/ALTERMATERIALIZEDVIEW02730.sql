...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02730
...
-- primary_obligation_id: AMV-EXT|02730|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_02730_mv OWNER TO CURRENT_USER;
-- primary-target-end
