...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01747
...
-- primary_obligation_id: AMV-EXT|01747|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_01747_mv OWNER TO CURRENT_USER;
-- primary-target-end
