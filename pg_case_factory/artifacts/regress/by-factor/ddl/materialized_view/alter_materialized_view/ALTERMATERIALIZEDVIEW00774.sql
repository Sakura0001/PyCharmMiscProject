...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00774
...
-- primary_obligation_id: AMV-EXT|00774|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW "altermaterializedview_00774_mv" OWNER TO CURRENT_USER;
-- primary-target-end
