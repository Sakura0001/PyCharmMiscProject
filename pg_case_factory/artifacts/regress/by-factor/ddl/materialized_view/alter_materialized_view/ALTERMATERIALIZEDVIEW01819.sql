...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01819
...
-- primary_obligation_id: AMV-EXT|01819|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_01819_mv OWNER TO SESSION_USER;
-- primary-target-end
