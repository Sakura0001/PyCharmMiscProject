...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02851
...
-- primary_obligation_id: AMV-EXT|02851|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_02851_mv" OWNER TO CURRENT_USER;
-- primary-target-end
