...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01777
...
-- primary_obligation_id: AMV-EXT|01777|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_01777_mv OWNER TO altermaterializedview_01777_nonexistent_role;
-- primary-target-end
