...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01896
...
-- primary_obligation_id: AMV-EXT|01896|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW altermaterializedview_01896_mv OWNER TO CURRENT_USER;
-- primary-target-end
