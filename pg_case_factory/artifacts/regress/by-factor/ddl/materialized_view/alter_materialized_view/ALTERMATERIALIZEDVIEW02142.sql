...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02142
...
-- primary_obligation_id: AMV-EXT|02142|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW public.altermaterializedview_02142_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
