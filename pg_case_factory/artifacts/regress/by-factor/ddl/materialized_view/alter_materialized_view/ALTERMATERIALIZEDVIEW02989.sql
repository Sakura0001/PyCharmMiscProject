...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02989
...
-- primary_obligation_id: AMV-EXT|02989|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_02989_mv OWNER TO CURRENT_USER;
-- primary-target-end
