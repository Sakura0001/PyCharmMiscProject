...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01471
...
-- primary_obligation_id: AMV-EXT|01471|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_01471_mv OWNER TO CURRENT_USER;
-- primary-target-end
