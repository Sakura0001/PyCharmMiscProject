...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01830
...
-- primary_obligation_id: AMV-EXT|01830|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_01830_mv OWNER TO SESSION_USER;
-- primary-target-end
