...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02838
...
-- primary_obligation_id: AMV-EXT|02838|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_02838_mv" OWNER TO CURRENT_ROLE;
-- primary-target-end
