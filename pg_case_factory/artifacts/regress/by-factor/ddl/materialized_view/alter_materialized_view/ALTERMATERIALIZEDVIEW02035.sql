...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02035
...
-- primary_obligation_id: AMV-EXT|02035|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW "altermaterializedview_02035_mv" OWNER TO CURRENT_USER;
-- primary-target-end
