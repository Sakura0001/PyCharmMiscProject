...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00733
...
-- primary_obligation_id: AMV-EXT|00733|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW altermaterializedview_00733_mv OWNER TO SESSION_USER;
-- primary-target-end
