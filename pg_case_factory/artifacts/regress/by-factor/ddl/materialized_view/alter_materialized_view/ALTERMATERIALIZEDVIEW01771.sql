...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01771
...
-- primary_obligation_id: AMV-EXT|01771|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_01771_mv OWNER TO altermaterializedview_01771_nonexistent_role;
-- primary-target-end
