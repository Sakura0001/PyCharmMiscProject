...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW03012
...
-- primary_obligation_id: AMV-EXT|03012|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_03012_mv OWNER TO altermaterializedview_03012_nonexistent_role;
-- primary-target-end
