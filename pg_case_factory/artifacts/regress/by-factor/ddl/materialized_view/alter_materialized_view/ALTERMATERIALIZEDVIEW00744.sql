...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00744
...
-- primary_obligation_id: AMV-EXT|00744|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW "altermaterializedview_00744_mv" OWNER TO CURRENT_ROLE;
-- primary-target-end
