...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00997
...
-- primary_obligation_id: AMV-EXT|00997|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW public.altermaterializedview_00997_mv OWNER TO SESSION_USER;
-- primary-target-end
