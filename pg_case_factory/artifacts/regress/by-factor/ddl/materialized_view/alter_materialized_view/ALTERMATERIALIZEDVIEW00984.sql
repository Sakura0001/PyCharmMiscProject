...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00984
...
-- primary_obligation_id: AMV-EXT|00984|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW public.altermaterializedview_00984_mv OWNER TO SESSION_USER;
-- primary-target-end
