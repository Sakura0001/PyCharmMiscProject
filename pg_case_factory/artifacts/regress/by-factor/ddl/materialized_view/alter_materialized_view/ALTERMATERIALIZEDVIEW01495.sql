...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01495
...
-- primary_obligation_id: AMV-EXT|01495|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_01495_mv OWNER TO altermaterializedview_01495_nonexistent_role;
-- primary-target-end
