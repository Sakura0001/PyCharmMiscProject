...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01609
...
-- primary_obligation_id: AMV-EXT|01609|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_01609_mv" OWNER TO CURRENT_USER;
-- primary-target-end
