...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01542
...
-- primary_obligation_id: AMV-EXT|01542|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_01542_mv OWNER TO SESSION_USER;
-- primary-target-end
