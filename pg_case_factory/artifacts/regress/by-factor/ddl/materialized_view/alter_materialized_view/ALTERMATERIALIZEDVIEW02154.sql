...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02154
...
-- primary_obligation_id: AMV-EXT|02154|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW public.altermaterializedview_02154_mv OWNER TO CURRENT_USER;
-- primary-target-end
