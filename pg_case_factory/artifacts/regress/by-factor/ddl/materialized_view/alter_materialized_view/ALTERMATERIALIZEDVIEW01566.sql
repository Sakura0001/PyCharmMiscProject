...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01566
...
-- primary_obligation_id: AMV-EXT|01566|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_01566_mv OWNER TO SESSION_USER;
-- primary-target-end
