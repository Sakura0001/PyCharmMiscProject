...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW03007
...
-- primary_obligation_id: AMV-EXT|03007|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_03007_mv OWNER TO CURRENT_USER;
-- primary-target-end
