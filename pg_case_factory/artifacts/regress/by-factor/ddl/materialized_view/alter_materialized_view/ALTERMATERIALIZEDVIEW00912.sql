...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00912
...
-- primary_obligation_id: AMV-EXT|00912|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW public.altermaterializedview_00912_mv OWNER TO CURRENT_USER;
-- primary-target-end
