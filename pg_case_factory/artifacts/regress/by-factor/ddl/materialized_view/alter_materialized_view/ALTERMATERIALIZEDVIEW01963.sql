...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01963
...
-- primary_obligation_id: AMV-EXT|01963|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW altermaterializedview_01963_mv OWNER TO SESSION_USER;
-- primary-target-end
