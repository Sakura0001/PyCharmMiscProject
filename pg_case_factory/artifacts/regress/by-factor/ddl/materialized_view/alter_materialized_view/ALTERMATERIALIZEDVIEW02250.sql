...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02250
...
-- primary_obligation_id: AMV-EXT|02250|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW public.altermaterializedview_02250_mv OWNER TO SESSION_USER;
-- primary-target-end
