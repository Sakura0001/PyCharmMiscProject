...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02251
...
-- primary_obligation_id: AMV-EXT|02251|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW public.altermaterializedview_02251_mv OWNER TO SESSION_USER;
-- primary-target-end
