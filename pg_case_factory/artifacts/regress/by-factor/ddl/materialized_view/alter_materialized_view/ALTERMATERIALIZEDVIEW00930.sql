...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00930
...
-- primary_obligation_id: AMV-EXT|00930|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW public.altermaterializedview_00930_mv OWNER TO CURRENT_USER;
-- primary-target-end
