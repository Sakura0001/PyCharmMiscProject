...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00847
...
-- primary_obligation_id: AMV-EXT|00847|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW "altermaterializedview_00847_mv" OWNER TO SESSION_USER;
-- primary-target-end
