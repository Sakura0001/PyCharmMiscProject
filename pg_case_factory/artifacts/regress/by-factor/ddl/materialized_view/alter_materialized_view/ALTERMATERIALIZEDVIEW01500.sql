...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01500
...
-- primary_obligation_id: AMV-EXT|01500|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_01500_mv OWNER TO altermaterializedview_01500_nonexistent_role;
-- primary-target-end
