...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01441
...
-- primary_obligation_id: AMV-EXT|01441|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_01441_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
