...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02935
...
-- primary_obligation_id: AMV-EXT|02935|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_02935_mv" OWNER TO SESSION_USER;
-- primary-target-end
