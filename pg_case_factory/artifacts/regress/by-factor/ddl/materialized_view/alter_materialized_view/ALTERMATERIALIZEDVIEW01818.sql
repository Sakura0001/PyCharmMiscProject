...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01818
...
-- primary_obligation_id: AMV-EXT|01818|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_01818_mv OWNER TO SESSION_USER;
-- primary-target-end
