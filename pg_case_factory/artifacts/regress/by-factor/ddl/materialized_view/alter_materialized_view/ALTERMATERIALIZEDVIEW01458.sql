...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01458
...
-- primary_obligation_id: AMV-EXT|01458|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_01458_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
