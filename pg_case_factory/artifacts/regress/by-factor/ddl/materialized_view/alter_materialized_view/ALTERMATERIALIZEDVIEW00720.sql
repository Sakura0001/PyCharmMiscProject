...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00720
...
-- primary_obligation_id: AMV-EXT|00720|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW altermaterializedview_00720_mv OWNER TO SESSION_USER;
-- primary-target-end
