...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01878
...
-- primary_obligation_id: AMV-EXT|01878|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW altermaterializedview_01878_mv OWNER TO CURRENT_USER;
-- primary-target-end
