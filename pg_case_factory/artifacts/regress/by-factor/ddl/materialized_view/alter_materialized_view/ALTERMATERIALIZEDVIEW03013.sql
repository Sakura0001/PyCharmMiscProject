...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW03013
...
-- primary_obligation_id: AMV-EXT|03013|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_03013_mv OWNER TO altermaterializedview_03013_nonexistent_role;
-- primary-target-end
