...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02100
...
-- primary_obligation_id: AMV-EXT|02100|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW "altermaterializedview_02100_mv" OWNER TO SESSION_USER;
-- primary-target-end
