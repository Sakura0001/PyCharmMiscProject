...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01849
...
-- primary_obligation_id: AMV-EXT|01849|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW altermaterializedview_01849_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
