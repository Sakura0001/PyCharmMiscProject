...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01489
...
-- primary_obligation_id: AMV-EXT|01489|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_01489_mv OWNER TO CURRENT_USER;
-- primary-target-end
