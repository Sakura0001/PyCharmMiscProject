...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01716
...
-- primary_obligation_id: AMV-EXT|01716|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_01716_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
