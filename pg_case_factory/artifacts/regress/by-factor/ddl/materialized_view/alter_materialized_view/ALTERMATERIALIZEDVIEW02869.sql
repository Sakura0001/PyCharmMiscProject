...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02869
...
-- primary_obligation_id: AMV-EXT|02869|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_02869_mv" OWNER TO CURRENT_USER;
-- primary-target-end
