...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01008
...
-- primary_obligation_id: AMV-EXT|01008|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW public.altermaterializedview_01008_mv OWNER TO SESSION_USER;
-- primary-target-end
