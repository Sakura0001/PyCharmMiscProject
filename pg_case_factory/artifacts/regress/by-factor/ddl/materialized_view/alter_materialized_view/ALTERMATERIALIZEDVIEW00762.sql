...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00762
...
-- primary_obligation_id: AMV-EXT|00762|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW "altermaterializedview_00762_mv" OWNER TO CURRENT_ROLE;
-- primary-target-end
