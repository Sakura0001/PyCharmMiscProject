...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00625
...
-- primary_obligation_id: AMV-EXT|00625|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW altermaterializedview_00625_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
