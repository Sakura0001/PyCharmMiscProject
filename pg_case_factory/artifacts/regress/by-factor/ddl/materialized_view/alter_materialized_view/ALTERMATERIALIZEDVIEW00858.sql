...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00858
...
-- primary_obligation_id: AMV-EXT|00858|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW "altermaterializedview_00858_mv" OWNER TO SESSION_USER;
-- primary-target-end
