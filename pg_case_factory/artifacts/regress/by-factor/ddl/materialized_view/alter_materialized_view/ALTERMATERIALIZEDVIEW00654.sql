...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00654
...
-- primary_obligation_id: AMV-EXT|00654|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW altermaterializedview_00654_mv OWNER TO CURRENT_USER;
-- primary-target-end
