...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02712
...
-- primary_obligation_id: AMV-EXT|02712|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_02712_mv OWNER TO CURRENT_USER;
-- primary-target-end
