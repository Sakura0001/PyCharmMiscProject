...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02880
...
-- primary_obligation_id: AMV-EXT|02880|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_02880_mv" OWNER TO altermaterializedview_02880_nonexistent_role;
-- primary-target-end
