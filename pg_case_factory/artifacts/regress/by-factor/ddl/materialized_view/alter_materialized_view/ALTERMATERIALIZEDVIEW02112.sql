...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02112
...
-- primary_obligation_id: AMV-EXT|02112|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW "altermaterializedview_02112_mv" OWNER TO SESSION_USER;
-- primary-target-end
