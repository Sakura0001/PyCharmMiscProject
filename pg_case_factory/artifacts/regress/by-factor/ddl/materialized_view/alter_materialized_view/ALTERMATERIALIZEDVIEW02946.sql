...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02946
...
-- primary_obligation_id: AMV-EXT|02946|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_02946_mv" OWNER TO SESSION_USER;
-- primary-target-end
