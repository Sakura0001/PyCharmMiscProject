...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00900
...
-- primary_obligation_id: AMV-EXT|00900|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW public.altermaterializedview_00900_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
