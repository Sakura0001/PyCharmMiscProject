...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02958
...
-- primary_obligation_id: AMV-EXT|02958|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_02958_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
