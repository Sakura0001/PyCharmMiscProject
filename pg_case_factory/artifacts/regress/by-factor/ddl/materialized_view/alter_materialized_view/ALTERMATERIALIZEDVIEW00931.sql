...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00931
...
-- primary_obligation_id: AMV-EXT|00931|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW public.altermaterializedview_00931_mv OWNER TO CURRENT_USER;
-- primary-target-end
