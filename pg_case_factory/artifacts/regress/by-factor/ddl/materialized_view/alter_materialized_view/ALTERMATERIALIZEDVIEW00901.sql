...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00901
...
-- primary_obligation_id: AMV-EXT|00901|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW public.altermaterializedview_00901_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
