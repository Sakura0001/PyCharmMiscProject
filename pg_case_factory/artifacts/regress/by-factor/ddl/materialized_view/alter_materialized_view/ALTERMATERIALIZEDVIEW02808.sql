...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02808
...
-- primary_obligation_id: AMV-EXT|02808|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_02808_mv OWNER TO SESSION_USER;
-- primary-target-end
