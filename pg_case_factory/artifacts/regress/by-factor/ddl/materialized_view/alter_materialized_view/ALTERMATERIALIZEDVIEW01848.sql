...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01848
...
-- primary_obligation_id: AMV-EXT|01848|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW altermaterializedview_01848_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
