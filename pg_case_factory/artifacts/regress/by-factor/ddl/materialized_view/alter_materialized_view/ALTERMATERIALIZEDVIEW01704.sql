...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01704
...
-- primary_obligation_id: AMV-EXT|01704|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_01704_mv" OWNER TO SESSION_USER;
-- primary-target-end
