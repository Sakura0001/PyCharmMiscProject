...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00846
...
-- primary_obligation_id: AMV-EXT|00846|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW "altermaterializedview_00846_mv" OWNER TO SESSION_USER;
-- primary-target-end
