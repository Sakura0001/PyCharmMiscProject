...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01746
...
-- primary_obligation_id: AMV-EXT|01746|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_01746_mv OWNER TO CURRENT_USER;
-- primary-target-end
