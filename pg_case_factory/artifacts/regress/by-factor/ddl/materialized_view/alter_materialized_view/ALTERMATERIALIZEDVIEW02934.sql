...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02934
...
-- primary_obligation_id: AMV-EXT|02934|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_02934_mv" OWNER TO SESSION_USER;
-- primary-target-end
