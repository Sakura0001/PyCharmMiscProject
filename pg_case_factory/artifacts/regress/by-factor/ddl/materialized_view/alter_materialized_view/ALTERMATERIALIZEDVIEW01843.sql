...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01843
...
-- primary_obligation_id: AMV-EXT|01843|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_01843_mv OWNER TO SESSION_USER;
-- primary-target-end
