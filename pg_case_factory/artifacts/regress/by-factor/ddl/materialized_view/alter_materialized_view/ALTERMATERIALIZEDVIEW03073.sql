...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW03073
...
-- primary_obligation_id: AMV-EXT|03073|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_03073_mv OWNER TO SESSION_USER;
-- primary-target-end
