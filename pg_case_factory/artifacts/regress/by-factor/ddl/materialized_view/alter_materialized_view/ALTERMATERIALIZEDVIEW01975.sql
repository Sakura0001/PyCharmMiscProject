...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01975
...
-- primary_obligation_id: AMV-EXT|01975|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW altermaterializedview_01975_mv OWNER TO SESSION_USER;
-- primary-target-end
