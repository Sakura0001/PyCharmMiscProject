...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00913
...
-- primary_obligation_id: AMV-EXT|00913|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW public.altermaterializedview_00913_mv OWNER TO CURRENT_USER;
-- primary-target-end
