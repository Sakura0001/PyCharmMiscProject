...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02743
...
-- primary_obligation_id: AMV-EXT|02743|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_02743_mv OWNER TO altermaterializedview_02743_nonexistent_role;
-- primary-target-end
