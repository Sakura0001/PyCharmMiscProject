...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01867
...
-- primary_obligation_id: AMV-EXT|01867|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW altermaterializedview_01867_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
