...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02227
...
-- primary_obligation_id: AMV-EXT|02227|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW public.altermaterializedview_02227_mv OWNER TO SESSION_USER;
-- primary-target-end
