...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01639
...
-- primary_obligation_id: AMV-EXT|01639|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_01639_mv" OWNER TO altermaterializedview_01639_nonexistent_role;
-- primary-target-end
