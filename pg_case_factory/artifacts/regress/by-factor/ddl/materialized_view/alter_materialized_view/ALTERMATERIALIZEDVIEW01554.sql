...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01554
...
-- primary_obligation_id: AMV-EXT|01554|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_01554_mv OWNER TO SESSION_USER;
-- primary-target-end
