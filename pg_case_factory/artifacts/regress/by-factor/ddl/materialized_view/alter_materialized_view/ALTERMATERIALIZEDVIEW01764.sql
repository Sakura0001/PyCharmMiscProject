...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01764
...
-- primary_obligation_id: AMV-EXT|01764|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_01764_mv OWNER TO CURRENT_USER;
-- primary-target-end
