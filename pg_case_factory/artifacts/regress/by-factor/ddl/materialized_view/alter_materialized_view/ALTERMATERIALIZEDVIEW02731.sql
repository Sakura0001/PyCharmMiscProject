...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02731
...
-- primary_obligation_id: AMV-EXT|02731|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_02731_mv OWNER TO CURRENT_USER;
-- primary-target-end
