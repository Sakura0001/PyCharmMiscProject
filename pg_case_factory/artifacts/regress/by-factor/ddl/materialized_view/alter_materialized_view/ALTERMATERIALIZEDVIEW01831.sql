...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01831
...
-- primary_obligation_id: AMV-EXT|01831|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_01831_mv OWNER TO SESSION_USER;
-- primary-target-end
