...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01974
...
-- primary_obligation_id: AMV-EXT|01974|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW altermaterializedview_01974_mv OWNER TO SESSION_USER;
-- primary-target-end
