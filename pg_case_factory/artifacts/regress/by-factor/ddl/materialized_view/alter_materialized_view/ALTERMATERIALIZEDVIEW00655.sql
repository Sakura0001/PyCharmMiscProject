...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00655
...
-- primary_obligation_id: AMV-EXT|00655|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW altermaterializedview_00655_mv OWNER TO CURRENT_USER;
-- primary-target-end
