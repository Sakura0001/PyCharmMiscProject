...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01866
...
-- primary_obligation_id: AMV-EXT|01866|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW altermaterializedview_01866_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
