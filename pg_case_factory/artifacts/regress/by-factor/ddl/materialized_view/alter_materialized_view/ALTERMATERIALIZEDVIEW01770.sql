...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01770
...
-- primary_obligation_id: AMV-EXT|01770|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_01770_mv OWNER TO altermaterializedview_01770_nonexistent_role;
-- primary-target-end
