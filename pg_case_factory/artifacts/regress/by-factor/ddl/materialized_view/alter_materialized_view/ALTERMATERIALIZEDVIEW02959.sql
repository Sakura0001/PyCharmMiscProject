...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02959
...
-- primary_obligation_id: AMV-EXT|02959|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_02959_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
