...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02737
...
-- primary_obligation_id: AMV-EXT|02737|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_02737_mv OWNER TO altermaterializedview_02737_nonexistent_role;
-- primary-target-end
