...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02976
...
-- primary_obligation_id: AMV-EXT|02976|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_02976_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
