...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00606
...
-- primary_obligation_id: AMV-EXT|00606|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW altermaterializedview_00606_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
