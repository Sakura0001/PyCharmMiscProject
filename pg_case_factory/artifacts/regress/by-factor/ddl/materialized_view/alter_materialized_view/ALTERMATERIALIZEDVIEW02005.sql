...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02005
...
-- primary_obligation_id: AMV-EXT|02005|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW "altermaterializedview_02005_mv" OWNER TO CURRENT_ROLE;
-- primary-target-end
