...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02238
...
-- primary_obligation_id: AMV-EXT|02238|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW public.altermaterializedview_02238_mv OWNER TO SESSION_USER;
-- primary-target-end
