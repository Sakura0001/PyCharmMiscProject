...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00709
...
-- primary_obligation_id: AMV-EXT|00709|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW altermaterializedview_00709_mv OWNER TO SESSION_USER;
-- primary-target-end
