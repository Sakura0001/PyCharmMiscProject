...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02173
...
-- primary_obligation_id: AMV-EXT|02173|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW public.altermaterializedview_02173_mv OWNER TO CURRENT_USER;
-- primary-target-end
