...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW03019
...
-- primary_obligation_id: AMV-EXT|03019|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_03019_mv OWNER TO altermaterializedview_03019_nonexistent_role;
-- primary-target-end
