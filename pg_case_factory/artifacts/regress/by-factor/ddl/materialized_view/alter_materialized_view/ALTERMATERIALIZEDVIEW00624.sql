...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00624
...
-- primary_obligation_id: AMV-EXT|00624|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW altermaterializedview_00624_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
