...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01596
...
-- primary_obligation_id: AMV-EXT|01596|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_01596_mv" OWNER TO CURRENT_ROLE;
-- primary-target-end
