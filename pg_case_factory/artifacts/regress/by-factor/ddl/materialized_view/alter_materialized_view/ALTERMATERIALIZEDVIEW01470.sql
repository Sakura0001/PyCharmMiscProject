...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01470
...
-- primary_obligation_id: AMV-EXT|01470|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_01470_mv OWNER TO CURRENT_USER;
-- primary-target-end
