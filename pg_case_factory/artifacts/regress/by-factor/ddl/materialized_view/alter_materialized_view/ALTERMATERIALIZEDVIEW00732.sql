...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00732
...
-- primary_obligation_id: AMV-EXT|00732|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW altermaterializedview_00732_mv OWNER TO SESSION_USER;
-- primary-target-end
