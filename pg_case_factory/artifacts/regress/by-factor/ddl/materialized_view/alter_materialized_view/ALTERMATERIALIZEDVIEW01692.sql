...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01692
...
-- primary_obligation_id: AMV-EXT|01692|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_01692_mv" OWNER TO SESSION_USER;
-- primary-target-end
