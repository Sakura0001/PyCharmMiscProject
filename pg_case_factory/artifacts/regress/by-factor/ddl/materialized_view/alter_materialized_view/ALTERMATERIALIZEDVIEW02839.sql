...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02839
...
-- primary_obligation_id: AMV-EXT|02839|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_02839_mv" OWNER TO CURRENT_ROLE;
-- primary-target-end
