...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01597
...
-- primary_obligation_id: AMV-EXT|01597|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_01597_mv" OWNER TO CURRENT_ROLE;
-- primary-target-end
