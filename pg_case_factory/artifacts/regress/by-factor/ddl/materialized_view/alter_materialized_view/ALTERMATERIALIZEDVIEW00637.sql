...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00637
...
-- primary_obligation_id: AMV-EXT|00637|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW altermaterializedview_00637_mv OWNER TO CURRENT_USER;
-- primary-target-end
