...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01494
...
-- primary_obligation_id: AMV-EXT|01494|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_01494_mv OWNER TO altermaterializedview_01494_nonexistent_role;
-- primary-target-end
