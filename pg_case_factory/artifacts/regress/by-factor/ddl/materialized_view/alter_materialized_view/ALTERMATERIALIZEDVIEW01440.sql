...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01440
...
-- primary_obligation_id: AMV-EXT|01440|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_01440_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
