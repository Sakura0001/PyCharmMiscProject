...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02088
...
-- primary_obligation_id: AMV-EXT|02088|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW "altermaterializedview_02088_mv" OWNER TO SESSION_USER;
-- primary-target-end
