...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01705
...
-- primary_obligation_id: AMV-EXT|01705|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_01705_mv" OWNER TO SESSION_USER;
-- primary-target-end
