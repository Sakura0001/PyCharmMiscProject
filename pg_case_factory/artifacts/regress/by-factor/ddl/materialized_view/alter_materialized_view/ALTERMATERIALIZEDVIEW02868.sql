...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02868
...
-- primary_obligation_id: AMV-EXT|02868|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_02868_mv" OWNER TO CURRENT_USER;
-- primary-target-end
