...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01459
...
-- primary_obligation_id: AMV-EXT|01459|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_01459_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
