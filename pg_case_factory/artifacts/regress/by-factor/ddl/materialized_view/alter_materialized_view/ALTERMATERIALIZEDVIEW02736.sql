...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02736
...
-- primary_obligation_id: AMV-EXT|02736|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_02736_mv OWNER TO altermaterializedview_02736_nonexistent_role;
-- primary-target-end
