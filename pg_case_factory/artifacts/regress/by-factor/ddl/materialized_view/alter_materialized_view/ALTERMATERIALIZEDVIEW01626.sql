...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01626
...
-- primary_obligation_id: AMV-EXT|01626|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_01626_mv" OWNER TO CURRENT_USER;
-- primary-target-end
