...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00870
...
-- primary_obligation_id: AMV-EXT|00870|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW "altermaterializedview_00870_mv" OWNER TO SESSION_USER;
-- primary-target-end
