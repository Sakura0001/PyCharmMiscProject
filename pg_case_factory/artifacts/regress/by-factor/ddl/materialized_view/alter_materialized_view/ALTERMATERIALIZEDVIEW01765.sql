...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01765
...
-- primary_obligation_id: AMV-EXT|01765|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_01765_mv OWNER TO CURRENT_USER;
-- primary-target-end
