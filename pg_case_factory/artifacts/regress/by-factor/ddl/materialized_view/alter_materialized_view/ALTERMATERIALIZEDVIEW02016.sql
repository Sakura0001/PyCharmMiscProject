...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02016
...
-- primary_obligation_id: AMV-EXT|02016|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW "altermaterializedview_02016_mv" OWNER TO CURRENT_USER;
-- primary-target-end
