...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00775
...
-- primary_obligation_id: AMV-EXT|00775|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW "altermaterializedview_00775_mv" OWNER TO CURRENT_USER;
-- primary-target-end
