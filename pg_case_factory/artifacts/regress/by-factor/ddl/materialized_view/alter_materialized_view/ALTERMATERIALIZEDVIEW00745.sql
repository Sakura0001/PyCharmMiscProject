...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00745
...
-- primary_obligation_id: AMV-EXT|00745|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW "altermaterializedview_00745_mv" OWNER TO CURRENT_ROLE;
-- primary-target-end
