...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02742
...
-- primary_obligation_id: AMV-EXT|02742|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_02742_mv OWNER TO altermaterializedview_02742_nonexistent_role;
-- primary-target-end
