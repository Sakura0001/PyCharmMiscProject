...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01962
...
-- primary_obligation_id: AMV-EXT|01962|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW altermaterializedview_01962_mv OWNER TO SESSION_USER;
-- primary-target-end
