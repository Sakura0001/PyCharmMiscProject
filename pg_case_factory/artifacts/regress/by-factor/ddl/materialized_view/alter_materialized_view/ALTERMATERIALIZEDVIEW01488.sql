...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01488
...
-- primary_obligation_id: AMV-EXT|01488|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_01488_mv OWNER TO CURRENT_USER;
-- primary-target-end
