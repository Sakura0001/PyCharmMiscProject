...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02821
...
-- primary_obligation_id: AMV-EXT|02821|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_02821_mv" OWNER TO CURRENT_ROLE;
-- primary-target-end
