...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01543
...
-- primary_obligation_id: AMV-EXT|01543|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_01543_mv OWNER TO SESSION_USER;
-- primary-target-end
