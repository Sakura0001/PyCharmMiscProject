...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02017
...
-- primary_obligation_id: AMV-EXT|02017|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW "altermaterializedview_02017_mv" OWNER TO CURRENT_USER;
-- primary-target-end
