...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01638
...
-- primary_obligation_id: AMV-EXT|01638|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_01638_mv" OWNER TO altermaterializedview_01638_nonexistent_role;
-- primary-target-end
