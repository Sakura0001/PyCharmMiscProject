...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW03072
...
-- primary_obligation_id: AMV-EXT|03072|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_03072_mv OWNER TO SESSION_USER;
-- primary-target-end
