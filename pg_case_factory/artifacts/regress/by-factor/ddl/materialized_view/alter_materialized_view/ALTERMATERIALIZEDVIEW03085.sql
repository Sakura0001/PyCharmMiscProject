...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW03085
...
-- primary_obligation_id: AMV-EXT|03085|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_03085_mv OWNER TO SESSION_USER;
-- primary-target-end
