...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW03060
...
-- primary_obligation_id: AMV-EXT|03060|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_03060_mv OWNER TO SESSION_USER;
-- primary-target-end
