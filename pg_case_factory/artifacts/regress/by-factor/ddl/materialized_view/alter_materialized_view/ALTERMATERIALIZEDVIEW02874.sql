...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02874
...
-- primary_obligation_id: AMV-EXT|02874|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_02874_mv" OWNER TO altermaterializedview_02874_nonexistent_role;
-- primary-target-end
