...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02155
...
-- primary_obligation_id: AMV-EXT|02155|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW public.altermaterializedview_02155_mv OWNER TO CURRENT_USER;
-- primary-target-end
