...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00871
...
-- primary_obligation_id: AMV-EXT|00871|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW "altermaterializedview_00871_mv" OWNER TO SESSION_USER;
-- primary-target-end
