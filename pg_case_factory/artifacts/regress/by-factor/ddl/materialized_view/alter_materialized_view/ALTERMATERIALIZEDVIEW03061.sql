...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW03061
...
-- primary_obligation_id: AMV-EXT|03061|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS public.altermaterializedview_03061_mv OWNER TO SESSION_USER;
-- primary-target-end
