...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02124
...
-- primary_obligation_id: AMV-EXT|02124|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW public.altermaterializedview_02124_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
