...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00996
...
-- primary_obligation_id: AMV-EXT|00996|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW public.altermaterializedview_00996_mv OWNER TO SESSION_USER;
-- primary-target-end
