...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02682
...
-- primary_obligation_id: AMV-EXT|02682|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_02682_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
