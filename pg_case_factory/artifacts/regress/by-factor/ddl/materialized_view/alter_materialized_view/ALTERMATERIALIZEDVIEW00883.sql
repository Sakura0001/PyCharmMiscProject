...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00883
...
-- primary_obligation_id: AMV-EXT|00883|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW public.altermaterializedview_00883_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
