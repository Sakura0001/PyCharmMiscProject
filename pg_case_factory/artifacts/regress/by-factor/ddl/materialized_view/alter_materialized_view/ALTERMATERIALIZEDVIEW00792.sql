...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00792
...
-- primary_obligation_id: AMV-EXT|00792|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW "altermaterializedview_00792_mv" OWNER TO CURRENT_USER;
-- primary-target-end
