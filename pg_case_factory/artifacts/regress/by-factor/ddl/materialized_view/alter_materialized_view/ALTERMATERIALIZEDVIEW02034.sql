...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02034
...
-- primary_obligation_id: AMV-EXT|02034|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW "altermaterializedview_02034_mv" OWNER TO CURRENT_USER;
-- primary-target-end
