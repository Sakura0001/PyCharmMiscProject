...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01879
...
-- primary_obligation_id: AMV-EXT|01879|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW altermaterializedview_01879_mv OWNER TO CURRENT_USER;
-- primary-target-end
