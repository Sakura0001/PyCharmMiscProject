...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00882
...
-- primary_obligation_id: AMV-EXT|00882|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW public.altermaterializedview_00882_mv OWNER TO CURRENT_ROLE;
-- primary-target-end
