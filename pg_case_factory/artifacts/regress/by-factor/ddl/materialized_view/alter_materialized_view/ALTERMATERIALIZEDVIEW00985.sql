...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00985
...
-- primary_obligation_id: AMV-EXT|00985|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW public.altermaterializedview_00985_mv OWNER TO SESSION_USER;
-- primary-target-end
