...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01950
...
-- primary_obligation_id: AMV-EXT|01950|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW altermaterializedview_01950_mv OWNER TO SESSION_USER;
-- primary-target-end
