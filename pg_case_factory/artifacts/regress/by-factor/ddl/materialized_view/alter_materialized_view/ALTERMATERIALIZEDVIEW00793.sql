...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00793
...
-- primary_obligation_id: AMV-EXT|00793|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW "altermaterializedview_00793_mv" OWNER TO CURRENT_USER;
-- primary-target-end
