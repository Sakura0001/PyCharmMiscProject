...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02875
...
-- primary_obligation_id: AMV-EXT|02875|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_02875_mv" OWNER TO altermaterializedview_02875_nonexistent_role;
-- primary-target-end
