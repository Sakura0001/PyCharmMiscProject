...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01009
...
-- primary_obligation_id: AMV-EXT|01009|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW public.altermaterializedview_01009_mv OWNER TO SESSION_USER;
-- primary-target-end
