...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01632
...
-- primary_obligation_id: AMV-EXT|01632|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_01632_mv" OWNER TO altermaterializedview_01632_nonexistent_role;
-- primary-target-end
