...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW00708
...
-- primary_obligation_id: AMV-EXT|00708|owner_to|error_assertion|drop_objects
...
ALTER MATERIALIZED VIEW altermaterializedview_00708_mv OWNER TO SESSION_USER;
-- primary-target-end
