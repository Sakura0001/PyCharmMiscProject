...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02785
...
-- primary_obligation_id: AMV-EXT|02785|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_02785_mv OWNER TO SESSION_USER;
-- primary-target-end
