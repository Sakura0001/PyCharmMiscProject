...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01627
...
-- primary_obligation_id: AMV-EXT|01627|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS "altermaterializedview_01627_mv" OWNER TO CURRENT_USER;
-- primary-target-end
