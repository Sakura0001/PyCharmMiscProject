...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW01951
...
-- primary_obligation_id: AMV-EXT|01951|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW altermaterializedview_01951_mv OWNER TO SESSION_USER;
-- primary-target-end
