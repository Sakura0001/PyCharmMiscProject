...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02713
...
-- primary_obligation_id: AMV-EXT|02713|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW IF EXISTS altermaterializedview_02713_mv OWNER TO CURRENT_USER;
-- primary-target-end
