...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02113
...
-- primary_obligation_id: AMV-EXT|02113|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW "altermaterializedview_02113_mv" OWNER TO SESSION_USER;
-- primary-target-end
