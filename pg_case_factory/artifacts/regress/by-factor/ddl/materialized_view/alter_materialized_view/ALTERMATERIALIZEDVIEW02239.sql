...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERMATERIALIZEDVIEW02239
...
-- primary_obligation_id: AMV-EXT|02239|owner_to|error_assertion|reset_state
...
ALTER MATERIALIZED VIEW public.altermaterializedview_02239_mv OWNER TO SESSION_USER;
-- primary-target-end
