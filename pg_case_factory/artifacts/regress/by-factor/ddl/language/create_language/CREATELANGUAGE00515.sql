...
-- primary_obligation_id: CLANG-EXT|00515|effect_query|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS "createlanguage_00515_QLang" CASCADE;
RESET ROLE;
...
CREATE TRUSTED LANGUAGE "createlanguage_00515_QLang" HANDLER createlanguage_00515_handler INLINE createlanguage_00515_inline VALIDATOR createlanguage_00515_validator;
-- primary-target-end
