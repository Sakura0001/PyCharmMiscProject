...
-- primary_obligation_id: CLANG-EXT|02413|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS "createlanguage_02413_QLang" CASCADE;
RESET ROLE;
...
CREATE OR REPLACE TRUSTED LANGUAGE "createlanguage_02413_QLang" HANDLER createlanguage_02413_handler VALIDATOR createlanguage_02413_validator;
-- primary-target-end
