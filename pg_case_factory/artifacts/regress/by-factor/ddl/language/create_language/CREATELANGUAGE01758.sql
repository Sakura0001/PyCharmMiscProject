...
-- primary_obligation_id: CLANG-EXT|01758|effect_query|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS createlanguage_01758_lang CASCADE;
RESET ROLE;
...
CREATE OR REPLACE TRUSTED LANGUAGE createlanguage_01758_lang HANDLER public.createlanguage_01758_handler INLINE public.createlanguage_01758_inline;
-- primary-target-end
