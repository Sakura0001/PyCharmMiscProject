...
-- primary_obligation_id: CLANG-EXT|00516|effect_query|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS "createlanguage_00516_QLang" CASCADE;
RESET ROLE;
...
CREATE TRUSTED LANGUAGE "createlanguage_00516_QLang" HANDLER createlanguage_00516_handler INLINE createlanguage_00516_inline VALIDATOR createlanguage_00516_validator;
-- primary-target-end
