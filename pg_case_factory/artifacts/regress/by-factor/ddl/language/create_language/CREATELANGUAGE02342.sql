...
-- primary_obligation_id: CLANG-EXT|02342|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS createlanguage_02342_lang CASCADE;
RESET ROLE;
...
CREATE OR REPLACE TRUSTED LANGUAGE createlanguage_02342_lang HANDLER createlanguage_02342_handler INLINE createlanguage_02342_inline VALIDATOR createlanguage_02342_validator;
-- primary-target-end
