...
-- primary_obligation_id: CLANG-EXT|00229|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS "createlanguage_00229_QLang" CASCADE;
RESET ROLE;
...
CREATE LANGUAGE "createlanguage_00229_QLang" HANDLER createlanguage_00229_handler INLINE createlanguage_00229_inline VALIDATOR createlanguage_00229_validator;
-- primary-target-end
