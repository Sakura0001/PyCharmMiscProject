...
-- primary_obligation_id: CLANG-EXT|00138|effect_query|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS createlanguage_00138_lang CASCADE;
RESET ROLE;
...
CREATE LANGUAGE createlanguage_00138_lang HANDLER public.createlanguage_00138_handler INLINE public.createlanguage_00138_inline VALIDATOR public.createlanguage_00138_validator;
-- primary-target-end
