...
-- primary_obligation_id: CLANG-EXT|01772|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS createlanguage_01772_lang CASCADE;
RESET ROLE;
...
CREATE OR REPLACE TRUSTED LANGUAGE createlanguage_01772_lang HANDLER public.createlanguage_01772_handler INLINE public.createlanguage_01772_inline VALIDATOR public.createlanguage_01772_validator;
-- primary-target-end
