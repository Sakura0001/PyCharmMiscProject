...
-- primary_obligation_id: CLANG-EXT|02437|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS "createlanguage_02437_QLang" CASCADE;
RESET ROLE;
...
CREATE OR REPLACE TRUSTED LANGUAGE "createlanguage_02437_QLang" HANDLER createlanguage_02437_handler INLINE createlanguage_02437_inline VALIDATOR createlanguage_02437_validator;
-- primary-target-end
