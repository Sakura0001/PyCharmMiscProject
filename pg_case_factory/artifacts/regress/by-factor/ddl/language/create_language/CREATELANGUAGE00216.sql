...
-- primary_obligation_id: CLANG-EXT|00216|effect_query|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS "createlanguage_00216_QLang" CASCADE;
RESET ROLE;
...
CREATE LANGUAGE "createlanguage_00216_QLang" HANDLER createlanguage_00216_handler INLINE createlanguage_00216_inline;
-- primary-target-end
