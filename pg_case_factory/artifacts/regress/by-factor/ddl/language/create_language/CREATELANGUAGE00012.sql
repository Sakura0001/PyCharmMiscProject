...
-- primary_obligation_id: CLANG-SFV|sfv-7fd0c292bdf6d1a8a8a5cb6d|with_handler
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS createlanguage_00012_lang CASCADE;
RESET ROLE;
...
CREATE LANGUAGE createlanguage_00012_lang HANDLER createlanguage_00012_handler;
-- primary-target-end
...
SELECT count(*) = 0 AS language_state FROM pg_catalog.pg_language WHERE lanname = 'createlanguage_00012_lang' ORDER BY count(*);
-- 5. 清理全部本编号对象。
DROP LANGUAGE IF EXISTS createlanguage_00012_lang CASCADE;
