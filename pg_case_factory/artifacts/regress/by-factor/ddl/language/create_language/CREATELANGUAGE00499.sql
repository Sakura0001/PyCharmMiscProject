...
-- primary_obligation_id: CLANG-EXT|00499|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS "createlanguage_00499_QLang" CASCADE;
RESET ROLE;
...
CREATE TRUSTED LANGUAGE "createlanguage_00499_QLang" HANDLER public.createlanguage_00499_handler VALIDATOR public.createlanguage_00499_validator;
-- primary-target-end
