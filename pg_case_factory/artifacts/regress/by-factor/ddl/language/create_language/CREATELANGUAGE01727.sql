...
-- primary_obligation_id: CLANG-EXT|01727|effect_query|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS createlanguage_01727_lang CASCADE;
RESET ROLE;
...
CREATE OR REPLACE TRUSTED LANGUAGE createlanguage_01727_lang HANDLER createlanguage_01727_handler;
-- primary-target-end
