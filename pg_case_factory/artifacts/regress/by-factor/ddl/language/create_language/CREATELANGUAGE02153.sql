...
-- primary_obligation_id: CLANG-EXT|02153|effect_query|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS "createlanguage_02153_QLang" CASCADE;
RESET ROLE;
...
CREATE OR REPLACE LANGUAGE "createlanguage_02153_QLang" HANDLER public.createlanguage_02153_handler INLINE public.createlanguage_02153_inline VALIDATOR public.createlanguage_02153_validator;
-- primary-target-end
