...
-- primary_obligation_id: CLANG-EXT|00230|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS "createlanguage_00230_QLang" CASCADE;
RESET ROLE;
...
CREATE LANGUAGE "createlanguage_00230_QLang" HANDLER createlanguage_00230_handler INLINE createlanguage_00230_inline VALIDATOR createlanguage_00230_validator;
-- primary-target-end
