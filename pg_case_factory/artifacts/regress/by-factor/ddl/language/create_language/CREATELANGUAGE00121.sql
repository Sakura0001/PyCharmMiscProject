...
-- primary_obligation_id: CLANG-EXT|00121|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS createlanguage_00121_lang CASCADE;
RESET ROLE;
...
CREATE LANGUAGE createlanguage_00121_lang HANDLER createlanguage_00121_handler INLINE createlanguage_00121_inline;
-- primary-target-end
