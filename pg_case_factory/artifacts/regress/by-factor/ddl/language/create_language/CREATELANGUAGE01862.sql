...
-- primary_obligation_id: CLANG-EXT|01862|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS "createlanguage_01862_QLang" CASCADE;
RESET ROLE;
...
CREATE OR REPLACE TRUSTED LANGUAGE "createlanguage_01862_QLang" HANDLER createlanguage_01862_handler INLINE createlanguage_01862_inline VALIDATOR createlanguage_01862_validator;
-- primary-target-end
