...
-- primary_obligation_id: CLANG-EXT|00421|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS createlanguage_00421_lang CASCADE;
RESET ROLE;
...
CREATE TRUSTED LANGUAGE createlanguage_00421_lang HANDLER createlanguage_00421_handler INLINE createlanguage_00421_inline VALIDATOR createlanguage_00421_validator;
-- primary-target-end
