...
-- primary_obligation_id: CLANG-EXT|00425|effect_query|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS createlanguage_00425_lang CASCADE;
RESET ROLE;
...
CREATE TRUSTED LANGUAGE createlanguage_00425_lang HANDLER public.createlanguage_00425_handler INLINE public.createlanguage_00425_inline VALIDATOR public.createlanguage_00425_validator;
-- primary-target-end
