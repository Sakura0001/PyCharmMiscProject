...
-- primary_obligation_id: CLANG-EXT|02418|effect_query|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS "createlanguage_02418_QLang" CASCADE;
RESET ROLE;
...
CREATE OR REPLACE TRUSTED LANGUAGE "createlanguage_02418_QLang" HANDLER public.createlanguage_02418_handler VALIDATOR public.createlanguage_02418_validator;
-- primary-target-end
