...
-- primary_obligation_id: CLANG-EXT|00803|effect_query|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS "createlanguage_00803_QLang" CASCADE;
RESET ROLE;
...
CREATE OR REPLACE LANGUAGE "createlanguage_00803_QLang" HANDLER createlanguage_00803_handler INLINE createlanguage_00803_inline VALIDATOR createlanguage_00803_validator;
-- primary-target-end
