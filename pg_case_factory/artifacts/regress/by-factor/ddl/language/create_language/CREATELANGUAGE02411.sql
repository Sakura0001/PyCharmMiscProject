...
-- primary_obligation_id: CLANG-EXT|02411|effect_query|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS "createlanguage_02411_QLang" CASCADE;
RESET ROLE;
...
CREATE OR REPLACE TRUSTED LANGUAGE "createlanguage_02411_QLang" HANDLER createlanguage_02411_handler VALIDATOR createlanguage_02411_validator;
-- primary-target-end
