...
-- primary_obligation_id: CLANG-EXT|00505|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS "createlanguage_00505_QLang" CASCADE;
RESET ROLE;
...
CREATE TRUSTED LANGUAGE "createlanguage_00505_QLang" HANDLER createlanguage_00505_handler INLINE createlanguage_00505_inline;
-- primary-target-end
