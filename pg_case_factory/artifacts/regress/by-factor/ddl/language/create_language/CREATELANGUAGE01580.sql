...
-- primary_obligation_id: CLANG-EXT|01580|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS "createlanguage_01580_QLang" CASCADE;
RESET ROLE;
...
CREATE OR REPLACE LANGUAGE "createlanguage_01580_QLang" HANDLER public.createlanguage_01580_handler INLINE public.createlanguage_01580_inline VALIDATOR public.createlanguage_01580_validator;
-- primary-target-end
