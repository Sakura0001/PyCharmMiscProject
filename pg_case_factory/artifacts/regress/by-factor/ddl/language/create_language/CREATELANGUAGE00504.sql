...
-- primary_obligation_id: CLANG-EXT|00504|effect_query|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS "createlanguage_00504_QLang" CASCADE;
RESET ROLE;
...
CREATE TRUSTED LANGUAGE "createlanguage_00504_QLang" HANDLER createlanguage_00504_handler INLINE createlanguage_00504_inline;
-- primary-target-end
