...
-- primary_obligation_id: CLANG-EXT|02048|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS createlanguage_02048_lang CASCADE;
RESET ROLE;
...
CREATE OR REPLACE LANGUAGE createlanguage_02048_lang HANDLER public.createlanguage_02048_handler INLINE public.createlanguage_02048_inline;
-- primary-target-end
