...
-- primary_obligation_id: CLANG-EXT|02052|effect_query|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS createlanguage_02052_lang CASCADE;
RESET ROLE;
...
CREATE OR REPLACE LANGUAGE createlanguage_02052_lang HANDLER createlanguage_02052_handler INLINE createlanguage_02052_inline VALIDATOR createlanguage_02052_validator;
-- primary-target-end
