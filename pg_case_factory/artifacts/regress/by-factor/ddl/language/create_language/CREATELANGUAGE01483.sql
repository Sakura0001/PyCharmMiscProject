...
-- primary_obligation_id: CLANG-EXT|01483|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS createlanguage_01483_lang CASCADE;
RESET ROLE;
...
CREATE OR REPLACE LANGUAGE createlanguage_01483_lang HANDLER public.createlanguage_01483_handler INLINE public.createlanguage_01483_inline VALIDATOR public.createlanguage_01483_validator;
-- primary-target-end
