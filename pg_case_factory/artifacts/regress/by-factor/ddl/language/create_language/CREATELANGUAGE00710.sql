...
-- primary_obligation_id: CLANG-EXT|00710|error_assertion|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS createlanguage_00710_lang CASCADE;
RESET ROLE;
...
CREATE OR REPLACE LANGUAGE createlanguage_00710_lang HANDLER createlanguage_00710_handler INLINE createlanguage_00710_inline VALIDATOR createlanguage_00710_validator;
-- primary-target-end
