...
-- primary_obligation_id: CLANG-EXT|02029|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42804
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP LANGUAGE IF EXISTS createlanguage_02029_lang CASCADE;
RESET ROLE;
...
CREATE OR REPLACE LANGUAGE createlanguage_02029_lang HANDLER createlanguage_02029_handler VALIDATOR createlanguage_02029_validator;
-- primary-target-end
