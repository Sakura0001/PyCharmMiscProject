...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHTEMPLATE01417
...
-- primary_obligation_id: DROPTEXTSEARCHTEMPLATE-EXT|01417|drop_text_search_template|catalog_query|cascade_cleanup
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS droptextsearchtemplate_01417_dict CASCADE;
...
CREATE TEXT SEARCH DICTIONARY droptextsearchtemplate_01417_dict TEMPLATE "select";
