...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHTEMPLATE02153
...
-- primary_obligation_id: DROPTEXTSEARCHTEMPLATE-EXT|02153|drop_text_search_template|notice_assertion|cascade_cleanup
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS droptextsearchtemplate_02153_dict CASCADE;
...
CREATE TEXT SEARCH DICTIONARY droptextsearchtemplate_02153_dict TEMPLATE "select";
