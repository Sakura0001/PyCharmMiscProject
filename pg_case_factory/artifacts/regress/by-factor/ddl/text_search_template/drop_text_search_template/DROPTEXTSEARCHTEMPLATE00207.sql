...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHTEMPLATE00207
...
-- primary_obligation_id: DROPTEXTSEARCHTEMPLATE-EXT|00207|drop_text_search_template|error_assertion|cascade_cleanup
-- expected_outcome: expected_failure
-- expected_sqlstate: 2BP01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS droptextsearchtemplate_00207_dict CASCADE;
...
CREATE TEXT SEARCH DICTIONARY droptextsearchtemplate_00207_dict TEMPLATE "select";
