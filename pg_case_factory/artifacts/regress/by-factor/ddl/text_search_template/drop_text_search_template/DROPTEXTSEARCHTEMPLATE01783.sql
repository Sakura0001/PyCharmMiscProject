...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHTEMPLATE01783
...
-- primary_obligation_id: DROPTEXTSEARCHTEMPLATE-EXT|01783|drop_text_search_template|catalog_query|cascade_cleanup
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS droptextsearchtemplate_01783_dict CASCADE;
...
CREATE TEXT SEARCH DICTIONARY droptextsearchtemplate_01783_dict TEMPLATE "select";
