...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHTEMPLATE01381
...
-- primary_obligation_id: DROPTEXTSEARCHTEMPLATE-EXT|01381|drop_text_search_template|catalog_query|cascade_cleanup
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH TEMPLATE IF EXISTS "droptextsearchtemplate_01381_qtmpl" CASCADE;
...
SELECT count(*) = 0 AS template_absent FROM pg_catalog.pg_ts_template WHERE tmplname = 'droptextsearchtemplate_01381_qtmpl' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
DROP TEXT SEARCH TEMPLATE IF EXISTS "droptextsearchtemplate_01381_qtmpl" CASCADE;
