...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHTEMPLATE00431
...
-- primary_obligation_id: DROPTEXTSEARCHTEMPLATE-EXT|00431|drop_text_search_template|notice_assertion|cascade_cleanup
-- expected_outcome: expected_failure
-- expected_sqlstate: 2BP01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS droptextsearchtemplate_00431_dict CASCADE;
...
CREATE TEXT SEARCH DICTIONARY droptextsearchtemplate_00431_dict TEMPLATE "select";
