...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHTEMPLATE01420
...
-- primary_obligation_id: DROPTEXTSEARCHTEMPLATE-EXT|01420|drop_text_search_template|error_assertion|manual_dependency_cleanup
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS droptextsearchtemplate_01420_dict CASCADE;
...
CREATE TEXT SEARCH DICTIONARY droptextsearchtemplate_01420_dict TEMPLATE "select";
