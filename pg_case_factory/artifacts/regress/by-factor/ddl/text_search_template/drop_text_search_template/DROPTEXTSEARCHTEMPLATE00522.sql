...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHTEMPLATE00522
...
-- primary_obligation_id: DROPTEXTSEARCHTEMPLATE-EXT|00522|drop_text_search_template|notice_assertion|manual_dependency_cleanup
-- expected_outcome: expected_failure
-- expected_sqlstate: 2BP01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS droptextsearchtemplate_00522_dict CASCADE;
...
CREATE TEXT SEARCH DICTIONARY droptextsearchtemplate_00522_dict TEMPLATE "select";
\set ON_ERROR_STOP off
-- 3. 执行唯一获得覆盖信用的 DROP TEXT SEARCH TEMPLATE。
-- primary-target-begin
DROP TEXT SEARCH TEMPLATE "select";
-- primary-target-end
