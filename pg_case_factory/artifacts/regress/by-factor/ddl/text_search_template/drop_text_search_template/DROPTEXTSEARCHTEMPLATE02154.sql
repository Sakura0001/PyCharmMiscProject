...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHTEMPLATE02154
...
-- primary_obligation_id: DROPTEXTSEARCHTEMPLATE-EXT|02154|drop_text_search_template|notice_assertion|manual_dependency_cleanup
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS droptextsearchtemplate_02154_dict CASCADE;
...
CREATE TEXT SEARCH DICTIONARY droptextsearchtemplate_02154_dict TEMPLATE "select";
