...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHTEMPLATE00210
...
-- primary_obligation_id: DROPTEXTSEARCHTEMPLATE-EXT|00210|drop_text_search_template|notice_assertion|manual_dependency_cleanup
-- expected_outcome: expected_failure
-- expected_sqlstate: 2BP01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH DICTIONARY IF EXISTS droptextsearchtemplate_00210_dict CASCADE;
...
CREATE TEXT SEARCH DICTIONARY droptextsearchtemplate_00210_dict TEMPLATE "select";
