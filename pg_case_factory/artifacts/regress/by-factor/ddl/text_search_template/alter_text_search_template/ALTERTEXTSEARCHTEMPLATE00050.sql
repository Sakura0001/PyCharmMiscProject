...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHTEMPLATE00050
...
-- primary_obligation_id: ATST-EXT|00050|error_assertion|revert_rename
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH TEMPLATE IF EXISTS "altertextsearchtemplate_00050_Mixed New";
...
ALTER TEXT SEARCH TEMPLATE altertextsearchtemplate_00050_no_such_tmpl RENAME TO "altertextsearchtemplate_00050_Mixed New";
-- primary-target-end
