...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHTEMPLATE00156
...
-- primary_obligation_id: ATST-EXT|00156|catalog_query_pg_ts_template|revert_rename
...
ALTER TEXT SEARCH TEMPLATE altertextsearchtemplate_00156_no_such_tmpl SET SCHEMA altertextsearchtemplate_00156_no_such_sch;
-- primary-target-end
...
SELECT count(*) = 0 AS template_state FROM pg_catalog.pg_ts_template WHERE tmplname = 'altertextsearchtemplate_00156_no_such_tmpl' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
