...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHTEMPLATE00067
...
-- primary_obligation_id: ATST-EXT|00067|error_assertion|drop_text_search_template
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH TEMPLATE IF EXISTS altertextsearchtemplate_00067_newtmpl;
...
ALTER TEXT SEARCH TEMPLATE altertextsearchtemplate_00067_no_such_tmpl RENAME TO altertextsearchtemplate_00067_newtmpl;
-- primary-target-end
