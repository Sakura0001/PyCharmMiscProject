...
-- primary_obligation_id: ASYS-EXT|05735|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_05735_nonexistent_param = 'on';
-- primary-target-end
