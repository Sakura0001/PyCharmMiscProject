...
-- primary_obligation_id: ASYS-EXT|06287|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_06287_quoted.param" = DEFAULT;
-- primary-target-end
