...
-- primary_obligation_id: ASYS-EXT|06087|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_06087_quoted.param" = 1024;
-- primary-target-end
