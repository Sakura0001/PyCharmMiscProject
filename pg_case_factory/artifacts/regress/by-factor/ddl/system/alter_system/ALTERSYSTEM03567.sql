...
-- primary_obligation_id: ASYS-EXT|03567|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_03567_custom.param = '8MB';
-- primary-target-end
