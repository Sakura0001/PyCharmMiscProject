...
-- primary_obligation_id: ASYS-EXT|00951|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_00951_custom.param = 'alpha,beta,gamma';
-- primary-target-end
