...
-- primary_obligation_id: ASYS-EXT|06183|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_06183_quoted.param" = 1024;
-- primary-target-end
