...
-- primary_obligation_id: ASYS-EXT|03735|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_03735_custom.param = DEFAULT;
-- primary-target-end
