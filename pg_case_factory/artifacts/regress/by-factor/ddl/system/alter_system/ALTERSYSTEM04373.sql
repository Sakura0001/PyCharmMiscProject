...
-- primary_obligation_id: ASYS-EXT|04373|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_04373_nonexistent_param = 'on';
-- primary-target-end
