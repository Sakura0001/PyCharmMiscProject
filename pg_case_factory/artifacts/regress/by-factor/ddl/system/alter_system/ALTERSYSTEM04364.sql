...
-- primary_obligation_id: ASYS-EXT|04364|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_04364_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
