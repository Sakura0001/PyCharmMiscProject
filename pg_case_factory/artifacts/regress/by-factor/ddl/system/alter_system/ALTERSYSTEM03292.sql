...
-- primary_obligation_id: ASYS-EXT|03292|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_03292_nonexistent_param = DEFAULT;
-- primary-target-end
