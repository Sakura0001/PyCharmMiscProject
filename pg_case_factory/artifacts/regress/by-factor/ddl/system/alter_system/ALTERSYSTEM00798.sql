...
-- primary_obligation_id: ASYS-EXT|00798|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_00798_nonexistent_param = DEFAULT;
-- primary-target-end
