...
-- primary_obligation_id: ASYS-EXT|05781|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_05781_nonexistent_param = DEFAULT;
-- primary-target-end
