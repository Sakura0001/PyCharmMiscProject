...
-- primary_obligation_id: ASYS-EXT|02239|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_02239_quoted.param" = 'on';
-- primary-target-end
