...
-- primary_obligation_id: ASYS-EXT|05732|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_05732_nonexistent_param = 'on';
-- primary-target-end
