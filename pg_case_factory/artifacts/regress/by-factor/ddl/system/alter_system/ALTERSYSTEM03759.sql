...
-- primary_obligation_id: ASYS-EXT|03759|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_03759_custom.param = DEFAULT;
-- primary-target-end
