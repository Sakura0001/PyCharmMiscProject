...
-- primary_obligation_id: ASYS-EXT|01876|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_01876_nonexistent_param = 'on';
-- primary-target-end
