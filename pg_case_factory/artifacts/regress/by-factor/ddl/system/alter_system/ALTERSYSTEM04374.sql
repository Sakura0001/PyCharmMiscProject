...
-- primary_obligation_id: ASYS-EXT|04374|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_04374_nonexistent_param = 'on';
-- primary-target-end
