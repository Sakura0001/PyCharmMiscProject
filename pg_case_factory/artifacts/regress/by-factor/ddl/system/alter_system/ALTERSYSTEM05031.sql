...
-- primary_obligation_id: ASYS-EXT|05031|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_05031_custom.param = DEFAULT;
-- primary-target-end
