...
-- primary_obligation_id: ASYS-EXT|05757|show_command|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_05757_quoted.param" = 'not_a_number';
-- primary-target-end
...
SHOW "alter_system_05757_quoted.param";
-- 5. 清理全部本编号对象。
ALTER SYSTEM RESET ALL;
