...
-- primary_obligation_id: ASYS-EXT|05951|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_05951_custom.param = 'on';
-- primary-target-end
