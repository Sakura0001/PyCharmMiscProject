...
-- primary_obligation_id: ASYS-EXT|04477|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_04477_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
