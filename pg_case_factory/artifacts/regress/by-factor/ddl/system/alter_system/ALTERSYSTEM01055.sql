...
-- primary_obligation_id: ASYS-EXT|01055|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_01055_custom.param = 'on';
-- primary-target-end
