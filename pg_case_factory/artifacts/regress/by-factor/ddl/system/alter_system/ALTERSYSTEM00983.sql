...
-- primary_obligation_id: ASYS-EXT|00983|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_00983_quoted.param" = 'alpha,beta,gamma';
-- primary-target-end
