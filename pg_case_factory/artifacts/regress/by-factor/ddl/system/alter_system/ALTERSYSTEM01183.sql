...
-- primary_obligation_id: ASYS-EXT|01183|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_01183_quoted.param" = 'on';
-- primary-target-end
