...
-- primary_obligation_id: ASYS-EXT|06055|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_06055_custom.param = 1024;
-- primary-target-end
