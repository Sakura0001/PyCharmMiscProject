...
-- primary_obligation_id: ASYS-EXT|04935|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_04935_quoted.param" = 1024;
-- primary-target-end
