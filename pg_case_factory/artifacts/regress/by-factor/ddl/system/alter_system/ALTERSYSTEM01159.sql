...
-- primary_obligation_id: ASYS-EXT|01159|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_01159_custom.param = 1024;
-- primary-target-end
