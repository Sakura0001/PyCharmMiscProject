...
-- primary_obligation_id: ASYS-EXT|04823|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_04823_quoted.param" = 'alpha,beta,gamma';
-- primary-target-end
