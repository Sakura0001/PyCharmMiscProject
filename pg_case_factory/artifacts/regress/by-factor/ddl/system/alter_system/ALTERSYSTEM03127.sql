...
-- primary_obligation_id: ASYS-EXT|03127|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_03127_nonexistent_param = 'on';
-- primary-target-end
