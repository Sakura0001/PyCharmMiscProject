...
-- primary_obligation_id: ASYS-EXT|05725|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_05725_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
