...
-- primary_obligation_id: ASYS-EXT|04430|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_04430_nonexistent_param = 'on';
-- primary-target-end
