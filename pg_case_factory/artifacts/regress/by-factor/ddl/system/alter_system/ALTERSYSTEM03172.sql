...
-- primary_obligation_id: ASYS-EXT|03172|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_03172_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
