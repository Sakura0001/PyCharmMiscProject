...
-- primary_obligation_id: ASYS-EXT|02029|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_02029_nonexistent_param = DEFAULT;
-- primary-target-end
