...
-- primary_obligation_id: ASYS-EXT|01871|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_01871_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
