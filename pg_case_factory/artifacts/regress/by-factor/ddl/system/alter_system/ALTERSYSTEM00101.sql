...
-- primary_obligation_id: ASYS-EXT|00101|show_command|alter_system_reset_all
...
-- 2. 创建完整本地规则和因子专用夹具。
CREATE ROLE alter_system_00101_actor LOGIN NOSUPERUSER;
SET ROLE alter_system_00101_actor;
...
-- 5. 清理全部本编号对象。
RESET ROLE;
DROP ROLE IF EXISTS alter_system_00101_actor;
ALTER SYSTEM RESET ALL;
