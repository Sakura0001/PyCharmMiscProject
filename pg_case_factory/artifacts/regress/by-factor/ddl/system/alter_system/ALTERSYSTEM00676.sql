...
-- primary_obligation_id: ASYS-EXT|00676|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_00676_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
