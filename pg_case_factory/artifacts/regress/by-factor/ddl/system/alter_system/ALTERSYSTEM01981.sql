...
-- primary_obligation_id: ASYS-EXT|01981|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_01981_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
