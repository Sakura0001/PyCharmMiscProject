...
-- primary_obligation_id: ASYS-EXT|01877|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_01877_nonexistent_param = 'on';
-- primary-target-end
