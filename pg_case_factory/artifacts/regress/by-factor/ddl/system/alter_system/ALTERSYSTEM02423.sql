...
-- primary_obligation_id: ASYS-EXT|02423|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_02423_quoted.param" = 'alpha,beta,gamma';
-- primary-target-end
