...
-- primary_obligation_id: ASYS-EXT|01878|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_01878_nonexistent_param = 'on';
-- primary-target-end
