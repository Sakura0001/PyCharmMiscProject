...
-- primary_obligation_id: ASYS-EXT|03286|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_03286_nonexistent_param = DEFAULT;
-- primary-target-end
