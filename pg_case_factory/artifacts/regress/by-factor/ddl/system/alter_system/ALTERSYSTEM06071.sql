...
-- primary_obligation_id: ASYS-EXT|06071|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_06071_quoted.param" = 'alpha,beta,gamma';
-- primary-target-end
