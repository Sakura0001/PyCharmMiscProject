...
-- primary_obligation_id: ASYS-EXT|00687|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_00687_nonexistent_param = 'on';
-- primary-target-end
