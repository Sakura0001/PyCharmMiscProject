...
-- primary_obligation_id: ASYS-EXT|05615|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_05615_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
