...
-- primary_obligation_id: ASYS-EXT|03279|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_03279_nonexistent_param = DEFAULT;
-- primary-target-end
