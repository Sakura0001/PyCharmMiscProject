...
-- primary_obligation_id: ASYS-EXT|04512|pg_settings_query|alter_system_reset_parameter
...
ALTER SYSTEM SET shared_buffers = 'not_a_number';
-- primary-target-end
