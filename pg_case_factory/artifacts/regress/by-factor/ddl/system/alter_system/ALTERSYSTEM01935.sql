...
-- primary_obligation_id: ASYS-EXT|01935|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_01935_nonexistent_param = 'on';
-- primary-target-end
