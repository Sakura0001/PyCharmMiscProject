...
-- primary_obligation_id: ASYS-EXT|04372|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_04372_nonexistent_param = 'on';
-- primary-target-end
