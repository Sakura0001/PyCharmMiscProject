...
-- primary_obligation_id: ASYS-EXT|03447|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_03447_custom.param = 'alpha,beta,gamma';
-- primary-target-end
