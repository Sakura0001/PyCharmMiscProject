...
-- primary_obligation_id: ASYS-EXT|01927|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_01927_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
