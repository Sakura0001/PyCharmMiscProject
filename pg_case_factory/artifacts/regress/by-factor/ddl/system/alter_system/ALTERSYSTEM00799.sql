...
-- primary_obligation_id: ASYS-EXT|00799|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_00799_nonexistent_param = DEFAULT;
-- primary-target-end
