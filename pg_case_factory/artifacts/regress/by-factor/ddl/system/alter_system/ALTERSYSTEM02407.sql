...
-- primary_obligation_id: ASYS-EXT|02407|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_02407_custom.param = 1024;
-- primary-target-end
