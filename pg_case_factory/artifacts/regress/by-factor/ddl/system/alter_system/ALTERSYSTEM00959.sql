...
-- primary_obligation_id: ASYS-EXT|00959|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_00959_custom.param = 'on';
-- primary-target-end
