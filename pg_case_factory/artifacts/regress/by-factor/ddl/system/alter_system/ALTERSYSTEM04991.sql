...
-- primary_obligation_id: ASYS-EXT|04991|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_04991_quoted.param" = DEFAULT;
-- primary-target-end
