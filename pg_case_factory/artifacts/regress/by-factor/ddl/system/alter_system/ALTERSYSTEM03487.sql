...
-- primary_obligation_id: ASYS-EXT|03487|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_03487_quoted.param" = 'on';
-- primary-target-end
