...
-- primary_obligation_id: ASYS-SFV|sfv-0789e44f58e58ee464483ade|set
...
ALTER SYSTEM SET alter_system_00023_nonexistent_param = '8MB';
-- primary-target-end
...
SELECT count(*) = 0 AS param_set FROM pg_catalog.pg_settings WHERE name = 'alter_system_00023_nonexistent_param' AND source = 'configuration file' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS cleanup_nonexistent_param;
