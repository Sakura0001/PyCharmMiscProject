...
-- primary_obligation_id: ASYS-EXT|03236|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_03236_nonexistent_param = 'on';
-- primary-target-end
