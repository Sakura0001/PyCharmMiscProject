...
-- primary_obligation_id: ASYS-EXT|03126|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_03126_nonexistent_param = 'on';
-- primary-target-end
