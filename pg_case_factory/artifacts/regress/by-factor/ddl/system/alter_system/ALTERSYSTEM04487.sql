...
-- primary_obligation_id: ASYS-EXT|04487|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_04487_nonexistent_param = 'on';
-- primary-target-end
