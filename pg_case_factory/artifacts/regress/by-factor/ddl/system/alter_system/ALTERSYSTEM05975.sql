...
-- primary_obligation_id: ASYS-EXT|05975|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_05975_quoted.param" = 'alpha,beta,gamma';
-- primary-target-end
