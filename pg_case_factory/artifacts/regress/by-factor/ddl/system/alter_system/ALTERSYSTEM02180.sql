...
-- primary_obligation_id: ASYS-EXT|02180|show_command|alter_system_reset_parameter
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
ALTER SYSTEM RESET "alter_system_02180_quoted.param";
...
SHOW "alter_system_02180_quoted.param";
-- 5. 清理全部本编号对象。
ALTER SYSTEM RESET "alter_system_02180_quoted.param";
