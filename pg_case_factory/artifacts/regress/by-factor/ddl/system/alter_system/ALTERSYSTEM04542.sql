...
-- primary_obligation_id: ASYS-EXT|04542|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_04542_nonexistent_param = DEFAULT;
-- primary-target-end
