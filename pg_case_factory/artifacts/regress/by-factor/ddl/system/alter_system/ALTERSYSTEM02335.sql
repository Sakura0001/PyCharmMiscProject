...
-- primary_obligation_id: ASYS-EXT|02335|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_02335_quoted.param" = 'on';
-- primary-target-end
