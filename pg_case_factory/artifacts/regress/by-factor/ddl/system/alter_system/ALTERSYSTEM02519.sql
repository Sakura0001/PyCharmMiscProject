...
-- primary_obligation_id: ASYS-EXT|02519|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_02519_quoted.param" = DEFAULT;
-- primary-target-end
