...
-- primary_obligation_id: ASYS-EXT|04431|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_04431_nonexistent_param = 'on';
-- primary-target-end
