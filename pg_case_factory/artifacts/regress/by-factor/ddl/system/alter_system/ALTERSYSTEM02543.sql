...
-- primary_obligation_id: ASYS-EXT|02543|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_02543_quoted.param" = DEFAULT;
-- primary-target-end
