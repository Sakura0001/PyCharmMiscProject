...
-- primary_obligation_id: ASYS-EXT|04428|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_04428_nonexistent_param = 'on';
-- primary-target-end
