...
-- primary_obligation_id: ASYS-EXT|05983|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_05983_quoted.param" = 'on';
-- primary-target-end
