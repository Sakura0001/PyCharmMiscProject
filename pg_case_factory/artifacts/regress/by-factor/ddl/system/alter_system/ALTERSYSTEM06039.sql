...
-- primary_obligation_id: ASYS-EXT|06039|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_06039_custom.param = 'alpha,beta,gamma';
-- primary-target-end
