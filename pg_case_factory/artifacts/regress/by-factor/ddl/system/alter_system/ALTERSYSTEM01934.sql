...
-- primary_obligation_id: ASYS-EXT|01934|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_01934_nonexistent_param = 'on';
-- primary-target-end
