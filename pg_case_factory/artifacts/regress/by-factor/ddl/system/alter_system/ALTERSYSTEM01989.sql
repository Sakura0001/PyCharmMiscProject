...
-- primary_obligation_id: ASYS-EXT|01989|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_01989_nonexistent_param = 'on';
-- primary-target-end
