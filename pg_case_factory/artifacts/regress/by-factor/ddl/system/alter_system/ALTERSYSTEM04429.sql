...
-- primary_obligation_id: ASYS-EXT|04429|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_04429_nonexistent_param = 'on';
-- primary-target-end
