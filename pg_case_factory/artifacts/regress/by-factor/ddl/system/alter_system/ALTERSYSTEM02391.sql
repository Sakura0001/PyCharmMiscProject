...
-- primary_obligation_id: ASYS-EXT|02391|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_02391_custom.param = 'alpha,beta,gamma';
-- primary-target-end
