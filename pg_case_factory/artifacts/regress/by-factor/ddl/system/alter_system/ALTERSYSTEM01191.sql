...
-- primary_obligation_id: ASYS-EXT|01191|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_01191_quoted.param" = 1024;
-- primary-target-end
