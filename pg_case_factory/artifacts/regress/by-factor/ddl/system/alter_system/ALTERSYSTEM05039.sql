...
-- primary_obligation_id: ASYS-EXT|05039|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_05039_quoted.param" = DEFAULT;
-- primary-target-end
