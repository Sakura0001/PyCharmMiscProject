...
-- primary_obligation_id: ASYS-EXT|05759|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_05759_quoted.param" = 'not_a_number';
-- primary-target-end
