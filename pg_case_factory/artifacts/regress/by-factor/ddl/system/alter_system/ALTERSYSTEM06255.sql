...
-- primary_obligation_id: ASYS-EXT|06255|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_06255_custom.param = DEFAULT;
-- primary-target-end
