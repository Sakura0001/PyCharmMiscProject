...
-- primary_obligation_id: ASYS-EXT|04426|pg_file_settings_query|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_04426_nonexistent_param = 'on';
-- primary-target-end
...
SELECT count(*) = 0 AS param_in_file FROM pg_catalog.pg_file_settings WHERE name = 'alter_system_04426_nonexistent_param' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS cleanup_nonexistent_param;
