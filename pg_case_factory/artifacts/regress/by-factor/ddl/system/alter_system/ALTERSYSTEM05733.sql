...
-- primary_obligation_id: ASYS-EXT|05733|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_05733_nonexistent_param = 'on';
-- primary-target-end
