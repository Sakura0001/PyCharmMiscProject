...
-- primary_obligation_id: ASYS-EXT|05783|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_05783_nonexistent_param = DEFAULT;
-- primary-target-end
