...
-- primary_obligation_id: ASYS-EXT|04983|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_04983_custom.param = DEFAULT;
-- primary-target-end
