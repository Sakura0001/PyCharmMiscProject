...
-- primary_obligation_id: ASYS-EXT|02039|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_02039_nonexistent_param = DEFAULT;
-- primary-target-end
