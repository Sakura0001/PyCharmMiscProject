...
-- primary_obligation_id: ASYS-EXT|00741|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_00741_nonexistent_param = 'on';
-- primary-target-end
