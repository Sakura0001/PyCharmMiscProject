...
-- primary_obligation_id: ASYS-EXT|06047|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_06047_custom.param = 'on';
-- primary-target-end
