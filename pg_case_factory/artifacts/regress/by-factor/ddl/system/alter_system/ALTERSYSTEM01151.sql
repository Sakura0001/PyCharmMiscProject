...
-- primary_obligation_id: ASYS-EXT|01151|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_01151_custom.param = 'on';
-- primary-target-end
