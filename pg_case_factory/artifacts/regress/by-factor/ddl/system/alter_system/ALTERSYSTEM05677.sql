...
-- primary_obligation_id: ASYS-EXT|05677|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_05677_nonexistent_param = 'on';
-- primary-target-end
