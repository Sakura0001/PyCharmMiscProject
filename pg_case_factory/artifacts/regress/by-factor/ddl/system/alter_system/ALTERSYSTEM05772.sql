...
-- primary_obligation_id: ASYS-EXT|05772|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_05772_nonexistent_param = DEFAULT;
-- primary-target-end
