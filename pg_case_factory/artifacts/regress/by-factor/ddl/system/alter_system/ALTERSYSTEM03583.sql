...
-- primary_obligation_id: ASYS-EXT|03583|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_03583_quoted.param" = 'on';
-- primary-target-end
