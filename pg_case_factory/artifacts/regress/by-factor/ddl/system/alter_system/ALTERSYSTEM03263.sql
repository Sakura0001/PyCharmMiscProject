...
-- primary_obligation_id: ASYS-EXT|03263|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_03263_quoted.param" = 'not_a_number';
-- primary-target-end
