...
-- primary_obligation_id: ASYS-EXT|04541|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_04541_nonexistent_param = DEFAULT;
-- primary-target-end
