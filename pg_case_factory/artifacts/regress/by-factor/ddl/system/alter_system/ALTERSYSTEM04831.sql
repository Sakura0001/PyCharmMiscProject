...
-- primary_obligation_id: ASYS-EXT|04831|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_04831_quoted.param" = 'on';
-- primary-target-end
