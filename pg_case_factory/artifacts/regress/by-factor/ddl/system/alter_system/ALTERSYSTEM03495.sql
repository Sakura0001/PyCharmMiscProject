...
-- primary_obligation_id: ASYS-EXT|03495|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_03495_quoted.param" = 1024;
-- primary-target-end
