...
-- primary_obligation_id: ASYS-EXT|05775|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_05775_nonexistent_param = DEFAULT;
-- primary-target-end
