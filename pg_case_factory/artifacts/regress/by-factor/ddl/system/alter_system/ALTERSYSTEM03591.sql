...
-- primary_obligation_id: ASYS-EXT|03591|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_03591_quoted.param" = 1024;
-- primary-target-end
