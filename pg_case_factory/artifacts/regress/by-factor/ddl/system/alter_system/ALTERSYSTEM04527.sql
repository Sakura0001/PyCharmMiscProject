...
-- primary_obligation_id: ASYS-EXT|04527|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_04527_nonexistent_param = DEFAULT;
-- primary-target-end
