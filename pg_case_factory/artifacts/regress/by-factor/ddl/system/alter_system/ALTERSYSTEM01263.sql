...
-- primary_obligation_id: ASYS-EXT|01263|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_01263_custom.param = DEFAULT;
-- primary-target-end
