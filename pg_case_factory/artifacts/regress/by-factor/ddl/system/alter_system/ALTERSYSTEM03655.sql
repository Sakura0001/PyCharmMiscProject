...
-- primary_obligation_id: ASYS-EXT|03655|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_03655_custom.param = 1024;
-- primary-target-end
