...
-- primary_obligation_id: ASYS-EXT|00967|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_00967_custom.param = 1024;
-- primary-target-end
