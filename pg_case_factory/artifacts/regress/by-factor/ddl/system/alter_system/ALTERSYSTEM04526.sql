...
-- primary_obligation_id: ASYS-EXT|04526|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_04526_nonexistent_param = DEFAULT;
-- primary-target-end
