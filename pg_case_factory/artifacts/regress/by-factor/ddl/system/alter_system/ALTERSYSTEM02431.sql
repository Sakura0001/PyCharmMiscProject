...
-- primary_obligation_id: ASYS-EXT|02431|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_02431_quoted.param" = 'on';
-- primary-target-end
