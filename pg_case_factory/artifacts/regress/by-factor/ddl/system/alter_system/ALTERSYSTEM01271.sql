...
-- primary_obligation_id: ASYS-EXT|01271|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_01271_quoted.param" = DEFAULT;
-- primary-target-end
