...
-- primary_obligation_id: ASYS-EXT|00678|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_00678_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
