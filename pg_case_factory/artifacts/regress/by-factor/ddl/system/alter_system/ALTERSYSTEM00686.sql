...
-- primary_obligation_id: ASYS-EXT|00686|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_00686_nonexistent_param = 'on';
-- primary-target-end
