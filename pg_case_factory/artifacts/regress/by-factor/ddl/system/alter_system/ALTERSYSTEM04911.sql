...
-- primary_obligation_id: ASYS-EXT|04911|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_04911_custom.param = '8MB';
-- primary-target-end
