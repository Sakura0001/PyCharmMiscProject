...
-- primary_obligation_id: ASYS-EXT|04375|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_04375_nonexistent_param = 'on';
-- primary-target-end
