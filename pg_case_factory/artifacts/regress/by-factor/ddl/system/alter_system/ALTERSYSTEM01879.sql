...
-- primary_obligation_id: ASYS-EXT|01879|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_01879_nonexistent_param = 'on';
-- primary-target-end
