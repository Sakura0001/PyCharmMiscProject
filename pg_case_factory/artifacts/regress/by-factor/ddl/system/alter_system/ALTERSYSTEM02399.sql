...
-- primary_obligation_id: ASYS-EXT|02399|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_02399_custom.param = 'on';
-- primary-target-end
