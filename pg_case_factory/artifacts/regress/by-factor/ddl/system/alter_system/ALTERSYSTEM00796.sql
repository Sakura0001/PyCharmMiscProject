...
-- primary_obligation_id: ASYS-EXT|00796|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_00796_nonexistent_param = DEFAULT;
-- primary-target-end
