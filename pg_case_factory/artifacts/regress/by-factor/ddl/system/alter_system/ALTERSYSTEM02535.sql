...
-- primary_obligation_id: ASYS-EXT|02535|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_02535_custom.param = DEFAULT;
-- primary-target-end
