...
-- primary_obligation_id: ASYS-EXT|04799|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_04799_custom.param = 'on';
-- primary-target-end
