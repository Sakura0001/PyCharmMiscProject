...
-- primary_obligation_id: ASYS-EXT|03118|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_03118_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
