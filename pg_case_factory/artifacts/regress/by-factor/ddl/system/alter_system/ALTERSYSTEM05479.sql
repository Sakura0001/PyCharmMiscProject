...
-- primary_obligation_id: ASYS-EXT|05479|error_assertion|alter_system_reset_all
...
-- 2. 创建完整本地规则和因子专用夹具。
CREATE ROLE alter_system_05479_actor LOGIN NOSUPERUSER;
SET ROLE alter_system_05479_actor;
...
-- 5. 清理全部本编号对象。
RESET ROLE;
DROP ROLE IF EXISTS alter_system_05479_actor;
ALTER SYSTEM RESET ALL;
