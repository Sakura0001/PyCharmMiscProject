...
-- primary_obligation_id: ASYS-EXT|04455|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_04455_quoted.param" = 'not_a_number';
-- primary-target-end
