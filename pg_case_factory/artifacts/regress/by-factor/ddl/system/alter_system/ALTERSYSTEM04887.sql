...
-- primary_obligation_id: ASYS-EXT|04887|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_04887_custom.param = 'alpha,beta,gamma';
-- primary-target-end
