...
-- primary_obligation_id: ASYS-EXT|03647|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_03647_custom.param = 'on';
-- primary-target-end
