...
-- primary_obligation_id: ASYS-EXT|00671|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_00671_custom.param = 'not_a_number';
-- primary-target-end
