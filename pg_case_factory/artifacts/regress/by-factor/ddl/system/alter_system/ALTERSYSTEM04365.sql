...
-- primary_obligation_id: ASYS-EXT|04365|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_04365_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
