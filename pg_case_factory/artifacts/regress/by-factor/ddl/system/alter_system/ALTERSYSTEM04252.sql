...
-- primary_obligation_id: ASYS-EXT|04252|show_command|alter_system_reset_parameter
...
-- 2. 创建完整本地规则和因子专用夹具。
CREATE ROLE alter_system_04252_actor LOGIN NOSUPERUSER;
SET ROLE alter_system_04252_actor;
...
-- 5. 清理全部本编号对象。
RESET ROLE;
DROP ROLE IF EXISTS alter_system_04252_actor;
ALTER SYSTEM RESET shared_buffers;
