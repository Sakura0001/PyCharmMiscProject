...
-- primary_obligation_id: ASYS-EXT|02247|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_02247_quoted.param" = 1024;
-- primary-target-end
