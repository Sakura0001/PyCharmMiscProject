...
-- primary_obligation_id: ASYS-EXT|05791|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_05791_nonexistent_param = DEFAULT;
-- primary-target-end
