...
-- primary_obligation_id: ASYS-EXT|03277|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_03277_nonexistent_param = DEFAULT;
-- primary-target-end
