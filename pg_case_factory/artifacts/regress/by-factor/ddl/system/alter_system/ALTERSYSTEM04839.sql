...
-- primary_obligation_id: ASYS-EXT|04839|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_04839_quoted.param" = 1024;
-- primary-target-end
