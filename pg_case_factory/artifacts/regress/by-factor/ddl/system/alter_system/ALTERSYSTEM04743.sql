...
-- primary_obligation_id: ASYS-EXT|04743|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_04743_quoted.param" = 1024;
-- primary-target-end
