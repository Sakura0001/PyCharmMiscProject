...
-- primary_obligation_id: ASYS-EXT|02495|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_02495_quoted.param" = DEFAULT;
-- primary-target-end
