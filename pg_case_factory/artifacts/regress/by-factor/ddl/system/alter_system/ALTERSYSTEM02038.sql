...
-- primary_obligation_id: ASYS-EXT|02038|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_02038_nonexistent_param = DEFAULT;
-- primary-target-end
