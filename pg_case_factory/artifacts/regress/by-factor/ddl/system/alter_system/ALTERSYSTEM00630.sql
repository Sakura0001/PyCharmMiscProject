...
-- primary_obligation_id: ASYS-EXT|00630|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_00630_nonexistent_param = 'on';
-- primary-target-end
