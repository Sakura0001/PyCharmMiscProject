...
-- primary_obligation_id: ASYS-EXT|00991|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_00991_quoted.param" = 'on';
-- primary-target-end
