...
-- primary_obligation_id: ASYS-EXT|05773|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_05773_nonexistent_param = DEFAULT;
-- primary-target-end
