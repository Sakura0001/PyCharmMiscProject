...
-- primary_obligation_id: ASYS-EXT|00781|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_00781_nonexistent_param = DEFAULT;
-- primary-target-end
