...
-- primary_obligation_id: ASYS-EXT|04821|show_command|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_04821_quoted.param" = 'alpha,beta,gamma';
-- primary-target-end
\set target_sqlstate :SQLSTATE
\echo PGCF_TARGET_SQLSTATE=:target_sqlstate
-- 4. 验证 SQLSTATE、目录状态和数据行为。
SELECT :'target_sqlstate' = '00000' AS target_sqlstate_matches_expected;
SHOW "alter_system_04821_quoted.param";
-- 5. 清理全部本编号对象。
ALTER SYSTEM RESET ALL;
