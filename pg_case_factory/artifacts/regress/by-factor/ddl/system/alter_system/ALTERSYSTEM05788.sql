...
-- primary_obligation_id: ASYS-EXT|05788|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_05788_nonexistent_param = DEFAULT;
-- primary-target-end
