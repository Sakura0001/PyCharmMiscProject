...
-- primary_obligation_id: ASYS-EXT|04485|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_04485_nonexistent_param = 'on';
-- primary-target-end
