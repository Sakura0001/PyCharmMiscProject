...
-- primary_obligation_id: ASYS-EXT|05726|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_05726_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
