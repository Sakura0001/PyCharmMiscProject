...
-- primary_obligation_id: ASYS-EXT|02487|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_02487_custom.param = DEFAULT;
-- primary-target-end
