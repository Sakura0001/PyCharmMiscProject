...
-- primary_obligation_id: ASYS-EXT|04903|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_04903_custom.param = 1024;
-- primary-target-end
