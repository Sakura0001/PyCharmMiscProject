...
-- primary_obligation_id: ASYS-EXT|05943|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_05943_custom.param = 'alpha,beta,gamma';
-- primary-target-end
