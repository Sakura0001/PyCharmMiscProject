...
-- primary_obligation_id: ASYS-EXT|03161|pg_settings_query|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_03161_custom.param = 'not_a_number';
-- primary-target-end
...
SELECT count(*) = 0 AS param_set FROM pg_catalog.pg_settings WHERE name = 'alter_system_03161_custom.param' AND source = 'configuration file' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ALTER SYSTEM RESET ALL;
