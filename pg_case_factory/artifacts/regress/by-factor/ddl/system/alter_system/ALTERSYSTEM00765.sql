...
-- primary_obligation_id: ASYS-EXT|00765|show_command|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_00765_quoted.param" = 'not_a_number';
-- primary-target-end
...
SHOW "alter_system_00765_quoted.param";
-- 5. 清理全部本编号对象。
ALTER SYSTEM RESET ALL;
