...
-- primary_obligation_id: ASYS-EXT|02303|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_02303_custom.param = 'on';
-- primary-target-end
