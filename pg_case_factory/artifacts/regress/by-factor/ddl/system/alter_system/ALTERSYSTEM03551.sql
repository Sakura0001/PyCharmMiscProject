...
-- primary_obligation_id: ASYS-EXT|03551|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_03551_custom.param = 'on';
-- primary-target-end
