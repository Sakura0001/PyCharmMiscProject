...
-- primary_obligation_id: ASYS-EXT|03238|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_03238_nonexistent_param = 'on';
-- primary-target-end
