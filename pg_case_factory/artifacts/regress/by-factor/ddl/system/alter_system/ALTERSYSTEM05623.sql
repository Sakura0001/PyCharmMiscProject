...
-- primary_obligation_id: ASYS-EXT|05623|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_05623_nonexistent_param = 'on';
-- primary-target-end
