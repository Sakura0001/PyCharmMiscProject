...
-- primary_obligation_id: ASYS-EXT|04532|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_04532_nonexistent_param = DEFAULT;
-- primary-target-end
