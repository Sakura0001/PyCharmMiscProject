...
-- primary_obligation_id: ASYS-EXT|02015|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_02015_quoted.param" = 'not_a_number';
-- primary-target-end
