...
-- primary_obligation_id: ASYS-EXT|06143|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_06143_custom.param = 'on';
-- primary-target-end
