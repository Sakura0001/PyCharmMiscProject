...
-- primary_obligation_id: ASYS-EXT|02031|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_02031_nonexistent_param = DEFAULT;
-- primary-target-end
