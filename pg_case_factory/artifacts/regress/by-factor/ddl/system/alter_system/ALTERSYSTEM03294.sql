...
-- primary_obligation_id: ASYS-EXT|03294|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_03294_nonexistent_param = DEFAULT;
-- primary-target-end
