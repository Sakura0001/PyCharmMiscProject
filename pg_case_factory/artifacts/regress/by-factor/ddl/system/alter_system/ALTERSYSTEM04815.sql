...
-- primary_obligation_id: ASYS-EXT|04815|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_04815_custom.param = '8MB';
-- primary-target-end
