...
-- primary_obligation_id: ASYS-EXT|04423|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_04423_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
