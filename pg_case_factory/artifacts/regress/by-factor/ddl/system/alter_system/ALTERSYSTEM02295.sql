...
-- primary_obligation_id: ASYS-EXT|02295|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_02295_custom.param = 'alpha,beta,gamma';
-- primary-target-end
