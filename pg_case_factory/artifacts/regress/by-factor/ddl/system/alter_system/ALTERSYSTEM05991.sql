...
-- primary_obligation_id: ASYS-EXT|05991|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_05991_quoted.param" = 1024;
-- primary-target-end
