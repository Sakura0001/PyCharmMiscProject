...
-- primary_obligation_id: ASYS-EXT|03559|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_03559_custom.param = 1024;
-- primary-target-end
