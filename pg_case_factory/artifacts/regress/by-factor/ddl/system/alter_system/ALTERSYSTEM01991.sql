...
-- primary_obligation_id: ASYS-EXT|01991|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_01991_nonexistent_param = 'on';
-- primary-target-end
