...
-- primary_obligation_id: ASYS-EXT|06279|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_06279_custom.param = DEFAULT;
-- primary-target-end
