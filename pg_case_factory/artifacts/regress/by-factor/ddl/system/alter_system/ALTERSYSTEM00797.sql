...
-- primary_obligation_id: ASYS-EXT|00797|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_00797_nonexistent_param = DEFAULT;
-- primary-target-end
