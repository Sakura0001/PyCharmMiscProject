...
-- primary_obligation_id: ASYS-EXT|02037|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_02037_nonexistent_param = DEFAULT;
-- primary-target-end
