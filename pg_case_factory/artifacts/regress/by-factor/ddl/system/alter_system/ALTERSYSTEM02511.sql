...
-- primary_obligation_id: ASYS-EXT|02511|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_02511_custom.param = DEFAULT;
-- primary-target-end
