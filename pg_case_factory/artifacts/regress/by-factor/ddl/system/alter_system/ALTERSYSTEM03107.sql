...
-- primary_obligation_id: ASYS-EXT|03107|pg_file_settings_query|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_03107_custom.param = 'not_a_number';
-- primary-target-end
...
SELECT count(*) = 0 AS param_in_file FROM pg_catalog.pg_file_settings WHERE name = 'alter_system_03107_custom.param' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ALTER SYSTEM RESET ALL;
