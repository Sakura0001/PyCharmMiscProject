...
-- primary_obligation_id: ASYS-EXT|03870|error_assertion|alter_system_reset_parameter
...
-- 2. 创建完整本地规则和因子专用夹具。
CREATE ROLE alter_system_03870_actor LOGIN NOSUPERUSER;
SET ROLE alter_system_03870_actor;
...
-- 5. 清理全部本编号对象。
RESET ROLE;
DROP ROLE IF EXISTS alter_system_03870_actor;
ALTER SYSTEM RESET shared_buffers;
