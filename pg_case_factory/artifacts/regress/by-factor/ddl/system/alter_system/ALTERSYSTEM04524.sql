...
-- primary_obligation_id: ASYS-EXT|04524|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_04524_nonexistent_param = DEFAULT;
-- primary-target-end
