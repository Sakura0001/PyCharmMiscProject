...
-- primary_obligation_id: ASYS-EXT|03287|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_03287_nonexistent_param = DEFAULT;
-- primary-target-end
