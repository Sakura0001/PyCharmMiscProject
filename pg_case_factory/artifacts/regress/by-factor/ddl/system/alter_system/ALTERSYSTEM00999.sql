...
-- primary_obligation_id: ASYS-EXT|00999|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_00999_quoted.param" = 1024;
-- primary-target-end
