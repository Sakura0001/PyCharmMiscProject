...
-- primary_obligation_id: ASYS-EXT|01047|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_01047_custom.param = 'alpha,beta,gamma';
-- primary-target-end
