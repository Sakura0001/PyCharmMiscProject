...
-- primary_obligation_id: ASYS-EXT|06175|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_06175_quoted.param" = 'on';
-- primary-target-end
