...
-- primary_obligation_id: ASYS-EXT|01983|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_01983_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
