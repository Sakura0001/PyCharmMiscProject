...
-- primary_obligation_id: ASYS-EXT|04534|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_04534_nonexistent_param = DEFAULT;
-- primary-target-end
