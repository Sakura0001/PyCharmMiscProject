...
-- primary_obligation_id: ASYS-EXT|03278|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_03278_nonexistent_param = DEFAULT;
-- primary-target-end
