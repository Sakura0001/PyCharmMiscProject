...
-- primary_obligation_id: ASYS-EXT|03575|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_03575_quoted.param" = 'alpha,beta,gamma';
-- primary-target-end
