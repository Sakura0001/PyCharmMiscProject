...
-- primary_obligation_id: ASYS-EXT|05676|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_05676_nonexistent_param = 'on';
-- primary-target-end
