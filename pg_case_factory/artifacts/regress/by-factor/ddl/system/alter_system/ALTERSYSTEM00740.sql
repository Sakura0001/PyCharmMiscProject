...
-- primary_obligation_id: ASYS-EXT|00740|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_00740_nonexistent_param = 'on';
-- primary-target-end
