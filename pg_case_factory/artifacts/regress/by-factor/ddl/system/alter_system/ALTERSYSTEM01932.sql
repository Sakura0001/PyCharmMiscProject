...
-- primary_obligation_id: ASYS-EXT|01932|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_01932_nonexistent_param = 'on';
-- primary-target-end
