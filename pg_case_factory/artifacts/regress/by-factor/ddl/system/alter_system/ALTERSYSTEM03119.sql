...
-- primary_obligation_id: ASYS-EXT|03119|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_03119_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
