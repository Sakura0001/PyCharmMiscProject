...
-- primary_obligation_id: ASYS-EXT|03229|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_03229_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
