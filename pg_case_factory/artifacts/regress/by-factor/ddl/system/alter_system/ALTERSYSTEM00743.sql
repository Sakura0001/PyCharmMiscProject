...
-- primary_obligation_id: ASYS-EXT|00743|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_00743_nonexistent_param = 'on';
-- primary-target-end
