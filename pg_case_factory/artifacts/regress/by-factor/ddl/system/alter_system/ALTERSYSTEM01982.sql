...
-- primary_obligation_id: ASYS-EXT|01982|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_01982_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
