...
-- primary_obligation_id: ASYS-EXT|01980|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_01980_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
