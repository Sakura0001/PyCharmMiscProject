...
-- primary_obligation_id: ASYS-EXT|00791|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_00791_nonexistent_param = DEFAULT;
-- primary-target-end
