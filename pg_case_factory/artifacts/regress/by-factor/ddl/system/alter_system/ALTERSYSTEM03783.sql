...
-- primary_obligation_id: ASYS-EXT|03783|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_03783_custom.param = DEFAULT;
-- primary-target-end
