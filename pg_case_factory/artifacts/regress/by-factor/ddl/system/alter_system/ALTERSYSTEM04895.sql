...
-- primary_obligation_id: ASYS-EXT|04895|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_04895_custom.param = 'on';
-- primary-target-end
