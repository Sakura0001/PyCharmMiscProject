...
-- primary_obligation_id: ASYS-EXT|05620|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_05620_nonexistent_param = 'on';
-- primary-target-end
