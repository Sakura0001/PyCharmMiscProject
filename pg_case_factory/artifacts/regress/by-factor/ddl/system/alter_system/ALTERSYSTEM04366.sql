...
-- primary_obligation_id: ASYS-EXT|04366|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_04366_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
