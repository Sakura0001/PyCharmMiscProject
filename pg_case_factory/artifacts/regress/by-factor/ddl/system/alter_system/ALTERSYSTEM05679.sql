...
-- primary_obligation_id: ASYS-EXT|05679|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_05679_nonexistent_param = 'on';
-- primary-target-end
