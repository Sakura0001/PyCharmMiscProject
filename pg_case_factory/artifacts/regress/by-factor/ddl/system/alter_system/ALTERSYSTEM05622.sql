...
-- primary_obligation_id: ASYS-EXT|05622|error_assertion|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_05622_nonexistent_param = 'on';
-- primary-target-end
