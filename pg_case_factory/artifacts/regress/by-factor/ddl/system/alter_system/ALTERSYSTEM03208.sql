...
-- primary_obligation_id: ASYS-EXT|03208|pg_settings_query|alter_system_reset_parameter
...
ALTER SYSTEM SET log_min_messages = 'not_a_number';
-- primary-target-end
