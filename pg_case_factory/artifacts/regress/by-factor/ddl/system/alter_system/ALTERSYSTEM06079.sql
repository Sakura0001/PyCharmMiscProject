...
-- primary_obligation_id: ASYS-EXT|06079|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_06079_quoted.param" = 'on';
-- primary-target-end
