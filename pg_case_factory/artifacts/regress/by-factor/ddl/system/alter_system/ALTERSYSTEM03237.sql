...
-- primary_obligation_id: ASYS-EXT|03237|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_03237_nonexistent_param = 'on';
-- primary-target-end
