...
-- primary_obligation_id: ASYS-EXT|04223|error_assertion|alter_system_reset_all
...
-- 2. 创建完整本地规则和因子专用夹具。
CREATE ROLE alter_system_04223_actor LOGIN NOSUPERUSER;
SET ROLE alter_system_04223_actor;
...
-- 5. 清理全部本编号对象。
RESET ROLE;
DROP ROLE IF EXISTS alter_system_04223_actor;
ALTER SYSTEM RESET ALL;
