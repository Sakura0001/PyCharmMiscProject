...
-- primary_obligation_id: ASYS-EXT|03767|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_03767_quoted.param" = DEFAULT;
-- primary-target-end
