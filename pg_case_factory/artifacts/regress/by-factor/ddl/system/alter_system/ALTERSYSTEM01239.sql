...
-- primary_obligation_id: ASYS-EXT|01239|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_01239_custom.param = DEFAULT;
-- primary-target-end
