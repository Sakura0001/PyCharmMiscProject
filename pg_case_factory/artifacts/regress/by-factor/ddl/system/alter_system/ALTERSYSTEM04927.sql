...
-- primary_obligation_id: ASYS-EXT|04927|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_04927_quoted.param" = 'on';
-- primary-target-end
