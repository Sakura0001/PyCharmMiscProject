...
-- primary_obligation_id: ASYS-EXT|01079|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_01079_quoted.param" = 'alpha,beta,gamma';
-- primary-target-end
