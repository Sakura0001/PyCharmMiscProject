...
-- primary_obligation_id: ASYS-EXT|04484|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_04484_nonexistent_param = 'on';
-- primary-target-end
