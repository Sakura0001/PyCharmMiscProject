...
-- primary_obligation_id: ASYS-EXT|00733|show_command|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_00733_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
