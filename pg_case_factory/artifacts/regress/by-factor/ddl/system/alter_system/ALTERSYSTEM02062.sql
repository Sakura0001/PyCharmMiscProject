...
-- primary_obligation_id: ASYS-EXT|02062|error_assertion|alter_system_reset_parameter
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
ALTER SYSTEM RESET "alter_system_02062_quoted.param";
