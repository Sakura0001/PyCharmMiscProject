...
-- primary_obligation_id: ASYS-EXT|02036|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_02036_nonexistent_param = DEFAULT;
-- primary-target-end
