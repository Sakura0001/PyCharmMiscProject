...
-- primary_obligation_id: ASYS-EXT|05780|show_command|alter_system_reset_parameter
...
ALTER SYSTEM SET alter_system_05780_nonexistent_param = DEFAULT;
-- primary-target-end
