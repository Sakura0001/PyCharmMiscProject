...
-- primary_obligation_id: ASYS-EXT|00735|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET alter_system_00735_nonexistent_param = 'alpha,beta,gamma';
-- primary-target-end
