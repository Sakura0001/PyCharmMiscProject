...
-- primary_obligation_id: ASYS-EXT|01295|error_assertion|alter_system_reset_all
...
ALTER SYSTEM SET "alter_system_01295_quoted.param" = DEFAULT;
-- primary-target-end
