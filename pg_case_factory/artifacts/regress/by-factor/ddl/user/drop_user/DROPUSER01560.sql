...
-- primary_obligation_id: DROPUSER-EXT|01560|drop_user|notice_assertion|terminate_sessions
-- expected_outcome: expected_failure
-- expected_sqlstate: 2BP01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP VIEW IF EXISTS dropuser_01560_ownv CASCADE;
DROP ROLE IF EXISTS "order";
\set ON_ERROR_STOP on
-- 2. 创建完整本地角色和因子专用夹具。
CREATE VIEW dropuser_01560_ownv AS SELECT 1 AS c;
ALTER VIEW dropuser_01560_ownv OWNER TO "order";
