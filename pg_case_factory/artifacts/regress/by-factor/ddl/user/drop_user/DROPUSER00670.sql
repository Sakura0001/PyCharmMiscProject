...
-- primary_obligation_id: DROPUSER-EXT|00670|drop_user|catalog_query|reassign_objects_then_drop
-- expected_outcome: expected_failure
-- expected_sqlstate: 2BP01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP VIEW IF EXISTS dropuser_00670_ownv CASCADE;
DROP ROLE IF EXISTS "order";
\set ON_ERROR_STOP on
-- 2. 创建完整本地角色和因子专用夹具。
CREATE VIEW dropuser_00670_ownv AS SELECT 1 AS c;
ALTER VIEW dropuser_00670_ownv OWNER TO "order";
