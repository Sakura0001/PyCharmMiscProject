...
-- primary_obligation_id: DROPUSER-EXT|00875|drop_user|notice_assertion|drop_role
-- expected_outcome: expected_failure
-- expected_sqlstate: 42501
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP ROLE IF EXISTS "order";
DROP ROLE IF EXISTS dropuser_00875_actor;
\set ON_ERROR_STOP on
-- 2. 创建完整本地角色和因子专用夹具。
CREATE ROLE dropuser_00875_actor LOGIN NOSUPERUSER NOCREATEROLE;
SET ROLE dropuser_00875_actor;
