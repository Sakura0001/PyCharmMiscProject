...
-- primary_obligation_id: AUSR-EXT|02820|error_assertion|revert_option
...
ALTER USER alteruser_02820_nosuchrole IN DATABASE pgcf SET work_mem = '4MB';
-- primary-target-end
