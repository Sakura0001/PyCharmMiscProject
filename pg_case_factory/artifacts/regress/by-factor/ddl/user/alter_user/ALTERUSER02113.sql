...
-- primary_obligation_id: AUSR-EXT|02113|error_assertion|revert_rename
...
ALTER USER alteruser_02113_nosuchrole IN DATABASE pgcf RESET ALL;
-- primary-target-end
