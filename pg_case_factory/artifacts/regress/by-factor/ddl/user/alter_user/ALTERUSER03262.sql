...
-- primary_obligation_id: AUSR-EXT|03262|config_parameter_query|reset_config
...
ALTER USER alteruser_03262_nosuchrole SET work_mem FROM CURRENT;
-- primary-target-end
