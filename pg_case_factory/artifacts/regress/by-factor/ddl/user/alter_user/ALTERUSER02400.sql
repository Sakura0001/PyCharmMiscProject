...
-- primary_obligation_id: AUSR-EXT|02400|error_assertion|revert_option
...
ALTER USER alteruser_02400_nosuchrole IN DATABASE pgcf RESET work_mem;
-- primary-target-end
