...
-- primary_obligation_id: AUSR-EXT|03252|error_assertion|revert_option
...
ALTER USER alteruser_03252_nosuchrole SET work_mem FROM CURRENT;
-- primary-target-end
