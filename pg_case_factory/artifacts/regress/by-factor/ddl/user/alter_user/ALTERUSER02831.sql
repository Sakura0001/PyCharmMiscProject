...
-- primary_obligation_id: AUSR-EXT|02831|config_parameter_query|drop_role
...
ALTER USER alteruser_02831_nosuchrole IN DATABASE pgcf SET work_mem = '4MB';
-- primary-target-end
