...
-- primary_obligation_id: AUSR-EXT|02817|config_parameter_query|revert_rename
...
ALTER USER alteruser_02817_nosuchrole IN DATABASE pgcf SET work_mem = '4MB';
-- primary-target-end
