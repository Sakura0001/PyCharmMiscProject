...
-- primary_obligation_id: AUSR-EXT|03321|config_parameter_query|revert_rename
...
ALTER USER alteruser_03321_nosuchrole IN DATABASE pgcf SET work_mem FROM CURRENT;
-- primary-target-end
