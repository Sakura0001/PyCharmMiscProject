...
-- primary_obligation_id: AUSR-EXT|02114|error_assertion|reset_config
...
ALTER USER alteruser_02114_nosuchrole IN DATABASE pgcf RESET ALL;
-- primary-target-end
