...
-- primary_obligation_id: AUSR-EXT|02834|error_assertion|reset_config
...
ALTER USER alteruser_02834_nosuchrole IN DATABASE pgcf SET work_mem = '4MB';
-- primary-target-end
