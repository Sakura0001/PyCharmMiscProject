...
-- primary_obligation_id: AUSR-EXT|03323|config_parameter_query|drop_role
...
ALTER USER alteruser_03323_nosuchrole IN DATABASE pgcf SET work_mem FROM CURRENT;
-- primary-target-end
