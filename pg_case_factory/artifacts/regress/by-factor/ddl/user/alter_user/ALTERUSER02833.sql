...
-- primary_obligation_id: AUSR-EXT|02833|error_assertion|revert_rename
...
ALTER USER alteruser_02833_nosuchrole IN DATABASE pgcf SET work_mem = '4MB';
-- primary-target-end
