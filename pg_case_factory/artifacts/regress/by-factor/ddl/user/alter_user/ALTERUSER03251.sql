...
-- primary_obligation_id: AUSR-EXT|03251|config_parameter_query|drop_role
...
ALTER USER alteruser_03251_nosuchrole SET work_mem FROM CURRENT;
-- primary-target-end
