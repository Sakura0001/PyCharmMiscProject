...
-- primary_obligation_id: AUSR-EXT|02098|config_parameter_query|reset_config
...
ALTER USER alteruser_02098_nosuchrole IN DATABASE pgcf RESET ALL;
-- primary-target-end
