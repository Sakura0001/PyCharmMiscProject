...
-- primary_obligation_id: AUSR-EXT|03324|error_assertion|revert_option
...
ALTER USER alteruser_03324_nosuchrole IN DATABASE pgcf SET work_mem FROM CURRENT;
-- primary-target-end
