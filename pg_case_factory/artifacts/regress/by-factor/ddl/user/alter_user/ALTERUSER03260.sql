...
-- primary_obligation_id: AUSR-EXT|03260|config_parameter_query|revert_option
...
ALTER USER alteruser_03260_nosuchrole SET work_mem FROM CURRENT;
-- primary-target-end
