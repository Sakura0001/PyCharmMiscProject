...
-- primary_obligation_id: AUSR-EXT|03248|config_parameter_query|revert_option
...
ALTER USER alteruser_03248_nosuchrole SET work_mem FROM CURRENT;
-- primary-target-end
