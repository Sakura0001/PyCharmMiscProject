...
-- primary_obligation_id: AUSR-EXT|01665|config_parameter_query|revert_rename
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP ROLE IF EXISTS "alteruser_01665_Mixed New";
...
ALTER USER alteruser_01665_nosuchrole RENAME TO "alteruser_01665_Mixed New";
-- primary-target-end
