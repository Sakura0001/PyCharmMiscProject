...
-- primary_obligation_id: AUSR-EXT|02385|config_parameter_query|revert_rename
...
ALTER USER alteruser_02385_nosuchrole IN DATABASE pgcf RESET work_mem;
-- primary-target-end
