...
-- primary_obligation_id: AUSR-EXT|02391|error_assertion|drop_role
...
ALTER USER alteruser_02391_nosuchrole IN DATABASE pgcf RESET work_mem;
-- primary-target-end
