...
-- primary_obligation_id: AUSR-EXT|02102|error_assertion|reset_config
...
ALTER USER alteruser_02102_nosuchrole IN DATABASE pgcf RESET ALL;
-- primary-target-end
