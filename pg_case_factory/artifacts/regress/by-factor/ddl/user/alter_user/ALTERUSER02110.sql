...
-- primary_obligation_id: AUSR-EXT|02110|config_parameter_query|reset_config
...
ALTER USER alteruser_02110_nosuchrole IN DATABASE pgcf RESET ALL;
-- primary-target-end
