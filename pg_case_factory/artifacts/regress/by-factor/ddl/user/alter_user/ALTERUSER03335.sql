...
-- primary_obligation_id: AUSR-EXT|03335|config_parameter_query|drop_role
...
ALTER USER alteruser_03335_nosuchrole IN DATABASE pgcf SET work_mem FROM CURRENT;
-- primary-target-end
