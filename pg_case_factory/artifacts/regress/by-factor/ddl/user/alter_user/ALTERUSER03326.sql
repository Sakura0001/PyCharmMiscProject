...
-- primary_obligation_id: AUSR-EXT|03326|error_assertion|reset_config
...
ALTER USER alteruser_03326_nosuchrole IN DATABASE pgcf SET work_mem FROM CURRENT;
-- primary-target-end
