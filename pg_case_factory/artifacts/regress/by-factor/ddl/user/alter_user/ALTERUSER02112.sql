...
-- primary_obligation_id: AUSR-EXT|02112|error_assertion|revert_option
...
ALTER USER alteruser_02112_nosuchrole IN DATABASE pgcf RESET ALL;
-- primary-target-end
