...
-- primary_obligation_id: AUSR-EXT|02097|config_parameter_query|revert_rename
...
ALTER USER alteruser_02097_nosuchrole IN DATABASE pgcf RESET ALL;
-- primary-target-end
