...
-- primary_obligation_id: AUSR-EXT|03266|error_assertion|reset_config
...
ALTER USER alteruser_03266_nosuchrole SET work_mem FROM CURRENT;
-- primary-target-end
