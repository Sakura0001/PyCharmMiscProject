...
-- primary_obligation_id: AUSR-EXT|03337|error_assertion|revert_rename
...
ALTER USER alteruser_03337_nosuchrole IN DATABASE pgcf SET work_mem FROM CURRENT;
-- primary-target-end
