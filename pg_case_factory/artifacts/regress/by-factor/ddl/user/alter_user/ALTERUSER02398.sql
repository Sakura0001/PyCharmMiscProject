...
-- primary_obligation_id: AUSR-EXT|02398|config_parameter_query|reset_config
...
ALTER USER alteruser_02398_nosuchrole IN DATABASE pgcf RESET work_mem;
-- primary-target-end
