...
-- primary_obligation_id: AUSR-EXT|01700|config_parameter_query|revert_option
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP ROLE IF EXISTS alteruser_01700_newrole;
...
ALTER USER alteruser_01700_nosuchrole RENAME TO alteruser_01700_newrole;
-- primary-target-end
