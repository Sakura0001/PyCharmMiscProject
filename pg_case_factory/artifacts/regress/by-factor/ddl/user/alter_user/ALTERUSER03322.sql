...
-- primary_obligation_id: AUSR-EXT|03322|config_parameter_query|reset_config
...
ALTER USER alteruser_03322_nosuchrole IN DATABASE pgcf SET work_mem FROM CURRENT;
-- primary-target-end
