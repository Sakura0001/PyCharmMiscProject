...
-- primary_obligation_id: AUSR-EXT|03249|config_parameter_query|revert_rename
...
ALTER USER alteruser_03249_nosuchrole SET work_mem FROM CURRENT;
-- primary-target-end
