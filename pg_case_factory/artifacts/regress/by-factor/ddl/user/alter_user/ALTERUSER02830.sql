...
-- primary_obligation_id: AUSR-EXT|02830|config_parameter_query|reset_config
...
ALTER USER alteruser_02830_nosuchrole IN DATABASE pgcf SET work_mem = '4MB';
-- primary-target-end
