...
-- primary_obligation_id: AUSR-EXT|02101|error_assertion|revert_rename
...
ALTER USER alteruser_02101_nosuchrole IN DATABASE pgcf RESET ALL;
-- primary-target-end
