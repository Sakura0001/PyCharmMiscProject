...
-- primary_obligation_id: AUSR-EXT|02402|error_assertion|reset_config
...
ALTER USER alteruser_02402_nosuchrole IN DATABASE pgcf RESET work_mem;
-- primary-target-end
