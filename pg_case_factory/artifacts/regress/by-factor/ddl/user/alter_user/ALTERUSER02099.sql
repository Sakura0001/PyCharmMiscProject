...
-- primary_obligation_id: AUSR-EXT|02099|config_parameter_query|drop_role
...
ALTER USER alteruser_02099_nosuchrole IN DATABASE pgcf RESET ALL;
-- primary-target-end
