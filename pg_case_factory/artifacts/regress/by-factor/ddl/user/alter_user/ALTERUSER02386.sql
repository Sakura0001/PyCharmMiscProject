...
-- primary_obligation_id: AUSR-EXT|02386|config_parameter_query|reset_config
...
ALTER USER alteruser_02386_nosuchrole IN DATABASE pgcf RESET work_mem;
-- primary-target-end
