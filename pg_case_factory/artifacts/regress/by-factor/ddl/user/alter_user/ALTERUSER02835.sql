...
-- primary_obligation_id: AUSR-EXT|02835|error_assertion|drop_role
...
ALTER USER alteruser_02835_nosuchrole IN DATABASE pgcf SET work_mem = '4MB';
-- primary-target-end
