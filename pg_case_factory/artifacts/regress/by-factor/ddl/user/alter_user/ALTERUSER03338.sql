...
-- primary_obligation_id: AUSR-EXT|03338|error_assertion|reset_config
...
ALTER USER alteruser_03338_nosuchrole IN DATABASE pgcf SET work_mem FROM CURRENT;
-- primary-target-end
