...
-- primary_obligation_id: AUSR-EXT|02387|config_parameter_query|drop_role
...
ALTER USER alteruser_02387_nosuchrole IN DATABASE pgcf RESET work_mem;
-- primary-target-end
