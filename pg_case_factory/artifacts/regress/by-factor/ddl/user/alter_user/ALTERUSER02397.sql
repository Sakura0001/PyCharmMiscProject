...
-- primary_obligation_id: AUSR-EXT|02397|config_parameter_query|revert_rename
...
ALTER USER alteruser_02397_nosuchrole IN DATABASE pgcf RESET work_mem;
-- primary-target-end
