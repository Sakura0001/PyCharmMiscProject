...
-- primary_obligation_id: AUSR-EXT|02401|error_assertion|revert_rename
...
ALTER USER alteruser_02401_nosuchrole IN DATABASE pgcf RESET work_mem;
-- primary-target-end
