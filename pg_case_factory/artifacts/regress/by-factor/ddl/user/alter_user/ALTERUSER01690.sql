...
-- primary_obligation_id: AUSR-EXT|01690|config_parameter_query|reset_config
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP ROLE IF EXISTS alteruser_01690_newrole;
...
ALTER USER alteruser_01690_nosuchrole RENAME TO alteruser_01690_newrole;
-- primary-target-end
