...
-- primary_obligation_id: AUSR-EXT|02389|error_assertion|revert_rename
...
ALTER USER alteruser_02389_nosuchrole IN DATABASE pgcf RESET work_mem;
-- primary-target-end
