...
-- primary_obligation_id: AUSR-EXT|03265|error_assertion|revert_rename
...
ALTER USER alteruser_03265_nosuchrole SET work_mem FROM CURRENT;
-- primary-target-end
