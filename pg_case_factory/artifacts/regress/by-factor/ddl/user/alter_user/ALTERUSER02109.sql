...
-- primary_obligation_id: AUSR-EXT|02109|config_parameter_query|revert_rename
...
ALTER USER alteruser_02109_nosuchrole IN DATABASE pgcf RESET ALL;
-- primary-target-end
