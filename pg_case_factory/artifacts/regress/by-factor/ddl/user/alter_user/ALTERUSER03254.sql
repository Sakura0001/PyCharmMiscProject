...
-- primary_obligation_id: AUSR-EXT|03254|error_assertion|reset_config
...
ALTER USER alteruser_03254_nosuchrole SET work_mem FROM CURRENT;
-- primary-target-end
