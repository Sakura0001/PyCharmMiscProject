...
-- primary_obligation_id: AUSR-EXT|03261|config_parameter_query|revert_rename
...
ALTER USER alteruser_03261_nosuchrole SET work_mem FROM CURRENT;
-- primary-target-end
