...
-- primary_obligation_id: AUSR-EXT|02390|error_assertion|reset_config
...
ALTER USER alteruser_02390_nosuchrole IN DATABASE pgcf RESET work_mem;
-- primary-target-end
