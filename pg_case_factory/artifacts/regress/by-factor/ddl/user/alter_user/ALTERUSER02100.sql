...
-- primary_obligation_id: AUSR-EXT|02100|error_assertion|revert_option
...
ALTER USER alteruser_02100_nosuchrole IN DATABASE pgcf RESET ALL;
-- primary-target-end
