...
-- primary_obligation_id: AUSR-EXT|03336|error_assertion|revert_option
...
ALTER USER alteruser_03336_nosuchrole IN DATABASE pgcf SET work_mem FROM CURRENT;
-- primary-target-end
