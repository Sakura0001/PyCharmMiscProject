...
-- primary_obligation_id: AUSR-EXT|02108|config_parameter_query|revert_option
...
ALTER USER alteruser_02108_nosuchrole IN DATABASE pgcf RESET ALL;
-- primary-target-end
