...
-- primary_obligation_id: AUSR-EXT|03253|error_assertion|revert_rename
...
ALTER USER alteruser_03253_nosuchrole SET work_mem FROM CURRENT;
-- primary-target-end
