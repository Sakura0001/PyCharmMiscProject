...
-- primary_obligation_id: AUSR-EXT|03339|error_assertion|drop_role
...
ALTER USER alteruser_03339_nosuchrole IN DATABASE pgcf SET work_mem FROM CURRENT;
-- primary-target-end
