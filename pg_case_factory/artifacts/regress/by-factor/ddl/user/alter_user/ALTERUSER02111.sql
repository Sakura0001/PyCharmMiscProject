...
-- primary_obligation_id: AUSR-EXT|02111|config_parameter_query|drop_role
...
ALTER USER alteruser_02111_nosuchrole IN DATABASE pgcf RESET ALL;
-- primary-target-end
