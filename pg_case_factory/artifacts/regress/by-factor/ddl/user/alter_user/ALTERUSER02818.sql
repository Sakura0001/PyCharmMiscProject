...
-- primary_obligation_id: AUSR-EXT|02818|config_parameter_query|reset_config
...
ALTER USER alteruser_02818_nosuchrole IN DATABASE pgcf SET work_mem = '4MB';
-- primary-target-end
