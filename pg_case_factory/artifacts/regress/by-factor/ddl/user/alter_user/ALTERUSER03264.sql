...
-- primary_obligation_id: AUSR-EXT|03264|error_assertion|revert_option
...
ALTER USER alteruser_03264_nosuchrole SET work_mem FROM CURRENT;
-- primary-target-end
