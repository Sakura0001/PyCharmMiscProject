...
-- primary_obligation_id: AUSR-EXT|03320|config_parameter_query|revert_option
...
ALTER USER alteruser_03320_nosuchrole IN DATABASE pgcf SET work_mem FROM CURRENT;
-- primary-target-end
