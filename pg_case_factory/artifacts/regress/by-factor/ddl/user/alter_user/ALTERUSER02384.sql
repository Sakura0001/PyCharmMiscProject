...
-- primary_obligation_id: AUSR-EXT|02384|config_parameter_query|revert_option
...
ALTER USER alteruser_02384_nosuchrole IN DATABASE pgcf RESET work_mem;
-- primary-target-end
