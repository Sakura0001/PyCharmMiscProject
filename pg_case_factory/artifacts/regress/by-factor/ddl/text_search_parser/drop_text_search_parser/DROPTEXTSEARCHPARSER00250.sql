...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHPARSER00250
...
-- primary_obligation_id: DROPTEXTSEARCHPARSER-EXT|00250|drop_text_search_parser|error_assertion|manual_dependency_cleanup
