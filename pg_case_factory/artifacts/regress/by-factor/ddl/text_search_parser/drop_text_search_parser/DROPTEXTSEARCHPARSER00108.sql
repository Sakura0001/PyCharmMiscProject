...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHPARSER00108
...
-- primary_obligation_id: DROPTEXTSEARCHPARSER-EXT|00108|drop_text_search_parser|notice_assertion|manual_dependency_cleanup
-- expected_outcome: expected_failure
-- expected_sqlstate: 2BP01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchparser_00108_config CASCADE;
...
CREATE TEXT SEARCH CONFIGURATION droptextsearchparser_00108_config (PARSER = "user");
