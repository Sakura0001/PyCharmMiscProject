...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHPARSER00043
...
-- primary_obligation_id: DROPTEXTSEARCHPARSER-EXT|00043|drop_text_search_parser|catalog_query|cascade_cleanup
-- expected_outcome: expected_failure
-- expected_sqlstate: 2BP01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchparser_00043_config CASCADE;
...
CREATE TEXT SEARCH CONFIGURATION droptextsearchparser_00043_config (PARSER = "user");
