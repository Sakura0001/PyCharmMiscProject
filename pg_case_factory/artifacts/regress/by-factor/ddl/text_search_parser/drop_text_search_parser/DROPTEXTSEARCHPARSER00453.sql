...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHPARSER00453
...
-- primary_obligation_id: DROPTEXTSEARCHPARSER-EXT|00453|drop_text_search_parser|error_assertion|cascade_cleanup
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH CONFIGURATION IF EXISTS droptextsearchparser_00453_config CASCADE;
...
CREATE TEXT SEARCH CONFIGURATION droptextsearchparser_00453_config (PARSER = "user");
