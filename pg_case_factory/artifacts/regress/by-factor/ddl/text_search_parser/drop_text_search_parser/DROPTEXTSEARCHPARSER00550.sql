...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHPARSER00550
...
-- primary_obligation_id: DROPTEXTSEARCHPARSER-EXT|00550|drop_text_search_parser|error_assertion|manual_dependency_cleanup
...
DROP TEXT SEARCH PARSER public.droptextsearchparser_00550_parser CASCADE;
-- primary-target-end
...
SELECT count(*) = 0 AS parser_absent FROM pg_catalog.pg_ts_parser WHERE prsname = 'droptextsearchparser_00550_parser' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
