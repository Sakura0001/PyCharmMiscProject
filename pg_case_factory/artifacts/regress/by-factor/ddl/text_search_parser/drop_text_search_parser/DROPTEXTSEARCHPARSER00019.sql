...
-- ++
-- --------------------------------------------------------
-- case_id: DROPTEXTSEARCHPARSER00019
...
-- primary_obligation_id: DROPTEXTSEARCHPARSER-SFV|sfv-a4871ac7f2648e29fbedec9f|drop_text_search_parser
...
DROP TEXT SEARCH PARSER droptextsearchparser_00019_parser;
-- primary-target-end
...
SELECT count(*) = 0 AS parser_absent FROM pg_catalog.pg_ts_parser WHERE prsname = 'droptextsearchparser_00019_parser' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
