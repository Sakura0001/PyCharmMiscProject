...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHPARSER00098
...
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH PARSER IF EXISTS alter_text_search_parser_00098_newparser CASCADE;
...
ALTER TEXT SEARCH PARSER alter_text_search_parser_00098_no_such_parser RENAME TO alter_text_search_parser_00098_newparser;
-- primary-target-end
