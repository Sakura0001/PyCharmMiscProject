...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERTEXTSEARCHPARSER00059
...
-- primary_obligation_id: ATSP-EXT|00059|error_assertion|drop_text_search_parser
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TEXT SEARCH PARSER IF EXISTS "alter_text_search_parser_00059_Mixed New" CASCADE;
...
ALTER TEXT SEARCH PARSER alter_text_search_parser_00059_no_such_parser RENAME TO "alter_text_search_parser_00059_Mixed New";
-- primary-target-end
