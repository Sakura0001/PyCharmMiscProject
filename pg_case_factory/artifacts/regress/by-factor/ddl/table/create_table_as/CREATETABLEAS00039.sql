...
-- primary_obligation_id: CTAS-SFV|sfv-d6fb5c4e0e52337b5b47c5ea|regular
-- expected_outcome: expected_failure
-- expected_sqlstate: 42601
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS createtableas_00039_t CASCADE;
...
CREATE TABLE createtableas_00039_t AS EXECUTE createtableas_00039_prep;
-- primary-target-end
...
SELECT count(*) AS target_created_count FROM pg_catalog.pg_class c WHERE c.relname = 'createtableas_00039_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
DROP TABLE IF EXISTS createtableas_00039_t CASCADE;
