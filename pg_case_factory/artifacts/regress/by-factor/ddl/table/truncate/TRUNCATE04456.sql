...
-- primary_obligation_id: TRUNCATE-EXT|04456|error_assertion|restart_identity_resets_sequences
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS truncate_04456_tbl, truncate_04456_ref CASCADE;
RESET ROLE;
...
TRUNCATE TABLE truncate_04456_missing RESTRICT ;
-- primary-target-end
