...
-- primary_obligation_id: TRUNCATE-EXT|02455|error_assertion|reinsert_data
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS truncate_02455_tbl, truncate_02455_ref CASCADE;
RESET ROLE;
...
TRUNCATE TABLE ONLY truncate_02455_missing ;
-- primary-target-end
