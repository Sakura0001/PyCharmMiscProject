...
-- primary_obligation_id: TRUNCATE-EXT|04294|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS truncate_04294_tbl, truncate_04294_ref CASCADE;
RESET ROLE;
...
TRUNCATE TABLE ONLY truncate_04294_missing RESTRICT ;
-- primary-target-end
