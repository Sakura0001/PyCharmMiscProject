...
-- primary_obligation_id: TRUNCATE-EXT|00791|error_assertion|reinsert_data
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS truncate_00791_tbl, truncate_00791_ref CASCADE;
RESET ROLE;
...
TRUNCATE TABLE truncate_00791_missing RESTART IDENTITY CASCADE ;
-- primary-target-end
