...
-- primary_obligation_id: TRUNCATE-EXT|04009|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS truncate_04009_tbl, truncate_04009_ref CASCADE;
RESET ROLE;
...
TRUNCATE TABLE truncate_04009_missing CONTINUE IDENTITY RESTRICT ;
-- primary-target-end
