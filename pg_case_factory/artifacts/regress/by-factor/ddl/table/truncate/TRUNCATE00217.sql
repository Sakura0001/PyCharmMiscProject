...
-- primary_obligation_id: TRUNCATE-EXT|00217|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS truncate_00217_tbl, truncate_00217_ref CASCADE;
RESET ROLE;
...
TRUNCATE TABLE truncate_00217_missing CONTINUE IDENTITY CASCADE ;
-- primary-target-end
