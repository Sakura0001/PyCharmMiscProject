...
-- primary_obligation_id: TRUNCATE-EXT|04647|error_assertion|reinsert_data
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS truncate_04647_tbl, truncate_04647_ref CASCADE;
RESET ROLE;
...
TRUNCATE TABLE truncate_04647_missing RESTART IDENTITY RESTRICT ;
-- primary-target-end
