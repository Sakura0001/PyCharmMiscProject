...
-- primary_obligation_id: TRUNCATE-EXT|00470|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS truncate_00470_tbl, truncate_00470_ref CASCADE;
RESET ROLE;
...
TRUNCATE TABLE ONLY truncate_00470_missing CASCADE ;
-- primary-target-end
