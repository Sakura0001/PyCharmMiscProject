...
-- primary_obligation_id: TRUNCATE-EXT|04297|error_assertion|rollback
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS truncate_04297_tbl, truncate_04297_ref CASCADE;
RESET ROLE;
...
TRUNCATE TABLE ONLY truncate_04297_missing RESTRICT ;
-- primary-target-end
