...
-- primary_obligation_id: TRUNCATE-EXT|02502|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS truncate_02502_tbl, truncate_02502_ref CASCADE;
RESET ROLE;
...
TRUNCATE TABLE truncate_02502_missing ;
-- primary-target-end
