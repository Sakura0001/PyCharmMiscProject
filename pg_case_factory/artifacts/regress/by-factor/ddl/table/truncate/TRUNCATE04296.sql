...
-- primary_obligation_id: TRUNCATE-EXT|04296|error_assertion|restart_identity_resets_sequences
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS truncate_04296_tbl, truncate_04296_ref CASCADE;
RESET ROLE;
...
TRUNCATE TABLE ONLY truncate_04296_missing RESTRICT ;
-- primary-target-end
