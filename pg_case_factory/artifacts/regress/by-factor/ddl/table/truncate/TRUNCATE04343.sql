...
-- primary_obligation_id: TRUNCATE-EXT|04343|error_assertion|reinsert_data
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS truncate_04343_tbl, truncate_04343_ref CASCADE;
RESET ROLE;
...
TRUNCATE TABLE truncate_04343_missing RESTRICT ;
-- primary-target-end
