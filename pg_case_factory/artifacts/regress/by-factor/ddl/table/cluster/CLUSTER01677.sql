...
-- primary_obligation_id: CLUSTER-EXT|01677|pg_stat_progress_cluster|none
...
-- 2. 创建完整本地表和因子专用夹具。
CREATE INDEX cluster_01677_i ON cluster_01677_t (id);
\set ON_ERROR_STOP off
-- 3. 执行唯一获得覆盖信用的 CLUSTER。
-- primary-target-begin
CLUSTER (VERBOSE TRUE) cluster_01677_no_such_table USING "cluster_01677_i";
-- primary-target-end
