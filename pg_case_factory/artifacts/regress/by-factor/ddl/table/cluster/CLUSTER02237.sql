...
-- primary_obligation_id: CLUSTER-EXT|02237|pg_stat_progress_cluster|none
...
-- 2. 创建完整本地表和因子专用夹具。
CREATE INDEX cluster_02237_i ON cluster_02237_t (id);
\set ON_ERROR_STOP off
-- 3. 执行唯一获得覆盖信用的 CLUSTER。
-- primary-target-begin
CLUSTER cluster_02237_no_such_table USING cluster_02237_i;
-- primary-target-end
