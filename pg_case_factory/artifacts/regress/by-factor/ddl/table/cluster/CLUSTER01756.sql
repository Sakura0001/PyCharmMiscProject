...
-- primary_obligation_id: CLUSTER-EXT|01756|pg_stat_progress_cluster|drop_objects
...
-- 2. 创建完整本地表和因子专用夹具。
CREATE INDEX cluster_01756_i ON cluster_01756_t (id);
\set ON_ERROR_STOP off
-- 3. 执行唯一获得覆盖信用的 CLUSTER。
-- primary-target-begin
CLUSTER cluster_01756_no_such_table USING "cluster_01756_i";
-- primary-target-end
