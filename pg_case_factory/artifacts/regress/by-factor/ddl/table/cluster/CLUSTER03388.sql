...
-- primary_obligation_id: CLUSTER-EXT|03388|pg_stat_progress_cluster|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42809
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS cluster_03388_t, cluster_03388_t2 CASCADE;
\set ON_ERROR_STOP on
-- 2. 创建完整本地表和因子专用夹具。
CREATE TABLE cluster_03388_t (id integer);
CREATE TABLE cluster_03388_t2 (id integer);
CREATE INDEX cluster_03388_i ON cluster_03388_t2 (id);
\set ON_ERROR_STOP off
-- 3. 执行唯一获得覆盖信用的 CLUSTER。
-- primary-target-begin
CLUSTER "cluster_03388_t" USING cluster_03388_i;
-- primary-target-end
