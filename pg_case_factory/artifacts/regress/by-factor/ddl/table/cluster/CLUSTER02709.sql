...
-- primary_obligation_id: CLUSTER-EXT|02709|pg_stat_progress_cluster|none
...
-- 2. 创建完整本地表和因子专用夹具。
CREATE INDEX cluster_02709_i ON cluster_02709_t (id);
\set ON_ERROR_STOP off
-- 3. 执行唯一获得覆盖信用的 CLUSTER。
-- primary-target-begin
CLUSTER (VERBOSE TRUE) cluster_02709_no_such_table USING cluster_02709_i;
-- primary-target-end
