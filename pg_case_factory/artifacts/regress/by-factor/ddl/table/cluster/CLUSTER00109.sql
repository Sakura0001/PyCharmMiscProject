...
-- primary_obligation_id: CLUSTER-EXT|00109|pg_stat_progress_cluster|none
-- expected_outcome: expected_failure
-- expected_sqlstate: 25001
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS cluster_00109_t CASCADE;
\set ON_ERROR_STOP on
-- 2. 创建完整本地表和因子专用夹具。
CREATE TABLE cluster_00109_t (id integer);
CREATE INDEX cluster_00109_i ON cluster_00109_t (id);
CLUSTER cluster_00109_t USING cluster_00109_i;
BEGIN;
