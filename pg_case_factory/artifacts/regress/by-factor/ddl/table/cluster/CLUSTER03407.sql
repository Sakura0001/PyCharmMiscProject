...
-- primary_obligation_id: CLUSTER-EXT|03407|error_assertion|none
-- expected_outcome: expected_failure
-- expected_sqlstate: 42809
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS cluster_03407_t, cluster_03407_t2 CASCADE;
\set ON_ERROR_STOP on
-- 2. 创建完整本地表和因子专用夹具。
CREATE TABLE cluster_03407_t (id integer);
CREATE TABLE cluster_03407_t2 (id integer);
CREATE INDEX cluster_03407_i ON cluster_03407_t2 (id);
\set ON_ERROR_STOP off
-- 3. 执行唯一获得覆盖信用的 CLUSTER。
-- primary-target-begin
CLUSTER cluster_03407_t USING cluster_03407_i;
-- primary-target-end
