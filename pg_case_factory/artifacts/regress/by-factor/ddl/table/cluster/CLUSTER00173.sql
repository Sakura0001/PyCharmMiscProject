...
-- primary_obligation_id: CLUSTER-EXT|00173|pg_stat_progress_cluster|none
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS cluster_00173_t CASCADE;
\set ON_ERROR_STOP on
-- 2. 创建完整本地表和因子专用夹具。
CREATE TABLE cluster_00173_t (id integer);
CREATE INDEX cluster_00173_i ON cluster_00173_t (id);
CLUSTER cluster_00173_t USING cluster_00173_i;
