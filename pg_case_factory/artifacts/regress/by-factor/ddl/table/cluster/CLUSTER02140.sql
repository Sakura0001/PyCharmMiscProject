...
-- primary_obligation_id: CLUSTER-EXT|02140|pg_stat_progress_cluster|drop_objects
...
-- 2. 创建完整本地表和因子专用夹具。
CREATE INDEX cluster_02140_i ON cluster_02140_t (id);
\set ON_ERROR_STOP off
-- 3. 执行唯一获得覆盖信用的 CLUSTER。
-- primary-target-begin
CLUSTER (VERBOSE FALSE) cluster_02140_no_such_table;
-- primary-target-end
