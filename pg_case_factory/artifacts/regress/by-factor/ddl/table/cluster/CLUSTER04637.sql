...
-- primary_obligation_id: CLUSTER-EXT|04637|pg_stat_progress_cluster|none
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS cluster_04637_t CASCADE;
\set ON_ERROR_STOP on
-- 2. 创建完整本地表和因子专用夹具。
CREATE TABLE cluster_04637_t (id integer);
CREATE INDEX cluster_04637_i ON cluster_04637_t (id);
-- 3. 执行唯一获得覆盖信用的 CLUSTER。
-- primary-target-begin
CLUSTER (VERBOSE TRUE) "cluster_04637_t" USING cluster_04637_i;
-- primary-target-end
