...
-- primary_obligation_id: CLUSTER-EXT|02773|pg_stat_progress_cluster|none
...
-- 2. 创建完整本地表和因子专用夹具。
CREATE INDEX cluster_02773_i ON cluster_02773_t (id);
\set ON_ERROR_STOP off
-- 3. 执行唯一获得覆盖信用的 CLUSTER。
-- primary-target-begin
CLUSTER VERBOSE cluster_02773_no_such_table;
-- primary-target-end
