...
-- primary_obligation_id: DROPSERVER-EXT|02102|drop_server|error_assertion|drop_server_cascade
...
DROP FOREIGN DATA WRAPPER IF EXISTS dropserver_02102_fdw CASCADE;
DROP OWNED BY dropserver_02102_actor;
DROP ROLE IF EXISTS dropserver_02102_actor;
\set ON_ERROR_STOP on
-- 2. 创建完整本地外部服务器和因子专用夹具。
CREATE ROLE dropserver_02102_actor LOGIN NOSUPERUSER;
CREATE FOREIGN DATA WRAPPER dropserver_02102_fdw;
CREATE SERVER "user" FOREIGN DATA WRAPPER dropserver_02102_fdw;
CREATE USER MAPPING FOR public SERVER "user";
SET ROLE dropserver_02102_actor;
