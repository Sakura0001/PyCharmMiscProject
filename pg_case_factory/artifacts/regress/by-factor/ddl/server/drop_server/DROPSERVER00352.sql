...
-- primary_obligation_id: DROPSERVER-EXT|00352|drop_server|pg_foreign_server_catalog|drop_server_cascade
...
DROP FOREIGN DATA WRAPPER IF EXISTS dropserver_00352_fdw CASCADE;
\set ON_ERROR_STOP on
-- 2. 创建完整本地外部服务器和因子专用夹具。
CREATE FOREIGN DATA WRAPPER dropserver_00352_fdw;
CREATE SERVER "user" FOREIGN DATA WRAPPER dropserver_00352_fdw;
