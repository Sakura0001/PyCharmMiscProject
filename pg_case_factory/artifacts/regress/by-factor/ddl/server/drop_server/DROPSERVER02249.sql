...
-- primary_obligation_id: DROPSERVER-EXT|02249|drop_server|pg_foreign_server_catalog|drop_user_mapping_then_drop_server
...
DROP FOREIGN DATA WRAPPER IF EXISTS dropserver_02249_fdw CASCADE;
\set ON_ERROR_STOP on
-- 2. 创建完整本地外部服务器和因子专用夹具。
CREATE FOREIGN DATA WRAPPER dropserver_02249_fdw;
CREATE SERVER "user" FOREIGN DATA WRAPPER dropserver_02249_fdw;
CREATE SERVER "order" FOREIGN DATA WRAPPER dropserver_02249_fdw;
