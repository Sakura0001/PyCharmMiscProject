...
-- primary_obligation_id: DROPSERVER-EXT|00417|drop_server|pg_foreign_server_catalog|drop_user_mapping_then_drop_server
...
DROP FOREIGN DATA WRAPPER IF EXISTS dropserver_00417_fdw CASCADE;
\set ON_ERROR_STOP on
-- 2. 创建完整本地外部服务器和因子专用夹具。
CREATE FOREIGN DATA WRAPPER dropserver_00417_fdw;
CREATE SERVER "user" FOREIGN DATA WRAPPER dropserver_00417_fdw;
