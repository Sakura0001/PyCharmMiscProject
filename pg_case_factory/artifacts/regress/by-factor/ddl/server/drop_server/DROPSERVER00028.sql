...
-- version      : 1.0
-- description  : DROP SERVER server_name_shape=reserved_word_name
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: DROPSERVER00028
...
-- primary_obligation_id: DROPSERVER-SFV|sfv-11e4c180ba8f264b094afcc2|drop_server
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP SERVER IF EXISTS "user" CASCADE;
DROP FOREIGN DATA WRAPPER IF EXISTS dropserver_00028_fdw CASCADE;
\set ON_ERROR_STOP on
-- 2. 创建完整本地外部服务器和因子专用夹具。
CREATE FOREIGN DATA WRAPPER dropserver_00028_fdw;
CREATE SERVER "user" FOREIGN DATA WRAPPER dropserver_00028_fdw;
