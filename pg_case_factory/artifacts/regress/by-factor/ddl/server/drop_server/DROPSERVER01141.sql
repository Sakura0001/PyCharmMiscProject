...
-- primary_obligation_id: DROPSERVER-EXT|01141|drop_server|pg_foreign_server_catalog|drop_user_mapping_then_drop_server
...
DROP FOREIGN DATA WRAPPER IF EXISTS dropserver_01141_fdw CASCADE;
DROP OWNED BY dropserver_01141_actor;
DROP ROLE IF EXISTS dropserver_01141_actor;
\set ON_ERROR_STOP on
-- 2. 创建完整本地外部服务器和因子专用夹具。
CREATE ROLE dropserver_01141_actor LOGIN NOSUPERUSER;
CREATE FOREIGN DATA WRAPPER dropserver_01141_fdw;
CREATE SERVER "user" FOREIGN DATA WRAPPER dropserver_01141_fdw;
CREATE USER MAPPING FOR public SERVER "user";
SET ROLE dropserver_01141_actor;
