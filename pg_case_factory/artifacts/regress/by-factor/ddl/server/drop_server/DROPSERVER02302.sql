...
-- primary_obligation_id: DROPSERVER-EXT|02302|drop_server|error_assertion|drop_server_cascade
...
DROP FOREIGN DATA WRAPPER IF EXISTS dropserver_02302_fdw CASCADE;
\set ON_ERROR_STOP on
-- 2. 创建完整本地外部服务器和因子专用夹具。
CREATE FOREIGN DATA WRAPPER dropserver_02302_fdw;
CREATE SERVER "user" FOREIGN DATA WRAPPER dropserver_02302_fdw;
CREATE SERVER "order" FOREIGN DATA WRAPPER dropserver_02302_fdw;
