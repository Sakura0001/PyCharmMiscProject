...
-- primary_obligation_id: ASRV-EXT|01494|error_assertion|drop_fdw_then_drop_server
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP SERVER IF EXISTS alterserver_01494_srv CASCADE;
DROP SERVER IF EXISTS "alterserver_01494_Mixed New" CASCADE;
...
ALTER SERVER alterserver_01494_srv RENAME TO "alterserver_01494_Mixed New";
-- primary-target-end
