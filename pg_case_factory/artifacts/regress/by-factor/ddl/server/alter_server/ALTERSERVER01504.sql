...
-- primary_obligation_id: ASRV-EXT|01504|error_assertion|drop_server
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP SERVER IF EXISTS alterserver_01504_srv CASCADE;
DROP SERVER IF EXISTS "alterserver_01504_Mixed New" CASCADE;
...
ALTER SERVER alterserver_01504_srv RENAME TO "alterserver_01504_Mixed New";
-- primary-target-end
