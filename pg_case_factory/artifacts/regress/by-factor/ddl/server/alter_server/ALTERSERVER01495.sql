...
-- primary_obligation_id: ASRV-EXT|01495|error_assertion|drop_server
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP SERVER IF EXISTS alterserver_01495_srv CASCADE;
DROP SERVER IF EXISTS "alterserver_01495_Mixed New" CASCADE;
...
ALTER SERVER alterserver_01495_srv RENAME TO "alterserver_01495_Mixed New";
-- primary-target-end
