...
-- primary_obligation_id: ASRV-EXT|01856|error_assertion|drop_user_mapping_then_drop_server
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP SERVER IF EXISTS alterserver_01856_srv CASCADE;
...
ALTER SERVER alterserver_01856_srv;
-- primary-target-end
