...
-- primary_obligation_id: ASRV-EXT|01522|error_assertion|drop_server
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP SERVER IF EXISTS alterserver_01522_srv CASCADE;
DROP SERVER IF EXISTS alterserver_01522_newsrv CASCADE;
...
ALTER SERVER alterserver_01522_srv RENAME TO alterserver_01522_newsrv;
-- primary-target-end
