...
-- primary_obligation_id: ASRV-EXT|01729|error_assertion|drop_server
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP SERVER IF EXISTS alterserver_01729_srv CASCADE;
...
ALTER SERVER alterserver_01729_srv VERSION '1.0' OPTIONS (ADD opt1 'val1', SET opt2 'val2', DROP opt3);
-- primary-target-end
