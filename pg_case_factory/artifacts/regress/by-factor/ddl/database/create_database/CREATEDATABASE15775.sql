...
-- primary_obligation_id: CD-EXT|15775|error_assertion|drop_database
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P04
-- 1. 清理本编号对象，保证脚本可重复执行。
SELECT 1 AS residual_check_no_objects;
DROP DATABASE IF EXISTS createdatabase_15775_db;
DROP ROLE IF EXISTS createdatabase_15775_actor;
\set ON_ERROR_STOP on
-- 2. 创建完整本地规则和因子专用夹具。
CREATE DATABASE createdatabase_15775_db;
CREATE ROLE createdatabase_15775_actor LOGIN NOSUPERUSER CREATEDB;
SET ROLE createdatabase_15775_actor;
