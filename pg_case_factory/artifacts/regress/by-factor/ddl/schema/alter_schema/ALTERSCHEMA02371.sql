...
-- primary_obligation_id: AS-EXT|02371|pg_namespace_catalog_query|DROP_SCHEMA
...
ALTER SCHEMA "select" RENAME TO alterschema_02371_newsch;
-- primary-target-end
