...
-- primary_obligation_id: AS-EXT|03397|pg_namespace_catalog_query|DROP_SCHEMA
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP OWNED BY alterschema_03397_newowner CASCADE;
DROP ROLE IF EXISTS alterschema_03397_newowner;
...
ALTER SCHEMA alterschema_03397_sch OWNER TO alterschema_03397_newowner;
-- primary-target-end
...
SELECT count(*) = 0 AS schema_state FROM pg_catalog.pg_namespace WHERE nspname = 'alterschema_03397_sch' ORDER BY count(*);
-- 5. 清理全部本编号对象。
DROP OWNED BY alterschema_03397_newowner CASCADE;
DROP ROLE IF EXISTS alterschema_03397_newowner;
