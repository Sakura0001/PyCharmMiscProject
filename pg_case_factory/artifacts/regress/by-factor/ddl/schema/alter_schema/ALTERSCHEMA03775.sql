...
-- primary_obligation_id: AS-EXT|03775|pg_namespace_catalog_query|DROP_SCHEMA
...
ALTER SCHEMA "select" RENAME TO alterschema_03775_newsch;
-- primary-target-end
