...
-- primary_obligation_id: AS-EXT|02364|pg_namespace_catalog_query|DROP_SCHEMA_CASCADE
...
ALTER SCHEMA "alterschema_02364_Mixed Schema" RENAME TO alterschema_02364_newsch;
-- primary-target-end
...
SELECT count(*) = 0 AS schema_state FROM pg_catalog.pg_namespace WHERE nspname = 'alterschema_02364_Mixed Schema' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
