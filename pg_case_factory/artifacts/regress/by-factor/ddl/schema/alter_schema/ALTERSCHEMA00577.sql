...
-- primary_obligation_id: AS-EXT|00577|current_schema_query|DROP_SCHEMA
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP OWNED BY alterschema_00577_newowner CASCADE;
DROP ROLE IF EXISTS alterschema_00577_newowner;
...
ALTER SCHEMA "select" OWNER TO alterschema_00577_newowner;
-- primary-target-end
