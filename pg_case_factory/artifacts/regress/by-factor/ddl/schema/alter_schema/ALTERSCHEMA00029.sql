...
-- version      : 1.0
-- description  : ALTER SCHEMA non_existent_schema=target_not_exists
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ALTERSCHEMA00029
...
-- primary_obligation_id: AS-SFV|sfv-96f44a600359610aaa7ee942|rename
...
ALTER SCHEMA alterschema_00029_sch RENAME TO alterschema_00029_newsch;
-- primary-target-end
...
SELECT count(*) = 0 AS schema_state FROM pg_catalog.pg_namespace WHERE nspname = 'alterschema_00029_sch' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
