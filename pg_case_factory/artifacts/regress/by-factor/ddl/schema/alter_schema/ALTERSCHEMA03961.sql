...
-- primary_obligation_id: AS-EXT|03961|current_schema_query|DROP_SCHEMA
...
CREATE VIEW "select".alterschema_03961_v AS SELECT 1 AS alterschema_03961_vcol;
