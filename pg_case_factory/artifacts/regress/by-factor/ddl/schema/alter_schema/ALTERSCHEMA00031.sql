...
-- primary_obligation_id: AS-SFV|sfv-b359d39c8aac5b584ac85b96|rename
...
ALTER SCHEMA alterschema_00031_sch RENAME TO alterschema_00031_newsch;
-- primary-target-end
...
SELECT count(*) = 0 AS schema_state FROM pg_catalog.pg_namespace WHERE nspname = 'alterschema_00031_sch' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
