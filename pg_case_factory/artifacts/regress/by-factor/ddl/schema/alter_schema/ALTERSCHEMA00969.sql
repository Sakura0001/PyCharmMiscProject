...
-- primary_obligation_id: AS-EXT|00969|pg_namespace_catalog_query|DROP_SCHEMA_CASCADE
...
ALTER SCHEMA "select" RENAME TO alterschema_00969_newsch;
-- primary-target-end
