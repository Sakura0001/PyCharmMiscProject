...
-- primary_obligation_id: AS-EXT|02368|current_schema_query|DROP_SCHEMA
...
ALTER SCHEMA "alterschema_02368_Mixed Schema" RENAME TO alterschema_02368_newsch;
-- primary-target-end
...
SELECT current_schema() IS DISTINCT FROM 'alterschema_02368_Mixed Schema' AS schema_absent;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
