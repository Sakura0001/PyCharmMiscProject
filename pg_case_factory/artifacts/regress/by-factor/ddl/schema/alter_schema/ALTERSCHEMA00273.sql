...
-- primary_obligation_id: AS-EXT|00273|current_schema_query|DROP_SCHEMA_CASCADE
...
ALTER SCHEMA alterschema_00273_sch OWNER TO CURRENT_ROLE;
-- primary-target-end
...
SELECT current_schema() IS DISTINCT FROM 'alterschema_00273_sch' AS schema_absent;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
