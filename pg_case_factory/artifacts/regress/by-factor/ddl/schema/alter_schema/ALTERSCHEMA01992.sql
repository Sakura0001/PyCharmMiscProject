...
-- primary_obligation_id: AS-EXT|01992|current_schema_query|DROP_SCHEMA_CASCADE
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP OWNED BY alterschema_01992_newowner CASCADE;
DROP ROLE IF EXISTS alterschema_01992_newowner;
...
ALTER SCHEMA "alterschema_01992_dotted.sch" OWNER TO alterschema_01992_newowner;
-- primary-target-end
...
SELECT current_schema() IS DISTINCT FROM 'alterschema_01992_dotted.sch' AS schema_absent;
-- 5. 清理全部本编号对象。
DROP OWNED BY alterschema_01992_newowner CASCADE;
DROP ROLE IF EXISTS alterschema_01992_newowner;
