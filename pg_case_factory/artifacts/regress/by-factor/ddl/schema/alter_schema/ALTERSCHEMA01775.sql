...
-- primary_obligation_id: AS-EXT|01775|current_schema_query|DROP_SCHEMA_IF_EXISTS
...
ALTER SCHEMA "alterschema_01775_dotted.sch" OWNER TO CURRENT_USER;
-- primary-target-end
...
SELECT current_schema() IS DISTINCT FROM 'alterschema_01775_dotted.sch' AS schema_absent;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
