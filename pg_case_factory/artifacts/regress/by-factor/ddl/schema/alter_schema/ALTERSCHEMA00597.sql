...
-- primary_obligation_id: AS-EXT|00597|current_schema_query|DROP_SCHEMA_CASCADE
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP OWNED BY alterschema_00597_newowner CASCADE;
DROP ROLE IF EXISTS alterschema_00597_newowner;
...
ALTER SCHEMA alterschema_00597_sch OWNER TO alterschema_00597_newowner;
-- primary-target-end
...
SELECT current_schema() IS DISTINCT FROM 'alterschema_00597_sch' AS schema_absent;
-- 5. 清理全部本编号对象。
DROP OWNED BY alterschema_00597_newowner CASCADE;
DROP ROLE IF EXISTS alterschema_00597_newowner;
