...
-- primary_obligation_id: AS-EXT|04102|information_schema_schemata|DROP_SCHEMA
...
CREATE VIEW "select".alterschema_04102_v AS SELECT 1 AS alterschema_04102_vcol;
