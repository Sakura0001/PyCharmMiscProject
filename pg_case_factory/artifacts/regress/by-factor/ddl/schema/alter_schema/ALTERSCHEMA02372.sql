...
-- primary_obligation_id: AS-EXT|02372|pg_namespace_catalog_query|DROP_SCHEMA_IF_EXISTS
...
ALTER SCHEMA "select" RENAME TO alterschema_02372_newsch;
-- primary-target-end
