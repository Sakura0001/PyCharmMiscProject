...
-- primary_obligation_id: AS-EXT|00992|current_schema_query|DROP_SCHEMA_IF_EXISTS
...
ALTER SCHEMA alterschema_00992_sch RENAME TO alterschema_00992_newsch;
-- primary-target-end
...
SELECT current_schema() IS DISTINCT FROM 'alterschema_00992_sch' AS schema_absent;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
