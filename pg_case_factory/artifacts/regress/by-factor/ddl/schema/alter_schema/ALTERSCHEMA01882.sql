...
-- primary_obligation_id: AS-EXT|01882|current_schema_query|DROP_SCHEMA
...
ALTER SCHEMA "alterschema_01882_dotted.sch" OWNER TO SESSION_USER;
-- primary-target-end
...
SELECT current_schema() IS DISTINCT FROM 'alterschema_01882_dotted.sch' AS schema_absent;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
