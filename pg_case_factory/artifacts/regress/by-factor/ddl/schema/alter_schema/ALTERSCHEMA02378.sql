...
-- primary_obligation_id: AS-EXT|02378|current_schema_query|DROP_SCHEMA_IF_EXISTS
...
ALTER SCHEMA "select" RENAME TO alterschema_02378_newsch;
-- primary-target-end
