...
-- primary_obligation_id: AS-EXT|00586|current_schema_query|DROP_SCHEMA
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP OWNED BY alterschema_00586_newowner CASCADE;
DROP ROLE IF EXISTS alterschema_00586_newowner;
...
ALTER SCHEMA "alterschema_00586_dotted.sch" OWNER TO alterschema_00586_newowner;
-- primary-target-end
...
SELECT current_schema() IS DISTINCT FROM 'alterschema_00586_dotted.sch' AS schema_absent;
-- 5. 清理全部本编号对象。
DROP OWNED BY alterschema_00586_newowner CASCADE;
DROP ROLE IF EXISTS alterschema_00586_newowner;
