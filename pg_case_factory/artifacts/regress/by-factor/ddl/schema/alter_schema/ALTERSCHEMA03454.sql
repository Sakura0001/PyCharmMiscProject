...
-- primary_obligation_id: AS-EXT|03454|information_schema_schemata|DROP_SCHEMA
...
CREATE VIEW "select".alterschema_03454_v AS SELECT 1 AS alterschema_03454_vcol;
\set ON_ERROR_STOP off
-- 3. 执行唯一获得覆盖信用的 ALTER SCHEMA。
-- primary-target-begin
ALTER SCHEMA "select" OWNER TO alterschema_03454_no_such_role;
-- primary-target-end
