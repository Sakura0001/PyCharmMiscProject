...
-- primary_obligation_id: AS-EXT|04107|current_schema_query|DROP_SCHEMA_CASCADE
...
CREATE VIEW "select".alterschema_04107_v AS SELECT 1 AS alterschema_04107_vcol;
