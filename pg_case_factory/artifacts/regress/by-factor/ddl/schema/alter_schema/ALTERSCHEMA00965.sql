...
-- primary_obligation_id: AS-EXT|00965|current_schema_query|DROP_SCHEMA_IF_EXISTS
...
ALTER SCHEMA "alterschema_00965_Mixed Schema" RENAME TO alterschema_00965_newsch;
-- primary-target-end
...
SELECT current_schema() IS DISTINCT FROM 'alterschema_00965_Mixed Schema' AS schema_absent;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
