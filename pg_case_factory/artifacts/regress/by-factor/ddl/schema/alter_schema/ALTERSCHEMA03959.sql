...
-- primary_obligation_id: AS-EXT|03959|information_schema_schemata|DROP_SCHEMA_IF_EXISTS
...
CREATE VIEW "select".alterschema_03959_v AS SELECT 1 AS alterschema_03959_vcol;
