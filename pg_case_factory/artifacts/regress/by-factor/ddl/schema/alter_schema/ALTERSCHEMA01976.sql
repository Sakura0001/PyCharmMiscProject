...
-- primary_obligation_id: AS-EXT|01976|pg_namespace_catalog_query|DROP_SCHEMA_IF_EXISTS
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP OWNED BY alterschema_01976_newowner CASCADE;
DROP ROLE IF EXISTS alterschema_01976_newowner;
...
ALTER SCHEMA "select" OWNER TO alterschema_01976_newowner;
-- primary-target-end
