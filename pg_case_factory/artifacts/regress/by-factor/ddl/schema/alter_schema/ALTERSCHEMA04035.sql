...
-- primary_obligation_id: AS-EXT|04035|current_schema_query|DROP_SCHEMA_CASCADE
...
CREATE VIEW "select".alterschema_04035_v AS SELECT 1 AS alterschema_04035_vcol;
