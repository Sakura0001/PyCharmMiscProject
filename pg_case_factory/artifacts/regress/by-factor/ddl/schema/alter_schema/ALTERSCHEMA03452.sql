...
-- primary_obligation_id: AS-EXT|03452|pg_namespace_catalog_query|DROP_SCHEMA_IF_EXISTS
...
CREATE VIEW "select".alterschema_03452_v AS SELECT 1 AS alterschema_03452_vcol;
\set ON_ERROR_STOP off
-- 3. 执行唯一获得覆盖信用的 ALTER SCHEMA。
-- primary-target-begin
ALTER SCHEMA "select" OWNER TO alterschema_03452_no_such_role;
-- primary-target-end
