...
-- primary_obligation_id: AS-EXT|03783|current_schema_query|DROP_SCHEMA_CASCADE
...
ALTER SCHEMA "select" RENAME TO alterschema_03783_newsch;
-- primary-target-end
