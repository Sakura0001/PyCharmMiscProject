...
-- primary_obligation_id: AS-EXT|00970|information_schema_schemata|DROP_SCHEMA
...
ALTER SCHEMA "select" RENAME TO alterschema_00970_newsch;
-- primary-target-end
