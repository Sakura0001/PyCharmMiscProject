...
-- primary_obligation_id: AS-EXT|00974|current_schema_query|DROP_SCHEMA_IF_EXISTS
...
ALTER SCHEMA "select" RENAME TO alterschema_00974_newsch;
-- primary-target-end
