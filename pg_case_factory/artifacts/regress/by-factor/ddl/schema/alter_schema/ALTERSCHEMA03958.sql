...
-- primary_obligation_id: AS-EXT|03958|information_schema_schemata|DROP_SCHEMA
...
CREATE VIEW "select".alterschema_03958_v AS SELECT 1 AS alterschema_03958_vcol;
