...
-- primary_obligation_id: AS-EXT|00651|current_schema_query|DROP_SCHEMA_CASCADE
...
ALTER SCHEMA "select" OWNER TO alterschema_00651_no_such_role;
-- primary-target-end
