...
-- primary_obligation_id: AS-EXT|03189|current_schema_query|DROP_SCHEMA_CASCADE
...
ALTER SCHEMA alterschema_03189_sch OWNER TO CURRENT_USER;
-- primary-target-end
...
SELECT current_schema() IS DISTINCT FROM 'alterschema_03189_sch' AS schema_absent;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
