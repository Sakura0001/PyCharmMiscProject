...
-- primary_obligation_id: AS-EXT|04099|pg_namespace_catalog_query|DROP_SCHEMA
...
CREATE VIEW "select".alterschema_04099_v AS SELECT 1 AS alterschema_04099_vcol;
