...
-- primary_obligation_id: AS-EXT|02389|pg_namespace_catalog_query|DROP_SCHEMA
...
ALTER SCHEMA alterschema_02389_sch RENAME TO alterschema_02389_newsch;
-- primary-target-end
...
SELECT count(*) = 0 AS schema_state FROM pg_catalog.pg_namespace WHERE nspname = 'alterschema_02389_sch' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
