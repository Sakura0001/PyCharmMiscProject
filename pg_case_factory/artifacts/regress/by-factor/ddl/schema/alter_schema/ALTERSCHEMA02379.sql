...
-- primary_obligation_id: AS-EXT|02379|current_schema_query|DROP_SCHEMA_CASCADE
...
ALTER SCHEMA "select" RENAME TO alterschema_02379_newsch;
-- primary-target-end
