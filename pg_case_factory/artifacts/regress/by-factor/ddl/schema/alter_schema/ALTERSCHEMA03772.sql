...
-- primary_obligation_id: AS-EXT|03772|current_schema_query|DROP_SCHEMA
...
ALTER SCHEMA "alterschema_03772_Mixed Schema" RENAME TO alterschema_03772_newsch;
-- primary-target-end
...
SELECT current_schema() IS DISTINCT FROM 'alterschema_03772_Mixed Schema' AS schema_absent;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
