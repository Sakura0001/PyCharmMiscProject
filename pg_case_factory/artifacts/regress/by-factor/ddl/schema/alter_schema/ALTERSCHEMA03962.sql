...
-- primary_obligation_id: AS-EXT|03962|current_schema_query|DROP_SCHEMA_IF_EXISTS
...
CREATE VIEW "select".alterschema_03962_v AS SELECT 1 AS alterschema_03962_vcol;
