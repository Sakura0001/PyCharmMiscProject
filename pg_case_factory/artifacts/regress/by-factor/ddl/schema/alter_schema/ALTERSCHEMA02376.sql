...
-- primary_obligation_id: AS-EXT|02376|information_schema_schemata|DROP_SCHEMA_CASCADE
...
ALTER SCHEMA "select" RENAME TO alterschema_02376_newsch;
-- primary-target-end
