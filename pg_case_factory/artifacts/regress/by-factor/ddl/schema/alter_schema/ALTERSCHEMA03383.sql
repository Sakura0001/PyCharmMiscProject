...
-- primary_obligation_id: AS-EXT|03383|information_schema_schemata|DROP_SCHEMA_IF_EXISTS
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP OWNED BY alterschema_03383_newowner CASCADE;
DROP ROLE IF EXISTS alterschema_03383_newowner;
...
ALTER SCHEMA "select" OWNER TO alterschema_03383_newowner;
-- primary-target-end
