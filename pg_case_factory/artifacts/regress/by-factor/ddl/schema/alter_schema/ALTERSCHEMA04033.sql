...
-- primary_obligation_id: AS-EXT|04033|current_schema_query|DROP_SCHEMA
...
CREATE VIEW "select".alterschema_04033_v AS SELECT 1 AS alterschema_04033_vcol;
