...
-- primary_obligation_id: AS-EXT|00972|information_schema_schemata|DROP_SCHEMA_CASCADE
...
ALTER SCHEMA "select" RENAME TO alterschema_00972_newsch;
-- primary-target-end
