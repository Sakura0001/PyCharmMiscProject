...
-- primary_obligation_id: AS-EXT|04105|current_schema_query|DROP_SCHEMA
...
CREATE VIEW "select".alterschema_04105_v AS SELECT 1 AS alterschema_04105_vcol;
