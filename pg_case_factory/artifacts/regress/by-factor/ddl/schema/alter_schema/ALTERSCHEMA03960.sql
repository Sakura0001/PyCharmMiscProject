...
-- primary_obligation_id: AS-EXT|03960|information_schema_schemata|DROP_SCHEMA_CASCADE
...
CREATE VIEW "select".alterschema_03960_v AS SELECT 1 AS alterschema_03960_vcol;
