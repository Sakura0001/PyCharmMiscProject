...
-- primary_obligation_id: AS-EXT|00967|pg_namespace_catalog_query|DROP_SCHEMA
...
ALTER SCHEMA "select" RENAME TO alterschema_00967_newsch;
-- primary-target-end
