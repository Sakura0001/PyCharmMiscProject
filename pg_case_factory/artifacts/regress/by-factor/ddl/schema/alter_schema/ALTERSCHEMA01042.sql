...
-- primary_obligation_id: AS-EXT|01042|information_schema_schemata|DROP_SCHEMA
-- expected_outcome: expected_failure
-- expected_sqlstate: 42939
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP SCHEMA IF EXISTS "select" CASCADE;
DROP SCHEMA IF EXISTS pg_alterschema_01042_reserved CASCADE;
...
ALTER SCHEMA "select" RENAME TO pg_alterschema_01042_reserved;
-- primary-target-end
