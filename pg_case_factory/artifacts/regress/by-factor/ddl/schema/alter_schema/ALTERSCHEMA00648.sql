...
-- primary_obligation_id: AS-EXT|00648|information_schema_schemata|DROP_SCHEMA_CASCADE
...
ALTER SCHEMA "select" OWNER TO alterschema_00648_no_such_role;
-- primary-target-end
