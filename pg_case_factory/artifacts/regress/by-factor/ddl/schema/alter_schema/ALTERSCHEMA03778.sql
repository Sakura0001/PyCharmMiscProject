...
-- primary_obligation_id: AS-EXT|03778|information_schema_schemata|DROP_SCHEMA
...
ALTER SCHEMA "select" RENAME TO alterschema_03778_newsch;
-- primary-target-end
