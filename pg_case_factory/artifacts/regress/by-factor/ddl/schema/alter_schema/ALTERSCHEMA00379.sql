...
-- primary_obligation_id: AS-EXT|00379|current_schema_query|DROP_SCHEMA
...
ALTER SCHEMA alterschema_00379_sch OWNER TO CURRENT_USER;
-- primary-target-end
...
SELECT current_schema() IS DISTINCT FROM 'alterschema_00379_sch' AS schema_absent;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
