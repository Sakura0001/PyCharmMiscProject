...
-- primary_obligation_id: AS-EXT|04100|pg_namespace_catalog_query|DROP_SCHEMA_IF_EXISTS
...
CREATE VIEW "select".alterschema_04100_v AS SELECT 1 AS alterschema_04100_vcol;
