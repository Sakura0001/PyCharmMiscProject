...
-- primary_obligation_id: AS-EXT|04030|information_schema_schemata|DROP_SCHEMA
...
CREATE VIEW "select".alterschema_04030_v AS SELECT 1 AS alterschema_04030_vcol;
