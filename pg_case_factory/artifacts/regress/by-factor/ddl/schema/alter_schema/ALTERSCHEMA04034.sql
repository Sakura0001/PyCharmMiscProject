...
-- primary_obligation_id: AS-EXT|04034|current_schema_query|DROP_SCHEMA_IF_EXISTS
...
CREATE VIEW "select".alterschema_04034_v AS SELECT 1 AS alterschema_04034_vcol;
