...
-- primary_obligation_id: AS-EXT|03957|pg_namespace_catalog_query|DROP_SCHEMA_CASCADE
...
CREATE VIEW "select".alterschema_03957_v AS SELECT 1 AS alterschema_03957_vcol;
