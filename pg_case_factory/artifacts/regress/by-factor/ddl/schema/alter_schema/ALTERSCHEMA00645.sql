...
-- primary_obligation_id: AS-EXT|00645|pg_namespace_catalog_query|DROP_SCHEMA_CASCADE
...
ALTER SCHEMA "select" OWNER TO alterschema_00645_no_such_role;
-- primary-target-end
