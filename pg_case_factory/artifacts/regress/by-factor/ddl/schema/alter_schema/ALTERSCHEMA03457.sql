...
-- primary_obligation_id: AS-EXT|03457|current_schema_query|DROP_SCHEMA
...
CREATE VIEW "select".alterschema_03457_v AS SELECT 1 AS alterschema_03457_vcol;
\set ON_ERROR_STOP off
-- 3. 执行唯一获得覆盖信用的 ALTER SCHEMA。
-- primary-target-begin
ALTER SCHEMA "select" OWNER TO alterschema_03457_no_such_role;
-- primary-target-end
