...
-- primary_obligation_id: AS-EXT|00646|information_schema_schemata|DROP_SCHEMA
...
ALTER SCHEMA "select" OWNER TO alterschema_00646_no_such_role;
-- primary-target-end
