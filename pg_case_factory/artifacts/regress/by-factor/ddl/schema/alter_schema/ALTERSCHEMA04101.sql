...
-- primary_obligation_id: AS-EXT|04101|pg_namespace_catalog_query|DROP_SCHEMA_CASCADE
...
CREATE VIEW "select".alterschema_04101_v AS SELECT 1 AS alterschema_04101_vcol;
