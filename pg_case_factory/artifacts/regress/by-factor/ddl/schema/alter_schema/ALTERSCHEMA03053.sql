...
-- primary_obligation_id: AS-EXT|03053|current_schema_query|DROP_SCHEMA_IF_EXISTS
...
ALTER SCHEMA "alterschema_03053_Mixed Schema" OWNER TO CURRENT_ROLE;
-- primary-target-end
...
SELECT current_schema() IS DISTINCT FROM 'alterschema_03053_Mixed Schema' AS schema_absent;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
