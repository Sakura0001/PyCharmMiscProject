...
-- primary_obligation_id: AS-EXT|04031|information_schema_schemata|DROP_SCHEMA_IF_EXISTS
...
CREATE VIEW "select".alterschema_04031_v AS SELECT 1 AS alterschema_04031_vcol;
