...
-- primary_obligation_id: AS-EXT|03175|information_schema_schemata|DROP_SCHEMA
...
ALTER SCHEMA "alterschema_03175_dotted.sch" OWNER TO CURRENT_USER;
-- primary-target-end
...
SELECT count(*) = 0 AS schema_state FROM information_schema.schemata WHERE schema_name = 'alterschema_03175_dotted.sch' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
