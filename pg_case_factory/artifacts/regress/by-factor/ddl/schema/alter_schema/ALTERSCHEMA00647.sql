...
-- primary_obligation_id: AS-EXT|00647|information_schema_schemata|DROP_SCHEMA_IF_EXISTS
...
ALTER SCHEMA "select" OWNER TO alterschema_00647_no_such_role;
-- primary-target-end
