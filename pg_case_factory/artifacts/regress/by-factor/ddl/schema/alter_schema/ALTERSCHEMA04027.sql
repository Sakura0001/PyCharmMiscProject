...
-- primary_obligation_id: AS-EXT|04027|pg_namespace_catalog_query|DROP_SCHEMA
...
CREATE VIEW "select".alterschema_04027_v AS SELECT 1 AS alterschema_04027_vcol;
