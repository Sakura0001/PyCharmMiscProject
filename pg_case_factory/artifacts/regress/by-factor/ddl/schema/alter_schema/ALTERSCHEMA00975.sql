...
-- primary_obligation_id: AS-EXT|00975|current_schema_query|DROP_SCHEMA_CASCADE
...
ALTER SCHEMA "select" RENAME TO alterschema_00975_newsch;
-- primary-target-end
