...
-- primary_obligation_id: AS-EXT|00980|information_schema_schemata|DROP_SCHEMA_IF_EXISTS
...
ALTER SCHEMA "alterschema_00980_dotted.sch" RENAME TO alterschema_00980_newsch;
-- primary-target-end
...
SELECT count(*) = 0 AS schema_state FROM information_schema.schemata WHERE schema_name = 'alterschema_00980_dotted.sch' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
