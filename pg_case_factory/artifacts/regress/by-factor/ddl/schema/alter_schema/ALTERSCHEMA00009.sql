...
-- version      : 1.0
-- description  : ALTER SCHEMA expected_status=failure
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ALTERSCHEMA00009
...
-- primary_obligation_id: AS-SFV|sfv-0d24c238d31ed1ed13215874|rename
...
ALTER SCHEMA alterschema_00009_sch RENAME TO alterschema_00009_newsch;
-- primary-target-end
...
SELECT count(*) = 0 AS schema_state FROM pg_catalog.pg_namespace WHERE nspname = 'alterschema_00009_sch' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
