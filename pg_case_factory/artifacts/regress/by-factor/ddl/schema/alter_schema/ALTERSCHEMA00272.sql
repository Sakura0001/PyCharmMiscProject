...
-- primary_obligation_id: AS-EXT|00272|current_schema_query|DROP_SCHEMA_IF_EXISTS
...
ALTER SCHEMA alterschema_00272_sch OWNER TO CURRENT_ROLE;
-- primary-target-end
...
SELECT current_schema() IS DISTINCT FROM 'alterschema_00272_sch' AS schema_absent;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
