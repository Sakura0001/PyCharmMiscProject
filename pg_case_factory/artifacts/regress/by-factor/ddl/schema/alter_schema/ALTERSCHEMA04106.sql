...
-- primary_obligation_id: AS-EXT|04106|current_schema_query|DROP_SCHEMA_IF_EXISTS
...
CREATE VIEW "select".alterschema_04106_v AS SELECT 1 AS alterschema_04106_vcol;
