...
-- primary_obligation_id: AS-EXT|00644|pg_namespace_catalog_query|DROP_SCHEMA_IF_EXISTS
...
ALTER SCHEMA "select" OWNER TO alterschema_00644_no_such_role;
-- primary-target-end
