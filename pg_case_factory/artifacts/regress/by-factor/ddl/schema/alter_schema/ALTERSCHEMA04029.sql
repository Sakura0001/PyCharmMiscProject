...
-- primary_obligation_id: AS-EXT|04029|pg_namespace_catalog_query|DROP_SCHEMA_CASCADE
...
CREATE VIEW "select".alterschema_04029_v AS SELECT 1 AS alterschema_04029_vcol;
