...
-- primary_obligation_id: AS-EXT|03776|pg_namespace_catalog_query|DROP_SCHEMA_IF_EXISTS
...
ALTER SCHEMA "select" RENAME TO alterschema_03776_newsch;
-- primary-target-end
