...
-- primary_obligation_id: AS-EXT|03779|information_schema_schemata|DROP_SCHEMA_IF_EXISTS
...
ALTER SCHEMA "select" RENAME TO alterschema_03779_newsch;
-- primary-target-end
