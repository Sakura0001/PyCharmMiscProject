...
-- primary_obligation_id: AS-EXT|00971|information_schema_schemata|DROP_SCHEMA_IF_EXISTS
...
ALTER SCHEMA "select" RENAME TO alterschema_00971_newsch;
-- primary-target-end
