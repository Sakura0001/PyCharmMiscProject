...
-- primary_obligation_id: AS-EXT|00570|current_schema_query|DROP_SCHEMA_CASCADE
-- expected_outcome: expected_failure
-- expected_sqlstate: 3F000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP OWNED BY alterschema_00570_newowner CASCADE;
DROP ROLE IF EXISTS alterschema_00570_newowner;
...
ALTER SCHEMA "alterschema_00570_Mixed Schema" OWNER TO alterschema_00570_newowner;
-- primary-target-end
...
SELECT current_schema() IS DISTINCT FROM 'alterschema_00570_Mixed Schema' AS schema_absent;
-- 5. 清理全部本编号对象。
DROP OWNED BY alterschema_00570_newowner CASCADE;
DROP ROLE IF EXISTS alterschema_00570_newowner;
