...
-- primary_obligation_id: AS-EXT|00968|pg_namespace_catalog_query|DROP_SCHEMA_IF_EXISTS
...
ALTER SCHEMA "select" RENAME TO alterschema_00968_newsch;
-- primary-target-end
