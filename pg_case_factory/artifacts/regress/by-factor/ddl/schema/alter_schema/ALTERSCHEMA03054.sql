...
-- primary_obligation_id: AS-EXT|03054|current_schema_query|DROP_SCHEMA_CASCADE
...
ALTER SCHEMA "alterschema_03054_Mixed Schema" OWNER TO CURRENT_ROLE;
-- primary-target-end
...
SELECT current_schema() IS DISTINCT FROM 'alterschema_03054_Mixed Schema' AS schema_absent;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
