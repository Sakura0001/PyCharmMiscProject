...
-- primary_obligation_id: AS-EXT|02392|information_schema_schemata|DROP_SCHEMA
...
ALTER SCHEMA alterschema_02392_sch RENAME TO alterschema_02392_newsch;
-- primary-target-end
...
SELECT count(*) = 0 AS schema_state FROM information_schema.schemata WHERE schema_name = 'alterschema_02392_sch' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
