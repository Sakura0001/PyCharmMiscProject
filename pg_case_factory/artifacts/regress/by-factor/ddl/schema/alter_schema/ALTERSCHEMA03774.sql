...
-- primary_obligation_id: AS-EXT|03774|current_schema_query|DROP_SCHEMA_CASCADE
...
ALTER SCHEMA "alterschema_03774_Mixed Schema" RENAME TO alterschema_03774_newsch;
-- primary-target-end
...
SELECT current_schema() IS DISTINCT FROM 'alterschema_03774_Mixed Schema' AS schema_absent;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
