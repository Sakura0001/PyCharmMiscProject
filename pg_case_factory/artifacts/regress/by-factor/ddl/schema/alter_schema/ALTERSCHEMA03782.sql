...
-- primary_obligation_id: AS-EXT|03782|current_schema_query|DROP_SCHEMA_IF_EXISTS
...
ALTER SCHEMA "select" RENAME TO alterschema_03782_newsch;
-- primary-target-end
