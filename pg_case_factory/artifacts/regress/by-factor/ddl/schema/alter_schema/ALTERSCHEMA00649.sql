...
-- primary_obligation_id: AS-EXT|00649|current_schema_query|DROP_SCHEMA
...
ALTER SCHEMA "select" OWNER TO alterschema_00649_no_such_role;
-- primary-target-end
