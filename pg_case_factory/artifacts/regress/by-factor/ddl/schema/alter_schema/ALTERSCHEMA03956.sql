...
-- primary_obligation_id: AS-EXT|03956|pg_namespace_catalog_query|DROP_SCHEMA_IF_EXISTS
...
CREATE VIEW "select".alterschema_03956_v AS SELECT 1 AS alterschema_03956_vcol;
