...
-- primary_obligation_id: AS-EXT|03459|current_schema_query|DROP_SCHEMA_CASCADE
...
CREATE VIEW "select".alterschema_03459_v AS SELECT 1 AS alterschema_03459_vcol;
\set ON_ERROR_STOP off
-- 3. 执行唯一获得覆盖信用的 ALTER SCHEMA。
-- primary-target-begin
ALTER SCHEMA "select" OWNER TO alterschema_03459_no_such_role;
-- primary-target-end
