...
-- primary_obligation_id: AS-EXT|02373|pg_namespace_catalog_query|DROP_SCHEMA_CASCADE
...
ALTER SCHEMA "select" RENAME TO alterschema_02373_newsch;
-- primary-target-end
