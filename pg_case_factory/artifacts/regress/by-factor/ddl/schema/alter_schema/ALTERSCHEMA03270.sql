...
-- primary_obligation_id: AS-EXT|03270|current_schema_query|DROP_SCHEMA_CASCADE
...
ALTER SCHEMA "alterschema_03270_Mixed Schema" OWNER TO SESSION_USER;
-- primary-target-end
...
SELECT current_schema() IS DISTINCT FROM 'alterschema_03270_Mixed Schema' AS schema_absent;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
