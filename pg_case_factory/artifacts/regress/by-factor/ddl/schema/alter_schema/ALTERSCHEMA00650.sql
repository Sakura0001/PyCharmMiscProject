...
-- primary_obligation_id: AS-EXT|00650|current_schema_query|DROP_SCHEMA_IF_EXISTS
...
ALTER SCHEMA "select" OWNER TO alterschema_00650_no_such_role;
-- primary-target-end
