...
-- primary_obligation_id: AS-EXT|04104|information_schema_schemata|DROP_SCHEMA_CASCADE
...
CREATE VIEW "select".alterschema_04104_v AS SELECT 1 AS alterschema_04104_vcol;
