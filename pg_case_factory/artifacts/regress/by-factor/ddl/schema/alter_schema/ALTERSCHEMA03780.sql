...
-- primary_obligation_id: AS-EXT|03780|information_schema_schemata|DROP_SCHEMA_CASCADE
...
ALTER SCHEMA "select" RENAME TO alterschema_03780_newsch;
-- primary-target-end
