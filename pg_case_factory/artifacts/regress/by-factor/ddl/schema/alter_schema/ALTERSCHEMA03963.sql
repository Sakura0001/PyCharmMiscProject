...
-- primary_obligation_id: AS-EXT|03963|current_schema_query|DROP_SCHEMA_CASCADE
...
CREATE VIEW "select".alterschema_03963_v AS SELECT 1 AS alterschema_03963_vcol;
