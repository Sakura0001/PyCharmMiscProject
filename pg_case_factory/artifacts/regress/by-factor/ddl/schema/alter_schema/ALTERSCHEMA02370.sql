...
-- primary_obligation_id: AS-EXT|02370|current_schema_query|DROP_SCHEMA_CASCADE
...
ALTER SCHEMA "alterschema_02370_Mixed Schema" RENAME TO alterschema_02370_newsch;
-- primary-target-end
...
SELECT current_schema() IS DISTINCT FROM 'alterschema_02370_Mixed Schema' AS schema_absent;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
