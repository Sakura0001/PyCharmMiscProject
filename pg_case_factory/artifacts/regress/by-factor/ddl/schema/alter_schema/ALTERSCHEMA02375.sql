...
-- primary_obligation_id: AS-EXT|02375|information_schema_schemata|DROP_SCHEMA_IF_EXISTS
...
ALTER SCHEMA "select" RENAME TO alterschema_02375_newsch;
-- primary-target-end
