...
-- primary_obligation_id: AS-EXT|00486|information_schema_schemata|DROP_SCHEMA_CASCADE
...
ALTER SCHEMA alterschema_00486_sch OWNER TO SESSION_USER;
-- primary-target-end
...
SELECT count(*) = 0 AS schema_state FROM information_schema.schemata WHERE schema_name = 'alterschema_00486_sch' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
