...
-- primary_obligation_id: AS-EXT|01644|pg_namespace_catalog_query|DROP_SCHEMA_CASCADE
...
ALTER SCHEMA "alterschema_01644_Mixed Schema" OWNER TO CURRENT_ROLE;
-- primary-target-end
...
SELECT count(*) = 0 AS schema_state FROM pg_catalog.pg_namespace WHERE nspname = 'alterschema_01644_Mixed Schema' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
