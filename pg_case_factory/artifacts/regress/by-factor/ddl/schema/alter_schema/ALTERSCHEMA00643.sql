...
-- primary_obligation_id: AS-EXT|00643|pg_namespace_catalog_query|DROP_SCHEMA
...
ALTER SCHEMA "select" OWNER TO alterschema_00643_no_such_role;
-- primary-target-end
