...
-- primary_obligation_id: AS-EXT|03955|pg_namespace_catalog_query|DROP_SCHEMA
...
CREATE VIEW "select".alterschema_03955_v AS SELECT 1 AS alterschema_03955_vcol;
