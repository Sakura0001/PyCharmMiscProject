...
-- primary_obligation_id: AS-EXT|04028|pg_namespace_catalog_query|DROP_SCHEMA_IF_EXISTS
...
CREATE VIEW "select".alterschema_04028_v AS SELECT 1 AS alterschema_04028_vcol;
