...
-- primary_obligation_id: AS-EXT|02374|information_schema_schemata|DROP_SCHEMA
...
ALTER SCHEMA "select" RENAME TO alterschema_02374_newsch;
-- primary-target-end
