...
-- primary_obligation_id: AS-EXT|00475|information_schema_schemata|DROP_SCHEMA
...
ALTER SCHEMA "alterschema_00475_dotted.sch" OWNER TO SESSION_USER;
-- primary-target-end
...
SELECT count(*) = 0 AS schema_state FROM information_schema.schemata WHERE schema_name = 'alterschema_00475_dotted.sch' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
