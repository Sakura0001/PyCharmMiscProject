...
-- primary_obligation_id: AS-EXT|03282|pg_namespace_catalog_query|DROP_SCHEMA_CASCADE
...
ALTER SCHEMA "alterschema_03282_dotted.sch" OWNER TO SESSION_USER;
-- primary-target-end
...
SELECT count(*) = 0 AS schema_state FROM pg_catalog.pg_namespace WHERE nspname = 'alterschema_03282_dotted.sch' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
