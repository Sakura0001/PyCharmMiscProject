...
-- primary_obligation_id: CSCHEMA-EXT|07316|current_schema_query|DROP_SCHEMA_CASCADE
-- expected_outcome: expected_failure
-- expected_sqlstate: 42710
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP SCHEMA IF EXISTS createschema_07316_s CASCADE;
DROP OWNED BY createschema_07316_owner CASCADE;
DROP ROLE IF EXISTS createschema_07316_owner;
\set ON_ERROR_STOP on
-- 2. 创建完整本地规则和因子专用夹具。
CREATE ROLE createschema_07316_owner LOGIN;
CREATE SCHEMA createschema_07316_s;
...
-- 5. 清理全部本编号对象。
DROP SCHEMA createschema_07316_s CASCADE;
DROP OWNED BY createschema_07316_owner CASCADE;
DROP ROLE IF EXISTS createschema_07316_owner;
