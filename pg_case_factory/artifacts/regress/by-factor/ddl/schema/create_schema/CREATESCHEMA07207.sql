...
-- primary_obligation_id: CSCHEMA-EXT|07207|current_schema_query|DROP_SCHEMA_IF_EXISTS
-- expected_outcome: expected_failure
-- expected_sqlstate: 42710
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP SCHEMA IF EXISTS createschema_07207_s CASCADE;
DROP OWNED BY createschema_07207_owner CASCADE;
DROP ROLE IF EXISTS createschema_07207_owner;
\set ON_ERROR_STOP on
-- 2. 创建完整本地规则和因子专用夹具。
CREATE ROLE createschema_07207_owner LOGIN;
CREATE SCHEMA createschema_07207_s;
