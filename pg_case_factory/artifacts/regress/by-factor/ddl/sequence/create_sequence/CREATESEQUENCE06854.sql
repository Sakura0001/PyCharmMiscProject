...
-- primary_obligation_id: CSQ-EXT|06854|nextval_call|DROP_SEQUENCE|ownership
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP SEQUENCE IF EXISTS createsequence_06854_seq CASCADE;
RESET ROLE;
...
CREATE TEMP SEQUENCE createsequence_06854_seq OWNED BY createsequence_06854_tbl.id;
-- primary-target-end
...
-- 5. 清理全部本编号对象。
DROP SEQUENCE createsequence_06854_seq CASCADE;
