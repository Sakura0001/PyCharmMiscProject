...
-- primary_obligation_id: CSQ-EXT|06780|nextval_call|DROP_SEQUENCE_IF_EXISTS|ownership
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP SEQUENCE IF EXISTS createsequence_06780_seq CASCADE;
RESET ROLE;
...
CREATE SEQUENCE createsequence_06780_seq OWNED BY createsequence_06780_tbl.id;
-- primary-target-end
