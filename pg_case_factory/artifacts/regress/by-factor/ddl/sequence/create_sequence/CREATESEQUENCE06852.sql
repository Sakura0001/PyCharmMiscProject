...
-- primary_obligation_id: CSQ-EXT|06852|nextval_call|DROP_SEQUENCE_IF_EXISTS|ownership
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP SEQUENCE IF EXISTS createsequence_06852_seq CASCADE;
RESET ROLE;
...
CREATE TEMP SEQUENCE createsequence_06852_seq OWNED BY createsequence_06852_tbl.id;
-- primary-target-end
