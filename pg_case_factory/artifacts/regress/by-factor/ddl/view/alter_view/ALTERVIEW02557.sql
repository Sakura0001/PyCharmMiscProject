...
-- primary_obligation_id: AVIEW-EXT|02557|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_02557_nosuchview ALTER alterview_02557_col DROP DEFAULT;
-- primary-target-end
