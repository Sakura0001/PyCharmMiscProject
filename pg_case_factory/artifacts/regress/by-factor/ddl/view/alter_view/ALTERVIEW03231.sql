...
-- primary_obligation_id: AVIEW-EXT|03231|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_03231_nosuchview RENAME alterview_03231_col TO alterview_03231_newcol;
-- primary-target-end
