...
-- primary_obligation_id: AVIEW-EXT|06444|error_assertion|drop_view_if_exists
...
ALTER VIEW alterview_06444_nosuchview RESET (security_invoker);
-- primary-target-end
