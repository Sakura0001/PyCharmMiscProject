...
-- primary_obligation_id: AVIEW-EXT|04508|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_04508_nosuchview RESET (security_invoker);
-- primary-target-end
