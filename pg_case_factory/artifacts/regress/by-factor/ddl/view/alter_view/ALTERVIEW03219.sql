...
-- primary_obligation_id: AVIEW-EXT|03219|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_03219_nosuchview RENAME alterview_03219_col TO alterview_03219_newcol;
-- primary-target-end
