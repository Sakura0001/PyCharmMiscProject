...
-- primary_obligation_id: AVIEW-EXT|08297|pg_views_query|revert_alter
...
ALTER VIEW alterview_08297_nosuchview ALTER alterview_08297_col SET DEFAULT 1;
-- primary-target-end
...
SELECT count(*) = 0 AS view_state FROM pg_catalog.pg_views WHERE viewname = 'alterview_08297_nosuchview' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
