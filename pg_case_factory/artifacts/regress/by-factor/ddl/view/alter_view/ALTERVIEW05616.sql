...
-- primary_obligation_id: AVIEW-EXT|05616|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_05616_nosuchview SET (check_option = cascaded);
-- primary-target-end
