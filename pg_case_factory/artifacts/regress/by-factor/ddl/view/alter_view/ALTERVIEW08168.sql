...
-- primary_obligation_id: AVIEW-EXT|08168|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_08168_nosuchview ALTER alterview_08168_col SET DEFAULT 1;
-- primary-target-end
