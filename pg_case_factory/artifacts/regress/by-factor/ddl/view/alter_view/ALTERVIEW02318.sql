...
-- primary_obligation_id: AVIEW-EXT|02318|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_02318_nosuchview SET SCHEMA alterview_02318_nosuchschema;
-- primary-target-end
