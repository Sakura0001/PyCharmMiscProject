...
-- primary_obligation_id: AVIEW-EXT|07238|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_07238_nosuchview ALTER COLUMN alterview_07238_col DROP DEFAULT;
-- primary-target-end
