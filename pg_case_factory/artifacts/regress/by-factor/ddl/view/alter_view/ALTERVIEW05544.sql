...
-- primary_obligation_id: AVIEW-EXT|05544|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_05544_nosuchview SET (check_option = local, security_barrier = true);
-- primary-target-end
