...
-- primary_obligation_id: AVIEW-EXT|03459|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_03459_nosuchview RENAME TO "alterview_03459_newview";
-- primary-target-end
