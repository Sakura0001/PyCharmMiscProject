...
-- primary_obligation_id: AVIEW-EXT|06412|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06412_nosuchview RESET (security_barrier);
-- primary-target-end
