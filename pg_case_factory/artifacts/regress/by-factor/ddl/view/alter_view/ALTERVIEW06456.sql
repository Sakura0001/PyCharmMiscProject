...
-- primary_obligation_id: AVIEW-EXT|06456|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_06456_nosuchview RESET (security_invoker);
-- primary-target-end
