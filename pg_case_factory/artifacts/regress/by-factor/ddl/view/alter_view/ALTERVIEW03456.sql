...
-- primary_obligation_id: AVIEW-EXT|03456|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_03456_nosuchview RENAME TO "alterview_03456_newview";
-- primary-target-end
