...
-- primary_obligation_id: AVIEW-EXT|04612|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_04612_nosuchview RESET (security_invoker);
-- primary-target-end
