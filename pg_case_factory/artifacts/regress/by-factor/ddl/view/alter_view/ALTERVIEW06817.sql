...
-- primary_obligation_id: AVIEW-EXT|06817|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06817_nosuchview SET (security_invoker = true);
-- primary-target-end
