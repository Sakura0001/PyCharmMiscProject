...
-- primary_obligation_id: AVIEW-EXT|05707|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05707_nosuchview SET (security_invoker = true);
-- primary-target-end
