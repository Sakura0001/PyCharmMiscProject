...
-- primary_obligation_id: AVIEW-EXT|07911|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_07911_nosuchview ALTER alterview_07911_col DROP DEFAULT;
-- primary-target-end
