...
-- primary_obligation_id: AVIEW-EXT|07553|select_from_view|revert_alter
...
ALTER VIEW alterview_07553_nosuchview ALTER COLUMN alterview_07553_col DROP DEFAULT;
-- primary-target-end
