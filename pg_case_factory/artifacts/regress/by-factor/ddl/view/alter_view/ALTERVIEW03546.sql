...
-- primary_obligation_id: AVIEW-EXT|03546|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_03546_nosuchview RENAME TO alterview_03546_newview;
-- primary-target-end
