...
-- primary_obligation_id: AVIEW-EXT|05691|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_05691_nosuchview SET (security_invoker = false);
-- primary-target-end
