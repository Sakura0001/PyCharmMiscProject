...
-- primary_obligation_id: AVIEW-EXT|05680|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05680_nosuchview SET (security_barrier = true);
-- primary-target-end
