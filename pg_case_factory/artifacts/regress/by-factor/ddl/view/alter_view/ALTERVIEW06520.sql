...
-- primary_obligation_id: AVIEW-EXT|06520|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06520_nosuchview RESET (security_barrier);
-- primary-target-end
