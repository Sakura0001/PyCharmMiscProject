...
-- primary_obligation_id: AVIEW-EXT|05605|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05605_nosuchview SET (security_invoker = true);
-- primary-target-end
