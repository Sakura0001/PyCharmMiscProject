...
-- primary_obligation_id: AVIEW-EXT|03533|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_03533_nosuchview RENAME TO alterview_03533_newview;
-- primary-target-end
