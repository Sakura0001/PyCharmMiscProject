...
-- primary_obligation_id: AVIEW-EXT|06866|error_assertion|revert_alter
...
ALTER VIEW alterview_06866_nosuchview SET (check_option = local, security_barrier = true);
-- primary-target-end
