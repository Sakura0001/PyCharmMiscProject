...
-- primary_obligation_id: AVIEW-EXT|04596|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_04596_nosuchview RESET (security_barrier);
-- primary-target-end
