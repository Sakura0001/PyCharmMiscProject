...
-- primary_obligation_id: AVIEW-EXT|06836|error_assertion|revert_alter
...
ALTER VIEW alterview_06836_nosuchview SET (check_option = cascaded);
-- primary-target-end
