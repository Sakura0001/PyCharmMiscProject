...
-- primary_obligation_id: AVIEW-EXT|07915|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_07915_nosuchview ALTER alterview_07915_col DROP DEFAULT;
-- primary-target-end
