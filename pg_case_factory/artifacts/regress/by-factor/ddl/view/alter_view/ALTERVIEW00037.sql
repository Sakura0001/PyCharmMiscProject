...
-- primary_obligation_id: AVIEW-SFV|sfv-f99ff382ebc3893b06c71288|set_option
...
ALTER VIEW alterview_00037_nosuchview SET (check_option = local);
-- primary-target-end
...
SELECT count(*) = 0 AS view_state FROM pg_catalog.pg_class WHERE relname = 'alterview_00037_nosuchview' AND relkind = 'v' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
