...
-- primary_obligation_id: AVIEW-EXT|02559|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_02559_nosuchview ALTER alterview_02559_col DROP DEFAULT;
-- primary-target-end
