...
-- primary_obligation_id: AVIEW-EXT|03535|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_03535_nosuchview RENAME TO alterview_03535_newview;
-- primary-target-end
