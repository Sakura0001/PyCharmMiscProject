...
-- primary_obligation_id: AVIEW-EXT|06457|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06457_nosuchview RESET (security_invoker);
-- primary-target-end
