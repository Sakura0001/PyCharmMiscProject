...
-- primary_obligation_id: AVIEW-EXT|03009|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_03009_nosuchview OWNER TO CURRENT_USER;
-- primary-target-end
