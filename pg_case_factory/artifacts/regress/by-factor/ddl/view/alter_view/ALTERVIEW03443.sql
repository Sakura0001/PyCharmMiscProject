...
-- primary_obligation_id: AVIEW-EXT|03443|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_03443_nosuchview RENAME TO "alterview_03443_newview";
-- primary-target-end
