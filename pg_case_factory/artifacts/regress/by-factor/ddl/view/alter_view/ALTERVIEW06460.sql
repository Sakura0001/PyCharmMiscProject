...
-- primary_obligation_id: AVIEW-EXT|06460|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06460_nosuchview RESET (security_invoker);
-- primary-target-end
