...
-- primary_obligation_id: AVIEW-EXT|06373|pg_class_query|drop_view_cascade
...
ALTER VIEW alterview_06373_nosuchview RESET (check_option);
-- primary-target-end
...
SELECT count(*) = 0 AS view_state FROM pg_catalog.pg_class WHERE relname = 'alterview_06373_nosuchview' AND relkind = 'v' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
