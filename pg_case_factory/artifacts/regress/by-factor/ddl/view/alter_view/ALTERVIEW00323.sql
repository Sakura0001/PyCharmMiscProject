...
-- primary_obligation_id: AVIEW-EXT|00323|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_00323_nosuchview ALTER "alterview_00323_col" DROP DEFAULT;
-- primary-target-end
