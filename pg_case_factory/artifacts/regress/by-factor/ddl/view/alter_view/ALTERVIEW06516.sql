...
-- primary_obligation_id: AVIEW-EXT|06516|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_06516_nosuchview RESET (security_barrier);
-- primary-target-end
