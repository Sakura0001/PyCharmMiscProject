...
-- primary_obligation_id: AVIEW-EXT|04570|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_04570_nosuchview RESET (check_option, security_barrier);
-- primary-target-end
