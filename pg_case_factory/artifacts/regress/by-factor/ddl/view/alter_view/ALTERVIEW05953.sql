...
-- primary_obligation_id: AVIEW-EXT|05953|pg_class_query|drop_view_cascade
...
ALTER VIEW alterview_05953_nosuchview OWNER TO CURRENT_USER;
-- primary-target-end
...
SELECT count(*) = 0 AS view_state FROM pg_catalog.pg_class WHERE relname = 'alterview_05953_nosuchview' AND relkind = 'v' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
