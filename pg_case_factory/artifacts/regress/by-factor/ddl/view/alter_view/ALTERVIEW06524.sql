...
-- primary_obligation_id: AVIEW-EXT|06524|pg_class_query|revert_alter
...
ALTER VIEW alterview_06524_nosuchview RESET (security_barrier);
-- primary-target-end
...
SELECT count(*) = 0 AS view_state FROM pg_catalog.pg_class WHERE relname = 'alterview_06524_nosuchview' AND relkind = 'v' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
