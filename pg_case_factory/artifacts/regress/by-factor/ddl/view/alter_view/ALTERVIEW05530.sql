...
-- primary_obligation_id: AVIEW-EXT|05530|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05530_nosuchview SET (check_option = local);
-- primary-target-end
