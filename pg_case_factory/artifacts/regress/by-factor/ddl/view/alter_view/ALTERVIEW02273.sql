...
-- primary_obligation_id: AVIEW-EXT|02273|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_02273_nosuchview SET SCHEMA pg_catalog;
-- primary-target-end
