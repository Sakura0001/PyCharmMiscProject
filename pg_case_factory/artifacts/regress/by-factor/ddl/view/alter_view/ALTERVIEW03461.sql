...
-- primary_obligation_id: AVIEW-EXT|03461|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_03461_nosuchview RENAME TO "alterview_03461_newview";
-- primary-target-end
