...
-- primary_obligation_id: AVIEW-EXT|05590|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05590_nosuchview SET (security_invoker = false);
-- primary-target-end
