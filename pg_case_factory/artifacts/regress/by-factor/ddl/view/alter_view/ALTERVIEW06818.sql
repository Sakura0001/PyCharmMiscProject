...
-- primary_obligation_id: AVIEW-EXT|06818|select_from_view|revert_alter
...
ALTER VIEW alterview_06818_nosuchview SET (security_invoker = true);
-- primary-target-end
