...
-- primary_obligation_id: AVIEW-EXT|03460|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_03460_nosuchview RENAME TO "alterview_03460_newview";
-- primary-target-end
