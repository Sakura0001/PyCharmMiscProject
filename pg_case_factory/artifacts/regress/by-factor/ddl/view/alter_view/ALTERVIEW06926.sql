...
-- primary_obligation_id: AVIEW-EXT|06926|error_assertion|revert_alter
...
ALTER VIEW alterview_06926_nosuchview SET (security_invoker = true);
-- primary-target-end
