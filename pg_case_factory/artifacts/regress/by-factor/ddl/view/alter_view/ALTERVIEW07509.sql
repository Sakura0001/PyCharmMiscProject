...
-- primary_obligation_id: AVIEW-EXT|07509|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_07509_nosuchview ALTER COLUMN alterview_07509_col SET DEFAULT 1;
-- primary-target-end
