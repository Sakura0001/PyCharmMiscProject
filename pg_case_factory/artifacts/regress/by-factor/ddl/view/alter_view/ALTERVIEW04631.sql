...
-- primary_obligation_id: AVIEW-EXT|04631|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_04631_nosuchview RESET (security_invoker);
-- primary-target-end
