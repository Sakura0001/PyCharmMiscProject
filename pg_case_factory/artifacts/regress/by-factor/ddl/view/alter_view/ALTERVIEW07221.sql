...
-- primary_obligation_id: AVIEW-EXT|07221|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_07221_nosuchview ALTER COLUMN alterview_07221_col DROP DEFAULT;
-- primary-target-end
