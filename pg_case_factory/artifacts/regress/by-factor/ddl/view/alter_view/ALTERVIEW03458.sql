...
-- primary_obligation_id: AVIEW-EXT|03458|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_03458_nosuchview RENAME TO "alterview_03458_newview";
-- primary-target-end
