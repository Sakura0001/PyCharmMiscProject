...
-- primary_obligation_id: AVIEW-EXT|06502|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06502_nosuchview RESET (check_option, security_barrier);
-- primary-target-end
