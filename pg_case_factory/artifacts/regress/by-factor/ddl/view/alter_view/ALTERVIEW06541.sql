...
-- primary_obligation_id: AVIEW-EXT|06541|pg_views_query|drop_view_cascade
...
ALTER VIEW alterview_06541_nosuchview RESET (security_invoker);
-- primary-target-end
...
SELECT count(*) = 0 AS view_state FROM pg_catalog.pg_views WHERE viewname = 'alterview_06541_nosuchview' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
