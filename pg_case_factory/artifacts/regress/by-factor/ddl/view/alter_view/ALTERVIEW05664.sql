...
-- primary_obligation_id: AVIEW-EXT|05664|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_05664_nosuchview SET (security_barrier = false);
-- primary-target-end
