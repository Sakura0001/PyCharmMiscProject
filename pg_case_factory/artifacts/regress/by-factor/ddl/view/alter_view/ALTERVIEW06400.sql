...
-- primary_obligation_id: AVIEW-EXT|06400|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06400_nosuchview RESET (check_option, security_barrier);
-- primary-target-end
