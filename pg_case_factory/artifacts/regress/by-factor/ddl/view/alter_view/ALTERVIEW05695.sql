...
-- primary_obligation_id: AVIEW-EXT|05695|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05695_nosuchview SET (security_invoker = false);
-- primary-target-end
