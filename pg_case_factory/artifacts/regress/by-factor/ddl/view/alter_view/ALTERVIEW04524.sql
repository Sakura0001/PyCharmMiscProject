...
-- primary_obligation_id: AVIEW-EXT|04524|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_04524_nosuchview RESET (security_invoker);
-- primary-target-end
