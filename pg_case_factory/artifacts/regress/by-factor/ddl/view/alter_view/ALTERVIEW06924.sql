...
-- primary_obligation_id: AVIEW-EXT|06924|error_assertion|drop_view_if_exists
...
ALTER VIEW alterview_06924_nosuchview SET (security_invoker = true);
-- primary-target-end
