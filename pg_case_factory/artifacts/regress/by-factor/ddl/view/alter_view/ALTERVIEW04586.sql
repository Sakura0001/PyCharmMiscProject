...
-- primary_obligation_id: AVIEW-EXT|04586|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_04586_nosuchview RESET (security_barrier);
-- primary-target-end
