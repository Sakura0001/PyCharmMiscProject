...
-- primary_obligation_id: AVIEW-EXT|08167|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_08167_nosuchview ALTER alterview_08167_col SET DEFAULT 1;
-- primary-target-end
