...
-- primary_obligation_id: AVIEW-EXT|02546|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_02546_nosuchview ALTER alterview_02546_col DROP DEFAULT;
-- primary-target-end
