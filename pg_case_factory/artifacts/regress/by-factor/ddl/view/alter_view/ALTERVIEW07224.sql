...
-- primary_obligation_id: AVIEW-EXT|07224|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_07224_nosuchview ALTER COLUMN alterview_07224_col DROP DEFAULT;
-- primary-target-end
