...
-- primary_obligation_id: AVIEW-EXT|02561|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_02561_nosuchview ALTER alterview_02561_col DROP DEFAULT;
-- primary-target-end
