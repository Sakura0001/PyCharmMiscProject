...
-- primary_obligation_id: AVIEW-EXT|04476|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_04476_nosuchview RESET (security_barrier);
-- primary-target-end
