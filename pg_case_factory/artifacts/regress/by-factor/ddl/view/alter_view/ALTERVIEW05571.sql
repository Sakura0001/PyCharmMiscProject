...
-- primary_obligation_id: AVIEW-EXT|05571|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_05571_nosuchview SET (security_barrier = true);
-- primary-target-end
