...
-- primary_obligation_id: AVIEW-EXT|04749|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_04749_nosuchview ALTER alterview_04749_col SET DEFAULT 1;
-- primary-target-end
