...
-- primary_obligation_id: AVIEW-EXT|06471|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_06471_nosuchview RESET (check_option);
-- primary-target-end
