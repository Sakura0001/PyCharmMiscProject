...
-- primary_obligation_id: AVIEW-EXT|08170|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_08170_nosuchview ALTER alterview_08170_col SET DEFAULT 1;
-- primary-target-end
