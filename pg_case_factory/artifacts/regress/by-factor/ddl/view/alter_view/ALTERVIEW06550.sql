...
-- primary_obligation_id: AVIEW-EXT|06550|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06550_nosuchview RESET (security_invoker);
-- primary-target-end
