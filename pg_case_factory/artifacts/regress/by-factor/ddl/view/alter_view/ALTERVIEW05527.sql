...
-- primary_obligation_id: AVIEW-EXT|05527|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05527_nosuchview SET (check_option = local);
-- primary-target-end
