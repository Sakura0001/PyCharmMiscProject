...
-- primary_obligation_id: AVIEW-EXT|03006|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_03006_nosuchview OWNER TO CURRENT_USER;
-- primary-target-end
