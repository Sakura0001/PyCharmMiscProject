...
-- primary_obligation_id: AVIEW-EXT|02558|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_02558_nosuchview ALTER alterview_02558_col DROP DEFAULT;
-- primary-target-end
