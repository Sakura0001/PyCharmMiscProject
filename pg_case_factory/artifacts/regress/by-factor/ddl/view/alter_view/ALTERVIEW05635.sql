...
-- primary_obligation_id: AVIEW-EXT|05635|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05635_nosuchview SET (check_option = local);
-- primary-target-end
