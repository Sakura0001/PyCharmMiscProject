...
-- primary_obligation_id: AVIEW-EXT|02991|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_02991_nosuchview OWNER TO CURRENT_USER;
-- primary-target-end
