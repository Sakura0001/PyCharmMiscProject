...
-- primary_obligation_id: AVIEW-EXT|07371|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_07371_nosuchview RENAME COLUMN alterview_07371_col TO alterview_07371_newcol;
-- primary-target-end
