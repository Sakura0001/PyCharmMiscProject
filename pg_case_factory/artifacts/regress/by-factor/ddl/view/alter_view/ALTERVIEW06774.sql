...
-- primary_obligation_id: AVIEW-EXT|06774|error_assertion|drop_view_if_exists
...
ALTER VIEW alterview_06774_nosuchview SET (security_barrier = false);
-- primary-target-end
