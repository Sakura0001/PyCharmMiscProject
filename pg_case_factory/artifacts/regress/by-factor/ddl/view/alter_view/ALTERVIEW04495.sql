...
-- primary_obligation_id: AVIEW-EXT|04495|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_04495_nosuchview RESET (security_barrier);
-- primary-target-end
