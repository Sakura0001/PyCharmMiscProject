...
-- primary_obligation_id: AVIEW-EXT|04582|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_04582_nosuchview RESET (security_barrier);
-- primary-target-end
