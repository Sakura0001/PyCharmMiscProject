...
-- primary_obligation_id: AVIEW-EXT|02257|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_02257_nosuchview SET SCHEMA pg_catalog;
-- primary-target-end
