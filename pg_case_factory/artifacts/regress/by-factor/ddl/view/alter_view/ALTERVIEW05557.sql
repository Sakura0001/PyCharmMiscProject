...
-- primary_obligation_id: AVIEW-EXT|05557|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05557_nosuchview SET (security_barrier = false);
-- primary-target-end
