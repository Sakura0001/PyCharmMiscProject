...
-- primary_obligation_id: AVIEW-EXT|05572|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05572_nosuchview SET (security_barrier = true);
-- primary-target-end
