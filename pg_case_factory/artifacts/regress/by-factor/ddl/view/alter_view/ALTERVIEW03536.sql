...
-- primary_obligation_id: AVIEW-EXT|03536|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_03536_nosuchview RENAME TO alterview_03536_newview;
-- primary-target-end
