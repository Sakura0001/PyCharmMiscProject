...
-- primary_obligation_id: AVIEW-EXT|04436|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_04436_nosuchview RESET (check_option);
-- primary-target-end
