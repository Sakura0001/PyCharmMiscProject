...
-- primary_obligation_id: AVIEW-EXT|06894|error_assertion|drop_view_if_exists
...
ALTER VIEW alterview_06894_nosuchview SET (security_barrier = true);
-- primary-target-end
