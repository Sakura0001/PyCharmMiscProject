...
-- primary_obligation_id: AVIEW-EXT|00611|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_00611_nosuchview ALTER "alterview_00611_col" SET DEFAULT 1;
-- primary-target-end
