...
-- primary_obligation_id: AVIEW-EXT|08184|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_08184_nosuchview ALTER alterview_08184_col SET DEFAULT 1;
-- primary-target-end
