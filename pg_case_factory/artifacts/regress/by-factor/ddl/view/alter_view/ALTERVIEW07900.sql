...
-- primary_obligation_id: AVIEW-EXT|07900|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_07900_nosuchview ALTER alterview_07900_col DROP DEFAULT;
-- primary-target-end
