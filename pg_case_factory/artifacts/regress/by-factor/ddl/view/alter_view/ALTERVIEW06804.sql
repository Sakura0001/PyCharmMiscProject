...
-- primary_obligation_id: AVIEW-EXT|06804|error_assertion|drop_view_if_exists
...
ALTER VIEW alterview_06804_nosuchview SET (security_invoker = false);
-- primary-target-end
