...
-- primary_obligation_id: AVIEW-EXT|06517|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06517_nosuchview RESET (security_barrier);
-- primary-target-end
