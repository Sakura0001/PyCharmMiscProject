...
-- primary_obligation_id: AVIEW-EXT|04526|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_04526_nosuchview RESET (security_invoker);
-- primary-target-end
