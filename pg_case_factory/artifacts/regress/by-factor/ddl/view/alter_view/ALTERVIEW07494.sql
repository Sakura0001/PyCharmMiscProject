...
-- primary_obligation_id: AVIEW-EXT|07494|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_07494_nosuchview ALTER COLUMN alterview_07494_col SET DEFAULT 1;
-- primary-target-end
