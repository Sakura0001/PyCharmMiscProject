...
-- primary_obligation_id: AVIEW-EXT|02032|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_02032_nosuchview OWNER TO alterview_02032_nosuchrole;
-- primary-target-end
