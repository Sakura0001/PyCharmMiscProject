...
-- primary_obligation_id: AVIEW-EXT|06051|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_06051_nosuchview OWNER TO SESSION_USER;
-- primary-target-end
