...
-- primary_obligation_id: AVIEW-EXT|06911|error_assertion|revert_alter
...
ALTER VIEW alterview_06911_nosuchview SET (security_invoker = false);
-- primary-target-end
