...
-- primary_obligation_id: AVIEW-EXT|06427|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06427_nosuchview RESET (security_barrier);
-- primary-target-end
