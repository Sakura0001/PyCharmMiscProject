...
-- primary_obligation_id: AVIEW-EXT|02949|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_02949_nosuchview OWNER TO CURRENT_ROLE;
-- primary-target-end
