...
-- primary_obligation_id: AVIEW-EXT|02335|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_02335_nosuchview SET SCHEMA alterview_02335_nosuchschema;
-- primary-target-end
