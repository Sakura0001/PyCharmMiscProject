...
-- primary_obligation_id: AVIEW-EXT|04435|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_04435_nosuchview RESET (check_option);
-- primary-target-end
