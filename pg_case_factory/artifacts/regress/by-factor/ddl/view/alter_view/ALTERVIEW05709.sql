...
-- primary_obligation_id: AVIEW-EXT|05709|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_05709_nosuchview SET (security_invoker = true);
-- primary-target-end
