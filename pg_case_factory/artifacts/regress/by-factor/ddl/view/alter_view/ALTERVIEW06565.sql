...
-- primary_obligation_id: AVIEW-EXT|06565|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06565_nosuchview RESET (security_invoker);
-- primary-target-end
