...
-- primary_obligation_id: AVIEW-EXT|00322|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_00322_nosuchview ALTER "alterview_00322_col" DROP DEFAULT;
-- primary-target-end
