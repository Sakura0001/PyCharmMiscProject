...
-- primary_obligation_id: AVIEW-EXT|06519|error_assertion|drop_view_if_exists
...
ALTER VIEW alterview_06519_nosuchview RESET (security_barrier);
-- primary-target-end
