...
-- primary_obligation_id: AVIEW-EXT|02951|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_02951_nosuchview OWNER TO CURRENT_ROLE;
-- primary-target-end
