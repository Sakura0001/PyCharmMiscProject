...
-- primary_obligation_id: AVIEW-EXT|02017|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_02017_nosuchview OWNER TO alterview_02017_nosuchrole;
-- primary-target-end
