...
-- primary_obligation_id: AVIEW-EXT|05692|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05692_nosuchview SET (security_invoker = false);
-- primary-target-end
