...
-- primary_obligation_id: AVIEW-EXT|03096|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_03096_nosuchview OWNER TO SESSION_USER;
-- primary-target-end
