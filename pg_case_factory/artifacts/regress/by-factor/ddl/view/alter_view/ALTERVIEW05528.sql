...
-- primary_obligation_id: AVIEW-EXT|05528|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_05528_nosuchview SET (check_option = local);
-- primary-target-end
