...
-- primary_obligation_id: AVIEW-EXT|03441|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_03441_nosuchview RENAME TO "alterview_03441_newview";
-- primary-target-end
