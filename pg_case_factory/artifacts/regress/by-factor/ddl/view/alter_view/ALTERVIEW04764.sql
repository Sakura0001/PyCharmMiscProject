...
-- primary_obligation_id: AVIEW-EXT|04764|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_04764_nosuchview ALTER alterview_04764_col SET DEFAULT 1;
-- primary-target-end
