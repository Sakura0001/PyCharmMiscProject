...
-- primary_obligation_id: AVIEW-EXT|06895|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06895_nosuchview SET (security_barrier = true);
-- primary-target-end
