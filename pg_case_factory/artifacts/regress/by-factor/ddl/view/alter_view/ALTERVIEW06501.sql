...
-- primary_obligation_id: AVIEW-EXT|06501|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_06501_nosuchview RESET (check_option, security_barrier);
-- primary-target-end
