...
-- primary_obligation_id: AVIEW-EXT|06879|error_assertion|drop_view_if_exists
...
ALTER VIEW alterview_06879_nosuchview SET (security_barrier = false);
-- primary-target-end
