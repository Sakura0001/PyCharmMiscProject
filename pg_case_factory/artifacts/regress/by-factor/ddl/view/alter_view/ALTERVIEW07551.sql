...
-- primary_obligation_id: AVIEW-EXT|07551|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_07551_nosuchview ALTER COLUMN alterview_07551_col DROP DEFAULT;
-- primary-target-end
