...
-- primary_obligation_id: AVIEW-EXT|03668|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_03668_nosuchview RENAME TO alterview_03668_newview;
-- primary-target-end
