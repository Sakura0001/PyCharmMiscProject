...
-- primary_obligation_id: AVIEW-EXT|06472|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06472_nosuchview RESET (check_option);
-- primary-target-end
