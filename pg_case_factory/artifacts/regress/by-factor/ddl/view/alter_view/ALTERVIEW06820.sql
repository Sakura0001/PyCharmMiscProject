...
-- primary_obligation_id: AVIEW-EXT|06820|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06820_nosuchview SET (security_invoker = true);
-- primary-target-end
