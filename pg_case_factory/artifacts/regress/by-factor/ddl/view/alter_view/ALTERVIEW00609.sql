...
-- primary_obligation_id: AVIEW-EXT|00609|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_00609_nosuchview ALTER "alterview_00609_col" SET DEFAULT 1;
-- primary-target-end
