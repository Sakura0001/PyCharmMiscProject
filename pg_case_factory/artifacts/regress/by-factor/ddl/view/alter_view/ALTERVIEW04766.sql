...
-- primary_obligation_id: AVIEW-EXT|04766|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_04766_nosuchview ALTER alterview_04766_col SET DEFAULT 1;
-- primary-target-end
