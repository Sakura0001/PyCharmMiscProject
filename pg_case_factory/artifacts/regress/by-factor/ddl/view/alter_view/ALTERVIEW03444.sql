...
-- primary_obligation_id: AVIEW-EXT|03444|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_03444_nosuchview RENAME TO "alterview_03444_newview";
-- primary-target-end
