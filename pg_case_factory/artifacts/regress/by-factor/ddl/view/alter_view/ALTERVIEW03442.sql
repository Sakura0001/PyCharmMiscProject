...
-- primary_obligation_id: AVIEW-EXT|03442|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_03442_nosuchview RENAME TO "alterview_03442_newview";
-- primary-target-end
