...
-- primary_obligation_id: AVIEW-EXT|06802|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06802_nosuchview SET (security_invoker = false);
-- primary-target-end
