...
-- primary_obligation_id: AVIEW-EXT|02544|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_02544_nosuchview ALTER alterview_02544_col DROP DEFAULT;
-- primary-target-end
