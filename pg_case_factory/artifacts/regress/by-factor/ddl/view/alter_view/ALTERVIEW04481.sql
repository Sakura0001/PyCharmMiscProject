...
-- primary_obligation_id: AVIEW-EXT|04481|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_04481_nosuchview RESET (security_barrier);
-- primary-target-end
