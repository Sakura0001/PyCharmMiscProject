...
-- primary_obligation_id: AVIEW-EXT|03681|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_03681_nosuchview RENAME TO alterview_03681_newview;
-- primary-target-end
