...
-- primary_obligation_id: AVIEW-EXT|03010|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_03010_nosuchview OWNER TO CURRENT_USER;
-- primary-target-end
