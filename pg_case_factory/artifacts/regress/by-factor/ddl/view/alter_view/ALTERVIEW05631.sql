...
-- primary_obligation_id: AVIEW-EXT|05631|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_05631_nosuchview SET (check_option = local);
-- primary-target-end
