...
-- primary_obligation_id: AVIEW-EXT|04462|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_04462_nosuchview RESET (check_option, security_barrier);
-- primary-target-end
