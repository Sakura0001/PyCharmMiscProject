...
-- primary_obligation_id: AVIEW-EXT|03084|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_03084_nosuchview OWNER TO SESSION_USER;
-- primary-target-end
