...
-- primary_obligation_id: AVIEW-EXT|02334|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_02334_nosuchview SET SCHEMA alterview_02334_nosuchschema;
-- primary-target-end
