...
-- primary_obligation_id: AVIEW-EXT|07241|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_07241_nosuchview ALTER COLUMN alterview_07241_col DROP DEFAULT;
-- primary-target-end
