...
-- primary_obligation_id: AVIEW-EXT|00594|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_00594_nosuchview ALTER "alterview_00594_col" SET DEFAULT 1;
-- primary-target-end
