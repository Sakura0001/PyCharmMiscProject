...
-- primary_obligation_id: AVIEW-EXT|03682|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_03682_nosuchview RENAME TO alterview_03682_newview;
-- primary-target-end
