...
-- primary_obligation_id: AVIEW-EXT|06474|error_assertion|drop_view_if_exists
...
ALTER VIEW alterview_06474_nosuchview RESET (check_option);
-- primary-target-end
