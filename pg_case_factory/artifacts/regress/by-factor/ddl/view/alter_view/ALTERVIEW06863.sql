...
-- primary_obligation_id: AVIEW-EXT|06863|select_from_view|revert_alter
...
ALTER VIEW alterview_06863_nosuchview SET (check_option = local, security_barrier = true);
-- primary-target-end
