...
-- primary_obligation_id: AVIEW-EXT|05651|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_05651_nosuchview SET (check_option = local, security_barrier = true);
-- primary-target-end
