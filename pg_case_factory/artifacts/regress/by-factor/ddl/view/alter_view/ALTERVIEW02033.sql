...
-- primary_obligation_id: AVIEW-EXT|02033|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_02033_nosuchview OWNER TO alterview_02033_nosuchrole;
-- primary-target-end
