...
-- primary_obligation_id: AVIEW-EXT|04464|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_04464_nosuchview RESET (check_option, security_barrier);
-- primary-target-end
