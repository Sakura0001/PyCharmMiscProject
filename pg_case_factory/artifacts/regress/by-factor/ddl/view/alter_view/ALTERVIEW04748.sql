...
-- primary_obligation_id: AVIEW-EXT|04748|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_04748_nosuchview ALTER alterview_04748_col SET DEFAULT 1;
-- primary-target-end
