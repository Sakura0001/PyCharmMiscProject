...
-- primary_obligation_id: AVIEW-EXT|04451|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_04451_nosuchview RESET (check_option);
-- primary-target-end
