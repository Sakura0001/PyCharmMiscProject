...
-- primary_obligation_id: AVIEW-EXT|06744|error_assertion|drop_view_if_exists
...
ALTER VIEW alterview_06744_nosuchview SET (check_option = local);
-- primary-target-end
