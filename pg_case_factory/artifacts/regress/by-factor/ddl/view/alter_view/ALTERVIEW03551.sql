...
-- primary_obligation_id: AVIEW-EXT|03551|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_03551_nosuchview RENAME TO alterview_03551_newview;
-- primary-target-end
