...
-- primary_obligation_id: AVIEW-EXT|00596|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_00596_nosuchview ALTER "alterview_00596_col" SET DEFAULT 1;
-- primary-target-end
