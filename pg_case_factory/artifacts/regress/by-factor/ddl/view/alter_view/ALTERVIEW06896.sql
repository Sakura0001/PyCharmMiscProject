...
-- primary_obligation_id: AVIEW-EXT|06896|error_assertion|revert_alter
...
ALTER VIEW alterview_06896_nosuchview SET (security_barrier = true);
-- primary-target-end
