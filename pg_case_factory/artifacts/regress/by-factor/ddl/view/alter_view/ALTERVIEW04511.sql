...
-- primary_obligation_id: AVIEW-EXT|04511|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_04511_nosuchview RESET (security_invoker);
-- primary-target-end
