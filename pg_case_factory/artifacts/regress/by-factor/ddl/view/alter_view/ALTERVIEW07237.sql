...
-- primary_obligation_id: AVIEW-EXT|07237|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_07237_nosuchview ALTER COLUMN alterview_07237_col DROP DEFAULT;
-- primary-target-end
