...
-- primary_obligation_id: AVIEW-EXT|06730|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06730_nosuchview SET (check_option = cascaded);
-- primary-target-end
