...
-- primary_obligation_id: AVIEW-EXT|07913|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_07913_nosuchview ALTER alterview_07913_col DROP DEFAULT;
-- primary-target-end
