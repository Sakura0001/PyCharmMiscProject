...
-- primary_obligation_id: AVIEW-EXT|06834|error_assertion|drop_view_if_exists
...
ALTER VIEW alterview_06834_nosuchview SET (check_option = cascaded);
-- primary-target-end
