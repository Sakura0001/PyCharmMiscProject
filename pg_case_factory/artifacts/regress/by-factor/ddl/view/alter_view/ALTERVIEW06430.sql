...
-- primary_obligation_id: AVIEW-EXT|06430|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06430_nosuchview RESET (security_barrier);
-- primary-target-end
