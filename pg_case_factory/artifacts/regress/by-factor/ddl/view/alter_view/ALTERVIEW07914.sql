...
-- primary_obligation_id: AVIEW-EXT|07914|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_07914_nosuchview ALTER alterview_07914_col DROP DEFAULT;
-- primary-target-end
