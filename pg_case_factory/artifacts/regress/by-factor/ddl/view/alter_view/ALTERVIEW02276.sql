...
-- primary_obligation_id: AVIEW-EXT|02276|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_02276_nosuchview SET SCHEMA pg_catalog;
-- primary-target-end
