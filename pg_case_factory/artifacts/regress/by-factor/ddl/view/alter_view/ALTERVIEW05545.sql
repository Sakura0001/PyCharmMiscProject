...
-- primary_obligation_id: AVIEW-EXT|05545|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05545_nosuchview SET (check_option = local, security_barrier = true);
-- primary-target-end
