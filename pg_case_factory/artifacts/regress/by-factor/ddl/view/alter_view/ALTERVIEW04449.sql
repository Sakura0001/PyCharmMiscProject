...
-- primary_obligation_id: AVIEW-EXT|04449|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_04449_nosuchview RESET (check_option);
-- primary-target-end
