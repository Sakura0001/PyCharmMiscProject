...
-- primary_obligation_id: AVIEW-EXT|08183|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_08183_nosuchview ALTER alterview_08183_col SET DEFAULT 1;
-- primary-target-end
