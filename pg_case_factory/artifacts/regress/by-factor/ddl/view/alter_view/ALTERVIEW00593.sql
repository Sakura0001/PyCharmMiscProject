...
-- primary_obligation_id: AVIEW-EXT|00593|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_00593_nosuchview ALTER "alterview_00593_col" SET DEFAULT 1;
-- primary-target-end
