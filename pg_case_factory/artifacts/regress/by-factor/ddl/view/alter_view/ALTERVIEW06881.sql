...
-- primary_obligation_id: AVIEW-EXT|06881|error_assertion|revert_alter
...
ALTER VIEW alterview_06881_nosuchview SET (security_barrier = false);
-- primary-target-end
