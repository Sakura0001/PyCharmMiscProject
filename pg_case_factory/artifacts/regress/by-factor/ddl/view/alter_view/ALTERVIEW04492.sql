...
-- primary_obligation_id: AVIEW-EXT|04492|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_04492_nosuchview RESET (security_barrier);
-- primary-target-end
