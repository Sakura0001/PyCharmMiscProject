...
-- primary_obligation_id: AVIEW-EXT|00325|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_00325_nosuchview ALTER "alterview_00325_col" DROP DEFAULT;
-- primary-target-end
