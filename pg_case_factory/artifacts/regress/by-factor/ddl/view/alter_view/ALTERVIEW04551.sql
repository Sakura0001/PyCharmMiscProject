...
-- primary_obligation_id: AVIEW-EXT|04551|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_04551_nosuchview RESET (check_option);
-- primary-target-end
