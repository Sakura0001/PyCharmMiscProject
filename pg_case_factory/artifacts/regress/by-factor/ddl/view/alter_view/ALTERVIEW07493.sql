...
-- primary_obligation_id: AVIEW-EXT|07493|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_07493_nosuchview ALTER COLUMN alterview_07493_col SET DEFAULT 1;
-- primary-target-end
