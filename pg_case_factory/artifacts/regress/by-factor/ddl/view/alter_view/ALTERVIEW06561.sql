...
-- primary_obligation_id: AVIEW-EXT|06561|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_06561_nosuchview RESET (security_invoker);
-- primary-target-end
