...
-- primary_obligation_id: AVIEW-EXT|04553|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_04553_nosuchview RESET (check_option);
-- primary-target-end
