...
-- primary_obligation_id: AVIEW-EXT|04601|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_04601_nosuchview RESET (security_barrier);
-- primary-target-end
