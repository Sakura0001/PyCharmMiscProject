...
-- primary_obligation_id: AVIEW-EXT|04566|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_04566_nosuchview RESET (check_option, security_barrier);
-- primary-target-end
