...
-- primary_obligation_id: AVIEW-EXT|03671|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_03671_nosuchview RENAME TO alterview_03671_newview;
-- primary-target-end
