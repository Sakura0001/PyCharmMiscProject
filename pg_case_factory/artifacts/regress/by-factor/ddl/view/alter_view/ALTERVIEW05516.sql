...
-- primary_obligation_id: AVIEW-EXT|05516|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_05516_nosuchview SET (check_option = cascaded);
-- primary-target-end
