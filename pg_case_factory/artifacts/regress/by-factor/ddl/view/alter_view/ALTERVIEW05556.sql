...
-- primary_obligation_id: AVIEW-EXT|05556|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_05556_nosuchview SET (security_barrier = false);
-- primary-target-end
