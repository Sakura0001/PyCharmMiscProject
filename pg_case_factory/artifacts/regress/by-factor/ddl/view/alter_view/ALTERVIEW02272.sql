...
-- primary_obligation_id: AVIEW-EXT|02272|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_02272_nosuchview SET SCHEMA pg_catalog;
-- primary-target-end
