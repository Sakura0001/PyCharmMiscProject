...
-- primary_obligation_id: AVIEW-EXT|00606|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_00606_nosuchview ALTER "alterview_00606_col" SET DEFAULT 1;
-- primary-target-end
