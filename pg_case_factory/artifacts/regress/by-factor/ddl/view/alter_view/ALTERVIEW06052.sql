...
-- primary_obligation_id: AVIEW-EXT|06052|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06052_nosuchview OWNER TO SESSION_USER;
-- primary-target-end
