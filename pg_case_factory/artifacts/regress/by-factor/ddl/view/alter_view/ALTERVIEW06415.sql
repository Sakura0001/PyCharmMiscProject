...
-- primary_obligation_id: AVIEW-EXT|06415|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06415_nosuchview RESET (security_barrier);
-- primary-target-end
