...
-- primary_obligation_id: AVIEW-EXT|05513|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_05513_nosuchview SET (check_option = cascaded);
-- primary-target-end
