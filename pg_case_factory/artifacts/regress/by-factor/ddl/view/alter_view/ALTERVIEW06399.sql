...
-- primary_obligation_id: AVIEW-EXT|06399|error_assertion|drop_view_if_exists
...
ALTER VIEW alterview_06399_nosuchview RESET (check_option, security_barrier);
-- primary-target-end
