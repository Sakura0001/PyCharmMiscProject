...
-- primary_obligation_id: AVIEW-EXT|02963|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_02963_nosuchview OWNER TO CURRENT_ROLE;
-- primary-target-end
