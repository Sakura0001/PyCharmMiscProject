...
-- primary_obligation_id: AVIEW-EXT|04538|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_04538_nosuchview RESET (check_option);
-- primary-target-end
