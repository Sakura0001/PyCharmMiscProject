...
-- primary_obligation_id: AVIEW-EXT|06535|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06535_nosuchview RESET (security_barrier);
-- primary-target-end
