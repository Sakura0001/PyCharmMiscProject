...
-- primary_obligation_id: AVIEW-EXT|07897|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_07897_nosuchview ALTER alterview_07897_col DROP DEFAULT;
-- primary-target-end
