...
-- primary_obligation_id: AVIEW-EXT|04765|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_04765_nosuchview ALTER alterview_04765_col SET DEFAULT 1;
-- primary-target-end
