...
-- primary_obligation_id: AVIEW-EXT|04568|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_04568_nosuchview RESET (check_option, security_barrier);
-- primary-target-end
