...
-- primary_obligation_id: AVIEW-EXT|05711|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_05711_nosuchview SET (security_invoker = true);
-- primary-target-end
