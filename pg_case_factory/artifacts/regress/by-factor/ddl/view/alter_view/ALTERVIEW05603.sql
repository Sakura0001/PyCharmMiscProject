...
-- primary_obligation_id: AVIEW-EXT|05603|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_05603_nosuchview SET (security_invoker = true);
-- primary-target-end
