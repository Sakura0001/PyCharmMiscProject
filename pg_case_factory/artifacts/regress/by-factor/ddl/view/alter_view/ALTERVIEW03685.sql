...
-- primary_obligation_id: AVIEW-EXT|03685|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_03685_nosuchview RENAME TO alterview_03685_newview;
-- primary-target-end
