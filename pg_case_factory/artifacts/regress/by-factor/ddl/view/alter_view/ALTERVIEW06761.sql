...
-- primary_obligation_id: AVIEW-EXT|06761|error_assertion|revert_alter
...
ALTER VIEW alterview_06761_nosuchview SET (check_option = local, security_barrier = true);
-- primary-target-end
