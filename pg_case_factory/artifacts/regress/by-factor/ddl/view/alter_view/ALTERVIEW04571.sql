...
-- primary_obligation_id: AVIEW-EXT|04571|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_04571_nosuchview RESET (check_option, security_barrier);
-- primary-target-end
