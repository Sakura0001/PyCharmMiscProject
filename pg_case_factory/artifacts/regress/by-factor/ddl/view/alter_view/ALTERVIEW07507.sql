...
-- primary_obligation_id: AVIEW-EXT|07507|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_07507_nosuchview ALTER COLUMN alterview_07507_col SET DEFAULT 1;
-- primary-target-end
