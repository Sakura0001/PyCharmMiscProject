...
-- primary_obligation_id: AVIEW-EXT|02542|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_02542_nosuchview ALTER alterview_02542_col DROP DEFAULT;
-- primary-target-end
