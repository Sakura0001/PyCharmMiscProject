...
-- primary_obligation_id: AVIEW-EXT|06775|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06775_nosuchview SET (security_barrier = false);
-- primary-target-end
