...
-- primary_obligation_id: AVIEW-EXT|06835|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06835_nosuchview SET (check_option = cascaded);
-- primary-target-end
