...
-- primary_obligation_id: AVIEW-EXT|04762|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_04762_nosuchview ALTER alterview_04762_col SET DEFAULT 1;
-- primary-target-end
