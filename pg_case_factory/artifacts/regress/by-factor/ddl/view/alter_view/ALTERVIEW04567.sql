...
-- primary_obligation_id: AVIEW-EXT|04567|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_04567_nosuchview RESET (check_option, security_barrier);
-- primary-target-end
