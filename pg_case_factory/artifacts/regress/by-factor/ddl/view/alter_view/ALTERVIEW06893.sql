...
-- primary_obligation_id: AVIEW-EXT|06893|select_from_view|revert_alter
...
ALTER VIEW alterview_06893_nosuchview SET (security_barrier = true);
-- primary-target-end
