...
-- primary_obligation_id: AVIEW-EXT|03667|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_03667_nosuchview RENAME TO alterview_03667_newview;
-- primary-target-end
