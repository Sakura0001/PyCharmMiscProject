...
-- primary_obligation_id: AVIEW-EXT|02965|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_02965_nosuchview OWNER TO CURRENT_ROLE;
-- primary-target-end
