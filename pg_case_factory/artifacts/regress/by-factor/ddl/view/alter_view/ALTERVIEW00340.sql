...
-- primary_obligation_id: AVIEW-EXT|00340|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_00340_nosuchview ALTER "alterview_00340_col" DROP DEFAULT;
-- primary-target-end
