...
-- primary_obligation_id: AVIEW-EXT|06923|select_from_view|revert_alter
...
ALTER VIEW alterview_06923_nosuchview SET (security_invoker = true);
-- primary-target-end
