...
-- primary_obligation_id: AVIEW-EXT|08185|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_08185_nosuchview ALTER alterview_08185_col SET DEFAULT 1;
-- primary-target-end
