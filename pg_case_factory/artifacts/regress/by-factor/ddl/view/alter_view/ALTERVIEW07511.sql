...
-- primary_obligation_id: AVIEW-EXT|07511|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_07511_nosuchview ALTER COLUMN alterview_07511_col SET DEFAULT 1;
-- primary-target-end
