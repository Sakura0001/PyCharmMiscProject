...
-- primary_obligation_id: AVIEW-EXT|06789|error_assertion|drop_view_if_exists
...
ALTER VIEW alterview_06789_nosuchview SET (security_barrier = true);
-- primary-target-end
