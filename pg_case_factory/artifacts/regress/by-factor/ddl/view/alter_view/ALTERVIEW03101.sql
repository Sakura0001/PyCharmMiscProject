...
-- primary_obligation_id: AVIEW-EXT|03101|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_03101_nosuchview OWNER TO SESSION_USER;
-- primary-target-end
