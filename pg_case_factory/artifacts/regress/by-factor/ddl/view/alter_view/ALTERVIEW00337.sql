...
-- primary_obligation_id: AVIEW-EXT|00337|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_00337_nosuchview ALTER "alterview_00337_col" DROP DEFAULT;
-- primary-target-end
