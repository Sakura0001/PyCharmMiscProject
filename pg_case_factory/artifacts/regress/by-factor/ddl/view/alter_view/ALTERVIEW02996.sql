...
-- primary_obligation_id: AVIEW-EXT|02996|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_02996_nosuchview OWNER TO CURRENT_USER;
-- primary-target-end
