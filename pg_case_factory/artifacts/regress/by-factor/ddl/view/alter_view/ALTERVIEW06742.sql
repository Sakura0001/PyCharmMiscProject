...
-- primary_obligation_id: AVIEW-EXT|06742|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06742_nosuchview SET (check_option = local);
-- primary-target-end
