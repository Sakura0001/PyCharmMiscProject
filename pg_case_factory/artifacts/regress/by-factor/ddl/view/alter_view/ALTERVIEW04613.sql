...
-- primary_obligation_id: AVIEW-EXT|04613|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_04613_nosuchview RESET (security_invoker);
-- primary-target-end
