...
-- primary_obligation_id: AVIEW-EXT|05678|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_05678_nosuchview SET (security_barrier = true);
-- primary-target-end
