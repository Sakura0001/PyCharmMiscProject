...
-- primary_obligation_id: AVIEW-EXT|07226|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_07226_nosuchview ALTER COLUMN alterview_07226_col DROP DEFAULT;
-- primary-target-end
