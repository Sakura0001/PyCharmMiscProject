...
-- primary_obligation_id: AVIEW-EXT|03008|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_03008_nosuchview OWNER TO CURRENT_USER;
-- primary-target-end
