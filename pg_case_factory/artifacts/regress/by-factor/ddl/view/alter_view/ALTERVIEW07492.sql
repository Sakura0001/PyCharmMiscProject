...
-- primary_obligation_id: AVIEW-EXT|07492|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_07492_nosuchview ALTER COLUMN alterview_07492_col SET DEFAULT 1;
-- primary-target-end
