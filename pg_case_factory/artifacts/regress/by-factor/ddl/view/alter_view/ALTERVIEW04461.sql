...
-- primary_obligation_id: AVIEW-EXT|04461|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_04461_nosuchview RESET (check_option, security_barrier);
-- primary-target-end
