...
-- primary_obligation_id: AVIEW-EXT|03445|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_03445_nosuchview RENAME TO "alterview_03445_newview";
-- primary-target-end
