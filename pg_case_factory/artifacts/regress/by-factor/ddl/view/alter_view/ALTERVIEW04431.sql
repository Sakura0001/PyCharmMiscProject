...
-- primary_obligation_id: AVIEW-EXT|04431|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_04431_nosuchview RESET (check_option);
-- primary-target-end
