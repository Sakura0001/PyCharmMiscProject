...
-- primary_obligation_id: AVIEW-EXT|05588|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_05588_nosuchview SET (security_invoker = false);
-- primary-target-end
