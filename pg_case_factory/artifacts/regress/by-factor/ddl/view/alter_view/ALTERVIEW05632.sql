...
-- primary_obligation_id: AVIEW-EXT|05632|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05632_nosuchview SET (check_option = local);
-- primary-target-end
