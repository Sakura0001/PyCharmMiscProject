...
-- primary_obligation_id: AVIEW-EXT|05606|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_05606_nosuchview SET (security_invoker = true);
-- primary-target-end
