...
-- primary_obligation_id: AVIEW-EXT|04506|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_04506_nosuchview RESET (security_invoker);
-- primary-target-end
