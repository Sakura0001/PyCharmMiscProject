...
-- primary_obligation_id: AVIEW-EXT|02541|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_02541_nosuchview ALTER alterview_02541_col DROP DEFAULT;
-- primary-target-end
