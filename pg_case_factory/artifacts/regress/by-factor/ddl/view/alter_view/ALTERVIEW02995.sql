...
-- primary_obligation_id: AVIEW-EXT|02995|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_02995_nosuchview OWNER TO CURRENT_USER;
-- primary-target-end
