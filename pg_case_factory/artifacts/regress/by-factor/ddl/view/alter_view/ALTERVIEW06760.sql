...
-- primary_obligation_id: AVIEW-EXT|06760|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06760_nosuchview SET (check_option = local, security_barrier = true);
-- primary-target-end
