...
-- primary_obligation_id: AVIEW-EXT|03548|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_03548_nosuchview RENAME TO alterview_03548_newview;
-- primary-target-end
