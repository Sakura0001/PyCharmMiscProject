...
-- primary_obligation_id: AVIEW-EXT|02333|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_02333_nosuchview SET SCHEMA alterview_02333_nosuchschema;
-- primary-target-end
