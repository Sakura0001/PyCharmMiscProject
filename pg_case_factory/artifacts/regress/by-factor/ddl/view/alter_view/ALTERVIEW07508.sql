...
-- primary_obligation_id: AVIEW-EXT|07508|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_07508_nosuchview ALTER COLUMN alterview_07508_col SET DEFAULT 1;
-- primary-target-end
