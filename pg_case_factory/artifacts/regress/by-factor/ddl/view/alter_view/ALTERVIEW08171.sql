...
-- primary_obligation_id: AVIEW-EXT|08171|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_08171_nosuchview ALTER alterview_08171_col SET DEFAULT 1;
-- primary-target-end
