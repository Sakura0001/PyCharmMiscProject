...
-- primary_obligation_id: AVIEW-EXT|03082|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_03082_nosuchview OWNER TO SESSION_USER;
-- primary-target-end
