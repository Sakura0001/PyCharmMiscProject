...
-- primary_obligation_id: AVIEW-EXT|05648|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_05648_nosuchview SET (check_option = local, security_barrier = true);
-- primary-target-end
