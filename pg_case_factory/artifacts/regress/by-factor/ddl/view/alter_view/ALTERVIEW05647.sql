...
-- primary_obligation_id: AVIEW-EXT|05647|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05647_nosuchview SET (check_option = local, security_barrier = true);
-- primary-target-end
