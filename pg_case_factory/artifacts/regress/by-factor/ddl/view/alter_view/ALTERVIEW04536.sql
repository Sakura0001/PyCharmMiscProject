...
-- primary_obligation_id: AVIEW-EXT|04536|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_04536_nosuchview RESET (check_option);
-- primary-target-end
