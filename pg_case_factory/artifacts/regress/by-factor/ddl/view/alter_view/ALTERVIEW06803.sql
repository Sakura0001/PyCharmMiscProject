...
-- primary_obligation_id: AVIEW-EXT|06803|select_from_view|revert_alter
...
ALTER VIEW alterview_06803_nosuchview SET (security_invoker = false);
-- primary-target-end
