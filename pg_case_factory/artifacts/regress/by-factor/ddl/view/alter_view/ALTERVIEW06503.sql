...
-- primary_obligation_id: AVIEW-EXT|06503|select_from_view|revert_alter
...
ALTER VIEW alterview_06503_nosuchview RESET (check_option, security_barrier);
-- primary-target-end
