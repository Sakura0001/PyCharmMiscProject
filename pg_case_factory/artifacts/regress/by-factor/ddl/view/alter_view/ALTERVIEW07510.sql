...
-- primary_obligation_id: AVIEW-EXT|07510|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_07510_nosuchview ALTER COLUMN alterview_07510_col SET DEFAULT 1;
-- primary-target-end
