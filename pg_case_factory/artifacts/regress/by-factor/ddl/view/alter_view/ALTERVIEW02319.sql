...
-- primary_obligation_id: AVIEW-EXT|02319|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_02319_nosuchview SET SCHEMA alterview_02319_nosuchschema;
-- primary-target-end
