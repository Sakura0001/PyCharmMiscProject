...
-- primary_obligation_id: AVIEW-EXT|02034|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_02034_nosuchview OWNER TO alterview_02034_nosuchrole;
-- primary-target-end
