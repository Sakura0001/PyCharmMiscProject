...
-- primary_obligation_id: AVIEW-EXT|07496|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_07496_nosuchview ALTER COLUMN alterview_07496_col SET DEFAULT 1;
-- primary-target-end
