...
-- primary_obligation_id: AVIEW-EXT|04598|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_04598_nosuchview RESET (security_barrier);
-- primary-target-end
