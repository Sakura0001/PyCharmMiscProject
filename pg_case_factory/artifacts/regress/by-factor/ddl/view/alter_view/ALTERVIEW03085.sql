...
-- primary_obligation_id: AVIEW-EXT|03085|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_03085_nosuchview OWNER TO SESSION_USER;
-- primary-target-end
