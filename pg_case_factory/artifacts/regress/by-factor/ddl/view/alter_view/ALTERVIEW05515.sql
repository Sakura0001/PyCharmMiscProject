...
-- primary_obligation_id: AVIEW-EXT|05515|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05515_nosuchview SET (check_option = cascaded);
-- primary-target-end
