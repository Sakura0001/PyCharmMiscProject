...
-- primary_obligation_id: AVIEW-EXT|00608|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_00608_nosuchview ALTER "alterview_00608_col" SET DEFAULT 1;
-- primary-target-end
