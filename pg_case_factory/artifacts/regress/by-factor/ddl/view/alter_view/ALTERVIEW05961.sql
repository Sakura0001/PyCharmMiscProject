...
-- primary_obligation_id: AVIEW-EXT|05961|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_05961_nosuchview OWNER TO CURRENT_USER;
-- primary-target-end
