...
-- primary_obligation_id: AVIEW-EXT|05604|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_05604_nosuchview SET (security_invoker = true);
-- primary-target-end
