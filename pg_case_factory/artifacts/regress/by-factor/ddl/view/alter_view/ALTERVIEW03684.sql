...
-- primary_obligation_id: AVIEW-EXT|03684|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_03684_nosuchview RENAME TO alterview_03684_newview;
-- primary-target-end
