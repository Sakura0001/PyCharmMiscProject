...
-- primary_obligation_id: AVIEW-EXT|07916|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_07916_nosuchview ALTER alterview_07916_col DROP DEFAULT;
-- primary-target-end
