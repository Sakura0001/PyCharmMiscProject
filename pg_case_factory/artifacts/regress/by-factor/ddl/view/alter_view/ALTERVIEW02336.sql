...
-- primary_obligation_id: AVIEW-EXT|02336|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_02336_nosuchview SET SCHEMA alterview_02336_nosuchschema;
-- primary-target-end
