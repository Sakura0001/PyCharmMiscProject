...
-- primary_obligation_id: AVIEW-EXT|05602|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05602_nosuchview SET (security_invoker = true);
-- primary-target-end
