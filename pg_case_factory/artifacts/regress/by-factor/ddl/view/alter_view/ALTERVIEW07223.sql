...
-- primary_obligation_id: AVIEW-EXT|07223|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_07223_nosuchview ALTER COLUMN alterview_07223_col DROP DEFAULT;
-- primary-target-end
