...
-- primary_obligation_id: AVIEW-EXT|03550|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_03550_nosuchview RENAME TO alterview_03550_newview;
-- primary-target-end
