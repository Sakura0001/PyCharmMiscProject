...
-- primary_obligation_id: AVIEW-EXT|00324|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_00324_nosuchview ALTER "alterview_00324_col" DROP DEFAULT;
-- primary-target-end
