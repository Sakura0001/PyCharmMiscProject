...
-- primary_obligation_id: AVIEW-EXT|06396|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_06396_nosuchview RESET (check_option, security_barrier);
-- primary-target-end
