...
-- primary_obligation_id: AVIEW-EXT|06787|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06787_nosuchview SET (security_barrier = true);
-- primary-target-end
