...
-- primary_obligation_id: AVIEW-EXT|03007|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_03007_nosuchview OWNER TO CURRENT_USER;
-- primary-target-end
