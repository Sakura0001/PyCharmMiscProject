...
-- primary_obligation_id: AVIEW-EXT|06728|select_from_view|revert_alter
...
ALTER VIEW alterview_06728_nosuchview SET (check_option = cascaded);
-- primary-target-end
