...
-- primary_obligation_id: AVIEW-EXT|06806|error_assertion|revert_alter
...
ALTER VIEW alterview_06806_nosuchview SET (security_invoker = false);
-- primary-target-end
