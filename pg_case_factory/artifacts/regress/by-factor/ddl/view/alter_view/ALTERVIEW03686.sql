...
-- primary_obligation_id: AVIEW-EXT|03686|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_03686_nosuchview RENAME TO alterview_03686_newview;
-- primary-target-end
