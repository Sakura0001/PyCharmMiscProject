...
-- primary_obligation_id: AVIEW-EXT|02332|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_02332_nosuchview SET SCHEMA alterview_02332_nosuchschema;
-- primary-target-end
