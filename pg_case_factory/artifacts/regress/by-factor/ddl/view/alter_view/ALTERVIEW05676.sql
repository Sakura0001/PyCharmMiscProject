...
-- primary_obligation_id: AVIEW-EXT|05676|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_05676_nosuchview SET (security_barrier = true);
-- primary-target-end
