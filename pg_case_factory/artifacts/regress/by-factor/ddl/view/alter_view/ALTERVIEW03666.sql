...
-- primary_obligation_id: AVIEW-EXT|03666|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_03666_nosuchview RENAME TO alterview_03666_newview;
-- primary-target-end
