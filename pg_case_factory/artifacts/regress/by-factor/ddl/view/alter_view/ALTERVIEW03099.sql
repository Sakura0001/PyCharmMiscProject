...
-- primary_obligation_id: AVIEW-EXT|03099|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_03099_nosuchview OWNER TO SESSION_USER;
-- primary-target-end
