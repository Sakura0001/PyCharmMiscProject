...
-- primary_obligation_id: AVIEW-EXT|08186|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_08186_nosuchview ALTER alterview_08186_col SET DEFAULT 1;
-- primary-target-end
