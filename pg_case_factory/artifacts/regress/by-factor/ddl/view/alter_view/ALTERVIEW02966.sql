...
-- primary_obligation_id: AVIEW-EXT|02966|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_02966_nosuchview OWNER TO CURRENT_ROLE;
-- primary-target-end
