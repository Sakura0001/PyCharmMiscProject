...
-- primary_obligation_id: AVIEW-EXT|07240|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_07240_nosuchview ALTER COLUMN alterview_07240_col DROP DEFAULT;
-- primary-target-end
