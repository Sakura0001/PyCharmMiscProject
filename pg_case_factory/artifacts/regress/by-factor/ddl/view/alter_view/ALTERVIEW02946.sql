...
-- primary_obligation_id: AVIEW-EXT|02946|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_02946_nosuchview OWNER TO CURRENT_ROLE;
-- primary-target-end
