...
-- primary_obligation_id: AVIEW-EXT|06847|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06847_nosuchview SET (check_option = local);
-- primary-target-end
