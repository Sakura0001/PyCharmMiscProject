...
-- primary_obligation_id: AVIEW-EXT|06445|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06445_nosuchview RESET (security_invoker);
-- primary-target-end
