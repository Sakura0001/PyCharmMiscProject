...
-- primary_obligation_id: AVIEW-EXT|06850|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06850_nosuchview SET (check_option = local);
-- primary-target-end
