...
-- primary_obligation_id: AVIEW-EXT|08211|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_08211_nosuchview ALTER alterview_08211_col DROP DEFAULT;
-- primary-target-end
