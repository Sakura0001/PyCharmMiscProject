...
-- primary_obligation_id: AVIEW-EXT|03547|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_03547_nosuchview RENAME TO alterview_03547_newview;
-- primary-target-end
