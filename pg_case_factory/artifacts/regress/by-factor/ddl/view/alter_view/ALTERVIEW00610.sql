...
-- primary_obligation_id: AVIEW-EXT|00610|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_00610_nosuchview ALTER "alterview_00610_col" SET DEFAULT 1;
-- primary-target-end
