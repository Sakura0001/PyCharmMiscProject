...
-- primary_obligation_id: AVIEW-EXT|02274|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_02274_nosuchview SET SCHEMA pg_catalog;
-- primary-target-end
