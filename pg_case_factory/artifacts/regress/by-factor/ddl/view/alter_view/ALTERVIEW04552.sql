...
-- primary_obligation_id: AVIEW-EXT|04552|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_04552_nosuchview RESET (check_option);
-- primary-target-end
