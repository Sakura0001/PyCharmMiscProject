...
-- primary_obligation_id: AVIEW-EXT|04615|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_04615_nosuchview RESET (security_invoker);
-- primary-target-end
