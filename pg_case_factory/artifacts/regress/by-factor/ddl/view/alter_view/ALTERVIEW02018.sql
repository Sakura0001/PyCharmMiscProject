...
-- primary_obligation_id: AVIEW-EXT|02018|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_02018_nosuchview OWNER TO alterview_02018_nosuchrole;
-- primary-target-end
