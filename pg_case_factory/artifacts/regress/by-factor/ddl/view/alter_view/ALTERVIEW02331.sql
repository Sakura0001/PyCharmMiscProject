...
-- primary_obligation_id: AVIEW-EXT|02331|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_02331_nosuchview SET SCHEMA alterview_02331_nosuchschema;
-- primary-target-end
