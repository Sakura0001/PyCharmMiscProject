...
-- primary_obligation_id: AVIEW-EXT|06908|select_from_view|revert_alter
...
ALTER VIEW alterview_06908_nosuchview SET (security_invoker = false);
-- primary-target-end
