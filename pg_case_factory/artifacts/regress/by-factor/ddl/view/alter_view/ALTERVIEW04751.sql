...
-- primary_obligation_id: AVIEW-EXT|04751|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_04751_nosuchview ALTER alterview_04751_col SET DEFAULT 1;
-- primary-target-end
