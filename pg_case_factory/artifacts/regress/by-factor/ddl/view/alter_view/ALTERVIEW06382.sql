...
-- primary_obligation_id: AVIEW-EXT|06382|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06382_nosuchview RESET (check_option);
-- primary-target-end
