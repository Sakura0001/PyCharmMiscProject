...
-- primary_obligation_id: AVIEW-EXT|06773|select_from_view|revert_alter
...
ALTER VIEW alterview_06773_nosuchview SET (security_barrier = false);
-- primary-target-end
