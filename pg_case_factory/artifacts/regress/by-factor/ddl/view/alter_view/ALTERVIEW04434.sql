...
-- primary_obligation_id: AVIEW-EXT|04434|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_04434_nosuchview RESET (check_option);
-- primary-target-end
