...
-- primary_obligation_id: AVIEW-EXT|05646|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_05646_nosuchview SET (check_option = local, security_barrier = true);
-- primary-target-end
