...
-- primary_obligation_id: AVIEW-EXT|04491|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_04491_nosuchview RESET (security_barrier);
-- primary-target-end
