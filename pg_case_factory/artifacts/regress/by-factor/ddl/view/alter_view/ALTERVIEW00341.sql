...
-- primary_obligation_id: AVIEW-EXT|00341|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_00341_nosuchview ALTER "alterview_00341_col" DROP DEFAULT;
-- primary-target-end
