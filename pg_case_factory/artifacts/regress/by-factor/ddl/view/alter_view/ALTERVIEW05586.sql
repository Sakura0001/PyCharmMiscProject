...
-- primary_obligation_id: AVIEW-EXT|05586|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_05586_nosuchview SET (security_invoker = false);
-- primary-target-end
