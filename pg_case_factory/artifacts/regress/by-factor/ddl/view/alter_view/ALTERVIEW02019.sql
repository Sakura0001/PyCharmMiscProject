...
-- primary_obligation_id: AVIEW-EXT|02019|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_02019_nosuchview OWNER TO alterview_02019_nosuchrole;
-- primary-target-end
