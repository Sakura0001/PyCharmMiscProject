...
-- primary_obligation_id: AVIEW-EXT|06534|error_assertion|drop_view_if_exists
...
ALTER VIEW alterview_06534_nosuchview RESET (security_barrier);
-- primary-target-end
