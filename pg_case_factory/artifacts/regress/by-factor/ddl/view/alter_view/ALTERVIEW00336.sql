...
-- primary_obligation_id: AVIEW-EXT|00336|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_00336_nosuchview ALTER "alterview_00336_col" DROP DEFAULT;
-- primary-target-end
