...
-- primary_obligation_id: AVIEW-EXT|02560|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_02560_nosuchview ALTER alterview_02560_col DROP DEFAULT;
-- primary-target-end
