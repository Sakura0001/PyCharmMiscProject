...
-- primary_obligation_id: AVIEW-EXT|07495|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_07495_nosuchview ALTER COLUMN alterview_07495_col SET DEFAULT 1;
-- primary-target-end
