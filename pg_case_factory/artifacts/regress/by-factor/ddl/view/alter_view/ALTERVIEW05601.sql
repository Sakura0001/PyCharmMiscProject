...
-- primary_obligation_id: AVIEW-EXT|05601|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_05601_nosuchview SET (security_invoker = true);
-- primary-target-end
