...
-- primary_obligation_id: AVIEW-EXT|06426|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_06426_nosuchview RESET (security_barrier);
-- primary-target-end
