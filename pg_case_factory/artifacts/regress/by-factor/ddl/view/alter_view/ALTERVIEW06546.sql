...
-- primary_obligation_id: AVIEW-EXT|06546|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_06546_nosuchview RESET (security_invoker);
-- primary-target-end
