...
-- primary_obligation_id: AVIEW-EXT|03670|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_03670_nosuchview RENAME TO alterview_03670_newview;
-- primary-target-end
