...
-- primary_obligation_id: AVIEW-EXT|06532|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06532_nosuchview RESET (security_barrier);
-- primary-target-end
