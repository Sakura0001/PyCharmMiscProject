...
-- primary_obligation_id: AVIEW-EXT|06864|error_assertion|drop_view_if_exists
...
ALTER VIEW alterview_06864_nosuchview SET (check_option = local, security_barrier = true);
-- primary-target-end
