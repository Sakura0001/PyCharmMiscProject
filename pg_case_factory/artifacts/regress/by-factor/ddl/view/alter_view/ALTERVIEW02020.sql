...
-- primary_obligation_id: AVIEW-EXT|02020|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_02020_nosuchview OWNER TO alterview_02020_nosuchrole;
-- primary-target-end
