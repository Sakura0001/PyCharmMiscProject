...
-- primary_obligation_id: AVIEW-EXT|04746|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_04746_nosuchview ALTER alterview_04746_col SET DEFAULT 1;
-- primary-target-end
