...
-- primary_obligation_id: AVIEW-EXT|02545|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_02545_nosuchview ALTER alterview_02545_col DROP DEFAULT;
-- primary-target-end
