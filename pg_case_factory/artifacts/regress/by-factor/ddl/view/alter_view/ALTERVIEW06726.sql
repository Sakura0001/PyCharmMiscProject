...
-- primary_obligation_id: AVIEW-EXT|06726|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_06726_nosuchview SET (check_option = cascaded);
-- primary-target-end
