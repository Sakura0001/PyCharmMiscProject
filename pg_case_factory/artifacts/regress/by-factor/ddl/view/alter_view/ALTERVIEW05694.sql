...
-- primary_obligation_id: AVIEW-EXT|05694|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_05694_nosuchview SET (security_invoker = false);
-- primary-target-end
