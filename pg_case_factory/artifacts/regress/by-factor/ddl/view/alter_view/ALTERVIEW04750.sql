...
-- primary_obligation_id: AVIEW-EXT|04750|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_04750_nosuchview ALTER alterview_04750_col SET DEFAULT 1;
-- primary-target-end
