...
-- primary_obligation_id: AVIEW-EXT|05665|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05665_nosuchview SET (security_barrier = false);
-- primary-target-end
