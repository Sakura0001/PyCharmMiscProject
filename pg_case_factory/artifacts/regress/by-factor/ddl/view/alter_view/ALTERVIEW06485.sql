...
-- primary_obligation_id: AVIEW-EXT|06485|information_schema_views|revert_alter
...
ALTER VIEW alterview_06485_nosuchview RESET (check_option);
-- primary-target-end
...
SELECT count(*) = 0 AS view_state FROM information_schema.views WHERE table_name = 'alterview_06485_nosuchview' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
