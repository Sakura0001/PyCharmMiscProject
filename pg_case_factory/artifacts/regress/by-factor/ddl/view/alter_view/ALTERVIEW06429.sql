...
-- primary_obligation_id: AVIEW-EXT|06429|error_assertion|drop_view_if_exists
...
ALTER VIEW alterview_06429_nosuchview RESET (security_barrier);
-- primary-target-end
