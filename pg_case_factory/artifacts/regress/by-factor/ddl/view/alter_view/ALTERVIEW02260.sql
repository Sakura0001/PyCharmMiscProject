...
-- primary_obligation_id: AVIEW-EXT|02260|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_02260_nosuchview SET SCHEMA pg_catalog;
-- primary-target-end
