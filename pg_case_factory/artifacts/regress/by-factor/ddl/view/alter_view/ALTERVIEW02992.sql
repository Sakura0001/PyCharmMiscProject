...
-- primary_obligation_id: AVIEW-EXT|02992|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_02992_nosuchview OWNER TO CURRENT_USER;
-- primary-target-end
