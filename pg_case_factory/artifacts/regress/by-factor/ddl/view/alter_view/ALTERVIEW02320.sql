...
-- primary_obligation_id: AVIEW-EXT|02320|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_02320_nosuchview SET SCHEMA alterview_02320_nosuchschema;
-- primary-target-end
