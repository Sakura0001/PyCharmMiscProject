...
-- primary_obligation_id: AVIEW-EXT|06772|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06772_nosuchview SET (security_barrier = false);
-- primary-target-end
