...
-- primary_obligation_id: AVIEW-EXT|07222|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_07222_nosuchview ALTER COLUMN alterview_07222_col DROP DEFAULT;
-- primary-target-end
