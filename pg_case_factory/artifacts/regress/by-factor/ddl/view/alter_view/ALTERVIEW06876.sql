...
-- primary_obligation_id: AVIEW-EXT|06876|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_06876_nosuchview SET (security_barrier = false);
-- primary-target-end
