...
-- primary_obligation_id: AVIEW-EXT|03097|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_03097_nosuchview OWNER TO SESSION_USER;
-- primary-target-end
