...
-- primary_obligation_id: AVIEW-EXT|05587|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05587_nosuchview SET (security_invoker = false);
-- primary-target-end
