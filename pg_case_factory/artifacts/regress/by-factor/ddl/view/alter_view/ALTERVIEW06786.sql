...
-- primary_obligation_id: AVIEW-EXT|06786|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_06786_nosuchview SET (security_barrier = true);
-- primary-target-end
