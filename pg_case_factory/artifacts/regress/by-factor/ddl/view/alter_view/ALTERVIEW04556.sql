...
-- primary_obligation_id: AVIEW-EXT|04556|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_04556_nosuchview RESET (check_option);
-- primary-target-end
