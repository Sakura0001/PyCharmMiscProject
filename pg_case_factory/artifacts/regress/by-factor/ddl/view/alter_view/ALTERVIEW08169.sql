...
-- primary_obligation_id: AVIEW-EXT|08169|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_08169_nosuchview ALTER alterview_08169_col SET DEFAULT 1;
-- primary-target-end
