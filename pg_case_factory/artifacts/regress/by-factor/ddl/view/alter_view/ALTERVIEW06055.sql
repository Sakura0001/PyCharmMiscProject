...
-- primary_obligation_id: AVIEW-EXT|06055|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06055_nosuchview OWNER TO SESSION_USER;
-- primary-target-end
