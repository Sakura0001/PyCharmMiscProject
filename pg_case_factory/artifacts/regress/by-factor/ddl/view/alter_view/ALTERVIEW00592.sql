...
-- primary_obligation_id: AVIEW-EXT|00592|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_00592_nosuchview ALTER "alterview_00592_col" SET DEFAULT 1;
-- primary-target-end
