...
-- primary_obligation_id: AVIEW-EXT|05576|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_05576_nosuchview SET (security_barrier = true);
-- primary-target-end
