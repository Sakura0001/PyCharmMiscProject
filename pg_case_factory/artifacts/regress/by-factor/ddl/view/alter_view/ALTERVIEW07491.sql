...
-- primary_obligation_id: AVIEW-EXT|07491|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_07491_nosuchview ALTER COLUMN alterview_07491_col SET DEFAULT 1;
-- primary-target-end
