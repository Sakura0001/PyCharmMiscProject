...
-- primary_obligation_id: AVIEW-EXT|00607|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_00607_nosuchview ALTER "alterview_00607_col" SET DEFAULT 1;
-- primary-target-end
