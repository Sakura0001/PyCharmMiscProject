...
-- primary_obligation_id: AVIEW-EXT|05529|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_05529_nosuchview SET (check_option = local);
-- primary-target-end
