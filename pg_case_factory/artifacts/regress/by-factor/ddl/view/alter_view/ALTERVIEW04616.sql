...
-- primary_obligation_id: AVIEW-EXT|04616|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_04616_nosuchview RESET (security_invoker);
-- primary-target-end
