...
-- primary_obligation_id: AVIEW-EXT|05512|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05512_nosuchview SET (check_option = cascaded);
-- primary-target-end
