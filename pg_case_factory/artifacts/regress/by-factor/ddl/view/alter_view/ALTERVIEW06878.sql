...
-- primary_obligation_id: AVIEW-EXT|06878|select_from_view|revert_alter
...
ALTER VIEW alterview_06878_nosuchview SET (security_barrier = false);
-- primary-target-end
