...
-- primary_obligation_id: AVIEW-EXT|04627|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_04627_nosuchview RESET (security_invoker);
-- primary-target-end
