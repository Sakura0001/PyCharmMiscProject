...
-- primary_obligation_id: AVIEW-EXT|07901|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_07901_nosuchview ALTER alterview_07901_col DROP DEFAULT;
-- primary-target-end
