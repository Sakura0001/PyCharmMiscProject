...
-- primary_obligation_id: AVIEW-EXT|03531|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_03531_nosuchview RENAME TO alterview_03531_newview;
-- primary-target-end
