...
-- primary_obligation_id: AVIEW-EXT|05560|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05560_nosuchview SET (security_barrier = false);
-- primary-target-end
