...
-- primary_obligation_id: AVIEW-EXT|03669|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_03669_nosuchview RENAME TO alterview_03669_newview;
-- primary-target-end
