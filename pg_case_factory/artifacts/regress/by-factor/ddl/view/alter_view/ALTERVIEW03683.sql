...
-- primary_obligation_id: AVIEW-EXT|03683|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_03683_nosuchview RENAME TO alterview_03683_newview;
-- primary-target-end
