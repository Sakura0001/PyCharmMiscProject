...
-- primary_obligation_id: AVIEW-EXT|04763|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_04763_nosuchview ALTER alterview_04763_col SET DEFAULT 1;
-- primary-target-end
