...
-- primary_obligation_id: AVIEW-EXT|02016|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_02016_nosuchview OWNER TO alterview_02016_nosuchrole;
-- primary-target-end
