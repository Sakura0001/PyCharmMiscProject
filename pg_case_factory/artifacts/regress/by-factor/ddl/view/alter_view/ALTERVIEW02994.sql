...
-- primary_obligation_id: AVIEW-EXT|02994|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_02994_nosuchview OWNER TO CURRENT_USER;
-- primary-target-end
