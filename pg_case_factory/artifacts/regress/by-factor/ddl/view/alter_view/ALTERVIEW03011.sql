...
-- primary_obligation_id: AVIEW-EXT|03011|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_03011_nosuchview OWNER TO CURRENT_USER;
-- primary-target-end
