...
-- primary_obligation_id: AVIEW-EXT|06788|select_from_view|revert_alter
...
ALTER VIEW alterview_06788_nosuchview SET (security_barrier = true);
-- primary-target-end
