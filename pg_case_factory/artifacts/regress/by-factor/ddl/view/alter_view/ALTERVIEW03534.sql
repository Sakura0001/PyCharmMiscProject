...
-- primary_obligation_id: AVIEW-EXT|03534|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_03534_nosuchview RENAME TO alterview_03534_newview;
-- primary-target-end
