...
-- primary_obligation_id: AVIEW-EXT|03098|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_03098_nosuchview OWNER TO SESSION_USER;
-- primary-target-end
