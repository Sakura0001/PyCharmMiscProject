...
-- primary_obligation_id: AVIEW-EXT|05591|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_05591_nosuchview SET (security_invoker = false);
-- primary-target-end
