...
-- primary_obligation_id: AVIEW-EXT|02036|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_02036_nosuchview OWNER TO alterview_02036_nosuchrole;
-- primary-target-end
