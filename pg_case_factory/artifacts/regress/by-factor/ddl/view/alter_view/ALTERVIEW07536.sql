...
-- primary_obligation_id: AVIEW-EXT|07536|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_07536_nosuchview ALTER COLUMN alterview_07536_col DROP DEFAULT;
-- primary-target-end
