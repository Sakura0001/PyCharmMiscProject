...
-- primary_obligation_id: AVIEW-EXT|07236|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_07236_nosuchview ALTER COLUMN alterview_07236_col DROP DEFAULT;
-- primary-target-end
