...
-- primary_obligation_id: AVIEW-EXT|05511|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_05511_nosuchview SET (check_option = cascaded);
-- primary-target-end
