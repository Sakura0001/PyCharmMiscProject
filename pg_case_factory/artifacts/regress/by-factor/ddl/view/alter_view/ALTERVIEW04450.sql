...
-- primary_obligation_id: AVIEW-EXT|04450|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_04450_nosuchview RESET (check_option);
-- primary-target-end
