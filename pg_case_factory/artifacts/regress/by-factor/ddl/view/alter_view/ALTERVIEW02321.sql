...
-- primary_obligation_id: AVIEW-EXT|02321|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_02321_nosuchview SET SCHEMA alterview_02321_nosuchschema;
-- primary-target-end
