...
-- primary_obligation_id: AVIEW-EXT|05681|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_05681_nosuchview SET (security_barrier = true);
-- primary-target-end
