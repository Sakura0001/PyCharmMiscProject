...
-- primary_obligation_id: AVIEW-EXT|06729|error_assertion|drop_view_if_exists
...
ALTER VIEW alterview_06729_nosuchview SET (check_option = cascaded);
-- primary-target-end
