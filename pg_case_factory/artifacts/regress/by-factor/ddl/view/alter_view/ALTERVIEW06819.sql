...
-- primary_obligation_id: AVIEW-EXT|06819|error_assertion|drop_view_if_exists
...
ALTER VIEW alterview_06819_nosuchview SET (security_invoker = true);
-- primary-target-end
