...
-- primary_obligation_id: AVIEW-EXT|06891|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_06891_nosuchview SET (security_barrier = true);
-- primary-target-end
