...
-- primary_obligation_id: AVIEW-EXT|04521|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_04521_nosuchview RESET (security_invoker);
-- primary-target-end
