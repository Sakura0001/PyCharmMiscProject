...
-- primary_obligation_id: AVIEW-EXT|06757|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06757_nosuchview SET (check_option = local, security_barrier = true);
-- primary-target-end
