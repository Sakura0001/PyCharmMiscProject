...
-- primary_obligation_id: AVIEW-EXT|02993|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_02993_nosuchview OWNER TO CURRENT_USER;
-- primary-target-end
