...
-- primary_obligation_id: AVIEW-EXT|03532|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_03532_nosuchview RENAME TO alterview_03532_newview;
-- primary-target-end
