...
-- primary_obligation_id: AVIEW-EXT|05558|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_05558_nosuchview SET (security_barrier = false);
-- primary-target-end
