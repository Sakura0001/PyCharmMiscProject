...
-- primary_obligation_id: AVIEW-EXT|04463|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_04463_nosuchview RESET (check_option, security_barrier);
-- primary-target-end
