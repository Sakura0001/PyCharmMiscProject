...
-- primary_obligation_id: AVIEW-EXT|02543|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_02543_nosuchview ALTER alterview_02543_col DROP DEFAULT;
-- primary-target-end
