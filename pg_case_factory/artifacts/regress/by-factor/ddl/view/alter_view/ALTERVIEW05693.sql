...
-- primary_obligation_id: AVIEW-EXT|05693|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_05693_nosuchview SET (security_invoker = false);
-- primary-target-end
