...
-- primary_obligation_id: AVIEW-EXT|06910|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06910_nosuchview SET (security_invoker = false);
-- primary-target-end
