...
-- primary_obligation_id: AVIEW-EXT|06907|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06907_nosuchview SET (security_invoker = false);
-- primary-target-end
