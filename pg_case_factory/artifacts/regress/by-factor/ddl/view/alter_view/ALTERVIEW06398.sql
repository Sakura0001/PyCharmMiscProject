...
-- primary_obligation_id: AVIEW-EXT|06398|select_from_view|revert_alter
...
ALTER VIEW alterview_06398_nosuchview RESET (check_option, security_barrier);
-- primary-target-end
