...
-- primary_obligation_id: AVIEW-EXT|04761|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_04761_nosuchview ALTER alterview_04761_col SET DEFAULT 1;
-- primary-target-end
