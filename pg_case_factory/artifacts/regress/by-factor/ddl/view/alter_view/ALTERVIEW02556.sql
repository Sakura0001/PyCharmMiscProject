...
-- primary_obligation_id: AVIEW-EXT|02556|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_02556_nosuchview ALTER alterview_02556_col DROP DEFAULT;
-- primary-target-end
