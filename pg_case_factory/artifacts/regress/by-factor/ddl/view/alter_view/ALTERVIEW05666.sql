...
-- primary_obligation_id: AVIEW-EXT|05666|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_05666_nosuchview SET (security_barrier = false);
-- primary-target-end
