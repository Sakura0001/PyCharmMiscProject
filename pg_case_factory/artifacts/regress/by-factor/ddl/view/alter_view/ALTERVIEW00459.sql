...
-- primary_obligation_id: AVIEW-EXT|00459|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_00459_nosuchview RENAME "alterview_00459_col" TO alterview_00459_newcol;
-- primary-target-end
