...
-- primary_obligation_id: AVIEW-EXT|06562|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06562_nosuchview RESET (security_invoker);
-- primary-target-end
