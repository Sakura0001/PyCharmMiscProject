...
-- primary_obligation_id: AVIEW-EXT|08182|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_08182_nosuchview ALTER alterview_08182_col SET DEFAULT 1;
-- primary-target-end
