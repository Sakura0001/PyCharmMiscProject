...
-- primary_obligation_id: AVIEW-EXT|05621|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_05621_nosuchview SET (check_option = cascaded);
-- primary-target-end
