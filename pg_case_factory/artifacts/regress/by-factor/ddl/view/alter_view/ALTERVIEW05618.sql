...
-- primary_obligation_id: AVIEW-EXT|05618|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_05618_nosuchview SET (check_option = cascaded);
-- primary-target-end
