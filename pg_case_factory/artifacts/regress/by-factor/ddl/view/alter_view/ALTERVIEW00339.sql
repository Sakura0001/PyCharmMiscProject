...
-- primary_obligation_id: AVIEW-EXT|00339|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_00339_nosuchview ALTER "alterview_00339_col" DROP DEFAULT;
-- primary-target-end
