...
-- primary_obligation_id: AVIEW-EXT|06816|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_06816_nosuchview SET (security_invoker = true);
-- primary-target-end
