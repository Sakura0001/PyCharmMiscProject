...
-- primary_obligation_id: AVIEW-EXT|05661|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_05661_nosuchview SET (security_barrier = false);
-- primary-target-end
