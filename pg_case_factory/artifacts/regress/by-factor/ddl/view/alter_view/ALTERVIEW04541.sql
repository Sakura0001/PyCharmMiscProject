...
-- primary_obligation_id: AVIEW-EXT|04541|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_04541_nosuchview RESET (check_option);
-- primary-target-end
