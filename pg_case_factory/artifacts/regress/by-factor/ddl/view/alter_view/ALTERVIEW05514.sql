...
-- primary_obligation_id: AVIEW-EXT|05514|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_05514_nosuchview SET (check_option = cascaded);
-- primary-target-end
