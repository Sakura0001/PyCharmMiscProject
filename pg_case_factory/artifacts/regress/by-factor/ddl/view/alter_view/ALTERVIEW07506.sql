...
-- primary_obligation_id: AVIEW-EXT|07506|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_07506_nosuchview ALTER COLUMN alterview_07506_col SET DEFAULT 1;
-- primary-target-end
