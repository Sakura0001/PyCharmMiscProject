...
-- primary_obligation_id: AVIEW-EXT|02271|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_02271_nosuchview SET SCHEMA pg_catalog;
-- primary-target-end
