...
-- primary_obligation_id: AVIEW-EXT|02962|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_02962_nosuchview OWNER TO CURRENT_ROLE;
-- primary-target-end
