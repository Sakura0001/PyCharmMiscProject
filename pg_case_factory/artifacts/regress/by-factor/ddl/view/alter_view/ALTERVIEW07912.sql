...
-- primary_obligation_id: AVIEW-EXT|07912|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_07912_nosuchview ALTER alterview_07912_col DROP DEFAULT;
-- primary-target-end
