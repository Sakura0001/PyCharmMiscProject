...
-- primary_obligation_id: AVIEW-EXT|06486|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_06486_nosuchview RESET (check_option);
-- primary-target-end
