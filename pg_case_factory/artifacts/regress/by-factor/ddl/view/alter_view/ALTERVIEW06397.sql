...
-- primary_obligation_id: AVIEW-EXT|06397|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06397_nosuchview RESET (check_option, security_barrier);
-- primary-target-end
