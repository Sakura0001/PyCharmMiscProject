...
-- primary_obligation_id: AVIEW-EXT|06459|error_assertion|drop_view_if_exists
...
ALTER VIEW alterview_06459_nosuchview RESET (security_invoker);
-- primary-target-end
