...
-- primary_obligation_id: AVIEW-EXT|03549|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_03549_nosuchview RENAME TO alterview_03549_newview;
-- primary-target-end
