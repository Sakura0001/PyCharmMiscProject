...
-- primary_obligation_id: AVIEW-EXT|05696|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_05696_nosuchview SET (security_invoker = false);
-- primary-target-end
