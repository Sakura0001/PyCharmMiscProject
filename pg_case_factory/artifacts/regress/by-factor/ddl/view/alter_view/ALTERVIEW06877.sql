...
-- primary_obligation_id: AVIEW-EXT|06877|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06877_nosuchview SET (security_barrier = false);
-- primary-target-end
