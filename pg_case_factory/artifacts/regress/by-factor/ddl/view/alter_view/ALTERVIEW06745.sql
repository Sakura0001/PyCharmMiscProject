...
-- primary_obligation_id: AVIEW-EXT|06745|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06745_nosuchview SET (check_option = local);
-- primary-target-end
