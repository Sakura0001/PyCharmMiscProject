...
-- primary_obligation_id: AVIEW-EXT|06771|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_06771_nosuchview SET (security_barrier = false);
-- primary-target-end
