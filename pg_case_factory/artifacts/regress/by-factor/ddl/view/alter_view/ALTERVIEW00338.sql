...
-- primary_obligation_id: AVIEW-EXT|00338|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_00338_nosuchview ALTER "alterview_00338_col" DROP DEFAULT;
-- primary-target-end
