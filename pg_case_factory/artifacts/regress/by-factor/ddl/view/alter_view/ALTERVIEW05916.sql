...
-- primary_obligation_id: AVIEW-EXT|05916|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_05916_nosuchview OWNER TO CURRENT_ROLE;
-- primary-target-end
