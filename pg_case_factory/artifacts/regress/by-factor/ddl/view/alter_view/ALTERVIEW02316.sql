...
-- primary_obligation_id: AVIEW-EXT|02316|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_02316_nosuchview SET SCHEMA alterview_02316_nosuchschema;
-- primary-target-end
