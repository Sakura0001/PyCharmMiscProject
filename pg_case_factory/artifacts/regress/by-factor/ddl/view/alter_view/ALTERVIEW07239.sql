...
-- primary_obligation_id: AVIEW-EXT|07239|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_07239_nosuchview ALTER COLUMN alterview_07239_col DROP DEFAULT;
-- primary-target-end
