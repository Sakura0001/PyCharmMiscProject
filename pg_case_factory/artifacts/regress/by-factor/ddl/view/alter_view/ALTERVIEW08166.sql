...
-- primary_obligation_id: AVIEW-EXT|08166|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_08166_nosuchview ALTER alterview_08166_col SET DEFAULT 1;
-- primary-target-end
