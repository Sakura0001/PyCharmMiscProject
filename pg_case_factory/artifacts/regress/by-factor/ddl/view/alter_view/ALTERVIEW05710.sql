...
-- primary_obligation_id: AVIEW-EXT|05710|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05710_nosuchview SET (security_invoker = true);
-- primary-target-end
