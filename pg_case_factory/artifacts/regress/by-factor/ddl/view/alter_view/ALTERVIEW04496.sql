...
-- primary_obligation_id: AVIEW-EXT|04496|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_04496_nosuchview RESET (security_barrier);
-- primary-target-end
