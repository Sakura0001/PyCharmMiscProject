...
-- primary_obligation_id: AVIEW-EXT|06880|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06880_nosuchview SET (security_barrier = false);
-- primary-target-end
