...
-- primary_obligation_id: AVIEW-EXT|06727|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06727_nosuchview SET (check_option = cascaded);
-- primary-target-end
