...
-- primary_obligation_id: AVIEW-EXT|05620|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_05620_nosuchview SET (check_option = cascaded);
-- primary-target-end
