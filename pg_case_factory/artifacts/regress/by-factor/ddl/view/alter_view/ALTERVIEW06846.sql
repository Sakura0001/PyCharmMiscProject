...
-- primary_obligation_id: AVIEW-EXT|06846|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_06846_nosuchview SET (check_option = local);
-- primary-target-end
