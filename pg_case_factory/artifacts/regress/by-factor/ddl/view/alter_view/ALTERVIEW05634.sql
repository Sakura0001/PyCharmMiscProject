...
-- primary_obligation_id: AVIEW-EXT|05634|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_05634_nosuchview SET (check_option = local);
-- primary-target-end
