...
-- primary_obligation_id: AVIEW-EXT|05636|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_05636_nosuchview SET (check_option = local);
-- primary-target-end
