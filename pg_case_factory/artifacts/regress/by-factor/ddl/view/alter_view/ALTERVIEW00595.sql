...
-- primary_obligation_id: AVIEW-EXT|00595|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_00595_nosuchview ALTER "alterview_00595_col" SET DEFAULT 1;
-- primary-target-end
