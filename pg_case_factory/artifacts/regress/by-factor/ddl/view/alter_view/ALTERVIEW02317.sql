...
-- primary_obligation_id: AVIEW-EXT|02317|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_02317_nosuchview SET SCHEMA alterview_02317_nosuchschema;
-- primary-target-end
