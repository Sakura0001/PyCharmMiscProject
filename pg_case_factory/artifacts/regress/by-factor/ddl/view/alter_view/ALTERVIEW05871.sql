...
-- primary_obligation_id: AVIEW-EXT|05871|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_05871_nosuchview ALTER alterview_05871_col DROP DEFAULT;
-- primary-target-end
