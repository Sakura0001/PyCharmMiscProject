...
-- primary_obligation_id: AVIEW-EXT|04599|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_04599_nosuchview RESET (security_barrier);
-- primary-target-end
