...
-- primary_obligation_id: AVIEW-EXT|06805|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06805_nosuchview SET (security_invoker = false);
-- primary-target-end
