...
-- primary_obligation_id: AVIEW-EXT|04480|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_04480_nosuchview RESET (security_barrier);
-- primary-target-end
