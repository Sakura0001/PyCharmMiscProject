...
-- primary_obligation_id: AVIEW-EXT|05574|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_05574_nosuchview SET (security_barrier = true);
-- primary-target-end
