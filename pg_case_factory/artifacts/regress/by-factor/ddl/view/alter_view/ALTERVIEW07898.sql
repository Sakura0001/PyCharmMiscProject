...
-- primary_obligation_id: AVIEW-EXT|07898|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_07898_nosuchview ALTER alterview_07898_col DROP DEFAULT;
-- primary-target-end
