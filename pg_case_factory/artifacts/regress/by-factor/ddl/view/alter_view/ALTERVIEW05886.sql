...
-- primary_obligation_id: AVIEW-EXT|05886|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_05886_nosuchview ALTER alterview_05886_col DROP DEFAULT;
-- primary-target-end
