...
-- primary_obligation_id: AVIEW-EXT|06925|error_assertion|drop_view_cascade
...
ALTER VIEW alterview_06925_nosuchview SET (security_invoker = true);
-- primary-target-end
