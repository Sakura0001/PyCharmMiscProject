...
-- primary_obligation_id: AVIEW-EXT|06487|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_06487_nosuchview RESET (check_option);
-- primary-target-end
