...
-- primary_obligation_id: AVIEW-EXT|00326|error_assertion|revert_alter
...
ALTER VIEW IF EXISTS alterview_00326_nosuchview ALTER "alterview_00326_col" DROP DEFAULT;
-- primary-target-end
