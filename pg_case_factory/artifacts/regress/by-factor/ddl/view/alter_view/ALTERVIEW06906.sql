...
-- primary_obligation_id: AVIEW-EXT|06906|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_06906_nosuchview SET (security_invoker = false);
-- primary-target-end
