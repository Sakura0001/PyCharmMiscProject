...
-- primary_obligation_id: AVIEW-EXT|02031|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_02031_nosuchview OWNER TO alterview_02031_nosuchrole;
-- primary-target-end
