...
-- primary_obligation_id: AVIEW-EXT|06401|error_assertion|revert_alter
...
ALTER VIEW alterview_06401_nosuchview RESET (check_option, security_barrier);
-- primary-target-end
