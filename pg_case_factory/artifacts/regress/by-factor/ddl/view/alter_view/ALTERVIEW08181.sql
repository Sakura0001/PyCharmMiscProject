...
-- primary_obligation_id: AVIEW-EXT|08181|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_08181_nosuchview ALTER alterview_08181_col SET DEFAULT 1;
-- primary-target-end
