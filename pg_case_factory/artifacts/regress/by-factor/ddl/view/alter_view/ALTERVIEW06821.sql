...
-- primary_obligation_id: AVIEW-EXT|06821|error_assertion|revert_alter
...
ALTER VIEW alterview_06821_nosuchview SET (security_invoker = true);
-- primary-target-end
