...
-- primary_obligation_id: AVIEW-EXT|04747|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_04747_nosuchview ALTER alterview_04747_col SET DEFAULT 1;
-- primary-target-end
