...
-- primary_obligation_id: AVIEW-EXT|04584|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_04584_nosuchview RESET (security_barrier);
-- primary-target-end
