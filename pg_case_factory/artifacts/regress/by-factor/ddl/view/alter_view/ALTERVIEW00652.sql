...
-- primary_obligation_id: AVIEW-EXT|00652|select_from_view|drop_view_cascade
...
ALTER VIEW alterview_00652_nosuchview ALTER "alterview_00652_col" DROP DEFAULT;
-- primary-target-end
