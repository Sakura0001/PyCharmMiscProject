...
-- primary_obligation_id: AVIEW-EXT|00321|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_00321_nosuchview ALTER "alterview_00321_col" DROP DEFAULT;
-- primary-target-end
