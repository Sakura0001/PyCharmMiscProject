...
-- primary_obligation_id: AVIEW-EXT|06506|error_assertion|revert_alter
...
ALTER VIEW alterview_06506_nosuchview RESET (check_option, security_barrier);
-- primary-target-end
