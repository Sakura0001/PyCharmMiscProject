...
-- primary_obligation_id: AVIEW-EXT|07899|error_assertion|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_07899_nosuchview ALTER alterview_07899_col DROP DEFAULT;
-- primary-target-end
