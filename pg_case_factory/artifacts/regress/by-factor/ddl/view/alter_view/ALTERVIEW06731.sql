...
-- primary_obligation_id: AVIEW-EXT|06731|error_assertion|revert_alter
...
ALTER VIEW alterview_06731_nosuchview SET (check_option = cascaded);
-- primary-target-end
