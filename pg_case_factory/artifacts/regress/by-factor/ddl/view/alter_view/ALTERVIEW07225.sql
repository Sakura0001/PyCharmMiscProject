...
-- primary_obligation_id: AVIEW-EXT|07225|error_assertion|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_07225_nosuchview ALTER COLUMN alterview_07225_col DROP DEFAULT;
-- primary-target-end
