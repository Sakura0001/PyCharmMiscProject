...
-- primary_obligation_id: AVIEW-EXT|07896|select_from_view|drop_view_if_exists
...
ALTER VIEW IF EXISTS alterview_07896_nosuchview ALTER alterview_07896_col DROP DEFAULT;
-- primary-target-end
