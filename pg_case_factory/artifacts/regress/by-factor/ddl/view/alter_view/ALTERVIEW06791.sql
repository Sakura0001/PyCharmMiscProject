...
-- primary_obligation_id: AVIEW-EXT|06791|error_assertion|revert_alter
...
ALTER VIEW alterview_06791_nosuchview SET (security_barrier = true);
-- primary-target-end
