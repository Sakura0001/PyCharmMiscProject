...
-- primary_obligation_id: AVIEW-EXT|06833|select_from_view|revert_alter
...
ALTER VIEW alterview_06833_nosuchview SET (check_option = cascaded);
-- primary-target-end
