...
-- primary_obligation_id: AVIEW-EXT|06776|error_assertion|revert_alter
...
ALTER VIEW alterview_06776_nosuchview SET (security_barrier = false);
-- primary-target-end
