...
-- primary_obligation_id: AVIEW-EXT|06381|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_06381_nosuchview RESET (check_option);
-- primary-target-end
