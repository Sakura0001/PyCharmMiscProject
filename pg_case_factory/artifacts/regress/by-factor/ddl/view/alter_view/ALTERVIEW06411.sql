...
-- primary_obligation_id: AVIEW-EXT|06411|select_from_view|drop_view_if_exists
...
ALTER VIEW alterview_06411_nosuchview RESET (security_barrier);
-- primary-target-end
