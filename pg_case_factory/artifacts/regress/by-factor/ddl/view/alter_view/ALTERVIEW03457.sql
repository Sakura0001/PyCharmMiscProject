...
-- primary_obligation_id: AVIEW-EXT|03457|select_from_view|drop_view_cascade
...
ALTER VIEW IF EXISTS alterview_03457_nosuchview RENAME TO "alterview_03457_newview";
-- primary-target-end
