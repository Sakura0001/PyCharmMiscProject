...
-- primary_obligation_id: AVIEW-EXT|04583|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_04583_nosuchview RESET (security_barrier);
-- primary-target-end
