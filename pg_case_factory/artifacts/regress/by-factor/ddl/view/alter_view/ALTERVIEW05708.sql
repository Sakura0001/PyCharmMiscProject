...
-- primary_obligation_id: AVIEW-EXT|05708|select_from_view|revert_alter
...
ALTER VIEW IF EXISTS alterview_05708_nosuchview SET (security_invoker = true);
-- primary-target-end
