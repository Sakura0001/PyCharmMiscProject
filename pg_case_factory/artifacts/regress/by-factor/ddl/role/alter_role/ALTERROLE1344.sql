...
-- primary_obligation_id: ALTERROLE-EXT|1344|set_value|pg_settings_catalog|revert_attribute_change
...
ALTER ROLE ALL IN DATABASE alterrole_1344_nodb SET work_mem TO 100;
-- primary-target-end
