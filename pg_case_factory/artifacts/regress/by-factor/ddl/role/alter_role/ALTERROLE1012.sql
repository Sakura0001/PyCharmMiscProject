...
-- primary_obligation_id: ALTERROLE-EXT|1012|set_value|pg_settings_catalog|reset_config_parameter
...
ALTER ROLE ALL IN DATABASE alterrole_1012_nodb SET work_mem TO 100;
-- primary-target-end
