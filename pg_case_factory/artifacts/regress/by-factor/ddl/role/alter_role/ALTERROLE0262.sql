...
-- primary_obligation_id: ALTERROLE-EXT|0262|reset_all|pg_settings_catalog|reset_config_parameter
...
ALTER ROLE ALL IN DATABASE alterrole_0262_nodb RESET ALL;
-- primary-target-end
