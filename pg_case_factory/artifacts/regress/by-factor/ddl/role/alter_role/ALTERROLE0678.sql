...
-- primary_obligation_id: ALTERROLE-EXT|0678|set_value|error_assertion|revert_attribute_change
...
ALTER ROLE ALL IN DATABASE alterrole_0678_nodb SET work_mem TO 100;
-- primary-target-end
