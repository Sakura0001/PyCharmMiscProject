...
-- primary_obligation_id: ALTERROLE-EXT|0667|set_value|pg_settings_catalog|reset_config_parameter
...
ALTER ROLE ALL IN DATABASE alterrole_0667_nodb SET work_mem TO 100;
-- primary-target-end
