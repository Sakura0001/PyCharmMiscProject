...
-- primary_obligation_id: ALTERROLE-EXT|1349|set_value|effect_query|drop_role
...
ALTER ROLE ALL IN DATABASE alterrole_1349_nodb SET work_mem TO 100;
-- primary-target-end
