...
-- primary_obligation_id: ALTERROLE-EXT|1014|set_value|pg_settings_catalog|revert_attribute_change
...
ALTER ROLE ALL IN DATABASE alterrole_1014_nodb SET work_mem TO 100;
-- primary-target-end
