...
-- primary_obligation_id: ALTERROLE-EXT|1353|set_value|error_assertion|revert_attribute_change
...
ALTER ROLE ALL IN DATABASE alterrole_1353_nodb SET work_mem TO 100;
-- primary-target-end
