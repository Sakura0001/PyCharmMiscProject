...
-- primary_obligation_id: ALTERROLE-EXT|0669|set_value|pg_settings_catalog|revert_attribute_change
...
ALTER ROLE ALL IN DATABASE alterrole_0669_nodb SET work_mem TO 100;
-- primary-target-end
