...
-- primary_obligation_id: ALTERROLE-EXT|1019|set_value|effect_query|drop_role
...
ALTER ROLE ALL IN DATABASE alterrole_1019_nodb SET work_mem TO 100;
-- primary-target-end
