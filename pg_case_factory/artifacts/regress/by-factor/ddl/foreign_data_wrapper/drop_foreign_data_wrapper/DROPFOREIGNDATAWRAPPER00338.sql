...
-- ++
-- --------------------------------------------------------
-- case_id: DROPFOREIGNDATAWRAPPER00338
...
-- primary_obligation_id: DROPFOREIGNDATAWRAPPER-EXT|00338|drop_foreign_data_wrapper|error_assertion|recreate_server
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP FOREIGN DATA WRAPPER IF EXISTS dropforeigndatawrapper_00338_fdw CASCADE;
...
SELECT count(*) = 0 AS fdw_absent FROM pg_catalog.pg_foreign_data_wrapper WHERE fdwname = 'dropforeigndatawrapper_00338_fdw' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
DROP FOREIGN DATA WRAPPER IF EXISTS dropforeigndatawrapper_00338_fdw CASCADE;
