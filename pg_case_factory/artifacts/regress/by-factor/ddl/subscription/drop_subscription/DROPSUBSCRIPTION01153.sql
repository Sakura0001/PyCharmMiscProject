...
-- primary_obligation_id: DROPSUBSCRIPTION-EXT|01153|drop_subscription|pg_subscription_catalog|drop_subscription_cascade
...
CREATE SUBSCRIPTION "user" CONNECTION 'host=127.0.0.1 port=1 dbname=dummy' PUBLICATION dummy_pub WITH (connect = false);
