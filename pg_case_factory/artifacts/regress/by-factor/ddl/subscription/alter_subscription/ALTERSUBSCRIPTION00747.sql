...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERSUBSCRIPTION00747
...
-- primary_obligation_id: ASUB-EXT|00747|error_assertion|drop_subscription
...
ALTER SUBSCRIPTION alter_subscription_00747_no_such_sub SKIP (lsn = '0/0');
-- primary-target-end
