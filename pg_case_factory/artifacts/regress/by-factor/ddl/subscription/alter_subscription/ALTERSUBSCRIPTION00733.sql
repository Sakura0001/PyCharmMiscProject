...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERSUBSCRIPTION00733
...
-- primary_obligation_id: ASUB-EXT|00733|error_assertion|drop_subscription
...
ALTER SUBSCRIPTION alter_subscription_00733_no_such_sub SET (streaming = true);
-- primary-target-end
