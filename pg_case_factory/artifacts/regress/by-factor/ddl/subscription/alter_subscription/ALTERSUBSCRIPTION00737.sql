...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERSUBSCRIPTION00737
...
-- primary_obligation_id: ASUB-EXT|00737|error_assertion|drop_subscription
...
ALTER SUBSCRIPTION alter_subscription_00737_no_such_sub SET (two_phase = true);
-- primary-target-end
