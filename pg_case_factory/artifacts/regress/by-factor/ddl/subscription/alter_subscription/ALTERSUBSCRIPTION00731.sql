...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERSUBSCRIPTION00731
...
-- primary_obligation_id: ASUB-EXT|00731|error_assertion|drop_subscription
...
ALTER SUBSCRIPTION alter_subscription_00731_no_such_sub SET (binary = true);
-- primary-target-end
