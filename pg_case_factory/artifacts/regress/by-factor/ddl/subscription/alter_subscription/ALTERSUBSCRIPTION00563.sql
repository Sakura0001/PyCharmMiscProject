...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERSUBSCRIPTION00563
...
-- primary_obligation_id: ASUB-EXT|00563|error_assertion|drop_subscription
...
ALTER SUBSCRIPTION alter_subscription_00563_no_such_sub CONNECTION 'host=localhost port=5432 dbname=pgcf';
-- primary-target-end
