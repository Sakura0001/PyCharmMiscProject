...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERSUBSCRIPTION00593
...
-- primary_obligation_id: ASUB-EXT|00593|error_assertion|drop_subscription
...
ALTER SUBSCRIPTION alter_subscription_00593_no_such_sub OWNER TO SESSION_USER;
-- primary-target-end
