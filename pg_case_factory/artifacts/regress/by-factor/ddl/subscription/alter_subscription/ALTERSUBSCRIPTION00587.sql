...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERSUBSCRIPTION00587
...
-- primary_obligation_id: ASUB-EXT|00587|error_assertion|drop_subscription
...
ALTER SUBSCRIPTION alter_subscription_00587_no_such_sub OWNER TO CURRENT_ROLE;
-- primary-target-end
