...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERSUBSCRIPTION00595
...
-- primary_obligation_id: ASUB-EXT|00595|error_assertion|drop_subscription
...
ALTER SUBSCRIPTION alter_subscription_00595_no_such_sub REFRESH PUBLICATION WITH (copy_data = false);
-- primary-target-end
