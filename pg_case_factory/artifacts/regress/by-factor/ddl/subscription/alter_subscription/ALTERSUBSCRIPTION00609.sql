...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERSUBSCRIPTION00609
...
-- primary_obligation_id: ASUB-EXT|00609|error_assertion|drop_subscription
...
ALTER SUBSCRIPTION alter_subscription_00609_no_such_sub REFRESH PUBLICATION WITH (copy_data = true);
-- primary-target-end
