...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERSUBSCRIPTION00727
...
-- primary_obligation_id: ASUB-EXT|00727|error_assertion|drop_subscription
...
ALTER SUBSCRIPTION alter_subscription_00727_no_such_sub SET (failover = true);
-- primary-target-end
