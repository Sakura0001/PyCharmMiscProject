...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERSUBSCRIPTION00729
...
-- primary_obligation_id: ASUB-EXT|00729|error_assertion|drop_subscription
...
ALTER SUBSCRIPTION alter_subscription_00729_no_such_sub SET (binary = true, streaming = true);
-- primary-target-end
