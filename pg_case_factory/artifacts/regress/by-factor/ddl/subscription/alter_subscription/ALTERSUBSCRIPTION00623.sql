...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERSUBSCRIPTION00623
...
-- primary_obligation_id: ASUB-EXT|00623|error_assertion|drop_subscription
...
ALTER SUBSCRIPTION alter_subscription_00623_no_such_sub REFRESH PUBLICATION;
-- primary-target-end
