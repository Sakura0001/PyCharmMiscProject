...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERSUBSCRIPTION00589
...
-- primary_obligation_id: ASUB-EXT|00589|error_assertion|drop_subscription
...
ALTER SUBSCRIPTION alter_subscription_00589_no_such_sub OWNER TO CURRENT_USER;
-- primary-target-end
