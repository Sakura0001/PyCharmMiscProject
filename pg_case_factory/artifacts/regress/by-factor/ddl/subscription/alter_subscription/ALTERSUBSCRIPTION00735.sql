...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERSUBSCRIPTION00735
...
-- primary_obligation_id: ASUB-EXT|00735|error_assertion|drop_subscription
...
ALTER SUBSCRIPTION alter_subscription_00735_no_such_sub SET (synchronous_commit = off);
-- primary-target-end
