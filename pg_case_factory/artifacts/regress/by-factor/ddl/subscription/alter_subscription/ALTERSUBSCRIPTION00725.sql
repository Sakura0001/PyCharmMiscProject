...
-- ++
-- --------------------------------------------------------
-- case_id: ALTERSUBSCRIPTION00725
...
-- primary_obligation_id: ASUB-EXT|00725|error_assertion|drop_subscription
...
ALTER SUBSCRIPTION alter_subscription_00725_no_such_sub SET (binary = true);
-- primary-target-end
