...
-- primary_obligation_id: DROPDOMAIN-EXT|00389|drop_domain|error_assertion|drop_domain
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP DOMAIN IF EXISTS dropdomain_00389_dom CASCADE;
...
DROP DOMAIN dropdomain_00389_dom RESTRICT;
-- primary-target-end
...
SELECT count(*) = 0 AS domain_absent FROM pg_catalog.pg_type WHERE typname = 'dropdomain_00389_dom' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
DROP DOMAIN IF EXISTS dropdomain_00389_dom CASCADE;
