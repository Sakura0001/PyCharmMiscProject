...
-- primary_obligation_id: CP-EXT|00376|effect_query|reset_state
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS checkpoint_00376_data;
\set ON_ERROR_STOP on
-- 2. 创建完整本地规则和因子专用夹具。
CREATE TABLE checkpoint_00376_data (id integer, payload text);
INSERT INTO checkpoint_00376_data VALUES (1, 'checkpoint_fixture');
