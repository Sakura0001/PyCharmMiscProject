...
-- primary_obligation_id: CP-EXT|09239|catalog_query|rollback
...
-- 2. 创建完整本地规则和因子专用夹具。
CREATE TABLE checkpoint_09239_data (id integer, payload text);
INSERT INTO checkpoint_09239_data VALUES (1, 'checkpoint_fixture');
