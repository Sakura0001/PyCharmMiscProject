...
-- primary_obligation_id: CP-EXT|04555|returned_rows|reset_state
...
-- 2. 创建完整本地规则和因子专用夹具。
CREATE TABLE checkpoint_04555_data (id integer, payload text);
INSERT INTO checkpoint_04555_data VALUES (1, 'checkpoint_fixture');
...
SELECT count(*) AS row_count FROM checkpoint_04555_data ORDER BY count(*);
-- 5. 清理全部本编号对象。
DROP TABLE IF EXISTS checkpoint_04555_data;
