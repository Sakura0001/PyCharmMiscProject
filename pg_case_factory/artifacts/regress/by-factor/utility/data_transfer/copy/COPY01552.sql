...
-- primary_obligation_id: COPY-EXT|01552|catalog_query|rollback
...
COPY public.copy_01552_t (copy_01552_c) FROM 'copy_01552_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'copy_01552_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
