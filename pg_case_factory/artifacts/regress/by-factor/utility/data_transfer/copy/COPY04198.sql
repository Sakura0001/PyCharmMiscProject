...
-- primary_obligation_id: COPY-EXT|04198|returned_rows|rollback
...
COPY public.copy_04198_t (copy_04198_c) TO STDOUT;
-- primary-target-end
...
SELECT count(*) = 0 AS no_copy FROM pg_catalog.pg_class WHERE relname = 'copy_04198_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
