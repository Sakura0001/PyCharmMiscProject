...
-- primary_obligation_id: COPY-EXT|00426|catalog_query|reset_state
...
COPY copy_00426_t FROM 'copy_00426_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'copy_00426_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
