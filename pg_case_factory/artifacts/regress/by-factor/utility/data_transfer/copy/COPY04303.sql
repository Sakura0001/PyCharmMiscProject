...
-- primary_obligation_id: COPY-EXT|04303|effect_query|rollback
...
COPY "copy_04303_t" (copy_04303_c) TO STDOUT;
-- primary-target-end
...
SELECT count(*) = 0 AS no_table FROM pg_catalog.pg_class WHERE relname = 'copy_04303_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
