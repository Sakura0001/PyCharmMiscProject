...
-- primary_obligation_id: COPY-EXT|00979|effect_query|rollback
...
COPY copy_00979_t FROM 'copy_00979_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_table FROM pg_catalog.pg_class WHERE relname = 'copy_00979_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
