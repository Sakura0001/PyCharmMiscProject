...
-- primary_obligation_id: COPY-EXT|01005|effect_query|reset_state
...
COPY public.copy_01005_t FROM 'copy_01005_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_table FROM pg_catalog.pg_class WHERE relname = 'copy_01005_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
