...
-- primary_obligation_id: COPY-EXT|03192|returned_rows|reset_state
...
COPY copy_03192_t TO 'copy_03192_out.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_copy FROM pg_catalog.pg_class WHERE relname = 'copy_03192_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
