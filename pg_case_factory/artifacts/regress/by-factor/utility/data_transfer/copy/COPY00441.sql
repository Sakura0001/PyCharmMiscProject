...
-- primary_obligation_id: COPY-EXT|00441|effect_query|reset_state
...
COPY "copy_00441_t" FROM 'copy_00441_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_table FROM pg_catalog.pg_class WHERE relname = 'copy_00441_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
