...
-- primary_obligation_id: COPY-EXT|03090|catalog_query|reset_state
...
COPY public.copy_03090_t TO 'copy_03090_out.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'copy_03090_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
