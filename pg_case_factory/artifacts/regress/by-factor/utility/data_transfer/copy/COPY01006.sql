...
-- primary_obligation_id: COPY-EXT|01006|returned_rows|rollback
...
COPY public.copy_01006_t FROM 'copy_01006_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_copy FROM pg_catalog.pg_class WHERE relname = 'copy_01006_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
