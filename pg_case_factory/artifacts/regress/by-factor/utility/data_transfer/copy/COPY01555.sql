...
-- primary_obligation_id: COPY-EXT|01555|effect_query|rollback
...
COPY public.copy_01555_t (copy_01555_c) FROM 'copy_01555_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_table FROM pg_catalog.pg_class WHERE relname = 'copy_01555_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
