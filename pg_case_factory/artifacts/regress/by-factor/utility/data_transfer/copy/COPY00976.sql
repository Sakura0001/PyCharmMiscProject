...
-- primary_obligation_id: COPY-EXT|00976|catalog_query|rollback
...
COPY copy_00976_t FROM 'copy_00976_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'copy_00976_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
