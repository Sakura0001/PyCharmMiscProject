...
-- primary_obligation_id: COPY-EXT|04290|catalog_query|reset_state
...
COPY copy_04290_t (copy_04290_c) TO STDOUT;
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'copy_04290_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
