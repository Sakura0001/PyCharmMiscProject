...
-- primary_obligation_id: COPY-EXT|00427|effect_query|rollback
...
COPY copy_00427_t FROM 'copy_00427_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_table FROM pg_catalog.pg_class WHERE relname = 'copy_00427_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
