...
-- primary_obligation_id: COPY-EXT|03082|returned_rows|rollback
...
COPY "copy_03082_t" TO 'copy_03082_out.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_copy FROM pg_catalog.pg_class WHERE relname = 'copy_03082_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
