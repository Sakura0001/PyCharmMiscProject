...
-- primary_obligation_id: COPY-EXT|04185|effect_query|reset_state
...
COPY "copy_04185_t" (copy_04185_c) TO STDOUT;
-- primary-target-end
...
SELECT count(*) = 0 AS no_table FROM pg_catalog.pg_class WHERE relname = 'copy_04185_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
