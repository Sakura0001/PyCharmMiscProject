...
-- primary_obligation_id: COPY-EXT|04174|returned_rows|rollback
...
COPY copy_04174_t (copy_04174_c) TO STDOUT;
-- primary-target-end
...
SELECT count(*) = 0 AS no_copy FROM pg_catalog.pg_class WHERE relname = 'copy_04174_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
