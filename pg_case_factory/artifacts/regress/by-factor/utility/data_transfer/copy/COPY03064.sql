...
-- primary_obligation_id: COPY-EXT|03064|catalog_query|rollback
...
COPY copy_03064_t TO 'copy_03064_out.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'copy_03064_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
