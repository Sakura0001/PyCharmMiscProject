...
-- primary_obligation_id: COPY-EXT|04188|returned_rows|reset_state
...
COPY "copy_04188_t" (copy_04188_c) TO STDOUT;
-- primary-target-end
...
SELECT count(*) = 0 AS no_copy FROM pg_catalog.pg_class WHERE relname = 'copy_04188_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
