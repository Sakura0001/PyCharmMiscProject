...
-- primary_obligation_id: COPY-EXT|01962|catalog_query|reset_state
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'copy_01962_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
