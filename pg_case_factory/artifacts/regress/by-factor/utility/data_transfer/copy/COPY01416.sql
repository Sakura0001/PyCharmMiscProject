...
-- primary_obligation_id: COPY-EXT|01416|returned_rows|reset_state
...
COPY copy_01416_t (copy_01416_c) FROM 'copy_01416_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_copy FROM pg_catalog.pg_class WHERE relname = 'copy_01416_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
