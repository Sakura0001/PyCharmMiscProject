...
-- primary_obligation_id: COPY-EXT|01545|effect_query|reset_state
...
COPY "copy_01545_t" (copy_01545_c) FROM 'copy_01545_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_table FROM pg_catalog.pg_class WHERE relname = 'copy_01545_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
