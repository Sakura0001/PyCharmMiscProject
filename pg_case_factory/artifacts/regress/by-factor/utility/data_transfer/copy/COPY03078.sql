...
-- primary_obligation_id: COPY-EXT|03078|catalog_query|reset_state
...
COPY "copy_03078_t" TO 'copy_03078_out.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'copy_03078_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
