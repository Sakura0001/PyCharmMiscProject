...
-- primary_obligation_id: COPY-EXT|00436|catalog_query|rollback
...
COPY "copy_00436_t" FROM 'copy_00436_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'copy_00436_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
