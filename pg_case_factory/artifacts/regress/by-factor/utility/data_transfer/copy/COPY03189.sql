...
-- primary_obligation_id: COPY-EXT|03189|effect_query|reset_state
...
COPY copy_03189_t TO 'copy_03189_out.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_table FROM pg_catalog.pg_class WHERE relname = 'copy_03189_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
