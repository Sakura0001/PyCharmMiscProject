...
-- primary_obligation_id: COPY-EXT|00993|effect_query|reset_state
...
COPY "copy_00993_t" FROM 'copy_00993_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_table FROM pg_catalog.pg_class WHERE relname = 'copy_00993_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
