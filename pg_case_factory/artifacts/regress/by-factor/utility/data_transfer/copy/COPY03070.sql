...
-- primary_obligation_id: COPY-EXT|03070|returned_rows|rollback
...
COPY copy_03070_t TO 'copy_03070_out.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_copy FROM pg_catalog.pg_class WHERE relname = 'copy_03070_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
