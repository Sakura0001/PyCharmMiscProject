...
-- primary_obligation_id: COPY-EXT|03076|catalog_query|rollback
...
COPY "copy_03076_t" TO 'copy_03076_out.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'copy_03076_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
