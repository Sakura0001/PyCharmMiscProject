...
-- primary_obligation_id: COPY-EXT|01542|catalog_query|reset_state
...
COPY "copy_01542_t" (copy_01542_c) FROM 'copy_01542_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'copy_01542_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
