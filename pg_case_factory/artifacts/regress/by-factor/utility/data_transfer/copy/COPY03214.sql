...
-- primary_obligation_id: COPY-EXT|03214|returned_rows|rollback
...
COPY public.copy_03214_t TO 'copy_03214_out.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_copy FROM pg_catalog.pg_class WHERE relname = 'copy_03214_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
