...
-- primary_obligation_id: COPY-EXT|01514|error_assertion|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 58P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS copy_01514_t;
\set ON_ERROR_STOP on
-- 2. 创建完整本地规则和因子专用夹具。
CREATE TABLE copy_01514_t (copy_01514_c int);
INSERT INTO copy_01514_t VALUES (1), (2), (3);
\set ON_ERROR_STOP off
-- 3. 执行唯一获得覆盖信用的 COPY。
-- primary-target-begin
COPY public.copy_01514_t (copy_01514_c) FROM 'copy_01514_no_such_file.csv';
-- primary-target-end
