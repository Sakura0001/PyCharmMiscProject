...
-- primary_obligation_id: COPY-EXT|00322|returned_rows|rollback
...
COPY "copy_00322_t" FROM 'copy_00322_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_copy FROM pg_catalog.pg_class WHERE relname = 'copy_00322_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
