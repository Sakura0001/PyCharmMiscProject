...
-- primary_obligation_id: COPY-EXT|00448|catalog_query|rollback
...
COPY public.copy_00448_t FROM 'copy_00448_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'copy_00448_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
