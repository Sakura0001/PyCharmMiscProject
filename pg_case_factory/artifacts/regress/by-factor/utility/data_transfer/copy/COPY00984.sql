...
-- primary_obligation_id: COPY-EXT|00984|returned_rows|reset_state
...
COPY copy_00984_t FROM 'copy_00984_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_copy FROM pg_catalog.pg_class WHERE relname = 'copy_00984_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
