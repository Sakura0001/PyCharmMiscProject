...
-- primary_obligation_id: COPY-EXT|01410|catalog_query|reset_state
...
COPY copy_01410_t (copy_01410_c) FROM 'copy_01410_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'copy_01410_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
