...
-- primary_obligation_id: COPY-EXT|01531|effect_query|rollback
...
COPY copy_01531_t (copy_01531_c) FROM 'copy_01531_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_table FROM pg_catalog.pg_class WHERE relname = 'copy_01531_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
