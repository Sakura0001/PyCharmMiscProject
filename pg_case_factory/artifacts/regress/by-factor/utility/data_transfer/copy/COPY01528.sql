...
-- primary_obligation_id: COPY-EXT|01528|catalog_query|rollback
...
COPY copy_01528_t (copy_01528_c) FROM 'copy_01528_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'copy_01528_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
