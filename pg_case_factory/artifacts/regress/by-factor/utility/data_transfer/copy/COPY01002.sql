...
-- primary_obligation_id: COPY-EXT|01002|catalog_query|reset_state
...
COPY public.copy_01002_t FROM 'copy_01002_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'copy_01002_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
