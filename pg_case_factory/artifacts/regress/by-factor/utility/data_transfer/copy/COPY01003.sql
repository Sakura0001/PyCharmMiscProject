...
-- primary_obligation_id: COPY-EXT|01003|effect_query|rollback
...
COPY public.copy_01003_t FROM 'copy_01003_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_table FROM pg_catalog.pg_class WHERE relname = 'copy_01003_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
