...
-- primary_obligation_id: COPY-EXT|01423|effect_query|rollback
...
COPY "copy_01423_t" (copy_01423_c) FROM 'copy_01423_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_table FROM pg_catalog.pg_class WHERE relname = 'copy_01423_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
