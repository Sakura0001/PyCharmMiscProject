...
-- primary_obligation_id: COPY-EXT|01426|returned_rows|rollback
...
COPY "copy_01426_t" (copy_01426_c) FROM 'copy_01426_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_copy FROM pg_catalog.pg_class WHERE relname = 'copy_01426_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
