...
-- primary_obligation_id: COPY-SFV|sfv-431bac02a94d489b2dbbdd21|copy_from
...
COPY copy_00046_t FROM 'copy_00046_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_table FROM pg_catalog.pg_class WHERE relname = 'copy_00046_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
