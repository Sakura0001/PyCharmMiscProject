...
-- primary_obligation_id: COPY-EXT|03067|effect_query|rollback
...
COPY copy_03067_t TO 'copy_03067_out.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_table FROM pg_catalog.pg_class WHERE relname = 'copy_03067_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
