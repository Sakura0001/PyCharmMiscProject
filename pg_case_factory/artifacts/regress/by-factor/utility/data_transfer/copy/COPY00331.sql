...
-- primary_obligation_id: COPY-EXT|00331|effect_query|rollback
...
COPY public.copy_00331_t FROM 'copy_00331_src.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_table FROM pg_catalog.pg_class WHERE relname = 'copy_00331_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
