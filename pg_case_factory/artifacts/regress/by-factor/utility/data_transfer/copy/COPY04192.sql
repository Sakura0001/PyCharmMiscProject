...
-- primary_obligation_id: COPY-EXT|04192|catalog_query|rollback
...
COPY public.copy_04192_t (copy_04192_c) TO STDOUT;
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'copy_04192_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
