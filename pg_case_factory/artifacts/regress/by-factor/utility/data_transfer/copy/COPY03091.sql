...
-- primary_obligation_id: COPY-EXT|03091|effect_query|rollback
...
COPY public.copy_03091_t TO 'copy_03091_out.csv';
-- primary-target-end
...
SELECT count(*) = 0 AS no_table FROM pg_catalog.pg_class WHERE relname = 'copy_03091_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
