...
-- primary_obligation_id: ANALYZE-EXT|02334|effect_query|reset_state
...
ANALYZE (BUFFER_USAGE_LIMIT 100) "analyze_02334_t";
-- primary-target-end
...
SELECT count(*) = 0 AS no_stats FROM pg_catalog.pg_class WHERE relname = 'analyze_02334_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
