...
-- primary_obligation_id: ANALYZE-EXT|00361|catalog_query|rollback
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_00361_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
