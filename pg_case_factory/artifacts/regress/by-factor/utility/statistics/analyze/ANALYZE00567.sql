...
-- primary_obligation_id: ANALYZE-EXT|00567|catalog_query|reset_state
...
ANALYZE (BUFFER_USAGE_LIMIT 100) analyze_00567_t * (analyze_00567_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_00567_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
