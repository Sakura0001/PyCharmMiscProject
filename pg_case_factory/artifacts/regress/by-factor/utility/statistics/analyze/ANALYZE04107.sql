...
-- primary_obligation_id: ANALYZE-EXT|04107|catalog_query|reset_state
...
ANALYZE (BUFFER_USAGE_LIMIT 100) "analyze_04107_t";
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_04107_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
