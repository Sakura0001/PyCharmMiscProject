...
-- primary_obligation_id: ANALYZE-EXT|04267|returned_rows|rollback
...
ANALYZE (VERBOSE) ONLY analyze_04267_t (analyze_04267_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_analyze FROM pg_catalog.pg_class WHERE relname = 'analyze_04267_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
