...
-- primary_obligation_id: ANALYZE-EXT|00715|returned_rows|rollback
...
ANALYZE (VERBOSE) ONLY analyze_00715_t (analyze_00715_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_analyze FROM pg_catalog.pg_class WHERE relname = 'analyze_00715_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
