...
-- primary_obligation_id: ANALYZE-EXT|03937|catalog_query|rollback
...
ANALYZE analyze_03937_t * (analyze_03937_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_03937_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
