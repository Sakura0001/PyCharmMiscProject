...
-- primary_obligation_id: ANALYZE-EXT|02349|returned_rows|reset_state
...
ANALYZE (BUFFER_USAGE_LIMIT 100) analyze_02349_t * (analyze_02349_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_analyze FROM pg_catalog.pg_class WHERE relname = 'analyze_02349_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
