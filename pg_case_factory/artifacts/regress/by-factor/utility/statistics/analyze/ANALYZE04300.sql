...
-- primary_obligation_id: ANALYZE-EXT|04300|effect_query|rollback
...
ANALYZE (VERBOSE) analyze_04300_t * (analyze_04300_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_stats FROM pg_catalog.pg_class WHERE relname = 'analyze_04300_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
