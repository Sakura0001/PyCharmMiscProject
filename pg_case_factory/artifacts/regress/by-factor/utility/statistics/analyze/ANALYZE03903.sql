...
-- primary_obligation_id: ANALYZE-EXT|03903|catalog_query|reset_state
...
ANALYZE ONLY analyze_03903_t (analyze_03903_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_03903_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
