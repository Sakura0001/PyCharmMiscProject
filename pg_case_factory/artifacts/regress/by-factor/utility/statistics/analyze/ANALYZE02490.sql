...
-- primary_obligation_id: ANALYZE-EXT|02490|effect_query|reset_state
...
ANALYZE (VERBOSE) ONLY analyze_02490_t (analyze_02490_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_stats FROM pg_catalog.pg_class WHERE relname = 'analyze_02490_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
