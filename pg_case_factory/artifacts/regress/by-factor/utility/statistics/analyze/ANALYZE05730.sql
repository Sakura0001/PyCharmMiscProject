...
-- primary_obligation_id: ANALYZE-EXT|05730|effect_query|reset_state
...
ANALYZE public.analyze_05730_t;
-- primary-target-end
...
SELECT count(*) = 0 AS no_stats FROM pg_catalog.pg_class WHERE relname = 'analyze_05730_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
