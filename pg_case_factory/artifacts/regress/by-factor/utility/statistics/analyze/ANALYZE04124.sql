...
-- primary_obligation_id: ANALYZE-EXT|04124|returned_rows|drop_objects
...
ANALYZE (BUFFER_USAGE_LIMIT 100) analyze_04124_t * (analyze_04124_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_analyze FROM pg_catalog.pg_class WHERE relname = 'analyze_04124_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
