...
-- primary_obligation_id: ANALYZE-EXT|00403|returned_rows|rollback
...
ANALYZE public.analyze_00403_t;
-- primary-target-end
...
SELECT count(*) = 0 AS no_analyze FROM pg_catalog.pg_class WHERE relname = 'analyze_00403_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
