...
-- primary_obligation_id: ANALYZE-EXT|05719|returned_rows|rollback
...
ANALYZE analyze_05719_t * (analyze_05719_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_analyze FROM pg_catalog.pg_class WHERE relname = 'analyze_05719_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
