...
-- primary_obligation_id: ANALYZE-EXT|02521|catalog_query|rollback
...
ANALYZE (VERBOSE) analyze_02521_t * (analyze_02521_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_02521_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
