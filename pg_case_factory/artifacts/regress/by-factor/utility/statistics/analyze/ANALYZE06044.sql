...
-- primary_obligation_id: ANALYZE-EXT|06044|returned_rows|drop_objects
...
ANALYZE (VERBOSE) ONLY analyze_06044_t (analyze_06044_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_analyze FROM pg_catalog.pg_class WHERE relname = 'analyze_06044_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
