...
-- primary_obligation_id: ANALYZE-EXT|00207|catalog_query|reset_state
...
ANALYZE (SKIP_LOCKED) analyze_00207_t * (analyze_00207_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_00207_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
