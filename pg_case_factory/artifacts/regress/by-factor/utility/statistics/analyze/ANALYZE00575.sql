...
-- primary_obligation_id: ANALYZE-EXT|00575|error_assertion|drop_objects
...
ANALYZE (BUFFER_USAGE_LIMIT 100) analyze_00575_t * (analyze_00575_c);
-- primary-target-end
