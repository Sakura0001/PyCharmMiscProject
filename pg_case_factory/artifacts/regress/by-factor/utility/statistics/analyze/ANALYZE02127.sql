...
-- primary_obligation_id: ANALYZE-EXT|02127|catalog_query|reset_state
...
ANALYZE ONLY analyze_02127_t (analyze_02127_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_02127_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
