...
-- primary_obligation_id: ANALYZE-EXT|05715|catalog_query|reset_state
...
ANALYZE analyze_05715_t * (analyze_05715_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_05715_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
