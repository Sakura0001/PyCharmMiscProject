...
-- primary_obligation_id: ANALYZE-EXT|05541|returned_rows|reset_state
...
ANALYZE (SKIP_LOCKED) analyze_05541_t * (analyze_05541_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_analyze FROM pg_catalog.pg_class WHERE relname = 'analyze_05541_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
