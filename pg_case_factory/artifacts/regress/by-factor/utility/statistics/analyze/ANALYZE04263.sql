...
-- primary_obligation_id: ANALYZE-EXT|04263|catalog_query|reset_state
...
ANALYZE (VERBOSE) ONLY analyze_04263_t (analyze_04263_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_04263_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
