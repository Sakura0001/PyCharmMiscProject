...
-- primary_obligation_id: ANALYZE-EXT|01986|effect_query|reset_state
...
ANALYZE (SKIP_LOCKED) analyze_01986_t * (analyze_01986_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_stats FROM pg_catalog.pg_class WHERE relname = 'analyze_01986_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
