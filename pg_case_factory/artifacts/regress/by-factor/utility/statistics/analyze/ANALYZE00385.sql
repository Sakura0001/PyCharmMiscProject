...
-- primary_obligation_id: ANALYZE-EXT|00385|catalog_query|rollback
...
ANALYZE analyze_00385_t * (analyze_00385_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_00385_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
