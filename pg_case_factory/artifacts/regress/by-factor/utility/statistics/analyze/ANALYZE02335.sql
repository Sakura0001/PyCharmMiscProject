...
-- primary_obligation_id: ANALYZE-EXT|02335|returned_rows|rollback
...
ANALYZE (BUFFER_USAGE_LIMIT 100) "analyze_02335_t";
-- primary-target-end
...
SELECT count(*) = 0 AS no_analyze FROM pg_catalog.pg_class WHERE relname = 'analyze_02335_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
