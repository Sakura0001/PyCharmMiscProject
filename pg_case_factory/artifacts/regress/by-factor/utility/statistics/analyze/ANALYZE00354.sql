...
-- primary_obligation_id: ANALYZE-EXT|00354|effect_query|reset_state
...
ANALYZE ONLY analyze_00354_t (analyze_00354_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_stats FROM pg_catalog.pg_class WHERE relname = 'analyze_00354_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
