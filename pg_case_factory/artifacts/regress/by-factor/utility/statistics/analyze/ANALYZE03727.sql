...
-- primary_obligation_id: ANALYZE-EXT|03727|returned_rows|rollback
...
ANALYZE (SKIP_LOCKED) ONLY analyze_03727_t (analyze_03727_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_analyze FROM pg_catalog.pg_class WHERE relname = 'analyze_03727_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
