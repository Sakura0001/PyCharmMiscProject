...
-- primary_obligation_id: ANALYZE-EXT|04279|returned_rows|rollback
...
ANALYZE (VERBOSE) analyze_04279_t;
-- primary-target-end
...
SELECT count(*) = 0 AS no_analyze FROM pg_catalog.pg_class WHERE relname = 'analyze_04279_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
