...
-- primary_obligation_id: ANALYZE-EXT|01998|effect_query|reset_state
...
ANALYZE (SKIP_LOCKED) public.analyze_01998_t;
-- primary-target-end
...
SELECT count(*) = 0 AS no_stats FROM pg_catalog.pg_class WHERE relname = 'analyze_01998_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
