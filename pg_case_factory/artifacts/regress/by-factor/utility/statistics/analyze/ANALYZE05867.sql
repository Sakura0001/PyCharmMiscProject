...
-- primary_obligation_id: ANALYZE-EXT|05867|error_assertion|drop_objects
...
ANALYZE (BUFFER_USAGE_LIMIT 100) ONLY analyze_05867_t (analyze_05867_c);
-- primary-target-end
