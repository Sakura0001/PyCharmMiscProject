...
-- primary_obligation_id: ANALYZE-EXT|00540|error_assertion|reset_state
...
ANALYZE (BUFFER_USAGE_LIMIT 100) ONLY analyze_00540_t (analyze_00540_c);
-- primary-target-end
