...
-- primary_obligation_id: ANALYZE-EXT|00538|error_assertion|rollback
...
ANALYZE (BUFFER_USAGE_LIMIT 100) ONLY analyze_00538_t (analyze_00538_c);
-- primary-target-end
