...
-- primary_obligation_id: ANALYZE-EXT|06085|catalog_query|rollback
...
ANALYZE (VERBOSE) public.analyze_06085_t;
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_06085_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
