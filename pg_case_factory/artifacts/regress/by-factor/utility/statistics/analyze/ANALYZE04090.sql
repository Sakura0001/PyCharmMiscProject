...
-- primary_obligation_id: ANALYZE-EXT|04090|error_assertion|rollback
...
ANALYZE (BUFFER_USAGE_LIMIT 100) ONLY analyze_04090_t (analyze_04090_c);
-- primary-target-end
