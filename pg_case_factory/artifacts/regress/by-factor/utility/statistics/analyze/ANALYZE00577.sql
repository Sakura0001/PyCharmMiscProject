...
-- primary_obligation_id: ANALYZE-EXT|00577|catalog_query|rollback
...
ANALYZE (BUFFER_USAGE_LIMIT 100) public.analyze_00577_t;
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_00577_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
