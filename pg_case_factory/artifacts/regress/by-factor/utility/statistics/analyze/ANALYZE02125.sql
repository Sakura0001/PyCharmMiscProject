...
-- primary_obligation_id: ANALYZE-EXT|02125|catalog_query|rollback
...
ANALYZE ONLY analyze_02125_t (analyze_02125_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_02125_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
