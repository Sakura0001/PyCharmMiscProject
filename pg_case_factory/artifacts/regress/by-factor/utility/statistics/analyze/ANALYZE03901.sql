...
-- primary_obligation_id: ANALYZE-EXT|03901|catalog_query|rollback
...
ANALYZE ONLY analyze_03901_t (analyze_03901_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_03901_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
