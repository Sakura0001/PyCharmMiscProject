...
-- primary_obligation_id: ANALYZE-EXT|06804|error_assertion|reset_state
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS analyze_06804_t;
\set ON_ERROR_STOP on
-- 2. 创建完整本地规则和因子专用夹具。
CREATE TABLE analyze_06804_t (analyze_06804_c int);
INSERT INTO analyze_06804_t VALUES (1), (2), (3);
