...
-- primary_obligation_id: ANALYZE-EXT|06039|catalog_query|reset_state
...
ANALYZE (VERBOSE) ONLY analyze_06039_t (analyze_06039_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_06039_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
