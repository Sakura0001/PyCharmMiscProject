...
-- primary_obligation_id: ANALYZE-EXT|04127|error_assertion|drop_objects
...
ANALYZE (BUFFER_USAGE_LIMIT 100) analyze_04127_t * (analyze_04127_c);
-- primary-target-end
