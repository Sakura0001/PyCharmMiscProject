...
-- primary_obligation_id: ANALYZE-EXT|04091|error_assertion|drop_objects
...
ANALYZE (BUFFER_USAGE_LIMIT 100) ONLY analyze_04091_t (analyze_04091_c);
-- primary-target-end
