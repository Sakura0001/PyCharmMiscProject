...
-- primary_obligation_id: ANALYZE-EXT|05716|effect_query|rollback
...
ANALYZE analyze_05716_t * (analyze_05716_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_stats FROM pg_catalog.pg_class WHERE relname = 'analyze_05716_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
