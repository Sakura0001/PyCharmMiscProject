...
-- primary_obligation_id: ANALYZE-EXT|02314|error_assertion|rollback
...
ANALYZE (BUFFER_USAGE_LIMIT 100) ONLY analyze_02314_t (analyze_02314_c);
-- primary-target-end
