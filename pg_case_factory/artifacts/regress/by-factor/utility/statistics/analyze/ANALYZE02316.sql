...
-- primary_obligation_id: ANALYZE-EXT|02316|error_assertion|reset_state
...
ANALYZE (BUFFER_USAGE_LIMIT 100) ONLY analyze_02316_t (analyze_02316_c);
-- primary-target-end
