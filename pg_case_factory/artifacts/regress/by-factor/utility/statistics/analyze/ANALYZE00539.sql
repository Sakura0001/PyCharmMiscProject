...
-- primary_obligation_id: ANALYZE-EXT|00539|error_assertion|drop_objects
...
ANALYZE (BUFFER_USAGE_LIMIT 100) ONLY analyze_00539_t (analyze_00539_c);
-- primary-target-end
