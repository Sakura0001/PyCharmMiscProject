...
-- primary_obligation_id: ANALYZE-EXT|02351|error_assertion|drop_objects
...
ANALYZE (BUFFER_USAGE_LIMIT 100) analyze_02351_t * (analyze_02351_c);
-- primary-target-end
