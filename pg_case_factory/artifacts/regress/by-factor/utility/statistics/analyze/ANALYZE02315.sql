...
-- primary_obligation_id: ANALYZE-EXT|02315|error_assertion|drop_objects
...
ANALYZE (BUFFER_USAGE_LIMIT 100) ONLY analyze_02315_t (analyze_02315_c);
-- primary-target-end
