...
-- primary_obligation_id: ANALYZE-EXT|01945|catalog_query|rollback
...
ANALYZE (SKIP_LOCKED) ONLY analyze_01945_t (analyze_01945_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_01945_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
