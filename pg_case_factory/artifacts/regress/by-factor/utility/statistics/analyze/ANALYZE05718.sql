...
-- primary_obligation_id: ANALYZE-EXT|05718|effect_query|reset_state
...
ANALYZE analyze_05718_t * (analyze_05718_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_stats FROM pg_catalog.pg_class WHERE relname = 'analyze_05718_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
