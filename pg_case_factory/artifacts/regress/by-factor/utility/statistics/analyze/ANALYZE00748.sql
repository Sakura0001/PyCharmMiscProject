...
-- primary_obligation_id: ANALYZE-EXT|00748|effect_query|rollback
...
ANALYZE (VERBOSE) analyze_00748_t * (analyze_00748_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_stats FROM pg_catalog.pg_class WHERE relname = 'analyze_00748_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
