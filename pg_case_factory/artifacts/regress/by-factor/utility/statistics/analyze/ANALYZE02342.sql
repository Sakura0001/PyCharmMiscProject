...
-- primary_obligation_id: ANALYZE-EXT|02342|catalog_query|drop_objects
...
ANALYZE (BUFFER_USAGE_LIMIT 100) analyze_02342_t * (analyze_02342_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_02342_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
