...
-- primary_obligation_id: ANALYZE-EXT|01982|catalog_query|drop_objects
...
ANALYZE (SKIP_LOCKED) analyze_01982_t * (analyze_01982_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_01982_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
