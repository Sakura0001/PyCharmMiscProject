...
-- primary_obligation_id: ANALYZE-EXT|05903|error_assertion|drop_objects
...
ANALYZE (BUFFER_USAGE_LIMIT 100) analyze_05903_t * (analyze_05903_c);
-- primary-target-end
