...
-- primary_obligation_id: ANALYZE-EXT|04311|catalog_query|reset_state
...
ANALYZE (VERBOSE) public.analyze_04311_t;
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_04311_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
