...
-- primary_obligation_id: ANALYZE-EXT|00355|returned_rows|rollback
...
ANALYZE ONLY analyze_00355_t (analyze_00355_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_analyze FROM pg_catalog.pg_class WHERE relname = 'analyze_00355_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
