...
-- primary_obligation_id: ANALYZE-EXT|02176|effect_query|rollback
...
ANALYZE public.analyze_02176_t;
-- primary-target-end
...
SELECT count(*) = 0 AS no_stats FROM pg_catalog.pg_class WHERE relname = 'analyze_02176_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
