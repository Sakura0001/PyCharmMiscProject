...
-- primary_obligation_id: ANALYZE-SFV|sfv-603623d91648e1939954f922|analyze
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_00043_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
