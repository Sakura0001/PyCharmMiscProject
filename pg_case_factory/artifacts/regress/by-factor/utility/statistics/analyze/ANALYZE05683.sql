...
-- primary_obligation_id: ANALYZE-EXT|05683|returned_rows|rollback
...
ANALYZE ONLY analyze_05683_t (analyze_05683_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_analyze FROM pg_catalog.pg_class WHERE relname = 'analyze_05683_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
