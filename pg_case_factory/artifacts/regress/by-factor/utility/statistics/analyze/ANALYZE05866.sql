...
-- primary_obligation_id: ANALYZE-EXT|05866|error_assertion|rollback
...
ANALYZE (BUFFER_USAGE_LIMIT 100) ONLY analyze_05866_t (analyze_05866_c);
-- primary-target-end
