...
-- primary_obligation_id: ANALYZE-EXT|00171|catalog_query|reset_state
...
ANALYZE (SKIP_LOCKED) ONLY analyze_00171_t (analyze_00171_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_00171_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
