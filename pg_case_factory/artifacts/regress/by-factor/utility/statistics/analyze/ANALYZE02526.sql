...
-- primary_obligation_id: ANALYZE-EXT|02526|effect_query|reset_state
...
ANALYZE (VERBOSE) analyze_02526_t * (analyze_02526_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_stats FROM pg_catalog.pg_class WHERE relname = 'analyze_02526_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
