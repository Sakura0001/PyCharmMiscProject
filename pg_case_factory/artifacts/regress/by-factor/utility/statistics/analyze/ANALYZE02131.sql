...
-- primary_obligation_id: ANALYZE-EXT|02131|returned_rows|rollback
...
ANALYZE ONLY analyze_02131_t (analyze_02131_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_analyze FROM pg_catalog.pg_class WHERE relname = 'analyze_02131_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
