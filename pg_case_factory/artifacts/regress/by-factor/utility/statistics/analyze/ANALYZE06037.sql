...
-- primary_obligation_id: ANALYZE-EXT|06037|catalog_query|rollback
...
ANALYZE (VERBOSE) ONLY analyze_06037_t (analyze_06037_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_06037_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
