...
-- primary_obligation_id: ANALYZE-EXT|01498|error_assertion|rollback
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS analyze_01498_t;
\set ON_ERROR_STOP on
-- 2. 创建完整本地规则和因子专用夹具。
CREATE TABLE analyze_01498_t (analyze_01498_c int);
INSERT INTO analyze_01498_t VALUES (1), (2), (3);
-- 3. 执行唯一获得覆盖信用的 ANALYZE。
-- primary-target-begin
ANALYZE analyze_01498_t;
-- primary-target-end
