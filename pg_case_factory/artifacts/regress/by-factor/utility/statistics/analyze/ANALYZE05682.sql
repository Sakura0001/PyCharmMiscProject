...
-- primary_obligation_id: ANALYZE-EXT|05682|effect_query|reset_state
...
ANALYZE ONLY analyze_05682_t (analyze_05682_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_stats FROM pg_catalog.pg_class WHERE relname = 'analyze_05682_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
