...
-- primary_obligation_id: ANALYZE-EXT|06075|catalog_query|reset_state
...
ANALYZE (VERBOSE) analyze_06075_t * (analyze_06075_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_06075_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
