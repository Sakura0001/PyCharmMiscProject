...
-- primary_obligation_id: ANALYZE-EXT|01993|catalog_query|rollback
...
ANALYZE (SKIP_LOCKED) public.analyze_01993_t;
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_01993_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
