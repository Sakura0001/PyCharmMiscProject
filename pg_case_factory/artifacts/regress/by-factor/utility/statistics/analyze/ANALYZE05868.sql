...
-- primary_obligation_id: ANALYZE-EXT|05868|error_assertion|reset_state
...
ANALYZE (BUFFER_USAGE_LIMIT 100) ONLY analyze_05868_t (analyze_05868_c);
-- primary-target-end
