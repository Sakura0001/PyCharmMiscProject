...
-- primary_obligation_id: ANALYZE-EXT|00349|catalog_query|rollback
...
ANALYZE ONLY analyze_00349_t (analyze_00349_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_00349_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
