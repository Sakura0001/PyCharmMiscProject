...
-- primary_obligation_id: ANALYZE-EXT|00206|catalog_query|drop_objects
...
ANALYZE (SKIP_LOCKED) analyze_00206_t * (analyze_00206_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_00206_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
