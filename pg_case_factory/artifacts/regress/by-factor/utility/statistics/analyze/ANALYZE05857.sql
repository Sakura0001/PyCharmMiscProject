...
-- primary_obligation_id: ANALYZE-EXT|05857|catalog_query|rollback
...
ANALYZE (BUFFER_USAGE_LIMIT 100) ONLY analyze_05857_t (analyze_05857_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_05857_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
