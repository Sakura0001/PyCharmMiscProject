...
-- primary_obligation_id: ANALYZE-EXT|04092|error_assertion|reset_state
...
ANALYZE (BUFFER_USAGE_LIMIT 100) ONLY analyze_04092_t (analyze_04092_c);
-- primary-target-end
