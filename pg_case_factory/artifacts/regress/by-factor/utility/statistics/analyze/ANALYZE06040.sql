...
-- primary_obligation_id: ANALYZE-EXT|06040|effect_query|rollback
...
ANALYZE (VERBOSE) ONLY analyze_06040_t (analyze_06040_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_stats FROM pg_catalog.pg_class WHERE relname = 'analyze_06040_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
