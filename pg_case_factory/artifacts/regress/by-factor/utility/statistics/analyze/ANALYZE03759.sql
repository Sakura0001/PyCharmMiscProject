...
-- primary_obligation_id: ANALYZE-EXT|03759|catalog_query|reset_state
...
ANALYZE (SKIP_LOCKED) analyze_03759_t * (analyze_03759_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_03759_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
