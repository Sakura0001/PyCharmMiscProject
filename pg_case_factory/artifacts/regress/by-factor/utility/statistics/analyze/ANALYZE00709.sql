...
-- primary_obligation_id: ANALYZE-EXT|00709|catalog_query|rollback
...
ANALYZE (VERBOSE) ONLY analyze_00709_t (analyze_00709_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_00709_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
