...
-- primary_obligation_id: ANALYZE-EXT|00712|effect_query|rollback
...
ANALYZE (VERBOSE) ONLY analyze_00712_t (analyze_00712_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_stats FROM pg_catalog.pg_class WHERE relname = 'analyze_00712_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
