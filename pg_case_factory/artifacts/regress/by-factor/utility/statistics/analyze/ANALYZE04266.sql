...
-- primary_obligation_id: ANALYZE-EXT|04266|effect_query|reset_state
...
ANALYZE (VERBOSE) ONLY analyze_04266_t (analyze_04266_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_stats FROM pg_catalog.pg_class WHERE relname = 'analyze_04266_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
