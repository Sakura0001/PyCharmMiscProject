...
-- primary_obligation_id: ANALYZE-EXT|05713|catalog_query|rollback
...
ANALYZE analyze_05713_t * (analyze_05713_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_05713_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
