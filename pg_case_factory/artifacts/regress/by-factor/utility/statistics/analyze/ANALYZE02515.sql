...
-- primary_obligation_id: ANALYZE-EXT|02515|returned_rows|rollback
...
ANALYZE (VERBOSE) "analyze_02515_t";
-- primary-target-end
...
SELECT count(*) = 0 AS no_analyze FROM pg_catalog.pg_class WHERE relname = 'analyze_02515_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
