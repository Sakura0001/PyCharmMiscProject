...
-- primary_obligation_id: ANALYZE-EXT|02129|effect_query|drop_objects
...
ANALYZE ONLY analyze_02129_t (analyze_02129_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_stats FROM pg_catalog.pg_class WHERE relname = 'analyze_02129_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
