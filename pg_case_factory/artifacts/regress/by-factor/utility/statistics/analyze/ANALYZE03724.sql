...
-- primary_obligation_id: ANALYZE-EXT|03724|effect_query|rollback
...
ANALYZE (SKIP_LOCKED) ONLY analyze_03724_t (analyze_03724_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_stats FROM pg_catalog.pg_class WHERE relname = 'analyze_03724_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
ROLLBACK;
