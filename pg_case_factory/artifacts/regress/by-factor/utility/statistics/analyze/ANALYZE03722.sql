...
-- primary_obligation_id: ANALYZE-EXT|03722|catalog_query|drop_objects
...
ANALYZE (SKIP_LOCKED) ONLY analyze_03722_t (analyze_03722_c);
-- primary-target-end
...
SELECT count(*) = 0 AS table_absent FROM pg_catalog.pg_class WHERE relname = 'analyze_03722_t' ORDER BY count(*);
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
