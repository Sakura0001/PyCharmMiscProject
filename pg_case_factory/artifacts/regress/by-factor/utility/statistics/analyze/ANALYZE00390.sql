...
-- primary_obligation_id: ANALYZE-EXT|00390|effect_query|reset_state
...
ANALYZE analyze_00390_t * (analyze_00390_c);
-- primary-target-end
...
SELECT count(*) = 0 AS no_stats FROM pg_catalog.pg_class WHERE relname = 'analyze_00390_t' AND relkind = 'r' ORDER BY count(*);
-- 5. 清理全部本编号对象。
RESET search_path;
