...
-- primary_obligation_id: EXPLAIN-EXT|01572|error_assertion|reset_state
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS explain_01572_t;
\set ON_ERROR_STOP on
-- 2. 创建完整本地规则和因子专用夹具。
CREATE TABLE explain_01572_t (explain_01572_c int);
INSERT INTO explain_01572_t VALUES (1), (2), (3);
