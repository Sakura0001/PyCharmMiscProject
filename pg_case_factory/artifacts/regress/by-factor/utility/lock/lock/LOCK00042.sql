...
-- primary_obligation_id: LOCK-SFV|sfv-dd3dbd79b795589f1aebd35c|branch_1
...
LOCK TABLE lock_00042_wrong_type_target IN ACCESS EXCLUSIVE MODE;
-- primary-target-end
...
SELECT count(*) = 0 AS relation_absent FROM pg_catalog.pg_class WHERE relname = 'lock_00042_t' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
