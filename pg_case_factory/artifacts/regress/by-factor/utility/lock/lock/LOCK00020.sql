...
-- version      : 1.0
-- description  : LOCK TABLE invalid_combination=object_type_mismatch
...
-- primary_obligation_id: LOCK-SFV|sfv-eecefa463187f9c58ae871e9|branch_1
...
LOCK TABLE lock_00020_wrong_type_target IN ACCESS EXCLUSIVE MODE;
-- primary-target-end
...
SELECT count(*) = 0 AS relation_absent FROM pg_catalog.pg_class WHERE relname = 'lock_00020_t' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
