...
-- version      : 1.0
-- description  : LOCK TABLE invalid_combination=syntax_valid_semantic_error
...
-- primary_obligation_id: LOCK-SFV|sfv-1442993616feff665404d649|branch_1
...
LOCK TABLE lock_00021_semantic_error_target IN ACCESS EXCLUSIVE MODE;
-- primary-target-end
...
SELECT count(*) = 0 AS relation_absent FROM pg_catalog.pg_class WHERE relname = 'lock_00021_t' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
