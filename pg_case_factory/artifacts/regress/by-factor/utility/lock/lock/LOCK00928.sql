...
-- primary_obligation_id: LOCK-EXT|00928|effect_query|rollback
...
LOCK TABLE lock_00928_no_such_table IN SHARE MODE;
-- primary-target-end
...
SELECT count(*) AS relation_effect_witness FROM pg_catalog.pg_class WHERE relname = 'lock_00928_t' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
SELECT 1 AS residual_check_no_objects;
