...
-- primary_obligation_id: CPREP-SFV|sfv-e7fad8e1dc5ede583932a588|commit_prepared
-- expected_outcome: expected_failure
-- expected_sqlstate: 42601
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS commitprepared_00028_data;
\set ON_ERROR_STOP on
-- 2. 创建完整本地规则和因子专用夹具。
CREATE TABLE commitprepared_00028_data (id integer, payload text);
INSERT INTO commitprepared_00028_data VALUES (1, 'commit_prepared_fixture');
