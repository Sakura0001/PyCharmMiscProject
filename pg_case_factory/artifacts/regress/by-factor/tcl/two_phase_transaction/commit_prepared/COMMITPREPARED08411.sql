...
-- primary_obligation_id: CPREP-EXT|08411|catalog_query|reset_state
-- expected_outcome: expected_failure
-- expected_sqlstate: 42601
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS commitprepared_08411_data;
\set ON_ERROR_STOP on
-- 2. 创建完整本地规则和因子专用夹具。
CREATE TABLE commitprepared_08411_data (id integer, payload text);
INSERT INTO commitprepared_08411_data VALUES (1, 'commit_prepared_fixture');
