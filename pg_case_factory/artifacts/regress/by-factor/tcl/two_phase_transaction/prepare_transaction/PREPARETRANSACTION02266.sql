...
-- ++
-- --------------------------------------------------------
-- case_id: PREPARETRANSACTION02266
...
-- primary_obligation_id: PREPARETRANSACTION-EXT|02266|catalog_query|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42601
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS preparetransaction_02266_data;
\set ON_ERROR_STOP on
-- 2. 创建完整本地规则和因子专用夹具。
CREATE TABLE preparetransaction_02266_data (id integer, payload text);
INSERT INTO preparetransaction_02266_data VALUES (1, 'prepare_transaction_fixture');
