...
-- ++
-- --------------------------------------------------------
-- case_id: PREPARETRANSACTION07414
...
-- primary_obligation_id: PREPARETRANSACTION-EXT|07414|catalog_query|drop_objects
-- expected_outcome: expected_failure
-- expected_sqlstate: 42601
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS preparetransaction_07414_data;
\set ON_ERROR_STOP on
-- 2. 创建完整本地规则和因子专用夹具。
CREATE TABLE preparetransaction_07414_data (id integer, payload text);
INSERT INTO preparetransaction_07414_data VALUES (1, 'prepare_transaction_fixture');
