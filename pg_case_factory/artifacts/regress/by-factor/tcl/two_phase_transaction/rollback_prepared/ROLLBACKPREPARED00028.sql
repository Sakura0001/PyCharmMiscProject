...
-- primary_obligation_id: ROLLBACKPREPARED-SFV|sfv-f0a10ae792cf6d78394fa9a4|rollback_prepared
-- expected_outcome: expected_failure
-- expected_sqlstate: 42601
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS rollbackprepared_00028_data;
\set ON_ERROR_STOP on
-- 2. 创建完整本地规则和因子专用夹具。
CREATE TABLE rollbackprepared_00028_data (id integer, payload text);
INSERT INTO rollbackprepared_00028_data VALUES (1, 'rollback_prepared_fixture');
