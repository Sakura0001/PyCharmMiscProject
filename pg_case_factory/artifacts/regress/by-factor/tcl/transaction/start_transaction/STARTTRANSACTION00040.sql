...
-- version      : 1.0
-- description  : START TRANSACTION transaction_state=savepoint_exists
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: STARTTRANSACTION00040
...
-- primary_obligation_id: STARTTRANSACTION-SFV|sfv-601592990d13f1613930daac|start_transaction
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN;
SAVEPOINT starttransaction_00040_sp;
