...
-- version      : 1.0
-- description  : START TRANSACTION transaction_state=prepared_transaction_exists
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: STARTTRANSACTION00039
...
-- primary_obligation_id: STARTTRANSACTION-SFV|sfv-40f7b3eacb9115e5dd96ad5c|start_transaction
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
ROLLBACK;
ROLLBACK PREPARED 'starttransaction_00039_prep';
\set ON_ERROR_STOP on
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN;
PREPARE TRANSACTION 'starttransaction_00039_prep';
