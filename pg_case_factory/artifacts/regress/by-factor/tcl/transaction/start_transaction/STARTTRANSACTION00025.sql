...
-- version      : 1.0
-- description  : START TRANSACTION state_boundary=prepared_transaction_leftover
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: STARTTRANSACTION00025
...
-- primary_obligation_id: STARTTRANSACTION-SFV|sfv-989c7bc8fe85d773138df04d|start_transaction
-- expected_outcome: success
-- expected_sqlstate: 00000
-- 1. 清理本编号对象，保证脚本可重复执行。
ROLLBACK;
ROLLBACK PREPARED 'starttransaction_00025_prep';
\set ON_ERROR_STOP on
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN;
PREPARE TRANSACTION 'starttransaction_00025_prep';
