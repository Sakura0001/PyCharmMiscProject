...
-- primary_obligation_id: SAVEPOINT-EXT|00349|effect_query|drop_objects
...
SAVEPOINT savepoint_00349_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_00349_sp AND CHAIN;
-- primary-target-end
