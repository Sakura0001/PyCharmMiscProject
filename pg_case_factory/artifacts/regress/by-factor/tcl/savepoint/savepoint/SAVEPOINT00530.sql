...
-- primary_obligation_id: SAVEPOINT-EXT|00530|effect_query|reset_state
...
SAVEPOINT savepoint_00530_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_00530_sp AND CHAIN;
-- primary-target-end
