...
-- primary_obligation_id: SAVEPOINT-EXT|00329|returned_rows|reset_state
...
SAVEPOINT savepoint_00329_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_00329_sp AND CHAIN;
-- primary-target-end
