...
-- primary_obligation_id: SAVEPOINT-EXT|00926|effect_query|reset_state
...
SAVEPOINT savepoint_00926_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_00926_sp AND NO CHAIN;
-- primary-target-end
