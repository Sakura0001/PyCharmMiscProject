...
-- primary_obligation_id: SAVEPOINT-EXT|01176|effect_query|rollback
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ WRITE;
SAVEPOINT savepoint_01176_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_01176_sp AND NO CHAIN;
-- primary-target-end
