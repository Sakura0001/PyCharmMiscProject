...
-- primary_obligation_id: SAVEPOINT-EXT|00328|returned_rows|drop_objects
...
SAVEPOINT savepoint_00328_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_00328_sp AND CHAIN;
-- primary-target-end
