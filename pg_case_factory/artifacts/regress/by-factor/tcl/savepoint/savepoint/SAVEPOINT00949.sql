...
-- primary_obligation_id: SAVEPOINT-EXT|00949|effect_query|drop_objects
...
SAVEPOINT savepoint_00949_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_00949_sp AND NO CHAIN;
-- primary-target-end
