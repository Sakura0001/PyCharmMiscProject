...
-- primary_obligation_id: SAVEPOINT-EXT|00374|effect_query|reset_state
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ ONLY;
SAVEPOINT savepoint_00374_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_00374_sp AND CHAIN;
-- primary-target-end
