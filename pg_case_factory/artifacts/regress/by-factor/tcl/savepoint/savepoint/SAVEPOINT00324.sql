...
-- primary_obligation_id: SAVEPOINT-EXT|00324|effect_query|rollback
...
SAVEPOINT savepoint_00324_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_00324_sp AND CHAIN;
-- primary-target-end
