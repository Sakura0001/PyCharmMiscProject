...
-- primary_obligation_id: SAVEPOINT-EXT|00999|returned_rows|rollback
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ WRITE;
SAVEPOINT savepoint_00999_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_00999_sp AND NO CHAIN;
-- primary-target-end
