...
-- primary_obligation_id: SAVEPOINT-EXT|00399|returned_rows|rollback
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ WRITE;
SAVEPOINT savepoint_00399_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_00399_sp AND CHAIN;
-- primary-target-end
