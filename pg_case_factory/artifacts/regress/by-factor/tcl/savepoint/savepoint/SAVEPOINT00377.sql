...
-- primary_obligation_id: SAVEPOINT-EXT|00377|returned_rows|reset_state
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ ONLY;
SAVEPOINT savepoint_00377_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_00377_sp AND CHAIN;
-- primary-target-end
