...
-- primary_obligation_id: SAVEPOINT-EXT|00348|effect_query|rollback
...
SAVEPOINT savepoint_00348_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_00348_sp AND CHAIN;
-- primary-target-end
