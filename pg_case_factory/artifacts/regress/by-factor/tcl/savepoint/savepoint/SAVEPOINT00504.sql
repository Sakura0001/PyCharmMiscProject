...
-- primary_obligation_id: SAVEPOINT-EXT|00504|effect_query|rollback
...
SAVEPOINT savepoint_00504_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_00504_sp AND CHAIN;
-- primary-target-end
