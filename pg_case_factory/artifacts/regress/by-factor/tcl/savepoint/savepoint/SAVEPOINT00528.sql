...
-- primary_obligation_id: SAVEPOINT-EXT|00528|effect_query|rollback
...
SAVEPOINT savepoint_00528_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_00528_sp AND CHAIN;
-- primary-target-end
