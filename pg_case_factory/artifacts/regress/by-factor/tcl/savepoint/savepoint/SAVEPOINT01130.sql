...
-- primary_obligation_id: SAVEPOINT-EXT|01130|effect_query|reset_state
...
SAVEPOINT savepoint_01130_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_01130_sp AND NO CHAIN;
-- primary-target-end
