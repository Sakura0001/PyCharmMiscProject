...
-- primary_obligation_id: SAVEPOINT-EXT|00948|effect_query|rollback
...
SAVEPOINT savepoint_00948_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_00948_sp AND NO CHAIN;
-- primary-target-end
