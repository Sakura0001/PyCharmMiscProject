...
-- primary_obligation_id: SAVEPOINT-EXT|01104|effect_query|rollback
...
SAVEPOINT savepoint_01104_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_01104_sp AND NO CHAIN;
-- primary-target-end
