...
-- primary_obligation_id: SAVEPOINT-EXT|01105|effect_query|drop_objects
...
SAVEPOINT savepoint_01105_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_01105_sp AND NO CHAIN;
-- primary-target-end
