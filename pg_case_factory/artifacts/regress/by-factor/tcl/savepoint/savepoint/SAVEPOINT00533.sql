...
-- primary_obligation_id: SAVEPOINT-EXT|00533|returned_rows|reset_state
...
SAVEPOINT savepoint_00533_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_00533_sp AND CHAIN;
-- primary-target-end
