...
-- primary_obligation_id: SAVEPOINT-EXT|00998|effect_query|reset_state
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ WRITE;
SAVEPOINT savepoint_00998_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_00998_sp AND NO CHAIN;
-- primary-target-end
