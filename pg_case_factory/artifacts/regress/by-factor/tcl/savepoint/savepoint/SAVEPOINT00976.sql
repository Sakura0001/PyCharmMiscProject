...
-- primary_obligation_id: SAVEPOINT-EXT|00976|returned_rows|drop_objects
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ ONLY;
SAVEPOINT savepoint_00976_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_00976_sp AND NO CHAIN;
-- primary-target-end
