...
-- primary_obligation_id: SAVEPOINT-EXT|01131|returned_rows|rollback
...
SAVEPOINT savepoint_01131_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_01131_sp AND NO CHAIN;
-- primary-target-end
