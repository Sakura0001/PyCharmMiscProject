...
-- primary_obligation_id: SAVEPOINT-EXT|00951|returned_rows|rollback
...
SAVEPOINT savepoint_00951_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_00951_sp AND NO CHAIN;
-- primary-target-end
