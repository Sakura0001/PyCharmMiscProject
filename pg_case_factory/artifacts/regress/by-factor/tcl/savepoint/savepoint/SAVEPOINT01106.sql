...
-- primary_obligation_id: SAVEPOINT-EXT|01106|effect_query|reset_state
...
SAVEPOINT savepoint_01106_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_01106_sp AND NO CHAIN;
-- primary-target-end
