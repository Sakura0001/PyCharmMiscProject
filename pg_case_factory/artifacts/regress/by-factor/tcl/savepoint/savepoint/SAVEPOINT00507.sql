...
-- primary_obligation_id: SAVEPOINT-EXT|00507|returned_rows|rollback
...
SAVEPOINT savepoint_00507_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_00507_sp AND CHAIN;
-- primary-target-end
