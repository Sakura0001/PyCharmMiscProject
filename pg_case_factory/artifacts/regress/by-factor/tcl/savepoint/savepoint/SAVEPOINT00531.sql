...
-- primary_obligation_id: SAVEPOINT-EXT|00531|returned_rows|rollback
...
SAVEPOINT savepoint_00531_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_00531_sp AND CHAIN;
-- primary-target-end
