...
-- primary_obligation_id: SAVEPOINT-EXT|01128|effect_query|rollback
...
SAVEPOINT savepoint_01128_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_01128_sp AND NO CHAIN;
-- primary-target-end
