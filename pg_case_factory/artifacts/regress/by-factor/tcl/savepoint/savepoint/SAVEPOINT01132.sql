...
-- primary_obligation_id: SAVEPOINT-EXT|01132|returned_rows|drop_objects
...
SAVEPOINT savepoint_01132_sp;
-- 3. 执行唯一获得覆盖信用的 SAVEPOINT。
-- primary-target-begin
SAVEPOINT savepoint_01132_sp AND NO CHAIN;
-- primary-target-end
