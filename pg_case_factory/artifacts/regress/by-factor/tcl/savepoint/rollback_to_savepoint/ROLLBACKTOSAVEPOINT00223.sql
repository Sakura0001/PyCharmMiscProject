...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00223
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00223|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00223_sp AND CHAIN;
-- primary-target-end
