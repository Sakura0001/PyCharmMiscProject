...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00069
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00069|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00069_sp AND CHAIN;
-- primary-target-end
