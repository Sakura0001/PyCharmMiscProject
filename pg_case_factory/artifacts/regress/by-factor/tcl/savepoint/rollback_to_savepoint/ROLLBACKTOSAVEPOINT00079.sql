...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00079
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00079|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00079_sp AND CHAIN;
-- primary-target-end
