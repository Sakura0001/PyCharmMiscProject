...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00201
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00201|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00201_sp AND CHAIN;
-- primary-target-end
