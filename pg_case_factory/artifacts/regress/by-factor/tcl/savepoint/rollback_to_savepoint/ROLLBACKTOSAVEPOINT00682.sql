...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00682
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00682|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00682_sp AND NO CHAIN;
-- primary-target-end
