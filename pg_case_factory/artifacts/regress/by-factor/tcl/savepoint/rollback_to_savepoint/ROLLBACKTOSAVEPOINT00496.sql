...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00496
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00496|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00496_sp AND CHAIN;
-- primary-target-end
