...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00769
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00769|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00769_sp AND NO CHAIN;
-- primary-target-end
