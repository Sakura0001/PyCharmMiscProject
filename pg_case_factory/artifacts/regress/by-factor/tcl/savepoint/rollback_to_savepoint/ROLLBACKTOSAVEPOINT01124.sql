...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01124
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01124|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01124_sp AND NO CHAIN;
-- primary-target-end
