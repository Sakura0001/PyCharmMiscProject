...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01347
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01347|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01347_sp;
-- primary-target-end
