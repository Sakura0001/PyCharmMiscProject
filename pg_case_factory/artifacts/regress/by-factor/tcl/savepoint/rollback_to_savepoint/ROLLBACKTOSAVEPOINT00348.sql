...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00348
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00348|effect_query|rollback
...
SAVEPOINT rollbacktosavepoint_00348_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00348_sp AND CHAIN;
-- primary-target-end
