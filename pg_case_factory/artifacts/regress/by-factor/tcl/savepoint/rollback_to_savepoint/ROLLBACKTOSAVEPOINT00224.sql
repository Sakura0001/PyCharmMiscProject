...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00224
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00224|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00224_sp AND CHAIN;
-- primary-target-end
