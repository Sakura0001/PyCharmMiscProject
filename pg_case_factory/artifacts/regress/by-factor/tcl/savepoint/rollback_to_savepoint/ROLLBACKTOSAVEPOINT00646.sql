...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00646
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00646|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00646_sp AND NO CHAIN;
-- primary-target-end
