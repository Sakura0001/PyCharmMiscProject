...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00347
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00347|catalog_query|reset_state
...
SAVEPOINT rollbacktosavepoint_00347_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00347_sp AND CHAIN;
-- primary-target-end
