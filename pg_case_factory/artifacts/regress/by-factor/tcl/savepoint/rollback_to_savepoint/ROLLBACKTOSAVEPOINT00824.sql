...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00824
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00824|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00824_sp AND NO CHAIN;
-- primary-target-end
