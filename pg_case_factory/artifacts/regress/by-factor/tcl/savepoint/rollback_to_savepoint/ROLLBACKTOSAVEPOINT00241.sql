...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00241
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00241|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00241_sp AND CHAIN;
-- primary-target-end
