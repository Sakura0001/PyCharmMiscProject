...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00190
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00190|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00190_sp AND CHAIN;
-- primary-target-end
