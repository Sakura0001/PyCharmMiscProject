...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00965
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00965|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00965_sp AND NO CHAIN;
-- primary-target-end
