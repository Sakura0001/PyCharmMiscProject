...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00581
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00581|returned_rows|reset_state
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ WRITE;
SAVEPOINT rollbacktosavepoint_00581_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00581_sp AND CHAIN;
-- primary-target-end
