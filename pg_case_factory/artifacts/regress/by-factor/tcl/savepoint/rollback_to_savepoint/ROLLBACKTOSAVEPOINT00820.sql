...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00820
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00820|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00820_sp AND NO CHAIN;
-- primary-target-end
