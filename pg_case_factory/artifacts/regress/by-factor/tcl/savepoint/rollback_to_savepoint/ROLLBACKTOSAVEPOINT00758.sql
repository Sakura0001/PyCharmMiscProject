...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00758
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00758|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00758_sp AND NO CHAIN;
-- primary-target-end
