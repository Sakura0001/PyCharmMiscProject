...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT expected_status=failure
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00012
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-b02aa16edc66e3c12d1efefc|rollback_to_savepoint
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00012_sp;
-- primary-target-end
