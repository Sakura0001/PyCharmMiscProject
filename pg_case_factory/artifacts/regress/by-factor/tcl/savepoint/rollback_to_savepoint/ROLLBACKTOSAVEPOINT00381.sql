...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00381
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00381|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00381_sp AND CHAIN;
-- primary-target-end
