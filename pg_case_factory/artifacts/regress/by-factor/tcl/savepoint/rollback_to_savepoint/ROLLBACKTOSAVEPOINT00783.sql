...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00783
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00783|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00783_sp AND NO CHAIN;
-- primary-target-end
