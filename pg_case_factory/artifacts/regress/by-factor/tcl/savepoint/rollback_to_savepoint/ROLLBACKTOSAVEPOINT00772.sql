...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00772
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00772|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00772_sp AND NO CHAIN;
-- primary-target-end
