...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00511
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00511|error_assertion|drop_objects
...
SAVEPOINT rollbacktosavepoint_00511_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00511_sp AND CHAIN;
-- primary-target-end
