...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00098
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00098|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00098_sp AND CHAIN;
-- primary-target-end
