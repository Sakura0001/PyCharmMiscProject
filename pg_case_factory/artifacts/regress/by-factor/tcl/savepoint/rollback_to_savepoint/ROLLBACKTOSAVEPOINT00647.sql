...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00647
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00647|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00647_sp AND NO CHAIN;
-- primary-target-end
