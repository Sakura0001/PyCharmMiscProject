...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00537
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00537|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00537_sp AND CHAIN;
-- primary-target-end
