...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00390
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00390|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00390_sp AND CHAIN;
-- primary-target-end
