...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00188
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00188|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00188_sp AND CHAIN;
-- primary-target-end
