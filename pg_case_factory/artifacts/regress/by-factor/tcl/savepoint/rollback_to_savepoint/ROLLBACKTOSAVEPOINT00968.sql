...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00968
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00968|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00968_sp AND NO CHAIN;
-- primary-target-end
