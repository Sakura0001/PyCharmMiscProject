...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01410
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01410|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01410_sp;
-- primary-target-end
