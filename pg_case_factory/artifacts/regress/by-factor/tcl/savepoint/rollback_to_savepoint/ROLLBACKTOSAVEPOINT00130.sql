...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00130
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00130|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00130_sp AND CHAIN;
-- primary-target-end
