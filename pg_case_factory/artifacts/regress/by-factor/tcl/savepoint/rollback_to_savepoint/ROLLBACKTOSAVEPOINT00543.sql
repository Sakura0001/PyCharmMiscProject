...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00543
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00543|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00543_sp AND CHAIN;
-- primary-target-end
