...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01543
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01543|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01543_sp;
-- primary-target-end
