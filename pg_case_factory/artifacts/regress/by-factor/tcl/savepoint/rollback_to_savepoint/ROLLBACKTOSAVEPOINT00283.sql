...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00283
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00283|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00283_sp AND CHAIN;
-- primary-target-end
