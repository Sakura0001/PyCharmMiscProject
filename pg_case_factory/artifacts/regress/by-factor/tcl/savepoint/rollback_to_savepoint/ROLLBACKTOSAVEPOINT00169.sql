...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00169
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00169|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00169_sp AND CHAIN;
-- primary-target-end
