...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00239
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00239|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00239_sp AND CHAIN;
-- primary-target-end
