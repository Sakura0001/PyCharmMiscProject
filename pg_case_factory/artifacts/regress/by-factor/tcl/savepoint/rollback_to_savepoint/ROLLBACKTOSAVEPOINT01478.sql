...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01478
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01478|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01478_sp;
-- primary-target-end
