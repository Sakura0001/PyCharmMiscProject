...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00499
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00499|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00499_sp AND CHAIN;
-- primary-target-end
