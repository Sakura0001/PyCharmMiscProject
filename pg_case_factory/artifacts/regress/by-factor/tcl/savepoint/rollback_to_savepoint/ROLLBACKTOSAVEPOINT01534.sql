...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01534
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01534|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01534_sp;
-- primary-target-end
