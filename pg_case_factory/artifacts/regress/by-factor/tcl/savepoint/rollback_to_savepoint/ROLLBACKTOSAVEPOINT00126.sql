...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00126
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00126|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00126_sp AND CHAIN;
-- primary-target-end
