...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01171
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01171|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01171_sp AND NO CHAIN;
-- primary-target-end
