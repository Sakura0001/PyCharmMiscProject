...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00109
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00109|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00109_sp AND CHAIN;
-- primary-target-end
