...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00120
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00120|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00120_sp AND CHAIN;
-- primary-target-end
