...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00686
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00686|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00686_sp AND NO CHAIN;
-- primary-target-end
