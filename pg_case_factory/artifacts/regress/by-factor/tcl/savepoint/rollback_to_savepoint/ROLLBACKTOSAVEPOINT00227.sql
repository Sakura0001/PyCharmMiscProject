...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00227
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00227|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00227_sp AND CHAIN;
-- primary-target-end
