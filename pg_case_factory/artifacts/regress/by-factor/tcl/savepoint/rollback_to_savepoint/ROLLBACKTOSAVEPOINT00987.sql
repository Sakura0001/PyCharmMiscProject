...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00987
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00987|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00987_sp AND NO CHAIN;
-- primary-target-end
