...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00222
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00222|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00222_sp AND CHAIN;
-- primary-target-end
