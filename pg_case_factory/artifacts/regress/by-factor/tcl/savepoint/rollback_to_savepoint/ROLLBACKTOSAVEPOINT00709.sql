...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00709
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00709|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00709_sp AND NO CHAIN;
-- primary-target-end
