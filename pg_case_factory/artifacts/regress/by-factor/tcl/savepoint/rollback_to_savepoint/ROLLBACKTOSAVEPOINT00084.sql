...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00084
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00084|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00084_sp AND CHAIN;
-- primary-target-end
