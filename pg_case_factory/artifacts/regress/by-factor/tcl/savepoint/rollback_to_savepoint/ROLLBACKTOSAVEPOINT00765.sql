...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00765
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00765|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00765_sp AND NO CHAIN;
-- primary-target-end
