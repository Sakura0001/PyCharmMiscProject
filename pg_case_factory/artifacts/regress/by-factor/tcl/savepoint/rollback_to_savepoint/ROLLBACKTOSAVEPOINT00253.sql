...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00253
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00253|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00253_sp AND CHAIN;
-- primary-target-end
