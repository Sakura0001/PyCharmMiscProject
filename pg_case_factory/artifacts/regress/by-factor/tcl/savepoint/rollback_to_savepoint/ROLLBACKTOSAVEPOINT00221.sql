...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00221
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00221|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00221_sp AND CHAIN;
-- primary-target-end
