...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00151
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00151|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00151_sp AND CHAIN;
-- primary-target-end
