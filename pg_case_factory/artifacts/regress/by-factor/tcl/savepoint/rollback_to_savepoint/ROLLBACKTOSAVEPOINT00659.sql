...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00659
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00659|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00659_sp AND NO CHAIN;
-- primary-target-end
