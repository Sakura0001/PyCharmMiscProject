...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00848
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00848|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00848_sp AND NO CHAIN;
-- primary-target-end
