...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00192
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00192|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00192_sp AND CHAIN;
-- primary-target-end
