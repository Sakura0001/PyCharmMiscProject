...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00228
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00228|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00228_sp AND CHAIN;
-- primary-target-end
