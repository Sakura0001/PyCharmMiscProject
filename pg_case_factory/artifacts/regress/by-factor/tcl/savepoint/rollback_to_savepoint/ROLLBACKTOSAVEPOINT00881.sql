...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00881
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00881|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00881_sp AND NO CHAIN;
-- primary-target-end
