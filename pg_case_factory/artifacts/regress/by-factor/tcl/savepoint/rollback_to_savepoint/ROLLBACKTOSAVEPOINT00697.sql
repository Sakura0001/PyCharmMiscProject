...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00697
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00697|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00697_sp AND NO CHAIN;
-- primary-target-end
