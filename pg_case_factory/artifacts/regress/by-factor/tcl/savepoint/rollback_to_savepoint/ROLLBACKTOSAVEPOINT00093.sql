...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00093
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00093|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00093_sp AND CHAIN;
-- primary-target-end
