...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00166
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00166|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00166_sp AND CHAIN;
-- primary-target-end
