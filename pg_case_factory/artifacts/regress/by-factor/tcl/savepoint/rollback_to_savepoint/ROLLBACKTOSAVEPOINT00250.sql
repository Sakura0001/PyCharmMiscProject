...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00250
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00250|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00250_sp AND CHAIN;
-- primary-target-end
