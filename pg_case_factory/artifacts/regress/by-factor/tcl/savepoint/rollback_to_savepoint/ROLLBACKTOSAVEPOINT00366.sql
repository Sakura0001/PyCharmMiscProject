...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00366
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00366|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00366_sp AND CHAIN;
-- primary-target-end
