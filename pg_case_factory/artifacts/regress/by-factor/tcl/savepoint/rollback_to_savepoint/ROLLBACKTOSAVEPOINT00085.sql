...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00085
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00085|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00085_sp AND CHAIN;
-- primary-target-end
