...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00895
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00895|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00895_sp AND NO CHAIN;
-- primary-target-end
