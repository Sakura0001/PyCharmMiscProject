...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00071
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00071|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00071_sp AND CHAIN;
-- primary-target-end
