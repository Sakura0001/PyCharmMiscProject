...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT transaction_id_shape=quoted_id
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00029
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-e2065add6dc774db6fb034aa|rollback_to_savepoint
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00029_sp;
-- primary-target-end
