...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00540
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00540|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00540_sp AND CHAIN;
-- primary-target-end
