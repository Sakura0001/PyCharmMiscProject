...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00282
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00282|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00282_sp AND CHAIN;
-- primary-target-end
