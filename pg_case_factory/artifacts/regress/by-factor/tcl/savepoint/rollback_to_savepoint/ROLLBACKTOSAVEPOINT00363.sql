...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00363
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00363|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00363_sp AND CHAIN;
-- primary-target-end
