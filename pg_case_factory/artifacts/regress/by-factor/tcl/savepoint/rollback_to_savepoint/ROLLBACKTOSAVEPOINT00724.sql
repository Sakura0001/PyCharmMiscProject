...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00724
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00724|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00724_sp AND NO CHAIN;
-- primary-target-end
