...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00831
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00831|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00831_sp AND NO CHAIN;
-- primary-target-end
