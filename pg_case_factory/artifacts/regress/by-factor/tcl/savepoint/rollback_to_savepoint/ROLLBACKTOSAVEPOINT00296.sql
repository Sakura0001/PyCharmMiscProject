...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00296
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00296|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00296_sp AND CHAIN;
-- primary-target-end
