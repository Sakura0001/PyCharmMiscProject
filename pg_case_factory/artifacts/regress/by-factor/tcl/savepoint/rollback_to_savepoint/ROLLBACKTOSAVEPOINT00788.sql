...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00788
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00788|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00788_sp AND NO CHAIN;
-- primary-target-end
