...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00471
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00471|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00471_sp AND CHAIN;
-- primary-target-end
