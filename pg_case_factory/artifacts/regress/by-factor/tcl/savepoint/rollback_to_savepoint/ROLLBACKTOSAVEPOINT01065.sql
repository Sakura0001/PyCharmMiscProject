...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01065
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01065|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01065_sp AND NO CHAIN;
-- primary-target-end
