...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01370
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01370|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01370_sp;
-- primary-target-end
