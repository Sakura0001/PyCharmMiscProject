...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01491
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01491|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01491_sp;
-- primary-target-end
