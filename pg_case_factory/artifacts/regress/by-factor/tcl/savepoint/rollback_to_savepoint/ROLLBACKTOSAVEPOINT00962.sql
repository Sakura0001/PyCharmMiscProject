...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00962
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00962|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00962_sp AND NO CHAIN;
-- primary-target-end
