...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01169
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01169|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01169_sp AND NO CHAIN;
-- primary-target-end
