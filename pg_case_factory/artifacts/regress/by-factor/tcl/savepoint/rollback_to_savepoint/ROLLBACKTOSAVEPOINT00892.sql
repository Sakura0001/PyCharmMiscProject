...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00892
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00892|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00892_sp AND NO CHAIN;
-- primary-target-end
