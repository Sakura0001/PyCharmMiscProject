...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00202
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00202|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00202_sp AND CHAIN;
-- primary-target-end
