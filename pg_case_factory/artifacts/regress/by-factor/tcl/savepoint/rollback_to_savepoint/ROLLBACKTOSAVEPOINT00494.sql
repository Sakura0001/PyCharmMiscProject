...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00494
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00494|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00494_sp AND CHAIN;
-- primary-target-end
