...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00695
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00695|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00695_sp AND NO CHAIN;
-- primary-target-end
