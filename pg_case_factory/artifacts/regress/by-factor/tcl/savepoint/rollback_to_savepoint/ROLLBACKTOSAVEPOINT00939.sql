...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00939
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00939|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00939_sp AND NO CHAIN;
-- primary-target-end
