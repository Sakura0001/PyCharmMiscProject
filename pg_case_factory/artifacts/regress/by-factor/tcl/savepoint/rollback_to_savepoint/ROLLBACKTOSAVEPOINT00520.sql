...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00520
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00520|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00520_sp AND CHAIN;
-- primary-target-end
