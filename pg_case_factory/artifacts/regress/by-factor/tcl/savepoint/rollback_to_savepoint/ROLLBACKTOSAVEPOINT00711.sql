...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00711
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00711|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00711_sp AND NO CHAIN;
-- primary-target-end
