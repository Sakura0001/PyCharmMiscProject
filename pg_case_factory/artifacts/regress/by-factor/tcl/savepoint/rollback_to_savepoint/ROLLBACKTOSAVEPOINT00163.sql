...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00163
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00163|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00163_sp AND CHAIN;
-- primary-target-end
