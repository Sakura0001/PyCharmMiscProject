...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01122
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01122|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01122_sp AND NO CHAIN;
-- primary-target-end
