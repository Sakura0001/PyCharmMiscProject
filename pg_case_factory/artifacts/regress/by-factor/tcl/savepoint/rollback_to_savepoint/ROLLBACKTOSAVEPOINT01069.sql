...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01069
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01069|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01069_sp AND NO CHAIN;
-- primary-target-end
