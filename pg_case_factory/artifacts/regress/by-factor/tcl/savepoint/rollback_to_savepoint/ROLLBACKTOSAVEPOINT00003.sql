...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT chain_behavior=and_no_chain
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00003
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-45d8e712d0f9a417c40ea1d5|rollback_to_savepoint
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00003_sp AND NO CHAIN;
-- primary-target-end
