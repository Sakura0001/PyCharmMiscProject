...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00160
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00160|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00160_sp AND CHAIN;
-- primary-target-end
