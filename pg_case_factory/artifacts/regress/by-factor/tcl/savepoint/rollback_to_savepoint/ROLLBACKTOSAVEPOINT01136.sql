...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01136
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01136|error_assertion|reset_state
...
SAVEPOINT rollbacktosavepoint_01136_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01136_sp AND NO CHAIN;
-- primary-target-end
