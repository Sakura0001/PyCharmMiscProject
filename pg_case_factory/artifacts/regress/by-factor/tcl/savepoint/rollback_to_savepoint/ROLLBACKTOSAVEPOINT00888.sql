...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00888
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00888|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00888_sp AND NO CHAIN;
-- primary-target-end
