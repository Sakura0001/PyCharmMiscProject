...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00795
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00795|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00795_sp AND NO CHAIN;
-- primary-target-end
