...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01073
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01073|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01073_sp AND NO CHAIN;
-- primary-target-end
