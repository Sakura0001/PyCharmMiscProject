...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00563
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00563|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00563_sp AND CHAIN;
-- primary-target-end
