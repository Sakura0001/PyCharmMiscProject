...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00101
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00101|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00101_sp AND CHAIN;
-- primary-target-end
