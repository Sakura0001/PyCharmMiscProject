...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00664
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00664|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00664_sp AND NO CHAIN;
-- primary-target-end
