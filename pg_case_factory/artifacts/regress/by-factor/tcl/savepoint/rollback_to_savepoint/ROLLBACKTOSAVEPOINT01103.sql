...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01103
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01103|catalog_query|reset_state
...
SAVEPOINT rollbacktosavepoint_01103_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01103_sp AND NO CHAIN;
-- primary-target-end
