...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00882
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00882|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00882_sp AND NO CHAIN;
-- primary-target-end
