...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00705
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00705|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00705_sp AND NO CHAIN;
-- primary-target-end
