...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00732
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00732|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00732_sp AND NO CHAIN;
-- primary-target-end
