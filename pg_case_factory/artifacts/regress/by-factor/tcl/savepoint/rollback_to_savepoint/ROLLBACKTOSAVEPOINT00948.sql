...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00948
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00948|effect_query|rollback
...
SAVEPOINT rollbacktosavepoint_00948_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00948_sp AND NO CHAIN;
-- primary-target-end
