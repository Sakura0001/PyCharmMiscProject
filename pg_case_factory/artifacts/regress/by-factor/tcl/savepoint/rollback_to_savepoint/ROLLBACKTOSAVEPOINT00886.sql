...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00886
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00886|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00886_sp AND NO CHAIN;
-- primary-target-end
