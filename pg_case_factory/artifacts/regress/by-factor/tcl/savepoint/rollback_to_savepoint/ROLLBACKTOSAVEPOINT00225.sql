...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00225
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00225|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00225_sp AND CHAIN;
-- primary-target-end
