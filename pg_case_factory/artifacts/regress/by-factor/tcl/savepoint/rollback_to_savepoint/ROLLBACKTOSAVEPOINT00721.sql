...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00721
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00721|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00721_sp AND NO CHAIN;
-- primary-target-end
