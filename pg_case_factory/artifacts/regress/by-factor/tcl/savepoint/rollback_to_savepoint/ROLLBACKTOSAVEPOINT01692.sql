...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01692
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01692|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01692_sp;
-- primary-target-end
