...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00653
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00653|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00653_sp AND NO CHAIN;
-- primary-target-end
