...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT chain_behavior=and_chain
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00002
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-f35ae1ed6d9020aa7deaf291|rollback_to_savepoint
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00002_sp AND CHAIN;
-- primary-target-end
