...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00673
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00673|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00673_sp AND NO CHAIN;
-- primary-target-end
