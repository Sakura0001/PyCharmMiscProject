...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01540
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01540|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01540_sp;
-- primary-target-end
