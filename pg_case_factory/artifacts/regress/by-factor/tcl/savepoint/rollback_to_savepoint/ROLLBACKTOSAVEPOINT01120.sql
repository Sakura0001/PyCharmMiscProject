...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01120
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01120|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01120_sp AND NO CHAIN;
-- primary-target-end
