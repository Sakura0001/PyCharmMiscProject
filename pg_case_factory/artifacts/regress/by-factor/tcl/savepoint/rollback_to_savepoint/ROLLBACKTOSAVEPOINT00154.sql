...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00154
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00154|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00154_sp AND CHAIN;
-- primary-target-end
