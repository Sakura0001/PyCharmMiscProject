...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00340
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00340|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00340_sp AND CHAIN;
-- primary-target-end
