...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00245
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00245|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00245_sp AND CHAIN;
-- primary-target-end
