...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00102
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00102|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00102_sp AND CHAIN;
-- primary-target-end
