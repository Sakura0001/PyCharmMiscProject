...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00949
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00949|effect_query|drop_objects
...
SAVEPOINT rollbacktosavepoint_00949_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00949_sp AND NO CHAIN;
-- primary-target-end
