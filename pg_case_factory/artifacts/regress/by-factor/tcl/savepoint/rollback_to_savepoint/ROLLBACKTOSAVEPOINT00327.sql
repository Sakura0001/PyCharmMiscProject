...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00327
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00327|returned_rows|rollback
...
SAVEPOINT rollbacktosavepoint_00327_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00327_sp AND CHAIN;
-- primary-target-end
