...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00733
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00733|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00733_sp AND NO CHAIN;
-- primary-target-end
