...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00146
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00146|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00146_sp AND CHAIN;
-- primary-target-end
