...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00889
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00889|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00889_sp AND NO CHAIN;
-- primary-target-end
