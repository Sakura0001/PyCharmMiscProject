...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00550
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00550|catalog_query|drop_objects
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ ONLY;
SAVEPOINT rollbacktosavepoint_00550_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00550_sp AND CHAIN;
-- primary-target-end
