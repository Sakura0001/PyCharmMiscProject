...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00220
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00220|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00220_sp AND CHAIN;
-- primary-target-end
