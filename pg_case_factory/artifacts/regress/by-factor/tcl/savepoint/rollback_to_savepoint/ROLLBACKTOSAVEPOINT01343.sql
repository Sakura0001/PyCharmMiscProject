...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01343
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01343|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01343_sp;
-- primary-target-end
