...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00360
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00360|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00360_sp AND CHAIN;
-- primary-target-end
