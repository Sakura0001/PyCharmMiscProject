...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00936
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00936|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00936_sp AND NO CHAIN;
-- primary-target-end
