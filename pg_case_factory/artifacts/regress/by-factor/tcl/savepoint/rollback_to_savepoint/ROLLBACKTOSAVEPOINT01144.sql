...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01144
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01144|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01144_sp AND NO CHAIN;
-- primary-target-end
