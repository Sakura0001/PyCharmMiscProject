...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00967
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00967|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00967_sp AND NO CHAIN;
-- primary-target-end
