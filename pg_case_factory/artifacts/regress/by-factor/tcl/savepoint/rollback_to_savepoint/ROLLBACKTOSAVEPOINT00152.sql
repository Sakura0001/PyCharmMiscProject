...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00152
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00152|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00152_sp AND CHAIN;
-- primary-target-end
