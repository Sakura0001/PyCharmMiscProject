...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00912
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00912|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00912_sp AND NO CHAIN;
-- primary-target-end
