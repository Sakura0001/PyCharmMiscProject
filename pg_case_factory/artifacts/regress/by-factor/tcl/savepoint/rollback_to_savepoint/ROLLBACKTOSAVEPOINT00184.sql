...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00184
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00184|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00184_sp AND CHAIN;
-- primary-target-end
