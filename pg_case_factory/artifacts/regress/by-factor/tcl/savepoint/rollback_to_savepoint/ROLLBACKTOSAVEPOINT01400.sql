...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01400
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01400|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01400_sp;
-- primary-target-end
