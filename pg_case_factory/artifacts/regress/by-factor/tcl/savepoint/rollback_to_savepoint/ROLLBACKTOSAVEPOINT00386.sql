...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00386
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00386|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00386_sp AND CHAIN;
-- primary-target-end
