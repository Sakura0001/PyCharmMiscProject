...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01141
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01141|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01141_sp AND NO CHAIN;
-- primary-target-end
