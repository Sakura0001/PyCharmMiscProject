...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01702
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01702|catalog_query|drop_objects
...
SAVEPOINT rollbacktosavepoint_01702_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01702_sp;
-- primary-target-end
