...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00356
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00356|error_assertion|reset_state
...
SAVEPOINT rollbacktosavepoint_00356_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00356_sp AND CHAIN;
-- primary-target-end
