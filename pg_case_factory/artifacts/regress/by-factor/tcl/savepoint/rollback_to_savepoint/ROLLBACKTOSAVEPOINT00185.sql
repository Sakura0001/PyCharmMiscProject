...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00185
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00185|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00185_sp AND CHAIN;
-- primary-target-end
