...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00707
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00707|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00707_sp AND NO CHAIN;
-- primary-target-end
