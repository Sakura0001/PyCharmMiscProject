...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00868
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00868|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00868_sp AND NO CHAIN;
-- primary-target-end
