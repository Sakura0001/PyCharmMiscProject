...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00845
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00845|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00845_sp AND NO CHAIN;
-- primary-target-end
