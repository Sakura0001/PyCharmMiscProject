...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00885
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00885|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00885_sp AND NO CHAIN;
-- primary-target-end
