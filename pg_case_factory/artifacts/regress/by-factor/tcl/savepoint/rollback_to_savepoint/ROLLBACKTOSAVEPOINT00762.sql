...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00762
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00762|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00762_sp AND NO CHAIN;
-- primary-target-end
