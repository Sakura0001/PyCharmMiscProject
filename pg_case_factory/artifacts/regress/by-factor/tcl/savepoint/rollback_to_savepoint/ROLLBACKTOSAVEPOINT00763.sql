...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00763
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00763|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00763_sp AND NO CHAIN;
-- primary-target-end
