...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00702
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00702|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00702_sp AND NO CHAIN;
-- primary-target-end
