...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00189
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00189|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00189_sp AND CHAIN;
-- primary-target-end
