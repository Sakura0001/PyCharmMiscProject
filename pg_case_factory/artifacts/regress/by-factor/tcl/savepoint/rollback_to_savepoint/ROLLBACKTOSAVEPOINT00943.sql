...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00943
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00943|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00943_sp AND NO CHAIN;
-- primary-target-end
