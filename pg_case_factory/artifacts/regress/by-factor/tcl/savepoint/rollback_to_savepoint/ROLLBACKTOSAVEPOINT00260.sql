...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00260
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00260|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00260_sp AND CHAIN;
-- primary-target-end
