...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT transaction_state=inside_transaction
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00036
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-08dd29202fc70d5b5bbffbc1|rollback_to_savepoint
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00036_sp;
-- primary-target-end
