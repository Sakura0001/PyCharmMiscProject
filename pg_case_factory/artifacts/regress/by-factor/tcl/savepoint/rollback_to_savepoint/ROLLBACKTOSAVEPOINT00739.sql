...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00739
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00739|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00739_sp AND NO CHAIN;
-- primary-target-end
