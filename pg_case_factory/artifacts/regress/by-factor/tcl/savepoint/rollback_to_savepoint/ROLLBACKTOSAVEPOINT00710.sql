...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00710
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00710|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00710_sp AND NO CHAIN;
-- primary-target-end
