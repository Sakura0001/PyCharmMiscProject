...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00827
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00827|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00827_sp AND NO CHAIN;
-- primary-target-end
