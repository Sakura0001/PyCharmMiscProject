...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00174
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00174|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00174_sp AND CHAIN;
-- primary-target-end
