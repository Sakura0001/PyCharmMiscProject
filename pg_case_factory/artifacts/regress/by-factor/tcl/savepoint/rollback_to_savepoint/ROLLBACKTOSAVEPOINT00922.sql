...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00922
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00922|catalog_query|drop_objects
...
SAVEPOINT rollbacktosavepoint_00922_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00922_sp AND NO CHAIN;
-- primary-target-end
