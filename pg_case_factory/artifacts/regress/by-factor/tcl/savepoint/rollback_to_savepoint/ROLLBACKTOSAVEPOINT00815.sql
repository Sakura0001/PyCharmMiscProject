...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00815
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00815|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00815_sp AND NO CHAIN;
-- primary-target-end
