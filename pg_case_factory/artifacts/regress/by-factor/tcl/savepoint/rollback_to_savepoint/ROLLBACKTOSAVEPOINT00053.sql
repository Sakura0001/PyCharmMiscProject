...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00053
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00053|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00053_sp AND CHAIN;
-- primary-target-end
