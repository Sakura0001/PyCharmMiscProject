...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00894
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00894|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00894_sp AND NO CHAIN;
-- primary-target-end
