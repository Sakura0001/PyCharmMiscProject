...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00687
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00687|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00687_sp AND NO CHAIN;
-- primary-target-end
