...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00510
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00510|error_assertion|rollback
...
SAVEPOINT rollbacktosavepoint_00510_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00510_sp AND CHAIN;
-- primary-target-end
