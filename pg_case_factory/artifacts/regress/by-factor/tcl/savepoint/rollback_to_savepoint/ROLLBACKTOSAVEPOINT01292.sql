...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01292
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01292|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01292_sp;
-- primary-target-end
