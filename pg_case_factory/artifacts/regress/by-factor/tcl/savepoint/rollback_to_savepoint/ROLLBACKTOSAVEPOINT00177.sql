...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00177
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00177|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00177_sp AND CHAIN;
-- primary-target-end
