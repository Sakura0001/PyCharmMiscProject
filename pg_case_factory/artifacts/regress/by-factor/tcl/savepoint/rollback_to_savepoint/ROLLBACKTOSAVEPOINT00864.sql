...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00864
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00864|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00864_sp AND NO CHAIN;
-- primary-target-end
