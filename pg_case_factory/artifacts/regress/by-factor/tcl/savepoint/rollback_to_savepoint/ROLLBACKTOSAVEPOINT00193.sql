...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00193
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00193|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00193_sp AND CHAIN;
-- primary-target-end
