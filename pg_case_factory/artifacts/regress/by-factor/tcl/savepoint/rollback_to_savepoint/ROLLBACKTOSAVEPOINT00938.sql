...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00938
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00938|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00938_sp AND NO CHAIN;
-- primary-target-end
