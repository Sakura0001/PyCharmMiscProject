...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00779
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00779|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00779_sp AND NO CHAIN;
-- primary-target-end
