...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00698
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00698|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00698_sp AND NO CHAIN;
-- primary-target-end
