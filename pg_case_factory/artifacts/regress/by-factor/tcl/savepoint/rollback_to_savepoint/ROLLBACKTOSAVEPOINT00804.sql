...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00804
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00804|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00804_sp AND NO CHAIN;
-- primary-target-end
