...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00175
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00175|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00175_sp AND CHAIN;
-- primary-target-end
