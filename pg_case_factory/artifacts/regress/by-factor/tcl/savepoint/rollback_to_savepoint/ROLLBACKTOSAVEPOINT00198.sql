...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00198
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00198|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00198_sp AND CHAIN;
-- primary-target-end
