...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00909
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00909|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00909_sp AND NO CHAIN;
-- primary-target-end
