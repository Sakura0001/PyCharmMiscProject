...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00771
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00771|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00771_sp AND NO CHAIN;
-- primary-target-end
