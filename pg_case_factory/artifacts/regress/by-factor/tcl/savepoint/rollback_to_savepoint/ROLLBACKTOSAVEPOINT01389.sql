...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01389
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01389|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01389_sp;
-- primary-target-end
