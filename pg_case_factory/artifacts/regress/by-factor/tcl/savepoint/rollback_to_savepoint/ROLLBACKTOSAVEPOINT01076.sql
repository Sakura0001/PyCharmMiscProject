...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01076
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01076|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01076_sp AND NO CHAIN;
-- primary-target-end
