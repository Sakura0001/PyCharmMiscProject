...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01691
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01691|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01691_sp;
-- primary-target-end
