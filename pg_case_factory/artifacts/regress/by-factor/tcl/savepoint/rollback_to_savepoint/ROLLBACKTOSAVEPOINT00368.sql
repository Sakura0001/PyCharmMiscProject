...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00368
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00368|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00368_sp AND CHAIN;
-- primary-target-end
