...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00149
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00149|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00149_sp AND CHAIN;
-- primary-target-end
