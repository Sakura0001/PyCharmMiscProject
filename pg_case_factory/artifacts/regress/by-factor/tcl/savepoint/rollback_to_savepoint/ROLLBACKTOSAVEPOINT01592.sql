...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01592
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01592|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01592_sp;
-- primary-target-end
