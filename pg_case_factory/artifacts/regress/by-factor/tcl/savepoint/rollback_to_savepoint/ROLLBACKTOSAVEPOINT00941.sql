...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00941
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00941|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00941_sp AND NO CHAIN;
-- primary-target-end
