...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00745
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00745|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00745_sp AND NO CHAIN;
-- primary-target-end
