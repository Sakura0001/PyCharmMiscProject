...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00786
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00786|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00786_sp AND NO CHAIN;
-- primary-target-end
