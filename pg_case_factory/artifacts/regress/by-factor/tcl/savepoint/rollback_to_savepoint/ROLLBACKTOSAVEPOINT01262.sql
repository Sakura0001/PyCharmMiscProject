...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01262
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01262|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01262_sp;
-- primary-target-end
