...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00049
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00049|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00049_sp AND CHAIN;
-- primary-target-end
