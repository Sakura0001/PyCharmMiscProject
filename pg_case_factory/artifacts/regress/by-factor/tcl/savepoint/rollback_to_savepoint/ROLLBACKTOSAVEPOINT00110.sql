...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00110
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00110|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00110_sp AND CHAIN;
-- primary-target-end
