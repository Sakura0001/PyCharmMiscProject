...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01438
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01438|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01438_sp;
-- primary-target-end
