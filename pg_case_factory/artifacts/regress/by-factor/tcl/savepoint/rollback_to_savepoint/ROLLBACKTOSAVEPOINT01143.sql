...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01143
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01143|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01143_sp AND NO CHAIN;
-- primary-target-end
