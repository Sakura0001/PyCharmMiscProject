...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00138
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00138|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00138_sp AND CHAIN;
-- primary-target-end
