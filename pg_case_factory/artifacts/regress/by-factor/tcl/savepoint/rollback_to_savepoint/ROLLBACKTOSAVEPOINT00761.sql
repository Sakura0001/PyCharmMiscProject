...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00761
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00761|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00761_sp AND NO CHAIN;
-- primary-target-end
