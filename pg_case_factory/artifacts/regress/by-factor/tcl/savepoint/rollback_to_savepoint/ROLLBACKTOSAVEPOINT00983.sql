...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00983
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00983|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00983_sp AND NO CHAIN;
-- primary-target-end
