...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01730
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01730|effect_query|reset_state
...
SAVEPOINT rollbacktosavepoint_01730_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01730_sp;
-- primary-target-end
