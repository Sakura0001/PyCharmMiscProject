...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00744
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00744|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00744_sp AND NO CHAIN;
-- primary-target-end
