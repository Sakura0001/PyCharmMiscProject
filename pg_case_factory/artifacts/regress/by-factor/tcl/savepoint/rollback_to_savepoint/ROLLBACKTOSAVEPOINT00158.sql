...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00158
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00158|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00158_sp AND CHAIN;
-- primary-target-end
