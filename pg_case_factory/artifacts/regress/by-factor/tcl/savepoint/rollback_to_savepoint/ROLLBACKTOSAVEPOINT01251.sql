...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01251
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01251|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01251_sp;
-- primary-target-end
