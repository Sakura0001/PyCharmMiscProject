...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00155
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00155|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00155_sp AND CHAIN;
-- primary-target-end
