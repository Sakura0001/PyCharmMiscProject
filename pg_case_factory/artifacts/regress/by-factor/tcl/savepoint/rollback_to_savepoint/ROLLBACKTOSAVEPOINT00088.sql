...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00088
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00088|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00088_sp AND CHAIN;
-- primary-target-end
