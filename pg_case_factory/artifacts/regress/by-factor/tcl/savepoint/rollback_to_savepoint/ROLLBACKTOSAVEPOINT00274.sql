...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00274
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00274|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00274_sp AND CHAIN;
-- primary-target-end
