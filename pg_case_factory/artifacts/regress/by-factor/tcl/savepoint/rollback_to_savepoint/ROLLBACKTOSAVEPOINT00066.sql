...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00066
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00066|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00066_sp AND CHAIN;
-- primary-target-end
