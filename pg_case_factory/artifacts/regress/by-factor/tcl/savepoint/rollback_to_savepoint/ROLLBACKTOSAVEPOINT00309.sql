...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00309
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00309|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00309_sp AND CHAIN;
-- primary-target-end
