...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01553
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01553|returned_rows|reset_state
...
SAVEPOINT rollbacktosavepoint_01553_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01553_sp;
-- primary-target-end
