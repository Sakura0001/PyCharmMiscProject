...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01732
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01732|returned_rows|drop_objects
...
SAVEPOINT rollbacktosavepoint_01732_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01732_sp;
-- primary-target-end
