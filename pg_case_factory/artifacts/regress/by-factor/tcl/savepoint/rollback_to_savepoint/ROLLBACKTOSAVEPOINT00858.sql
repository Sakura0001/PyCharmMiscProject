...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00858
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00858|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00858_sp AND NO CHAIN;
-- primary-target-end
