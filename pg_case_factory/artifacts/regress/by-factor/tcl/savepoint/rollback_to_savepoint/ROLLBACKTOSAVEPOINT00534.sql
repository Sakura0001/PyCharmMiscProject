...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00534
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00534|error_assertion|rollback
...
SAVEPOINT rollbacktosavepoint_00534_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00534_sp AND CHAIN;
-- primary-target-end
