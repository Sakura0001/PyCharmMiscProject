...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00055
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00055|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00055_sp AND CHAIN;
-- primary-target-end
