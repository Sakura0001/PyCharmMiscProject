...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00290
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00290|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00290_sp AND CHAIN;
-- primary-target-end
