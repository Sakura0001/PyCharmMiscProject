...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00266
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00266|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00266_sp AND CHAIN;
-- primary-target-end
