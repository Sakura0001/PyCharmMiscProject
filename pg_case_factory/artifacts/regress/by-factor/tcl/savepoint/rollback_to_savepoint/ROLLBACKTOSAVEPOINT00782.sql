...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00782
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00782|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00782_sp AND NO CHAIN;
-- primary-target-end
