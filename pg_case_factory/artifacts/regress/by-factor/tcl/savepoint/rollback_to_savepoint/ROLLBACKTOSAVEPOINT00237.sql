...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00237
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00237|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00237_sp AND CHAIN;
-- primary-target-end
