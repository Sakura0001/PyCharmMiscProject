...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00339
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00339|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00339_sp AND CHAIN;
-- primary-target-end
