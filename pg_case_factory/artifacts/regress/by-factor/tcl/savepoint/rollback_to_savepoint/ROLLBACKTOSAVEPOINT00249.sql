...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00249
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00249|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00249_sp AND CHAIN;
-- primary-target-end
