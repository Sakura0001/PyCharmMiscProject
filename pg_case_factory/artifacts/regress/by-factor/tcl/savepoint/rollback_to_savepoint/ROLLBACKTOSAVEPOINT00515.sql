...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00515
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00515|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00515_sp AND CHAIN;
-- primary-target-end
