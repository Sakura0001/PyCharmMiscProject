...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00276
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00276|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00276_sp AND CHAIN;
-- primary-target-end
