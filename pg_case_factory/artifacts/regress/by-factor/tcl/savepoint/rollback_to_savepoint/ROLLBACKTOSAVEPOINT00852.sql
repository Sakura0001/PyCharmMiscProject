...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00852
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00852|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00852_sp AND NO CHAIN;
-- primary-target-end
