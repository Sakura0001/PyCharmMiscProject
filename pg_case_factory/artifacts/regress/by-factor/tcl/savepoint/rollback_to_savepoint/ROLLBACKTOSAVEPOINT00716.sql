...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00716
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00716|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00716_sp AND NO CHAIN;
-- primary-target-end
