...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01336
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01336|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01336_sp;
-- primary-target-end
