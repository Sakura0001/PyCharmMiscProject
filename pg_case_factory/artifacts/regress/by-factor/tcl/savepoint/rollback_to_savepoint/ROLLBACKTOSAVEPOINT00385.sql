...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00385
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00385|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00385_sp AND CHAIN;
-- primary-target-end
