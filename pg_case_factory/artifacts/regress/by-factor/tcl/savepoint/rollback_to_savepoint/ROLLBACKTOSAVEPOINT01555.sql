...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01555
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01555|error_assertion|drop_objects
...
SAVEPOINT rollbacktosavepoint_01555_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01555_sp;
-- primary-target-end
