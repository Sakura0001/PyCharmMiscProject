...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00468
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00468|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00468_sp AND CHAIN;
-- primary-target-end
