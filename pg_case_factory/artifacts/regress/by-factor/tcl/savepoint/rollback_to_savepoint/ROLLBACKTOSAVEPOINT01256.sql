...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01256
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01256|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01256_sp;
-- primary-target-end
