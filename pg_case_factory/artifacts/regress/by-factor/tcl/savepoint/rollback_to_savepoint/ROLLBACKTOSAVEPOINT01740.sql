...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01740
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01740|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01740_sp;
-- primary-target-end
