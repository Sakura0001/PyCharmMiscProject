...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00148
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00148|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00148_sp AND CHAIN;
-- primary-target-end
