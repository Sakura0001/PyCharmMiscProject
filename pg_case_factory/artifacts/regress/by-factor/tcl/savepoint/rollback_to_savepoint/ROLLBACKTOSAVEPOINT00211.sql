...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00211
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00211|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00211_sp AND CHAIN;
-- primary-target-end
