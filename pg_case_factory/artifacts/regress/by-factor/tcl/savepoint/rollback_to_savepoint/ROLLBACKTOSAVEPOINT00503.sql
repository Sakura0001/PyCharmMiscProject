...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00503
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00503|catalog_query|reset_state
...
SAVEPOINT rollbacktosavepoint_00503_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00503_sp AND CHAIN;
-- primary-target-end
