...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00876
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00876|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00876_sp AND NO CHAIN;
-- primary-target-end
