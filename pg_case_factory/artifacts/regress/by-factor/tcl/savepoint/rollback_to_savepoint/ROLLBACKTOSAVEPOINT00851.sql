...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00851
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00851|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00851_sp AND NO CHAIN;
-- primary-target-end
