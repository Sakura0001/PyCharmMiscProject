...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00261
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00261|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00261_sp AND CHAIN;
-- primary-target-end
