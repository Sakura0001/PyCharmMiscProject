...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00123
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00123|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00123_sp AND CHAIN;
-- primary-target-end
