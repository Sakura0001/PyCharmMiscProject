...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00280
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00280|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00280_sp AND CHAIN;
-- primary-target-end
