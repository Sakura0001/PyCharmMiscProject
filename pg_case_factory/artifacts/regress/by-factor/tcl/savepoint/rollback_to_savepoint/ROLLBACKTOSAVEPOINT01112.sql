...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01112
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01112|error_assertion|reset_state
...
SAVEPOINT rollbacktosavepoint_01112_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01112_sp AND NO CHAIN;
-- primary-target-end
