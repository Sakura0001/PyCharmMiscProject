...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00884
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00884|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00884_sp AND NO CHAIN;
-- primary-target-end
