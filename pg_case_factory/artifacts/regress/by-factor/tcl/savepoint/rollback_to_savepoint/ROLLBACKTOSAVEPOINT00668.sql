...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00668
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00668|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00668_sp AND NO CHAIN;
-- primary-target-end
