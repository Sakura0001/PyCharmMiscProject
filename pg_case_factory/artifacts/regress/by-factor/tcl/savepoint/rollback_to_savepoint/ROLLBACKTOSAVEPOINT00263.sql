...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00263
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00263|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00263_sp AND CHAIN;
-- primary-target-end
