...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00070
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00070|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00070_sp AND CHAIN;
-- primary-target-end
