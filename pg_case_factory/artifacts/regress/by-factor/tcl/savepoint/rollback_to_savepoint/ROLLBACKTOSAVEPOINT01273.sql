...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01273
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01273|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01273_sp;
-- primary-target-end
