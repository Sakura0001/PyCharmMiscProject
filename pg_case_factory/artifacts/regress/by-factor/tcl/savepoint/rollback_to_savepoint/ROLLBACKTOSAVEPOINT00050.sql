...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00050
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00050|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00050_sp AND CHAIN;
-- primary-target-end
