...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT environment_context=external_resource_required
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00008
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-bc8bc831f82621543481ae46|rollback_to_savepoint
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00008_sp;
-- primary-target-end
