...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00243
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00243|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00243_sp AND CHAIN;
-- primary-target-end
