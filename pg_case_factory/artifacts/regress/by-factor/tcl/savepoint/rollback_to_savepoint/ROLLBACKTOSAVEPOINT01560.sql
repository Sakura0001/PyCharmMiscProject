...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01560
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01560|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01560_sp;
-- primary-target-end
