...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00846
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00846|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00846_sp AND NO CHAIN;
-- primary-target-end
