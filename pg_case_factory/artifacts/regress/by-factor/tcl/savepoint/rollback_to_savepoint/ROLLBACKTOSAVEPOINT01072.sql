...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01072
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01072|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01072_sp AND NO CHAIN;
-- primary-target-end
