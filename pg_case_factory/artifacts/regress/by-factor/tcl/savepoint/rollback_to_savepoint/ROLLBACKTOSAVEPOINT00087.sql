...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00087
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00087|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00087_sp AND CHAIN;
-- primary-target-end
