...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00052
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00052|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00052_sp AND CHAIN;
-- primary-target-end
