...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00167
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00167|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00167_sp AND CHAIN;
-- primary-target-end
