...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00701
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00701|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00701_sp AND NO CHAIN;
-- primary-target-end
