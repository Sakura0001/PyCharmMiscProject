...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00247
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00247|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00247_sp AND CHAIN;
-- primary-target-end
