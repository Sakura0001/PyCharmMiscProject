...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00748
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00748|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00748_sp AND NO CHAIN;
-- primary-target-end
