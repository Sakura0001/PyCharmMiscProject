...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01565
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01565|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01565_sp;
-- primary-target-end
