...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00264
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00264|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00264_sp AND CHAIN;
-- primary-target-end
