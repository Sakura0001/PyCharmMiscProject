...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01741
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01741|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01741_sp;
-- primary-target-end
