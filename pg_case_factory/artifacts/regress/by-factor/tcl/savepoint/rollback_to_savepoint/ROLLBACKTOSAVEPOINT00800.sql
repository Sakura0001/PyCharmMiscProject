...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00800
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00800|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00800_sp AND NO CHAIN;
-- primary-target-end
