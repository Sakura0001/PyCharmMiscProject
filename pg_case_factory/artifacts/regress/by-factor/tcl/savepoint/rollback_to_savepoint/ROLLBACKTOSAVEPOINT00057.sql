...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00057
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00057|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00057_sp AND CHAIN;
-- primary-target-end
