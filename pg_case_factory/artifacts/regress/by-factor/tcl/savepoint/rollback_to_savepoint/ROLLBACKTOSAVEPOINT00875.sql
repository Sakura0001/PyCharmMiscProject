...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00875
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00875|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00875_sp AND NO CHAIN;
-- primary-target-end
