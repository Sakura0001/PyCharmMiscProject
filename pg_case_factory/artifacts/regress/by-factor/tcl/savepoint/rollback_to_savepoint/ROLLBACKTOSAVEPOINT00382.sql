...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00382
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00382|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00382_sp AND CHAIN;
-- primary-target-end
