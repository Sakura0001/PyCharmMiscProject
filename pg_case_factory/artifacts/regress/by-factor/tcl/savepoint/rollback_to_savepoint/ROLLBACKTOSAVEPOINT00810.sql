...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00810
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00810|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00810_sp AND NO CHAIN;
-- primary-target-end
