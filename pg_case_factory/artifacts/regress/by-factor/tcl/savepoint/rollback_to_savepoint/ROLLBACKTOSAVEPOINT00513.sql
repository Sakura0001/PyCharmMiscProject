...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00513
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00513|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00513_sp AND CHAIN;
-- primary-target-end
