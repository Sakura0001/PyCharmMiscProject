...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00392
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00392|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00392_sp AND CHAIN;
-- primary-target-end
