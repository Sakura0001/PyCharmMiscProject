...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00226
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00226|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00226_sp AND CHAIN;
-- primary-target-end
