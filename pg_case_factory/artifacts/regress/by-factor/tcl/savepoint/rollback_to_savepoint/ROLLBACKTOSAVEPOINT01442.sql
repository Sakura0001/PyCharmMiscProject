...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01442
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01442|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01442_sp;
-- primary-target-end
