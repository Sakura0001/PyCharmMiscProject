...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00754
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00754|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00754_sp AND NO CHAIN;
-- primary-target-end
