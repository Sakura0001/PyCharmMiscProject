...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00209
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00209|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00209_sp AND CHAIN;
-- primary-target-end
