...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01487
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01487|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01487_sp;
-- primary-target-end
