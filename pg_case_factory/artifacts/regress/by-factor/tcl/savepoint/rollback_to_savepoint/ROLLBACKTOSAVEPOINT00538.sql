...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00538
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00538|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00538_sp AND CHAIN;
-- primary-target-end
