...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00334
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00334|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00334_sp AND CHAIN;
-- primary-target-end
