...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00865
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00865|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00865_sp AND NO CHAIN;
-- primary-target-end
