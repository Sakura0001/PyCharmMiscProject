...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01766
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01766|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01766_sp;
-- primary-target-end
