...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00805
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00805|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00805_sp AND NO CHAIN;
-- primary-target-end
