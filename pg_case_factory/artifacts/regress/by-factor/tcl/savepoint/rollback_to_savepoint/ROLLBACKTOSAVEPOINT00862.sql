...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00862
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00862|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00862_sp AND NO CHAIN;
-- primary-target-end
