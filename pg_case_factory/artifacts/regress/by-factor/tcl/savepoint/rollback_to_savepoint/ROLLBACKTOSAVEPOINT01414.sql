...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01414
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01414|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01414_sp;
-- primary-target-end
