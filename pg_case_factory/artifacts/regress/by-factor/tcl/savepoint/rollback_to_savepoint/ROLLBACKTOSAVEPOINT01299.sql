...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01299
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01299|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01299_sp;
-- primary-target-end
