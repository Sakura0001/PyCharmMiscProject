...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01369
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01369|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01369_sp;
-- primary-target-end
