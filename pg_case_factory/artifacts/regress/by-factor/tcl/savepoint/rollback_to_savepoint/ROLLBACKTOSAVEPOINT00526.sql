...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00526
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00526|catalog_query|drop_objects
...
SAVEPOINT rollbacktosavepoint_00526_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00526_sp AND CHAIN;
-- primary-target-end
