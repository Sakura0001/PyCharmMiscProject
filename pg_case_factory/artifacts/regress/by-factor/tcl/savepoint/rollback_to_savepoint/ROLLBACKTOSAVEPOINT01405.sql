...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01405
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01405|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01405_sp;
-- primary-target-end
