...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00940
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00940|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00940_sp AND NO CHAIN;
-- primary-target-end
