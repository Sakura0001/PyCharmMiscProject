...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01075
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01075|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01075_sp AND NO CHAIN;
-- primary-target-end
