...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00113
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00113|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00113_sp AND CHAIN;
-- primary-target-end
