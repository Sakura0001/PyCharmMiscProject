...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00271
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00271|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00271_sp AND CHAIN;
-- primary-target-end
