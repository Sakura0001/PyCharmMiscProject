...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01099
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01099|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01099_sp AND NO CHAIN;
-- primary-target-end
