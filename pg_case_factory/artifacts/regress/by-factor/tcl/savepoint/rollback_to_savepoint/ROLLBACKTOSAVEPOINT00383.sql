...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00383
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00383|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00383_sp AND CHAIN;
-- primary-target-end
