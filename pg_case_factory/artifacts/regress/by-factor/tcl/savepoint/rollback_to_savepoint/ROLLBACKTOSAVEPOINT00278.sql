...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00278
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00278|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00278_sp AND CHAIN;
-- primary-target-end
