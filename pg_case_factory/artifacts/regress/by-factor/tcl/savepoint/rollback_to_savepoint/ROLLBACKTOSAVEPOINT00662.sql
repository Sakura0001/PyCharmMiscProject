...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00662
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00662|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00662_sp AND NO CHAIN;
-- primary-target-end
