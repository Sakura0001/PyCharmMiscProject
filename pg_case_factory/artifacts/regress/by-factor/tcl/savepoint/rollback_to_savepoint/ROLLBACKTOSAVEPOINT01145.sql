...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01145
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01145|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01145_sp AND NO CHAIN;
-- primary-target-end
