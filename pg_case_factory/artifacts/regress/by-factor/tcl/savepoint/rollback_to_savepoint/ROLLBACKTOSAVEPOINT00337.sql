...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00337
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00337|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00337_sp AND CHAIN;
-- primary-target-end
