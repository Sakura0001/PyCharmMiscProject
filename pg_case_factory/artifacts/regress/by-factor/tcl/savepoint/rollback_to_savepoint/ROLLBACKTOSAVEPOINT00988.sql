...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00988
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00988|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00988_sp AND NO CHAIN;
-- primary-target-end
