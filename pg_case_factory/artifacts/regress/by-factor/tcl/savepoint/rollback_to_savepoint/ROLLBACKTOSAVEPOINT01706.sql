...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01706
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01706|effect_query|reset_state
...
SAVEPOINT rollbacktosavepoint_01706_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01706_sp;
-- primary-target-end
