...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00723
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00723|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00723_sp AND NO CHAIN;
-- primary-target-end
