...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01700
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01700|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01700_sp;
-- primary-target-end
