...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01102
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01102|catalog_query|drop_objects
...
SAVEPOINT rollbacktosavepoint_01102_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01102_sp AND NO CHAIN;
-- primary-target-end
