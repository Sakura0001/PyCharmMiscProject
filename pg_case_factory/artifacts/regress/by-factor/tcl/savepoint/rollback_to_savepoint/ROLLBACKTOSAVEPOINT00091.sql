...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00091
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00091|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00091_sp AND CHAIN;
-- primary-target-end
