...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00132
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00132|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00132_sp AND CHAIN;
-- primary-target-end
