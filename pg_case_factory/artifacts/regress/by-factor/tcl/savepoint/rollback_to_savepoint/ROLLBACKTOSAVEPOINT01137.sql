...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01137
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01137|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01137_sp AND NO CHAIN;
-- primary-target-end
