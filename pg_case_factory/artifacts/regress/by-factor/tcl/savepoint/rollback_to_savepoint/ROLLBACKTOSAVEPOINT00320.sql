...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00320
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00320|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00320_sp AND CHAIN;
-- primary-target-end
