...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00861
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00861|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00861_sp AND NO CHAIN;
-- primary-target-end
