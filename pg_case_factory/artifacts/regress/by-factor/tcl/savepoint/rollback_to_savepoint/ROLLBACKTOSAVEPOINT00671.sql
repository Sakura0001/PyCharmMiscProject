...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00671
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00671|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00671_sp AND NO CHAIN;
-- primary-target-end
