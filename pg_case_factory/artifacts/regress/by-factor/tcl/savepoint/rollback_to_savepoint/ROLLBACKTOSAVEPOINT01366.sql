...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01366
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01366|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01366_sp;
-- primary-target-end
