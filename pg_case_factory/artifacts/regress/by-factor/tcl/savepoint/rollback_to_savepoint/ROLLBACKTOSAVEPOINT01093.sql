...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01093
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01093|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01093_sp AND NO CHAIN;
-- primary-target-end
