...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01717
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01717|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01717_sp;
-- primary-target-end
