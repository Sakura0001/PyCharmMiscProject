...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00802
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00802|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00802_sp AND NO CHAIN;
-- primary-target-end
