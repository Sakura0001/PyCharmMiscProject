...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00082
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00082|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00082_sp AND CHAIN;
-- primary-target-end
