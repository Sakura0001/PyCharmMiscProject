...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00914
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00914|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00914_sp AND NO CHAIN;
-- primary-target-end
