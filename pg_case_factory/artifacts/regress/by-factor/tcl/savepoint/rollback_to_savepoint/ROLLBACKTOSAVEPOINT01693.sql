...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01693
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01693|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01693_sp;
-- primary-target-end
