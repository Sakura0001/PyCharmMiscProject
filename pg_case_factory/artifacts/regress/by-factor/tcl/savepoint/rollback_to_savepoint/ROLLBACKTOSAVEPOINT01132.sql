...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01132
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01132|returned_rows|drop_objects
...
SAVEPOINT rollbacktosavepoint_01132_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01132_sp AND NO CHAIN;
-- primary-target-end
