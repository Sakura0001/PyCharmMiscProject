...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00842
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00842|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00842_sp AND NO CHAIN;
-- primary-target-end
