...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01548
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01548|effect_query|rollback
...
SAVEPOINT rollbacktosavepoint_01548_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01548_sp;
-- primary-target-end
