...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01309
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01309|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01309_sp;
-- primary-target-end
