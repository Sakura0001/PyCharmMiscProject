...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01250
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01250|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01250_sp;
-- primary-target-end
