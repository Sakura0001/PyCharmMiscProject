...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00834
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00834|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00834_sp AND NO CHAIN;
-- primary-target-end
