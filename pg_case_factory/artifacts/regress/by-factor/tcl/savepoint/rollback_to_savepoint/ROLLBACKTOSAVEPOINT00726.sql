...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00726
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00726|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00726_sp AND NO CHAIN;
-- primary-target-end
