...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00752
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00752|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00752_sp AND NO CHAIN;
-- primary-target-end
