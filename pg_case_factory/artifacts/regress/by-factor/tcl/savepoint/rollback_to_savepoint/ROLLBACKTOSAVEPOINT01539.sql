...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01539
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01539|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01539_sp;
-- primary-target-end
