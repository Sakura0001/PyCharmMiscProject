...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01298
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01298|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01298_sp;
-- primary-target-end
