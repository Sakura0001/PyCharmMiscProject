...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00924
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00924|effect_query|rollback
...
SAVEPOINT rollbacktosavepoint_00924_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00924_sp AND NO CHAIN;
-- primary-target-end
