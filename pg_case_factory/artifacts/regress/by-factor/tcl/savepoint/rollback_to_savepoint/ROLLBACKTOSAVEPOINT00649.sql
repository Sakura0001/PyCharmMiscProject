...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00649
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00649|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00649_sp AND NO CHAIN;
-- primary-target-end
