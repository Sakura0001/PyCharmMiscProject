...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00293
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00293|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00293_sp AND CHAIN;
-- primary-target-end
