...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00950
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00950|effect_query|reset_state
...
SAVEPOINT rollbacktosavepoint_00950_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00950_sp AND NO CHAIN;
-- primary-target-end
