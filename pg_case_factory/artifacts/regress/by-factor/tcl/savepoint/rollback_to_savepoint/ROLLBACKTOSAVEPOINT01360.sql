...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01360
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01360|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01360_sp;
-- primary-target-end
