...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01718
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01718|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01718_sp;
-- primary-target-end
