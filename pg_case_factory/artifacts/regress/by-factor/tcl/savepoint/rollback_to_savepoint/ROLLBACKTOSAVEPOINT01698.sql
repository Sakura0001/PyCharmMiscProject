...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01698
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01698|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01698_sp;
-- primary-target-end
