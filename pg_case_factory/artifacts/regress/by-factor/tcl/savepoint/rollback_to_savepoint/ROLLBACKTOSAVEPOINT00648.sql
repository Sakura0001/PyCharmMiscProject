...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00648
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00648|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00648_sp AND NO CHAIN;
-- primary-target-end
