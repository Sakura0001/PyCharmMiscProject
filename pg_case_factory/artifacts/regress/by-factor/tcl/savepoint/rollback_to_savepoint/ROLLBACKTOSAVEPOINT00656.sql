...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00656
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00656|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00656_sp AND NO CHAIN;
-- primary-target-end
