...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00768
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00768|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00768_sp AND NO CHAIN;
-- primary-target-end
