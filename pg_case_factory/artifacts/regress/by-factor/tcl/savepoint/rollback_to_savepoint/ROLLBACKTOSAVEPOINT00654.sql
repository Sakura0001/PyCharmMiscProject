...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00654
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00654|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00654_sp AND NO CHAIN;
-- primary-target-end
