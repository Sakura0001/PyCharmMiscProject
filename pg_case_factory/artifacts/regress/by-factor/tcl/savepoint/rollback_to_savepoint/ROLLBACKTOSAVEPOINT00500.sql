...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00500
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00500|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00500_sp AND CHAIN;
-- primary-target-end
