...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00544
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00544|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00544_sp AND CHAIN;
-- primary-target-end
