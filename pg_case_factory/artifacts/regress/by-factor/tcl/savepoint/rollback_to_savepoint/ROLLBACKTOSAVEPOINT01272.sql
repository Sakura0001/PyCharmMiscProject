...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01272
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01272|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01272_sp;
-- primary-target-end
