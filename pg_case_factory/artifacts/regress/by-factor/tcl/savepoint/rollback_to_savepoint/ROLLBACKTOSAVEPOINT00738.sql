...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00738
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00738|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00738_sp AND NO CHAIN;
-- primary-target-end
