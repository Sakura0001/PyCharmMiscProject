...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00492
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00492|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00492_sp AND CHAIN;
-- primary-target-end
