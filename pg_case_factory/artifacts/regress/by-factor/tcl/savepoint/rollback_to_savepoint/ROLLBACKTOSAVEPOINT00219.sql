...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00219
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00219|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00219_sp AND CHAIN;
-- primary-target-end
