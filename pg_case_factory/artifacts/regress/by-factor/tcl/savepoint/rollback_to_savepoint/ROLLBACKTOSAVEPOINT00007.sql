...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT cleanup_mode=rollback
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00007
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-053b7a158f2d4126737c4553|rollback_to_savepoint
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00007_sp;
-- primary-target-end
