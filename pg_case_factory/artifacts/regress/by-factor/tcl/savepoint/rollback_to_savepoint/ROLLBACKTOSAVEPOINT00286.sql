...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00286
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00286|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00286_sp AND CHAIN;
-- primary-target-end
