...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00964
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00964|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00964_sp AND NO CHAIN;
-- primary-target-end
