...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00984
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00984|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00984_sp AND NO CHAIN;
-- primary-target-end
