...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00927
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00927|returned_rows|rollback
...
SAVEPOINT rollbacktosavepoint_00927_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00927_sp AND NO CHAIN;
-- primary-target-end
