...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00335
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00335|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00335_sp AND CHAIN;
-- primary-target-end
