...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01537
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01537|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01537_sp;
-- primary-target-end
