...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01068
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01068|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01068_sp AND NO CHAIN;
-- primary-target-end
