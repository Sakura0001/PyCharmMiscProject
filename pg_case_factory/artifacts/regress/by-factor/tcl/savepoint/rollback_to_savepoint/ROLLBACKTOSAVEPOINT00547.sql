...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00547
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00547|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00547_sp AND CHAIN;
-- primary-target-end
