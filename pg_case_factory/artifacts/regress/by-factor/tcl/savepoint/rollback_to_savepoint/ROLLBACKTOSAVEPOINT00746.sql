...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00746
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00746|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00746_sp AND NO CHAIN;
-- primary-target-end
