...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00353
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00353|returned_rows|reset_state
...
SAVEPOINT rollbacktosavepoint_00353_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00353_sp AND CHAIN;
-- primary-target-end
