...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00812
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00812|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00812_sp AND NO CHAIN;
-- primary-target-end
