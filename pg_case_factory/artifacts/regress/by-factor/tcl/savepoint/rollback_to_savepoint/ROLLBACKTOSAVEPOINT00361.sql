...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00361
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00361|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00361_sp AND CHAIN;
-- primary-target-end
