...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT transaction_mode=default
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00031
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-65b6a0c402a8886ab79779fd|rollback_to_savepoint
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00031_sp;
-- primary-target-end
