...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00181
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00181|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00181_sp AND CHAIN;
-- primary-target-end
