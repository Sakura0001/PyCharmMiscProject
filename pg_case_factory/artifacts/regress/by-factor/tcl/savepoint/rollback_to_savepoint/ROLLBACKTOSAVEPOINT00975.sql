...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00975
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00975|returned_rows|rollback
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ ONLY;
SAVEPOINT rollbacktosavepoint_00975_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00975_sp AND NO CHAIN;
-- primary-target-end
