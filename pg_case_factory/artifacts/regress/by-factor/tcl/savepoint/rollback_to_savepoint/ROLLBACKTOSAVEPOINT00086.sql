...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00086
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00086|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00086_sp AND CHAIN;
-- primary-target-end
