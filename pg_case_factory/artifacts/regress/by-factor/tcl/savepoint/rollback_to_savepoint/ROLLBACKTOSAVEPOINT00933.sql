...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00933
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00933|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00933_sp AND NO CHAIN;
-- primary-target-end
