...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00122
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00122|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00122_sp AND CHAIN;
-- primary-target-end
