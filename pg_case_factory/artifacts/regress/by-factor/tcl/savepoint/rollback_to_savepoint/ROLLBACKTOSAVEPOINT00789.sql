...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00789
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00789|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00789_sp AND NO CHAIN;
-- primary-target-end
