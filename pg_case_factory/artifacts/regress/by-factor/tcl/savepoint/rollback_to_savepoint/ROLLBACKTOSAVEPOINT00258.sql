...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00258
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00258|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00258_sp AND CHAIN;
-- primary-target-end
