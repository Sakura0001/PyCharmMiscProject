...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01432
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01432|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01432_sp;
-- primary-target-end
