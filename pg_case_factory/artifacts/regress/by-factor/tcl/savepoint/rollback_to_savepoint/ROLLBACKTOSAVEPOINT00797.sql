...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00797
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00797|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00797_sp AND NO CHAIN;
-- primary-target-end
