...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01556
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01556|error_assertion|reset_state
...
SAVEPOINT rollbacktosavepoint_01556_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01556_sp;
-- primary-target-end
