...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00915
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00915|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00915_sp AND NO CHAIN;
-- primary-target-end
