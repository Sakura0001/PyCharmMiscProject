...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00076
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00076|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00076_sp AND CHAIN;
-- primary-target-end
