...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00767
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00767|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00767_sp AND NO CHAIN;
-- primary-target-end
