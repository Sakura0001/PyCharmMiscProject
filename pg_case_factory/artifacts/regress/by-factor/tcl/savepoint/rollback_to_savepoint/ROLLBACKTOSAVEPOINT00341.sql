...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00341
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00341|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00341_sp AND CHAIN;
-- primary-target-end
