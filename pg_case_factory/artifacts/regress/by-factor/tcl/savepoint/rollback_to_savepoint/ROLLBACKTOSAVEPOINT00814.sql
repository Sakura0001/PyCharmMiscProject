...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00814
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00814|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00814_sp AND NO CHAIN;
-- primary-target-end
