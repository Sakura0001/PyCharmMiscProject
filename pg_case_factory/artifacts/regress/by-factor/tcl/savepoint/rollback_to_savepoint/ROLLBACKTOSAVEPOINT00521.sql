...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00521
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00521|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00521_sp AND CHAIN;
-- primary-target-end
