...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00077
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00077|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00077_sp AND CHAIN;
-- primary-target-end
