...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT cleanup_mode=reset_state
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00006
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-e8bca61b277237dd288bfa6f|rollback_to_savepoint
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00006_sp;
-- primary-target-end
