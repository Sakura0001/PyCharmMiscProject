...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00048
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00048|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00048_sp AND CHAIN;
-- primary-target-end
