...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01411
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01411|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01411_sp;
-- primary-target-end
