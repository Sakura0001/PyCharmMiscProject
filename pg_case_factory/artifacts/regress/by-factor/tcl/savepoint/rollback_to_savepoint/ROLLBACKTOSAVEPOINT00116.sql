...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00116
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00116|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00116_sp AND CHAIN;
-- primary-target-end
