...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00781
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00781|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00781_sp AND NO CHAIN;
-- primary-target-end
