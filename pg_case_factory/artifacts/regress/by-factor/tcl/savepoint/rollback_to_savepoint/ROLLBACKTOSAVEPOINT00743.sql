...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00743
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00743|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00743_sp AND NO CHAIN;
-- primary-target-end
