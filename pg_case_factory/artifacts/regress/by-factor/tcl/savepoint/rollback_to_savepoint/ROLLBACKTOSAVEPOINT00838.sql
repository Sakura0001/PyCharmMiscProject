...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00838
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00838|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00838_sp AND NO CHAIN;
-- primary-target-end
