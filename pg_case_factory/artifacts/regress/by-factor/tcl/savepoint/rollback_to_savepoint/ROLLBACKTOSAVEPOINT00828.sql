...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00828
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00828|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00828_sp AND NO CHAIN;
-- primary-target-end
