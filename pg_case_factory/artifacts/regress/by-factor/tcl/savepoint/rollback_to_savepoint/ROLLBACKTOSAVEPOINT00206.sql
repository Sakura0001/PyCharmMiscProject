...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00206
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00206|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00206_sp AND CHAIN;
-- primary-target-end
