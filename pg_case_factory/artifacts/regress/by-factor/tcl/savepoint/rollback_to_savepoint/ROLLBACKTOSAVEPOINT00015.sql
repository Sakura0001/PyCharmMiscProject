...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT framework_context=outer_transaction_present
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00015
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-3eec0cbccc44aec8bae60e1c|rollback_to_savepoint
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00015_sp;
-- primary-target-end
