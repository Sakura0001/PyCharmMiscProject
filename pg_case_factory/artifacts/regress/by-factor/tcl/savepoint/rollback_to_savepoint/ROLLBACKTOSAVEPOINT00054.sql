...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00054
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00054|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00054_sp AND CHAIN;
-- primary-target-end
