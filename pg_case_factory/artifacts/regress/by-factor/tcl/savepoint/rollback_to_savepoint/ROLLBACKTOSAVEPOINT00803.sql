...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00803
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00803|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00803_sp AND NO CHAIN;
-- primary-target-end
