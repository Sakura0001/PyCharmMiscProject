...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01720
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01720|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01720_sp;
-- primary-target-end
