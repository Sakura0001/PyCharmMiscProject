...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00358
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00358|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00358_sp AND CHAIN;
-- primary-target-end
