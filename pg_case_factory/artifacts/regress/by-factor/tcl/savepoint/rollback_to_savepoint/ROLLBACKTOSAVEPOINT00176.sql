...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00176
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00176|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00176_sp AND CHAIN;
-- primary-target-end
