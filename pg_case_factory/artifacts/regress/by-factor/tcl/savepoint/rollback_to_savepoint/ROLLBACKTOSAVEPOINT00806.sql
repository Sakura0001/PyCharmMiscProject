...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00806
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00806|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00806_sp AND NO CHAIN;
-- primary-target-end
