...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00678
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00678|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00678_sp AND NO CHAIN;
-- primary-target-end
