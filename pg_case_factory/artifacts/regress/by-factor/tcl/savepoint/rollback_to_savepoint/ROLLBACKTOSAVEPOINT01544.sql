...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01544
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01544|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01544_sp;
-- primary-target-end
