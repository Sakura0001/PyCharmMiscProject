...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT savepoint_name_shape=released_name
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00021
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-39e7f861ea65c474f9674bcf|rollback_to_savepoint
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN;
SAVEPOINT rollbacktosavepoint_00021_sp;
RELEASE rollbacktosavepoint_00021_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00021_sp;
-- primary-target-end
