...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00985
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00985|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00985_sp AND NO CHAIN;
-- primary-target-end
