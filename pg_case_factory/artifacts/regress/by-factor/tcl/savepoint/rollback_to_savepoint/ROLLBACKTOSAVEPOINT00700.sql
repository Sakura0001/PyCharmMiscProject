...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00700
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00700|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00700_sp AND NO CHAIN;
-- primary-target-end
