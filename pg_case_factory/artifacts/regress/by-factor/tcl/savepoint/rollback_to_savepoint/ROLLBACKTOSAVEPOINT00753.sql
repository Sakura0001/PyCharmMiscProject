...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00753
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00753|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00753_sp AND NO CHAIN;
-- primary-target-end
