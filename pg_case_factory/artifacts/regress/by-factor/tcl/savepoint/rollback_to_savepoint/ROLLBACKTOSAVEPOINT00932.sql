...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00932
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00932|error_assertion|reset_state
...
SAVEPOINT rollbacktosavepoint_00932_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00932_sp AND NO CHAIN;
-- primary-target-end
