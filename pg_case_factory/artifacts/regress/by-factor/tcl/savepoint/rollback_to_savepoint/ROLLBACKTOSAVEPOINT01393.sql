...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01393
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01393|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01393_sp;
-- primary-target-end
