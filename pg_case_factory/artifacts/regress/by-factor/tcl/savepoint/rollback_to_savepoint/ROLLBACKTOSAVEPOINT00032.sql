...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT transaction_mode=deferrable
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00032
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-fb87d7ab3d1ddafa13ccefab|rollback_to_savepoint
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00032_sp;
-- primary-target-end
