...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00213
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00213|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00213_sp AND CHAIN;
-- primary-target-end
