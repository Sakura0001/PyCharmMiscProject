...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00094
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00094|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00094_sp AND CHAIN;
-- primary-target-end
