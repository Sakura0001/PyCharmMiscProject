...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00931
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00931|error_assertion|drop_objects
...
SAVEPOINT rollbacktosavepoint_00931_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00931_sp AND NO CHAIN;
-- primary-target-end
