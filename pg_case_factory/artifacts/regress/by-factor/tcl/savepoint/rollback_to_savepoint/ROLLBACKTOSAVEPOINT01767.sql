...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01767
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01767|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01767_sp;
-- primary-target-end
