...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00384
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00384|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00384_sp AND CHAIN;
-- primary-target-end
