...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00755
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00755|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00755_sp AND NO CHAIN;
-- primary-target-end
