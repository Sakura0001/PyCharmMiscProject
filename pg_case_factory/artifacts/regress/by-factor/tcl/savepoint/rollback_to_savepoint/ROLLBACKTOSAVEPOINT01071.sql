...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01071
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01071|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01071_sp AND NO CHAIN;
-- primary-target-end
