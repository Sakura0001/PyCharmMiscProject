...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01364
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01364|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01364_sp;
-- primary-target-end
