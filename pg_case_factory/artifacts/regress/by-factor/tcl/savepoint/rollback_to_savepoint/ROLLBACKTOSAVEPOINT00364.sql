...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00364
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00364|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00364_sp AND CHAIN;
-- primary-target-end
