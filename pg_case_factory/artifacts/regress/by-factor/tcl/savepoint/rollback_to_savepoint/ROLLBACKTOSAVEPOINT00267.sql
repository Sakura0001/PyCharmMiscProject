...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00267
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00267|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00267_sp AND CHAIN;
-- primary-target-end
