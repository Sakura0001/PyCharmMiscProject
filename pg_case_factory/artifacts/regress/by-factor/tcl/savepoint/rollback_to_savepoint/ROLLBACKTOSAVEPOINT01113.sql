...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01113
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01113|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01113_sp AND NO CHAIN;
-- primary-target-end
