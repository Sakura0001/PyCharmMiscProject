...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00316
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00316|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00316_sp AND CHAIN;
-- primary-target-end
