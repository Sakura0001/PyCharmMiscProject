...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00825
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00825|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00825_sp AND NO CHAIN;
-- primary-target-end
