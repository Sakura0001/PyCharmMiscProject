...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT cleanup_mode=drop_objects
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00005
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-c999d77b7266ade7df446eac|rollback_to_savepoint
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00005_sp;
-- primary-target-end
