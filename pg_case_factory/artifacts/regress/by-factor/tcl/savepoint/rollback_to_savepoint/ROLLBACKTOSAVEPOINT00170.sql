...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00170
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00170|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00170_sp AND CHAIN;
-- primary-target-end
