...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01098
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01098|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01098_sp AND NO CHAIN;
-- primary-target-end
