...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00197
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00197|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00197_sp AND CHAIN;
-- primary-target-end
