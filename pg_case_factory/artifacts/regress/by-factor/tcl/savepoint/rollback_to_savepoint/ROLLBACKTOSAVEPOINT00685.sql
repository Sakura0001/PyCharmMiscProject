...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00685
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00685|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00685_sp AND NO CHAIN;
-- primary-target-end
