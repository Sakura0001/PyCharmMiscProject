...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00196
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00196|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00196_sp AND CHAIN;
-- primary-target-end
