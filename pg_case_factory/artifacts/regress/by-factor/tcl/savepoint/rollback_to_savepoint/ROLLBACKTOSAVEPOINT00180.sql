...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00180
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00180|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00180_sp AND CHAIN;
-- primary-target-end
