...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00719
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00719|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00719_sp AND NO CHAIN;
-- primary-target-end
