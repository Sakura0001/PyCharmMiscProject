...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01110
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01110|error_assertion|rollback
...
SAVEPOINT rollbacktosavepoint_01110_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01110_sp AND NO CHAIN;
-- primary-target-end
