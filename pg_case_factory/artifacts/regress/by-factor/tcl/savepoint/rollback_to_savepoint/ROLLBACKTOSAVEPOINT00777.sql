...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00777
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00777|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00777_sp AND NO CHAIN;
-- primary-target-end
