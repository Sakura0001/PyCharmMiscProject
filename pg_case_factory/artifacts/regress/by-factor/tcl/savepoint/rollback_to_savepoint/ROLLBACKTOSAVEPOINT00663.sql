...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00663
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00663|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00663_sp AND NO CHAIN;
-- primary-target-end
