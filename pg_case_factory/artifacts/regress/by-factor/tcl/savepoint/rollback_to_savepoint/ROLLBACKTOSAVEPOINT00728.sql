...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00728
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00728|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00728_sp AND NO CHAIN;
-- primary-target-end
