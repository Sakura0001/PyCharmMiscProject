...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00661
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00661|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00661_sp AND NO CHAIN;
-- primary-target-end
