...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00083
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00083|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00083_sp AND CHAIN;
-- primary-target-end
