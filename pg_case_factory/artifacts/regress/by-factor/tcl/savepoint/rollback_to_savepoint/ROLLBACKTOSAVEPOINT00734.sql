...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00734
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00734|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00734_sp AND NO CHAIN;
-- primary-target-end
