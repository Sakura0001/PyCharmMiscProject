...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00117
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00117|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00117_sp AND CHAIN;
-- primary-target-end
