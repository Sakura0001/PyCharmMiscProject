...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00928
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00928|returned_rows|drop_objects
...
SAVEPOINT rollbacktosavepoint_00928_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00928_sp AND NO CHAIN;
-- primary-target-end
