...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00822
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00822|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00822_sp AND NO CHAIN;
-- primary-target-end
