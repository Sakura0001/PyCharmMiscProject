...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01275
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01275|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01275_sp;
-- primary-target-end
