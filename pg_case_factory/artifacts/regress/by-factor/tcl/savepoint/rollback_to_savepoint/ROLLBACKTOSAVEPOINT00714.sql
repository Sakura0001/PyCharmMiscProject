...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00714
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00714|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00714_sp AND NO CHAIN;
-- primary-target-end
