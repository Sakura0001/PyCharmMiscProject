...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00105
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00105|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00105_sp AND CHAIN;
-- primary-target-end
