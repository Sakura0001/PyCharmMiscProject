...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00918
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00918|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00918_sp AND NO CHAIN;
-- primary-target-end
