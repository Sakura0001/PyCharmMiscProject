...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00046
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00046|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00046_sp AND CHAIN;
-- primary-target-end
