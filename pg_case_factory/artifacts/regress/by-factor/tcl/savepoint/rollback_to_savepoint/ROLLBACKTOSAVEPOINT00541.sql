...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00541
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00541|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00541_sp AND CHAIN;
-- primary-target-end
