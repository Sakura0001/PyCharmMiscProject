...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00275
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00275|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00275_sp AND CHAIN;
-- primary-target-end
