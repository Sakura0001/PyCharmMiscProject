...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00317
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00317|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00317_sp AND CHAIN;
-- primary-target-end
