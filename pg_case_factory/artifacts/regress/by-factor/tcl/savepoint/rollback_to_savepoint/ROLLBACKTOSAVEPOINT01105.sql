...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01105
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01105|effect_query|drop_objects
...
SAVEPOINT rollbacktosavepoint_01105_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01105_sp AND NO CHAIN;
-- primary-target-end
