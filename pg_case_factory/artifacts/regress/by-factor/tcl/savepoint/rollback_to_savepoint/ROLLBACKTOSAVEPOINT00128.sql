...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00128
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00128|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00128_sp AND CHAIN;
-- primary-target-end
