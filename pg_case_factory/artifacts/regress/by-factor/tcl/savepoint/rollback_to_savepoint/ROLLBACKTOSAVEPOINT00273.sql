...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00273
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00273|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00273_sp AND CHAIN;
-- primary-target-end
