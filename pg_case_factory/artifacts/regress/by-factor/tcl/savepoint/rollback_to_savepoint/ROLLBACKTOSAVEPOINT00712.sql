...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00712
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00712|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00712_sp AND NO CHAIN;
-- primary-target-end
