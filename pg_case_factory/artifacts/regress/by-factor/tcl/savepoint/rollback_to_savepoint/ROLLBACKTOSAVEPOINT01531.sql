...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01531
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01531|error_assertion|drop_objects
...
SAVEPOINT rollbacktosavepoint_01531_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01531_sp;
-- primary-target-end
