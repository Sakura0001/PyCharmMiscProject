...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00650
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00650|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00650_sp AND NO CHAIN;
-- primary-target-end
