...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00074
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00074|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00074_sp AND CHAIN;
-- primary-target-end
