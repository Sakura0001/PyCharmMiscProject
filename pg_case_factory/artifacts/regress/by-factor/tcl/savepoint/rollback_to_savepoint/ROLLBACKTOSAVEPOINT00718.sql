...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00718
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00718|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00718_sp AND NO CHAIN;
-- primary-target-end
