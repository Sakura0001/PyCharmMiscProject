...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00475
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00475|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00475_sp AND CHAIN;
-- primary-target-end
