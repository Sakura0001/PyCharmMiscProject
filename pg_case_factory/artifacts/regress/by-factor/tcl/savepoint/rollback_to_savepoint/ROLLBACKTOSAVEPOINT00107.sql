...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00107
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00107|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00107_sp AND CHAIN;
-- primary-target-end
