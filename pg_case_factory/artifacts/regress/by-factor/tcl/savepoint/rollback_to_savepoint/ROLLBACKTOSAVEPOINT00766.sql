...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00766
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00766|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00766_sp AND NO CHAIN;
-- primary-target-end
