...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00735
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00735|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00735_sp AND NO CHAIN;
-- primary-target-end
