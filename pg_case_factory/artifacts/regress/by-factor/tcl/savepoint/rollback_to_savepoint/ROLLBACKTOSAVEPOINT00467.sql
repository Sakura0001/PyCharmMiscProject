...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00467
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00467|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00467_sp AND CHAIN;
-- primary-target-end
