...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00143
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00143|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00143_sp AND CHAIN;
-- primary-target-end
