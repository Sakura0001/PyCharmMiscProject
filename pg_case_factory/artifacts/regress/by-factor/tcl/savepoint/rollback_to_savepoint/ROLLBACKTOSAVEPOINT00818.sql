...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00818
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00818|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00818_sp AND NO CHAIN;
-- primary-target-end
