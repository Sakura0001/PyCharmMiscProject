...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01388
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01388|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01388_sp;
-- primary-target-end
