...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00696
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00696|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00696_sp AND NO CHAIN;
-- primary-target-end
