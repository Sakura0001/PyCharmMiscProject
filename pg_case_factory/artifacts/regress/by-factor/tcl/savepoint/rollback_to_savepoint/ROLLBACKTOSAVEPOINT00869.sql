...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00869
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00869|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00869_sp AND NO CHAIN;
-- primary-target-end
