...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00556
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00556|returned_rows|drop_objects
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ ONLY;
SAVEPOINT rollbacktosavepoint_00556_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00556_sp AND CHAIN;
-- primary-target-end
