...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00821
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00821|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00821_sp AND NO CHAIN;
-- primary-target-end
