...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00135
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00135|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00135_sp AND CHAIN;
-- primary-target-end
