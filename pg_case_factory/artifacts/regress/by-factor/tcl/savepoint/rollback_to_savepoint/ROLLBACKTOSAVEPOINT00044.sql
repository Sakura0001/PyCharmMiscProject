...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT verification_mode=returned_rows
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00044
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-0a5d3a09ae46e3488726982d|rollback_to_savepoint
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00044_sp;
-- primary-target-end
