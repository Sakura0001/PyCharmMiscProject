...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00195
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00195|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00195_sp AND CHAIN;
-- primary-target-end
