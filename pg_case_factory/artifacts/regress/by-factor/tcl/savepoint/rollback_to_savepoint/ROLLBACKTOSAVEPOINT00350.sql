...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00350
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00350|effect_query|reset_state
...
SAVEPOINT rollbacktosavepoint_00350_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00350_sp AND CHAIN;
-- primary-target-end
