...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00691
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00691|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00691_sp AND NO CHAIN;
-- primary-target-end
