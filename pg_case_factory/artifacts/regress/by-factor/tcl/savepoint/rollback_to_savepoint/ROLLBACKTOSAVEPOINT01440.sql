...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01440
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01440|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01440_sp;
-- primary-target-end
