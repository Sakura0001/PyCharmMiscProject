...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01092
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01092|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01092_sp AND NO CHAIN;
-- primary-target-end
