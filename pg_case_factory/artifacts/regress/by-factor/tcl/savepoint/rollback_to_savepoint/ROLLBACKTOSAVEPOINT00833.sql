...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00833
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00833|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00833_sp AND NO CHAIN;
-- primary-target-end
