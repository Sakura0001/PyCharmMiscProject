...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01249
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01249|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01249_sp;
-- primary-target-end
