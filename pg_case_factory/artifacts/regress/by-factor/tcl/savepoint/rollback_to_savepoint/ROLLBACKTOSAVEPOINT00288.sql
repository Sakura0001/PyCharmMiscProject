...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00288
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00288|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00288_sp AND CHAIN;
-- primary-target-end
