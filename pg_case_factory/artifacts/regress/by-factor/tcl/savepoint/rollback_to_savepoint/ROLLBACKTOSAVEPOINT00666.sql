...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00666
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00666|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00666_sp AND NO CHAIN;
-- primary-target-end
