...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01095
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01095|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01095_sp AND NO CHAIN;
-- primary-target-end
