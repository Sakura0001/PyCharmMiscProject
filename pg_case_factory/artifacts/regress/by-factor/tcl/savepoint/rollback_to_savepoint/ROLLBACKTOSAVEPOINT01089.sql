...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01089
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01089|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01089_sp AND NO CHAIN;
-- primary-target-end
