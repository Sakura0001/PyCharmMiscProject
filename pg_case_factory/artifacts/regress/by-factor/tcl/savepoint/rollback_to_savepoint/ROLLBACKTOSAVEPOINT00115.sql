...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00115
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00115|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00115_sp AND CHAIN;
-- primary-target-end
