...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00855
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00855|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00855_sp AND NO CHAIN;
-- primary-target-end
