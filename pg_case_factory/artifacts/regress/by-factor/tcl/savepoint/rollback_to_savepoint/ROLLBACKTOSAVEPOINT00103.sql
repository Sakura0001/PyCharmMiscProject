...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00103
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00103|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00103_sp AND CHAIN;
-- primary-target-end
