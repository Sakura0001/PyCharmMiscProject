...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00497
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00497|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00497_sp AND CHAIN;
-- primary-target-end
