...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00859
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00859|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00859_sp AND NO CHAIN;
-- primary-target-end
