...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00873
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00873|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00873_sp AND NO CHAIN;
-- primary-target-end
