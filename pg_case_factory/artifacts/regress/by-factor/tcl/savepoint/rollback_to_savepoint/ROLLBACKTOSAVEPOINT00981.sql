...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00981
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00981|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00981_sp AND NO CHAIN;
-- primary-target-end
