...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01127
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01127|catalog_query|reset_state
...
SAVEPOINT rollbacktosavepoint_01127_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01127_sp AND NO CHAIN;
-- primary-target-end
