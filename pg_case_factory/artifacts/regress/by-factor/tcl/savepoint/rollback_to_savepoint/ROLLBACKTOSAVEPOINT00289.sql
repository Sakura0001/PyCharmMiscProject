...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00289
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00289|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00289_sp AND CHAIN;
-- primary-target-end
