...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00357
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00357|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00357_sp AND CHAIN;
-- primary-target-end
