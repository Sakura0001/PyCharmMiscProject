...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00205
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00205|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00205_sp AND CHAIN;
-- primary-target-end
