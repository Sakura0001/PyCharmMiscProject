...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00692
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00692|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00692_sp AND NO CHAIN;
-- primary-target-end
