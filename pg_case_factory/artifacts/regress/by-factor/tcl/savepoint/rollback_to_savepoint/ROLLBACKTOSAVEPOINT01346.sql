...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01346
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01346|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01346_sp;
-- primary-target-end
