...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01067
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01067|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01067_sp AND NO CHAIN;
-- primary-target-end
