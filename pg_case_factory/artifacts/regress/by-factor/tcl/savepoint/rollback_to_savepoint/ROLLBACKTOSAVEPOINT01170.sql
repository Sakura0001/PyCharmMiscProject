...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01170
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01170|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01170_sp AND NO CHAIN;
-- primary-target-end
