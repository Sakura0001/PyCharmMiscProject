...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01090
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01090|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01090_sp AND NO CHAIN;
-- primary-target-end
