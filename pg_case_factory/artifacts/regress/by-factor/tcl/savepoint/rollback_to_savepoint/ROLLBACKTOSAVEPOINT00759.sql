...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00759
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00759|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00759_sp AND NO CHAIN;
-- primary-target-end
