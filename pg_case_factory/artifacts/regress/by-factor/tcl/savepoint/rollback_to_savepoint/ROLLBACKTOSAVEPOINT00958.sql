...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00958
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00958|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00958_sp AND NO CHAIN;
-- primary-target-end
