...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00913
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00913|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00913_sp AND NO CHAIN;
-- primary-target-end
