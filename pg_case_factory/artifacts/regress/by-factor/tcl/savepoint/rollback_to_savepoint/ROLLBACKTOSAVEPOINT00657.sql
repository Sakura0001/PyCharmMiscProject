...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00657
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00657|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00657_sp AND NO CHAIN;
-- primary-target-end
