...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01399
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01399|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01399_sp;
-- primary-target-end
