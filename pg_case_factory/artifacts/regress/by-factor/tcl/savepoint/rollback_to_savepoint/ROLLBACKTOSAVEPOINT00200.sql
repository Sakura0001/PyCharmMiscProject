...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00200
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00200|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00200_sp AND CHAIN;
-- primary-target-end
