...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00183
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00183|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00183_sp AND CHAIN;
-- primary-target-end
