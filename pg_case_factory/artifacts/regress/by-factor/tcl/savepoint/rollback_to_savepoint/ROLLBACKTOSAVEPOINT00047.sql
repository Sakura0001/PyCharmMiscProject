...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00047
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00047|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00047_sp AND CHAIN;
-- primary-target-end
