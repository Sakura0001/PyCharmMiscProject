...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00095
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00095|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00095_sp AND CHAIN;
-- primary-target-end
