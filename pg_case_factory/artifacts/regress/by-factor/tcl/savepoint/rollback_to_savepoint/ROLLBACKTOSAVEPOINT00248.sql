...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00248
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00248|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00248_sp AND CHAIN;
-- primary-target-end
