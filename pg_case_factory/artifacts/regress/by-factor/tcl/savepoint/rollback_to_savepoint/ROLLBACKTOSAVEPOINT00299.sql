...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00299
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00299|catalog_query|reset_state
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN;
SAVEPOINT rollbacktosavepoint_00299_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00299_sp AND CHAIN;
-- primary-target-end
