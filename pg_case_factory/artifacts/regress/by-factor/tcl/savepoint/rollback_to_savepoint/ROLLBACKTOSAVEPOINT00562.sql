...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00562
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00562|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00562_sp AND CHAIN;
-- primary-target-end
