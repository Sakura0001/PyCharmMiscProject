...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00699
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00699|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00699_sp AND NO CHAIN;
-- primary-target-end
