...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00365
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00365|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00365_sp AND CHAIN;
-- primary-target-end
