...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00295
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00295|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00295_sp AND CHAIN;
-- primary-target-end
