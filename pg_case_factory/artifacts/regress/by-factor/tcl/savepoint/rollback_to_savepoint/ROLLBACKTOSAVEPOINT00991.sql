...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00991
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00991|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00991_sp AND NO CHAIN;
-- primary-target-end
