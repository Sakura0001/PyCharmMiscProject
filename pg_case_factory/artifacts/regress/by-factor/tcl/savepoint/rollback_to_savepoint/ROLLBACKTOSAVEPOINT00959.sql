...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00959
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00959|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00959_sp AND NO CHAIN;
-- primary-target-end
