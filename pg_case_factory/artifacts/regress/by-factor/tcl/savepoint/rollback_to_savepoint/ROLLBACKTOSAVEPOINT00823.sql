...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00823
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00823|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00823_sp AND NO CHAIN;
-- primary-target-end
