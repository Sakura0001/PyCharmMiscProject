...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00720
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00720|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00720_sp AND NO CHAIN;
-- primary-target-end
