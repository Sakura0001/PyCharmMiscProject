...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00064
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00064|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00064_sp AND CHAIN;
-- primary-target-end
