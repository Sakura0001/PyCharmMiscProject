...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00809
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00809|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00809_sp AND NO CHAIN;
-- primary-target-end
