...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00343
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00343|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00343_sp AND CHAIN;
-- primary-target-end
