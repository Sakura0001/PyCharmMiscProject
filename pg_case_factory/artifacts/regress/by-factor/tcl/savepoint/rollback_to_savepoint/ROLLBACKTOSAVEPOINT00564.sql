...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00564
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00564|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00564_sp AND CHAIN;
-- primary-target-end
