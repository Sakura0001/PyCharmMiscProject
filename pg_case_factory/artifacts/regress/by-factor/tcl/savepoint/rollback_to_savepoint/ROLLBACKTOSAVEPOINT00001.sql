...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-GRM|branch_1|rollback_to_savepoint|synopsis|rollback_to_savepoint
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00001_sp;
-- primary-target-end
