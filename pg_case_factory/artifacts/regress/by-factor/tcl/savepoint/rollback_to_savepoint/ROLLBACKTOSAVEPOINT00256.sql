...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00256
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00256|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00256_sp AND CHAIN;
-- primary-target-end
