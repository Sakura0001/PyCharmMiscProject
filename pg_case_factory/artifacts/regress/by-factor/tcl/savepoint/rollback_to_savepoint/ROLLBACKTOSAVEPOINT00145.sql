...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00145
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00145|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00145_sp AND CHAIN;
-- primary-target-end
