...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00465
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00465|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00465_sp AND CHAIN;
-- primary-target-end
