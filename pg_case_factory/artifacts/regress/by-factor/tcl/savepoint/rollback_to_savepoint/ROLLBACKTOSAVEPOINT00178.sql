...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00178
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00178|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00178_sp AND CHAIN;
-- primary-target-end
