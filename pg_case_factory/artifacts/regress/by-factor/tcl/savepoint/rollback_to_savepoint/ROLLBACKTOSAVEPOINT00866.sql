...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00866
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00866|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00866_sp AND NO CHAIN;
-- primary-target-end
