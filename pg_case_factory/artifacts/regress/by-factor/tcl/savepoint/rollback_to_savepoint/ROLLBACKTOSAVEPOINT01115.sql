...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01115
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01115|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01115_sp AND NO CHAIN;
-- primary-target-end
