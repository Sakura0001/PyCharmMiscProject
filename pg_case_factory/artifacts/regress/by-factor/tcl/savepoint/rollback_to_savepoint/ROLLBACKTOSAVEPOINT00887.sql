...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00887
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00887|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00887_sp AND NO CHAIN;
-- primary-target-end
