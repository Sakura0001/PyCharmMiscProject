...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00179
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00179|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00179_sp AND CHAIN;
-- primary-target-end
