...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00516
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00516|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00516_sp AND CHAIN;
-- primary-target-end
