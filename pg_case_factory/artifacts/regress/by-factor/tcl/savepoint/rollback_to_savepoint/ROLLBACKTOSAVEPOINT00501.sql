...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00501
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00501|catalog_query|rollback
...
SAVEPOINT rollbacktosavepoint_00501_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00501_sp AND CHAIN;
-- primary-target-end
