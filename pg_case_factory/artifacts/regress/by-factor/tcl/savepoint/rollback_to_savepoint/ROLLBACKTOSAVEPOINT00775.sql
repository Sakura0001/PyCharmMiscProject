...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00775
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00775|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00775_sp AND NO CHAIN;
-- primary-target-end
