...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00674
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00674|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00674_sp AND NO CHAIN;
-- primary-target-end
