...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00134
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00134|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00134_sp AND CHAIN;
-- primary-target-end
