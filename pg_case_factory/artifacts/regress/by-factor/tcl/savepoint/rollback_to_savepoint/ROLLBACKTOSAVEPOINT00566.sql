...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00566
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00566|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00566_sp AND CHAIN;
-- primary-target-end
