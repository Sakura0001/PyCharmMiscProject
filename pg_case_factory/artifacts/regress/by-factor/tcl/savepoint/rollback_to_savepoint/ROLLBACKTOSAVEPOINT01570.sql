...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01570
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01570|catalog_query|drop_objects
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ ONLY;
SAVEPOINT rollbacktosavepoint_01570_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01570_sp;
-- primary-target-end
