...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00669
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00669|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00669_sp AND NO CHAIN;
-- primary-target-end
