...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01163
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01163|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01163_sp AND NO CHAIN;
-- primary-target-end
