...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00078
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00078|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00078_sp AND CHAIN;
-- primary-target-end
