...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00498
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00498|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00498_sp AND CHAIN;
-- primary-target-end
