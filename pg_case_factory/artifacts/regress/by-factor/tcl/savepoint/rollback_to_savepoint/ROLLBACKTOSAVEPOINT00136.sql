...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00136
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00136|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00136_sp AND CHAIN;
-- primary-target-end
