...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00835
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00835|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00835_sp AND NO CHAIN;
-- primary-target-end
