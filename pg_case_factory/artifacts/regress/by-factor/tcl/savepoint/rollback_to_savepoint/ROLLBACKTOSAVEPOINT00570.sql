...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00570
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00570|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00570_sp AND CHAIN;
-- primary-target-end
