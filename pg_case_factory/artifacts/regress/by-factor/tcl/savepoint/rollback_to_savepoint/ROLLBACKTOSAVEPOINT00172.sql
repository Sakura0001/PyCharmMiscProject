...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00172
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00172|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00172_sp AND CHAIN;
-- primary-target-end
