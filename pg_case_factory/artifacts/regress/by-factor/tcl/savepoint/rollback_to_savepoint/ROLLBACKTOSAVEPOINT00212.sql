...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00212
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00212|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00212_sp AND CHAIN;
-- primary-target-end
