...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00545
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00545|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00545_sp AND CHAIN;
-- primary-target-end
