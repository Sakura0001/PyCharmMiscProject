...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00947
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00947|catalog_query|reset_state
...
SAVEPOINT rollbacktosavepoint_00947_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00947_sp AND NO CHAIN;
-- primary-target-end
