...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00522
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00522|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00522_sp AND CHAIN;
-- primary-target-end
