...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00059
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00059|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00059_sp AND CHAIN;
-- primary-target-end
