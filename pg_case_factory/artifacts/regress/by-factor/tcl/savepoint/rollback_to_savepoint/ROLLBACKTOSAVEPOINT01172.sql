...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01172
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01172|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01172_sp AND NO CHAIN;
-- primary-target-end
