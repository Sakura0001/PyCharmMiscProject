...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00139
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00139|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00139_sp AND CHAIN;
-- primary-target-end
