...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00277
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00277|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00277_sp AND CHAIN;
-- primary-target-end
