...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00533
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00533|returned_rows|reset_state
...
SAVEPOINT rollbacktosavepoint_00533_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00533_sp AND CHAIN;
-- primary-target-end
