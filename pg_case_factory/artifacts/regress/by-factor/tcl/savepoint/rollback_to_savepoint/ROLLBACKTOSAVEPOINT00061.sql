...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00061
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00061|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00061_sp AND CHAIN;
-- primary-target-end
