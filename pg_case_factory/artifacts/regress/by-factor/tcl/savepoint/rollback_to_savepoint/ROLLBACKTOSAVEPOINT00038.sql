...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT transaction_state=outside_transaction
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00038
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-aebc9931f5cda8a0af866ae7|rollback_to_savepoint
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00038_sp;
-- primary-target-end
