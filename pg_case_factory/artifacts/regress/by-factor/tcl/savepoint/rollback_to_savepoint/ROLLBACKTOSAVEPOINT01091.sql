...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01091
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01091|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01091_sp AND NO CHAIN;
-- primary-target-end
