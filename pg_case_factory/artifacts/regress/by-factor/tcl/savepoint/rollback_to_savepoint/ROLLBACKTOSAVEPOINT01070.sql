...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01070
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01070|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01070_sp AND NO CHAIN;
-- primary-target-end
