...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00961
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00961|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00961_sp AND NO CHAIN;
-- primary-target-end
