...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00992
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00992|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00992_sp AND NO CHAIN;
-- primary-target-end
