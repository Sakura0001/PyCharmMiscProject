...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01269
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01269|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01269_sp;
-- primary-target-end
