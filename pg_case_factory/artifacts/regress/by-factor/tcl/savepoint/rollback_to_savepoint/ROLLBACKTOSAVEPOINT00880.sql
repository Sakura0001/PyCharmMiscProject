...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00880
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00880|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00880_sp AND NO CHAIN;
-- primary-target-end
