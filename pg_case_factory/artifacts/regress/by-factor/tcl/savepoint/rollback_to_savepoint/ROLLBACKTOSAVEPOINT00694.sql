...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00694
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00694|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00694_sp AND NO CHAIN;
-- primary-target-end
