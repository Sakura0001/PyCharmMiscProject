...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01558
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01558|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01558_sp;
-- primary-target-end
