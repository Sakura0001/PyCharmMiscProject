...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00217
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00217|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00217_sp AND CHAIN;
-- primary-target-end
