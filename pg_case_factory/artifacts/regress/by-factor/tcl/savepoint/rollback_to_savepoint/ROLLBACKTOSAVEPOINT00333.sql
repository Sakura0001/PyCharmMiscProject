...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00333
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00333|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00333_sp AND CHAIN;
-- primary-target-end
