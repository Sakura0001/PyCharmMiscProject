...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00246
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00246|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00246_sp AND CHAIN;
-- primary-target-end
