...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00470
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00470|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00470_sp AND CHAIN;
-- primary-target-end
