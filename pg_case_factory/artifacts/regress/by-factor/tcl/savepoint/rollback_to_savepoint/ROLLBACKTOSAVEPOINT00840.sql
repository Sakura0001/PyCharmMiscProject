...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00840
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00840|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00840_sp AND NO CHAIN;
-- primary-target-end
