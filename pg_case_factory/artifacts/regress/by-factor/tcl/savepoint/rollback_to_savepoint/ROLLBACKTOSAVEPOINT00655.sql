...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00655
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00655|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00655_sp AND NO CHAIN;
-- primary-target-end
