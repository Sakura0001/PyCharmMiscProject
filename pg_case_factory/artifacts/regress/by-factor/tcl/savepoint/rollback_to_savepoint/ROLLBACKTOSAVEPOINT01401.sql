...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01401
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01401|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01401_sp;
-- primary-target-end
