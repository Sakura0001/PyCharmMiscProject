...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01162
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01162|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01162_sp AND NO CHAIN;
-- primary-target-end
