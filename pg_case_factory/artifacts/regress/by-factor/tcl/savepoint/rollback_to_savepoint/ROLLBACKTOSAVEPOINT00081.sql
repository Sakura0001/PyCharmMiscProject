...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00081
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00081|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00081_sp AND CHAIN;
-- primary-target-end
