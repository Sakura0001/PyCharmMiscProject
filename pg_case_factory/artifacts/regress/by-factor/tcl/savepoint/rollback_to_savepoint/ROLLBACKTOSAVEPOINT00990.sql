...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00990
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00990|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00990_sp AND NO CHAIN;
-- primary-target-end
