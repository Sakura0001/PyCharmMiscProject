...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00045
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00045|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00045_sp AND CHAIN;
-- primary-target-end
