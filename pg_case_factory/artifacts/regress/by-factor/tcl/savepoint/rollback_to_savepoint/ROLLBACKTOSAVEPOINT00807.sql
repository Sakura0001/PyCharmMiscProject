...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00807
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00807|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00807_sp AND NO CHAIN;
-- primary-target-end
