...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00583
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00583|error_assertion|drop_objects
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ WRITE;
SAVEPOINT rollbacktosavepoint_00583_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00583_sp AND CHAIN;
-- primary-target-end
