...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00794
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00794|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00794_sp AND NO CHAIN;
-- primary-target-end
