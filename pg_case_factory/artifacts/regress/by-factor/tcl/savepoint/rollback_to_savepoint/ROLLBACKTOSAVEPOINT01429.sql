...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01429
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01429|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01429_sp;
-- primary-target-end
