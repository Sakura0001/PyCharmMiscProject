...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00469
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00469|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00469_sp AND CHAIN;
-- primary-target-end
