...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00490
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00490|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00490_sp AND CHAIN;
-- primary-target-end
