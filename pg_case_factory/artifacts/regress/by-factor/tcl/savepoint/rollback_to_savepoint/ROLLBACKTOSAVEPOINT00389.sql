...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00389
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00389|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00389_sp AND CHAIN;
-- primary-target-end
