...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00144
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00144|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00144_sp AND CHAIN;
-- primary-target-end
