...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00326
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00326|effect_query|reset_state
...
SAVEPOINT rollbacktosavepoint_00326_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00326_sp AND CHAIN;
-- primary-target-end
