...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00910
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00910|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00910_sp AND NO CHAIN;
-- primary-target-end
