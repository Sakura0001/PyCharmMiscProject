...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01511
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01511|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01511_sp;
-- primary-target-end
