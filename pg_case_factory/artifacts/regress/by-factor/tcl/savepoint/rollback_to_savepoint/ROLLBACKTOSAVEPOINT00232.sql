...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00232
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00232|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00232_sp AND CHAIN;
-- primary-target-end
