...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00150
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00150|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00150_sp AND CHAIN;
-- primary-target-end
