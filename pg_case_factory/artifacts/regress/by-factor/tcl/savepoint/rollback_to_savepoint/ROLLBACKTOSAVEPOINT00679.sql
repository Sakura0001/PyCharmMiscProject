...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00679
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00679|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00679_sp AND NO CHAIN;
-- primary-target-end
