...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00279
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00279|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00279_sp AND CHAIN;
-- primary-target-end
