...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00207
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00207|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00207_sp AND CHAIN;
-- primary-target-end
