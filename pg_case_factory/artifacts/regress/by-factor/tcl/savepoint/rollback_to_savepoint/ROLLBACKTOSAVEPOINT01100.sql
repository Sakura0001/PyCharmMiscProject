...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01100
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01100|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01100_sp AND NO CHAIN;
-- primary-target-end
