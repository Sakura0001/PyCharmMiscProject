...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00731
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00731|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00731_sp AND NO CHAIN;
-- primary-target-end
