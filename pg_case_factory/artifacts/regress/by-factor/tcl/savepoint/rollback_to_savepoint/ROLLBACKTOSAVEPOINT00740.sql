...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00740
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00740|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00740_sp AND NO CHAIN;
-- primary-target-end
