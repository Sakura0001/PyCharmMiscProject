...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01094
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01094|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01094_sp AND NO CHAIN;
-- primary-target-end
