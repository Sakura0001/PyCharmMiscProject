...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01701
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01701|catalog_query|rollback
...
SAVEPOINT rollbacktosavepoint_01701_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01701_sp;
-- primary-target-end
