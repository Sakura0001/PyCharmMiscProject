...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00096
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00096|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00096_sp AND CHAIN;
-- primary-target-end
