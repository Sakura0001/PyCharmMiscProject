...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00473
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00473|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00473_sp AND CHAIN;
-- primary-target-end
