...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00269
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00269|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00269_sp AND CHAIN;
-- primary-target-end
