...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01424
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01424|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01424_sp;
-- primary-target-end
