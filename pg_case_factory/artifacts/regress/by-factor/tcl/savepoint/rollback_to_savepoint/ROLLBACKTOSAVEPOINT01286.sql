...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01286
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01286|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01286_sp;
-- primary-target-end
