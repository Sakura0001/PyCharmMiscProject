...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00367
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00367|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00367_sp AND CHAIN;
-- primary-target-end
