...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00519
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00519|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00519_sp AND CHAIN;
-- primary-target-end
