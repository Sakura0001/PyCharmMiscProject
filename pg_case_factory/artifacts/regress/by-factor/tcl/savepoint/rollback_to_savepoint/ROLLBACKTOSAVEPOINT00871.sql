...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00871
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00871|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00871_sp AND NO CHAIN;
-- primary-target-end
