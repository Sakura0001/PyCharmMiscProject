...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01166
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01166|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01166_sp AND NO CHAIN;
-- primary-target-end
