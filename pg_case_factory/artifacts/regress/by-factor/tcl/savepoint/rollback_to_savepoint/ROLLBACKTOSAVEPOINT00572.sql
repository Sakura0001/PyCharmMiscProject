...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00572
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00572|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00572_sp AND CHAIN;
-- primary-target-end
