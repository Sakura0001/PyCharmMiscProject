...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00125
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00125|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00125_sp AND CHAIN;
-- primary-target-end
