...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00870
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00870|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00870_sp AND NO CHAIN;
-- primary-target-end
