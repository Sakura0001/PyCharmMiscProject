...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00229
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00229|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00229_sp AND CHAIN;
-- primary-target-end
