...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00790
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00790|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00790_sp AND NO CHAIN;
-- primary-target-end
