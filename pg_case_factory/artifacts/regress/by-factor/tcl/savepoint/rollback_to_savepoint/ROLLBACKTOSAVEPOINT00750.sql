...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00750
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00750|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00750_sp AND NO CHAIN;
-- primary-target-end
