...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00542
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00542|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00542_sp AND CHAIN;
-- primary-target-end
