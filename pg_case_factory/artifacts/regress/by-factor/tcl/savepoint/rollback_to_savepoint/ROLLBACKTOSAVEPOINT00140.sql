...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00140
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00140|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00140_sp AND CHAIN;
-- primary-target-end
