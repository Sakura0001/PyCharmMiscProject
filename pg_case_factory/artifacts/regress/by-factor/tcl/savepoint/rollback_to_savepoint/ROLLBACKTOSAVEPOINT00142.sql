...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00142
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00142|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00142_sp AND CHAIN;
-- primary-target-end
