...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00850
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00850|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00850_sp AND NO CHAIN;
-- primary-target-end
