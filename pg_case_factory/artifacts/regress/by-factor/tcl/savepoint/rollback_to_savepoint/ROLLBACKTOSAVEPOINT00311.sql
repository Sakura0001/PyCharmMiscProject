...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00311
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00311|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00311_sp AND CHAIN;
-- primary-target-end
