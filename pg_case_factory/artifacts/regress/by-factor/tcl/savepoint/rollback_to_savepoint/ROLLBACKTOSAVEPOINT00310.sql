...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00310
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00310|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00310_sp AND CHAIN;
-- primary-target-end
