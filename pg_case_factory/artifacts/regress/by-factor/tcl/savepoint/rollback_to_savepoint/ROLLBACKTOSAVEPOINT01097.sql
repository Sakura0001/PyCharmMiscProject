...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01097
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01097|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01097_sp AND NO CHAIN;
-- primary-target-end
