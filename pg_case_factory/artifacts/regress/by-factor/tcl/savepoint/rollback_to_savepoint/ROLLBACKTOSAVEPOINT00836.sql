...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00836
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00836|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00836_sp AND NO CHAIN;
-- primary-target-end
