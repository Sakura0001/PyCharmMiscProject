...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00114
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00114|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00114_sp AND CHAIN;
-- primary-target-end
