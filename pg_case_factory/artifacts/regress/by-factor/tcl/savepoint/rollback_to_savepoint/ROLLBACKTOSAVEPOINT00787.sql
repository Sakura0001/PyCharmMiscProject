...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00787
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00787|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00787_sp AND NO CHAIN;
-- primary-target-end
