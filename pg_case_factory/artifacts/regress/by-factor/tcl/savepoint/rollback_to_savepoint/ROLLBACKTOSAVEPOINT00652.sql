...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00652
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00652|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00652_sp AND NO CHAIN;
-- primary-target-end
