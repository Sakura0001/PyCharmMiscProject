...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00946
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00946|catalog_query|drop_objects
...
SAVEPOINT rollbacktosavepoint_00946_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00946_sp AND NO CHAIN;
-- primary-target-end
