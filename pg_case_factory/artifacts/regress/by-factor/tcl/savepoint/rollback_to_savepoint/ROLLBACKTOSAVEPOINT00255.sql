...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00255
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00255|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00255_sp AND CHAIN;
-- primary-target-end
