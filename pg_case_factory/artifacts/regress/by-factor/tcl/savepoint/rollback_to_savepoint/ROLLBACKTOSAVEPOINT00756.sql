...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00756
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00756|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00756_sp AND NO CHAIN;
-- primary-target-end
