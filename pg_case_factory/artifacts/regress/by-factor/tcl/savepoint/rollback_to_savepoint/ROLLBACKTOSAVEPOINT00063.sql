...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00063
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00063|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00063_sp AND CHAIN;
-- primary-target-end
