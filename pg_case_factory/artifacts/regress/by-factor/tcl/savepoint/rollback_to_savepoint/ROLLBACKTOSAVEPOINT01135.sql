...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01135
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01135|error_assertion|drop_objects
...
SAVEPOINT rollbacktosavepoint_01135_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01135_sp AND NO CHAIN;
-- primary-target-end
