...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00874
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00874|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00874_sp AND NO CHAIN;
-- primary-target-end
