...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00565
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00565|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00565_sp AND CHAIN;
-- primary-target-end
