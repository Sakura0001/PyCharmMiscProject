...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00168
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00168|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00168_sp AND CHAIN;
-- primary-target-end
