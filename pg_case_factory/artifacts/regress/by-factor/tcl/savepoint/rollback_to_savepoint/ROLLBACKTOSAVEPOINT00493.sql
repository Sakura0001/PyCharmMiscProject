...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00493
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00493|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00493_sp AND CHAIN;
-- primary-target-end
