...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01146
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01146|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01146_sp AND NO CHAIN;
-- primary-target-end
