...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00349
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00349|effect_query|drop_objects
...
SAVEPOINT rollbacktosavepoint_00349_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00349_sp AND CHAIN;
-- primary-target-end
