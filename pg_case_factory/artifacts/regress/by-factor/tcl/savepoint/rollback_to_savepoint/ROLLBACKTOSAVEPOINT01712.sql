...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01712
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01712|error_assertion|reset_state
...
SAVEPOINT rollbacktosavepoint_01712_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01712_sp;
-- primary-target-end
