...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00704
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00704|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00704_sp AND NO CHAIN;
-- primary-target-end
