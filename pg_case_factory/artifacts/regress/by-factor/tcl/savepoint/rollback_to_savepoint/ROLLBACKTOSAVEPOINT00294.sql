...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00294
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00294|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00294_sp AND CHAIN;
-- primary-target-end
