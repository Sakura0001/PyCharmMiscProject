...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00751
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00751|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00751_sp AND NO CHAIN;
-- primary-target-end
