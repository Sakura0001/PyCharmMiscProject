...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00689
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00689|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00689_sp AND NO CHAIN;
-- primary-target-end
