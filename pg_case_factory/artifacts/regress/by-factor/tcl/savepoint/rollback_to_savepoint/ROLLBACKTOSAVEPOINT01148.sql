...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01148
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01148|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01148_sp AND NO CHAIN;
-- primary-target-end
