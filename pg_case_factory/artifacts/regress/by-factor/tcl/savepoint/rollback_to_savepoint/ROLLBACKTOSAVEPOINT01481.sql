...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01481
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01481|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01481_sp;
-- primary-target-end
