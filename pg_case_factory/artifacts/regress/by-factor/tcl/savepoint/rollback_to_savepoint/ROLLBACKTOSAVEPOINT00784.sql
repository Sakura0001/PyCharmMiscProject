...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00784
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00784|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00784_sp AND NO CHAIN;
-- primary-target-end
