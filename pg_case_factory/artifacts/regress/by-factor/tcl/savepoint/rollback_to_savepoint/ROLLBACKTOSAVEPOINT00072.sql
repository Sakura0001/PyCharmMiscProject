...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00072
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00072|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00072_sp AND CHAIN;
-- primary-target-end
