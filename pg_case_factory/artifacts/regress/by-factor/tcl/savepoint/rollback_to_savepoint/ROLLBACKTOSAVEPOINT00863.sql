...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00863
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00863|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00863_sp AND NO CHAIN;
-- primary-target-end
