...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01563
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01563|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01563_sp;
-- primary-target-end
