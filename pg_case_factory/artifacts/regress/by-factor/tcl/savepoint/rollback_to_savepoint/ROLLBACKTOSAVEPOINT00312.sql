...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00312
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00312|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00312_sp AND CHAIN;
-- primary-target-end
