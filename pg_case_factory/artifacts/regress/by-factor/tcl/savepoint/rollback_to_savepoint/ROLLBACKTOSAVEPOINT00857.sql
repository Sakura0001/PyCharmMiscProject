...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00857
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00857|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00857_sp AND NO CHAIN;
-- primary-target-end
