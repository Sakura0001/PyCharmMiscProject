...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01668
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01668|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01668_sp;
-- primary-target-end
