...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01763
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01763|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01763_sp;
-- primary-target-end
