...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00080
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00080|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00080_sp AND CHAIN;
-- primary-target-end
