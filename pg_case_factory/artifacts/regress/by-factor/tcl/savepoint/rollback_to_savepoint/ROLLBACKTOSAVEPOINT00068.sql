...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00068
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00068|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00068_sp AND CHAIN;
-- primary-target-end
