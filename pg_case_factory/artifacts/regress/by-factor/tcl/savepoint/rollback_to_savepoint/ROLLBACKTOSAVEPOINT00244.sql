...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00244
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00244|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00244_sp AND CHAIN;
-- primary-target-end
