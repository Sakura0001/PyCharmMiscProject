...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00099
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00099|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00099_sp AND CHAIN;
-- primary-target-end
