...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00137
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00137|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00137_sp AND CHAIN;
-- primary-target-end
