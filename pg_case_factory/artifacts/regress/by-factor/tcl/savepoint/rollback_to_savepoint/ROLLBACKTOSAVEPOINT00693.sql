...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00693
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00693|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00693_sp AND NO CHAIN;
-- primary-target-end
