...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00056
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00056|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00056_sp AND CHAIN;
-- primary-target-end
