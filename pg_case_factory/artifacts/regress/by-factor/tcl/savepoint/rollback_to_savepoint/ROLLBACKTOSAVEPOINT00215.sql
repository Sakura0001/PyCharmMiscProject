...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00215
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00215|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00215_sp AND CHAIN;
-- primary-target-end
