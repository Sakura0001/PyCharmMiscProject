...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00191
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00191|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00191_sp AND CHAIN;
-- primary-target-end
