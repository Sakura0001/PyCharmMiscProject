...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00194
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00194|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00194_sp AND CHAIN;
-- primary-target-end
