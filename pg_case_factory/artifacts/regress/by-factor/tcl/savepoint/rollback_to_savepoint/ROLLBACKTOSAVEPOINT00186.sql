...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00186
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00186|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00186_sp AND CHAIN;
-- primary-target-end
