...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01109
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01109|returned_rows|reset_state
...
SAVEPOINT rollbacktosavepoint_01109_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01109_sp AND NO CHAIN;
-- primary-target-end
