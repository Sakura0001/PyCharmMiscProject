...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00567
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00567|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00567_sp AND CHAIN;
-- primary-target-end
