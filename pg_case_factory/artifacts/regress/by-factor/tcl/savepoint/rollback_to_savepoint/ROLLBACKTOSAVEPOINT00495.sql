...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00495
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00495|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00495_sp AND CHAIN;
-- primary-target-end
