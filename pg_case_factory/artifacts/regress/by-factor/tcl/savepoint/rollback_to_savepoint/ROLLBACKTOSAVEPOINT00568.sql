...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00568
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00568|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00568_sp AND CHAIN;
-- primary-target-end
