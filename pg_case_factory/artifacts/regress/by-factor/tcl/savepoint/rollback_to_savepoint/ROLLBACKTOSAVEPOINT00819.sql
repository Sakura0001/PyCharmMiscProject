...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00819
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00819|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00819_sp AND NO CHAIN;
-- primary-target-end
