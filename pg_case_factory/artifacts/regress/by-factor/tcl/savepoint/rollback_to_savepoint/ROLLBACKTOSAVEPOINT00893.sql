...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00893
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00893|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00893_sp AND NO CHAIN;
-- primary-target-end
