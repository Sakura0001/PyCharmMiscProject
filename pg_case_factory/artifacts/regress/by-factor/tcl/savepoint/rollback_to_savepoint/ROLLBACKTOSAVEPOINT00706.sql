...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00706
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00706|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00706_sp AND NO CHAIN;
-- primary-target-end
