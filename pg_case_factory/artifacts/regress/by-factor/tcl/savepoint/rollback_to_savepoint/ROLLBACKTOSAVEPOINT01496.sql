...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01496
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01496|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01496_sp;
-- primary-target-end
