...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00811
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00811|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00811_sp AND NO CHAIN;
-- primary-target-end
