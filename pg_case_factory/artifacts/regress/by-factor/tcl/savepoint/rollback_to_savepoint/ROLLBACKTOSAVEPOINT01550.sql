...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01550
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01550|effect_query|reset_state
...
SAVEPOINT rollbacktosavepoint_01550_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01550_sp;
-- primary-target-end
