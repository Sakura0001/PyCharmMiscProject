...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00100
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00100|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00100_sp AND CHAIN;
-- primary-target-end
