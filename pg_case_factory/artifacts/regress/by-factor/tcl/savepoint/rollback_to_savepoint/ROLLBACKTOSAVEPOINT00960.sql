...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00960
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00960|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00960_sp AND NO CHAIN;
-- primary-target-end
