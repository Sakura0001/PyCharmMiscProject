...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00285
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00285|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00285_sp AND CHAIN;
-- primary-target-end
