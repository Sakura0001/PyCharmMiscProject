...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00561
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00561|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00561_sp AND CHAIN;
-- primary-target-end
