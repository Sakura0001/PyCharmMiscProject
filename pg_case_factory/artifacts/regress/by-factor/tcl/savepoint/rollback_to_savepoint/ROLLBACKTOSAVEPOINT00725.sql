...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00725
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00725|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00725_sp AND NO CHAIN;
-- primary-target-end
