...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00854
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00854|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00854_sp AND NO CHAIN;
-- primary-target-end
