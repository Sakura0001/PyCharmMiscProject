...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00785
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00785|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00785_sp AND NO CHAIN;
-- primary-target-end
