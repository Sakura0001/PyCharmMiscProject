...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00281
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00281|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00281_sp AND CHAIN;
-- primary-target-end
