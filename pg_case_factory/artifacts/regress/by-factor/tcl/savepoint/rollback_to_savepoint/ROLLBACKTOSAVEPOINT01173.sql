...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01173
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01173|catalog_query|rollback
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ WRITE;
SAVEPOINT rollbacktosavepoint_01173_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01173_sp AND NO CHAIN;
-- primary-target-end
