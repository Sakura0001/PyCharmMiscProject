...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00986
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00986|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00986_sp AND NO CHAIN;
-- primary-target-end
