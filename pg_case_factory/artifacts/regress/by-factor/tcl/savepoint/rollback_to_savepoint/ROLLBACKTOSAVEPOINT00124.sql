...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00124
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00124|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00124_sp AND CHAIN;
-- primary-target-end
