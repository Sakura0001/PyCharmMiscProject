...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT state_boundary=nested_savepoint
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00023
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-7fe454731f12947a53806802|rollback_to_savepoint
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00023_sp;
-- primary-target-end
