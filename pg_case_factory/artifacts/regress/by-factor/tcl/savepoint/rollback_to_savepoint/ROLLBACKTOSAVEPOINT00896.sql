...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00896
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00896|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00896_sp AND NO CHAIN;
-- primary-target-end
