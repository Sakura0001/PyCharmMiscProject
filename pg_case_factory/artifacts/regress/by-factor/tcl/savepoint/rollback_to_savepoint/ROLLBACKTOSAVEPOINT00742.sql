...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00742
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00742|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00742_sp AND NO CHAIN;
-- primary-target-end
