...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01117
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01117|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01117_sp AND NO CHAIN;
-- primary-target-end
