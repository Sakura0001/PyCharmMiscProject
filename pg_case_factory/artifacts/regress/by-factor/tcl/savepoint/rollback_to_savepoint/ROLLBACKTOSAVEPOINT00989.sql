...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00989
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00989|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00989_sp AND NO CHAIN;
-- primary-target-end
