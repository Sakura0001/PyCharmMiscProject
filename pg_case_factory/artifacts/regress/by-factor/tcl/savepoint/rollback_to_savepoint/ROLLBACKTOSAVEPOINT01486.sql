...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01486
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01486|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01486_sp;
-- primary-target-end
