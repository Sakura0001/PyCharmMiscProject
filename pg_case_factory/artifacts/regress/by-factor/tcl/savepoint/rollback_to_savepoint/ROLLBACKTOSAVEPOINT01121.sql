...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01121
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01121|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01121_sp AND NO CHAIN;
-- primary-target-end
