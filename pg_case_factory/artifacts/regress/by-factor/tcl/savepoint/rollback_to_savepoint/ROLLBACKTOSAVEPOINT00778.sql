...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00778
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00778|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00778_sp AND NO CHAIN;
-- primary-target-end
