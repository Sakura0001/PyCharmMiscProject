...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00569
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00569|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00569_sp AND CHAIN;
-- primary-target-end
