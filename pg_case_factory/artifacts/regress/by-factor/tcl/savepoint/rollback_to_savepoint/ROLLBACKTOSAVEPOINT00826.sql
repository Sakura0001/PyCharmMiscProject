...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00826
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00826|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00826_sp AND NO CHAIN;
-- primary-target-end
