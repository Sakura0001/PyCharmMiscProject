...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00942
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00942|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00942_sp AND NO CHAIN;
-- primary-target-end
