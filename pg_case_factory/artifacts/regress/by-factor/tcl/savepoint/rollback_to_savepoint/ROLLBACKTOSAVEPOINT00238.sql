...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00238
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00238|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00238_sp AND CHAIN;
-- primary-target-end
