...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00571
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00571|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00571_sp AND CHAIN;
-- primary-target-end
