...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00073
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00073|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00073_sp AND CHAIN;
-- primary-target-end
