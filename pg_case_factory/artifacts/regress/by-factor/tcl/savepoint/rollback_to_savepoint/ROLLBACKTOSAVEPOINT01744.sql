...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01744
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01744|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01744_sp;
-- primary-target-end
