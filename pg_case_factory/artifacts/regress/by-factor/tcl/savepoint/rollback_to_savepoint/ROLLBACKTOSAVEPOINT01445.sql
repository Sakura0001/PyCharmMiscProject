...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01445
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01445|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01445_sp;
-- primary-target-end
