...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00867
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00867|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00867_sp AND NO CHAIN;
-- primary-target-end
