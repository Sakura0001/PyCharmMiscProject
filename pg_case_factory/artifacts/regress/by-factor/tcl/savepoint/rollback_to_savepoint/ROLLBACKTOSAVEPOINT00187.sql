...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00187
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00187|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00187_sp AND CHAIN;
-- primary-target-end
