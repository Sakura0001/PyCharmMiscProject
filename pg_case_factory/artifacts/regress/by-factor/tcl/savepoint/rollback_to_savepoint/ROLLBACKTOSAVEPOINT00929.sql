...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00929
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00929|returned_rows|reset_state
...
SAVEPOINT rollbacktosavepoint_00929_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00929_sp AND NO CHAIN;
-- primary-target-end
