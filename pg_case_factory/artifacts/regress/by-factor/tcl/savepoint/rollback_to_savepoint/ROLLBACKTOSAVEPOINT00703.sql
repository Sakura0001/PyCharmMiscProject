...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00703
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00703|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00703_sp AND NO CHAIN;
-- primary-target-end
