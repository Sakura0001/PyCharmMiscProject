...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00645
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00645|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00645_sp AND NO CHAIN;
-- primary-target-end
