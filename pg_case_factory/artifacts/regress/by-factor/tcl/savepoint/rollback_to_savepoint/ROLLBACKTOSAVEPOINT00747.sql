...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00747
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00747|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00747_sp AND NO CHAIN;
-- primary-target-end
