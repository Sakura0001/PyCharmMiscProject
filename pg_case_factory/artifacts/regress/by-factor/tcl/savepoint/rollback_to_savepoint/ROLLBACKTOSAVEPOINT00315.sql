...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00315
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00315|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00315_sp AND CHAIN;
-- primary-target-end
