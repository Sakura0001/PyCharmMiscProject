...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00236
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00236|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00236_sp AND CHAIN;
-- primary-target-end
