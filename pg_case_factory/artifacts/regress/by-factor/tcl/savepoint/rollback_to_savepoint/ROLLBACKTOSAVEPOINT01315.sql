...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01315
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01315|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01315_sp;
-- primary-target-end
