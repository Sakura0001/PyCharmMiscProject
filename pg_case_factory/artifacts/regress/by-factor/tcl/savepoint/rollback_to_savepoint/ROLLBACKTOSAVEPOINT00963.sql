...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00963
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00963|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00963_sp AND NO CHAIN;
-- primary-target-end
