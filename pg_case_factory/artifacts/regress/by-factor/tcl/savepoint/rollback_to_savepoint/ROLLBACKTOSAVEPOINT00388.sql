...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00388
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00388|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00388_sp AND CHAIN;
-- primary-target-end
