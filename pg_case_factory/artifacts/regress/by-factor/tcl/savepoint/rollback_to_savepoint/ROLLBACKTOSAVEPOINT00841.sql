...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00841
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00841|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00841_sp AND NO CHAIN;
-- primary-target-end
