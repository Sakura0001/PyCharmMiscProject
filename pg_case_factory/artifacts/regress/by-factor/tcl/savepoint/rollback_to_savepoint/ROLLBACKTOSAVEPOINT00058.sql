...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00058
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00058|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00058_sp AND CHAIN;
-- primary-target-end
