...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00584
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00584|error_assertion|reset_state
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ WRITE;
SAVEPOINT rollbacktosavepoint_00584_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00584_sp AND CHAIN;
-- primary-target-end
