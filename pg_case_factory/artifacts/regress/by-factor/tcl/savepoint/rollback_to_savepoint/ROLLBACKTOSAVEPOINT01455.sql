...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01455
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01455|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01455_sp;
-- primary-target-end
