...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00251
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00251|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00251_sp AND CHAIN;
-- primary-target-end
