...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01083
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01083|returned_rows|rollback
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN;
SAVEPOINT rollbacktosavepoint_01083_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01083_sp AND NO CHAIN;
-- primary-target-end
