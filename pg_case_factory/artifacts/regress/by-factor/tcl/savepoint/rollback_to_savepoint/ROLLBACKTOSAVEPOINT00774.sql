...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00774
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00774|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00774_sp AND NO CHAIN;
-- primary-target-end
