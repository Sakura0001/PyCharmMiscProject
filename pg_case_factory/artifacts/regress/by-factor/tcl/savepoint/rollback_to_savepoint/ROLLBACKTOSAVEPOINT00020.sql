...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT savepoint_name_shape=quoted_name
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00020
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-e62e863be2a4c305c6f6b94c|rollback_to_savepoint
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN;
SAVEPOINT "rollbacktosavepoint_00020_Mixed SP";
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT "rollbacktosavepoint_00020_Mixed SP";
-- primary-target-end
