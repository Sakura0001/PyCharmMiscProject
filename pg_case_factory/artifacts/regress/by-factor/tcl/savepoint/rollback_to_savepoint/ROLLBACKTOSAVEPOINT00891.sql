...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00891
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00891|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00891_sp AND NO CHAIN;
-- primary-target-end
