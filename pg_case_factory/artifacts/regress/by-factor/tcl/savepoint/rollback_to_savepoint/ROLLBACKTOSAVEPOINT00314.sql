...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00314
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00314|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00314_sp AND CHAIN;
-- primary-target-end
