...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01165
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01165|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01165_sp AND NO CHAIN;
-- primary-target-end
