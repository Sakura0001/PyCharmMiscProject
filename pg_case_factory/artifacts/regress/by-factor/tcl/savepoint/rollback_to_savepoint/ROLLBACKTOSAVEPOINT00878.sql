...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00878
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00878|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00878_sp AND NO CHAIN;
-- primary-target-end
