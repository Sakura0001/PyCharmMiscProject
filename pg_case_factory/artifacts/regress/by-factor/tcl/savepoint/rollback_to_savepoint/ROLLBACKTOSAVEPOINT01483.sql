...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01483
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01483|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01483_sp;
-- primary-target-end
