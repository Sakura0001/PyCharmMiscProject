...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00089
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00089|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00089_sp AND CHAIN;
-- primary-target-end
