...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00156
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00156|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00156_sp AND CHAIN;
-- primary-target-end
