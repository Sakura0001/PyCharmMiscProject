...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00843
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00843|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00843_sp AND NO CHAIN;
-- primary-target-end
