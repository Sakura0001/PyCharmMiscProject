...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00548
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00548|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00548_sp AND CHAIN;
-- primary-target-end
