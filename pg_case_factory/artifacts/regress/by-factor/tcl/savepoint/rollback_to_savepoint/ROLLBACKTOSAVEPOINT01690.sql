...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01690
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01690|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01690_sp;
-- primary-target-end
