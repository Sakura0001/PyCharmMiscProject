...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01131
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01131|returned_rows|rollback
...
SAVEPOINT rollbacktosavepoint_01131_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01131_sp AND NO CHAIN;
-- primary-target-end
