...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00713
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00713|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00713_sp AND NO CHAIN;
-- primary-target-end
