...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00916
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00916|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00916_sp AND NO CHAIN;
-- primary-target-end
