...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00242
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00242|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00242_sp AND CHAIN;
-- primary-target-end
