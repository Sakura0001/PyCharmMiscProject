...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00793
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00793|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00793_sp AND NO CHAIN;
-- primary-target-end
