...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00121
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00121|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00121_sp AND CHAIN;
-- primary-target-end
