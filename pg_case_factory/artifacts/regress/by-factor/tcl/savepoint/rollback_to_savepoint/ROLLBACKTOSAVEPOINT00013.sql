...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT expected_status=success
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00013
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-94d8b3b96a96fff1c4eee5ce|rollback_to_savepoint
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00013_sp;
-- primary-target-end
