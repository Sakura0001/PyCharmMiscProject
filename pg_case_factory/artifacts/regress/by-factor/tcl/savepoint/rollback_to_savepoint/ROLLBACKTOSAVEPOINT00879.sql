...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00879
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00879|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00879_sp AND NO CHAIN;
-- primary-target-end
