...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01426
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01426|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01426_sp;
-- primary-target-end
