...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00065
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00065|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00065_sp AND CHAIN;
-- primary-target-end
