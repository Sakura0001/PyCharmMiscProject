...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00917
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00917|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00917_sp AND NO CHAIN;
-- primary-target-end
