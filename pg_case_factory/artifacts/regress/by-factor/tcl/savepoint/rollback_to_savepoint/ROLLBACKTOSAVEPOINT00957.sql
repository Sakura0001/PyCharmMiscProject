...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00957
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00957|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00957_sp AND NO CHAIN;
-- primary-target-end
