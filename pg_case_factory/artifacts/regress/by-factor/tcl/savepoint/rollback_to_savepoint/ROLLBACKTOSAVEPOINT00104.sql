...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00104
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00104|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00104_sp AND CHAIN;
-- primary-target-end
