...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00791
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00791|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00791_sp AND NO CHAIN;
-- primary-target-end
