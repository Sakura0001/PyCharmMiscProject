...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00982
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00982|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00982_sp AND NO CHAIN;
-- primary-target-end
