...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT transaction_state=savepoint_exists
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00040
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-3e22f7101c7b0b91d256626e|rollback_to_savepoint
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN;
SAVEPOINT rollbacktosavepoint_00040_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00040_sp;
-- primary-target-end
