...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00133
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00133|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00133_sp AND CHAIN;
-- primary-target-end
