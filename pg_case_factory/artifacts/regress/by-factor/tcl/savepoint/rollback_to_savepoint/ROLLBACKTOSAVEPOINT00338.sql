...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00338
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00338|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00338_sp AND CHAIN;
-- primary-target-end
