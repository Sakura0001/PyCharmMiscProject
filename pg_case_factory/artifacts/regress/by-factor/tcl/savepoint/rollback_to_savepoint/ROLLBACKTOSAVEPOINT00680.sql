...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00680
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00680|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00680_sp AND NO CHAIN;
-- primary-target-end
