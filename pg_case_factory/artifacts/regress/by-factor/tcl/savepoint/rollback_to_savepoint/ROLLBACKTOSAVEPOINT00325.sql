...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00325
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00325|effect_query|drop_objects
...
SAVEPOINT rollbacktosavepoint_00325_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00325_sp AND CHAIN;
-- primary-target-end
