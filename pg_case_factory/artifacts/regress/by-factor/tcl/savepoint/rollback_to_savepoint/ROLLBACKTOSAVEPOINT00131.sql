...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00131
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00131|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00131_sp AND CHAIN;
-- primary-target-end
