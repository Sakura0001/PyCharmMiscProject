...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00252
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00252|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00252_sp AND CHAIN;
-- primary-target-end
