...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00359
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00359|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00359_sp AND CHAIN;
-- primary-target-end
