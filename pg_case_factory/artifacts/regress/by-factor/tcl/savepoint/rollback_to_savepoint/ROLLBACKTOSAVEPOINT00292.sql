...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00292
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00292|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00292_sp AND CHAIN;
-- primary-target-end
