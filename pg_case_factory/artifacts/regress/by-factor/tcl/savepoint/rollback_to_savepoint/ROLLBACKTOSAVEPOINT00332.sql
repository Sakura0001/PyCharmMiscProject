...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00332
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00332|error_assertion|reset_state
...
SAVEPOINT rollbacktosavepoint_00332_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00332_sp AND CHAIN;
-- primary-target-end
