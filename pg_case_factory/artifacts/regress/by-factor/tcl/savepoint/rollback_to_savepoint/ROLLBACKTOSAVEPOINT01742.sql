...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01742
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01742|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01742_sp;
-- primary-target-end
