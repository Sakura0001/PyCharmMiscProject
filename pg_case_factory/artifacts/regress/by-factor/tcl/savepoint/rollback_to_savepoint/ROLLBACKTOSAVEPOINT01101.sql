...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01101
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01101|catalog_query|rollback
...
SAVEPOINT rollbacktosavepoint_01101_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01101_sp AND NO CHAIN;
-- primary-target-end
