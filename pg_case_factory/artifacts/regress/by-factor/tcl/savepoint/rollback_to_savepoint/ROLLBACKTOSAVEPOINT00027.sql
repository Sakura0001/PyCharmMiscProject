...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT transaction_id_shape=duplicate_id
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00027
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-fcf17b832898e55fcefba14b|rollback_to_savepoint
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00027_sp;
-- primary-target-end
