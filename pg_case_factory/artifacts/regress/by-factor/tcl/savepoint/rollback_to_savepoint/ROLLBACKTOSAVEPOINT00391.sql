...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00391
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00391|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00391_sp AND CHAIN;
-- primary-target-end
