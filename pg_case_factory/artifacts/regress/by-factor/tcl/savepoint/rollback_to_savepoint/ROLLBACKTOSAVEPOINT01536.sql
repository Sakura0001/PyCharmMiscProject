...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01536
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01536|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01536_sp;
-- primary-target-end
