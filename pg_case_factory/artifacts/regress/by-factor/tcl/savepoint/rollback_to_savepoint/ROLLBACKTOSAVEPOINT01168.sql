...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01168
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01168|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01168_sp AND NO CHAIN;
-- primary-target-end
