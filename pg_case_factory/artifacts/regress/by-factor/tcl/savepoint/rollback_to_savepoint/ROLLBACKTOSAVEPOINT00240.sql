...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00240
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00240|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00240_sp AND CHAIN;
-- primary-target-end
