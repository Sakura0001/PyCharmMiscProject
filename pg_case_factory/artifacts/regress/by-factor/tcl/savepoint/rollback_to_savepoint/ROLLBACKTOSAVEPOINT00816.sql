...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00816
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00816|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00816_sp AND NO CHAIN;
-- primary-target-end
