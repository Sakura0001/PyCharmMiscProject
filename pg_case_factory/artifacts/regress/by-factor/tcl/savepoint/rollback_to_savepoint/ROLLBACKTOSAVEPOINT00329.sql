...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00329
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00329|returned_rows|reset_state
...
SAVEPOINT rollbacktosavepoint_00329_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00329_sp AND CHAIN;
-- primary-target-end
