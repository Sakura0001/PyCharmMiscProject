...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00741
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00741|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00741_sp AND NO CHAIN;
-- primary-target-end
