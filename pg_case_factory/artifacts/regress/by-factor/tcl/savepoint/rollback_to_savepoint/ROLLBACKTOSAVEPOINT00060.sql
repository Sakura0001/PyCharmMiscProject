...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00060
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00060|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00060_sp AND CHAIN;
-- primary-target-end
