...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT state_boundary=no_open_transaction
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00024
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-6d3becf718b5574985c566a8|rollback_to_savepoint
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00024_sp;
-- primary-target-end
