...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00268
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00268|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00268_sp AND CHAIN;
-- primary-target-end
