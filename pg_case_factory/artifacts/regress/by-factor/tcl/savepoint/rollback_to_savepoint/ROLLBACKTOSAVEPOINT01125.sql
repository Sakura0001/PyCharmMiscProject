...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01125
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01125|catalog_query|rollback
...
SAVEPOINT rollbacktosavepoint_01125_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01125_sp AND NO CHAIN;
-- primary-target-end
