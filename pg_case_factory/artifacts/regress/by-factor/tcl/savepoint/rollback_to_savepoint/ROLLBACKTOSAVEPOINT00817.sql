...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00817
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00817|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00817_sp AND NO CHAIN;
-- primary-target-end
