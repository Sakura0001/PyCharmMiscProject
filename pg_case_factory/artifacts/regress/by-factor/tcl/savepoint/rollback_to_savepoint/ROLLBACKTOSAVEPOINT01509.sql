...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01509
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01509|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01509_sp;
-- primary-target-end
