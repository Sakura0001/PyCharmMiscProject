...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01164
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01164|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01164_sp AND NO CHAIN;
-- primary-target-end
