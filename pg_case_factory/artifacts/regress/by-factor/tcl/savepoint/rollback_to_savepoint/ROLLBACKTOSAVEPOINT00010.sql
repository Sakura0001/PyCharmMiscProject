...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT environment_context=outside_transaction_required
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00010
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-447c31fab1df146234ba525a|rollback_to_savepoint
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00010_sp;
-- primary-target-end
