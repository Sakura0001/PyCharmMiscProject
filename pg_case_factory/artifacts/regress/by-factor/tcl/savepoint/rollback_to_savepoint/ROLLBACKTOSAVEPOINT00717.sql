...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00717
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00717|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00717_sp AND NO CHAIN;
-- primary-target-end
