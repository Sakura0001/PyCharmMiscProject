...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00204
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00204|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00204_sp AND CHAIN;
-- primary-target-end
