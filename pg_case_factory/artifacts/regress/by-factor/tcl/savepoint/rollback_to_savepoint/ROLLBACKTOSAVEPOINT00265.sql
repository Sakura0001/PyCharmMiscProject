...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00265
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00265|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00265_sp AND CHAIN;
-- primary-target-end
