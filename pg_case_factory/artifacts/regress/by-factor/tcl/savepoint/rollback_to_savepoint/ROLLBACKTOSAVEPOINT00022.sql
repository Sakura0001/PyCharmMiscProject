...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT savepoint_name_shape=simple_name
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00022
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-5294f3d2e2aa5ff198ed1c21|rollback_to_savepoint
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN;
SAVEPOINT rollbacktosavepoint_00022_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00022_sp;
-- primary-target-end
