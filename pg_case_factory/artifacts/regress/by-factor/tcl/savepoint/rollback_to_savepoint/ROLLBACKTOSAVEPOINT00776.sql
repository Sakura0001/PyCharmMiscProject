...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00776
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00776|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00776_sp AND NO CHAIN;
-- primary-target-end
