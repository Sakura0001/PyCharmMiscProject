...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00141
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00141|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00141_sp AND CHAIN;
-- primary-target-end
