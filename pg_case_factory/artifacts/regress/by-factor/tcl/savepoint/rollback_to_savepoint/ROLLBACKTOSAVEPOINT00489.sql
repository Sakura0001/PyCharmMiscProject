...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00489
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00489|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00489_sp AND CHAIN;
-- primary-target-end
