...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00062
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00062|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00062_sp AND CHAIN;
-- primary-target-end
