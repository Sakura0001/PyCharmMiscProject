...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00491
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00491|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00491_sp AND CHAIN;
-- primary-target-end
