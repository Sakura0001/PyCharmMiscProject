...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01703
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01703|catalog_query|reset_state
...
SAVEPOINT rollbacktosavepoint_01703_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01703_sp;
-- primary-target-end
