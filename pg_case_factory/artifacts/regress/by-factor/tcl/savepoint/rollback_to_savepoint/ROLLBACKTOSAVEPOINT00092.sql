...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00092
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00092|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00092_sp AND CHAIN;
-- primary-target-end
