...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01420
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01420|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01420_sp;
-- primary-target-end
