...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00660
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00660|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00660_sp AND NO CHAIN;
-- primary-target-end
