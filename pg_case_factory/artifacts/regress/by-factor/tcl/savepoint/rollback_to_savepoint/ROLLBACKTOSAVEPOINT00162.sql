...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00162
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00162|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00162_sp AND CHAIN;
-- primary-target-end
