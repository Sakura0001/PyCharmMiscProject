...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00872
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00872|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00872_sp AND NO CHAIN;
-- primary-target-end
