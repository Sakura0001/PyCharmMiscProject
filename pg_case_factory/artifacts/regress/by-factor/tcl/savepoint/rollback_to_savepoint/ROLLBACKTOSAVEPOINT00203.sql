...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00203
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00203|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00203_sp AND CHAIN;
-- primary-target-end
