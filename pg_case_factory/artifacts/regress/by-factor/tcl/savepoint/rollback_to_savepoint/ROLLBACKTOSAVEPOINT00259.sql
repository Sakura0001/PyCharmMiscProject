...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00259
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00259|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00259_sp AND CHAIN;
-- primary-target-end
