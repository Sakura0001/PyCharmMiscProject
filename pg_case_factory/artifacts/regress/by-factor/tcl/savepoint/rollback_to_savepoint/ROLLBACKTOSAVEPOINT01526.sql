...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01526
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01526|effect_query|reset_state
...
SAVEPOINT rollbacktosavepoint_01526_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01526_sp;
-- primary-target-end
