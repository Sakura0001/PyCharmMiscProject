...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01106
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01106|effect_query|reset_state
...
SAVEPOINT rollbacktosavepoint_01106_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01106_sp AND NO CHAIN;
-- primary-target-end
