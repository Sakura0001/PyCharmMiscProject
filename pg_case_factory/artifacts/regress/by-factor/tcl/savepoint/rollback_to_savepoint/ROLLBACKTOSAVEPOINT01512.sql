...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01512
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01512|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01512_sp;
-- primary-target-end
