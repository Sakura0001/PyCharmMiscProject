...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00722
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00722|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00722_sp AND NO CHAIN;
-- primary-target-end
