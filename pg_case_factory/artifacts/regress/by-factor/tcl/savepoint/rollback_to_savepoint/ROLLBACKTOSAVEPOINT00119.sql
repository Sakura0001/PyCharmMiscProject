...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00119
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00119|catalog_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00119_sp AND CHAIN;
-- primary-target-end
