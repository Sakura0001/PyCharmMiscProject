...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00837
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00837|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00837_sp AND NO CHAIN;
-- primary-target-end
