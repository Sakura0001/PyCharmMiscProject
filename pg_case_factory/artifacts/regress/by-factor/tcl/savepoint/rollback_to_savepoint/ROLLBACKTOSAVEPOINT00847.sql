...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00847
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00847|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00847_sp AND NO CHAIN;
-- primary-target-end
