...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01140
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01140|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01140_sp AND NO CHAIN;
-- primary-target-end
