...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00934
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00934|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00934_sp AND NO CHAIN;
-- primary-target-end
