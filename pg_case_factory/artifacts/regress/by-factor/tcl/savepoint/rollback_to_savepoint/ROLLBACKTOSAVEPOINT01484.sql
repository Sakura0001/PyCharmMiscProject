...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01484
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01484|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01484_sp;
-- primary-target-end
