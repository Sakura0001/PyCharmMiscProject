...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00665
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00665|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00665_sp AND NO CHAIN;
-- primary-target-end
