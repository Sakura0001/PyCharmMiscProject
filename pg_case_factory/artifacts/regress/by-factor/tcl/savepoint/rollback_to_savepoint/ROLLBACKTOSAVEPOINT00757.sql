...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00757
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00757|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00757_sp AND NO CHAIN;
-- primary-target-end
