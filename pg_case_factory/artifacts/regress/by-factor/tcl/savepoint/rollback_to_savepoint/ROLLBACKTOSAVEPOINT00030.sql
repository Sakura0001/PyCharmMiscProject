...
-- version      : 1.0
-- description  : ROLLBACK TO SAVEPOINT transaction_id_shape=simple_id
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00030
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-SFV|sfv-34dcc4e8a5296f81c4ce70ad|rollback_to_savepoint
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00030_sp;
-- primary-target-end
