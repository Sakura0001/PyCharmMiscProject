...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00684
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00684|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00684_sp AND NO CHAIN;
-- primary-target-end
