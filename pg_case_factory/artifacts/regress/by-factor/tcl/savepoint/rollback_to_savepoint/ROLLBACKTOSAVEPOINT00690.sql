...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00690
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00690|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00690_sp AND NO CHAIN;
-- primary-target-end
