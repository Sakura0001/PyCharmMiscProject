...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00165
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00165|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00165_sp AND CHAIN;
-- primary-target-end
