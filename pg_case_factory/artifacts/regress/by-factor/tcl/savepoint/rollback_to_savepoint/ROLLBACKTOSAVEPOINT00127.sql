...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00127
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00127|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00127_sp AND CHAIN;
-- primary-target-end
