...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00272
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00272|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00272_sp AND CHAIN;
-- primary-target-end
