...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00688
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00688|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00688_sp AND NO CHAIN;
-- primary-target-end
