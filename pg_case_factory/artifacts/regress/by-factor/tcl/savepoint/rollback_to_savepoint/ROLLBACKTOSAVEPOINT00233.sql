...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00233
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00233|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00233_sp AND CHAIN;
-- primary-target-end
