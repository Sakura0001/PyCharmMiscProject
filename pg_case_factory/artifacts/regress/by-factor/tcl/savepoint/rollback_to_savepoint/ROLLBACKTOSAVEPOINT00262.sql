...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00262
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00262|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00262_sp AND CHAIN;
-- primary-target-end
