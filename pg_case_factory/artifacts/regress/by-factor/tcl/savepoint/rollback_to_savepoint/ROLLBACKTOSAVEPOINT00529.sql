...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00529
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00529|effect_query|drop_objects
...
SAVEPOINT rollbacktosavepoint_00529_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00529_sp AND CHAIN;
-- primary-target-end
