...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00208
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00208|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00208_sp AND CHAIN;
-- primary-target-end
