...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00651
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00651|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00651_sp AND NO CHAIN;
-- primary-target-end
