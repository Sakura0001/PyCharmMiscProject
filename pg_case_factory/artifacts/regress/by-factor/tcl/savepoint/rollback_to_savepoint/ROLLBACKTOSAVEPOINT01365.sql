...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01365
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01365|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01365_sp;
-- primary-target-end
