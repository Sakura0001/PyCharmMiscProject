...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00051
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00051|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00051_sp AND CHAIN;
-- primary-target-end
