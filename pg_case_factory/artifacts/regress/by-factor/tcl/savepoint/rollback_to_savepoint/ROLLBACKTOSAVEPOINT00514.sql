...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00514
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00514|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00514_sp AND CHAIN;
-- primary-target-end
