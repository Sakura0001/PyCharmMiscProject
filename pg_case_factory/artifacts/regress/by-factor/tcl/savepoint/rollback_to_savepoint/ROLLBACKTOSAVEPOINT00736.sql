...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00736
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00736|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00736_sp AND NO CHAIN;
-- primary-target-end
