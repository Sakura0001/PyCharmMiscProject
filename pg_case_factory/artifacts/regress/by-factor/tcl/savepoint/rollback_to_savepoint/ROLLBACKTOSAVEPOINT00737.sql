...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00737
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00737|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00737_sp AND NO CHAIN;
-- primary-target-end
