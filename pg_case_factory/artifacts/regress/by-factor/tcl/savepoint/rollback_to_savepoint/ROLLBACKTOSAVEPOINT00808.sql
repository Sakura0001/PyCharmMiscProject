...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00808
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00808|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00808_sp AND NO CHAIN;
-- primary-target-end
