...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00677
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00677|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00677_sp AND NO CHAIN;
-- primary-target-end
