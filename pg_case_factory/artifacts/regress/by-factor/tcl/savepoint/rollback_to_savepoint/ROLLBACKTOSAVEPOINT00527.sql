...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00527
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00527|catalog_query|reset_state
...
SAVEPOINT rollbacktosavepoint_00527_sp;
-- 3. 执行唯一获得覆盖信用的 ROLLBACK TO SAVEPOINT。
-- primary-target-begin
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00527_sp AND CHAIN;
-- primary-target-end
