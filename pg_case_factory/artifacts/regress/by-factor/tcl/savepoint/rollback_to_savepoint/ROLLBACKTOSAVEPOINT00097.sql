...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00097
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00097|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00097_sp AND CHAIN;
-- primary-target-end
