...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00883
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00883|error_assertion|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00883_sp AND NO CHAIN;
-- primary-target-end
