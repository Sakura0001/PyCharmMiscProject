...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00524
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00524|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00524_sp AND CHAIN;
-- primary-target-end
