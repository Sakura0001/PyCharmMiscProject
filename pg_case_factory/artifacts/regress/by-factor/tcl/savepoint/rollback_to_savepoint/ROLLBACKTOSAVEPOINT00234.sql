...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00234
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00234|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00234_sp AND CHAIN;
-- primary-target-end
