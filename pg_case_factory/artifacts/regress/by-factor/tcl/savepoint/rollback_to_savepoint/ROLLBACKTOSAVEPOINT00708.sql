...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00708
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00708|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00708_sp AND NO CHAIN;
-- primary-target-end
