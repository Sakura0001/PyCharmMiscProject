...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00111
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00111|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00111_sp AND CHAIN;
-- primary-target-end
