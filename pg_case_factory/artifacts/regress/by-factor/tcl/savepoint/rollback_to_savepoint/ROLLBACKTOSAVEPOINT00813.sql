...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00813
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00813|catalog_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00813_sp AND NO CHAIN;
-- primary-target-end
