...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00832
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00832|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00832_sp AND NO CHAIN;
-- primary-target-end
