...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01762
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01762|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01762_sp;
-- primary-target-end
