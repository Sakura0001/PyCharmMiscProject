...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00216
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00216|effect_query|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00216_sp AND CHAIN;
-- primary-target-end
