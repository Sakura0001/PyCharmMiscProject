...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00182
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00182|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00182_sp AND CHAIN;
-- primary-target-end
