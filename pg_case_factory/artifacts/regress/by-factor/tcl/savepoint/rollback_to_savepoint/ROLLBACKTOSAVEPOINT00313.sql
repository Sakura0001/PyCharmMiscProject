...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00313
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00313|effect_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00313_sp AND CHAIN;
-- primary-target-end
