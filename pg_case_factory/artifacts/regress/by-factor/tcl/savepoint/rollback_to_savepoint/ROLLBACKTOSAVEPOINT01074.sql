...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01074
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01074|error_assertion|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01074_sp AND NO CHAIN;
-- primary-target-end
