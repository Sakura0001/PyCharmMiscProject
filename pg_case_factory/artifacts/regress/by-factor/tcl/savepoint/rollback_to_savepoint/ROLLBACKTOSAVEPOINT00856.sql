...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00856
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00856|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00856_sp AND NO CHAIN;
-- primary-target-end
