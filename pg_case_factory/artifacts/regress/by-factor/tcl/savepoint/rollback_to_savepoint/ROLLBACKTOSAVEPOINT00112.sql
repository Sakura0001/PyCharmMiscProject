...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00112
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00112|returned_rows|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00112_sp AND CHAIN;
-- primary-target-end
