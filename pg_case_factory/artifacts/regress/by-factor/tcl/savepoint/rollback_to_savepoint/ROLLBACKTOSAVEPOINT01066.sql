...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT01066
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|01066|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_01066_sp AND NO CHAIN;
-- primary-target-end
