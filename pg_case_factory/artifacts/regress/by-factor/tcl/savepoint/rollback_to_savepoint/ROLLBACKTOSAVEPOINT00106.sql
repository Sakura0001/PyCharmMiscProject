...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00106
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00106|catalog_query|drop_objects
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00106_sp AND CHAIN;
-- primary-target-end
