...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00749
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00749|returned_rows|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00749_sp AND NO CHAIN;
-- primary-target-end
