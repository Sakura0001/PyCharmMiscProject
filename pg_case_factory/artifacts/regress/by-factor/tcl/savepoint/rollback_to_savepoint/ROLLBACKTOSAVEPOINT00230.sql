...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00230
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00230|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00230_sp AND CHAIN;
-- primary-target-end
