...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00890
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00890|effect_query|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00890_sp AND NO CHAIN;
-- primary-target-end
