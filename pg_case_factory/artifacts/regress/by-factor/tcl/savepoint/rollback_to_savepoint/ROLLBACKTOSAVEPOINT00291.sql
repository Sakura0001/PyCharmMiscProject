...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00291
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00291|returned_rows|rollback
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00291_sp AND CHAIN;
-- primary-target-end
