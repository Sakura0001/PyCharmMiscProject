...
-- ++
-- --------------------------------------------------------
-- case_id: ROLLBACKTOSAVEPOINT00164
...
-- primary_obligation_id: ROLLBACKTOSAVEPOINT-EXT|00164|error_assertion|reset_state
...
ROLLBACK TO SAVEPOINT rollbacktosavepoint_00164_sp AND CHAIN;
-- primary-target-end
