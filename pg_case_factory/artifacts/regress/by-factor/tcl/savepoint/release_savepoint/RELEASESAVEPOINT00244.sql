...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00244|returned_rows|drop_objects
...
RELEASE SAVEPOINT releasesavepoint_00244_sp AND CHAIN;
-- primary-target-end
