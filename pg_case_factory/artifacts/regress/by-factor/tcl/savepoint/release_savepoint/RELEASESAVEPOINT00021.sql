...
-- version      : 1.0
-- description  : RELEASE SAVEPOINT savepoint_name_shape=released_name
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: RELEASESAVEPOINT00021
...
-- primary_obligation_id: RELEASESAVEPOINT-SFV|sfv-af66d79342c20eeffa9779c4|release_savepoint
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN;
SAVEPOINT releasesavepoint_00021_sp;
RELEASE releasesavepoint_00021_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00021_sp;
-- primary-target-end
