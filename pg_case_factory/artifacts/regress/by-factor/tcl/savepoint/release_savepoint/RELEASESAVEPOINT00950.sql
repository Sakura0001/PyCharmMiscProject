...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00950|effect_query|reset_state
...
SAVEPOINT releasesavepoint_00950_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00950_sp AND NO CHAIN;
-- primary-target-end
