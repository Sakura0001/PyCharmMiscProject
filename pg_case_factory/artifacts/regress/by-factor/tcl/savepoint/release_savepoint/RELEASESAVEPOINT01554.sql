...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01554|error_assertion|rollback
...
SAVEPOINT releasesavepoint_01554_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01554_sp;
-- primary-target-end
