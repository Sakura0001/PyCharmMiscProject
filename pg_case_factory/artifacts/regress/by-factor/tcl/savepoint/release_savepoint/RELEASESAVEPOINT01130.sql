...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01130|effect_query|reset_state
...
SAVEPOINT releasesavepoint_01130_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01130_sp AND NO CHAIN;
-- primary-target-end
