...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00929|returned_rows|reset_state
...
SAVEPOINT releasesavepoint_00929_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00929_sp AND NO CHAIN;
-- primary-target-end
