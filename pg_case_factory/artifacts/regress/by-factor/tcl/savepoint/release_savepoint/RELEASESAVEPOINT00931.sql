...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00931|error_assertion|drop_objects
...
SAVEPOINT releasesavepoint_00931_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00931_sp AND NO CHAIN;
-- primary-target-end
