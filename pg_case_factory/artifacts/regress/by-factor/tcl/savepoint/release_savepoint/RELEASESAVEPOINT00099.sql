...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00099|returned_rows|rollback
...
RELEASE SAVEPOINT releasesavepoint_00099_sp AND CHAIN;
-- primary-target-end
