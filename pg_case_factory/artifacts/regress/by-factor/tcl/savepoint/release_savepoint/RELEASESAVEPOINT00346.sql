...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00346|catalog_query|drop_objects
...
SAVEPOINT releasesavepoint_00346_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00346_sp AND CHAIN;
-- primary-target-end
