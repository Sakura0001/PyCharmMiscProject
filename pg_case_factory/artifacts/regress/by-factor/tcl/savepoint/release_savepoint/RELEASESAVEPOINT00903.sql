...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00903|returned_rows|rollback
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN;
SAVEPOINT releasesavepoint_00903_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00903_sp AND NO CHAIN;
-- primary-target-end
