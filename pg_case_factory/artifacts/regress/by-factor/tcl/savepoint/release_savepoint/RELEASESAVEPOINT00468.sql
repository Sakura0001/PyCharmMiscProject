...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00468|effect_query|rollback
...
RELEASE SAVEPOINT releasesavepoint_00468_sp AND CHAIN;
-- primary-target-end
