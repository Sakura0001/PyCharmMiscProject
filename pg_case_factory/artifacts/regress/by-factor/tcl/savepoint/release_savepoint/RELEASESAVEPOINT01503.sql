...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01503|returned_rows|rollback
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN;
SAVEPOINT releasesavepoint_01503_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01503_sp;
-- primary-target-end
