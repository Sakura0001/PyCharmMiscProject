...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01729|effect_query|drop_objects
...
SAVEPOINT releasesavepoint_01729_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01729_sp;
-- primary-target-end
