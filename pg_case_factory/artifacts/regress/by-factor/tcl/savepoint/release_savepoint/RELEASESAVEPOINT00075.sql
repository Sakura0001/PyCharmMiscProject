...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00075|returned_rows|rollback
...
RELEASE SAVEPOINT releasesavepoint_00075_sp AND CHAIN;
-- primary-target-end
