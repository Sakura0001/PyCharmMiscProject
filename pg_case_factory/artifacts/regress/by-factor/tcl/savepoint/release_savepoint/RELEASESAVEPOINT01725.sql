...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01725|catalog_query|rollback
...
SAVEPOINT releasesavepoint_01725_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01725_sp;
-- primary-target-end
