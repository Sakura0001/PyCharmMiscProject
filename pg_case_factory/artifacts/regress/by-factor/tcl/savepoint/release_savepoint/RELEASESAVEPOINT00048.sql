...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00048|effect_query|rollback
...
RELEASE SAVEPOINT releasesavepoint_00048_sp AND CHAIN;
-- primary-target-end
