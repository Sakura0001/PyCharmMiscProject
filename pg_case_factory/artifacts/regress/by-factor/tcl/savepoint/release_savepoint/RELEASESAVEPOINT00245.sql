...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00245|returned_rows|reset_state
...
RELEASE SAVEPOINT releasesavepoint_00245_sp AND CHAIN;
-- primary-target-end
