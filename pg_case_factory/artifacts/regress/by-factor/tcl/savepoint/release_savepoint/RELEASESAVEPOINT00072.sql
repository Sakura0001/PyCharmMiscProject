...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00072|effect_query|rollback
...
RELEASE SAVEPOINT releasesavepoint_00072_sp AND CHAIN;
-- primary-target-end
