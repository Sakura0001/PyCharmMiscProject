...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00946|catalog_query|drop_objects
...
SAVEPOINT releasesavepoint_00946_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00946_sp AND NO CHAIN;
-- primary-target-end
