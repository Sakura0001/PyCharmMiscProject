...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01712|error_assertion|reset_state
...
SAVEPOINT releasesavepoint_01712_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01712_sp;
-- primary-target-end
