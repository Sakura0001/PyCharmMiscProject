...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00891|returned_rows|rollback
...
RELEASE SAVEPOINT releasesavepoint_00891_sp AND NO CHAIN;
-- primary-target-end
