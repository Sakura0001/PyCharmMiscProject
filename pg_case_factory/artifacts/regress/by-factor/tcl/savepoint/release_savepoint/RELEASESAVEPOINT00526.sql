...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00526|catalog_query|drop_objects
...
SAVEPOINT releasesavepoint_00526_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00526_sp AND CHAIN;
-- primary-target-end
