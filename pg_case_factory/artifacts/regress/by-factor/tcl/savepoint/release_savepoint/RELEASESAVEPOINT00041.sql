...
-- version      : 1.0
-- description  : RELEASE SAVEPOINT verification_mode=catalog_query
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: RELEASESAVEPOINT00041
...
-- primary_obligation_id: RELEASESAVEPOINT-SFV|sfv-e5c5e0b181c0fec80c17ecea|release_savepoint
...
RELEASE SAVEPOINT releasesavepoint_00041_sp;
-- primary-target-end
