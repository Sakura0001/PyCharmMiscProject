...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00492|effect_query|rollback
...
RELEASE SAVEPOINT releasesavepoint_00492_sp AND CHAIN;
-- primary-target-end
