...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00219|returned_rows|rollback
...
RELEASE SAVEPOINT releasesavepoint_00219_sp AND CHAIN;
-- primary-target-end
