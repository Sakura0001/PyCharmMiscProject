...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00650|effect_query|reset_state
...
RELEASE SAVEPOINT releasesavepoint_00650_sp AND NO CHAIN;
-- primary-target-end
