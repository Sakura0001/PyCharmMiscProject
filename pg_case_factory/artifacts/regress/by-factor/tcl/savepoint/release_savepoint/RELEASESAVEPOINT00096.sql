...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00096|effect_query|rollback
...
RELEASE SAVEPOINT releasesavepoint_00096_sp AND CHAIN;
-- primary-target-end
