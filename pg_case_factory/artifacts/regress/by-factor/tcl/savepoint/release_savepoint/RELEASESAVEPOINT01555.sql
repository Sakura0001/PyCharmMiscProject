...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01555|error_assertion|drop_objects
...
SAVEPOINT releasesavepoint_01555_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01555_sp;
-- primary-target-end
