...
-- version      : 1.0
-- description  : RELEASE SAVEPOINT chain_behavior=and_no_chain
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: RELEASESAVEPOINT00003
...
-- primary_obligation_id: RELEASESAVEPOINT-SFV|sfv-5b8d3a94b684b36dd991578d|release_savepoint
...
RELEASE SAVEPOINT releasesavepoint_00003_sp AND NO CHAIN;
-- primary-target-end
