...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00528|effect_query|rollback
...
SAVEPOINT releasesavepoint_00528_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00528_sp AND CHAIN;
-- primary-target-end
