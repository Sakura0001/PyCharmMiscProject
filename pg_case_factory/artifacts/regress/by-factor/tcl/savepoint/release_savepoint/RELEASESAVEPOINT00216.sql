...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00216|effect_query|rollback
...
RELEASE SAVEPOINT releasesavepoint_00216_sp AND CHAIN;
-- primary-target-end
