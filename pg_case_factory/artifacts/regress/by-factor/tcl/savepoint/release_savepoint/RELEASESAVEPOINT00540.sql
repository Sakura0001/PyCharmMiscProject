...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00540|effect_query|rollback
...
RELEASE SAVEPOINT releasesavepoint_00540_sp AND CHAIN;
-- primary-target-end
