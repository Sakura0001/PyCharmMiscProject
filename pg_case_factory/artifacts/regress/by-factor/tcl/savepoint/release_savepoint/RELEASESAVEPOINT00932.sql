...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00932|error_assertion|reset_state
...
SAVEPOINT releasesavepoint_00932_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00932_sp AND NO CHAIN;
-- primary-target-end
