...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01553|returned_rows|reset_state
...
SAVEPOINT releasesavepoint_01553_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01553_sp;
-- primary-target-end
