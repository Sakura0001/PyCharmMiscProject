...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00503|catalog_query|reset_state
...
SAVEPOINT releasesavepoint_00503_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00503_sp AND CHAIN;
-- primary-target-end
