...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00819|returned_rows|rollback
...
RELEASE SAVEPOINT releasesavepoint_00819_sp AND NO CHAIN;
-- primary-target-end
