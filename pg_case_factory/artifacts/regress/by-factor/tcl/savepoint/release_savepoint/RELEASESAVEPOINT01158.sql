...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01158|error_assertion|rollback
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ ONLY;
SAVEPOINT releasesavepoint_01158_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01158_sp AND NO CHAIN;
-- primary-target-end
