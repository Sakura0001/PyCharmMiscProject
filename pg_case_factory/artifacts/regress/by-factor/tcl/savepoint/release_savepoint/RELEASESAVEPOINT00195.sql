...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00195|returned_rows|rollback
...
RELEASE SAVEPOINT releasesavepoint_00195_sp AND CHAIN;
-- primary-target-end
