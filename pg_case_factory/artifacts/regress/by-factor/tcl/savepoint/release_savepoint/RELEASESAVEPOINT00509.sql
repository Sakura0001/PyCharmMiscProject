...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00509|returned_rows|reset_state
...
SAVEPOINT releasesavepoint_00509_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00509_sp AND CHAIN;
-- primary-target-end
