...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00792|effect_query|rollback
...
RELEASE SAVEPOINT releasesavepoint_00792_sp AND NO CHAIN;
-- primary-target-end
