...
-- version      : 1.0
-- description  : RELEASE SAVEPOINT transaction_state=savepoint_exists
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: RELEASESAVEPOINT00040
...
-- primary_obligation_id: RELEASESAVEPOINT-SFV|sfv-11afe8a7fcd4dd14512bba74|release_savepoint
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN;
SAVEPOINT releasesavepoint_00040_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00040_sp;
-- primary-target-end
