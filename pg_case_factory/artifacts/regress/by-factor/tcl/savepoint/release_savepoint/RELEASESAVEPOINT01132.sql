...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01132|returned_rows|drop_objects
...
SAVEPOINT releasesavepoint_01132_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01132_sp AND NO CHAIN;
-- primary-target-end
