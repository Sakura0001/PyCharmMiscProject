...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00927|returned_rows|rollback
...
SAVEPOINT releasesavepoint_00927_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00927_sp AND NO CHAIN;
-- primary-target-end
