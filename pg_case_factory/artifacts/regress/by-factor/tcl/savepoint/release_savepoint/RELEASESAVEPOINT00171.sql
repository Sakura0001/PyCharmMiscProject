...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00171|returned_rows|rollback
...
RELEASE SAVEPOINT releasesavepoint_00171_sp AND CHAIN;
-- primary-target-end
