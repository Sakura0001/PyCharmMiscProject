...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01573|effect_query|drop_objects
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ ONLY;
SAVEPOINT releasesavepoint_01573_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01573_sp;
-- primary-target-end
