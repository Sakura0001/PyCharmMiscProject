...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00549|catalog_query|rollback
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ ONLY;
SAVEPOINT releasesavepoint_00549_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00549_sp AND CHAIN;
-- primary-target-end
