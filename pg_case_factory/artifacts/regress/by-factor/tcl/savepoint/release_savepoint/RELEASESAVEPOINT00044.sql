...
-- version      : 1.0
-- description  : RELEASE SAVEPOINT verification_mode=returned_rows
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: RELEASESAVEPOINT00044
...
-- primary_obligation_id: RELEASESAVEPOINT-SFV|sfv-3db74c5145c49edb250a93c8|release_savepoint
...
RELEASE SAVEPOINT releasesavepoint_00044_sp;
-- primary-target-end
