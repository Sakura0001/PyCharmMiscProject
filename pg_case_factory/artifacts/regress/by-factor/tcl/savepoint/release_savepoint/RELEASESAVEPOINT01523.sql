...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01523|catalog_query|reset_state
...
SAVEPOINT releasesavepoint_01523_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01523_sp;
-- primary-target-end
