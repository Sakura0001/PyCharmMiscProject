...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00557|returned_rows|reset_state
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ ONLY;
SAVEPOINT releasesavepoint_00557_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00557_sp AND CHAIN;
-- primary-target-end
