...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00924|effect_query|rollback
...
SAVEPOINT releasesavepoint_00924_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00924_sp AND NO CHAIN;
-- primary-target-end
