...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00141|catalog_query|rollback
...
RELEASE SAVEPOINT releasesavepoint_00141_sp AND CHAIN;
-- primary-target-end
