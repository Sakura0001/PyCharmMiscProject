...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01101|catalog_query|rollback
...
SAVEPOINT releasesavepoint_01101_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01101_sp AND NO CHAIN;
-- primary-target-end
