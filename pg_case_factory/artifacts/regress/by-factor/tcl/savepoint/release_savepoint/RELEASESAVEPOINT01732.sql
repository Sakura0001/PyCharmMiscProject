...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01732|returned_rows|drop_objects
...
SAVEPOINT releasesavepoint_01732_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01732_sp;
-- primary-target-end
