...
-- version      : 1.0
-- description  : RELEASE SAVEPOINT transaction_state=inside_transaction
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: RELEASESAVEPOINT00036
...
-- primary_obligation_id: RELEASESAVEPOINT-SFV|sfv-25b485ee6e52fffaa226fbfa|release_savepoint
...
RELEASE SAVEPOINT releasesavepoint_00036_sp;
-- primary-target-end
