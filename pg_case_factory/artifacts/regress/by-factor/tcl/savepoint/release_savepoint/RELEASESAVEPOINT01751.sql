...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01751|catalog_query|reset_state
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ ONLY;
SAVEPOINT releasesavepoint_01751_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01751_sp;
-- primary-target-end
