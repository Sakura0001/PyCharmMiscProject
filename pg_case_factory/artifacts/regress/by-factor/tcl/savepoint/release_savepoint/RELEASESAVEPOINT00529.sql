...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00529|effect_query|drop_objects
...
SAVEPOINT releasesavepoint_00529_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00529_sp AND CHAIN;
-- primary-target-end
