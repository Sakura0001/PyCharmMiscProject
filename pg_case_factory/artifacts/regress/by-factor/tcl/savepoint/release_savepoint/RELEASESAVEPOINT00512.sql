...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00512|error_assertion|reset_state
...
SAVEPOINT releasesavepoint_00512_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00512_sp AND CHAIN;
-- primary-target-end
