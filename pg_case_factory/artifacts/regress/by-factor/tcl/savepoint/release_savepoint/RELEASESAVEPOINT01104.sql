...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01104|effect_query|rollback
...
SAVEPOINT releasesavepoint_01104_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01104_sp AND NO CHAIN;
-- primary-target-end
