...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01551|returned_rows|rollback
...
SAVEPOINT releasesavepoint_01551_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01551_sp;
-- primary-target-end
