...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01532|error_assertion|reset_state
...
SAVEPOINT releasesavepoint_01532_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01532_sp;
-- primary-target-end
