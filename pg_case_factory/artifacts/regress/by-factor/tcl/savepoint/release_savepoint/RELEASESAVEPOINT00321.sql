...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00321|catalog_query|rollback
...
SAVEPOINT releasesavepoint_00321_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00321_sp AND CHAIN;
-- primary-target-end
