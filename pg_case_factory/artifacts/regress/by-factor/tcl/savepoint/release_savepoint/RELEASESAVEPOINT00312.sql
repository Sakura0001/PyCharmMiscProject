...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00312|effect_query|rollback
...
RELEASE SAVEPOINT releasesavepoint_00312_sp AND CHAIN;
-- primary-target-end
