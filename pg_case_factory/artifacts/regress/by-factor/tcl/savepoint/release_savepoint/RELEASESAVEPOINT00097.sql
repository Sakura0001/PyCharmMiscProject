...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00097|effect_query|drop_objects
...
RELEASE SAVEPOINT releasesavepoint_00097_sp AND CHAIN;
-- primary-target-end
