...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01000|returned_rows|drop_objects
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ WRITE;
SAVEPOINT releasesavepoint_01000_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01000_sp AND NO CHAIN;
-- primary-target-end
