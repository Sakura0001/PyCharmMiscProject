...
-- version      : 1.0
-- description  : RELEASE SAVEPOINT savepoint_name_shape=simple_name
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: RELEASESAVEPOINT00022
...
-- primary_obligation_id: RELEASESAVEPOINT-SFV|sfv-0dac7298c45d93874a978078|release_savepoint
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN;
SAVEPOINT releasesavepoint_00022_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00022_sp;
-- primary-target-end
