...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00696|effect_query|rollback
...
RELEASE SAVEPOINT releasesavepoint_00696_sp AND NO CHAIN;
-- primary-target-end
