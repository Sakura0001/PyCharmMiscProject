...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00804|effect_query|rollback
...
RELEASE SAVEPOINT releasesavepoint_00804_sp AND NO CHAIN;
-- primary-target-end
