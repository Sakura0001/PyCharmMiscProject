...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00501|catalog_query|rollback
...
SAVEPOINT releasesavepoint_00501_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00501_sp AND CHAIN;
-- primary-target-end
