...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00123|returned_rows|rollback
...
RELEASE SAVEPOINT releasesavepoint_00123_sp AND CHAIN;
-- primary-target-end
