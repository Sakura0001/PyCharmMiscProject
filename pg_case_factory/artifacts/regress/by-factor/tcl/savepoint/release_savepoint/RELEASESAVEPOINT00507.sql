...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00507|returned_rows|rollback
...
SAVEPOINT releasesavepoint_00507_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00507_sp AND CHAIN;
-- primary-target-end
