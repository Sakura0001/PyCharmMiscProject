...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01125|catalog_query|rollback
...
SAVEPOINT releasesavepoint_01125_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01125_sp AND NO CHAIN;
-- primary-target-end
