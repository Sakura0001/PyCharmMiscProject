...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01179|returned_rows|rollback
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ WRITE;
SAVEPOINT releasesavepoint_01179_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01179_sp AND NO CHAIN;
-- primary-target-end
