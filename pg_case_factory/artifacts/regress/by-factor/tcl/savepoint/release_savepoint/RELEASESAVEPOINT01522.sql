...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01522|catalog_query|drop_objects
...
SAVEPOINT releasesavepoint_01522_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01522_sp;
-- primary-target-end
