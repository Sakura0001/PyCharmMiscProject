...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00328|returned_rows|drop_objects
...
SAVEPOINT releasesavepoint_00328_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00328_sp AND CHAIN;
-- primary-target-end
