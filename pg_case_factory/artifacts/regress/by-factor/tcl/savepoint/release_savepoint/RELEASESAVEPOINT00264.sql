...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00264|effect_query|rollback
...
RELEASE SAVEPOINT releasesavepoint_00264_sp AND CHAIN;
-- primary-target-end
