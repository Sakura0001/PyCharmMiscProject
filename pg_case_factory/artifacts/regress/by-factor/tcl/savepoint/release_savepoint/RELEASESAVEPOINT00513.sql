...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00513|catalog_query|rollback
...
RELEASE SAVEPOINT releasesavepoint_00513_sp AND CHAIN;
-- primary-target-end
