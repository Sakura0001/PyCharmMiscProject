...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01524|effect_query|rollback
...
SAVEPOINT releasesavepoint_01524_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01524_sp;
-- primary-target-end
