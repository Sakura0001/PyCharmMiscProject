...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01707|returned_rows|rollback
...
SAVEPOINT releasesavepoint_01707_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01707_sp;
-- primary-target-end
