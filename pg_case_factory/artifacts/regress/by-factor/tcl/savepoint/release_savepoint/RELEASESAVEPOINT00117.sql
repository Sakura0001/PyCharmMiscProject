...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00117|catalog_query|rollback
...
RELEASE SAVEPOINT releasesavepoint_00117_sp AND CHAIN;
-- primary-target-end
