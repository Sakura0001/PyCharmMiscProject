...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00568|returned_rows|drop_objects
...
RELEASE SAVEPOINT releasesavepoint_00568_sp AND CHAIN;
-- primary-target-end
