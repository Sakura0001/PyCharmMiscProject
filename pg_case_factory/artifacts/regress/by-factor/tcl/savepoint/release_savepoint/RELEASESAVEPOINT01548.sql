...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01548|effect_query|rollback
...
SAVEPOINT releasesavepoint_01548_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01548_sp;
-- primary-target-end
