...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00921|catalog_query|rollback
...
SAVEPOINT releasesavepoint_00921_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00921_sp AND NO CHAIN;
-- primary-target-end
