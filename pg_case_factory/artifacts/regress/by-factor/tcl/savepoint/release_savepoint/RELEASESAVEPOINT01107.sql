...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01107|returned_rows|rollback
...
SAVEPOINT releasesavepoint_01107_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01107_sp AND NO CHAIN;
-- primary-target-end
