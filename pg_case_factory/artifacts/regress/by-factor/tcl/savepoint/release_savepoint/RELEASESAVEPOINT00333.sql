...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00333|catalog_query|rollback
...
RELEASE SAVEPOINT releasesavepoint_00333_sp AND CHAIN;
-- primary-target-end
