...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00354|error_assertion|rollback
...
SAVEPOINT releasesavepoint_00354_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00354_sp AND CHAIN;
-- primary-target-end
