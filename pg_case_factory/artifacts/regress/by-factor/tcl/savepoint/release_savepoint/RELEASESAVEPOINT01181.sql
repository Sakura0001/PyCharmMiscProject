...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01181|returned_rows|reset_state
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ WRITE;
SAVEPOINT releasesavepoint_01181_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01181_sp AND NO CHAIN;
-- primary-target-end
