...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00049|effect_query|drop_objects
...
RELEASE SAVEPOINT releasesavepoint_00049_sp AND CHAIN;
-- primary-target-end
