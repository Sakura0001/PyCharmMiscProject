...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00564|effect_query|rollback
...
RELEASE SAVEPOINT releasesavepoint_00564_sp AND CHAIN;
-- primary-target-end
