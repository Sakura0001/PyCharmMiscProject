...
-- version      : 1.0
-- description  : RELEASE SAVEPOINT savepoint_name_shape=quoted_name
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: RELEASESAVEPOINT00020
...
-- primary_obligation_id: RELEASESAVEPOINT-SFV|sfv-1d0970111709ce8beb6a96c9|release_savepoint
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN;
SAVEPOINT "releasesavepoint_00020_Mixed SP";
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT "releasesavepoint_00020_Mixed SP";
-- primary-target-end
