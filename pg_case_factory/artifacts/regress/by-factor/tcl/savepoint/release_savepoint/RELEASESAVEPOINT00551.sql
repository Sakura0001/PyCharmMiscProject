...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00551|catalog_query|reset_state
...
-- 2. 创建完整本地规则和因子专用夹具。
BEGIN READ ONLY;
SAVEPOINT releasesavepoint_00551_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00551_sp AND CHAIN;
-- primary-target-end
