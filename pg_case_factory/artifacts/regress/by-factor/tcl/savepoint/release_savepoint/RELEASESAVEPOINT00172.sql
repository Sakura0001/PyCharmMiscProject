...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00172|returned_rows|drop_objects
...
RELEASE SAVEPOINT releasesavepoint_00172_sp AND CHAIN;
-- primary-target-end
