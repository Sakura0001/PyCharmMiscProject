...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|01728|effect_query|rollback
...
SAVEPOINT releasesavepoint_01728_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_01728_sp;
-- primary-target-end
