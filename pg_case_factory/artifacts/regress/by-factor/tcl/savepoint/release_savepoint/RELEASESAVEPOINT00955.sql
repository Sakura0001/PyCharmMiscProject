...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00955|error_assertion|drop_objects
...
SAVEPOINT releasesavepoint_00955_sp;
-- 3. 执行唯一获得覆盖信用的 RELEASE SAVEPOINT。
-- primary-target-begin
RELEASE SAVEPOINT releasesavepoint_00955_sp AND NO CHAIN;
-- primary-target-end
