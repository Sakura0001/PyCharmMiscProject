...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00168|effect_query|rollback
...
RELEASE SAVEPOINT releasesavepoint_00168_sp AND CHAIN;
-- primary-target-end
