...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00237|catalog_query|rollback
...
RELEASE SAVEPOINT releasesavepoint_00237_sp AND CHAIN;
-- primary-target-end
