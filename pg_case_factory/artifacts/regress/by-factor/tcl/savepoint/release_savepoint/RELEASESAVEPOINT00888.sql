...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00888|effect_query|rollback
...
RELEASE SAVEPOINT releasesavepoint_00888_sp AND NO CHAIN;
-- primary-target-end
