...
-- version      : 1.0
-- description  : RELEASE SAVEPOINT transaction_state=outside_transaction
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: RELEASESAVEPOINT00763
...
-- primary_obligation_id: RELEASESAVEPOINT-EXT|00763|error_assertion|drop_objects
...
RELEASE SAVEPOINT releasesavepoint_00763_sp AND NO CHAIN;
-- primary-target-end
