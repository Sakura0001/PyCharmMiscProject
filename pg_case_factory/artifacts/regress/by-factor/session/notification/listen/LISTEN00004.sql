...
-- version      : 1.0
-- description  : LISTEN expected_status=failure
...
-- primary_obligation_id: LISTEN-SFV|sfv-e6ad011a326dba136cfd72a1|listen
...
SELECT count(*) = 0 AS not_listening FROM pg_catalog.pg_listening_channels() AS ch WHERE ch = 'listen_00004_ch' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
UNLISTEN *;
