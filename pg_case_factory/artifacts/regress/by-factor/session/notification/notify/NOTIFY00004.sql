...
-- version      : 1.0
-- description  : NOTIFY expected_status=failure
...
-- primary_obligation_id: NOTIFY-SFV|sfv-ca1957a79209165165b66f89|notify
...
SELECT count(*) = 0 AS not_listening FROM pg_catalog.pg_listening_channels() AS ch WHERE ch = 'notify_00004_ch' ORDER BY count(*) LIMIT 1;
-- 5. 清理全部本编号对象。
UNLISTEN *;
