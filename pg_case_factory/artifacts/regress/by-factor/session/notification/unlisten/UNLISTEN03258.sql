...
-- primary_obligation_id: UNLISTEN-EXT|03258|error_assertion|rollback|value_payload
...
-- 2. 创建完整本地规则和因子专用夹具。
LISTEN unlisten_03258_ch;
-- 3. 执行唯一获得覆盖信用的 UNLISTEN。
-- primary-target-begin
UNLISTEN unlisten_03258_ch;
-- primary-target-end
