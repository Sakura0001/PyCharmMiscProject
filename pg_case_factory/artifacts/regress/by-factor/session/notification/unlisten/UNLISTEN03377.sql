...
-- primary_obligation_id: UNLISTEN-EXT|03377|error_assertion|reset_state|value_payload
...
-- 2. 创建完整本地规则和因子专用夹具。
LISTEN unlisten_03377_ch;
-- 3. 执行唯一获得覆盖信用的 UNLISTEN。
-- primary-target-begin
UNLISTEN unlisten_03377_ch;
-- primary-target-end
