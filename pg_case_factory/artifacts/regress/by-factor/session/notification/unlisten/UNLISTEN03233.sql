...
-- primary_obligation_id: UNLISTEN-EXT|03233|error_assertion|reset_state|value_payload
...
-- 2. 创建完整本地规则和因子专用夹具。
LISTEN unlisten_03233_ch;
-- 3. 执行唯一获得覆盖信用的 UNLISTEN。
-- primary-target-begin
UNLISTEN unlisten_03233_ch;
-- primary-target-end
