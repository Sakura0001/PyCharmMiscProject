...
-- primary_obligation_id: UNLISTEN-EXT|01097|error_assertion|reset_state|name_payload
...
-- 2. 创建完整本地规则和因子专用夹具。
LISTEN public.unlisten_01097_ch;
-- 3. 执行唯一获得覆盖信用的 UNLISTEN。
-- primary-target-begin
UNLISTEN public.unlisten_01097_ch;
-- primary-target-end
