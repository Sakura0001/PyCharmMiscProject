...
-- primary_obligation_id: UNLISTEN-EXT|01670|error_assertion|rollback|dependency_invalid
...
-- 2. 创建完整本地规则和因子专用夹具。
LISTEN unlisten_01670_ch;
-- 3. 执行唯一获得覆盖信用的 UNLISTEN。
-- primary-target-begin
UNLISTEN unlisten_01670_ch;
-- primary-target-end
