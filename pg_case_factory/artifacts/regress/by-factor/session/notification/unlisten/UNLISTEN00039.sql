...
-- version      : 1.0
-- description  : UNLISTEN verification_mode=error_assertion
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: UNLISTEN00039
...
-- primary_obligation_id: UNLISTEN-SFV|sfv-a8ba0b6ec8482e8cfecec4cb|unlisten
...
-- 2. 创建完整本地规则和因子专用夹具。
LISTEN unlisten_00039_ch;
-- 3. 执行唯一获得覆盖信用的 UNLISTEN。
-- primary-target-begin
UNLISTEN unlisten_00039_ch;
-- primary-target-end
