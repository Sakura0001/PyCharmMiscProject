...
-- primary_obligation_id: UNLISTEN-EXT|02018|error_assertion|rollback|scope_name
...
-- 2. 创建完整本地规则和因子专用夹具。
LISTEN public.unlisten_02018_ch;
-- 3. 执行唯一获得覆盖信用的 UNLISTEN。
-- primary-target-begin
UNLISTEN public.unlisten_02018_ch;
-- primary-target-end
