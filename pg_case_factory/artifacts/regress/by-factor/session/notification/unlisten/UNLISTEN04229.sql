...
-- primary_obligation_id: UNLISTEN-EXT|04229|error_assertion|reset_state|invalid_transaction
...
-- 2. 创建完整本地规则和因子专用夹具。
LISTEN unlisten_04229_ch;
-- 3. 执行唯一获得覆盖信用的 UNLISTEN。
-- primary-target-begin
UNLISTEN unlisten_04229_ch;
-- primary-target-end
