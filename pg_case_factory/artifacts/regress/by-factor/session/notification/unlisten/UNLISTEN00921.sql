...
-- primary_obligation_id: UNLISTEN-EXT|00921|error_assertion|reset_state|name_payload
...
-- 2. 创建完整本地规则和因子专用夹具。
LISTEN "unlisten_00921_QuotedCh";
-- 3. 执行唯一获得覆盖信用的 UNLISTEN。
-- primary-target-begin
UNLISTEN "unlisten_00921_QuotedCh";
-- primary-target-end
