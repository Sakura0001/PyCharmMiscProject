...
-- primary_obligation_id: UNLISTEN-EXT|00858|error_assertion|rollback|name_payload
...
-- 2. 创建完整本地规则和因子专用夹具。
LISTEN "unlisten_00858_QuotedCh";
-- 3. 执行唯一获得覆盖信用的 UNLISTEN。
-- primary-target-begin
UNLISTEN "unlisten_00858_QuotedCh";
-- primary-target-end
