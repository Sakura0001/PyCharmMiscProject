...
-- primary_obligation_id: UNLISTEN-EXT|01685|error_assertion|reset_state|dependency_invalid
...
-- 2. 创建完整本地规则和因子专用夹具。
LISTEN unlisten_01685_ch;
-- 3. 执行唯一获得覆盖信用的 UNLISTEN。
-- primary-target-begin
UNLISTEN unlisten_01685_ch;
-- primary-target-end
