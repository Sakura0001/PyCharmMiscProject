...
-- primary_obligation_id: UNLISTEN-EXT|00113|error_assertion|reset_state|scope_value
...
-- 2. 创建完整本地规则和因子专用夹具。
LISTEN unlisten_00113_ch;
-- 3. 执行唯一获得覆盖信用的 UNLISTEN。
-- primary-target-begin
UNLISTEN unlisten_00113_ch;
-- primary-target-end
