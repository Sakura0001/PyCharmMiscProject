...
-- primary_obligation_id: SETCONSTRAINTS-EXT|00752|catalog_query|rollback|scope_value
...
RESET ROLE;
RESET work_mem;
DROP ROLE IF EXISTS setconstraints_00752_actor;
\set ON_ERROR_STOP on
SELECT 1 AS setup_boundary;
-- 2. 创建完整本地规则和因子专用夹具。
SET work_mem = '64MB';
CREATE ROLE setconstraints_00752_actor LOGIN NOSUPERUSER;
SET ROLE setconstraints_00752_actor;
...
RESET work_mem;
RESET ROLE;
DROP OWNED BY setconstraints_00752_actor CASCADE;
DROP ROLE IF EXISTS setconstraints_00752_actor;
