...
-- primary_obligation_id: SETCONSTRAINTS-EXT|00963|catalog_query|reset_state|name_payload
...
RESET ROLE;
RESET work_mem;
DROP ROLE IF EXISTS setconstraints_00963_actor;
\set ON_ERROR_STOP on
SELECT 1 AS setup_boundary;
-- 2. 创建完整本地规则和因子专用夹具。
SET work_mem = '64MB';
CREATE ROLE setconstraints_00963_actor LOGIN NOSUPERUSER;
SET ROLE setconstraints_00963_actor;
...
RESET work_mem;
RESET ROLE;
DROP OWNED BY setconstraints_00963_actor CASCADE;
DROP ROLE IF EXISTS setconstraints_00963_actor;
