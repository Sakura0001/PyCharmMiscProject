...
-- primary_obligation_id: SET-EXT|02921|catalog_query|reset_state|scope_name
...
RESET ROLE;
RESET work_mem;
DROP ROLE IF EXISTS set_02921_actor;
\set ON_ERROR_STOP on
SELECT 1 AS setup_boundary;
-- 2. 创建完整本地规则和因子专用夹具。
SET work_mem = '64MB';
CREATE ROLE set_02921_actor LOGIN NOSUPERUSER;
SET ROLE set_02921_actor;
-- 3. 执行唯一获得覆盖信用的 SET。
...
RESET work_mem;
RESET ROLE;
DROP OWNED BY set_02921_actor CASCADE;
DROP ROLE IF EXISTS set_02921_actor;
