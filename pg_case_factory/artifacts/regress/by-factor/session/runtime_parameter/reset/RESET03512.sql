...
-- primary_obligation_id: RESET-EXT|03512|catalog_query|rollback|value_payload
...
RESET ROLE;
RESET work_mem;
DROP ROLE IF EXISTS reset_03512_actor;
\set ON_ERROR_STOP on
SELECT 1 AS setup_boundary;
-- 2. 创建完整本地规则和因子专用夹具。
SET work_mem = '64MB';
CREATE ROLE reset_03512_actor LOGIN NOSUPERUSER;
SET ROLE reset_03512_actor;
-- 3. 执行唯一获得覆盖信用的 RESET。
...
RESET work_mem;
RESET ROLE;
DROP OWNED BY reset_03512_actor CASCADE;
DROP ROLE IF EXISTS reset_03512_actor;
