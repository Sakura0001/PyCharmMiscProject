...
-- primary_obligation_id: DIS-EXT|02551|catalog_query|reset_state|scope_name
...
RESET ROLE;
RESET work_mem;
DROP ROLE IF EXISTS discard_02551_actor;
\set ON_ERROR_STOP on
SELECT 1 AS setup_boundary;
-- 2. 创建完整本地规则和因子专用夹具。
SET work_mem = '64MB';
CREATE ROLE discard_02551_actor LOGIN NOSUPERUSER;
SET ROLE discard_02551_actor;
...
RESET work_mem;
RESET ROLE;
DROP OWNED BY discard_02551_actor CASCADE;
DROP ROLE IF EXISTS discard_02551_actor;
