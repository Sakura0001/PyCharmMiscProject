...
-- version      : 1.0
-- description  : DISCARD verification_mode=effect_query
-- FE           : PG18-STATEMENT-FACTOR-LOOP
-- ++
-- --------------------------------------------------------
-- case_id: DISCARD00037
...
-- primary_obligation_id: DIS-SFV|sfv-8e2c45a95b044aa769d100a2|discard
...
SELECT current_setting('work_mem') AS work_mem_value;
-- 5. 清理全部本编号对象。
RESET work_mem;
