...
-- primary_obligation_id: EXECUTE-EXT|00725|error_assertion|drop_objects|core_behavior
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS execute_00725_bt CASCADE;
DEALLOCATE ALL;
RESET ROLE;
...
EXECUTE execute_00725_nonexistent;
-- primary-target-end
