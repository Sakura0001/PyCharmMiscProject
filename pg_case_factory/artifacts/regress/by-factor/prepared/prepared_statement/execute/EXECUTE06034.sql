...
-- primary_obligation_id: EXECUTE-EXT|06034|effect_query|rollback|full_cross
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS execute_06034_bt CASCADE;
DEALLOCATE ALL;
RESET ROLE;
...
EXECUTE execute_06034_nonexistent;
-- primary-target-end
