...
-- primary_obligation_id: EXECUTE-EXT|06744|effect_query|reset_state|full_cross
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS execute_06744_bt CASCADE;
DEALLOCATE ALL;
RESET ROLE;
...
EXECUTE execute_06744_nonexistent;
-- primary-target-end
