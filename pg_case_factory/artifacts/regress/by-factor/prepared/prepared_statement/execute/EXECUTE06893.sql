...
-- primary_obligation_id: EXECUTE-EXT|06893|error_assertion|drop_objects|full_cross
-- expected_outcome: expected_failure
-- expected_sqlstate: 42704
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS execute_06893_bt CASCADE;
DEALLOCATE ALL;
RESET ROLE;
...
EXECUTE execute_06893_nonexistent;
-- primary-target-end
