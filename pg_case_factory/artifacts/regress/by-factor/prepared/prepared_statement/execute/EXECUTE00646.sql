...
-- primary_obligation_id: EXECUTE-EXT|00646|effect_query|rollback|core_behavior
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS execute_00646_bt CASCADE;
DEALLOCATE ALL;
RESET ROLE;
...
EXECUTE execute_00646_nonexistent;
-- primary-target-end
