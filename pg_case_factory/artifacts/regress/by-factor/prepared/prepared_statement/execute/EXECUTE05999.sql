...
-- primary_obligation_id: EXECUTE-EXT|05999|effect_query|drop_objects|full_cross
-- expected_outcome: expected_failure
-- expected_sqlstate: 42P01
-- 1. 清理本编号对象，保证脚本可重复执行。
DROP TABLE IF EXISTS execute_05999_bt CASCADE;
DEALLOCATE ALL;
RESET ROLE;
...
EXECUTE execute_05999_nonexistent;
-- primary-target-end
