...
def _build_object_name(prefix: str, case_token: str, sequence: int, max_length: int = 63) -> str:
...
def build_name_context(case_token: str, sequence: int, max_identifier_length: int = 63) -> dict[str, str]:
    return {
