...
来源：https://www.postgresql.org/docs/16/sql-savepoint.html
...
官方说明：SAVEPOINT — define a new savepoint within the current transaction
...
structured_config:
  ...
  official_source: https://www.postgresql.org/docs/16/sql-savepoint.html
  statement:
    key: savepoint
    name: SAVEPOINT
    aliases:
    ...
    - savepoint
    - SAVEPOINT
    purpose: SAVEPOINT — define a new savepoint within the current transaction
  syntax_templates:
  - SAVEPOINT savepoint_name
  factor_layers:
  - tier: T1
