...
官方说明：ROLLBACK TO SAVEPOINT — roll back to a savepoint
...
structured_config:
  ...
  statement:
    ...
    - rollback to savepoint
    - ROLLBACK TO SAVEPOINT
    purpose: ROLLBACK TO SAVEPOINT — roll back to a savepoint
  syntax_templates:
  - ROLLBACK [ WORK | TRANSACTION ] TO [ SAVEPOINT ] savepoint_name
  factor_layers:
  - tier: T1
  ...
  coverage_policy:
    ...
    - transaction_state
  rendering:
    statement_template: ROLLBACK [ WORK | TRANSACTION ] TO [ SAVEPOINT ] savepoint_name
