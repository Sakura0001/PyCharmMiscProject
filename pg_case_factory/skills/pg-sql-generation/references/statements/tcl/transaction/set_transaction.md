...
官方说明：SET TRANSACTION — set the characteristics of the current transaction
...
structured_config:
  ...
  statement:
    ...
    - set transaction
    - SET TRANSACTION
    purpose: SET TRANSACTION — set the characteristics of the current transaction
  syntax_templates:
  ...
  coverage_policy:
    ...
    - transaction_state
  rendering:
    statement_template: SET TRANSACTION transaction_mode [, ...]
