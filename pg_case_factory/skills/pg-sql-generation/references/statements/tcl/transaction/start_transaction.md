...
官方说明：START TRANSACTION — start a transaction block
...
structured_config:
  ...
  statement:
    ...
    - start transaction
    - START TRANSACTION
    purpose: START TRANSACTION — start a transaction block
  syntax_templates:
  ...
  coverage_policy:
    ...
    - transaction_state
  rendering:
    statement_template: START TRANSACTION [ transaction_mode [, ...] ]
