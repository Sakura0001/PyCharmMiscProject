...
官方说明：ANALYZE — collect statistics about a database
...
structured_config:
  ...
  statement:
    ...
    - analyze
    - ANALYZE
    purpose: ANALYZE — collect statistics about a database
  syntax_templates:
  - "ANALYZE [ ( option [, ...] ) ] [ table_and_columns [, ...] ]\nANALYZE [ VERBOSE ] [ table_and_columns [, ...] ]\n\nwhere\
  ...
  coverage_policy:
    ...
    - target_state
  rendering:
    statement_template: ANALYZE [ ( option [, ...] ) ] [ table_and_columns [, ...] ]
