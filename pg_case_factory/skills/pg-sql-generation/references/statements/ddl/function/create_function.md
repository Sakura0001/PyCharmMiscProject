...
来源：https://www.postgresql.org/docs/18/sql-createfunction.html
...
- **必须覆盖参数数据类型：CREATE FUNCTION 是参数数据类型选择的核心语句，argtype 和 rettype 中所有 PostgreSQL 18.4 支持的常用数据类型类别必须至少有一个代表性参数定义。**
...
structured_config:
  ...
  official_source: https://www.postgresql.org/docs/18/sql-createfunction.html
  pg18_compatibility:
    target_version: "18.4"
    official_source: https://www.postgresql.org/docs/18/sql-createfunction.html
