...
官方说明：MERGE — conditionally insert, update, or delete rows of a table
...
structured_config:
  ...
  statement:
    ...
    - merge
    - MERGE
    purpose: MERGE — conditionally insert, update, or delete rows of a table
  syntax_templates:
  - "[ WITH with_query [, ...] ]\nMERGE INTO [ ONLY ] target_table_name [ * ] [ [ AS ] target_alias ]\n    USING data_source\
    \ ON join_condition\n    when_clause [...]\n\nwhere data_source is:\n\n    { [ ONLY ] source_table_name [ * ] | ( source_query\
  ...
  coverage_policy:
    ...
    - data_or_query_shape
  rendering:
    statement_template: '[ WITH with_query [, ...] ]'
