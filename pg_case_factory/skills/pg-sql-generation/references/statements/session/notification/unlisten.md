...
来源：https://www.postgresql.org/docs/16/sql-unlisten.html
...
官方说明：UNLISTEN — stop listening for a notification
...
structured_config:
  ...
  domain: notification
  skill_name: unlisten
  official_source: https://www.postgresql.org/docs/16/sql-unlisten.html
  statement:
    key: unlisten
    name: UNLISTEN
    aliases:
    ...
    - unlisten
    - UNLISTEN
    purpose: UNLISTEN — stop listening for a notification
  syntax_templates:
  - UNLISTEN { channel | * }
  factor_layers:
  - tier: T1
  ...
  coverage_policy:
    ...
    - session_state
  rendering:
    statement_template: UNLISTEN { channel | * }
