...
来源：https://www.postgresql.org/docs/16/sql-reset.html
...
官方说明：RESET — restore the value of a run-time parameter to the default value
...
structured_config:
  ...
  skill_name: reset
  official_source: https://www.postgresql.org/docs/16/sql-reset.html
  statement:
    key: reset
    name: RESET
    aliases:
    ...
    - reset
    - RESET
    purpose: RESET — restore the value of a run-time parameter to the default value
  syntax_templates:
  - 'RESET configuration_parameter
  ...
  coverage_policy:
    ...
    - session_state
  rendering:
    statement_template: RESET configuration_parameter
